...
ZEXTERN int
    ZEXPORT deflatePending OF((z_streamp strm, unsigned* pending, int* bits));
/*
...
ZEXTERN
    uLong ZEXPORT adler32_z OF((uLong adler, const Bytef* buf, z_size_t len));
/*
...
#ifndef Z_SOLO
ZEXTERN int
    ZEXPORTVA gzvprintf Z_ARG((gzFile file, const char* format, va_list va));
#endif
#endif
