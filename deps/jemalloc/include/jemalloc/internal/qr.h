...
#define qr_meld(a_qr_a, a_qr_b, a_type, a_field)                               \
    do {                                                                       \
        a_type* t;                                                             \
...
#define qr_remove(a_qr, a_field)                                               \
    do {                                                                       \
        (a_qr)->a_field.qre_prev->a_field.qre_next = (a_qr)->a_field.qre_next; \
        (a_qr)->a_field.qre_next->a_field.qre_prev = (a_qr)->a_field.qre_prev; \
        (a_qr)->a_field.qre_next                   = (a_qr);                   \
        (a_qr)->a_field.qre_prev                   = (a_qr);                   \
    } while (0)
