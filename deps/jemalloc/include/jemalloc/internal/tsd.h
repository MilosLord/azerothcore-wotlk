...
#define TSD_INITIALIZER                                                        \
    {                                                                          \
        ATOMIC_INIT(tsd_state_uninitialized), TCACHE_ENABLED_ZERO_INITIALIZER, \
            false, 0, 0, 0, 0, 0, 0, NULL, RTREE_CTX_ZERO_INITIALIZER, NULL,   \
            NULL, NULL, TSD_BINSHARDS_ZERO_INITIALIZER,                        \
            TCACHE_ZERO_INITIALIZER,                                           \
            WITNESS_TSD_INITIALIZER MALLOC_TEST_TSD_INITIALIZER                \
    }
...
JEMALLOC_ALWAYS_INLINE uint8_t tsd_state_get(tsd_t* tsd)
{
    /*
...
JEMALLOC_ALWAYS_INLINE tsdn_t* tsd_tsdn(tsd_t* tsd) { return (tsdn_t*)tsd; }
...
JEMALLOC_ALWAYS_INLINE tsd_t* tsdn_tsd(tsdn_t* tsdn)
{
...
JEMALLOC_ALWAYS_INLINE rtree_ctx_t* tsdn_rtree_ctx(tsdn_t*      tsdn,
                                                   rtree_ctx_t* fallback)
{
    /*
