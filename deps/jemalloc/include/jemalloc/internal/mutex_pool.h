...
static inline malloc_mutex_t* mutex_pool_mutex(mutex_pool_t* pool,
                                               uintptr_t     key)
{
...
static inline void mutex_pool_assert_not_held(tsdn_t* tsdn, mutex_pool_t* pool)
{
...
static inline void mutex_pool_lock2(tsdn_t*       tsdn,
                                    mutex_pool_t* pool,
                                    uintptr_t     key1,
                                    uintptr_t     key2)
{
...
static inline void mutex_pool_unlock2(tsdn_t*       tsdn,
                                      mutex_pool_t* pool,
                                      uintptr_t     key1,
                                      uintptr_t     key2)
{
