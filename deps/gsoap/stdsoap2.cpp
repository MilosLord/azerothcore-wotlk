...
/* unicode character representing unknown characters outside the XML 1.0 UTF8
 * unicode space */
...
static int soap_set_error(
    struct soap*, const char*, const char*, const char*, const char*, int);
static int soap_copy_fault(
...
static int        soap_try_connect_command(struct soap*,
                                           int         http_command,
                                           const char* endpoint,
                                           const char* action);
...
#ifdef WITH_NTLM
static int soap_ntlm_handshake(struct soap* soap,
                               int          command,
                               const char*  endpoint,
                               const char*  host,
                               int          port);
...
#ifndef WITH_LEAN
static const char*
           soap_set_validation_fault(struct soap*, const char*, const char*);
...
static const wchar_t* soap_wstring(struct soap* soap,
                                   const char*  s,
                                   int          flag,
                                   long         minlen,
                                   long         maxlen,
...
static const char* soap_string(struct soap* soap,
                               const char*  s,
                               int          flag,
                               long         minlen,
                               long         maxlen,
...
static const char* soap_QName(struct soap* soap,
                              const char*  s,
                              long         minlen,
                              long         maxlen,
                              const char*  pattern);
...
static struct soap_multipart* soap_alloc_multipart(struct soap*,
...
static int tcp_gethostbyname(struct soap*,
                             const char*     addr,
...
static SOAP_SOCKET
tcp_connect(struct soap*, const char* endpoint, const char* host, int port);
static SOAP_SOCKET
...
const char soap_base64i[81] =
    "\76XXX\77\64\65\66\67\70\71\72\73\74\75XXXXXXX\00\01\02\03\04\05\06\07\10"
    "\11\12\13\14\15\16\17\20\21\22\23\24\25\26\27\30\31XXXXXX\32\33\34\35\36"
    "\37\40\41\42\43\44\45\46\47\50\51\52\53\54\55\56\57\60\61\62\63";
...
#ifndef WITH_LEAN
static const struct soap_code_map
    html_entity_codes[] = /* entities for XHTML parsing */
        ...
        if (soap_valid_socket(sk)) {
            if (soap->send_timeout) {
                for (;;) {
                    ...
                    if (soap->ssl)
                        ...
                        r = tcp_select(soap,
                                       ...
                                       SOAP_TCP_SELECT_SND |
                                           ...
                                           SOAP_TCP_SELECT_PIP,
                                       soap->send_timeout);
                    if ((r & SOAP_TCP_SELECT_PIP)) /* abort if data is pending
                                                      on pipe */
                    {
                        DBGLOG(TEST,
                               SOAP_MESSAGE(
                                   fdebug, "Connection closed by self pipe\n"));
                        return SOAP_EOF;
                    }
#else
#ifdef WITH_OPENSSL
                    if (soap->ssl)
                        r = tcp_select(
                            soap, sk, SOAP_TCP_SELECT_ALL, soap->send_timeout);
                    else
#endif
#ifdef WITH_GNUTLS
                        if (soap->session)
            ...
            if (soap->transfer_timeout) {
                ...
                if ((soap->transfer_timeout > 0 &&
                     difftime(now, (time_t)soap->start) >
                         (double)soap->transfer_timeout) ||
                    (soap->transfer_timeout < 0 &&
                     difftime(now, (time_t)soap->start) >
                         -1000000.0 * (double)soap->transfer_timeout))
                    return SOAP_EOF;
            }
#endif
#ifdef WITH_OPENSSL
            if (soap->ssl)
                ...
                if (soap->ssl) {
                err =
                    gsk_secure_socket_write(soap->ssl, (char*)s, n, &nwritten);
                if (err != GSK_OK)
                    nwritten = 0;
            }
            else
                ...
                if (soap->peerlen)
                    ...
                    nwritten =
                        send(sk, s, (SOAP_WINSOCKINT)n, soap->socket_flags);
                /* retry and back-off algorithm */
                /* TODO: this is not very clear from specs so verify and limit
                 * conditions under which we should loop (e.g. ENOBUFS) */
                if (nwritten < 0) {
                    int udp_repeat;
                    int udp_delay;
                    ...
                    do {
                        tcp_select(
                            soap, sk, SOAP_TCP_SELECT_ERR, -1000 * udp_delay);
                        if (soap->peerlen)
                            nwritten = sendto(sk,
                                              (char*)s,
                                              (SOAP_WINSOCKINT)n,
                            ...
                            nwritten = send(
                                sk, s, (SOAP_WINSOCKINT)n, soap->socket_flags);
                        udp_delay <<= 1;
...
#ifdef WITH_OPENSSL
                if (soap->ssl &&
                    (r = SSL_get_error(soap->ssl, nwritten)) !=
                        SSL_ERROR_NONE &&
                ...
                if (err == SOAP_EWOULDBLOCK || err == SOAP_EAGAIN) {
                    ...
                    if (soap->ssl && r == SSL_ERROR_WANT_READ)
                        r = tcp_select(
                            ...
                            soap->send_timeout ? soap->send_timeout : -10000);
                    else
#elif defined(WITH_GNUTLS)
                    if (soap->session &&
                        !gnutls_record_get_direction(soap->session))
                        r = tcp_select(
                            soap,
                            sk,
                            SOAP_TCP_SELECT_RCV | SOAP_TCP_SELECT_ERR,
            ...
            if (soap->rpmreqid)
                nwritten =
                    (httpBlockPut(soap->rpmreqid, (char*)s, n) == 0) ? n : -1;
            else
#endif
#ifdef WIN32
...
int SOAP_FMAC2 soap_send_raw(struct soap* soap, const char* s, size_t n)
{
    ...
    if (soap->fpreparesend && (soap->mode & SOAP_IO) != SOAP_IO_STORE &&
        ...
        (soap->error = soap->fpreparesend(soap, s, n)) != SOAP_OK)
        return soap->error;
    if (soap->ffiltersend &&
        (soap->error = soap->ffiltersend(soap, &s, &n)) != SOAP_OK)
        return soap->error;
#endif
    if ((soap->mode & SOAP_IO_LENGTH)) {
        ...
        while (n >= i) {
            (void)soap_memcpy(
                (void*)(soap->buf + soap->bufidx), i, (const void*)s, i);
        ...
        (void)soap_memcpy((void*)(soap->buf + soap->bufidx),
                          sizeof(soap->buf) - soap->bufidx,
                          (const void*)s,
                          n);
        soap->bufidx += n;
    }
...
int SOAP_FMAC2 soap_flush(struct soap* soap)
{
    ...
    if (!n)
        return soap->error = soap->fsend(
                   soap,
                   SOAP_STR_EOS,
                   0); /* force a zero send for HTTP GET and DELETE */
#ifndef WITH_LEANER
    if ((soap->mode & SOAP_IO) == SOAP_IO_STORE) {
        int r;
        if (soap->fpreparesend &&
            (r = soap->fpreparesend(soap, soap->buf, n)) != SOAP_OK)
            return soap->error = r;
    }
#endif
    soap->bufidx = 0;
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_send3(struct soap* soap,
                          const char*  s1,
                          const char*  s2,
                          const char*  s3)
{
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_query_send_key(struct soap* soap, const char* s)
{
    if (!s)
        return SOAP_OK;
    if (!soap->body && soap_send_raw(soap, "&", 1))
        return soap->error;
    soap->body = 0;
    (void)soap_encode_url(
        s,
        soap->msgbuf,
        (int)sizeof(soap->msgbuf)); /* msgbuf length is max SOAP_TMPLEN or just
                                       1024 bytes */
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_query_send_val(struct soap* soap, const char* s)
{
    if (!s)
        return SOAP_OK;
...
#ifndef WITH_LEANER
SOAP_FMAC1
char* SOAP_FMAC2 soap_query(struct soap* soap)
{
...
#ifndef WITH_LEANER
SOAP_FMAC1
char* SOAP_FMAC2 soap_query_key(struct soap* soap, char** s)
{
    char* t = *s;
    (void)soap;
    if (t && *t) {
...
#ifndef WITH_LEANER
SOAP_FMAC1
char* SOAP_FMAC2 soap_query_val(struct soap* soap, char** s)
{
    char* t = *s;
    (void)soap;
    if (t && *t == '=') {
...
#ifndef WITH_LEANER
SOAP_FMAC1
const char* SOAP_FMAC2 soap_query_decode(char* buf, size_t len, const char* val)
{
    const char* s;
    char*       t;
    for (s = val; *s; s++)
...
static size_t frecv(struct soap* soap, char* s, size_t n)
{
    ...
    {
        if (soap->is->good())
            return (size_t)soap->is->read(s, (std::streamsize)n)
                .gcount(); /* downcast to std::streamsize is OK: gcount()
                              returns how much we got in s[] */
        return 0;
    }
#else
    ...
    if (soap_valid_socket(sk)) {
        for (;;) {
            ...
            if (soap->recv_timeout &&
                !soap->ssl) /* OpenSSL: sockets are nonblocking so go ahead to
                               read */
#else
            if (soap->recv_timeout)
#endif
            ...
            if (soap->ssl) {
                ...
                if (err == GSK_OK && r > 0)
                    return (size_t)r;
                if (err != GSK_OK && err != GSK_WOULD_BLOCK &&
                    err != GSK_WOULD_BLOCK_WRITE)
                    return 0;
            }
            else
#endif
            {
                ...
                if ((soap->omode & SOAP_IO_UDP)) {
                    ...
                    r = recvfrom(
                        ...
                        soap->socket_flags,
                        &soap->peer.addr,
                        &k); /* portability note: see SOAP_SOCKLEN_T definition
                                in stdsoap2.h, SOAP_WINSOCKINT cast is safe due
                                to limited range of n in the engine (64K) */
                    ...
                    r = recv(sk,
                             s,
                             (SOAP_WINSOCKINT)n,
                             soap->socket_flags); /* SOAP_WINSOCKINT cast is
                                                     safe due to limited range
                                                     of n in the engine (64K) */
                if (r >= 0)
                    return (size_t)r;
                r = soap_socket_errno;
...
static soap_wchar soap_getchunkchar(struct soap* soap)
{
    ...
    soap->buflen = soap->chunkbuflen =
        soap->frecv(soap, soap->buf, sizeof(soap->buf));
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
...
int SOAP_FMAC2 soap_recv_raw(struct soap* soap)
{
    ...
    if ((soap->mode & SOAP_ENC_ZLIB) && soap->d_stream) {
        ...
        if (soap->d_stream->avail_in || !soap->d_stream->avail_out) {
            ...
            if (r == Z_NEED_DICT && soap->z_dict)
                r = inflateSetDictionary(soap->d_stream,
                                         (const Bytef*)soap->z_dict,
                                         soap->z_dict_len);
            if (r == Z_OK || r == Z_STREAM_END) {
                soap->bufidx = 0;
                ret          = soap->buflen =
                    sizeof(soap->buf) - soap->d_stream->avail_out;
                if (soap->zlib_in == SOAP_ZLIB_GZIP)
                    soap->z_crc =
                        crc32(soap->z_crc, (Byte*)soap->buf, (unsigned int)ret);
                if (r == Z_STREAM_END) {
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug,
                ...
                if (ret) {
                    ...
                    soap->count += ret;
                    if (soap->recv_maxlength &&
                        soap->count > soap->recv_maxlength)
                        return soap->error = SOAP_EOF;
                    soap->z_ratio_in = (float)soap->d_stream->total_in /
                                       (float)soap->d_stream->total_out;
                    if (soap->count > SOAP_MAXINFLATESIZE &&
                        soap->z_ratio_in < SOAP_MINDEFLATERATIO) {
                        soap->d_stream->msg =
                            (char*)"caught SOAP_MINDEFLATERATIO explosive "
                                   "decompression guard (remedy: increase "
                                   "SOAP_MAXINFLATESIZE and/or decrease "
                    ...
                    if (soap->fpreparerecv &&
                        (r = soap->fpreparerecv(soap, soap->buf, ret)) !=
                            SOAP_OK)
                        return soap->error = r;
#endif
                    return SOAP_OK;
    ...
    zlib_again:
        if ((soap->mode & SOAP_IO) == SOAP_IO_CHUNK && !soap->chunksize) {
            (void)soap_memcpy((void*)soap->buf,
                              sizeof(soap->buf),
                              (const void*)soap->z_buf,
                              sizeof(soap->buf));
    ...
    if ((soap->mode & SOAP_IO) ==
        SOAP_IO_CHUNK) /* read HTTP chunked transfer */
    {
        for (;;) {
            soap_wchar c;
            char *     t, tmp[17];
            if (soap->chunksize) {
                soap->buflen = ret = soap->frecv(
                    soap,
                    soap->buf,
                    soap->chunksize > sizeof(soap->buf) ? sizeof(soap->buf)
                                                        : soap->chunksize);
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug,
            ...
            *t = '\0';
            ...
            if (soap->buflen > soap->chunkbuflen) {
                ...
                DBGLOG(
                    TEST,
                    SOAP_MESSAGE(fdebug,
                                 "Passed end of buffer for chunked HTTP (%u "
                                 "bytes left)\n",
    ...
    if ((soap->mode & SOAP_ENC_ZLIB)) {
        (void)soap_memcpy((void*)soap->z_buf,
                          sizeof(soap->buf),
                          (const void*)soap->buf,
                          sizeof(soap->buf));
        ...
        if (r == Z_OK || r == Z_STREAM_END) {
            ...
            if (soap->zlib_in == SOAP_ZLIB_GZIP)
                soap->z_crc = crc32(
                    soap->z_crc, (Byte*)soap->buf, (unsigned int)soap->buflen);
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                "Inflated %u bytes\n",
                                (unsigned int)soap->buflen));
            ...
            soap->z_ratio_in = (float)soap->d_stream->total_in /
                               (float)soap->d_stream->total_out;
            if (soap->count + ret > SOAP_MAXINFLATESIZE &&
                soap->z_ratio_in < SOAP_MINDEFLATERATIO) {
                soap->d_stream->msg =
                    (char*)"caught SOAP_MINDEFLATERATIO explosive "
                           "decompression guard (remedy: increase "
...
#ifndef WITH_LEANER
            if (soap->fpreparerecv &&
                (r = soap->fpreparerecv(soap, soap->buf, ret)) != SOAP_OK)
                return soap->error = r;
#endif
        }
        else {
    ...
    if (ret) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Read count=" SOAP_ULONG_FORMAT " (+%lu)\n",
                            soap->count,
                            (unsigned long)ret));
        return SOAP_OK;
    }
...
int SOAP_FMAC2 soap_recv(struct soap* soap)
{
    ...
    if ((soap->mode & SOAP_ENC_DIME)) {
        if (soap->dime.buflen) {
            ...
            soap->dime.size  = ((size_t)tmp[8] << 24) | ((size_t)tmp[9] << 16) |
                              ((size_t)tmp[10] << 8) | ((size_t)tmp[11]);
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
            ...
            if (soap->buflen - soap->bufidx >= soap->dime.size) {
                ...
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug,
                           "Chunked SOAP in DIME (%u bytes in chunk left)\n",
    ...
    if (soap->ffilterrecv) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Filter recverror = %d bufidx = %lu buflen = %lu\n",
                            soap->recverror,
                            (unsigned long)soap->bufidx,
        ...
        if (soap->recverror) {
            ...
            soap->bufidx = soap->buflen = 0;
            err                         = soap->ffilterrecv(
                soap, soap->buf, &soap->buflen, sizeof(soap->buf));
            if (err) {
                if (err == SOAP_EOF)
                    return SOAP_EOF;
            ...
            soap->buflen -= soap->bufidx; /* chunked may set bufidx > 0 to skip
                                             hex chunk length */
        }
        while (soap->ffilterrecv) {
            err = soap->ffilterrecv(soap,
...
SOAP_FMAC1
const struct soap_code_map* SOAP_FMAC2
...
LONG64
SOAP_FMAC2
soap_code_int(const struct soap_code_map* code_map,
              const char*                 str,
              LONG64                      other)
{
    if (code_map) {
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_code_str(const struct soap_code_map* code_map,
                                     long                        code)
{
    if (!code_map)
        return NULL;
    ...
    if (code_map) {
        while (str && *str) {
            ...
            for (p = code_map; p->string; p++) {
                ...
                if (!strncmp(p->string, str, n) &&
                    soap_coblank((soap_wchar)str[n])) {
                    bits |= p->code;
                    str += n;
                    while (*str > 0 && *str <= 32)
                        str++;
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_code_list(struct soap*                soap,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_binary_search_string(const char** a, int n, const char* s)
{
    int min = 0, max = n - 1;
    while (min <= max) {
        int mid = (min + max) / 2;
...
static soap_wchar soap_char(struct soap* soap)
{
    ...
    *s = '\0';
    ...
    if (!strcmp(tmp, "apos"))
        return '\'';
#ifndef WITH_LEAN
    return (soap_wchar)soap_code_int(
...
static soap_wchar soap_getpi(struct soap* soap)
{
    char       buf[64];
    char*      s = buf;
    size_t     i = sizeof(buf);
    ...
    if (!strncmp(buf, "xml ", 4)) {
        ...
        if (s && s[10]) {
            if (!soap_tag_cmp(s + 11, "iso-8859-*") ||
                ...
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug, "Switching to latin encoding\n"));
                soap->mode |= SOAP_ENC_LATIN;
            }
            else if (!soap_tag_cmp(s + 11, "utf-8*")) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug, "Switching to utf-8 encoding\n"));
                soap->mode &= ~SOAP_ENC_LATIN;
            }
        }
    }
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_move(struct soap* soap, ULONG64 n)
{
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "Moving " SOAP_ULONG_FORMAT " bytes forward\n", n));
    for (; n; n--)
...
#ifdef WITH_REPLACE_ILLEGAL_UTF8
    if (!(c == 0x09 || c == 0x0A || c == 0x0D || (c >= 0x80 && c <= 0xD7FF) ||
...
soap_wchar SOAP_FMAC2 soap_getutf8(struct soap* soap)
{
    ...
    if (c < 0xFC)
        return ((soap_wchar)(c & 0x03) << 24) | (c1 << 18) | (c2 << 12) |
               (c3 << 6) | c4;
    return ((soap_wchar)(c & 0x01) << 30) | (c1 << 24) | (c2 << 18) |
           (c3 << 12) | (c4 << 6) | (soap_wchar)(soap_get1(soap) & 0x3F);
#endif
}
...
SOAP_FMAC1
size_t SOAP_FMAC2 soap_utf8len(const char* s)
{
    size_t l = 0;
    while (*s)
        if ((*s++ & 0xC0) != 0x80)
        ...
        for (i = 0; i < k; i++) {
            ...
            if (soap_isxdigit(c)) {
                ...
                if (soap->maxlength > 0 && l > (size_t)soap->maxlength) {
                    ...
                    if (p)
                        (void)soap_memcpy(
                            (void*)p, l, (const void*)soap->labbuf, l);
                }
                return p;
            }
            *s++ = (char)(((d1 >= 'A' ? (d1 & 0x7) + 9 : d1 - '0') << 4) +
                          (d2 >= 'A' ? (d2 & 0x7) + 9 : d2 - '0'));
        }
        l = soap->lablen;
        if (soap->maxlength > 0 && l > (size_t)soap->maxlength) {
...
SOAP_FMAC1
unsigned char* SOAP_FMAC2 soap_getbase64(struct soap* soap,
                                         int*         n,
                                         int          malloc_flag)
{
    size_t l = 0;
    ...
    for (;;) {
        int   i;
        char* s = (char*)soap_push_block(
            soap, NULL, 3 * SOAP_BLKLEN); /* must be multiple of 3 */
        if (!s) {
            soap_end_block(soap, NULL);
            return NULL;
        }
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_xop_forward(struct soap*    soap,
                                unsigned char** ptr,
                                int*            size,
                                char**          id,
                                char**          type,
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment_forward(struct soap*    soap,
                                       unsigned char** ptr,
                                       int*            size,
                                       char**          id,
                                       char**          type,
...
SOAP_FMAC1
void* SOAP_FMAC2 soap_memdup(struct soap* soap, const void* s, size_t n)
{
    void* t = NULL;
    if (s) {
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_strtrim(struct soap* soap, char* s)
{
    (void)soap;
    if (s) {
        char* t;
...
SOAP_FMAC1
wchar_t* SOAP_FMAC2 soap_wstrtrim(struct soap* soap, wchar_t* s)
{
    (void)soap;
    if (s) {
        wchar_t* t;
...
SOAP_FMAC1
struct soap_blist* SOAP_FMAC2 soap_alloc_block(struct soap* soap)
{
    struct soap_blist* p;
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "New block sequence (prev=%p)\n", (void*)soap->blist));
...
SOAP_FMAC1
void* SOAP_FMAC2 soap_push_block(struct soap*       soap,
                                 struct soap_blist* b,
                                 size_t             n)
{
    struct soap_bhead* p;
    if (!b)
        b = soap->blist;
    if (!b || b->size + n < b->size || sizeof(struct soap_bhead) + n < n ||
        (SOAP_MAXALLOCSIZE > 0 &&
         sizeof(struct soap_bhead) + n > SOAP_MAXALLOCSIZE)) {
        soap->error = SOAP_EOM;
        return NULL;
    }
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "Push block %p of %u bytes on %lu previous blocks (%lu "
                        "bytes total)\n",
                        (void*)p,
                        (unsigned int)n,
                        (unsigned long)b->item,
                        (unsigned long)b->size));
    b->item++;
    return (void*)(p +
                   1); /* skip block header and point to n allocated bytes */
}

/******************************************************************************/

SOAP_FMAC1
void* SOAP_FMAC2 soap_push_block_max(struct soap*       soap,
                                     struct soap_blist* b,
                                     size_t             n)
{
...
SOAP_FMAC1
void SOAP_FMAC2 soap_update_pointers(struct soap* soap,
                                     const char*  dst,
                                     const char*  src,
                                     size_t       len)
{
...
#endif
#ifndef WITH_NOIDREF
    if ((soap->version && !(soap->imode & SOAP_XML_TREE)) ||
        ...
        for (i = 0; i < SOAP_IDHASH; i++) {
            ...
            for (ip = soap->iht[i]; ip; ip = ip->next) {
                ...
                if (ip->shaky) {
                    DBGLOG(
                        TEST,
                        SOAP_MESSAGE(fdebug, "Update shaky id='%s'\n", ip->id));
                    if (ip->ptr && ip->ptr >= start && ip->ptr < end) {
                        DBGLOG(TEST,
                               SOAP_MESSAGE(fdebug,
                                            "Update ptr %p -> %p\n",
                                            ip->ptr,
                                            (void*)((const char*)ip->ptr +
                                                    (dst - src))));
                    ...
                    for (fp = ip->flist; fp; fp = fp->next) {
                        if (fp->ptr >= start && fp->ptr < end) {
                            DBGLOG(TEST,
                                   SOAP_MESSAGE(
                                       fdebug,
                                       "Copy list update id='%s' target "
                                       "type=%d %p -> %p\n",
                                       ip->id,
                                       fp->type,
                                       fp->ptr,
                                       (void*)((char*)fp->ptr + (dst - src))));
                            fp->ptr =
                                (void*)((const char*)fp->ptr + (dst - src));
                        }
                    }
                    if (ip->smart && ip->smart >= start && ip->smart < end) {
                        DBGLOG(
                            ...
                            SOAP_MESSAGE(
                                ...
                                ip->smart,
                                (void*)((const char*)ip->smart + (dst - src))));
                        ip->smart =
                            (void*)((const char*)ip->smart + (dst - src));
                    }
                }
        ...
        for (ip = soap->iht[i]; ip; ip = ip->next) {
            for (p = (const char*)ip->copy; p; p = *(const char**)p)
                if (p >= start && p < end)
                    return SOAP_ERR;
            for (fp = ip->flist; fp; fp = fp->next)
                if (fp->type == ip->type && (const char*)fp->ptr >= start &&
                    (const char*)fp->ptr < end)
                    return SOAP_ERR;
        }
    }
    return SOAP_OK;
...
int SOAP_FMAC2 soap_resolve(struct soap* soap)
{
                    ...
                    if (ip->ptr &&
                        ...
                        while ((fp = ip->flist)) {
                            DBGLOG(
                                ...
                                SOAP_MESSAGE(
                                    fdebug,
                                    "Resolving forwarded data type=%d target "
                                    "type=%d location=%p level=%u id='%s'\n",
                                    ip->type,
                                    fp->type,
                                    ip->ptr,
                                    fp->level,
    ...
    if (id) {
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Resolution error: forwarded data for id='%s' "
                            "could not be propagated, please report this "
                            "problem to the gSOAP developers\n",
                            id));
...
SOAP_FMAC1
size_t SOAP_FMAC2 soap_size_block(struct soap*       soap,
                                  struct soap_blist* b,
                                  size_t             n)
{
    if (!b)
...
void SOAP_FMAC2 soap_end_block(struct soap* soap, struct soap_blist* b)
{
    ...
    DBGLOG(TEST,
           if (soap->blist)
               SOAP_MESSAGE(fdebug, "Restored previous block sequence\n"));
#ifndef WITH_NOIDREF
    if (!soap->blist && ((soap->version && !(soap->imode & SOAP_XML_TREE)) ||
                         (soap->mode & SOAP_XML_GRAPH))) {
        int                i;
        struct soap_ilist* ip = NULL;
        for (i = 0; i < SOAP_IDHASH; i++)
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_save_block(struct soap*       soap,
                                 struct soap_blist* b,
                                 char*              p,
                                 int                flag)
{
    ...
    if (b->size) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Save all %lu blocks in contiguous memory space of "
                            "%u bytes (%p->%p)\n",
                            (unsigned long)b->item,
                            (unsigned int)b->size,
                            (void*)b->head,
        ...
        if (p) {
            s = p;
            for (q = soap_first_block(soap, b); q;
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_putsizesoffsets(struct soap* soap,
                                      const char*  type,
                                      const int*   size,
                                      const int*   offset,
                                      int          dim)
{
    ...
    if (soap->version != 2 && offset) {
        (SOAP_SNPRINTF(soap->type, sizeof(soap->type) - 1, strlen(type) + 20),
         "%s[%d",
         type,
         size[0] + offset[0]);
        for (i = 1; i < dim; i++) {
            size_t l = strlen(soap->type);
            (SOAP_SNPRINTF(soap->type + l, sizeof(soap->type) - l - 1, 20),
             t,
             size[i] + offset[i]);
        }
    }
...
char* SOAP_FMAC2 soap_putoffsets(struct soap* soap, const int* offset, int dim)
{
    ...
    if (soap->version == 1) {
        (SOAP_SNPRINTF(soap->arrayOffset, sizeof(soap->arrayOffset) - 1, 20),
         "[%d",
         offset[0]);
        for (i = 1; i < dim; i++) {
            size_t l = strlen(soap->arrayOffset);
            (SOAP_SNPRINTF(
                 soap->arrayOffset + l, sizeof(soap->arrayOffset) - l - 1, 20),
             ",%d",
             offset[i]);
        }
...
SOAP_FMAC1
size_t SOAP_FMAC2 soap_size(const int* size, int dim)
{
    int    i;
    size_t n = 0;
    if (size[0] <= 0)
...
SOAP_FMAC1
size_t SOAP_FMAC2 soap_getsizes(const char* attr, int* size, int dim)
{
    size_t i, k, n;
    if (!*attr)
        return 0;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_getoffsets(const char* attr,
                               const int*  size,
                               int*        offset,
                               int         dim)
{
...
SOAP_FMAC1
struct soap_nlist* SOAP_FMAC2 soap_push_namespace(struct soap* soap,
                                                  const char*  id,
                                                  const char*  ns)
{
    ...
    if (i >= 0)
        k = 0;
    if (sizeof(struct soap_nlist) + n + k > n &&
        (SOAP_MAXALLOCSIZE <= 0 ||
         sizeof(struct soap_nlist) + n + k <= SOAP_MAXALLOCSIZE))
        np = (struct soap_nlist*)SOAP_MALLOC(soap,
                                             sizeof(struct soap_nlist) + n + k);
    if (!np) {
        soap->error = SOAP_EOM;
        return NULL;
    }
    ...
    if (i < 0) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Push NOT OK: no match found for '%s' in namespace "
                            "mapping table (added to stack anyway)\n",
                            ns));
    }
    else {
        np->ns = NULL;
...
void SOAP_FMAC2 soap_pop_namespace(struct soap* soap)
{
    ...
    for (np = soap->nlist; np && np->level >= soap->level; np = nq) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Pop namespace binding (level=%u) '%s' level=%u\n",
                            soap->level,
                            np->id,
                            np->level));
        SOAP_FREE(soap, np);
...
SOAP_FMAC1
int SOAP_FMAC2 soap_match_namespace(
    struct soap* soap, const char* id1, const char* id2, size_t n1, size_t n2)
{
    ...
    if (np) {
        if (!(soap->mode & SOAP_XML_IGNORENS) &&
            (n2 > 0 || !np->ns || *np->ns)) {
            if (np->index < 0 ||
                ((s = soap->local_namespaces[np->index].id) &&
                 (strncmp(s, id2, n2) || (s[n2] && s[n2] != '_'))))
                return SOAP_NAMESPACE;
        }
        return SOAP_OK;
    }
    if (n1 == 0)
        return n2 == 0 || (soap->mode & SOAP_XML_IGNORENS) ? SOAP_OK
                                                           : SOAP_NAMESPACE;
    if ((n1 == 3 && n1 == n2 && !strncmp(id1, "xml", 3) &&
         !strncmp(id1, id2, 3)) ||
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_current_namespace_tag(struct soap* soap,
                                                  const char*  tag)
{
    ...
    if (np) {
        ...
        if (np->ns) {
            ...
            do
                np = np->next;
            while (np &&
                   *np->id); /* find if there is any other default namespace */
            if (np)
                return soap_strdup(soap, s);
        }
    }
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_current_namespace_att(struct soap* soap,
                                                  const char*  tag)
{
    struct soap_nlist* np;
    const char*        s;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_match_tag(struct soap* soap,
                              const char*  tag1,
                              const char*  tag2)
{
    const char *s, *t;
    ...
    if (t) {
        if (s) {
            ...
            if (t != tag2 && !(soap->mode & SOAP_XML_IGNORENS)) {
                err =
                    soap_match_namespace(soap, tag1, tag2, s - tag1, t - tag2);
                if (err) {
                    DBGLOG(
                        TEST,
                        SOAP_MESSAGE(
            ...
            if ((soap->mode & SOAP_XML_IGNORENS) ||
                soap_match_namespace(soap, tag1, tag2, 0, t - tag2))
                return SOAP_TAG_MISMATCH;
        }
    ...
    if (s) {
        if (!(soap->mode & SOAP_XML_IGNORENS) ||
            SOAP_STRCMP(s + 1,
                        tag2)) /* always fails (except when ignoring ns) */
            return SOAP_TAG_MISMATCH;
    }
             ...
             ((soap->mode & SOAP_XML_STRICT) &&
              ...
              soap_match_namespace(
                  soap, tag1, tag2, 0, 0)) /* strict checking: default namespace
                                              must be null namespace */
#endif
    ) {
        return SOAP_TAG_MISMATCH;
    }
...
SOAP_FMAC1
int SOAP_FMAC2 soap_match_att(struct soap* soap,
                              const char*  tag1,
                              const char*  tag2)
{
    const char *s, *t;
...
int SOAP_FMAC2
#if defined(VXWORKS) && defined(WM_SECURE_KEY_STORAGE)
soap_ssl_server_context(struct soap*   soap,
...
#endif
{
    ...
    if (dhfile) {
        ...
        if (n >= 512 && s && *s == '\0')
            ...
            if (!fd)
                return soap_set_receiver_error(
                    soap, "SSL/TLS error", "Invalid DH file", SOAP_SSL_ERROR);
            dparams_len =
                (unsigned int)fread(dparams_buf, 1, sizeof(dparams_buf), fd);
            fclose(fd);
            gnutls_datum_t dparams = {dparams_buf, dparams_len};
            if (gnutls_dh_params_import_pkcs3(
                    soap->dh_params, &dparams, GNUTLS_X509_FMT_PEM))
                return soap_set_receiver_error(
                    soap, "SSL/TLS error", "Invalid DH file", SOAP_SSL_ERROR);
        }
    }
    ...
    if (!err) {
        if (sid)
            SSL_CTX_set_session_id_context(
                soap->ctx, (unsigned char*)sid, (unsigned int)strlen(sid));
        else
...
int SOAP_FMAC2
#if defined(VXWORKS) && defined(WM_SECURE_KEY_STORAGE)
soap_ssl_client_context(struct soap*   soap,
                        unsigned short flags,
                        const char*    keyfile,
                        const char*    keyid,
                        const char*    password,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_ssl_crl(struct soap* soap, const char* crlfile)
{
#ifdef WITH_OPENSSL
    if (crlfile && soap->ctx) {
...
{
    /* Note: for multi-threaded applications, the main program should call
     * soap_ssl_init() before any threads are started */
    if (!soap_ssl_init_done) {
        soap_ssl_init_done = 1;
#ifdef WITH_OPENSSL
#if OPENSSL_VERSION_NUMBER < 0x10100000L
        SSL_library_init();
        OpenSSL_add_all_algorithms(); /* we keep ciphers and digests for the
                                         program's lifetime */
#ifndef WITH_LEAN
...
#endif
        {
            /* if /dev/urandom does not exist we need to do at least some
            ...
            do {
#ifdef HAVE_RANDOM
                long r = random(); /* we actually do no use random() anywhere,
                                      except to further seed the OpenSSL PRNG */
                RAND_seed(&r, sizeof(long));
#else
                int r = rand(); /* we actually do no use rand() anywhere, except
                                   when random() is not available and to further
...
#if defined(WITH_OPENSSL) || defined(WITH_GNUTLS)
SOAP_FMAC1
void SOAP_FMAC2 soap_ssl_noinit()
{
    /* Call this first to bypass SSL init is SSL is already initialized
     * elsewhere */
    soap_ssl_init_done = 1;
}
#endif
...
#if defined(WITH_OPENSSL) || defined(WITH_GNUTLS)
SOAP_FMAC1
const char* SOAP_FMAC2 soap_ssl_error(struct soap* soap, int ret, int err)
{
#ifdef WITH_OPENSSL
    const char* msg = soap_code_str(h_ssl_error_codes, err);
    if (!msg)
        return ERR_error_string(err, soap->msgbuf);
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(msg) + 1),
     "%s\n",
     msg);
    if (ERR_peek_error()) {
        unsigned long r;
        while ((r = ERR_get_error())) {
            ...
            if (ERR_GET_REASON(r) == SSL_R_CERTIFICATE_VERIFY_FAILED &&
                l < sizeof(soap->msgbuf)) {
                const char* s = X509_verify_cert_error_string(
                    SSL_get_verify_result(soap->ssl));
                (SOAP_SNPRINTF(
                     soap->msgbuf + l, sizeof(soap->msgbuf) - l, strlen(s)),
                 "%s",
                 s);
            }
        }
        ...
        case 0:
            soap_strcpy(
                soap->msgbuf + l,
                sizeof(soap->msgbuf) - l,
                "EOF was observed that violates the SSL/TLS protocol. The "
                "client probably provided invalid authentication information.");
            break;
        case -1: {
            const char* s = strerror(soap_errno);
            (SOAP_SNPRINTF(
                 soap->msgbuf + l, sizeof(soap->msgbuf) - l, strlen(s) + 42),
             "Error observed by underlying SSL/TLS BIO: %s",
             s);
        } break;
        }
    }
...
static int ssl_auth_init(struct soap* soap)
{
    ...
    if (!soap->ctx) {
#if OPENSSL_VERSION_NUMBER >= 0x10100000L
        /* TLS_method: a TLS/SSL connection established may understand the
         * SSLv3, TLSv1, TLSv1.1 and TLSv1.2 protocols. */
        soap->ctx = SSL_CTX_new(TLS_method());
#else
        /* SSLv23_method: a TLS/SSL connection established may understand the
         * SSLv3, TLSv1, TLSv1.1 and TLSv1.2 protocols. */
        soap->ctx = SSL_CTX_new(SSLv23_method());
#endif
        if (!soap->ctx)
            return soap_set_receiver_error(
                soap, "SSL/TLS error", "Can't setup context", SOAP_SSL_ERROR);
    ...
    if (soap->randfile) {
        if (!RAND_load_file(soap->randfile, -1))
            return soap_set_receiver_error(
                soap, "SSL/TLS error", "Can't load randomness", SOAP_SSL_ERROR);
    }
    if (soap->cafile || soap->capath) {
        if (!SSL_CTX_load_verify_locations(
                soap->ctx, soap->cafile, soap->capath))
            return soap_set_receiver_error(soap,
                                           "SSL/TLS error",
                                           "Can't read CA PEM file",
                                           SOAP_SSL_ERROR);
        if (soap->cafile &&
            (soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION))
            SSL_CTX_set_client_CA_list(soap->ctx,
                                       SSL_load_client_CA_file(soap->cafile));
    }
    if (!(soap->ssl_flags & SOAP_SSL_NO_DEFAULT_CA_PATH)) {
        if (!SSL_CTX_set_default_verify_paths(soap->ctx))
            return soap_set_receiver_error(
                soap,
                "SSL/TLS error",
                "Can't read default CA PEM file and/or directory",
                SOAP_SSL_ERROR);
    }
    if (soap->crlfile) {
...
/* This code assumes a typical scenario with key and cert in one PEM file, see
 * alternative code below */
    ...
    if (soap->keyfile) {
        if (!SSL_CTX_use_certificate_chain_file(soap->ctx, soap->keyfile))
            return soap_set_receiver_error(
                soap,
                "SSL/TLS error",
                "Can't find or read certificate in private key PEM file",
                SOAP_SSL_ERROR);
        if (soap->password) {
            SSL_CTX_set_default_passwd_cb_userdata(soap->ctx,
                                                   (void*)soap->password);
            SSL_CTX_set_default_passwd_cb(soap->ctx, ssl_password);
        }
#ifndef WM_SECURE_KEY_STORAGE
        if (!SSL_CTX_use_PrivateKey_file(
                soap->ctx, soap->keyfile, SSL_FILETYPE_PEM))
            return soap_set_receiver_error(soap,
                                           "SSL/TLS error",
                                           "Can't read private key PEM file",
                                           SOAP_SSL_ERROR);
#endif
    }
#else
    /* Suggested alternative approach to check the key file for cert only when
     * cafile==NULL */
    if (soap->password) {
        SSL_CTX_set_default_passwd_cb_userdata(soap->ctx,
                                               (void*)soap->password);
    ...
    if (!pkey)
        return soap_set_receiver_error(
            soap, "SSL error", "Can't find key", SOAP_SSL_ERROR);
    if (!SSL_CTX_use_PrivateKey(soap->ctx, pkey))
        return soap_set_receiver_error(
            soap, "SSL error", "Can't read key", SOAP_SSL_ERROR);
#endif
    if ((soap->ssl_flags & SOAP_SSL_RSA)) {
        ...
        if (SSL_CTX_need_tmp_RSA(soap->ctx)) {
            ...
            BIGNUM*       bne = BN_new();
            RSA*          rsa = RSA_new();
            if (!bne || !rsa || !BN_set_word(bne, e) ||
                !RSA_generate_key_ex(rsa, SOAP_SSL_RSA_BITS, bne, NULL) ||
        ...
        if (n >= 512 && s && *s == '\0') {
            ...
            if (!bio)
                return soap_set_receiver_error(soap,
                                               "SSL/TLS error",
                                               "Can't read DH PEM file",
                                               SOAP_SSL_ERROR);
            dh = PEM_read_bio_DHparams(bio, NULL, NULL, NULL);
            BIO_free(bio);
        }
        if (!dh || DH_check(dh, &n) != 1 ||
            SSL_CTX_set_tmp_dh(soap->ctx, dh) < 0) {
            if (dh)
                DH_free(dh);
            return soap_set_receiver_error(soap,
                                           "SSL/TLS error",
                                           "Can't set DH parameters",
                                           SOAP_SSL_ERROR);
        }
        DH_free(dh);
    }
    /* enable all TSLv1 protocols and disable SSLv3 by default if no SSL/TLS
     * flags are set */
    ...
    if (!soap_ssl_init_done)
        soap_ssl_init();
    if (!soap->xcred) {
        if (gnutls_certificate_allocate_credentials(&soap->xcred) !=
            GNUTLS_E_SUCCESS)
            return soap_set_receiver_error(
                soap,
                "SSL/TLS error",
                "Can't allocate credentials or trust",
                SOAP_SSL_ERROR);
#if GNUTLS_VERSION_NUMBER >= 0x030300
        ...
        if (soap->cafile) {
            if (gnutls_certificate_set_x509_trust_file(
                    soap->xcred, soap->cafile, GNUTLS_X509_FMT_PEM) < 0)
                return soap_set_receiver_error(soap,
                                               "SSL/TLS error",
                                               "Can't read CA PEM file",
                                               SOAP_SSL_ERROR);
        ...
        if (soap->keyfile) {
            if (gnutls_certificate_set_x509_key_file2(
                    ...
                    GNUTLS_X509_FMT_PEM,
                    soap->password,
                    GNUTLS_PKCS_PKCS12_3DES | GNUTLS_PKCS_PKCS12_ARCFOUR |
                        GNUTLS_PKCS_PKCS12_RC2_40 | GNUTLS_PKCS_PBES2_AES_128 |
                        GNUTLS_PKCS_PBES2_AES_192 | GNUTLS_PKCS_PBES2_AES_256 |
                        GNUTLS_PKCS_PBES2_DES) <
                0) /* Assumes that key and cert(s) are concatenated in the
                      keyfile and the key is encrypted with one of these
                      algorithms */
                return soap_set_receiver_error(
                    soap,
                    "SSL/TLS error",
    ...
    if ((soap->ssl_flags & SOAP_SSL_CLIENT)) {
        ...
        if (soap->cafile || soap->crlfile || soap->keyfile) {
            ret =
                gnutls_priority_set_direct(soap->session, "PERFORMANCE", NULL);
            if (ret != GNUTLS_E_SUCCESS)
                return soap_set_receiver_error(soap,
                                               soap_ssl_error(soap, ret, 0),
                                               "SSL/TLS set priority error",
                                               SOAP_SSL_ERROR);
            gnutls_credentials_set(
                soap->session, GNUTLS_CRD_CERTIFICATE, soap->xcred);
        }
        else {
            if (!soap->acred)
                gnutls_anon_allocate_client_credentials(&soap->acred);
            ret = gnutls_priority_set_direct(
                soap->session, "PERFORMANCE:+ANON-DH:!ARCFOUR-128", NULL);
            if (ret != GNUTLS_E_SUCCESS)
                return soap_set_receiver_error(soap,
                                               soap_ssl_error(soap, ret, 0),
                                               "SSL/TLS set priority error",
        ...
        return soap_set_receiver_error(
            soap,
            "SSL/TLS error",
            "No key file: anonymous server authentication not supported in "
            "this release",
            SOAP_SSL_ERROR);
    }
    else {
        ...
        if ((soap->ssl_flags & SOAP_SSL_RSA) && soap->rsa_params)
            gnutls_certificate_set_rsa_export_params(soap->xcred,
                                                     soap->rsa_params);
#endif
        ...
        gnutls_credentials_set(
            soap->session, GNUTLS_CRD_CERTIFICATE, soap->xcred);
        if ((soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION))
            gnutls_certificate_server_set_request(soap->session,
                                                  GNUTLS_CERT_REQUEST);
        ...
        if (gnutls_protocol_set_priority(soap->session, protocol_priority) !=
            GNUTLS_E_SUCCESS)
            return soap_set_receiver_error(
                soap, "SSL/TLS error", "Can't set protocol", SOAP_SSL_ERROR);
#else
        ...
        if (gnutls_priority_set_direct(soap->session, soap->tmpbuf, NULL) !=
            GNUTLS_E_SUCCESS)
            return soap_set_receiver_error(soap,
                                           "SSL/TLS error",
                                           "Can't set protocol priority",
                                           SOAP_SSL_ERROR);
#endif
    }
#endif
    ...
    if (!soap->ctx) {
        ...
        if (err == GSK_OK)
            err = gsk_attribute_set_enum(
                soap->ctx, GSK_PROTOCOL_SSLV2, GSK_PROTOCOL_SSLV2_OFF);
        /* enable all TSLv1 protocols and disable SSLv3 by default if no SSL/TLS
         * flags are set */
        if ((soap->ssl_flags & SOAP_SSLv3_TLSv1) == 0)
            soap->ssl_flags |= SOAP_TLSv1;
        if (err == GSK_OK) {
            if ((soap->ssl_flags & SOAP_SSLv3))
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_SSLV3, GSK_PROTOCOL_SSLV3_ON);
            else
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_SSLV3, GSK_PROTOCOL_SSLV3_OFF);
        }
        if (err == GSK_OK) {
            if ((soap->ssl_flags & SOAP_TLSv1_0))
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_ON);
            else
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_OFF);
        }
        if (err == GSK_OK) {
            if ((soap->ssl_flags & SOAP_TLSv1_1))
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_1_ON);
            else
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_1_OFF);
        }
        if (err == GSK_OK) {
            if ((soap->ssl_flags & SOAP_TLSv1_2))
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_2_ON);
            else
                err = gsk_attribute_set_enum(
                    soap->ctx, GSK_PROTOCOL_TLSV1, GSK_PROTOCOL_TLSV1_2_OFF);
        }
        if (err == GSK_OK)
            err = gsk_attribute_set_buffer(
                soap->ctx,
                GSK_KEYRING_FILE,
                soap->keyfile,
                0); /* keyfile is a keyring .kdb file */
        if (err == GSK_OK)
            err = gsk_attribute_set_buffer(soap->ctx,
                                           GSK_KEYRING_PW,
                                           soap->password,
                                           0); /* locked by password */
        if (err == GSK_OK)
        ...
        if (err != GSK_OK)
            return soap_set_receiver_error(
                soap,
                gsk_strerror(err),
                "SYSTEM SSL error in ssl_auth_init()",
                SOAP_SSL_ERROR);
    }
#endif
    return SOAP_OK;
...
static int ssl_verify_callback(int ok, X509_STORE_CTX* store)
{
    ...
    if (!ok) {
        ...
        fprintf(stderr,
                "\nDEBUG mode TLS/SSL warnings:\nSSL verify error %d or "
                "warning with certificate at depth %d: %s\n",
                err,
        ...
        case X509_V_ERR_CRL_HAS_EXPIRED:
            ...
            ok = 1;
            fprintf(stderr,
                    "Initialize soap_ssl_client_context with "
                    "SOAP_SSL_ALLOW_EXPIRED_CERTIFICATE to allow this "
                    "verification error to pass without DEBUG mode enabled\n");
        }
    }
#endif
    /* Note: return 1 to try to continue, but unsafe progress will be terminated
     * by OpenSSL */
    return ok;
}
#endif
...
#ifdef WITH_OPENSSL
static int ssl_verify_callback_allow_expired_certificate(int             ok,
                                                         X509_STORE_CTX* store)
{
    ok = ssl_verify_callback(ok, store);
    if (!ok) {
        /* accept self signed certificates, expired certificates, and
         * certficiates w/o CRL */
    ...
    if (r < 0)
        ...
        if (gnutls_x509_crt_init(&cert) < 0)
            err = "Could not get X509 certificates";
                      ...
                      soap->session, &cert_list_size)) == NULL)
            err = "Could not get X509 certificates";
        else if (gnutls_x509_crt_import(
                     cert, &cert_list[0], GNUTLS_X509_FMT_DER) < 0)
            err = "Error parsing X509 certificate";
        else if (!(soap->ssl_flags & SOAP_SSL_ALLOW_EXPIRED_CERTIFICATE) &&
                 gnutls_x509_crt_get_expiration_time(cert) < time(NULL))
            err = "The certificate has expired";
        else if (!(soap->ssl_flags & SOAP_SSL_ALLOW_EXPIRED_CERTIFICATE) &&
                 gnutls_x509_crt_get_activation_time(cert) > time(NULL))
...
int SOAP_FMAC2 soap_ssl_accept(struct soap* soap)
{
    ...
    if (!soap->ssl) {
        ...
        if (!soap->ssl) {
            ...
            return soap_set_receiver_error(
                soap,
                "SSL/TLS error",
                "SSL_new() failed in soap_ssl_accept()",
                SOAP_SSL_ERROR);
        }
    }
    else {
    ...
    if (soap->recv_timeout || soap->send_timeout) {
        int t = soap->recv_timeout > soap->send_timeout ? soap->recv_timeout
                                                        : soap->send_timeout;
        if (t > 0)
            retries = 10 * t;
        else if (t > -100000)
    ...
    while ((r = SSL_accept(soap->ssl)) <= 0) {
        err = SSL_get_error(soap->ssl, r);
        if (err == SSL_ERROR_WANT_ACCEPT || err == SSL_ERROR_WANT_READ ||
            err == SSL_ERROR_WANT_WRITE) {
    ...
    if ((soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION)) {
        ...
        if ((err = SSL_get_verify_result(soap->ssl)) != X509_V_OK) {
            soap_closesock(soap);
            return soap_set_sender_error(
                soap,
                X509_verify_cert_error_string(err),
                "SSL certificate presented by peer cannot be verified in "
                "soap_ssl_accept()",
                SOAP_SSL_ERROR);
        }
        ...
        if (!peer) {
            soap_closesock(soap);
            return soap_set_sender_error(soap,
                                         "SSL/TLS error",
                                         "No SSL certificate was presented by "
                                         "the peer in soap_ssl_accept()",
                                         SOAP_SSL_ERROR);
        }
        X509_free(peer);
    }
    ...
    if ((soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION)) {
        ...
        if (err) {
            soap_closesock(soap);
            return soap_set_receiver_error(
                soap, "SSL/TLS error", err, SOAP_SSL_ERROR);
        }
    }
#endif
#ifdef WITH_SYSTEMSSL
    ...
    if (r == GSK_OK)
        r = gsk_attribute_set_buffer(
            soap->ssl, GSK_KEYRING_LABEL, soap->cafile, 0);
    if (r == GSK_OK)
        r = gsk_attribute_set_enum(
            soap->ssl, GSK_SESSION_TYPE, GSK_SERVER_SESSION);
    if (r == GSK_OK)
        r = gsk_attribute_set_buffer(
            soap->ssl, GSK_V3_CIPHER_SPECS_EXPANDED, "0035002F000A", 0);
    if (r == GSK_OK)
        r = gsk_attribute_set_enum(
            soap->ssl, GSK_V3_CIPHERS, GSK_V3_CIPHERS_CHAR4);
    if (r == GSK_OK)
        r = gsk_attribute_set_callback(soap->ssl, GSK_IO_CALLBACK, &local_io);
    if (r != GSK_OK)
        return soap_set_receiver_error(soap,
                                       gsk_strerror(r),
                                       "SYSTEM SSL error in soap_ssl_accept()",
                                       SOAP_SSL_ERROR);
    ...
    if (r != GSK_OK) {
        soap_set_receiver_error(
            soap,
            gsk_strerror(r),
            "gsk_secure_socket_init() failed in soap_ssl_accept()",
            SOAP_SSL_ERROR);
        return soap_closesock(soap);
    }
#endif
...
#endif
        {
            (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), 37),
             "TCP/UDP IP error %d",
             soap->errnum);
            msg = soap->msgbuf;
        }
...
#if !defined(WITH_IPV6) || defined(WITH_COOKIES)
#ifndef WITH_NOIO
static int tcp_gethostbyname(struct soap*    soap,
                             const char*     addr,
                             struct hostent* hostent,
                             struct in_addr* inaddr)
{
    ...
    (!_GNU_SOURCE && !defined(_POSIX_C_SOURCE) && !defined(_XOPEN_SOURCE)) ||  \
    _POSIX_C_SOURCE >= 200112L || _XOPEN_SOURCE >= 600 ||                      \
    defined(__ANDROID__) || defined(FREEBSD) || defined(__FreeBSD__)) &&       \
    defined(HAVE_GETHOSTBYNAME_R)
    int    r;
    ...
    defined(__ANDROID__) || defined(FREEBSD) || defined(__FreeBSD__)) &&       \
    defined(HAVE_GETHOSTBYNAME_R)
    while ((r = gethostbyname_r(
                addr, hostent, tmpbuf, tmplen, &hostent, &soap->errnum)) < 0) {
...
tcp_connect(struct soap* soap, const char* endpoint, const char* host, int port)
{
    ...
    if (soap_valid_socket(soap->socket)) {
        if ((soap->omode & SOAP_IO_UDP) && soap->socket == soap->master) {
            ...
            if (soap_memcpy((void*)&soap->peer.storage,
                            sizeof(soap->peer.storage),
                            (const void*)res->ai_addr,
                            res->ai_addrlen)) {
                soap->error = SOAP_EOM;
                soap->fclosesocket(soap, soap->socket);
                freeaddrinfo(res);
...
#define IP_MULTICAST_IF 2
    ...
    if (soap->proxy_host)
        err = getaddrinfo(
            soap->proxy_host, soap_int2s(soap, soap->proxy_port), &hints, &res);
    else
        err = getaddrinfo(host, soap_int2s(soap, port), &hints, &res);
    if (err || !res) {
        soap_set_receiver_error(soap,
...
again:
    ...
    if ((soap->keep_alive || soap->tcp_keep_alive) &&
        setsockopt(sk, SOL_SOCKET, SO_KEEPALIVE, (char*)&set, sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
#endif
    ...
    if (soap->sndbuf > 0 &&
        setsockopt(
            sk, SOL_SOCKET, SO_SNDBUF, (char*)&soap->sndbuf, sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
#endif
    ...
    if (soap->rcvbuf > 0 &&
        setsockopt(
            sk, SOL_SOCKET, SO_RCVBUF, (char*)&soap->rcvbuf, sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
#endif
...
#ifdef TCP_KEEPIDLE
    if (soap->tcp_keep_idle && setsockopt(sk,
                                          IPPROTO_TCP,
                                          TCP_KEEPIDLE,
                                          (char*)&(soap->tcp_keep_idle),
                                          sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
...
#endif
#ifdef TCP_KEEPINTVL
    if (soap->tcp_keep_intvl && setsockopt(sk,
                                           IPPROTO_TCP,
                                           TCP_KEEPINTVL,
                                           (char*)&(soap->tcp_keep_intvl),
                                           sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
...
#endif
#ifdef TCP_KEEPCNT
    if (soap->tcp_keep_cnt && setsockopt(sk,
                                         IPPROTO_TCP,
                                         TCP_KEEPCNT,
                                         (char*)&(soap->tcp_keep_cnt),
                                         sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
...
#ifdef TCP_NODELAY
    if (!(soap->omode & SOAP_IO_UDP) &&
        setsockopt(sk, IPPROTO_TCP, TCP_NODELAY, (char*)&set, sizeof(int))) {
        soap->errnum = soap_socket_errno;
#ifdef WITH_IPV6
        freeaddrinfo(ressave);
#endif
...
#define IP_MULTICAST_IF 2
    ...
    if (soap->client_addr) {
        ...
        if (inet_pton(AF_INET, soap->client_addr, (void*)&addr.sin_addr) != 1 ||
            bind(sk, (struct sockaddr*)&addr, sizeof(addr))) {
            soap->errnum = soap_socket_errno;
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Could not bind before connect\n"));
            soap_set_receiver_error(soap,
                                    tcp_error(soap),
        ...
        soap->client_addr = NULL; /* disable bind before connect, so need to set
                                     it again before the next connect */
        soap->client_port = -1;   /* disable bind before connect, so need to set
                                     it again before the next connect */
    }
    else
#endif
    ...
    if (soap->client_interface) {
        if (inet_pton(AF_INET,
                      ...
                      &soap->peer.in.sin_addr) != 1) {
            soap->errnum = soap_socket_errno;
            soap_set_receiver_error(soap,
                                    tcp_error(soap),
                                    "inet_pton() failed in tcp_connect()",
                                    SOAP_TCP_ERROR);
            soap->fclosesocket(soap, sk);
        ...
        soap->client_interface =
            NULL; /* disable client interface, so need to set it again before
                     the next connect */
    }
#endif
    soap->errmode = 2;
    ...
    if (soap->client_addr) {
        ...
        if ((soap->client_addr_ipv6 && res->ai_family == AF_INET6 &&
             inet_pton(AF_INET6,
                       soap->client_addr_ipv6,
                       (void*)&addr.sin6_addr.s6_addr) == 1) ||
            (!soap->client_addr_ipv6 &&
             inet_pton(AF_INET6,
                       soap->client_addr,
                       (void*)&addr.sin6_addr.s6_addr) == 1)) {
        ...
        else /* not an IPv6 address, must be IPv4 */
        {
            ...
            if (soap->client_port >= 0)
                addr.sin_port = htons(soap->client_port);
            if (inet_pton(AF_INET, soap->client_addr, (void*)&addr.sin_addr) !=
                    1 ||
                bind(sk, (struct sockaddr*)&addr, sizeof(addr))) {
                soap->errnum = soap_socket_errno;
                freeaddrinfo(ressave);
        ...
        soap->client_addr = NULL; /* disable bind before connect, so need to set
                                     it again before the next connect */
        soap->client_addr_ipv6 =
            NULL; /* disable bind before connect, so need to set it again before
                     the next connect */
        soap->client_port = -1; /* disable bind before connect, so need to set
                                   it again before the next connect */
    }
...
#endif
        {
            ...
            if (err == SOAP_EADDRINUSE) {
                ...
                for (;;) {
                    ...
                    r = tcp_select(soap,
                                   sk,
                                   SOAP_TCP_SELECT_SND | SOAP_TCP_SELECT_PIP,
...
#else
                    r = tcp_select(
                        soap, sk, SOAP_TCP_SELECT_SND, soap->connect_timeout);
#endif
                    if (r > 0)
                        break;
                    if (!r) {
                ...
                if (!getsockopt(
                        sk, SOL_SOCKET, SO_ERROR, (char*)&soap->errnum, &k) &&
                    !soap->errnum) /* portability note: see SOAP_SOCKLEN_T
                                      definition in stdsoap2.h */
                    break;
                DBGLOG(TEST,
    ...
    if (endpoint && !soap_tag_cmp(endpoint, "https:*")) {
        ...
        if (soap->proxy_host) {
            ...
            const char* http_content =
                soap->http_content; /* save http_content when set */
            const char* http_extra_header =
                soap->http_extra_header; /* save http_extra_header when set */
            ...
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                "Connecting to %s proxy server %s for "
            ...
            if (soap->ntlm_challenge &&
                soap_ntlm_handshake(soap, SOAP_CONNECT, endpoint, host, port)) {
                soap->fclosesocket(soap, sk);
                return soap->socket = SOAP_INVALID_SOCKET;
            }
#endif
            ...
            if (endpoint)
                soap_strcpy(soap->endpoint,
                            sizeof(soap->endpoint),
                            endpoint); /* restore */
            soap->mode = m;
        }
#ifdef WITH_OPENSSL
        ...
        if (!soap->ctx && (soap->error = soap->fsslauth(soap)) != SOAP_OK) {
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "SSL required, but no ctx set\n"));
            soap->fclosesocket(soap, sk);
        ...
        if (!(soap->ssl_flags & SOAP_SSLv3) &&
            !SSL_set_tlsext_host_name(soap->ssl, host)) {
            soap_set_receiver_error(
                soap, "SSL/TLS error", "SNI failed", SOAP_SSL_ERROR);
            soap->fclosesocket(soap, sk);
            return soap->socket = SOAP_INVALID_SOCKET;
        }
#elif (OPENSSL_VERSION_NUMBER >= 0x0090800fL) &&                               \
    defined(SSL_CTRL_SET_TLSEXT_HOSTNAME)
        if (!SSL_ctrl(soap->ssl,
        ...
        if (soap->connect_timeout || soap->recv_timeout || soap->send_timeout) {
            ...
            int t = soap->recv_timeout > soap->send_timeout
                        ? soap->recv_timeout
                        : soap->send_timeout;
            ...
            if ((r = SSL_connect(soap->ssl)) <= 0) {
                ...
                if (err == SSL_ERROR_WANT_CONNECT ||
                    ...
                    if (s == 0 && retries-- <= 0) {
                        DBGLOG(
                            TEST,
                            SOAP_MESSAGE(fdebug, "SSL/TLS connect timeout\n"));
                        soap_set_receiver_error(
                            soap,
                            "Timeout",
                            "SSL_connect() failed in tcp_connect()",
                            SOAP_TCP_ERROR);
                        soap->fclosesocket(soap, sk);
                        return soap->socket = SOAP_INVALID_SOCKET;
                    }
        ...
        if ((soap->ssl_flags & SOAP_SSL_REQUIRE_SERVER_AUTHENTICATION)) {
            if ((err = SSL_get_verify_result(soap->ssl)) != X509_V_OK) {
                soap_set_sender_error(soap,
                                      X509_verify_cert_error_string(err),
                                      "SSL/TLS certificate presented by peer "
                                      "cannot be verified in tcp_connect()",
                                      SOAP_SSL_ERROR);
                soap->fclosesocket(soap, sk);
                return soap->socket = SOAP_INVALID_SOCKET;
            }
            if (!(soap->ssl_flags & SOAP_SSL_SKIP_HOST_CHECK)) {
                ...
                if (!peer) {
                    soap_set_sender_error(
                        soap,
                        "SSL/TLS error",
                        "No SSL/TLS certificate was presented by the peer in "
                        "tcp_connect()",
                        SOAP_SSL_ERROR);
                    soap->fclosesocket(soap, sk);
                    return soap->socket = SOAP_INVALID_SOCKET;
                                    ...
                                    for (j = 0; j < sk_CONF_VALUE_num(val);
                                        ...
                                        if (nval &&
                                            ...
                                            DBGLOG(
                                                ...
                                                SOAP_MESSAGE(
                                                    fdebug,
                                                    "SSL: host name %s match "
                                                    "with certificate %s %s\n",
                                                    host,
                                                    nval->name,
                                                    nval->value));
                                            break;
                ...
                names = (GENERAL_NAMES*)X509_get_ext_d2i(
                    peer, NID_subject_alt_name, NULL, NULL);
                if (names) {
...
#else
                            const char* tmp =
                                (const char*)ASN1_STRING_get0_data(name);
#endif
                ...
                if (!ok) {
                    soap_set_sender_error(soap,
                                          "SSL/TLS error",
                                          "SSL/TLS certificate host name "
                                          "mismatch in tcp_connect()",
                                          SOAP_SSL_ERROR);
                    soap->fclosesocket(soap, sk);
                    return soap->socket = SOAP_INVALID_SOCKET;
                }
        ...
        gnutls_transport_set_ptr(soap->session,
                                 (gnutls_transport_ptr_t)(long)sk);
        if (soap->connect_timeout || soap->recv_timeout || soap->send_timeout) {
            /* Set SSL connect timeout and set SSL sockets to non-blocking */
            int t = soap->recv_timeout > soap->send_timeout
                        ? soap->recv_timeout
        ...
        if ((soap->ssl_flags & SOAP_SSL_REQUIRE_SERVER_AUTHENTICATION)) {
            ...
            if (s) {
                soap->fclosesocket(soap, sk);
                soap->error = soap_set_sender_error(
                    soap, "SSL/TLS verify error", s, SOAP_SSL_ERROR);
                return soap->socket = SOAP_INVALID_SOCKET;
            }
        }
#endif
        ...
        if (r == GSK_OK)
            r = gsk_attribute_set_numeric_value(soap->ssl, GSK_FD, sk);
        if (r == GSK_OK)
            r = gsk_attribute_set_buffer(soap->ssl,
                                         GSK_KEYRING_LABEL,
                                         soap->cafile,
                                         0); /* Certificate label */
        if (r == GSK_OK)
            r = gsk_attribute_set_enum(
                soap->ssl, GSK_SESSION_TYPE, GSK_CLIENT_SESSION);
        if (r == GSK_OK)
            r = gsk_attribute_set_buffer(
                soap->ssl, GSK_V3_CIPHER_SPECS_EXPANDED, "0035002F000A", 0);
        if (r == GSK_OK)
            r = gsk_attribute_set_enum(
                soap->ssl, GSK_V3_CIPHERS, GSK_V3_CIPHERS_CHAR4);
        if (r == GSK_OK)
            r = gsk_attribute_set_callback(
                soap->ssl, GSK_IO_CALLBACK, &local_io);
        if (r != GSK_OK) {
            soap_set_receiver_error(soap,
                                    gsk_strerror(r),
                                    "SYSTEM SSL error in tcp_connect()",
                                    SOAP_SSL_ERROR);
            return soap->socket = SOAP_INVALID_SOCKET;
        }
        /* Try connecting until success or timeout */
...
#ifndef WITH_NOIO
static int tcp_select(struct soap* soap, SOAP_SOCKET sk, int flags, int timeout)
{
    int            r;
    struct timeval tv;
...
#endif
            if (r < 0 && (soap->errnum = soap_socket_errno) == SOAP_EINTR &&
                eintr > 0) {
                eintr--;
                r = 0;
            }
                ...
                for (;;) {
                    if (read(soap->pipe_fd[0], &ch, 1) == -1) {
                        if (soap_socket_errno == SOAP_EAGAIN)
                            break;
                        DBGLOG(TEST,
                               SOAP_MESSAGE(fdebug, "Self pipe read error\n"));
                        return -1;
                    }
                }
...
#ifdef WITH_SELF_PIPE
        r = select((int)(sk > soap->pipe_fd[0] ? sk : soap->pipe_fd[0]) + 1,
                   rfd,
                   sfd,
                   efd,
                   &tv);
...
tcp_accept(struct soap* soap, SOAP_SOCKET sk, struct sockaddr* addr, int* len)
{
    ...
    (void)soap;
    s = accept(
        sk, addr, (SOAP_SOCKLEN_T*)len); /* portability note: see SOAP_SOCKLEN_T
                                            definition in stdsoap2.h */
#ifdef WITH_SOCKET_CLOSE_ON_EXIT
#ifdef WIN32
#ifndef UNDER_CE
...
static int tcp_disconnect(struct soap* soap)
{
    ...
    if (soap->ssl) {
        ...
        if (*soap->host) {
            ...
            if (soap->session) {
                soap_strcpy(
                    soap->session_host, sizeof(soap->session_host), soap->host);
        ...
        if (soap_valid_socket(soap->socket)) {
            ...
            if (r == 0 &&
                !soap->fshutdownsocket(soap, soap->socket, SOAP_SHUT_WR)) {
#if !defined(WITH_LEAN) && !defined(WIN32)
                /*
                   wait up to 5 seconds for close_notify to be sent by peer (if
                   peer not present, this avoids calling SSL_shutdown() which
                   has a lengthy return timeout)
                 */
                r = tcp_select(soap,
                               soap->socket,
                               SOAP_TCP_SELECT_RCV | SOAP_TCP_SELECT_ERR,
...
#ifndef WITH_NOIO
static int tcp_closesocket(struct soap* soap, SOAP_SOCKET sk)
{
    (void)soap;
...
#ifndef WITH_NOIO
static int tcp_shutdownsocket(struct soap* soap, SOAP_SOCKET sk, int how)
{
    (void)soap;
    DBGLOG(TEST,
...
soap_bind(struct soap* soap, const char* host, int port, int backlog)
{
...
#endif
#ifndef WITH_LEAN
    if (soap->bind_flags && setsockopt(soap->master,
                                       SOL_SOCKET,
                                       soap->bind_flags,
                                       (char*)&set,
                                       sizeof(int))) {
        ...
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "setsockopt failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
#ifndef UNDER_CE
    if (((soap->imode | soap->omode) & SOAP_IO_KEEPALIVE) &&
        (!((soap->imode | soap->omode) & SOAP_IO_UDP)) &&
        setsockopt(
            soap->master, SOL_SOCKET, SO_KEEPALIVE, (char*)&set, sizeof(int))) {
        soap->errnum = soap_socket_errno;
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "setsockopt SO_KEEPALIVE failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
    if (soap->sndbuf > 0 && setsockopt(soap->master,
                                       SOL_SOCKET,
                                       SO_SNDBUF,
                                       (char*)&soap->sndbuf,
                                       sizeof(int))) {
        ...
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "setsockopt SO_SNDBUF failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
    if (soap->rcvbuf > 0 && setsockopt(soap->master,
                                       SOL_SOCKET,
                                       SO_RCVBUF,
                                       (char*)&soap->rcvbuf,
                                       sizeof(int))) {
        ...
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "setsockopt SO_RCVBUF failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
#ifdef TCP_NODELAY
    if (!(soap->omode & SOAP_IO_UDP) &&
        setsockopt(
            soap->master, IPPROTO_TCP, TCP_NODELAY, (char*)&set, sizeof(int))) {
        soap->errnum = soap_socket_errno;
        soap_set_receiver_error(soap,
                                tcp_error(soap),
    ...
    if (res.ai_family == AF_INET6 &&
        setsockopt(soap->master,
                   IPPROTO_IPV6,
                   IPV6_V6ONLY,
                   soap->bind_v6only ? (char*)&set : (char*)&unset,
                   sizeof(int))) {
        soap->errnum = soap_socket_errno;
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "setsockopt IPV6_V6ONLY failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
    soap->errmode = 0;
    if (bind(soap->master, res.ai_addr, (int)res.ai_addrlen)) {
        soap->errnum = soap_socket_errno;
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "Could not bind to host, bind failed\n"));
        soap_closesock(soap);
        soap_set_receiver_error(soap,
                                tcp_error(soap),
                                "bind failed in soap_bind()",
                                SOAP_TCP_ERROR);
        return SOAP_INVALID_SOCKET;
    }
#else
    ...
    if (!(soap->omode & SOAP_IO_UDP) && listen(soap->master, backlog)) {
        soap->errnum = soap_socket_errno;
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "Could not bind to host, listen failed\n"));
        soap_closesock(soap);
        soap_set_receiver_error(soap,
                                tcp_error(soap),
...
int SOAP_FMAC2 soap_poll(struct soap* soap)
{
    ...
    if (soap_valid_socket(soap->socket)) {
        ...
        r = tcp_select(
            soap, soap->master, SOAP_TCP_SELECT_SND | SOAP_TCP_SELECT_ERR, 0);
    }
    else {
    ...
    if (r > 0) {
        ...
        if ((soap->imode & SOAP_ENC_SSL) && soap->ssl) {
            if (soap_valid_socket(soap->socket) && (r & SOAP_TCP_SELECT_SND) &&
                (!(r & SOAP_TCP_SELECT_RCV) ||
...
#ifndef WITH_NOIO
SOAP_FMAC1
int SOAP_FMAC2 soap_ready(struct soap* soap)
{
#ifndef WITH_LEAN
    int r;
    if (!soap_valid_socket(soap->socket))
        return SOAP_OK; /* OK when no socket! */
    r = tcp_select(
        soap, soap->socket, SOAP_TCP_SELECT_RCV | SOAP_TCP_SELECT_ERR, 0);
    if (r > 0 && (r & SOAP_TCP_SELECT_ERR))
        r = -1;
    if (r < 0 && soap_socket_errno != SOAP_EINTR)
        return soap_set_receiver_error(soap,
                                       tcp_error(soap),
                                       "select failed in soap_ready()",
                                       SOAP_TCP_ERROR);
    if (r > 0) {
        char t;
#ifdef WITH_OPENSSL
    ...
    for (;;) {
        ...
        if (soap_valid_socket(soap->socket)) {
            ...
            if (getaddrinfo(soap->host, NULL, &hints, &res) == 0 && res) {
                ...
                (void)soap_memcpy(
                    &result, sizeof(result), res->ai_addr, res->ai_addrlen);
                freeaddrinfo(res);
                if (result.ss_family == AF_INET6) {
                    ...
                    for (i = 0; i < 16; i++)
                        soap->ip6[i / 4] =
                            (soap->ip6[i / 4] << 8) + inaddr->s6_addr[i];
                }
            ...
            soap->ip6[2] = 0xFFFF;
            soap->ip6[3] = soap->ip;
            (SOAP_SNPRINTF(soap->host, sizeof(soap->host), 80),
             "%u.%u.%u.%u",
             (int)(soap->ip >> 24) & 0xFF,
             (int)(soap->ip >> 16) & 0xFF,
             (int)(soap->ip >> 8) & 0xFF,
             (int)soap->ip & 0xFF);
            soap->port =
                (int)ntohs(soap->peer.in.sin_port); /* does not return port
            ...
            if (soap->sndbuf > 0 && setsockopt(soap->socket,
                                               SOL_SOCKET,
                                               SO_SNDBUF,
                                               (char*)&soap->sndbuf,
                                               sizeof(int))) {
                ...
                soap_set_receiver_error(
                    soap,
                    tcp_error(soap),
                    "setsockopt SO_SNDBUF failed in soap_accept()",
                    SOAP_TCP_ERROR);
                soap_closesock(soap);
                return SOAP_INVALID_SOCKET;
            }
            if (soap->rcvbuf > 0 && setsockopt(soap->socket,
                                               SOL_SOCKET,
                                               SO_RCVBUF,
                                               (char*)&soap->rcvbuf,
                                               sizeof(int))) {
...
int SOAP_FMAC2 soap_closesock(struct soap* soap)
{
    ...
    if (err || status == SOAP_EOF || status == SOAP_TCP_ERROR ||
        status == SOAP_SSL_ERROR || !soap->keep_alive) {
        soap->keep_alive = 0;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_force_closesock(struct soap* soap)
{
    soap->keep_alive = 0;
...
#ifdef WITH_SELF_PIPE
SOAP_FMAC1
void SOAP_FMAC2 soap_close_connection(struct soap* soap)
{
    if (soap_valid_socket(soap->socket))
...
void SOAP_FMAC2 soap_done(struct soap* soap)
{
    ...
    if (soap->clist)
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug,
                         "Warning: managed C++ data was not deallocated with "
                         "soap_destroy() from the heap managed by context %p\n",
                         (void*)soap));
    if (soap->alist)
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Warning: managed C data was not deallocated with "
                            "soap_end() from the heap managed by context %p\n",
                            (void*)soap));
#endif
    soap->alist = NULL;
    while (soap->clist) {
    ...
    while (soap->plugins) {
        ...
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug, "Removing plugin '%s'\n", soap->plugins->id));
...
static int http_parse(struct soap* soap)
{
    ...
    int  err = SOAP_OK;
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Waiting for HTTP request/response...\n"));
    soap->fform     = NULL;
    *soap->endpoint = '\0';
    soap->bearer    = NULL;
#ifdef WITH_NTLM
    ...
    if (s && s[5] == '1' && s[6] == '.' && s[7] == '0') {
        ...
        if (soap->status == 0 &&
            (soap->omode & SOAP_IO) ==
                SOAP_IO_CHUNK) /* soap->status == 0 for HTTP request */
            soap->omode =
                (soap->omode & ~SOAP_IO) |
                SOAP_IO_STORE; /* HTTP 1.0 does not support chunked transfers */
    }
    DBGLOG(
        TEST,
        SOAP_MESSAGE(fdebug, "Keep alive connection = %d\n", soap->keep_alive));
    if (soap->status == 0) {
        size_t l = 0;
        if (s) {
        ...
        if (s && soap->status) {
            ...
            while (k > 0 && soap_coblank((soap_wchar)soap->msgbuf[l + k - 1]))
                k--;
            if (soap_strncpy(
                    soap->path, sizeof(soap->path), soap->msgbuf + l, k))
                return soap->error = 414;
            if (*soap->path && *soap->path != '/')
                r = soap_strncpy(
                    soap->endpoint, sizeof(soap->endpoint), soap->path, k);
            else
                r = soap_strncat(
                    soap->endpoint, sizeof(soap->endpoint), soap->path, k);
            if (r)
...
http_parse_header(struct soap* soap, const char* key, const char* val)
{
    if (!soap_tag_cmp(key, "Host")) {
        ...
        if (soap_strncat(soap->endpoint,
                         sizeof(soap->endpoint),
                         val,
                         sizeof(soap->endpoint) - 9))
        ...
        if (soap_http_header_attribute(soap, val, "application/dime"))
            ...
            const char* type;
            soap->mime.boundary = soap_strdup(
                soap, soap_http_header_attribute(soap, val, "boundary"));
            soap->mime.start = soap_strdup(
                soap, soap_http_header_attribute(soap, val, "start"));
...
#endif
            if (strchr(val, '*') ||
                soap_http_header_attribute(soap, val, "deflate"))
        ...
        if (!soap_tag_cmp(val, "close"))
            soap->keep_alive = 0;
             ...
             !soap_tag_cmp(key, "Proxy-Authorization")) {
#ifdef WITH_NTLM
        if (!soap_tag_cmp(val, "NTLM*")) {
            ...
            char* s;
            soap_base642s(
                soap, val + 6, soap->tmpbuf, sizeof(soap->tmpbuf) - 1, &n);
            soap->tmpbuf[n] = '\0';
            ...
            if (s) {
             ...
             !soap_tag_cmp(key, "Proxy-Authenticate")) {
#ifdef WITH_NTLM
        if (!soap_tag_cmp(val, "NTLM*"))
            soap->ntlm_challenge = soap_strdup(soap, val + 4);
        else
#endif
            soap->authrealm = soap_strdup(
                soap, soap_http_header_attribute(soap, val + 6, "realm"));
    }
    else if (!soap_tag_cmp(key, "Expect")) {
        if (!soap_tag_cmp(val, "100-continue")) {
            if ((soap->error = soap->fposthdr(
                     soap, "HTTP/1.1 100 Continue", NULL)) != SOAP_OK ||
...
#ifdef WITH_COOKIES
    else if (!soap_tag_cmp(key, "Cookie") || !soap_tag_cmp(key, "Cookie2") ||
...
#if !defined(WITH_NOHTTP) || !defined(WITH_LEANER)
SOAP_FMAC1
const char* SOAP_FMAC2 soap_http_header_attribute(struct soap* soap,
                                                  const char*  line,
                                                  const char*  key)
{
    const char* s = line;
...
#if !defined(WITH_NOHTTP) || !defined(WITH_LEANER)
SOAP_FMAC1
const char* SOAP_FMAC2 soap_decode_key(char* buf, size_t len, const char* val)
{
...
#ifndef WITH_NOHTTP
static int http_patch(struct soap* soap)
{
    (void)soap;
...
{
    if (soap->origin &&
        soap->cors_method) /* CORS Origin and Access-Control-Request-Method
                              headers */
    {
        soap->cors_origin =
            soap->cors_allow; /* modify this code or hook your own soap->fopt()
                                 callback with logic */
                     ...
                     ULONG64      count)
{
    ...
    if (!endpoint || (soap_tag_cmp(endpoint, "http:*") &&
                      soap_tag_cmp(endpoint, "https:*") &&
                      soap_tag_cmp(endpoint, "httpg:*")))
        return SOAP_OK;
    /* set l to prevent overruns ('host' and 'soap->host' are substrings of
     * 'endpoint') */
    l = strlen(endpoint) + strlen(soap->http_version) + 80;
    if (l > sizeof(soap->tmpbuf))
        return soap->error = SOAP_EOM;
    if (soap->status == SOAP_CONNECT)
        (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), l),
         "%s %s:%d HTTP/%s",
         s,
         soap->host,
         soap->port,
        ...
        if (soap->status == SOAP_OPTIONS) {
            err =
                soap->fposthdr(soap,
                               ...
                               soap->cors_method ? soap->cors_method : "POST");
            if (err)
                return err;
            if (soap->cors_header) {
                err = soap->fposthdr(
                    soap, "Access-Control-Request-Headers", soap->cors_header);
                if (err)
                    return err;
            }
        }
    ...
    if ((soap->imode & SOAP_ENC_MTOM)) {
        err = soap->fposthdr(
            soap, "Accept", "multipart/related,application/xop+xml,*/*;q=0.8");
        if (err)
            return err;
    }
#endif
    ...
    if (soap->bearer) {
        ...
        (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), l + 1),
         "Bearer %s",
         soap->bearer);
    ...
    if (soap->ntlm_challenge) {
        ...
        if (l) {
            (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), l + 5),
             "NTLM %s",
             soap->ntlm_challenge);
            if (soap->proxy_host) {
        ...
        if (soap->userid && soap->passwd) {
            ...
            (SOAP_SNPRINTF(soap->tmpbuf + 262,
                           sizeof(soap->tmpbuf) - 262,
                           strlen(soap->userid) + strlen(soap->passwd) + 1),
             "%s:%s",
             soap->userid,
             soap->passwd);
            soap_s2base64(soap,
    ...
    if (action && soap->status != SOAP_GET && soap->status != SOAP_DEL) {
        (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), strlen(action) + 2),
         "\"%s\"",
         action);
...
static int http_post_header(struct soap* soap, const char* key, const char* val)
{
    if (key) {
        if (http_send_header(soap, key))
            return soap->error;
        if (val &&
            (soap_send_raw(soap, ": ", 2) || http_send_header(soap, val)))
            return soap->error;
    }
...
#ifndef WITH_NOHTTP
static int http_response(struct soap* soap, int status, ULONG64 count)
{
    int         err;
    char        http[32];
    int         code = status;
    ...
    if (soap->rpmreqid || soap_valid_socket(soap->master) ||
        soap_valid_socket(soap->socket) || soap->recvfd != 0 ||
        soap->sendfd != 1 || soap->os) /* RPM behaves as if standalone */
#else
    if (soap_valid_socket(soap->master) || soap_valid_socket(soap->socket)
#ifndef UNDER_CE
        || soap->recvfd != 0 || soap->sendfd != 1
#else
        || soap->recvfd != stdin || soap->sendfd != stdout
#endif
        || soap->os) /* standalone server application (over sockets), not CGI
                        (over stdin/out) */
#endif
        (SOAP_SNPRINTF(http, sizeof(http), strlen(soap->http_version) + 5),
         "HTTP/%s",
         soap->http_version);
    else
    ...
    (SOAP_SNPRINTF(
         soap->tmpbuf, sizeof(soap->tmpbuf), sizeof(http) + 22 + strlen(line)),
     "%s %d %s",
     http,
     code,
     line);
...
#ifndef WITH_LEAN
    if (status == 401) {
        (SOAP_SNPRINTF_SAFE(soap->tmpbuf, sizeof(soap->tmpbuf)),
         "Basic realm=\"%s\"",
         (soap->authrealm &&
          strlen(soap->authrealm) + 14 < sizeof(soap->tmpbuf))
             ? soap->authrealm
             : "gSOAP Web Service");
    ...
    if (soap->cors_origin) {
        err = soap->fposthdr(
            soap, "Access-Control-Allow-Origin", soap->cors_origin);
        if (err)
            return err;
        ...
        if (soap->cors_methods) {
            err = soap->fposthdr(
                soap, "Access-Control-Allow-Methods", soap->cors_methods);
            if (err)
                return err;
            if (soap->cors_headers) {
                err = soap->fposthdr(
                    soap, "Access-Control-Allow-Headers", soap->cors_headers);
                if (err)
                    return err;
            }
        }
...
int SOAP_FMAC2 soap_response(struct soap* soap, int status)
{
    ULONG64 count;
    if (!(soap->omode &
          (SOAP_ENC_PLAIN | SOAP_IO_STORE /* this tests for chunking too */)) &&
        (status == SOAP_HTML ||
         (status >= SOAP_FILE && status < SOAP_FILE + 600)))
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_extend_url(struct soap* soap,
                                       const char*  s,
                                       const char*  t)
{
    if (s)
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_extend_url_query(struct soap* soap,
                                             const char*  s,
                                             const char*  t)
{
...
SOAP_FMAC1
void SOAP_FMAC2 soap_url_query(struct soap* soap, const char* s, const char* t)
{
    size_t n = strlen(s);
    if (n) {
        char*  r = soap->msgbuf;
        ...
        if (r) {
            ...
            (void)soap_memmove(r + m - 1,
                               soap->msgbuf + sizeof(soap->msgbuf) -
                                   (r + n + 1),
                               r + k + 1,
                               strlen(r + k + 1) + 1);
            if (m)
                (void)soap_memmove(
                    r - 1, soap->msgbuf + sizeof(soap->msgbuf) - (r - 1), t, m);
        }
        else {
            soap_strcat(soap->msgbuf, sizeof(soap->msgbuf), s);
            if (t) {
                int m = (int)strlen(
                    soap->msgbuf); /* msgbuf length is max SOAP_TMPLEN or just
                                      1024 bytes */
                (void)soap_encode_url(
                    t, soap->msgbuf + m, (int)sizeof(soap->msgbuf) - m);
            }
            soap_strcat(soap->msgbuf, sizeof(soap->msgbuf), "&");
        }
    }
...
SOAP_FMAC1
int SOAP_FMAC2 soap_encode_url(const char* s, char* t, int len)
{
    int c;
    int n = len;
    if (s && n > 0) {
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_encode_url_string(struct soap* soap, const char* s)
{
    if (s) {
...
SOAP_FMAC1
struct soap_cookie* SOAP_FMAC2 soap_cookie(struct soap* soap,
                                           const char*  name,
                                           const char*  domain,
                                           const char*  path)
{
...
SOAP_FMAC1
struct soap_cookie* SOAP_FMAC2 soap_cookie_env(struct soap* soap,
                                               const char*  name,
                                               const char*  domain,
                                               const char*  path,
                                               short        env)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "Search cookie='%s' domain='%s' path='%s' env=%hd\n",
                        name,
                        domain ? domain : "(null)",
                        path ? path : "(null)",
                        env));
    for (p = soap->cookies; p; p = p->next) {
        DBGLOG(
            ...
            SOAP_MESSAGE(
                ...
                p->path ? p->path : "(null)",
                p->env));
        if ((!env || p->env) && !strcmp(p->name, name) &&
            (!domain || (domain && p->domain && !strcmp(p->domain, domain))) &&
            (!path ||
             (path && p->path && !strncmp(p->path, path, strlen(p->path)))))
            break;
    }
    return p;
}
...
SOAP_FMAC1
struct soap_cookie* SOAP_FMAC2 soap_set_cookie(struct soap* soap,
                                               const char*  name,
                                               const char*  value,
                                               const char*  domain,
                                               const char*  path)
{
    ...
    if (!q) {
        ...
        if (q) {
            ...
            q->secure   = 0;
            q->modified = 0;
            for (p = &soap->cookies, n = soap->cookie_max; *p && n;
                 p = &(*p)->next, n--)
                if (!strcmp((*p)->name, name) && (*p)->path && path &&
...
SOAP_FMAC1
void SOAP_FMAC2 soap_clr_cookie(struct soap* soap,
                                const char*  name,
                                const char*  domain,
                                const char*  path)
{
    ...
    for (p = &soap->cookies, q = *p; q; q = *p) {
        if (!strcmp(q->name, name) &&
            (!q->domain || !strcmp(q->domain, domain)) &&
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_cookie_value(struct soap* soap,
                                         const char*  name,
                                         const char*  domain,
                                         const char*  path)
{
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_env_cookie_value(struct soap* soap,
                                             const char*  name,
                                             const char*  domain,
                                             const char*  path)
{
...
SOAP_FMAC1
time_t SOAP_FMAC2 soap_cookie_expire(struct soap* soap,
                                     const char*  name,
                                     const char*  domain,
                                     const char*  path)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_cookie_expire(struct soap* soap,
                                      const char*  name,
                                      long         maxage,
                                      const char*  domain,
                                      const char*  path)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "Set cookie expiration max-age=%ld: cookie='%s' "
                        "domain='%s' path='%s'\n",
                        maxage,
                        name,
                        domain ? domain : "(null)",
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_cookie_secure(struct soap* soap,
                                      const char*  name,
                                      const char*  domain,
                                      const char*  path)
{
    ...
    DBGLOG(
        TEST,
        SOAP_MESSAGE(fdebug,
                     "Set cookie secure: cookie='%s' domain='%s' path='%s'\n",
                     name,
                     domain ? domain : "(null)",
                     path ? path : "(null)"));
    p = soap_cookie(soap, name, domain, path);
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_cookie_session(struct soap* soap,
                                       const char*  name,
                                       const char*  domain,
                                       const char*  path)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_clr_cookie_session(struct soap* soap,
                                       const char*  name,
                                       const char*  domain,
                                       const char*  path)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_putcookies(struct soap* soap,
                               const char*  domain,
                               const char*  path,
                               int          secure)
{
...
#endif
            if (flag && (!q->path || !strncmp(q->path, path, strlen(q->path)))
                ...
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug,
                           "Sending cookie %s=%s path=\"/%s\" domain=\"%s\"\n",
                           q->name ? q->name : "(null)",
                           q->value ? q->value : "(null)",
                           q->path ? q->path : "(null)",
                           q->domain ? q->domain : "(null)"));
                if (q->version != version &&
                    (s - tmp) + (size_t)36 < sizeof(tmp)) {
                    (SOAP_SNPRINTF_SAFE(s, sizeof(tmp) - (s - tmp)),
                     "$Version=%u;",
                     q->version);
                    version = q->version;
                    s += strlen(s);
                ...
                if (q->name &&
                    (s - tmp) + strlen(q->name) + (size_t)15 < sizeof(tmp)) {
                    s += soap_encode_url(
                        q->name, s, (int)(tmp + sizeof(tmp) - s) - 15);
                }
                if (q->value && *q->value &&
                    (s - tmp) + strlen(q->value) + (size_t)16 < sizeof(tmp)) {
                    *s++ = '=';
                    s += soap_encode_url(
                        q->value, s, (int)(tmp + sizeof(tmp) - s) - 16);
                }
                if (q->path &&
                    (s - tmp) + strlen(q->path) + (size_t)36 < sizeof(tmp)) {
                    (SOAP_SNPRINTF_SAFE(s, sizeof(tmp) - (s - tmp)),
                     ";$Path=\"/%s\"",
                     (*q->path == '/' ? q->path + 1 : q->path));
                    s += strlen(s);
                }
                if (q->domain &&
                    (s - tmp) + strlen(q->domain) + (size_t)36 < sizeof(tmp)) {
                    (SOAP_SNPRINTF_SAFE(s, sizeof(tmp) - (s - tmp)),
                     ";$Domain=\"%s\"",
                     q->domain);
                    s += strlen(s);
...
void SOAP_FMAC2 soap_getcookies(struct soap* soap, const char* val)
{
        ...
        if (!soap_tag_cmp(tmp, "$Version")) {
                ...
                if (!p->expire && strlen(tmp) >= 23) {
                    ...
                    if (t) {
                        ...
                        if (t[1] >= 'A') {
                            ...
                            if (t[17] && t[18] && t[19] != ' ')
                                t += 2; /* format is Sun Nov  6 08:49:37 2017 -
                                           ANSI-C */
                            a[0]      = t[17];
                            a[1]      = t[18];
                            ...
                            /* format is Sunday, 06-Nov-17 08:49:37 GMT - RFC
                             * 850 */
                            a[0]      = t[1];
                            a[1]      = t[2];
                            T.tm_mday = (int)soap_strtol(a, NULL, 10);
                            ...
                            T.tm_mon  = (int)(strstr(mns, a) - mns) / 2;
                            if (t[10] != ' ')
                                t += 2; /* format is Wed, 09 Jun 2021 10:18:14
                                           GMT - RFC 822 */
                            a[0]      = t[8];
                            a[1]      = t[9];
                            T.tm_year = 100 + (int)soap_strtol(a, NULL, 10);
            ...
            if (p) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug,
                           "Got environment cookie='%s' value='%s' domain='%s' "
                           "path='%s' expire=" SOAP_ULONG_FORMAT " secure=%d\n",
                           p->name,
                           p->value ? p->value : "(null)",
                           p->domain ? p->domain : "(null)",
                           p->path ? p->path : "(null)",
                           ...
                           p->secure));
                q = soap_set_cookie(
                    soap, p->name, p->value, p->domain, p->path);
                if (q) {
                    q->version = p->version;
                    q->expire  = p->expire;
                    q->secure  = p->secure;
            ...
            p = (struct soap_cookie*)SOAP_MALLOC(soap,
            ...
            if (p) {
                ...
                if (*tmp) {
                    ...
                    if (p->value)
                        (void)soap_memcpy(
                            (void*)p->value, l, (const void*)tmp, l);
                }
                if (domain) {
                    p->domain = domain;
                    domain    = NULL;
                ...
                if (path) {
                    ...
                    if (p->path)
                        (void)soap_memcpy(
                            (void*)p->path, l, (const void*)soap->path, l);
                }
                else {
                    p->path = (char*)SOAP_MALLOC(soap, 2);
                    if (p->path)
                        (void)soap_memcpy(
                            (void*)p->path, 2, (const void*)"/", 2);
                }
                p->expire  = 0;
                p->secure  = 0;
                p->version = version;
    ...
    if (p) {
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Got environment cookie='%s' value='%s' "
                            "domain='%s' path='%s' expire=" SOAP_ULONG_FORMAT
                            " secure=%d\n",
                            p->name,
                            p->value ? p->value : "(null)",
                            p->domain ? p->domain : "(null)",
...
SOAP_FMAC1
struct soap_cookie* SOAP_FMAC2 soap_copy_cookies(struct soap*       copy,
...
SOAP_FMAC1
struct soap* SOAP_FMAC2 soap_versioning(soap_new)(soap_mode imode,
                                                  soap_mode omode)
{
    struct soap* soap;
#ifdef __cplusplus
...
soap_embed(struct soap* soap, const void* p, const void* a, int n, int t)
{
    ...
    if (soap->version == 2)
        soap->encoding = 1;
    if (!p || (!soap->encodingStyle && !(soap->mode & SOAP_XML_GRAPH)) ||
...
SOAP_FMAC1
int SOAP_FMAC2 soap_pointer_lookup(struct soap*        soap,
                                   const void*         p,
                                   int                 type,
                                   struct soap_plist** ppp)
{
    ...
    *ppp = NULL;
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "Lookup location=%p type=%d: not found\n", p, type));
    return 0;
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_pointer_enter(struct soap*        soap,
                                  const void*         p,
                                  const void*         a,
                                  int                 n,
                                  int                 type,
                                  struct soap_plist** ppp)
{
    ...
    if (!soap->pblk || soap->pidx >= SOAP_PTRBLK) {
        struct soap_pblk* pb =
            (struct soap_pblk*)SOAP_MALLOC(soap, sizeof(struct soap_pblk));
        if (!pb) {
            soap->error = SOAP_EOM;
            return 0;
        }
...
SOAP_FMAC1
int SOAP_FMAC2 soap_array_pointer_lookup(struct soap*        soap,
                                         const void*         p,
                                         const void*         a,
                                         int                 n,
                                         int                 type,
                                         struct soap_plist** ppp)
{
    ...
    *ppp = NULL;
    ...
    DBGLOG(
        TEST,
        SOAP_MESSAGE(
            fdebug, "Array lookup location=%p type=%d: not found\n", a, type));
    return 0;
}
...
int SOAP_FMAC2 soap_begin_count(struct soap* soap)
{
...
#ifdef WITH_ZLIB
    if ((soap->mode & SOAP_ENC_ZLIB) &&
        (soap->mode & SOAP_IO) == SOAP_IO_FLUSH) {
        if (!(soap->mode & SOAP_ENC_DIME))
            soap->mode &= ~SOAP_IO_LENGTH;
    ...
    if (soap->fprepareinitsend && (soap->mode & SOAP_IO) != SOAP_IO_STORE &&
        (soap->error = soap->fprepareinitsend(soap)) != SOAP_OK)
        return soap->error;
#endif
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug,
               "Begin count phase (socket=%d mode=0x%x count=" SOAP_ULONG_FORMAT
               ")\n",
               (int)soap->socket,
               (unsigned int)soap->mode,
               soap->count));
#ifndef WITH_LEANER
    if ((soap->mode & SOAP_IO_LENGTH))
...
int SOAP_FMAC2 soap_end_count(struct soap* soap)
{
    ...
    if ((soap->mode & SOAP_IO_LENGTH)) {
        ...
        if (soap->fpreparefinalsend &&
            (soap->error = soap->fpreparefinalsend(soap)) != SOAP_OK)
            return soap->error;
    }
#else
    (void)soap;
...
static int soap_init_send(struct soap* soap)
{
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
    ...
    *soap->tag = '\0';
...
#ifndef UNDER_CE
#ifndef WITH_FASTCGI
    if (!soap_valid_socket(soap->socket) && !soap->os &&
        soap->sendfd >= 0) /* Set win32 stdout or soap->sendfd to BINARY, e.g.
                              to support DIME */
#ifdef __BORLANDC__
    ...
    if ((soap->mode & SOAP_ENC_ZLIB) && soap->zlib_state != SOAP_ZLIB_DEFLATE) {
        ...
        if (soap->zlib_out != SOAP_ZLIB_DEFLATE) {
            (void)soap_memcpy((void*)soap->z_buf,
                              sizeof(soap->buf),
                              (const void*)"\37\213\10\0\0\0\0\0\0\377",
                              10);
            ...
            return soap->error = SOAP_ZLIB_ERROR;
        if (soap->z_dict) {
            if (deflateSetDictionary(soap->d_stream,
                                     (const Bytef*)soap->z_dict,
                                     soap->z_dict_len) != Z_OK)
                return soap->error = SOAP_ZLIB_ERROR;
        }
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug,
               "Begin send phase (socket=%d mode=0x%x count=" SOAP_ULONG_FORMAT
               ")\n",
               (int)soap->socket,
               soap->mode,
               soap->count));
...
void SOAP_FMAC2 soap_embedded(struct soap* soap, const void* p, int t)
{
    ...
    if (soap_pointer_lookup(soap, p, t, &pp)) {
        ...
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug, "Embedded %p type=%d mark set to 1\n", p, t));
    }
}
#endif
...
int SOAP_FMAC2 soap_reference(struct soap* soap, const void* p, int t)
{
    ...
    if (!p ||
        (!soap->encodingStyle &&
         !(soap->omode &
           (SOAP_ENC_DIME | SOAP_ENC_MIME | SOAP_ENC_MTOM | SOAP_XML_GRAPH))) ||
...
int SOAP_FMAC2 soap_array_reference(
    struct soap* soap, const void* p, const void* a, int n, int t)
{
    struct soap_plist* pp;
    if (!p || !a || (!soap->encodingStyle && !(soap->omode & SOAP_XML_GRAPH)) ||
        (soap->omode & SOAP_XML_TREE))
        return 1;
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment_reference(struct soap* soap,
                                         const void*  p,
                                         const void*  a,
                                         int          n,
                                         int          t,
                                         ...
                                         const char*  type)
{
    struct soap_plist* pp;
    if (!p || !a ||
        (!soap->encodingStyle && !(soap->omode & SOAP_XML_GRAPH) && !id &&
         !type) ||
        (soap->omode & SOAP_XML_TREE))
        return 1;
    if (soap_array_pointer_lookup(soap, p, a, n, t, &pp)) {
...
int SOAP_FMAC2 soap_embedded_id(struct soap* soap, int id, const void* p, int t)
{
    ...
    if (id >= 0 || (!soap->encodingStyle && !(soap->omode & SOAP_XML_GRAPH)) ||
        (soap->omode & SOAP_XML_TREE))
        return id;
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Embedded_id %p type=%d id=%d\n", p, t, id));
    if (id < -1)
...
int SOAP_FMAC2 soap_is_embedded(struct soap* soap, struct soap_plist* pp)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "Is embedded? %d %d\n", (int)pp->mark1, (int)pp->mark2));
    if (soap->version == 1 && soap->encodingStyle &&
        !(soap->omode & SOAP_XML_GRAPH) && soap->part != SOAP_IN_HEADER) {
        if ((soap->mode & SOAP_IO_LENGTH))
            return pp->mark1 != 0;
        return pp->mark2 != 0;
    }
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment(struct soap* soap,
                               const char*  tag,
                               int          id,
                               const void*  p,
                               const void*  a,
                               ...
                               int          t)
{
    ...
    if (id <= 0)
        id = i;
    if (!aid) {
        (SOAP_SNPRINTF(soap->tmpbuf,
                       sizeof(soap->tmpbuf),
                       strlen(soap->dime_id_format) + 20),
         soap->dime_id_format,
         id);
    ...
    if ((soap->mode & SOAP_IO_LENGTH)) {
        if (pp->mark1 != 3) {
            ...
            if ((soap->omode & SOAP_ENC_MTOM))
                content = soap_alloc_multipart(soap,
                                               &soap->mime.first,
                                               &soap->mime.last,
                                               (const char*)a,
                                               n);
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
struct soap_ilist* SOAP_FMAC2 soap_enter(struct soap* soap,
                                         const char*  id,
                                         int          t,
                                         size_t       n)
{
    ...
    struct soap_ilist* ip = NULL;
    size_t             l  = strlen(id);
    if (sizeof(struct soap_ilist) + l > l &&
        (SOAP_MAXALLOCSIZE <= 0 ||
         sizeof(struct soap_ilist) + l <= SOAP_MAXALLOCSIZE))
        ip = (struct soap_ilist*)SOAP_MALLOC(soap,
                                             sizeof(struct soap_ilist) + l);
    if (ip) {
        ip->type  = t;
        ip->size  = n;
        ip->ptr   = NULL;
        ...
        h = soap_hash(
            id); /* h = (HASH(id) % SOAP_IDHASH) so soap->iht[h] is safe */
        ip->next     = soap->iht[h];
        soap->iht[h] = ip;
    }
    return ip;
...
void* SOAP_FMAC2 soap_malloc(struct soap* soap, size_t n)
{
    ...
    n +=
        (~n + 1) & (sizeof(void*) -
                    1); /* align at 4-, 8- or 16-byte boundary by rounding up */
...
static void soap_free_mht(struct soap* soap)
{
    ...
    for (i = 0; i < (int)SOAP_PTRHASH; i++) {
        for (mp = soap->mht[i]; mp; mp = mq) {
            ...
            if (mp->live)
                fprintf(stderr,
                        "%s(%d): malloc() = %p not freed (memory leak or "
                        "forgot to call soap_end()?)\n",
                        mp->file,
                        mp->line,
                        mp->ptr);
            free(mp);
...
#ifdef SOAP_MEM_DEBUG
SOAP_FMAC1
void* SOAP_FMAC2 soap_track_malloc(struct soap* soap,
                                   const char*  file,
                                   int          line,
                                   size_t       size)
{
    ...
    if (soap) {
        ...
        struct soap_mlist* mp =
            (struct soap_mlist*)malloc(sizeof(struct soap_mlist));
...
#ifdef SOAP_MEM_DEBUG
SOAP_FMAC1
void SOAP_FMAC2 soap_track_free(struct soap* soap,
                                const char*  file,
                                int          line,
                                void*        p)
{
    if (!soap) {
        ...
        if (mp) {
            if (mp->live) {
                ...
                fprintf(stderr,
                        "%s(%d): free(%p) double free of pointer malloced at "
                        "%s(%d)\n",
                        file,
                        line,
                        p,
            ...
            if (p == (*cp)->ptr) {
                ...
                *cp                  = q->next;
                if (q->fdelete(soap, q)) {
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug,
                                        "Could not dealloc data %p: deletion "
                                        "callback failed for object type=%d\n",
                                        q->ptr,
                                        q->type));
#ifdef SOAP_MEM_DEBUG
                    fprintf(stderr,
                            "new(object type=%d) = %p not freed: deletion "
                            "callback failed\n",
                            q->type,
                            q->ptr);
#endif
...
#ifdef SOAP_MEM_DEBUG
                fprintf(stderr,
                        "new(object type=%d) = %p not freed: deletion callback "
                        "failed\n",
                        q->type,
                        q->ptr);
#endif
...
SOAP_FMAC1
struct soap_clist* SOAP_FMAC2 soap_link(struct soap* soap,
                                        int          t,
                                        int          n,
                                        int (*fdelete)(struct soap*,
                                                       struct soap_clist*))
{
    struct soap_clist* cp = NULL;
    if (soap) {
        if (n != SOAP_NO_LINK_TO_DELETE) {
            cp = (struct soap_clist*)SOAP_MALLOC(soap,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_unlink(struct soap* soap, const void* p)
{
    char**              q;
    struct soap_clist** cp;
    if (soap && p) {
        ...
        for (cp = &soap->clist; *cp; cp = &(*cp)->next) {
            if (p == (*cp)->ptr) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug, "Unlinked class instance %p\n", p));
                q   = (char**)*cp;
                *cp = (*cp)->next;
                SOAP_FREE(soap, q);
                return SOAP_OK; /* found and removed from dealloc chain */
...
int SOAP_FMAC2 soap_lookup_type(struct soap* soap, const char* id)
{
    ...
    if (id && *id) {
        ...
        if (ip) {
            DBGLOG(
                TEST,
                SOAP_MESSAGE(fdebug, "Lookup id='%s' type=%d\n", id, ip->type));
            return ip->type;
        }
    }
    DBGLOG(TEST,
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
short SOAP_FMAC2 soap_begin_shaky(struct soap* soap)
{
    short f     = soap->shaky;
    soap->shaky = 1;
    return f;
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
void SOAP_FMAC2 soap_end_shaky(struct soap* soap, short f) { soap->shaky = f; }
#endif

/******************************************************************************/

#ifndef WITH_NOIDREF
static int soap_is_shaky(struct soap* soap, void* p)
{
    (void)p;
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
void* SOAP_FMAC2 soap_id_lookup(struct soap* soap,
                                const char*  id,
                                void**       p,
                                int          t,
                                size_t       n,
                                ...
                                int (*fbase)(int, int))
{
    ...
    if (!ip) {
        ip =
            soap_enter(soap, id, t, n); /* new hash table entry for string id */
        if (!ip)
            return NULL;
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Forwarding first href='%s' type=%d location=%p "
                            "(%u bytes) level=%u\n",
                            id,
                            t,
                            (void*)p,
        ...
        *p = NULL;
    ...
    else if (ip->type != t && (!fbase || !fbase(ip->type, t)) &&
             (!fbase || !fbase(t, ip->type) || soap_type_punned(soap, ip))) {
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Lookup type incompatibility: ref='%s' id-type=%d "
                            "ref-type=%d\n",
                            id,
                            ip->type,
                            t));
        ...
        return NULL;
             ...
             !ip->shaky) /* when block lists are in use, ip->ptr will change */
    {
        DBGLOG(
            TEST,
            SOAP_MESSAGE(
        ...
        if (k) {
            if (!ip->spine) {
                ...
                if (k > SOAP_MAXPTRS)
                    return NULL;
                ip->spine =
                    (void**)soap_malloc(soap, SOAP_MAXPTRS * sizeof(void*));
                if (!ip->spine)
                    return NULL;
                ip->spine[0] = NULL;
                for (i = 1; i < SOAP_MAXPTRS; i++)
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
void* SOAP_FMAC2 soap_id_forward(
    struct soap* soap,
    const char*  href,
    void*        p,
    size_t       i,
    ...
    int (*fbase)(int, int))
{
    ...
    if (!p || !href || !*href)
        return p;
    ip = soap_lookup(
        soap, href); /* lookup pointer to hash table entry for string id */
    if (!ip) {
        ip = soap_enter(
            soap, href, t, n); /* new hash table entry for string id */
        if (!ip)
            return NULL;
        DBGLOG(
            TEST,
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Forward type incompatibility id='%s' expect "
                            "type=%d size=%lu level=%u got type=%d size=%lu\n",
                            href,
                            ip->type,
                            (unsigned long)ip->size,
                            k,
    ...
    if (finsert || n < sizeof(void*)) {
        ...
        if ((ip->type != t || ip->size != n) &&
            (!fbase || !fbase(ip->type, t))) {
            DBGLOG(
                TEST,
                SOAP_MESSAGE(fdebug,
                             "Forward type incompatibility id='%s' expect "
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Forwarding type=%d (target type=%d) size=%lu "
                            "location=%p level=%u index=%lu href='%s'\n",
                            t,
                            tt,
                            (unsigned long)n,
                            p,
    ...
    int (*fbase)(int, int))
{
    ...
    if (!p) {
        if (finstantiate) {
            p = finstantiate(soap,
                             ...
                             type,
                             arrayType,
                             &n); /* soap->alloced is set in soap_link() */
            t = soap->alloced;
        }
        else {
    ...
    if (!ip) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Enter type incompatibility id='%s' expect type=%d "
                            "size=%lu got type=%d size=%lu\n",
                            id,
                            ip->type,
                            (unsigned long)ip->size,
                            t,
...
SOAP_FMAC1
void** SOAP_FMAC2 soap_id_smart(struct soap* soap,
                                const char*  id,
                                int          t,
                                size_t       n)
{
...
#ifndef WITH_NOIDREF
    if (id && *id) {
        struct soap_ilist* ip = soap_lookup(
            soap, id); /* lookup pointer to hash table entry for string id */
        if (!ip) {
            ip = soap_enter(
                soap, id, t, n); /* new hash table entry for string id */
            if (!ip)
                return NULL;
        }
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "New smart shared pointer entry id='%s' type=%d "
                            "size=%lu smart=%p\n",
                            id,
                            t,
                            (unsigned long)n,
...
#ifndef WITH_NOIDREF
static int soap_type_punned(struct soap* soap, const struct soap_ilist* ip)
{
...
#ifndef WITH_NOIDREF
SOAP_FMAC1
int SOAP_FMAC2 soap_id_nullify(struct soap* soap, const char* id)
{
    int i;
    for (i = 0; i < SOAP_IDHASH; i++) {
        struct soap_ilist* ip;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_end_send_flush(struct soap* soap)
{
    ...
    if ((soap->mode & SOAP_IO)) /* need to flush the remaining data in buffer */
    {
        ...
        if ((soap->mode & SOAP_ENC_ZLIB) && soap->d_stream) {
            ...
            do {
                ...
                if (soap->d_stream->avail_out != sizeof(soap->buf)) {
                    if (soap_flush_raw(soap,
                                       soap->z_buf,
                                       sizeof(soap->buf) -
                                           soap->d_stream->avail_out)) {
                        soap->zlib_state = SOAP_ZLIB_NONE;
                        deflateEnd(soap->d_stream);
                        return soap->error;
                    }
            ...
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                ...
                                soap->d_stream->total_in,
                                soap->d_stream->total_out));
            soap->z_ratio_out = (float)soap->d_stream->total_out /
                                (float)soap->d_stream->total_in;
        ...
        if ((soap->mode & SOAP_IO) == SOAP_IO_STORE) {
...
#endif
            {
                ...
                if (!(soap->mode & SOAP_ENC_PLAIN)) {
                    ...
                    if (soap->status >= SOAP_POST)
                        ...
                        soap->error = soap->fresponse(
                            soap, soap->status, soap->blist->size);
                ...
                for (p = soap_first_block(soap, NULL); p;
                    ...
                    DBGLOG(
                        ...
                        SOAP_MESSAGE(fdebug,
                                     "Send %u bytes to socket=%d/fd=%d\n",
                                     (unsigned int)soap_block_size(soap, NULL),
                                     (int)soap->socket,
                                     soap->sendfd));
                    soap->error =
                        soap->fsend(soap, p, soap_block_size(soap, NULL));
                    if (soap->error) {
                        soap_end_block(soap, NULL);
                        return soap->error;
                    }
            ...
            if ((soap->omode & SOAP_IO) == SOAP_IO_STORE &&
                (soap->imode & SOAP_IO) != SOAP_IO_STORE)
                soap->omode =
                    (soap->omode & ~SOAP_IO) | (soap->imode & SOAP_IO);
        }
#ifndef WITH_LEANER
    ...
    if (!soap->ssl)
        ...
        if (soap_valid_socket(soap->socket) && !soap->keep_alive &&
            ...
            soap->fshutdownsocket(
                soap, soap->socket, SOAP_SHUT_WR); /* Send TCP FIN */
#endif
#if defined(__cplusplus) && !defined(WITH_COMPAT)
    if (soap->os)
        soap->os->flush();
...
int SOAP_FMAC2 soap_end_recv(struct soap* soap)
{
    ...
    if ((soap->mode & SOAP_ENC_MIME)) {
        if ((soap->mode & SOAP_MIME_POSTCHECK)) {
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Post checking MIME attachments\n"));
            if (!soap->keep_alive)
    ...
    if ((soap->mode & SOAP_ENC_ZLIB) && soap->d_stream) {
        ...
        if (soap->zlib_in == SOAP_ZLIB_GZIP) {
            ...
            if (soap->z_crc != ((uLong)(unsigned char)soap->z_buf[0] |
                                ((uLong)(unsigned char)soap->z_buf[1] << 8) |
                                ((uLong)(unsigned char)soap->z_buf[2] << 16) |
                                ((uLong)(unsigned char)soap->z_buf[3] << 24))) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug,
                                    "Gzip inflate error: crc check failed, "
                                    "message corrupted? (crc32=%lu)\n",
                                    (unsigned long)soap->z_crc));
                return soap->error = SOAP_ZLIB_ERROR;
            }
            if (soap->d_stream->total_out !=
                ((uLong)(unsigned char)soap->z_buf[4] |
                 ((uLong)(unsigned char)soap->z_buf[5] << 8) |
                 ((uLong)(unsigned char)soap->z_buf[6] << 16) |
                 ((uLong)(unsigned char)soap->z_buf[7] << 24))) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug,
...
SOAP_FMAC1
void SOAP_FMAC2 soap_set_recv_logfile(struct soap* soap, const char* logfile)
{
    (void)soap;
    (void)logfile;
#ifdef SOAP_DEBUG
...
SOAP_FMAC1
void SOAP_FMAC2 soap_set_sent_logfile(struct soap* soap, const char* logfile)
{
    (void)soap;
    (void)logfile;
#ifdef SOAP_DEBUG
...
SOAP_FMAC1
void SOAP_FMAC2 soap_set_test_logfile(struct soap* soap, const char* logfile)
{
    (void)soap;
    (void)logfile;
#ifdef SOAP_DEBUG
...
SOAP_FMAC1
struct soap* SOAP_FMAC2 soap_copy(const struct soap* soap)
{
    struct soap* copy =
        soap_versioning(soap_new)(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
SOAP_FMAC1
struct soap* SOAP_FMAC2 soap_copy_context(struct soap*       copy,
                                          const struct soap* soap)
{
    if (copy == soap)
        return copy;
    ...
    if (copy) {
        ...
        copy->namespaces =
            soap->namespaces; /* point to shared read-only namespaces table */
        copy->c_locale = NULL;
#ifdef WITH_OPENSSL
        copy->bio             = NULL;
        copy->ssl             = NULL;
        ...
        for (p = soap->plugins; p; p = p->next) {
            struct soap_plugin* q = (struct soap_plugin*)SOAP_MALLOC(
                copy, sizeof(struct soap_plugin));
            if (!q) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug, "Could not allocate plugin '%s'\n", p->id));
                soap_end(copy);
                soap_done(copy);
                return NULL;
            }
...
void SOAP_FMAC2 soap_copy_stream(struct soap* copy, struct soap* soap)
{
    ...
    copy->port    = soap->port;
    (void)soap_memcpy((void*)copy->host,
                      sizeof(copy->host),
                      (const void*)soap->host,
                      sizeof(soap->host));
    (void)soap_memcpy((void*)copy->endpoint,
                      sizeof(copy->endpoint),
                      (const void*)soap->endpoint,
                      sizeof(soap->endpoint));
#endif
#ifdef WITH_OPENSSL
    copy->bio = soap->bio;
    ...
    if (soap->d_stream && soap->zlib_state != SOAP_ZLIB_NONE) {
        ...
        if (copy->d_stream)
            (void)soap_memcpy((void*)copy->d_stream,
                              sizeof(z_stream),
                              (const void*)soap->d_stream,
                              sizeof(z_stream));
    }
    ...
    if (soap->z_buf && soap->zlib_state != SOAP_ZLIB_NONE) {
        ...
        if (copy->z_buf)
            (void)soap_memcpy((void*)copy->z_buf,
                              sizeof(soap->buf),
                              (const void*)soap->z_buf,
                              sizeof(soap->buf));
        else
...
#endif
    (void)soap_memcpy((void*)copy->buf,
                      sizeof(copy->buf),
                      (const void*)soap->buf,
                      sizeof(soap->buf));
    ...
    (void)soap_memcpy((void*)copy->tag,
                      sizeof(copy->tag),
                      (const void*)soap->tag,
                      sizeof(soap->tag));
    (void)soap_memcpy((void*)copy->id,
                      sizeof(copy->id),
                      (const void*)soap->id,
                      sizeof(soap->id));
    (void)soap_memcpy((void*)copy->href,
                      sizeof(copy->href),
                      (const void*)soap->href,
                      sizeof(soap->href));
    (void)soap_memcpy((void*)copy->type,
                      sizeof(copy->type),
                      (const void*)soap->type,
                      sizeof(soap->type));
    ...
    for (tq = soap->attributes; tq; tq = tq->next) {
        ...
        if (tp->size) {
            ...
            if (tp->value)
                (void)soap_memcpy((void*)tp->value,
                                  tp->size,
                                  (const void*)tq->value,
                                  tp->size);
        }
...
SOAP_FMAC1
void SOAP_FMAC2 soap_free_stream(struct soap* soap)
{
    soap->socket = SOAP_INVALID_SOCKET;
...
SOAP_FMAC1
void SOAP_FMAC2 soap_initialize(struct soap* soap)
{
...
SOAP_FMAC1
void SOAP_FMAC2 soap_versioning(soap_init)(struct soap* soap,
                                           soap_mode    imode,
                                           soap_mode    omode)
{
    size_t i;
    ...
    soap->client_addr = NULL; /* client address (IPv4 or IPv6 or host name) to
                                 bind before connect, NULL for none */
    soap->client_addr_ipv6 = NULL; /* client address IPv6 or host name to bind
                                      before connect, NULL for none */
    soap->client_port =
        -1; /* client port to bind before connect, -1 for none */
    ...
    soap->long_double_format =
        NULL; /* Defined in custom serializer custom/long_double.c */
    soap->dime_id_format =
        "cid:id%d"; /* default DIME id format for int id index */
    soap->recv_maxlength =
        0x7FFFFFFF; /* default max length of messages received (2GB) */
    soap->recv_timeout     = 0;
    soap->send_timeout     = 0;
    soap->transfer_timeout = 0;
...
SOAP_FMAC1
void SOAP_FMAC2 soap_set_version(struct soap* soap, short version)
{
    soap_set_local_namespaces(soap);
    if (soap->version != version && soap->local_namespaces &&
        soap->local_namespaces[0].id && soap->local_namespaces[1].id) {
        if (version == 1) {
...
static void soap_version(struct soap* soap)
{
...
#ifndef WITH_LEAN
SOAP_FMAC1
const char* SOAP_FMAC2 soap_tagsearch(const char* big, const char* little)
{
    if (big && little) {
...
SOAP_FMAC1
struct soap_nlist* SOAP_FMAC2 soap_lookup_ns(struct soap* soap,
                                             const char*  tag,
                                             size_t       n)
{
    struct soap_nlist* np;
                                       ...
                                       short        isearly)
{
    ...
    if (!utilized) {
        for (np = soap->nlist; np; np = np->next) {
            if (!strcmp(np->id, id) &&
                ((!np->ns && *id) || (np->ns && !strcmp(np->ns, ns))))
                break;
        }
        if (np) {
...
static void soap_utilize_ns(struct soap* soap, const char* tag, short isearly)
{
    ...
    if (np) {
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Utilizing namespace '%s' of '%s' at level %u "
                            "utilized=%d at level=%u\n",
                            np->ns ? np->ns : "",
                            tag,
                            soap->level + isearly,
                            np->index,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element(struct soap* soap,
                            const char*  tag,
                            int          id,
                            const char*  type)
{
        ...
        if (soap->event == SOAP_SEC_BEGIN && !soap->evlev) {
            ...
            for (np = soap->nlist; np; np = np->next) {
                int p =
                    soap->c14ninclude
                        ? *soap->c14ninclude == '+' ||
                              soap_tagsearch(soap->c14ninclude, np->id) != NULL
                        : 0;
                if (np->index == 2 || p) {
                    struct soap_nlist* np1 =
    ...
    if ((soap->mode & SOAP_XML_DOM)) {
        struct soap_dom_element* elt = (struct soap_dom_element*)soap_malloc(
            soap, sizeof(struct soap_dom_element));
        if (!elt)
            return soap->error = SOAP_EOM;
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Adding DOM element tag='%s' %p (parent='%s' %p)\n",
                            tag,
                            elt,
                            soap->dom ? soap->dom->name : "(null)",
                            soap->dom));
        elt->soap = soap;
        elt->next = NULL;
        elt->prnt = soap->dom;
        ...
        if (!soap->ns) {
            if (!(soap->mode & SOAP_XML_CANONICAL) &&
                soap_send(soap, soap->prolog))
                return soap->error;
        }
        else if ((soap->mode & SOAP_XML_INDENT)) {
            if (soap->ns == 1 && soap_send_raw(soap,
                                               soap_indent,
                                               soap->level < sizeof(soap_indent)
                                                   ? soap->level
                                                   : sizeof(soap_indent) - 1))
                return soap->error;
            soap->body = 1;
        }
        if ((soap->mode & SOAP_XML_DEFAULTNS)) {
            ...
            if (n) {
                struct Namespace* ns = soap->local_namespaces;
                for (; ns && ns->id; ns++) {
                    if (*ns->id && ns->ns && !strncmp(ns->id, tag, n) &&
                        !ns->id[n]) {
                        if (!soap->nlist || *soap->nlist->id ||
                            (soap->nlist->ns &&
                             strcmp(soap->nlist->ns, ns->ns))) {
                            (void)soap_push_ns(soap,
                                               SOAP_STR_EOS,
                                               ns->out ? ns->out : ns->ns,
                                               0,
                                               0);
                            if (soap_attribute(
                                    soap, "xmlns", ns->out ? ns->out : ns->ns))
                                return soap->error;
                        }
                        break;
                    }
    ...
    soap->ns = 1; /* namespace table control: ns = 0 or 2 to start, then 1 to
    ...
    if (id > 0) {
        (SOAP_SNPRINTF(
             soap->tmpbuf, sizeof(soap->tmpbuf), sizeof(SOAP_BASEREFNAME) + 20),
         SOAP_BASEREFNAME "%d",
         id);
        if (soap->version == 2) {
...
#ifndef WITH_LEAN
        if ((soap->mode & SOAP_XML_CANONICAL) &&
            !(soap->mode & SOAP_XML_CANONICAL_NA))
    ...
    if (soap->null && soap->position > 0 && soap->version == 1) {
        int i;
        (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf) - 1, 20),
         "[%d",
         soap->positions[0]);
        for (i = 1; i < soap->position; i++) {
            size_t l = strlen(soap->tmpbuf);
            (SOAP_SNPRINTF(soap->tmpbuf + l, sizeof(soap->tmpbuf) - l - 1, 20),
             ",%d",
             soap->positions[i]);
        }
    ...
    if (soap->mustUnderstand) {
        if (soap->actor && *soap->actor) {
            if (soap_attribute(soap,
                               soap->version == 2 ? "SOAP-ENV:role"
                                                  : "SOAP-ENV:actor",
                               soap->actor))
                return soap->error;
        }
    ...
    if (soap->encoding) {
        if (soap->encodingStyle && soap->local_namespaces &&
            ...
            if (soap->encodingStyle && soap_attribute(soap,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_begin_out(struct soap* soap,
                                      const char*  tag,
                                      int          id,
                                      const char*  type)
{
...
SOAP_FMAC1
void SOAP_FMAC2 soap_strcat(char* t, size_t n, const char* s)
{
    size_t k = strlen(t);
    if (k < n) {
        t += k;
...
#if _MSC_VER < 1400
/* concat string up to m chars (leaves destination intact on overrun and returns
 * nonzero, zero if OK) */
SOAP_FMAC1
int SOAP_FMAC2 soap_strncat(char* t, size_t n, const char* s, size_t m)
{
    size_t k;
    if (!t || !s)
        return 1;
...
soap_strtoll(const char* s, char** t, int b)
{
    ...
    if (b == 10) {
        ...
        while ((c = *s) && c >= '0' && c <= '9') {
            if (n >= 922337203685477580LL &&
                (n > 922337203685477580LL || c >= '8')) {
                if (neg && n == 922337203685477580LL && c == '8') {
                    if (t)
                        *t = (char*)(s + 1);
                    return -9223372036854775807LL -
                           1LL; /* appease compilers that complain */
                }
                break;
            }
            n *= 10LL;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_array_begin_out(struct soap* soap,
                                    const char*  tag,
                                    int          id,
                                    const char*  type,
                                    const char*  offset)
{
    ...
    if (soap->version == 1) {
        ...
        if (s && (size_t)(s - type) < sizeof(soap->tmpbuf)) {
            (void)soap_strncpy(
                soap->tmpbuf, sizeof(soap->tmpbuf), type, s - type);
...
int SOAP_FMAC2 soap_element_start_end_out(struct soap* soap, const char* tag)
{
    ...
    if ((soap->mode & SOAP_XML_CANONICAL)) {
        ...
        for (np = soap->nlist; np; np = np->next) {
            if (np->ns && np->index == 1) {
                ...
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug,
                                    "Enabling utilized binding (level=%u) "
                                    "%s='%s' SEC-BEGIN=%d c14ninclude='%s'\n",
                                    np->level,
                                    soap->tmpbuf,
                                    np->ns,
    ...
    if ((soap->mode & SOAP_XML_DOM) && soap->dom) {
        ...
        for (tp = soap->attributes; tp; tp = tp->next) {
            if (tp->visible) {
                *att = (struct soap_dom_attribute*)soap_malloc(
                    soap, sizeof(struct soap_dom_attribute));
                if (!*att)
                    return soap->error;
                (*att)->next = NULL;
                (*att)->nstr = NULL;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_end(struct soap* soap, const char* tag)
{
#ifndef WITH_LEAN
    const char* s;
#endif
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_ref(struct soap* soap,
                                const char*  tag,
                                int          id,
                                int          href)
{
    ...
    (SOAP_SNPRINTF(
         soap->href, sizeof(soap->href), sizeof(SOAP_BASEREFNAME) + 21),
     "#" SOAP_BASEREFNAME "%d",
     href);
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_href(struct soap* soap,
                                 const char*  tag,
                                 int          id,
                                 const char*  ref,
                                 const char*  val)
{
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "Element '%s' reference %s='%s'\n", tag, ref, val));
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_null(struct soap* soap,
                                 const char*  tag,
                                 int          id,
                                 const char*  type)
{
    ...
    for (tp = soap->attributes; tp; tp = tp->next)
        if (tp->visible)
            break;
    if (tp || (soap->version == 2 && soap->position > 0) || id > 0 ||
        (soap->mode & SOAP_XML_NIL)) {
        if (soap_element(soap, tag, id, type) ||
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_empty(struct soap* soap, const char* tag)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_id(struct soap* soap,
                               const char*  tag,
                               int          id,
                               const void*  p,
                               const void*  a,
...
#ifndef WITH_NOIDREF
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Element_id %p type=%d id=%d\n", p, t, id));
...
SOAP_FMAC1
int SOAP_FMAC2 soap_check_and_mark(struct soap* soap,
                                   const void*  p,
                                   int          t,
                                   char**       mark)
{
    if (mark) {
        struct soap_plist* pp;
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "Check %p and mark %p\n", p, (void*)mark));
        if (!soap_pointer_lookup(soap, p, t, &pp))
...
SOAP_FMAC1
void* SOAP_FMAC2 soap_mark_lookup(struct soap*        soap,
                                  const void*         p,
                                  int                 t,
                                  struct soap_plist** ppp,
                                  char**              mark)
{
    ...
    if (mark || !(soap->mode & SOAP_XML_TREE)) {
        ...
        if (mark) {
            ...
            *mark = &(*ppp)->mark1;
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Mark cycle %d\n", (*ppp)->mark1));
        }
    }
    return NULL;
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_mark_cycle(struct soap* soap, struct soap_plist* pp)
{
    (void)soap;
...
SOAP_FMAC1
void SOAP_FMAC2 soap_mark_dup(struct soap* soap, void* a, struct soap_plist* pp)
{
    (void)soap;
    if (pp)
        pp->dup = a;
...
SOAP_FMAC1
void SOAP_FMAC2 soap_unmark(struct soap* soap, char* mark)
{
    (void)soap;
    if (mark)
...
SOAP_FMAC1
int SOAP_FMAC2 soap_attribute(struct soap* soap,
                              const char*  name,
                              const char*  value)
{
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Attribute '%s'='%s'\n", name, value));
#ifdef WITH_DOM
    if ((soap->mode & SOAP_XML_DOM) && !(soap->mode & SOAP_XML_CANONICAL) &&
        soap->dom) {
        struct soap_dom_attribute* a = (struct soap_dom_attribute*)soap_malloc(
            soap, sizeof(struct soap_dom_attribute));
        if (!a)
            return soap->error;
    ...
    if ((soap->mode & SOAP_XML_CANONICAL)) {
        ...
        if (!strncmp(name, "xmlns", 5) &&
            ...
            if (name[5] == '\0')
                soap_utilize_ns(soap, SOAP_STR_EOS, 0);
            else if (soap->c14ninclude &&
                     ((*soap->c14ninclude == '*' ||
                       soap_tagsearch(soap->c14ninclude, name + 6))))
...
#endif
    {
        if (soap_send_raw(soap, " ", 1) || soap_send(soap, name))
            return soap->error;
        if (value)
            if (soap_send_raw(soap, "=\"", 2) ||
                soap_string_out(soap, value, 1) || soap_send_raw(soap, "\"", 1))
                return soap->error;
    }
    return SOAP_OK;
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_element_begin_in(struct soap* soap,
                                     const char*  tag,
                                     int          nillable,
                                     const char*  type)
{
    if (!soap_peek_element(soap)) {
        ...
        if (!soap->error) {
            ...
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                "Begin tag found (level=%u) '%s'='%s'\n",
                                soap->level,
                                soap->tag,
                                tag ? tag : SOAP_STR_EOS));
            soap->error = SOAP_OK;
        }
    }
...
int SOAP_FMAC2 soap_element_end_in(struct soap* soap, const char* tag)
{
    ...
    if ((soap->mode & SOAP_XML_DOM) && soap->dom) {
        ...
        if (s && (soap->mode & SOAP_XML_STRICT)) {
            for (; *s; s++)
                if (!soap_coblank((soap_wchar)*s))
                    return soap->error = SOAP_END_TAG; /* reject mixed content
                                                          before ending tag */
        }
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_attr_value(struct soap* soap,
                                       const char*  name,
                                       int          flag,
                                       int          occurs)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_attr(struct soap* soap,
                             const char*  name,
                             const char*  value,
                             int          flag)
{
    ...
    if (!tp) {
        ...
        if (sizeof(struct soap_attribute) + l > l &&
            (SOAP_MAXALLOCSIZE <= 0 ||
             sizeof(struct soap_attribute) + l <= SOAP_MAXALLOCSIZE))
            tp = (struct soap_attribute*)SOAP_MALLOC(
                soap, sizeof(struct soap_attribute) + l);
        if (!tp)
            return soap->error = SOAP_EOM;
        tp->ns = NULL;
#ifndef WITH_LEAN
        if ((soap->mode & SOAP_XML_CANONICAL)) {
            ...
            DBGLOG(TEST,
                   SOAP_MESSAGE(
                       fdebug, "Inserting attribute %s for c14n\n", name));
            if (!strncmp(name, "xmlns", 5)) {
                for (; *tpp; tpp = &(*tpp)->next)
                    if (strncmp((*tpp)->name, "xmlns", 5) ||
                        strcmp((*tpp)->name + 5, name + 5) > 0)
                        break;
            }
            else if (!s) {
                for (; *tpp; tpp = &(*tpp)->next)
                    if (strncmp((*tpp)->name, "xmlns", 5) &&
                        ((*tpp)->ns || strcmp((*tpp)->name, name) > 0))
                        break;
            }
            else {
                ...
                if (np) {
                    ...
                    for (tq = soap->attributes; tq; tq = tq->next) {
                        if (!strncmp(tq->name, "xmlns:", 6) &&
                            !strncmp(tq->name + 6, name, s - name) &&
                            !tq->name[6 + s - name]) {
                            tp->ns = tq->ns;
                            break;
                        }
                ...
                for (; *tpp; tpp = &(*tpp)->next) {
                    int k;
                    if (strncmp((*tpp)->name, "xmlns", 5) && (*tpp)->ns &&
                        tp->ns &&
                        ((k = strcmp((*tpp)->ns, tp->ns)) > 0 ||
                         (!k && strcmp((*tpp)->name, name) > 0)))
                        break;
                }
            }
            tp->next = *tpp;
            ...
            if (s && strchr(value, ':')) {
                ...
                if (np && np->ns && soap->local_namespaces) {
                    if ((!strcmp(s + 1, "type") &&
                         !strcmp(
                             np->ns,
                             soap->local_namespaces[2].ns)) /* xsi:type QName */
                        || ((!strcmp(s + 1, "arrayType") ||
                             !strcmp(s + 1, "itemType")) &&
                            !strcmp(np->ns,
                                    soap->local_namespaces[1]
                                        .ns))) /* SOAP-ENC:arrayType and
                                                  SOAP-ENC:itemType QName */
...
int SOAP_FMAC2 soap_append_lab(struct soap* soap, const char* s, size_t n)
{
    ...
    if (soap->labidx + n >= soap->lablen) {
        ...
        if (t) {
            (void)soap_memcpy((void*)soap->labbuf,
                              soap->lablen,
                              (const void*)t,
                              soap->labidx);
            SOAP_FREE(soap, t);
    ...
    if (s) {
        (void)soap_memcpy((void*)(soap->labbuf + soap->labidx),
                          soap->lablen - soap->labidx,
                          (const void*)s,
                          n);
        soap->labidx += n;
    }
...
int SOAP_FMAC2 soap_peek_element(struct soap* soap)
{
    ...
    c = soap_get(soap);
#ifdef WITH_DOM
    /* whitespace leading up to the start tag is significant for DOM as-is (but
     * comments and PIs are removed from this lead) */
    if (soap_coblank(c)) {
        soap->labidx = 0;
        do {
            if (soap_append_lab(soap, NULL, 0))
        ...
        *soap->tag = '\0';
        ...
        if ((soap->mode & SOAP_XML_DOM) && soap->dom) {
            if (lead && *lead)
                ...
                soap->dom->tail =
                    SOAP_STR_EOS; /* body with closing tag instead of <tag/> */
        }
#endif
        return soap->error = SOAP_NO_TAG;
    }
    ...
    *s = '\0';
    ...
    if ((soap->mode & SOAP_XML_DOM)) {
        ...
        elt = (struct soap_dom_element*)soap_malloc(
            soap, sizeof(struct soap_dom_element));
        if (!elt)
            return soap->error;
        elt->next = NULL;
        ...
        if (c == '=') {
            ...
            if (soap_getattrval(soap, tp->value, &k, c)) {
                ...
                for (;;) {
                    k = soap->lablen - soap->labidx;
                    if (soap_getattrval(
                            soap, soap->labbuf + soap->labidx, &k, c)) {
                        if (soap->error != SOAP_EOM)
                            return soap->error;
                        soap->error  = SOAP_OK;
                        soap->labidx = soap->lablen;
                ...
                if (tp->value) {
                    (void)soap_memcpy(
                        (void*)s, k, (const void*)tp->value, tp->size);
                    SOAP_FREE(soap, tp->value);
                }
            ...
            if (tp->visible) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug, "Duplicate attribute in %s\n", soap->tag));
                return soap->error = SOAP_SYNTAX_ERROR; /* redefined (duplicate)
                                                           attribute */
            }
        ...
        if (tp->visible && tp->value) {
            ...
            if (!strcmp(tp->name, "id")) {
                ...
                if ((soap->version == 1 && !(soap->imode & SOAP_XML_TREE)) ||
                    (soap->mode & SOAP_XML_GRAPH) ||
                    ((soap->mode & (SOAP_ENC_MTOM | SOAP_ENC_DIME)) &&
                     *tp->value != '#'))
                ...
                if ((soap->version == 2 && !(soap->imode & SOAP_XML_TREE)) ||
                    (soap->mode & SOAP_XML_GRAPH)) {
                    *soap->href = '#';
                    soap_strcpy(soap->href + (*tp->value != '#'),
                                sizeof(soap->href) - 1,
                                tp->value);
                }
            }
            ...
            if (!strcmp(tp->name, "href")) {
                if ((soap->mode & (SOAP_ENC_MTOM | SOAP_ENC_DIME)) &&
                    *tp->value != '#')
                    soap_strcpy(soap->href, sizeof(soap->href), tp->value);
            }
#endif
            ...
            else if (!soap_match_tag(
                         soap, tp->name, "SOAP-ENV:encodingStyle")) {
                if (!soap->encodingStyle)
                    soap->encodingStyle = SOAP_STR_EOS;
                soap_version(soap);
            }
                ...
                if (!soap_match_tag(soap, tp->name, "SOAP-ENC:arrayType")) {
                    ...
                    if (s &&
                        (size_t)(s - tp->value) < sizeof(soap->arrayType)) {
                        (void)soap_strncpy(soap->arrayType,
                                           sizeof(soap->arrayType),
                                           tp->value,
                                           s - tp->value);
                        soap_strcpy(
                            soap->arraySize, sizeof(soap->arraySize), s);
                    }
                    else
                        soap_strcpy(soap->arrayType,
                                    sizeof(soap->arrayType),
                                    tp->value);
                }
                else if (!soap_match_tag(soap, tp->name, "SOAP-ENC:offset")) {
                    soap_strcpy(soap->arrayOffset,
                                sizeof(soap->arrayOffset),
                                tp->value);
                }
                else if (!soap_match_tag(soap, tp->name, "SOAP-ENC:position")) {
                    soap->position =
                        soap_getposition(tp->value, soap->positions);
                }
                else if (!soap_match_tag(soap, tp->name, "SOAP-ENC:root")) {
                    soap->root = ((!strcmp(tp->value, "1") ||
                                   !strcmp(tp->value, "true")));
                }
                else if (!soap_match_tag(
                             soap, tp->name, "SOAP-ENV:mustUnderstand") &&
                         (!strcmp(tp->value, "1") ||
                          !strcmp(tp->value, "true"))) {
                ...
                if (!soap_match_tag(soap, tp->name, "SOAP-ENC:id")) {
                    ...
                    *soap->href = '#';
                    ...
                    soap_strcpy(
                        soap->arrayType, sizeof(soap->arrayType), tp->value);
                }
                else if (!soap_match_tag(
                             soap, tp->name, "SOAP-ENC:arraySize")) {
                    soap_strcpy(
                        soap->arraySize, sizeof(soap->arraySize), tp->value);
                }
                else if (!soap_match_tag(
                             soap, tp->name, "SOAP-ENV:mustUnderstand") &&
                         (!strcmp(tp->value, "1") ||
                ...
                if (!soap_match_tag(soap, tp->name, "wsdl:required") &&
                    !strcmp(tp->value, "true"))
                    soap->mustUnderstand = 1;
            }
        }
...
SOAP_FMAC1
int SOAP_FMAC2 soap_ignore(struct soap* soap)
{
    int        n = 0;
    soap_wchar c;
    soap->level++;
    DBGLOG(TEST,
           SOAP_MESSAGE(
               fdebug, "Ignoring XML content at level=%u\n", soap->level));
#ifdef WITH_DOM
    if ((soap->mode & SOAP_XML_DOM) && soap->dom) {
        ...
        default:
            ...
            if ((soap->mode & SOAP_C_MBSTRING)) {
                ...
                if (m > 0 && !((soap_wchar)wc == c && m == 1 && c < 0x80)) {
                    if (soap_send_raw(soap, s, t - s - 1) ||
                        soap_pututf8(soap, (unsigned long)wc))
                        return soap->error;
                    s = t += m - 1;
                    continue;
                }
            ...
            if ((c & mask) || !(c & 0xFFFFFFE0UL)) {
                if (soap_send_raw(soap, s, t - s - 1) ||
                    soap_pututf8(soap, (unsigned char)c))
                    return soap->error;
                s = t;
            }
#endif
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_string_in(
    struct soap* soap, int flag, long minlen, long maxlen, const char* pattern)
{
    char*      s;
    char*      t = NULL;
    size_t     i;
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Reading string content, flag=%d\n", flag));
        ...
        *t = '<';
        ...
        for (tp = soap->attributes; tp; tp = tp->next) {
            if (tp->visible) {
                ...
                *t++ = ' ';
                (void)soap_strncpy(
                    t, sizeof(soap->tmpbuf) - (t - soap->tmpbuf), tp->name, k);
                t += k;
                if (tp->value) {
                    k = strlen(tp->value);
    ...
    if (flag <= 0) {
        ...
        for (;;) {
            ...
            size_t k;
            if (soap_append_lab(
                    soap, NULL, 0)) /* allocate more space in look-aside buffer
                                       if necessary */
                return NULL;
            ...
            for (i = 0; i < k; i++) {
                ...
                if ((c >= 0x80 || c < SOAP_AP) && state != 1) {
                    ...
                    if ((c & 0x7FFFFFFF) >= 0x80 &&
                        (flag <= 0 || (soap->mode & SOAP_C_UTFSTRING))) {
                        c &= 0x7FFFFFFF;
                        t = buf;
                        if (c < 0x0800)
                            *t++ = (char)(0xC0 | ((c >> 6) & 0x1F));
                ...
                default:
                    ...
                    if ((soap->mode & SOAP_C_MBSTRING)) {
#if defined(WIN32) && !defined(CYGWIN) && !defined(__MINGW32__) &&             \
    !defined(__MINGW64__) && !defined(__BORLANDC__)
                        m = 0;
                        wctomb_s(
                            &m, buf, sizeof(buf), (wchar_t)(c & 0x7FFFFFFF));
#else
    ...
    !defined(__MINGW64__) && !defined(__BORLANDC__)
            ...
            if (maxlen >= 0 && l > (size_t)maxlen) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(
                           fdebug, "String too long: maxlen=%ld\n", maxlen));
                soap->error = SOAP_LENGTH;
                return NULL;
            }
        }
    ...
    while ((c = *s++)) {
        ...
        default:
            if (c >= 0x20 && c < 0x80) {
                ...
                /* check for UTF16 encoding when wchar_t is too small to hold
                 * UCS */
...
#ifndef WITH_LEANER
SOAP_FMAC1
wchar_t* SOAP_FMAC2 soap_wstring_in(
    struct soap* soap, int flag, long minlen, long maxlen, const char* pattern)
{
    wchar_t*   s;
    int        i, n = 0, f = 0;
    ...
    if (soap_alloc_block(soap) == NULL)
        return NULL;
    for (;;) {
        s = (wchar_t*)soap_push_block(
            soap, NULL, sizeof(wchar_t) * SOAP_BLKLEN);
        if (!s)
            return NULL;
        for (i = 0; i < SOAP_BLKLEN; i++) {
            if (t) {
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_int2s(struct soap* soap, int n)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outint(struct soap* soap,
                           const char*  tag,
                           int          id,
                           const int*   p,
                           const char*  type,
                           int          n)
{
    if (soap_element_begin_out(
            soap, tag, soap_embedded_id(soap, id, p, n), type) ||
...
#endif
    p = (int*)soap_id_enter(
        soap, soap->id, p, t, sizeof(int), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (int*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(int), 0, NULL, NULL);
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outlong(struct soap* soap,
                            const char*  tag,
                            int          id,
                            const long*  p,
                            const char*  type,
...
SOAP_FMAC1
long* SOAP_FMAC2 soap_inlong(
    struct soap* soap, const char* tag, long* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (long*)soap_id_enter(
        soap, soap->id, p, t, sizeof(long), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (long*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(long), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
{
    (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), 20),
     SOAP_LONG_FORMAT,
     n);
    return soap->tmpbuf;
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outLONG64(struct soap*  soap,
                              const char*   tag,
                              int           id,
                              const LONG64* p,
                              const char*   type,
...
LONG64* SOAP_FMAC2 soap_inLONG64(
    struct soap* soap, const char* tag, LONG64* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (LONG64*)soap_id_enter(
        soap, soap->id, p, t, sizeof(LONG64), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (LONG64*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(LONG64), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_byte2s(struct soap* soap, char n)
{
    return soap_long2s(soap, (long)n);
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outbyte(struct soap* soap,
                            const char*  tag,
                            int          id,
                            const char*  p,
                            const char*  type,
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_inbyte(
    struct soap* soap, const char* tag, char* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (char*)soap_id_enter(
        soap, soap->id, p, t, sizeof(char), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (char*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(char), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_short2s(struct soap* soap, short n)
{
    return soap_long2s(soap, (long)n);
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outshort(struct soap* soap,
                             const char*  tag,
                             int          id,
                             const short* p,
                             const char*  type,
...
SOAP_FMAC1
short* SOAP_FMAC2 soap_inshort(
    struct soap* soap, const char* tag, short* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (short*)soap_id_enter(
        soap, soap->id, p, t, sizeof(short), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (short*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(short), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
#if defined(WITH_C_LOCALE)
#ifdef WIN32
    _sprintf_s_l(soap->tmpbuf,
                 _countof(soap->tmpbuf),
                 soap->float_format,
                 SOAP_LOCALE(soap),
                 n);
#else
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outfloat(struct soap* soap,
                             const char*  tag,
                             int          id,
                             const float* p,
                             const char*  type,
...
/* On some systems strtof requires -std=c99 or does not even link: so we try
 * strtod first */
#if defined(WITH_C_LOCALE)
...
SOAP_FMAC1
float* SOAP_FMAC2 soap_infloat(
    struct soap* soap, const char* tag, float* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (float*)soap_id_enter(
        soap, soap->id, p, t, sizeof(float), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (float*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(float), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
#else
    locale = uselocale(SOAP_LOCALE(soap));
    (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), 40),
     soap->double_format,
     n);
    uselocale(locale);
#endif
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outdouble(struct soap*  soap,
                              const char*   tag,
                              int           id,
                              const double* p,
                              const char*   type,
...
SOAP_FMAC1
double* SOAP_FMAC2 soap_indouble(
    struct soap* soap, const char* tag, double* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (double*)soap_id_enter(
        soap, soap->id, p, t, sizeof(double), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (double*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(double), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_unsignedByte2s(struct soap* soap, unsigned char n)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outunsignedByte(struct soap*         soap,
                                    const char*          tag,
                                    int                  id,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2unsignedByte(struct soap*   soap,
                                   const char*    s,
                                   unsigned char* p)
{
    if (s) {
                                              ...
                                              int            t)
{
    ...
    p = (unsigned char*)soap_id_enter(
        soap, soap->id, p, t, sizeof(unsigned char), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (unsigned char*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(unsigned char), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_unsignedShort2s(struct soap* soap, unsigned short n)
{
    return soap_unsignedLong2s(soap, (unsigned long)n);
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outunsignedShort(struct soap*          soap,
                                     const char*           tag,
                                     int                   id,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2unsignedShort(struct soap*    soap,
                                    const char*     s,
                                    unsigned short* p)
{
    if (s) {
...
SOAP_FMAC1
unsigned short* SOAP_FMAC2 soap_inunsignedShort(struct soap*    soap,
                                                const char*     tag,
                                                unsigned short* p,
                                                const char*     type,
                                                int             t)
{
    ...
    p = (unsigned short*)soap_id_enter(
        soap, soap->id, p, t, sizeof(unsigned short), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (unsigned short*)soap_id_forward(soap,
                                             soap->href,
                                             p,
                                             0,
                                             t,
...
SOAP_FMAC1
const char* SOAP_FMAC2 soap_unsignedInt2s(struct soap* soap, unsigned int n)
{
    return soap_unsignedLong2s(soap, (unsigned long)n);
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outunsignedInt(struct soap*        soap,
                                   const char*         tag,
                                   int                 id,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2unsignedInt(struct soap*  soap,
                                  const char*   s,
                                  unsigned int* p)
{
    if (s) {
...
SOAP_FMAC1
unsigned int* SOAP_FMAC2 soap_inunsignedInt(struct soap*  soap,
                                            const char*   tag,
                                            unsigned int* p,
                                            const char*   type,
                                            int           t)
{
    ...
    (void)type;
#endif
    p = (unsigned int*)soap_id_enter(
        soap, soap->id, p, t, sizeof(unsigned int), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (unsigned int*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(unsigned int), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outunsignedLong(struct soap*         soap,
                                    const char*          tag,
                                    int                  id,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2unsignedLong(struct soap*   soap,
                                   const char*    s,
                                   unsigned long* p)
{
    if (s) {
                                              ...
                                              int            t)
{
    ...
    p = (unsigned long*)soap_id_enter(
        soap, soap->id, p, t, sizeof(unsigned long), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (unsigned long*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(unsigned long), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outULONG64(struct soap*   soap,
                               const char*    tag,
                               int            id,
                               const ULONG64* p,
                               const char*    type,
...
SOAP_FMAC1
ULONG64* SOAP_FMAC2 soap_inULONG64(
    struct soap* soap, const char* tag, ULONG64* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
#ifndef WITH_LEAN
    ...
    (void)type;
#endif
    p = (ULONG64*)soap_id_enter(
        soap, soap->id, p, t, sizeof(ULONG64), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (ULONG64*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(ULONG64), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2char(struct soap* soap,
                           const char*  s,
                           char**       t,
                           int          flag,
                           long         minlen,
...
#ifdef __cplusplus
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdchar(struct soap* soap,
                              const char*  s,
                              std::string* t,
                              int          flag,
                              long         minlen,
...
static char* soap_collapse(struct soap* soap, char* s, int flag, int insitu)
{
    ...
    if (n > 0) {
        if (!soap_coblank((soap_wchar)s[n - 1])) {
            for (t = s;
                 (*t && !soap_coblank((soap_wchar)*t)) ||
                 (*t == 32 && (!t[1] || !soap_coblank((soap_wchar)t[1])));
                 t++)
                continue;
            if (!*t)
                return s;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_s2QName(struct soap* soap,
                            const char*  s,
                            char**       t,
                            long         minlen,
                            long         maxlen,
...
#ifdef __cplusplus
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdQName(struct soap* soap,
                               const char*  s,
                               std::string* t,
                               long         minlen,
                               long         maxlen,
                              ...
                              const char*  pattern)
{
    if (s) {
        ...
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug, "Normalized namespace(s) of QNames '%s'", s));
        ...
        for (;;) {
            ...
            while (s[n] && !soap_coblank((soap_wchar)s[n]))
                n++;
            np = soap->nlist;
            /* if there is no namespace stack, or prefix is "#" or "xml" then
             * copy string */
            ...
            else /* we normalize the QName by replacing its prefix */
            {
                ...
                if (np) {
                    if (np->index >= 0 && soap->local_namespaces &&
                        (q = soap->local_namespaces[np->index].id) != NULL) {
                        size_t k = strlen(q);
                        if (q[k - 1] != '_') {
                            r = q;
                            m = k;
                        ...
                        DBGLOG(TEST,
                               SOAP_MESSAGE(fdebug,
                                            "\nNamespace prefix of '%s' not "
                                            "defined (index=%d, URI='%s')\n",
                                            s,
                                            np->index,
                                            np->ns ? np->ns : SOAP_STR_EOS));
                        soap->error = SOAP_NAMESPACE;
                        return NULL;
                    }
                }
...
const char* SOAP_FMAC2 soap_QName2s(struct soap* soap, const char* s)
{
    ...
    if (s) {
        ...
        for (;;) {
            ...
            {
#ifndef WITH_LEAN
                if (r && (soap->mode & SOAP_XML_CANONICAL) &&
                    !(soap->mode & SOAP_XML_CANONICAL_NA))
                ...
                if (q) {
                    ...
                    else /* not in namespace table: create xmlns binding */
                    {
                        ...
                        if (!x)
                            return NULL;
                        x[q - s - 2] = '\0';
                        (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), 27),
                         "xmlns:_%d",
                         soap->idnum++);
            ...
            /* copy normalized QName into buffer, including the ending blank or
             * NUL */
#ifdef WITH_FAST
            ...
            if (q) {
                if (soap_memcpy(
                        (void*)b, k - m, (const void*)q, n - (q - s) + 1)) {
                    soap->error = SOAP_EOM;
                    return NULL;
                }
                b += n - (q - s) + 1;
...
#ifndef WITH_LEAN
SOAP_FMAC1
int SOAP_FMAC2 soap_s2wchar(struct soap* soap,
                            const char*  s,
                            wchar_t**    t,
                            int          flag,
                            long         minlen,
...
#ifndef WITH_LEAN
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdwchar(struct soap*  soap,
                               const char*   s,
                               std::wstring* t,
                               int           flag,
                               long          minlen,
        ...
        if ((soap->mode & SOAP_ENC_LATIN)) {
            ...
            while (*s) {
                ...
                if (sizeof(wchar_t) < 4 && c > 0xFFFF) {
                    ...
                    c2 = 0xDC00 + (c & 0x3FF);
                    if (soap_append_lab(
                            soap, (const char*)&c1, sizeof(wchar_t)) ||
                        soap_append_lab(
                            soap, (const char*)&c2, sizeof(wchar_t)))
                        return NULL;
                }
                else if (soap_append_lab(
                             soap, (const char*)&c, sizeof(wchar_t))) {
                    return NULL;
                }
            }
        }
                ...
                if (soap_coblank((soap_wchar)*t)) {
                    ...
                    *t = L' ';
                    for (r = t + 1; *r && soap_coblank((soap_wchar)*r); r++)
                        continue;
                    if (r > t + 1)
                        (void)soap_memmove(t + 1,
                                           sizeof(wchar_t) * (n - (t - s)),
                                           r,
...
const char* SOAP_FMAC2 soap_wchar2s(struct soap* soap, const wchar_t* s)
{
    ...
    if (r) {
        /* Convert wchar to UTF8 (chars above U+10FFFF are silently converted,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outstring(struct soap* soap,
                              const char*  tag,
                              int          id,
                              char* const* p,
                              const char*  type,
                              int          n)
{
    ...
    if (soap_element_begin_out(soap, tag, id, type) ||
        soap_string_out(soap, *p, 0) || soap_element_end_out(soap, tag))
        return soap->error;
    return SOAP_OK;
}
...
SOAP_FMAC1
char** SOAP_FMAC2 soap_instring(struct soap* soap,
                                const char*  tag,
                                char**       p,
                                const char*  type,
                                int          t,
                                ...
                                const char*  pattern)
{
    ...
    if (*soap->href == '#')
        p = (char**)soap_id_lookup(
            soap, soap->href, (void**)p, t, sizeof(char**), 0, NULL);
    if (soap->body && soap_element_end_in(soap, tag))
        return NULL;
    return p;
}
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_outwstring(struct soap*    soap,
                               const char*     tag,
                               int             id,
                               wchar_t* const* p,
                               const char*     type,
                               int             n)
{
    ...
    if (!**p && (soap->mode & SOAP_C_NILSTRING))
        return soap_element_null(soap, tag, id, type);
    if (soap_element_begin_out(soap, tag, id, type) ||
        soap_wstring_out(soap, *p, 0) || soap_element_end_out(soap, tag))
        return soap->error;
    return SOAP_OK;
}
#endif
...
#ifndef WITH_LEANER
SOAP_FMAC1
wchar_t** SOAP_FMAC2 soap_inwstring(struct soap* soap,
                                    const char*  tag,
                                    wchar_t**    p,
                                    const char*  type,
                                    int          t,
                                    ...
                                    const char*  pattern)
{
    ...
    if (soap->null) {
        ...
        *p = soap_wstring_in(soap, flag, minlen, maxlen, pattern);
        if (!*p || !(wchar_t*)soap_id_enter(soap,
                                            soap->id,
                                            *p,
                                            t,
                                            sizeof(wchar_t*),
    ...
    if (*soap->href == '#')
        p = (wchar_t**)soap_id_lookup(
            soap, soap->href, (void**)p, t, sizeof(wchar_t**), 0, NULL);
    if (soap->body && soap_element_end_in(soap, tag))
        return NULL;
    return p;
}
...
#define __FILETIME_to_ll(f)                                                    \
    ((long long)(f).dwHighDateTime << 32 | (long long)(f).dwLowDateTime)
static time_t mktime(struct tm* pt)
{
    SYSTEMTIME s, s1, s2;
    FILETIME   f, f1, f2;
    long long  diff;
    ...
    return (time_t)((__FILETIME_to_ll(f) - 116444736000000000LL) / 10000000LL) -
           (time_t)diff;
}
#endif
#endif
...
static struct tm* gmtime_r(const time_t* t, struct tm* pt)
{
    FILETIME   f, f1, f2;
    SYSTEMTIME s, s1 = {0};
    ...
    pt->tm_yday =
        (((__FILETIME_to_ll(f2) - __FILETIME_to_ll(f1)) / 10000000LL) /
         (60 * 60 * 24));
    pt->tm_hour  = s.wHour;
    pt->tm_min   = s.wMinute;
    pt->tm_sec   = s.wSecond;
...
#ifndef WITH_LEAN
#ifdef UNDER_CE
/* WinCE very simple strftime for format "%Y-%m-%dT%H:%M:%SZ", note: %F and %T
 * not supported by MS */
static size_t
...
const char* SOAP_FMAC2 soap_dateTime2s(struct soap* soap, time_t n)
{
    ...
    if (gmtime_r(&n, pT) != SOAP_FUNC_R_ERR)
        l = strftime(
            soap->tmpbuf, sizeof(soap->tmpbuf), "%Y-%m-%dT%H:%M:%SZ", pT);
#elif defined(HAVE_GMTIME) && !defined(WITH_NOZONE)
    pT = gmtime(&n);
    if (pT)
        l = strftime(
            soap->tmpbuf, sizeof(soap->tmpbuf), "%Y-%m-%dT%H:%M:%SZ", pT);
#elif (defined(HAVE_TM_GMTOFF) || defined(HAVE_STRUCT_TM_TM_GMTOFF) ||         \
       defined(HAVE_STRUCT_TM___TM_GMTOFF)) &&                                 \
    !defined(WITH_NOZONE)
#if defined(HAVE_LOCALTIME_R)
    if (localtime_r(&n, pT) != SOAP_FUNC_R_ERR) {
        l = strftime(
            soap->tmpbuf, sizeof(soap->tmpbuf), "%Y-%m-%dT%H:%M:%S%z", pT);
        if (l) {
            (void)soap_memmove(soap->tmpbuf + 23,
                               sizeof(soap->tmpbuf) - 23,
                               soap->tmpbuf + 22,
                               3);  /* 2000-03-01T02:00:00+0300 */
    ...
    if (localtime_r(&n, pT) != SOAP_FUNC_R_ERR) {
        ...
        gettimeofday(&tv, &tz);
        l = strftime(
            soap->tmpbuf, sizeof(soap->tmpbuf), "%Y-%m-%dT%H:%M:%S", pT);
        if (l)
            (SOAP_SNPRINTF(soap->tmpbuf + l, sizeof(soap->tmpbuf) - l, 7),
             "%+03d:%02d",
             -tz.tz_minuteswest / 60 + (pT->tm_isdst != 0),
...
#ifndef WITH_LEAN
SOAP_FMAC1
int SOAP_FMAC2 soap_outdateTime(struct soap*  soap,
                                const char*   tag,
                                int           id,
                                const time_t* p,
                                const char*   type,
...
int SOAP_FMAC2 soap_s2dateTime(struct soap* soap, const char* s, time_t* p)
{
    *p = 0;
    if (s) {
        ...
        if (*t == 'T' ||
            ((*t == 't' || *t == ' ') && !(soap->mode & SOAP_XML_STRICT))) {
        ...
        if (*t) {
            ...
            if (*t == '+' || *t == '-') {
                ...
                /* note: day of the month may be out of range, timegm() handles
                 * it */
            }
            else if (*t != 'Z') {
                return soap->error = SOAP_TYPE;
...
#ifndef WITH_LEAN
SOAP_FMAC1
time_t* SOAP_FMAC2 soap_indateTime(
    struct soap* soap, const char* tag, time_t* p, const char* type, int t)
{
    if (soap_element_begin_in(soap, tag, 0, NULL))
        return NULL;
    if (*soap->type && soap_match_tag(soap, soap->type, type) &&
    ...
    p = (time_t*)soap_id_enter(
        soap, soap->id, p, t, sizeof(time_t), NULL, NULL, NULL, NULL);
    if (!p)
        return NULL;
    if (*soap->href != '#') {
        ...
        p = (time_t*)soap_id_forward(
            soap, soap->href, p, 0, t, t, sizeof(time_t), 0, NULL, NULL);
        if (soap->body && soap_element_end_in(soap, tag))
            return NULL;
    }
    return p;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_outliteral(struct soap* soap,
                               const char*  tag,
                               char* const* p,
                               const char*  type)
{
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_outwliteral(struct soap*    soap,
                                const char*     tag,
                                wchar_t* const* p,
                                const char*     type)
{
...
#ifndef WITH_LEANER
SOAP_FMAC1
wchar_t** SOAP_FMAC2 soap_inwliteral(struct soap* soap,
                                     const char*  tag,
                                     wchar_t**    p)
{
    if (soap_element_begin_in(soap, tag, 1, NULL)) {
...
const char* SOAP_FMAC2 soap_value(struct soap* soap)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Element content value='%s'\n", soap->tmpbuf));
    if (c == SOAP_TT || c == SOAP_LT || (int)c == EOF) {
        soap_unget(soap, c);
    }
    else {
...
SOAP_FMAC1
int SOAP_FMAC2 soap_getline(struct soap* soap, char* buf, int len)
{
    char*      s = buf;
    int        i = len;
    soap_wchar c = 0;
...
static ULONG64 soap_count_attachments(struct soap* soap)
{
#ifndef WITH_LEANER
    struct soap_multipart* content;
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "Calculating the message size with attachments, "
                        "current count=" SOAP_ULONG_FORMAT "\n",
                        count));
    if ((soap->mode & SOAP_ENC_DIME) && !(soap->mode & SOAP_ENC_MTOM)) {
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug, "Calculating the size of DIME attachments\n"));
        for (content = soap->dime.first; content; content = content->next) {
            ...
            if (content->options)
                count += ((((unsigned char)content->options[2] << 8) |
                           ((unsigned char)content->options[3])) +
                          7) &
                         (~3);
            DBGLOG(
                TEST,
    ...
    if ((soap->mode & SOAP_ENC_MIME) && soap->mime.boundary) {
        ...
        DBGLOG(
            TEST,
            SOAP_MESSAGE(fdebug, "Calculating the size of MIME attachments\n"));
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "New count=" SOAP_ULONG_FORMAT "\n", count));
    return count;
#else
    return soap->count;
#endif
...
#ifndef WITH_LEANER
SOAP_FMAC1
char* SOAP_FMAC2 soap_dime_option(struct soap*   soap,
...
int SOAP_FMAC2 soap_putdimehdr(struct soap* soap)
{
    ...
    if (soap->dime.options)
        optlen = (((unsigned char)soap->dime.options[2] << 8) |
                  ((unsigned char)soap->dime.options[3])) +
                 4;
    if (soap->dime.id) {
...
int SOAP_FMAC2 soap_putdime(struct soap* soap)
{
    ...
    for (content = soap->dime.first; content; content = content->next) {
        ...
        if (soap->fdimereadopen &&
            ((handle = soap->fdimereadopen(soap,
                                           (void*)content->ptr,
                                           content->id,
                                           content->type,
            ...
            if (!size && ((soap->mode & SOAP_ENC_PLAIN) ||
                          (soap->mode & SOAP_IO) == SOAP_IO_CHUNK ||
                          (soap->mode & SOAP_IO) == SOAP_IO_STORE)) {
                size_t chunksize = sizeof(soap->tmpbuf);
                DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Chunked streaming DIME\n"));
                do {
                    size =
                        soap->fdimeread(soap, handle, soap->tmpbuf, chunksize);
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug,
                ...
                do {
                    ...
                    bufsize =
                        soap->fdimeread(soap, handle, soap->tmpbuf, bufsize);
                    if (!bufsize) {
                        DBGLOG(TEST,
                               SOAP_MESSAGE(
                                   fdebug,
                                   "fdimeread failed: insufficient data (%lu "
                                   "bytes remaining from %lu bytes)\n",
                                   (unsigned long)size,
                                   (unsigned long)content->size));
                ...
                if (soap_send_raw(
                        soap, SOAP_STR_PADDING, -(long)soap->dime.size & 3))
                    return soap->error;
            }
            DBGLOG(TEST, SOAP_MESSAGE(fdebug, "fdimereadclose\n"));
...
int SOAP_FMAC2 soap_getdimehdr(struct soap* soap)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "DIME flags=%x id='%s', type='%s', options='%s'\n",
                        soap->dime.flags,
                        soap->dime.id ? soap->dime.id : SOAP_STR_EOS,
                        soap->dime.type ? soap->dime.type : "",
                        soap->dime.options ? soap->dime.options + 4
                                           : SOAP_STR_EOS));
    if ((soap->dime.flags & SOAP_DIME_ME))
        soap->mode &= ~SOAP_ENC_DIME;
    return SOAP_OK;
...
int SOAP_FMAC2 soap_getdime(struct soap* soap)
{
    if (soap->dime.buflen || soap->dime.chunksize) {
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Skip remainder of SOAP in DIME (%u bytes or %u "
                            "bytes in chunk left)\n",
                            (unsigned int)soap->dime.buflen,
                            (unsigned int)soap->dime.chunksize));
        do
        ...
        if (soap_move(
                soap,
                (size_t)(((soap->dime.size + 3) & (~3)) - soap_tell(soap))))
            return soap->error = SOAP_CHK_EOF;
    }
    for (;;) {
        struct soap_multipart* content;
        if (soap_getdimehdr(soap))
            break;
        if (soap->fdimewriteopen &&
            ((soap->dime.ptr = (char*)soap->fdimewriteopen(
                  soap, soap->dime.id, soap->dime.type, soap->dime.options)) !=
                 NULL ||
             soap->error)) {
            ...
            for (;;) {
                ...
                for (;;) {
                    ...
                    if (size < n)
                        n = size;
                    soap->error = soap->fdimewrite(soap,
                                                   (void*)soap->dime.ptr,
                                                   soap->buf + soap->bufidx,
                                                   n);
                    if (soap->error)
            ...
            if (soap->dime.size + 1 > soap->dime.size)
                soap->blist->size++; /* allocate one more byte in blist for the
                                        terminating '\0' */
            soap->dime.ptr = soap_save_block(soap, NULL, NULL, 0);
            if (!soap->dime.ptr)
                return soap->error;
            if (soap->dime.size + 1 > soap->dime.size)
                soap->dime.ptr[soap->dime.size] =
                    '\0'; /* make 0-terminated, just in case even though this is
                             binary data */
            soap->dime.id      = id;
            soap->dime.type    = type;
            soap->dime.options = options;
...
int SOAP_FMAC2 soap_getmimehdr(struct soap* soap)
{
    ...
    if (soap_set_mime_attachment(
            soap, NULL, 0, SOAP_MIME_NONE, NULL, NULL, NULL, NULL))
        return soap->error = SOAP_EOM;
        ...
        if (val) {
            *val = '\0';
            ...
            if (!soap_tag_cmp(key, "Content-ID"))
                ...
                content->id = soap_strdup(
                    soap, soap_http_header_attribute(soap, val, "name"));
            else if (!soap_tag_cmp(key, "Content-Type"))
                ...
                content->encoding = (enum soap_mime_encoding)soap_code_int(
                    mime_codes, val, (LONG64)SOAP_MIME_NONE);
        }
...
#ifndef WITH_LEANER
SOAP_FMAC1
void SOAP_FMAC2 soap_post_check_mime_attachments(struct soap* soap)
{
...
#ifndef WITH_LEANER
SOAP_FMAC1
struct soap_multipart* SOAP_FMAC2 soap_recv_mime_attachment(struct soap* soap,
                                                            void*        handle)
{
    soap_wchar             c = 0;
    size_t                 i, m  = 0;
    ...
    if (!content) {
        ...
        if (soap->fmimewriteopen &&
            ((content->ptr = (char*)soap->fmimewriteopen(soap,
                                                         (void*)handle,
                                                         content->id,
                                                         content->type,
                                                         content->description,
    ...
    for (;;) {
            ...
            if (m > 0) {
                *s++ = *t++;
                ...
                if (flag || c == '\r') {
                    ...
                    if (soap->mime.boundary) {
                        if (soap_strncat(soap->msgbuf,
                                         sizeof(soap->msgbuf),
                                         soap->mime.boundary,
                                         sizeof(soap->msgbuf) - 4)) {
        ...
        if (content->ptr && soap->fmimewrite) {
            soap->error =
                soap->fmimewrite(soap, (void*)content->ptr, soap->tmpbuf, i);
            if (soap->error)
                break;
        }
    }
    ...
    if (content->ptr) {
        ...
        *s = '\0'; /* make 0-terminated, just in case even though this is binary
                      data */
        content->size =
            soap_size_block(soap, NULL, i + 1) - 1; /* last block with '\0' */
...
/* return UUID "<prefix>xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx" in a temporary
 * buffer */
SOAP_FMAC1
const char* SOAP_FMAC2 soap_rand_uuid(struct soap* soap, const char* prefix)
{
    int r1, r2, r3, r4;
#ifdef WITH_OPENSSL
    r1 = soap_random;
    ...
    r4 = soap_random;
    (SOAP_SNPRINTF(
         soap->tmpbuf, sizeof(soap->tmpbuf), prefix ? strlen(prefix) + 37 : 37),
     "%s%8.8x-%4.4hx-4%3.3hx-%4.4hx-%4.4hx%8.8x",
     prefix ? prefix : SOAP_STR_EOS,
     r1,
     (short)(r2 >> 16),
    ...
    if (content->id) {
        ...
        while (*xp) {
            ...
            if (!soap_match_cid(soap, xq->id, content->id)) {
                DBGLOG(TEST,
                       SOAP_MESSAGE(fdebug,
                                    "Found matching attachment id='%s' for "
                                    "content id='%s'\n",
                                    xq->id,
                                    content->id));
                *xp       = xq->next;
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_putmimehdr(struct soap*           soap,
                               struct soap_multipart* content)
{
    const char* s;
    DBGLOG(TEST,
    ...
    if (soap_send3(soap, "\r\n--", soap->mime.boundary, "\r\n"))
        return soap->error;
    if (content->type &&
        soap_send3(soap, "Content-Type: ", content->type, "\r\n"))
        return soap->error;
    s = soap_code_str(mime_codes, content->encoding);
    ...
    if (content->id && soap_send3(soap, "Content-ID: ", content->id, "\r\n"))
        return soap->error;
    if (content->location &&
        soap_send3(soap, "Content-Location: ", content->location, "\r\n"))
        return soap->error;
    if (content->description &&
        soap_send3(soap, "Content-Description: ", content->description, "\r\n"))
        return soap->error;
    return soap_send_raw(soap, "\r\n", 2);
}
#endif
...
int SOAP_FMAC2 soap_putmime(struct soap* soap)
{
    ...
    for (content = soap->mime.first; content; content = content->next) {
        void* handle;
        if (soap->fmimereadopen &&
            ((handle = soap->fmimereadopen(soap,
                                           (void*)content->ptr,
                                           content->id,
                                           content->type,
            ...
            if (!size) {
                if ((soap->mode & SOAP_ENC_PLAIN) ||
                    ...
                    (soap->mode & SOAP_IO) == SOAP_IO_STORE) {
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug, "Chunked streaming MIME\n"));
                    do {
                        size = soap->fmimeread(
                            soap, handle, soap->tmpbuf, sizeof(soap->tmpbuf));
                        DBGLOG(TEST,
                               SOAP_MESSAGE(fdebug,
                    ...
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug,
                                        "Error: cannot chunk streaming MIME "
                                        "(no HTTP chunking)\n"));
                }
            }
            else {
                do {
                    ...
                    if (size < sizeof(soap->tmpbuf))
                        ...
                        bufsize = sizeof(soap->tmpbuf);
                    bufsize =
                        soap->fmimeread(soap, handle, soap->tmpbuf, bufsize);
                    if (!bufsize) {
                        DBGLOG(TEST,
                               SOAP_MESSAGE(
                                   fdebug,
                                   "fmimeread failed: insufficient data (%lu "
                                   "bytes remaining from %lu bytes)\n",
                                   (unsigned long)size,
                                   (unsigned long)content->size));
                        soap->error = SOAP_EOF;
...
#ifndef WITH_LEANER
SOAP_FMAC1
void SOAP_FMAC2 soap_set_mime(struct soap* soap,
                              const char*  boundary,
                              const char*  start)
{
...
#ifndef WITH_LEANER
static int soap_begin_attachments(struct soap* soap)
{
    if ((soap->mode & SOAP_ENC_MIME) && soap->mime.boundary &&
        soap->mime.start) {
        const char* s;
        if (strlen(soap->mime.boundary) + strlen(soap->mime.start) + 140 >
            sizeof(soap->tmpbuf))
            return soap->error = SOAP_EOM;
        if ((soap->mode & SOAP_ENC_DIME) && !(soap->mode & SOAP_ENC_MTOM)) {
            s = "application/dime";
    ...
    if ((soap->mode & SOAP_IO_LENGTH))
        soap->dime.size =
            (size_t)
                soap->count; /* DIME in MIME correction, soap->count is small */
...
static int soap_end_attachments(struct soap* soap)
{
    if ((soap->mode & SOAP_IO_LENGTH) && (soap->mode & SOAP_ENC_DIME) &&
        ...
        if (soap->count > 0xFFFFFFFF)
            return soap->error = SOAP_DIME_ERROR;
        soap->dime.size =
            (size_t)soap->count - soap->dime.size; /* DIME in MIME correction */
        (SOAP_SNPRINTF(
             soap->id, sizeof(soap->id), strlen(soap->dime_id_format) + 20),
         soap->dime_id_format,
         0);
        ...
        if (!soap->dime.first)
            soap->dime.flags |= SOAP_DIME_ME;
        soap->count +=
            12 + ((strlen(soap->dime.id) + 3) & (~3)) +
            (soap->dime.type ? ((strlen(soap->dime.type) + 3) & (~3)) : 0);
    }
    if ((soap->mode & SOAP_ENC_DIME) && !(soap->mode & SOAP_ENC_MTOM))
...
soap_alloc_multipart(struct soap*            soap,
                     ...
                     size_t                  size)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        ...
                        (void*)ptr,
                        (unsigned long)size));
    content = (struct soap_multipart*)soap_malloc(
        soap, sizeof(struct soap_multipart));
    if (content) {
        content->next        = NULL;
        content->ptr         = ptr;
        content->size        = size;
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_set_dime_attachment(struct soap*   soap,
                                        const char*    ptr,
                                        size_t         size,
                                        const char*    type,
                                        const char*    id,
                                        ...
                                        const char*    option)
{
    struct soap_multipart* content = soap_alloc_multipart(
...
#ifndef WITH_LEANER
SOAP_FMAC1
int SOAP_FMAC2 soap_set_mime_attachment(struct soap*            soap,
                                        const char*             ptr,
                                        size_t                  size,
...
#ifndef WITH_LEANER
SOAP_FMAC1
struct soap_multipart* SOAP_FMAC2
...
SOAP_FMAC1
int SOAP_FMAC2 soap_begin_serve(struct soap* soap)
{
#ifdef WITH_FASTCGI
    if (FCGI_Accept() < 0) {
        soap->error = SOAP_EOF;
    ...
    *soap->endpoint      = '\0';
...
#ifndef UNDER_CE
#ifndef WITH_FASTCGI
    if (!soap_valid_socket(soap->socket) && !soap->is &&
        soap->recvfd >= 0) /* Set win32 stdin or soap->recvfd to BINARY, e.g. to
                              support DIME */
#ifdef __BORLANDC__
...
#endif
#ifndef WITH_LEANER
    if (soap->fprepareinitrecv &&
        (soap->error = soap->fprepareinitrecv(soap)) != SOAP_OK)
        return soap->error;
#endif
    c = soap_getchar(soap);
#ifdef WITH_GZIP
    if (c == 0x1F) {
        ...
        if (inflateInit2(soap->d_stream, -MAX_WBITS) != Z_OK)
            return soap->error = SOAP_ZLIB_ERROR;
        if (soap->z_dict) {
            if (inflateSetDictionary(soap->d_stream,
                                     (const Bytef*)soap->z_dict,
                                     soap->z_dict_len) != Z_OK)
                return soap->error = SOAP_ZLIB_ERROR;
        }
    ...
    else if ((c & 0xFFFC) == (SOAP_DIME_VERSION | SOAP_DIME_MB) &&
             (soap_get0(soap) & 0xFFF0) == 0x20) {
        soap->mode |= SOAP_ENC_DIME;
    }
    else
#endif
    ...
    if (((c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z')) &&
        !(soap->mode &
          (SOAP_ENC_MIME | SOAP_ENC_DIME | SOAP_ENC_ZLIB | SOAP_ENC_PLAIN))) {
...
#endif
#ifndef WITH_LEANER
        if (soap->fpreparerecv && (soap->mode & SOAP_IO) != SOAP_IO_CHUNK &&
            soap->buflen > soap->bufidx) {
            int r;
            DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Invoking fpreparerecv\n"));
            r = soap->fpreparerecv(
                soap, soap->buf + soap->bufidx, soap->buflen - soap->bufidx);
            if (r)
                return soap->error = r;
        }
#endif
        if (soap->error && soap->error < SOAP_STOP) {
            if (soap->status >= 200 && soap->status < 600) {
                ...
                return soap_set_receiver_error(
                    soap, "HTTP Error", s, soap->status);
            }
            return soap->error;
        }
        if (!soap->body && soap->status >= 200 && soap->status < 600)
            return soap->error =
                       soap->status; /* client side received HTTP status code */
        if (soap->status > SOAP_POST) {
            soap->fform = NULL;
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Invoking http method handler\n"));
            switch (soap->status) {
            case SOAP_GET:
            ...
            if (soap->error == SOAP_OK)
                return soap->error =
                           SOAP_STOP; /* prevents further processing */
            if (soap->error != SOAP_FORM ||
                !soap->fform) /* continue if handler returned SOAP_FORM */
                return soap->error;
            soap->error = SOAP_OK;
        }
        if (soap->fform) {
            ...
            if (soap->error == SOAP_OK)
                return soap->error =
                           SOAP_STOP; /* prevents further processing */
            if (soap->status != SOAP_POST ||
                soap->error != 404) /* continue with POST if handler returned
                                       HTTP not found */
                return soap->error;
            soap->error = SOAP_OK;
        }
        ...
        if (soap->mime.start) {
            do {
                if (!soap->mime.last->id)
                    break;
                if (!soap_match_cid(
                        soap, soap->mime.start, soap->mime.last->id))
                    break;
            } while (soap_recv_mime_attachment(soap, NULL));
        }
        if (soap_http_header_attribute(
                soap, soap->mime.first->type, "application/dime"))
            soap->mode |= SOAP_ENC_DIME;
    }
    if ((soap->mode & SOAP_ENC_DIME)) {
        if (soap_getdimehdr(soap))
        ...
        if ((soap->dime.flags & SOAP_DIME_CF)) {
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Chunked SOAP in DIME message\n"));
            soap->dime.chunksize = soap->dime.size;
            if (soap->buflen - soap->bufidx >= soap->dime.chunksize) {
                soap->dime.buflen = soap->buflen;
                soap->buflen      = soap->bufidx + soap->dime.chunksize;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_http_has_body(struct soap* soap)
{
    return soap->length || (soap->mode & SOAP_ENC_ZLIB) ||
           (soap->mode & SOAP_IO) == SOAP_IO_CHUNK;
}
...
SOAP_FMAC1
int SOAP_FMAC2 soap_http_skip_body(struct soap* soap)
{
    ...
    DBGLOG(
        TEST,
        SOAP_MESSAGE(fdebug, "Skipping HTTP body (mode=0x%x)\n", soap->mode));
    if (k && !(soap->mode & SOAP_ENC_ZLIB)) {
        size_t i;
        soap->length = 0;
        for (i = 0; i < k; i++) {
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_http_get_body(struct soap* soap, size_t* len)
{
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_http_get_form(struct soap* soap)
{
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_http_get_body_prefix(struct soap* soap,
                                           size_t*      len,
                                           const char*  prefix)
{
    char*   s;
    ...
    if (k && !(soap->mode & SOAP_ENC_ZLIB)) {
        ...
        if ((SOAP_MAXALLOCSIZE != 0 && n + k > SOAP_MAXALLOCSIZE) ||
            n + k > (ULONG64)((size_t)-2)) {
            soap->error = SOAP_EOM;
            return NULL;
        }
        ...
        if (soap->error == SOAP_TAG_MISMATCH) {
            if (!soap_element_begin_in(soap, "Envelope", 0, NULL))
                soap->error = SOAP_VERSIONMISMATCH;
                     ...
                     soap->status == 400 || soap->status == 500)
                return SOAP_OK; /* allow non-SOAP (REST) XML content to be
                                   captured */
...
int SOAP_FMAC2 soap_body_begin_out(struct soap* soap)
{
    if (soap->version == 1)
        soap->encoding = 1;
#ifndef WITH_LEAN
    if ((soap->mode & SOAP_SEC_WSUID) &&
        soap_set_attr(soap, "wsu:Id", "Body", 1))
        return soap->error;
#endif
    if (soap->version == 0)
        return SOAP_OK;
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_GET(struct soap* soap,
                        const char*  endpoint,
                        const char*  action)
{
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_PUT(struct soap* soap,
                        const char*  endpoint,
                        const char*  action,
                        const char*  type)
{
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_POST(struct soap* soap,
                         const char*  endpoint,
                         const char*  action,
                         const char*  type)
{
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_PATCH(struct soap* soap,
                          const char*  endpoint,
                          const char*  action,
                          const char*  type)
{
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_DELETE(struct soap* soap, const char* endpoint)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_connect(struct soap* soap,
                            const char*  endpoint,
                            const char*  action)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_connect_command(struct soap* soap,
                                    int          http_command,
    ...
    if (endpoints) {
        ...
        for (;;) {
            ...
            if (s) {
                ...
                for (;;) {
                    (void)soap_strncpy(
                        endpoint, l + 1, endpoints, s - endpoints);
                    endpoint[s - endpoints] = '\0';
                    if (soap_try_connect_command(
                            soap, http_command, endpoint, action) !=
                        SOAP_TCP_ERROR)
                        break;
                    while (*s == ' ')
                        s++;
...
static int soap_try_connect_command(struct soap* soap,
                                    int          http_command,
                                    const char*  endpoint,
                                    const char*  action)
{
    ...
    (void)soap_memcpy(
        ...
        sizeof(host),
        soap->host,
        sizeof(soap->host)); /* save previous host name: if != then reconnect */
    ...
    if (soap->fconnect) {
        ...
        if (!soap->keep_alive || !soap_valid_socket(soap->socket) ||
            strcmp(soap->host, host) || soap->port != port || !soap->fpoll ||
            soap->fpoll(soap)) {
            soap->error = SOAP_OK;
#ifndef WITH_LEAN
            if (!strncmp(endpoint, "soap.udp:", 9) ||
                !strncmp(endpoint, "udp:", 4)) {
                soap->omode |= SOAP_IO_UDP;
            }
            else
#endif
            ...
            if (!soap->keep_alive || !soap_valid_socket(soap->socket)) {
                soap->socket =
                    soap->fopen(soap, endpoint, soap->host, soap->port);
    ...
    if (http_command == SOAP_GET || http_command == SOAP_DEL ||
        http_command == SOAP_HEAD || http_command == SOAP_OPTIONS) {
        soap->mode &= ~SOAP_IO;
        soap->mode |= SOAP_IO_BUFFER;
    }
    if ((soap->mode & SOAP_IO) != SOAP_IO_STORE &&
        !(soap->mode & SOAP_ENC_PLAIN) && endpoint) {
        soap_mode k = soap->mode;
        soap->mode &= ~(SOAP_IO | SOAP_ENC_ZLIB);
        if ((k & SOAP_IO) != SOAP_IO_FLUSH)
            soap->mode |= SOAP_IO_BUFFER;
        soap->error = soap->fpost(
            soap, endpoint, soap->host, soap->port, soap->path, action, count);
        if (soap->error)
            return soap->error;
        if ((k & SOAP_IO) == SOAP_IO_CHUNK) {
            if (soap_flush(soap))
                               ...
                               int          port)
{
    ...
    const char* userid =
        (soap->proxy_userid ? soap->proxy_userid : soap->userid);
    const char* passwd =
        (soap->proxy_passwd ? soap->proxy_passwd : soap->passwd);
    ...
    if (soap->ntlm_challenge && userid && passwd && soap->authrealm) {
        ...
        if (!*soap->ntlm_challenge) {
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                "NTLM S->C Type 1: received NTLM "
                                "authentication challenge from server\n"));
            /* S -> C   401 Unauthorized
                        WWW-Authenticate: NTLM
            */
            buildSmbNtlmAuthRequest(&req, userid, soap->authrealm);
            soap->ntlm_challenge = soap_s2base64(
                soap, (unsigned char*)(void*)&req, NULL, SmbLength(&req));
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug,
                                "NTLM C->S Type 2: sending NTLM authorization "
            ...
            */
            ...
            if (soap->fpost(
                    soap, endpoint, host, port, soap->path, soap->action, 0) ||
        ...
        */
        ...
        soap->ntlm_challenge = soap_s2base64(
            soap, (unsigned char*)(void*)&res, NULL, SmbLength(&res));
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "NTLM C->S Type 3: sending NTLM authorization to "
                            "server\nAuthorization: NTLM %s\n",
                            soap->ntlm_challenge));
        /* C -> S   GET ...
                    Authorization: NTLM
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_s2base64(struct soap*         soap,
                               ...
                               int                  n)
{
    ...
    t[0] = '\0';
    if (n > 0) /* 0 < n <= 2 implies that t[0..4] is allocated (base64 scaling
                  formula) */
    {
        m = 0;
        for (i = 0; i < n; i++)
...
SOAP_FMAC1
char* SOAP_FMAC2 soap_s2hex(struct soap*         soap,
                            const unsigned char* s,
                            char*                t,
                            int                  n)
{
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
const char* SOAP_FMAC2 soap_http_content_type(struct soap* soap, int status)
{
    if (soap->status != SOAP_GET && soap->status != SOAP_DEL &&
        soap->status != SOAP_CONNECT) {
...
#endif
        if (((status >= SOAP_FILE && status < SOAP_FILE + 600) ||
             soap->status == SOAP_PUT || soap->status == SOAP_POST_FILE ||
             soap->status == SOAP_PATCH) &&
            soap->http_content && *soap->http_content &&
            !strchr(soap->http_content, 10) && !strchr(soap->http_content, 13))
            s = soap->http_content;
        else if (status == SOAP_HTML)
            s = "text/html; charset=utf-8";
        else if (soap->version == 2)
            s = "application/soap+xml; charset=utf-8";
        soap->http_content = NULL; /* use http_content once (assign new value
                                      before each call) */
#ifndef WITH_LEANER
        ...
        if ((soap->mode & SOAP_ENC_MIME) && soap->mime.boundary) {
            ...
            if (sizeof(soap->tmpbuf) > l + n)
                (void)soap_strncpy(
                    soap->tmpbuf + l, sizeof(soap->tmpbuf) - l, s, n);
            if (soap->mime.start) {
                l = strlen(soap->tmpbuf);
                (SOAP_SNPRINTF(soap->tmpbuf + l,
                               sizeof(soap->tmpbuf) - l,
                               strlen(soap->mime.start) + 10),
                 "\"; start=\"%s",
                 soap->mime.start);
            }
            if (r) {
        ...
        if (status == SOAP_OK && soap->version == 2 && soap->action) {
            ...
            (SOAP_SNPRINTF(soap->tmpbuf + l, sizeof(soap->tmpbuf) - l, n + 11),
             "; action=\"%s\"",
             soap->action);
        }
#else
...
#ifndef WITH_NOHTTP
SOAP_FMAC1
int SOAP_FMAC2 soap_puthttphdr(struct soap* soap, int status, ULONG64 count)
{
    int err = SOAP_OK;
...
#ifdef WITH_GZIP
            err = soap->fposthdr(soap,
                                 "Content-Encoding",
                                 soap->zlib_out == SOAP_ZLIB_DEFLATE ? "deflate"
                                                                     : "gzip");
#else
    ...
    if (soap->http_extra_header) {
        ...
        soap->http_extra_header = NULL; /* use http_extra_header once (assign
                                           new value before each call) */
        if (*header) {
...
soap_set_validation_fault(struct soap* soap, const char* s, const char* t)
{
    if (!t)
        t = SOAP_STR_EOS;
    if (*soap->tag)
        (SOAP_SNPRINTF(soap->msgbuf,
                       sizeof(soap->msgbuf),
                       strlen(s) + strlen(t) + strlen(soap->tag) + 47),
        ...
        (SOAP_SNPRINTF(
             soap->msgbuf, sizeof(soap->msgbuf), strlen(s) + strlen(t) + 33),
...
void SOAP_FMAC2 soap_set_fault(struct soap* soap)
{
    ...
    case SOAP_TAG_MISMATCH:
        *s = soap_set_validation_fault(
            soap, "tag name or namespace mismatch", NULL);
        break;
    case SOAP_TYPE:
        if (*soap->type)
    ...
    case SOAP_MUSTUNDERSTAND:
        *c = "SOAP-ENV:MustUnderstand";
        (SOAP_SNPRINTF(
             soap->msgbuf, sizeof(soap->msgbuf), strlen(soap->tag) + 65),
         "The data in element '%s' must be understood but cannot be processed",
         soap->tag);
        *s = soap->msgbuf;
        break;
    ...
    case SOAP_NO_METHOD:
        (SOAP_SNPRINTF(
             soap->msgbuf, sizeof(soap->msgbuf), strlen(soap->tag) + 66),
    ...
    case SOAP_DUPLICATE_ID:
        *s = soap_set_validation_fault(
            soap,
            "multiple elements (use the SOAP_XML_TREE flag) with duplicate id ",
            soap->id);
        if (soap->version == 2)
    ...
    case SOAP_HREF:
        *s = soap_set_validation_fault(
            soap, "incompatible object type id-ref ", soap->id);
        break;
    case SOAP_FAULT:
        break;
#ifndef WITH_NOIO
    ...
    case SOAP_DIME_ERROR:
        *s = "DIME format error or max DIME size exceeds SOAP_MAXDIMESIZE "
             "currently set to " SOAP_XSTRINGIFY(SOAP_MAXDIMESIZE);
        break;
    case SOAP_DIME_HREF:
    ...
    case SOAP_ZLIB_ERROR:
        ...
        (SOAP_SNPRINTF(soap->msgbuf,
                       sizeof(soap->msgbuf),
                       (soap->d_stream && soap->d_stream->msg
                            ? strlen(soap->d_stream->msg)
                            : 0) +
                           19),
         "Zlib/gzip error: '%s'",
         soap->d_stream && soap->d_stream->msg ? soap->d_stream->msg
                                               : SOAP_STR_EOS);
        *s = soap->msgbuf;
#else
        *s = "Zlib/gzip not installed for (de)compression: recompile with "
             "-DWITH_GZIP";
#endif
        break;
    case SOAP_REQUIRED:
        *s =
            soap_set_validation_fault(soap, "missing required attribute", NULL);
        break;
    case SOAP_PROHIBITED:
        *s = soap_set_validation_fault(
            soap, "prohibited attribute present", NULL);
        break;
    case SOAP_LEVEL:
    ...
    case SOAP_LENGTH:
        *s = soap_set_validation_fault(
            soap, "value range or content length violation", NULL);
        break;
    case SOAP_OCCURS:
        *s = soap_set_validation_fault(
            soap, "occurrence constraint violation", NULL);
        break;
    case SOAP_FIXED:
        *s = soap_set_validation_fault(
            soap, "value does not match the fixed value required", NULL);
        break;
    case SOAP_EMPTY:
        *s = soap_set_validation_fault(
            soap, "empty value provided where a value is required", NULL);
        break;
    case SOAP_FD_EXCEEDED:
        *s = "Maximum number of open connections was reached: increase "
             "FD_SETSIZE or define HAVE_POLL";
        break;
    case SOAP_UTF_ERROR:
    ...
    case SOAP_EOF:
        ...
        *s = soap_strerror(soap); /* *s = soap->msgbuf */
        ...
        if (strlen(soap->msgbuf) + 25 < sizeof(soap->msgbuf)) {
            (void)soap_memmove((void*)(soap->msgbuf + 25),
                               sizeof(soap->tmpbuf) - 25,
                               (const void*)soap->msgbuf,
                               strlen(soap->msgbuf) + 1);
            if (soap->is)
#if defined(__cplusplus) && !defined(WITH_COMPAT)
                (void)soap_memcpy((void*)soap->msgbuf,
                                  sizeof(soap->msgbuf),
                                  (const void*)"End or bad std::istream: ",
                                  25);
#else
                (void)soap_memcpy((void*)soap->msgbuf,
                                  sizeof(soap->msgbuf),
                                  (const void*)"End at NUL buffer input: ",
                                  25);
#endif
            else
                (void)soap_memcpy((void*)soap->msgbuf,
                                  sizeof(soap->msgbuf),
                                  (const void*)"End of file or no input: ",
                                  25);
        }
#endif
        break;
    ...
    default:
        ...
        if (soap->error >= 200 && soap->error < 600) {
            ...
            (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(t) + 54),
             "Error %d: HTTP %d %s",
             soap->error,
             soap->error,
             t);
...
#endif
        {
            (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), 26),
             "Error %d",
             soap->error);
            *s = soap->msgbuf;
        }
...
int SOAP_FMAC2 soap_send_fault(struct soap* soap)
{
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        ...
                        soap->error));
    soap->keep_alive =
        0; /* error: close connection later by disabling keep-alive here */
    soap_set_fault(soap);
    ...
    if (status != SOAP_EOF || (!soap->recv_timeout && !soap->send_timeout)) {
        ...
        if (soap->fpoll && soap->fpoll(soap)) {
            ...
            r = tcp_select(soap,
                           soap->socket,
                           SOAP_TCP_SELECT_RCV | SOAP_TCP_SELECT_SND,
                           0);
            if (r > 0) {
                int t;
            ...
            if (soap->version > 0) {
                ...
                if ((soap->mode & SOAP_IO_LENGTH)) {
                    if (soap_envelope_begin_out(soap) || soap_putheader(soap) ||
                        soap_body_begin_out(soap) || soap_putfault(soap) ||
                ...
                if ((soap->mode & SOAP_IO_LENGTH))
                    if (soap_element_begin_out(soap, "fault", 0, NULL) ||
                        soap_outstring(
                            soap, "reason", 0, (char* const*)&s, NULL, 0) ||
                        (d && *d &&
                         soap_outliteral(
                             soap, "detail", (char* const*)d, NULL)) ||
                ...
                if (soap_response(soap, status) ||
                    ...
                    soap_element_end_out(soap, "fault") || soap_end_send(soap))
                    return soap_closesock(soap);
            }
        }
    }
...
SOAP_FMAC1
int SOAP_FMAC2 soap_recv_fault(struct soap* soap, int check)
{
    int status = soap->status;
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        ...
                        status));
    if (!check) {
        /* try getfault when no tag or tag mismatched at level 2, otherwise
         * close and return SOAP_TAG_MISMATCH or HTTP error code */
        if (soap->error != SOAP_NO_TAG &&
            ...
            if (soap->error == SOAP_TAG_MISMATCH && soap->level == 0) {
                ...
                if (!soap_element_begin_in(soap, "fault", 0, NULL)) {
                    char *s = NULL, *d = NULL;
                    (void)soap_instring(
                        soap, "reason", &s, NULL, 0, 1, 0, -1, NULL);
                    (void)soap_inliteral(soap, "detail", &d);
                    if (!soap_element_end_in(soap, "fault") &&
                        !soap_end_recv(soap)) {
    ...
    if (soap_getfault(soap)) {
        /* if check>0 and no SOAP Fault is present and no HTTP error then just
         * return to parse request */
        if (check && (status == 0 || (status >= 200 && status <= 299)) &&
            ((soap->error == SOAP_TAG_MISMATCH && soap->level == 2) ||
             soap->error == SOAP_NO_TAG))
            return soap->error = SOAP_OK;
        /* if check=0 and empty SOAP Body and encodingStyle is NULL and no HTTP
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Error: soap_get_soapfault() failed with error %d "
                            "at level %u tag '%s'\n",
                            soap->error,
                            soap->level,
                            soap->tag));
        *soap_faultcode(soap) =
        ...
        if (!soap_match_tag(soap, s, "SOAP-ENV:Server") ||
            ...
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Received SOAP Fault code %s\n", s));
            status = SOAP_FAULT;
        }
...
int SOAP_FMAC2 soap_send_empty_response(struct soap* soap, int httpstatuscode)
{
    ...
    if (!(m & SOAP_IO_UDP)) {
        ...
        soap->error =
            SOAP_STOP; /* stops the server from returning another response */
        soap->omode = m;
    }
    return soap_closesock(soap);
}
...
int SOAP_FMAC2 soap_recv_empty_response(struct soap* soap)
{
    ...
    if (!(soap->omode & SOAP_IO_UDP) && !(soap->omode & SOAP_ENC_PLAIN)) {
        ...
        else if (soap->error == 200 || soap->error == 201 ||
                 soap->error == 202) {
            soap->error = SOAP_OK;
        }
    }
#ifndef WITH_LEANER
    else if ((soap->fprepareinitrecv &&
              (soap->error = soap->fprepareinitrecv(soap))) ||
             (soap->fpreparefinalrecv &&
    ...
    *soap->msgbuf = '\0';
    ...
    (!_GNU_SOURCE &&                                                           \
     ...
     defined(__ANDROID__) || !defined(__GLIBC__))
        err = strerror_r(
            err, soap->msgbuf, sizeof(soap->msgbuf)); /* XSI-compliant */
        if (err != 0)
            soap_strcpy(soap->msgbuf, sizeof(soap->msgbuf), "unknown error");
#else
        return strerror_r(
            err, soap->msgbuf, sizeof(soap->msgbuf)); /* GNU-specific */
#endif
#else
        return strerror(err);
#endif
        ...
        *soap->msgbuf = '\0';
        len           = FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM |
                            ...
                            0,
                            (LPTSTR)soap->msgbuf,
                            (DWORD)(sizeof(soap->msgbuf) / sizeof(TCHAR)),
                            NULL);
        for (i = 0; i <= len; i++) {
        ...
        if (soap->recv_maxlength && soap->count > soap->recv_maxlength) {
            soap_strcpy(soap->msgbuf,
                        sizeof(soap->msgbuf),
                        "max message length exceeded");
        }
        else {
            int tt = soap->transfer_timeout, rt = soap->recv_timeout,
                st = soap->send_timeout;
#ifndef WITH_LEAN
            int tu = ' ', ru = ' ', su = ' ';
#endif
            soap_strcpy(soap->msgbuf,
            ...
            if (tt | rt || st)
                soap_strcpy(soap->msgbuf + 28,
                            sizeof(soap->msgbuf) - 28,
                            " or timed out");
#ifndef WITH_LEAN
            if (tt < 0) {
                tt = -tt;
            ...
            if (tt) {
                size_t l = strlen(soap->msgbuf);
                (SOAP_SNPRINTF(soap->msgbuf + l, sizeof(soap->msgbuf) - l, 43),
                 " (%d%csec max transfer time)",
                 tt,
                 tu);
            }
            if (rt) {
                size_t l = strlen(soap->msgbuf);
                (SOAP_SNPRINTF(soap->msgbuf + l, sizeof(soap->msgbuf) - l, 40),
                 " (%d%csec max recv delay)",
                 rt,
                 ru);
            }
            if (st) {
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_sender_error(struct soap* soap,
                                     const char*  faultstring,
                                     const char*  faultdetailXML,
                                     int          soaperror)
{
    return soap_set_error(soap,
                          soap->version == 2   ? "SOAP-ENV:Sender"
                          : soap->version == 1 ? "SOAP-ENV:Client"
                                               : "at sender",
                          NULL,
                          faultstring,
                          faultdetailXML,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_receiver_error(struct soap* soap,
                                       const char*  faultstring,
                                       const char*  faultdetailXML,
                                       int          soaperror)
{
    return soap_set_error(soap,
                          soap->version == 2   ? "SOAP-ENV:Receiver"
                          : soap->version == 1 ? "SOAP-ENV:Server"
                                               : "detected",
                          NULL,
                          faultstring,
                          faultdetailXML,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_sender_fault(struct soap* soap,
                                 const char*  faultstring,
                                 const char*  faultdetailXML)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_sender_fault_subcode(struct soap* soap,
                                         const char*  faultsubcodeQName,
                                         const char*  faultstring,
                                         const char*  faultdetailXML)
{
    return soap_copy_fault(soap,
                           soap->version == 2   ? "SOAP-ENV:Sender"
                           : soap->version == 1 ? "SOAP-ENV:Client"
                                                : "at source",
                           faultsubcodeQName,
...
SOAP_FMAC1
int SOAP_FMAC2 soap_receiver_fault(struct soap* soap,
                                   const char*  faultstring,
                                   const char*  faultdetailXML)
{
...
SOAP_FMAC1
int SOAP_FMAC2 soap_receiver_fault_subcode(struct soap* soap,
                                           const char*  faultsubcodeQName,
                                           const char*  faultstring,
                                           const char*  faultdetailXML)
{
...
void SOAP_FMAC2 soap_stream_fault(struct soap* soap, std::ostream& os)
{
    if (soap_check_state(soap)) {
        ...
        os << (soap->version ? "SOAP 1." : "Error ")
           << (soap->version ? (int)soap->version : soap->error) << " fault "
           << *c << "[" << (v ? v : "no subcode") << "]" << std::endl
...
char* SOAP_FMAC2 soap_sprint_fault(struct soap* soap, char* buf, size_t len)
{
    if (soap_check_state(soap)) {
        ...
        if (!d)
            d = "[no detail]";
        (SOAP_SNPRINTF(
             buf, len, strlen(*c) + strlen(v) + strlen(s) + strlen(d) + 72),
         "%s%d fault %s [%s]\n\"%s\"\nDetail: %s\n",
         soap->version ? "SOAP 1." : "Error ",
         soap->version ? (int)soap->version : soap->error,
         *c,
...
#ifndef WITH_LEAN
    int i, j, c1, c2;
    if (soap_check_state(soap) == SOAP_OK && soap->error &&
        soap->error != SOAP_STOP && soap->bufidx <= soap->buflen &&
        soap->buflen > 0 && soap->buflen <= sizeof(soap->buf)) {
        i = (int)soap->bufidx - 1;
        if (i <= 0)
            i = 0;
        c1           = soap->buf[i];
...
#ifndef WITH_COMPAT
SOAP_FMAC1
void SOAP_FMAC2 soap_stream_fault_location(struct soap* soap, std::ostream& os)
{
    int i, j, c1, c2;
    if (soap_check_state(soap) == SOAP_OK && soap->error &&
        soap->error != SOAP_STOP && soap->bufidx <= soap->buflen &&
...
SOAP_FMAC1
int SOAP_FMAC2 soap_register_plugin_arg(struct soap* soap,
                                        ...
                                        void* arg)
{
    ...
    if (!err && p->fdelete && p->id) {
        if (!soap_lookup_plugin(soap, p->id)) {
            ...
            soap->plugins = p;
            DBGLOG(TEST,
                   SOAP_MESSAGE(fdebug, "Registered '%s' plugin\n", p->id));
            return SOAP_OK;
        }
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug,
                            "Could not register plugin '%s': plugin with the "
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug,
                        "Could not register plugin '%s': plugin returned error "
                        "%d or plugin ID not set or fdelete callback not set\n",
                        p->id ? p->id : "plugin ID not set",
                        err));
    SOAP_FREE(soap, p);
...
SOAP_FMAC1
void* SOAP_FMAC2 soap_lookup_plugin(struct soap* soap, const char* id)
{
...
{
    soap_init(this);
    /* no logs to prevent DEBUG mode leaks when the user calls a soap_init() on
     * this context */
