...
extern "C" SOAP_FMAC5 int SOAP_FMAC6 soap_serve(struct soap* soap)
{
    ...
    do {
        ...
        if ((soap_serve_request(soap) ||
            ...
            soap->error && soap->error < SOAP_STOP) {
#ifdef WITH_FASTCGI
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns1__executeCommand(struct soap* soap)
{
    ...
    soap_default_ns1__executeCommandResponse(
        soap, &soap_tmp_ns1__executeCommandResponse);
    ...
    if (!soap_get_ns1__executeCommand(
            soap, &soap_tmp_ns1__executeCommand, "ns1:executeCommand", NULL))
        return soap->error;
    if (soap_body_end_in(soap) || soap_envelope_end_in(soap) ||
        soap_end_recv(soap))
        return soap->error;
    soap->error =
        ns1__executeCommand(soap,
                            soap_tmp_ns1__executeCommand.command,
                            soap_tmp_ns1__executeCommandResponse.result);
    if (soap->error)
        return soap->error;
    ...
    if ((soap->mode & SOAP_IO_LENGTH)) {
        if (soap_envelope_begin_out(soap) || soap_putheader(soap) ||
            ...
            soap_put_ns1__executeCommandResponse(
                soap,
                &soap_tmp_ns1__executeCommandResponse,
