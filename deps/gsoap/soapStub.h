...
#error                                                                         \
    "GSOAP VERSION 208105 MISMATCH IN GENERATED CODE VERSUS LIBRARY CODE: PLEASE REINSTALL PACKAGE"
#endif
...
public:
    ...
    /** Friend allocator */
    friend SOAP_FMAC1 ns1__executeCommandResponse* SOAP_FMAC2
...
public:
    ...
    /** Friend allocator */
    friend SOAP_FMAC1 ns1__executeCommand* SOAP_FMAC2
...
public:
    ...
    SOAP_ENV__Header() {}
    /** Friend allocator */
    friend SOAP_FMAC1 SOAP_ENV__Header* SOAP_FMAC2
...
/* Type SOAP_ENV__Code is a recursive data type, (in)directly referencing itself
 * through its (base or derived class) members */
/* SOAP_ENV__Code: */
...
public:
    ...
    /** Friend allocator */
    friend SOAP_FMAC1 SOAP_ENV__Code* SOAP_FMAC2
...
public:
    char* __any;
    /** Any type of element 'fault' assigned to fault with its
     * SOAP_TYPE_<typename> assigned to __type */
    /** Do not create a cyclic data structure through this member unless SOAP
     * encoding or SOAP_XML_GRAPH are used for id-ref serialization */
    int   __type;
    void* fault;
...
public:
    ...
    /** Friend allocator */
    friend SOAP_FMAC1 SOAP_ENV__Detail* SOAP_FMAC2
...
public:
    ...
    /** Friend allocator */
    friend SOAP_FMAC1 SOAP_ENV__Reason* SOAP_FMAC2
...
public:
    ...
    /** Constructor with member initializations */
    SOAP_ENV__Fault()
        : faultcode(), faultstring(), faultactor(), detail(), SOAP_ENV__Code(),
          SOAP_ENV__Reason(), SOAP_ENV__Node(), SOAP_ENV__Role(),
          SOAP_ENV__Detail()
    {
    }
    /** Friend allocator */
    friend SOAP_FMAC1 SOAP_ENV__Fault* SOAP_FMAC2
...
/* struct ns1__executeCommand has binding name 'ns1__executeCommand' for type
 * 'ns1:executeCommand' */
#ifndef SOAP_TYPE_ns1__executeCommand
#define SOAP_TYPE_ns1__executeCommand (10)
#endif

/* struct ns1__executeCommandResponse has binding name
 * 'ns1__executeCommandResponse' for type 'ns1:executeCommandResponse' */
#ifndef SOAP_TYPE_ns1__executeCommandResponse
#define SOAP_TYPE_ns1__executeCommandResponse (9)
#endif

/* struct SOAP_ENV__Reason * has binding name 'PointerToSOAP_ENV__Reason' for
 * type '' */
#ifndef SOAP_TYPE_PointerToSOAP_ENV__Reason
#define SOAP_TYPE_PointerToSOAP_ENV__Reason (20)
#endif

/* struct SOAP_ENV__Detail * has binding name 'PointerToSOAP_ENV__Detail' for
 * type '' */
...
/** Web service operation 'ns1__executeCommand' implementation, should return
