...
soap_instantiate(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 int SOAP_FMAC4 soap_fdelete(struct soap* soap, struct soap_clist*);
SOAP_FMAC3 int SOAP_FMAC4 soap_fbase(int, int);
SOAP_FMAC3 void SOAP_FMAC4
soap_finsert(struct soap*, int, int, void*, size_t, const void*, void**);
...
inline int soap_write_byte(struct soap* soap, char const* p)
{
    soap_free_temp(soap);
    if (p) {
        if (soap_begin_send(soap) || ::soap_put_byte(soap, p, "byte", "") ||
            soap_end_send(soap))
            return soap->error;
    }
    return SOAP_OK;
...
{
    soap_free_temp(soap);
    if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_byte(soap, p, "byte", "") || soap_end_send(soap) ||
...
{
    soap_free_temp(soap);
    if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_byte(soap, p, "byte", "") || soap_end_send(soap) ||
        soap_recv_empty_response(soap))
        return soap_closesock(soap);
    return SOAP_OK;
...
inline int
soap_POST_send_byte(struct soap* soap, const char* URL, char const* p)
{
    soap_free_temp(soap);
    if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_byte(soap, p, "byte", "") || soap_end_send(soap))
        return soap_closesock(soap);
    return SOAP_OK;
}
...
inline int soap_write_int(struct soap* soap, int const* p)
{
    soap_free_temp(soap);
    if (p) {
        if (soap_begin_send(soap) || ::soap_put_int(soap, p, "int", "") ||
            soap_end_send(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_PUT_int(struct soap* soap, const char* URL, int const* p)
{
    soap_free_temp(soap);
    if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_int(soap, p, "int", "") || soap_end_send(soap) ||
        soap_recv_empty_response(soap))
        return soap_closesock(soap);
    return SOAP_OK;
}
...
inline struct SOAP_ENV__Fault*
soap_new_set_SOAP_ENV__Fault(struct soap*             soap,
                             char*                    faultcode,
                             char*                    faultstring,
                             char*                    faultactor,
...
inline int soap_write_SOAP_ENV__Fault(struct soap*                  soap,
                                      struct SOAP_ENV__Fault const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_SOAP_ENV__Fault(soap, p), 0) ||
        ::soap_put_SOAP_ENV__Fault(soap, p, "SOAP-ENV:Fault", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Fault(struct soap*                  soap,
                                    const char*                   URL,
                                    struct SOAP_ENV__Fault const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_SOAP_ENV__Fault(struct soap*                  soap,
                                      const char*                   URL,
                                      struct SOAP_ENV__Fault const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_SOAP_ENV__Fault(struct soap*                  soap,
                                          const char*                   URL,
                                          struct SOAP_ENV__Fault const* p)
{
    soap_free_temp(soap);
...
inline int soap_read_SOAP_ENV__Fault(struct soap*            soap,
                                     struct SOAP_ENV__Fault* p)
{
    if (p) {
        ::soap_default_SOAP_ENV__Fault(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_SOAP_ENV__Fault(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_SOAP_ENV__Fault(struct soap*            soap,
                                    const char*             URL,
                                    struct SOAP_ENV__Fault* p)
{
...
inline int soap_POST_recv_SOAP_ENV__Fault(struct soap*            soap,
                                          struct SOAP_ENV__Fault* p)
{
...
inline int soap_write_SOAP_ENV__Reason(struct soap*                   soap,
                                       struct SOAP_ENV__Reason const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_SOAP_ENV__Reason(soap, p), 0) ||
        ::soap_put_SOAP_ENV__Reason(soap, p, "SOAP-ENV:Reason", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Reason(struct soap*                   soap,
                                     const char*                    URL,
                                     struct SOAP_ENV__Reason const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_SOAP_ENV__Reason(struct soap*                   soap,
                                       const char*                    URL,
                                       struct SOAP_ENV__Reason const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_SOAP_ENV__Reason(struct soap*                   soap,
                                           const char*                    URL,
                                           struct SOAP_ENV__Reason const* p)
{
    soap_free_temp(soap);
...
inline int soap_read_SOAP_ENV__Reason(struct soap*             soap,
                                      struct SOAP_ENV__Reason* p)
{
    if (p) {
        ::soap_default_SOAP_ENV__Reason(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_SOAP_ENV__Reason(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_SOAP_ENV__Reason(struct soap*             soap,
                                     const char*              URL,
                                     struct SOAP_ENV__Reason* p)
{
...
inline int soap_POST_recv_SOAP_ENV__Reason(struct soap*             soap,
                                           struct SOAP_ENV__Reason* p)
{
...
inline int soap_write_SOAP_ENV__Detail(struct soap*                   soap,
                                       struct SOAP_ENV__Detail const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_SOAP_ENV__Detail(soap, p), 0) ||
        ::soap_put_SOAP_ENV__Detail(soap, p, "SOAP-ENV:Detail", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Detail(struct soap*                   soap,
                                     const char*                    URL,
                                     struct SOAP_ENV__Detail const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_SOAP_ENV__Detail(struct soap*                   soap,
                                       const char*                    URL,
                                       struct SOAP_ENV__Detail const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_SOAP_ENV__Detail(struct soap*                   soap,
                                           const char*                    URL,
                                           struct SOAP_ENV__Detail const* p)
{
    soap_free_temp(soap);
...
inline int soap_read_SOAP_ENV__Detail(struct soap*             soap,
                                      struct SOAP_ENV__Detail* p)
{
    if (p) {
        ::soap_default_SOAP_ENV__Detail(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_SOAP_ENV__Detail(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_SOAP_ENV__Detail(struct soap*             soap,
                                     const char*              URL,
                                     struct SOAP_ENV__Detail* p)
{
...
inline int soap_POST_recv_SOAP_ENV__Detail(struct soap*             soap,
                                           struct SOAP_ENV__Detail* p)
{
...
soap_new_set_SOAP_ENV__Code(struct soap*           soap,
...
inline int soap_write_SOAP_ENV__Code(struct soap*                 soap,
                                     struct SOAP_ENV__Code const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_SOAP_ENV__Code(soap, p), 0) ||
        ::soap_put_SOAP_ENV__Code(soap, p, "SOAP-ENV:Code", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Code(struct soap*                 soap,
                                   const char*                  URL,
                                   struct SOAP_ENV__Code const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_SOAP_ENV__Code(struct soap*                 soap,
                                     const char*                  URL,
                                     struct SOAP_ENV__Code const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_SOAP_ENV__Code(struct soap*                 soap,
                                         const char*                  URL,
                                         struct SOAP_ENV__Code const* p)
{
    soap_free_temp(soap);
...
inline int soap_read_SOAP_ENV__Code(struct soap* soap, struct SOAP_ENV__Code* p)
{
    if (p) {
        ...
        if (soap_begin_recv(soap) ||
            ::soap_get_SOAP_ENV__Code(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_SOAP_ENV__Code(struct soap*           soap,
                                   const char*            URL,
...
inline int soap_POST_recv_SOAP_ENV__Code(struct soap*           soap,
                                         struct SOAP_ENV__Code* p)
{
...
inline int soap_write_SOAP_ENV__Header(struct soap*                   soap,
                                       struct SOAP_ENV__Header const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_SOAP_ENV__Header(soap, p), 0) ||
        ::soap_put_SOAP_ENV__Header(soap, p, "SOAP-ENV:Header", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Header(struct soap*                   soap,
                                     const char*                    URL,
                                     struct SOAP_ENV__Header const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_SOAP_ENV__Header(struct soap*                   soap,
                                       const char*                    URL,
                                       struct SOAP_ENV__Header const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_SOAP_ENV__Header(struct soap*                   soap,
                                           const char*                    URL,
                                           struct SOAP_ENV__Header const* p)
{
    soap_free_temp(soap);
...
inline int soap_read_SOAP_ENV__Header(struct soap*             soap,
                                      struct SOAP_ENV__Header* p)
{
    if (p) {
        ::soap_default_SOAP_ENV__Header(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_SOAP_ENV__Header(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_SOAP_ENV__Header(struct soap*             soap,
                                     const char*              URL,
                                     struct SOAP_ENV__Header* p)
{
...
inline int soap_POST_recv_SOAP_ENV__Header(struct soap*             soap,
                                           struct SOAP_ENV__Header* p)
{
...
SOAP_FMAC3 void SOAP_FMAC4
soap_default_ns1__executeCommand(struct soap*, struct ns1__executeCommand*);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__executeCommand(
    struct soap*, const struct ns1__executeCommand*);
SOAP_FMAC3 int SOAP_FMAC4
soap_out_ns1__executeCommand(struct soap*,
                             const char*,
                             int,
                             const struct ns1__executeCommand*,
                             const char*);
SOAP_FMAC3 struct ns1__executeCommand* SOAP_FMAC4 soap_in_ns1__executeCommand(
    struct soap*, const char*, struct ns1__executeCommand*, const char*);
SOAP_FMAC1 struct ns1__executeCommand* SOAP_FMAC2
soap_instantiate_ns1__executeCommand(
    struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__executeCommand*
soap_new_ns1__executeCommand(struct soap* soap, int n = -1)
{
    return soap_instantiate_ns1__executeCommand(soap, n, NULL, NULL, NULL);
}

inline struct ns1__executeCommand*
soap_new_req_ns1__executeCommand(struct soap* soap)
{
...
inline struct ns1__executeCommand*
soap_new_set_ns1__executeCommand(struct soap* soap, char* command)
{
    struct ns1__executeCommand* _p = ::soap_new_ns1__executeCommand(soap);
    if (_p) {
        ::soap_default_ns1__executeCommand(soap, _p);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__executeCommand(
    struct soap*, const struct ns1__executeCommand*, const char*, const char*);

inline int soap_write_ns1__executeCommand(struct soap* soap,
                                          struct ns1__executeCommand const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_ns1__executeCommand(soap, p), 0) ||
        ::soap_put_ns1__executeCommand(soap, p, "ns1:executeCommand", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_ns1__executeCommand(struct soap*                      soap,
                                        const char*                       URL,
                                        struct ns1__executeCommand const* p)
{
    soap_free_temp(soap);
...
inline int soap_PATCH_ns1__executeCommand(struct soap* soap,
                                          const char*  URL,
                                          struct ns1__executeCommand const* p)
{
    soap_free_temp(soap);
...
inline int soap_POST_send_ns1__executeCommand(
    struct soap* soap, const char* URL, struct ns1__executeCommand const* p)
{
    soap_free_temp(soap);
    if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") ||
        (::soap_serialize_ns1__executeCommand(soap, p), 0) ||
...
SOAP_FMAC3 struct ns1__executeCommand* SOAP_FMAC4 soap_get_ns1__executeCommand(
    struct soap*, struct ns1__executeCommand*, const char*, const char*);

inline int soap_read_ns1__executeCommand(struct soap*                soap,
                                         struct ns1__executeCommand* p)
{
    if (p) {
        ::soap_default_ns1__executeCommand(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_ns1__executeCommand(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_GET_ns1__executeCommand(struct soap*                soap,
                                        const char*                 URL,
                                        struct ns1__executeCommand* p)
{
...
inline int soap_POST_recv_ns1__executeCommand(struct soap*                soap,
                                              struct ns1__executeCommand* p)
{
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__executeCommandResponse(
    struct soap*, struct ns1__executeCommandResponse*);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__executeCommandResponse(
    struct soap*, const struct ns1__executeCommandResponse*);
SOAP_FMAC3 int SOAP_FMAC4
soap_out_ns1__executeCommandResponse(struct soap*,
                                     const char*,
                                     int,
                                     const struct ns1__executeCommandResponse*,
                                     const char*);
SOAP_FMAC3 struct ns1__executeCommandResponse* SOAP_FMAC4
soap_in_ns1__executeCommandResponse(struct soap*,
                                    const char*,
...
inline struct ns1__executeCommandResponse*
soap_new_ns1__executeCommandResponse(struct soap* soap, int n = -1)
{
    return soap_instantiate_ns1__executeCommandResponse(
        soap, n, NULL, NULL, NULL);
}

inline struct ns1__executeCommandResponse*
soap_new_req_ns1__executeCommandResponse(struct soap* soap)
{
    struct ns1__executeCommandResponse* _p =
        ::soap_new_ns1__executeCommandResponse(soap);
    if (_p) {
...
inline struct ns1__executeCommandResponse*
soap_new_set_ns1__executeCommandResponse(struct soap* soap, char** result)
{
    struct ns1__executeCommandResponse* _p =
        ::soap_new_ns1__executeCommandResponse(soap);
    if (_p) {
...
SOAP_FMAC3 int SOAP_FMAC4
soap_put_ns1__executeCommandResponse(struct soap*,
                                     const struct ns1__executeCommandResponse*,
                                     const char*,
                                     const char*);

inline int soap_write_ns1__executeCommandResponse(
    struct soap* soap, struct ns1__executeCommandResponse const* p)
{
    soap_free_temp(soap);
    if (soap_begin_send(soap) ||
        (::soap_serialize_ns1__executeCommandResponse(soap, p), 0) ||
        ::soap_put_ns1__executeCommandResponse(
            soap, p, "ns1:executeCommandResponse", "") ||
        soap_end_send(soap))
        return soap->error;
    return SOAP_OK;
}

inline int soap_PUT_ns1__executeCommandResponse(
    struct soap*                              soap,
    const char*                               URL,
...
inline int soap_PATCH_ns1__executeCommandResponse(
    struct soap*                              soap,
    const char*                               URL,
    struct ns1__executeCommandResponse const* p)
{
...
inline int soap_POST_send_ns1__executeCommandResponse(
    struct soap*                              soap,
    const char*                               URL,
    struct ns1__executeCommandResponse const* p)
{
...
SOAP_FMAC3 struct ns1__executeCommandResponse* SOAP_FMAC4
soap_get_ns1__executeCommandResponse(struct soap*,
                                     struct ns1__executeCommandResponse*,
                                     const char*,
                                     const char*);

inline int
soap_read_ns1__executeCommandResponse(struct soap*                        soap,
                                      struct ns1__executeCommandResponse* p)
{
    if (p) {
        ::soap_default_ns1__executeCommandResponse(soap, p);
        if (soap_begin_recv(soap) ||
            ::soap_get_ns1__executeCommandResponse(soap, p, NULL, NULL) ==
                NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
...
inline int soap_GET_ns1__executeCommandResponse(
    struct soap* soap, const char* URL, struct ns1__executeCommandResponse* p)
{
    if (soap_GET(soap, URL, NULL) ||
        ::soap_read_ns1__executeCommandResponse(soap, p))
        return soap_closesock(soap);
    return soap_closesock(soap);
}

inline int soap_POST_recv_ns1__executeCommandResponse(
    struct soap* soap, struct ns1__executeCommandResponse* p)
{
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTostring(struct soap*,
                                                          char** const*);
SOAP_FMAC3 int SOAP_FMAC4  soap_out_PointerTostring(
     struct soap*, const char*, int, char** const*, const char*);
SOAP_FMAC3 char*** SOAP_FMAC4 soap_in_PointerTostring(struct soap*,
                                                      const char*,
                                                      char***,
                                                      const char*);
SOAP_FMAC3 int SOAP_FMAC4     soap_put_PointerTostring(struct soap*,
                                                       char** const*,
                                                       const char*,
                                                       const char*);
SOAP_FMAC3 char*** SOAP_FMAC4 soap_get_PointerTostring(struct soap*,
                                                       char***,
                                                       const char*,
                                                       const char*);
#endif
...
inline int soap_write__QName(struct soap* soap, char* const* p)
{
    soap_free_temp(soap);
    if (p) {
        if (soap_begin_send(soap) || ::soap_put__QName(soap, p, "QName", "") ||
            soap_end_send(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_PUT__QName(struct soap* soap, const char* URL, char* const* p)
{
    soap_free_temp(soap);
    if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put__QName(soap, p, "QName", "") || soap_end_send(soap) ||
        soap_recv_empty_response(soap))
        return soap_closesock(soap);
    return SOAP_OK;
}
...
inline int
soap_POST_send__QName(struct soap* soap, const char* URL, char* const* p)
{
    soap_free_temp(soap);
    if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put__QName(soap, p, "QName", "") || soap_end_send(soap))
...
inline int soap_read__QName(struct soap* soap, char** p)
{
    if (p) {
        if (soap_begin_recv(soap) ||
            ::soap_get__QName(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_write_string(struct soap* soap, char* const* p)
{
    soap_free_temp(soap);
    if (p) {
        if (soap_begin_send(soap) || ::soap_put_string(soap, p, "string", "") ||
            soap_end_send(soap))
            return soap->error;
    }
    return SOAP_OK;
...
inline int soap_PUT_string(struct soap* soap, const char* URL, char* const* p)
{
    soap_free_temp(soap);
    if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_string(soap, p, "string", "") || soap_end_send(soap) ||
        soap_recv_empty_response(soap))
        return soap_closesock(soap);
    return SOAP_OK;
}
...
inline int
soap_POST_send_string(struct soap* soap, const char* URL, char* const* p)
{
    soap_free_temp(soap);
    if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") ||
        ::soap_put_string(soap, p, "string", "") || soap_end_send(soap))
...
inline int soap_read_string(struct soap* soap, char** p)
{
    if (p) {
        if (soap_begin_recv(soap) ||
            ::soap_get_string(soap, p, NULL, NULL) == NULL ||
            soap_end_recv(soap))
            return soap->error;
    }
    return SOAP_OK;
