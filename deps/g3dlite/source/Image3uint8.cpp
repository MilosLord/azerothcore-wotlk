...
Image3uint8::Ref Image3uint8::fromImage1uint8(
    const ReferenceCountedPointer<class Image1uint8>& im)
{
    return fromArray(
        im->getCArray(), im->width(), im->height(), im->wrapMode());
}

Image3uint8::Image3uint8(int w, int h, WrapMode wrap)
    : Map2D<Color3uint8>(w, h, wrap)
{
    setAll(Color3::black());
}
...
Image3uint8::Ref
Image3uint8::fromImage3(const ReferenceCountedPointer<Image3>& im)
{
...
Image3uint8::Ref Image3uint8::fromFile(const std::string& filename,
                                       WrapMode           wrap,
                                       GImage::Format     fmt)
{
...
Image3uint8::Ref Image3uint8::fromArray(const class Color3uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image3uint8::Ref
Image3uint8::fromArray(const class Color1* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image3uint8::Ref Image3uint8::fromArray(const class Color1uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image3uint8::Ref
Image3uint8::fromArray(const class Color3* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image3uint8::Ref Image3uint8::fromArray(const class Color4uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image3uint8::Ref
Image3uint8::fromArray(const class Color4* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
ReferenceCountedPointer<class Image1uint8> Image3uint8::getChannel(int c) const
{
    ...
    Image1uint8Ref dst =
        Image1uint8::createEmpty(width(), height(), wrapMode());
...
const ImageFormat* Image3uint8::format() const { return ImageFormat::RGB8(); }
