...
Image1::Ref
Image1::fromArray(const class Color3unorm8* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
...
Image1::Ref
Image1::fromArray(const class Color1* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1::Ref
Image1::fromArray(const class Color1unorm8* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1::Ref
Image1::fromArray(const class Color3* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1::Ref
Image1::fromArray(const class Color4unorm8* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1::Ref
Image1::fromArray(const class Color4* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
void Image1::save(const std::string& filename)
{
    ...
    // floating point to L8.
    Image1unorm8::Ref unorm8 = Image1unorm8::fromImage1(
        dynamic_pointer_cast<Image1>(shared_from_this()));
