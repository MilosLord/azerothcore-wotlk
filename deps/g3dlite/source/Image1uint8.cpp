...
Image1uint8::Image1uint8(int w, int h, WrapMode wrap)
    : Map2D<Color1uint8, Color1>(w, h, wrap)
{
    setAll(Color1uint8(0));
}

Image1uint8::Ref Image1uint8::fromImage3uint8(
    const ReferenceCountedPointer<class Image3uint8>& im)
{
    return fromArray(
...
Image1uint8::Ref
Image1uint8::fromImage1(const ReferenceCountedPointer<Image1>& im)
{
...
Image1uint8::Ref Image1uint8::fromFile(const std::string& filename,
                                       WrapMode           wrap,
                                       GImage::Format     fmt)
{
...
Image1uint8::Ref Image1uint8::fromArray(const class Color3uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image1uint8::Ref
Image1uint8::fromArray(const class Color1* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1uint8::Ref Image1uint8::fromArray(const class Color1uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image1uint8::Ref
Image1uint8::fromArray(const class Color3* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image1uint8::Ref Image1uint8::fromArray(const class Color4uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image1uint8::Ref
Image1uint8::fromArray(const class Color4* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
const ImageFormat* Image1uint8::format() const { return ImageFormat::L8(); }
