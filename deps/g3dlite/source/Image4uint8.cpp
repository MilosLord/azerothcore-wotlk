...
Image4uint8::Image4uint8(int w, int h, WrapMode wrap)
    : Map2D<Color4uint8, Color4>(w, h, wrap)
{
    setAll(Color4::zero());
}
...
Image4uint8::Ref
Image4uint8::fromImage4(const ReferenceCountedPointer<Image4>& im)
{
...
Image4uint8::Ref Image4uint8::fromFile(const std::string& filename,
                                       WrapMode           wrap,
                                       GImage::Format     fmt)
{
...
Image4uint8::Ref Image4uint8::fromArray(const class Color3uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image4uint8::Ref
Image4uint8::fromArray(const class Color1* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image4uint8::Ref Image4uint8::fromArray(const class Color1uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image4uint8::Ref
Image4uint8::fromArray(const class Color3* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
Image4uint8::Ref Image4uint8::fromArray(const class Color4uint8* ptr,
                                        int                      w,
                                        int                      h,
                                        WrapMode                 wrap)
{
...
Image4uint8::Ref
Image4uint8::fromArray(const class Color4* ptr, int w, int h, WrapMode wrap)
{
    Ref out = createEmpty(wrap);
    out->copyArray(ptr, w, h);
    return out;
...
const ImageFormat* Image4uint8::format() const { return ImageFormat::RGBA8(); }
