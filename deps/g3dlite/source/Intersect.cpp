...
bool __fastcall Intersect::rayAABox(const Ray& ray, const AABox& box)
{
    ...
    case Ray::MMM:
        ...
        if ((ray.m_origin.x < box.lo.x) || (ray.m_origin.y < box.lo.y) ||
            (ray.m_origin.z < box.lo.z) ||
    ...
    case Ray::MPM:
        ...
        if ((ray.m_origin.x < box.lo.x) || (ray.m_origin.y > box.hi.y) ||
            (ray.m_origin.z < box.lo.z) ||
    ...
    case Ray::PMM:
        ...
        if ((ray.m_origin.x > box.hi.x) || (ray.m_origin.y < box.lo.y) ||
            (ray.m_origin.z < box.lo.z) ||
    ...
    case Ray::PPM:
        ...
        if ((ray.m_origin.x > box.hi.x) || (ray.m_origin.y > box.hi.y) ||
            (ray.m_origin.z < box.lo.z) ||
    ...
    case Ray::OMO:
        ...
        if ((ray.m_origin.y < box.lo.y) || (ray.m_origin.x < box.lo.x) ||
            (ray.m_origin.x > box.hi.x) || (ray.m_origin.z < box.lo.z) ||
            (ray.m_origin.z > box.hi.z))
            return false;
        else
    ...
    case Ray::OPO:
        ...
        if ((ray.m_origin.y > box.hi.y) || (ray.m_origin.x < box.lo.x) ||
            (ray.m_origin.x > box.hi.x) || (ray.m_origin.z < box.lo.z) ||
            (ray.m_origin.z > box.hi.z))
            return false;
        else
    ...
    case Ray::OOM:
        ...
        if ((ray.m_origin.z < box.lo.z) || (ray.m_origin.x < box.lo.x) ||
            (ray.m_origin.x > box.hi.x) || (ray.m_origin.y < box.lo.y) ||
            (ray.m_origin.y > box.hi.y))
            return false;
        else
            return true;
    ...
    case Ray::OOP:
        ...
        if ((ray.m_origin.z > box.hi.z) || (ray.m_origin.x < box.lo.x) ||
            (ray.m_origin.x > box.hi.x) || (ray.m_origin.y < box.lo.y) ||
            (ray.m_origin.y > box.hi.y))
            return false;
        else
...
bool __fastcall Intersect::rayAABox(const Ray&   ray,
                                    const AABox& box,
                                    float&       time)
{
