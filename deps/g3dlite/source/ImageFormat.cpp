...
ImageFormat::ImageFormat(int          _numComponents,
                         bool         _compressed,
                         int          _glFormat,
                         int          _glBaseFormat,
                         int          _luminanceBits,
    ...
    :
      ...
      numComponents(_numComponents), compressed(_compressed), code(_code),
      colorSpace(_colorSpace), bayerPattern(_bayerPattern),
      openGLFormat(_glFormat), openGLBaseFormat(_glBaseFormat),
      luminanceBits(_luminanceBits), alphaBits(_alphaBits), redBits(_redBits),
      greenBits(_greenBits), blueBits(_blueBits), stencilBits(_stencilBits),
      depthBits(_depthBits), cpuBitsPerPixel(_cpuBitsPerPixel),
      openGLBitsPerPixel(_openGLBitsPerPixel), openGLDataFormat(glDataFormat),
      opaque(_opaque), numberFormat(_numberFormat)
{
...
const ImageFormat*
ImageFormat::getFormatWithAlpha(const ImageFormat* otherFormat)
{
...
{
    return (numComponents == 1) && (cpuBitsPerPixel == 8) &&
           ((luminanceBits == 8) || (redBits == 8) || (alphaBits == 8));
}

bool ImageFormat::representableAsColor2unorm8() const
{
    return (numComponents == 2) && (cpuBitsPerPixel == 16) &&
...
{
    return (numComponents == 3) && (cpuBitsPerPixel == 24) &&
           (redBits == 8 && greenBits == 8 && blueBits == 8);
}

bool ImageFormat::representableAsColor4unorm8() const
{
    return (numComponents == 4) && (cpuBitsPerPixel == 32) &&
...
#define DEFINE_TEXTUREFORMAT_METHOD(enumname,                                  \
                                    cmpnts,                                    \
                                    cmprssd,                                   \
                                    glf,                                       \
                                    glbf,                                      \
    ...
    {                                                                          \
        static const ImageFormat format(cmpnts,                                \
                                        cmprssd,                               \
                                        glf,                                   \
                                        glbf,                                  \
                                        lb,                                    \
...
DEFINE_TEXTUREFORMAT_METHOD(L8,
                            1,
                            UNCOMP_FORMAT,
                            GL_LUMINANCE8,
                            GL_LUMINANCE,
...
DEFINE_TEXTUREFORMAT_METHOD(L16,
                            1,
                            UNCOMP_FORMAT,
                            GL_LUMINANCE16,
                            GL_LUMINANCE,
...
DEFINE_TEXTUREFORMAT_METHOD(L16F,
                            1,
                            UNCOMP_FORMAT,
                            GL_LUMINANCE16F_ARB,
                            GL_LUMINANCE,
...
DEFINE_TEXTUREFORMAT_METHOD(L32F,
                            1,
                            UNCOMP_FORMAT,
                            GL_LUMINANCE32F_ARB,
                            GL_LUMINANCE,
...
DEFINE_TEXTUREFORMAT_METHOD(A8,
                            1,
                            UNCOMP_FORMAT,
                            GL_ALPHA8,
                            GL_ALPHA,
...
DEFINE_TEXTUREFORMAT_METHOD(A16,
                            1,
                            UNCOMP_FORMAT,
                            GL_ALPHA16,
                            GL_ALPHA,
...
DEFINE_TEXTUREFORMAT_METHOD(A16F,
                            1,
                            UNCOMP_FORMAT,
                            GL_ALPHA16F_ARB,
                            GL_ALPHA,
...
DEFINE_TEXTUREFORMAT_METHOD(A32F,
                            1,
                            UNCOMP_FORMAT,
                            GL_ALPHA32F_ARB,
                            GL_ALPHA,
...
DEFINE_TEXTUREFORMAT_METHOD(LA4,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(LA8,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(LA16,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(LA16F,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(LA32F,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(BGR8,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB8,
                            GL_BGR,
...
DEFINE_TEXTUREFORMAT_METHOD(BGRA8,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA8,
                            GL_BGRA,
...
DEFINE_TEXTUREFORMAT_METHOD(R8,
                            1,
                            UNCOMP_FORMAT,
                            GL_R8,
                            GL_RED,
...
DEFINE_TEXTUREFORMAT_METHOD(R8I,
                            1,
                            UNCOMP_FORMAT,
                            GL_R8I,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R8UI,
                            1,
                            UNCOMP_FORMAT,
                            GL_R8UI,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R16,
                            1,
                            UNCOMP_FORMAT,
                            GL_R16,
                            GL_RED,
...
DEFINE_TEXTUREFORMAT_METHOD(R16I,
                            1,
                            UNCOMP_FORMAT,
                            GL_R16I,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R16UI,
                            1,
                            UNCOMP_FORMAT,
                            GL_R16UI,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R32I,
                            1,
                            UNCOMP_FORMAT,
                            GL_R32I,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R32UI,
                            1,
                            UNCOMP_FORMAT,
                            GL_R32UI,
                            GL_RED_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RG8,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG8,
                            GL_RG,
...
// The base format for integer formats must be *_INTEGER even though the spec
// doesn't state this
DEFINE_TEXTUREFORMAT_METHOD(RG8I,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG8I,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RG8UI,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG8UI,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RG16,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG16,
                            GL_RG,
...
DEFINE_TEXTUREFORMAT_METHOD(RG16I,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG16I,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RG16UI,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG16UI,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R16F,
                            1,
                            UNCOMP_FORMAT,
                            GL_R16F,
                            GL_RED,
...
DEFINE_TEXTUREFORMAT_METHOD(RG16F,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG16F,
                            GL_RG,
...
DEFINE_TEXTUREFORMAT_METHOD(RG32I,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG32I,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RG32UI,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG32UI,
                            GL_RG_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R32F,
                            1,
                            UNCOMP_FORMAT,
                            GL_R32F,
                            GL_RED,
...
DEFINE_TEXTUREFORMAT_METHOD(RG32F,
                            2,
                            UNCOMP_FORMAT,
                            GL_RG32F,
                            GL_RG,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB5,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB5,
                            GL_RGBA,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB5A1,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGB5_A1,
                            GL_RGBA,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB8,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB8,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB10,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB10,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB10A2,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGB10_A2,
                            GL_RGBA,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB16,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB16,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB16F,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB16F_ARB,
                            GL_RGB,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGB32F,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB32F_ARB,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGBA8,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA16,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA16,
                            GL_RGBA,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA16F,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA16F_ARB,
                            GL_RGBA,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA32F,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA32F_ARB,
                            GL_RGBA,
...
DEFINE_TEXTUREFORMAT_METHOD(RGBA16I,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA16I,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA16UI,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA16UI,
                            GL_RGBA_INTEGER,
...
// The base format for integer formats must be *_INTEGER even though the spec
// doesn't state this
DEFINE_TEXTUREFORMAT_METHOD(RGB32I,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB32I,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGB32UI,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB32UI,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA32I,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA32I,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA32UI,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA32UI,
                            GL_RGBA_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(R11G11B10F,
                            3,
                            UNCOMP_FORMAT,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGB9E5F,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB9_E5_EXT,
                            GL_RGB,
...
// The base format for integer formats must be *_INTEGER even though the spec
// doesn't state this
DEFINE_TEXTUREFORMAT_METHOD(RGB8I,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB8I_EXT,
                            GL_RGB_INTEGER,
...
DEFINE_TEXTUREFORMAT_METHOD(RGB8UI,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB8UI_EXT,
                            GL_RGB_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA8I,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA8I_EXT,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA8UI,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA8UI_EXT,
                            GL_RGBA_INTEGER,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGB8_SNORM,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB8_SNORM,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGBA8_SNORM,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA8_SNORM,
                            GL_RGBA,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGB16_SNORM,
                            3,
                            UNCOMP_FORMAT,
                            GL_RGB16_SNORM,
                            GL_RGB,
                            ...
                            ImageFormat::COLOR_SPACE_RGB);
DEFINE_TEXTUREFORMAT_METHOD(RGBA16_SNORM,
                            4,
                            UNCOMP_FORMAT,
                            GL_RGBA16_SNORM,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(RGBA_DXT3,
                            4,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(RGBA_DXT5,
                            4,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGB8,
                            3,
                            UNCOMP_FORMAT,
                            GL_SRGB8,
                            GL_RGB,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGBA8,
                            4,
                            UNCOMP_FORMAT,
                            GL_SRGB8_ALPHA8,
                            GL_RGBA,
...
DEFINE_TEXTUREFORMAT_METHOD(SL8,
                            1,
                            UNCOMP_FORMAT,
                            GL_SLUMINANCE8,
                            GL_LUMINANCE,
...
DEFINE_TEXTUREFORMAT_METHOD(SLA8,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGB_DXT1,
                            3,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGBA_DXT1,
                            4,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGBA_DXT3,
                            4,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(SRGBA_DXT5,
                            4,
                            COMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(DEPTH16,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(DEPTH24,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(DEPTH32,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(DEPTH32F,
                            1,
                            UNCOMP_FORMAT,
                            GL_DEPTH_COMPONENT32_ARB,
                            GL_DEPTH_COMPONENT,
...
DEFINE_TEXTUREFORMAT_METHOD(STENCIL1,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(STENCIL4,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(STENCIL8,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(STENCIL16,
                            1,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(DEPTH24_STENCIL8,
                            2,
                            UNCOMP_FORMAT,
...
DEFINE_TEXTUREFORMAT_METHOD(YUV420_PLANAR,
                            3,
                            UNCOMP_FORMAT,
                            GL_NONE,
                            GL_NONE,
...
DEFINE_TEXTUREFORMAT_METHOD(YUV422,
                            3,
                            UNCOMP_FORMAT,
                            GL_NONE,
                            GL_NONE,
                            ...
                            ImageFormat::COLOR_SPACE_YUV);
DEFINE_TEXTUREFORMAT_METHOD(YUV444,
                            3,
                            UNCOMP_FORMAT,
                            GL_NONE,
                            GL_NONE,
