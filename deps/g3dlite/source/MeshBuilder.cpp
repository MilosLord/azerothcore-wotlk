...
void MeshBuilder::commit(std::string&    n,
                         ...
                         Array<Vector3>& outvertexArray)
{
    ...
    if (close == MeshBuilder::AUTO_WELD) {
        ...
        MeshAlg::computeAreaStatistics(triList,
                                       index,
                                       minEdgeLen,
                                       meanEdgeLen,
                                       medianEdgeLen,
...
void MeshBuilder::centerTriList()
{
    ...
    if (scaleAndCenter) {
        // Matrix3 rot90 = Matrix3::fromAxisAngle(Vector3::UNIT_Y,
        // toRadians(180)) * Matrix3::fromAxisAngle(Vector3::UNIT_X,
        // toRadians(90));
...
void MeshBuilder::addQuad(const Vector3& a,
                          const Vector3& b,
                          const Vector3& c,
                          const Vector3& d)
{
