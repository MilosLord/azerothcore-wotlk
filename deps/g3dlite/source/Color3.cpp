...
{
    *this = Color3::zero();
    any.verifyNameBeginsWith("Color3",
                             "Power3",
                             "Radiance3",
                             "Irradiance3",
                             "Energy3",
    ...
    case Any::TABLE:
        ...
        for (Any::AnyTable::Iterator it = any.table().begin(); it.isValid();
             ++it) {
...
{
    static const Color3 map[] = {Color3::black(),
                                 Color3::red() * 0.75f,
                                 Color3::green() * 0.75f,
                                 Color3::yellow() * 0.75f,
                                 Color3::blue() * 0.75f,
...
{
    static const Color3 colorArray[8] = {Color3::blue(),
                                         Color3::red(),
                                         Color3::green(),
                                         Color3::orange(),
                                         Color3::yellow(),
...
Color3::Color3(const class Color3unorm8& other)
...
{
    return Color3(uniformRandom(), uniformRandom(), uniformRandom())
        .direction();
}
...
Vector3 Color3::toHSV(const Color3& _rgb)
{
    ...
    if (_rgb.r == hsv.z) { // note from the max we know that it exactly equals
                           // one of the three.
