...
/**
 ...
 <table>
  ...
  <tr><td>std::string</td><td><i>The string in double-quotes
(</i><code>"</code><i>)</i></td></tr>
  ...
  <tr><td>AABox</td><td><code>AAB(</code>low Vector3<code>, </code>high
Vector3<code>)</code></td></tr>
  <tr><td>Matrix2</td><td><code>M2(</code>r0c0<code>, </code>r0c1<code>,
                             <br>&nbsp;&nbsp;&nbsp;</code>r1c0<code>,
</code>r1c1<code>)</code></td></tr>
  <tr><td>Matrix3</td><td><code>M3(</code>r0c0<code>, </code>r0c1<code>,
</code>r0c2<code>, <br>&nbsp;&nbsp;&nbsp;</code>r1c0<code>, </code>r1c1<code>,
</code>r1c2<code>, <br>&nbsp;&nbsp;&nbsp;</code>r2c0<code>, </code>r2c1<code>,
</code>r2c2<code>)</code></td></tr>
  <tr><td>Matrix4</td><td><code>M4(</code>r0c0<code>, </code>r0c1<code>,
</code>r0c2<code>, </code>r0c3<code>, <br>&nbsp;&nbsp;&nbsp;</code>r1c0<code>,
</code>r1c1<code>, </code>r1c2<code>, </code>r1c3<code>,
         <br>&nbsp;&nbsp;&nbsp;</code>r2c0<code>, </code>r2c1<code>,
</code>r2c2<code>, </code>r2c3<code>, <br>&nbsp;&nbsp;&nbsp;</code>r3c0<code>,
</code>r3c1<code>, </code>r3c2<code>, </code>r3c3<code>)</code></td></tr>
  <tr><td>CoordinateFrame</td><td><code>CF(</code>r0c0<code>, </code>r0c1<code>,
</code>r0c2<code>,   </code>r0c3<code>, <br>&nbsp;&nbsp;&nbsp;</code>r1c0<code>,
</code>r1c1<code>, </code>r1c2<code>,   </code>r1c3<code>,
         <br>&nbsp;&nbsp;&nbsp;</code>r2c0<code>, </code>r2c1<code>,
</code>r2c2<code>,   </code>r2c3<code>)</code></td></tr>
  <tr><td>CoordinateFrame</td><td><code>CF(V3(</code><i>x</i><code>,
</code><i>y</i><code>, </code><i>z</i><code>), </code><i>yaw deg</i><code>,
</code><i>pitch deg</i><code>, </code><i>optional roll
deg</i><code>)</code></td></tr>

  <tr><td>Array</td><td><code>[</code><i>element<sub>0</sub></i><code>,
</code><i>element<sub>1</sub></i><code>, </code> ... <code>,
</code><i>element<sub>n-1</sub></i><code>]</code></td></tr>
  <tr><td>Table</td><td><code>{</code><i>symbol<sub>0</sub></i><code> =
</code><i>value<sub>0</sub></i>
                               <br><code>&nbsp;</code><i>symbol<sub>1</sub></i><code>
= </code><i>value<sub>1</sub></i> <br><code>&nbsp;</code>...
                               <br><code>&nbsp;</code><i>symbol<sub>n-1</sub></i><code>
= </code><i>value<sub>n-1</sub></i><code>}</code></td></tr>
  </table>
 ...
 arrays and tables instead of generating errors.  get() has more strict
semantics, like a C++ class.

 AnyVal uses copy-on-mutate, so that <code>AnyVal a = b</code> semantically
copies <code>b</code> (like <code>int a = b</code> would), although in practice
 it delays the copy until one is mutated so that it is still fast to "copy"
large arrays and tables.
 ...
 <pre>
    ...
    <i>Using defaults to handle errors:
       If there was no "enabled" value, this will return the default instead of
failing</i> bool enabled = property["enabled"].boolean(true);
 ...
 <pre>
  ...
  <br>I think that AnyVal will be easier for novice C++ users.  It addresses the
problem that even though G3D::TextInput makes reading configuration files
extremely simple, many people still don't use it.  So AnyVal makes it
ridiculously simple to read and write a tree of G3D types to a file.
...
public:
    ...
    /** Thrown when an inappropriate operation is performed (e.g., operator[] on
     * a number) */
    ...
    public:
        ...
        CorruptText() {}
        CorruptText(const std::string& s, const G3D::Token& t)
            : message(s), token(t)
        {
        }
    };
...
public:
    ...
    /** Array dereference.  If the index is out of bounds, IndexOutOfBounds is
     * thrown */
    ...
    /** If the index is out of bounds, the array is resized.  If the index is
       negative, IndexOutOfBounds is thrown.*/
    AnyVal& operator[](int);

    /** If @a i is out of bounds or this is not an ARRAY, defaultVal is
     * returned.*/
