...
/**
    ...
    \cite By Kaz Kylheku
   http://www.velocityreviews.com/forums/t620780-mathew-hendrys-macro-for-binary-integer-literals.html
...
/**
    ...
    \cite Tom Torfs
   http://groups.google.com/group/comp.arch.embedded/msg/9d430b6d3da12c8f \sa
...
#define BIN32(dmsb, db2, db3, dlsb)                                            \
    (((unsigned long)BIN8(dmsb) << 24) + ((unsigned long)BIN8(db2) << 16) +    \
     ((unsigned long)BIN8(db3) << 8) + BIN8(dlsb))
