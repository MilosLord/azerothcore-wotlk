/**
  ...
  @cite
     ...
     <A
 HREF="http://msdn.microsoft.com/library/periodic/period99/feb99_BUGSLAYE_BUGSLAYE.htm">
     http://msdn.microsoft.com/library/periodic/period99/feb99_BUGSLAYE_BUGSLAYE.htm</A>

  @cite
     Douglas Cox, An assert() Replacement, Code of The Day, flipcode, Sept 19,
 2000 <A
 HREF="http://www.flipcode.com/cgi-bin/msg.cgi?showThread=COTD-AssertReplace&forum=cotd&id=-1">
...
namespace G3D {
typedef bool (*AssertionHook)(const char*        _expression,
    ...
    do {                                                                       \
        if (!(exp)) {                                                          \
            ...
            if ((G3D::_internal::_debugHook != NULL) &&                        \
                G3D::_internal::_debugHook((const char*)(#exp),                \
                                           message,                            \
                                           __FILE__,                           \
                                           __LINE__,                           \
    ...
    {                                                                          \
        if (!(exp)) {                                                          \
            ...
            if ((G3D::_internal::_failureHook != NULL) &&                      \
                G3D::_internal::_failureHook(#exp,                             \
                                             message,                          \
                                             __FILE__,                         \
                                             __LINE__,                         \
                                             __debugPromptShowDialog__)) {     \
