...
/**
  ...
  <table>
  <tr><td></td><td><b>Point3</b></td><td><b>LineSegment</b></td><td><b>Ray
*</b></td><td><b>Line</b></td><td><b>Plane</b></td><td><b>Triangle</b></td><td><b>Sphere</b></td><td><b>Cylinder</b></td><td><b>Capsule</b></td><td><b>AABox</b></td><td><b>Box</b></td></tr>
  <tr><td><b>Point3</b></td><td>\link Vector3::operator== P3::==\endlink \link
Vector3::fuzzyEq V3::fuzzy \endlink \link G3D::distance distance
\endlink</td><td bgcolor=#C0C0C0 colspan=10 ></td></tr>
  <tr><td><b>LineSegment</b></td><td>\link LineSegment::closestPoint
LS::closestPoint\endlink \link LineSegment::distance LS::distance\endlink \link
CollisionDetection::closestPointOnLineSegment CD\endlink</td><td></td><td
bgcolor=#C0C0C0 colspan=9 ></td></tr> <tr><td><b>Ray
*</b></td><td>Ray::closestPoint Ray::distance</td><td></td><td></td><td
bgcolor=#C0C0C0 colspan=8 ></td></tr>
  <tr><td><b>Line</b></td><td>Line::closestPoint
Line::distance</td><td></td><td>\link
CollisionDetection::closestPointsBetweenLineAndLine CD\endlink</td><td></td><td
bgcolor=#C0C0C0 colspan=7 ></td></tr>
  <tr><td><b>Plane</b></td><td></td><td></td><td></td><td></td><td></td><td
bgcolor=#C0C0C0 colspan=6 ></td></tr>
  <tr><td><b>Triangle</b></td><td></td><td></td><td></td><td></td><td></td><td></td><td
bgcolor=#C0C0C0 colspan=5 ></td></tr>
  <tr><td><b>Sphere</b></td><td>Sphere::contains</td><td></td><td>\link
CollisionDetection::collisionTimeForMovingPointFixedSphere CD \endlink, \link
Ray::intersectionTime R::time\endlink</td><td></td><td></td><td>\link
G3D::CollisionDetection::fixedSolidSphereIntersectsFixedTriangle
CD\endlink</td><td> \link
G3D::CollisionDetection::penetrationDepthForFixedSphereFixedSphere
CD\endlink</td><td bgcolor=#C0C0C0 colspan=4 ></td></tr>
  <tr><td><b>Cylinder</b></td><td>Cylinder::contains</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td
bgcolor=#C0C0C0 colspan=3 ></td></tr>
  <tr><td><b>Capsule</b></td><td>Capsule::contains</td> <td></td> <td></td>
<td></td> <td></td> <td>\link
G3D::CollisionDetection::collisionTimeForMovingSphereFixedTriangle
CD\endlink</td> <td></td><td></td><td></td><td bgcolor=#C0C0C0 colspan=2
></td></tr>
  <tr><td><b>AABox</b></td><td>AABox::contains</td><td></td><td></td><td></td><td></td><td>\link
CollisionDetection::fixedSolidBoxIntersectsFixedTriangle
CD\endlink</td><td></td><td></td><td></td><td></td><td bgcolor=#C0C0C0 colspan=1
></td></tr> <tr><td><b>Box</b></td><td>Box::contains</td><td>(treat as
Ray)</td><td>\link CollisionDetection::collisionTimeForMovingPointFixedBox
CD\endlink</td><td>(treat as Ray)</td><td>\link
CollisionDetection::penetrationDepthForFixedBoxFixedPlane CD
\endlink</td><td>\link CollisionDetection::penetrationDepthForFixedBoxFixedPlane
CD\endlink</td><td>\link
CollisionDetection::penetrationDepthForFixedSphereFixedBox
CD\endlink</td><td>None (use OPCODE)</td><td>\link
CollisionDetection::movingSpherePassesThroughFixedBox CD \endlink</td><td>\link
CollisionDetection::penetrationDepthForFixedBoxFixedBox CD\endlink</td><td>\link
CollisionDetection::penetrationDepthForFixedBoxFixedBox CD\endlink</td></tr>
  </table>

  <p>
  <b>Moving Collision Detection:</b>

  <i>* Note: Moving collision detection against certain primitives is equivalent
to static collision detection against a bigger primitive.  Ray, Line Segment ==
``moving Point''; Capsule ==``moving Sphere''; Plane == ``moving Line''</i>
...
public:
    ...
    static Vector3 separatingAxisForSolidBoxSolidBox(
        const int separatingAxisIndex, const Box& box1, const Box& box2);
    ...
    /**
      ...
      */
    static bool parallelAxisForSolidBoxSolidBox(const double* ca,
     ...
     */
    static float
    projectedDistanceForSolidBoxSolidBox(const int      separatingAxisIndex,
                                         const Vector3& a,
                                         const Vector3& b,
                                         const Vector3& D,
                                         const double*  c,
    ...
    /**
      ...
      @param bd Pointer to array of dot products of Box 2 axes and D.
     */
    static void fillSolidBoxSolidBoxInfo(const Box& box1,
                                         const Box& box2,
                                         Vector3&   a,
                                         Vector3&   b,
                                         Vector3&   D,
     ...
     */
    static bool conservativeBoxBoxTest(const Vector3& a,
                                       const Vector3& b,
                                       const Vector3& D);
    ...
    static bool fixedSolidBoxIntersectsFixedSolidBox(
        const Box& box1, const Box& box2, const int lastSeparatingAxis = -1);
    ...
    /**
      ...
      calculations, these values could (will) differ as the line slope
      approaches zero or inifinity.

      @cite variables and algorithm based on derivation at the following
      website: http://softsurfer.com/Archive/algorithm_0106/algorithm_0106.htm
     ...
     */
    static void closestPointsBetweenLineAndLine(const Line& line1,
                                                const Line& line2,
                                                Vector3&    closest1,
                                                Vector3&    closest2);
    ...
    /**
      ...
      @param contactNormals        Surface normal at contact point. [Post
      Condition]
     ...
     */
    static float
    penetrationDepthForFixedBoxFixedBox(const Box&      box1,
                                        const Box&      box2,
    ...
    /**
      ...
      - Sphere contained in Box:
         - Normal is based on side of least penetration (as is the depth
      calculation).
      ...
      - Sphere intersects one vertex
         - Normal is based on vector from the box center to the vertex of
      penetration.
      ...
      @param box            Fixed Box.
      @param contactPoints    Sphere point that penetrates the box. [Post
      Condition]
     ...
     */
    static float
    collisionTimeForMovingPointFixedPlane(const Vector3&     point,
     ...
     */
    inline static float
    collisionTimeForMovingPointFixedTriangle(const Vector3& orig,
                                             const Vector3& dir,
                                             const Vector3& v0,
                                             const Vector3& v1,
                                             const Vector3& v2)
    {
        return Ray::fromOriginAndDirection(orig, dir).intersectionTime(
            v0, v1, v2);
    }
    ...
    {
        float t =
            collisionTimeForMovingPointFixedTriangle(orig, dir, v0, v1, v2);
        if (t < finf()) {
            location = orig + dir * t;
        }
        return t;
    ...
    /**
     ...
     @cite Andrew Woo, from "Graphics Gems", Academic Press, 1990
       @cite Optimized code by Pierre Terdiman, 2000 (~20-30% faster on Celeron
     500)
     @cite Epsilon value added by Klaus Hartmann
     @cite http://www.codercorner.com/RayAABB.cpp
     */
    static float
    collisionTimeForMovingPointFixedAABox(const Vector3&     point,
                                          const Vector3&     velocity,
     ...
     */
    static bool
    collisionLocationForMovingPointFixedAABox(const Vector3&     point,
                                              const Vector3&     velocity,
                                              const class AABox& box,
                                              Vector3&           outLocation,
                                              bool&    inside = ignoreBool,
    ...
    /**
     ...
     @param invDir      1/dir
     @param location    Location of collision. [Post Condition]
     @param inside        Does the ray originate inside the box? [Post
     Condition]

     @return True if the ray hits the box
    */
    static bool __fastcall rayAABox(const Ray&     ray,
     ...
     */
    static float
    collisionTimeForMovingPointFixedSphere(const Vector3&      point,
                                           const Vector3&      velocity,
    ...
    /**
     ...
     @note If the point is already inside the box, no collision: inf is
     returned.
     ...
     */
    static float
    collisionTimeForMovingPointFixedBox(const Vector3&   point,
                                        const Vector3&   velocity,
                                        const class Box& box,
                                        Vector3&         outLocation,
                                        Vector3&         outNormal = ignore);
     ...
     */
    static float
    collisionTimeForMovingPointFixedRectangle(const Vector3& point,
                                              const Vector3& velocity,
                                              const Vector3& v0,
                                              const Vector3& v1,
                                              const Vector3& v2,
     ...
     */
    static float
    collisionTimeForMovingPointFixedCapsule(const Vector3&       point,
                                            const Vector3&       velocity,
    ...
    /**
     ...
     @param velocity    Sphere's velocity.
     @param plane        Fixed Plane.
     @param outLocation    Location of collision -- not center position of
     sphere at the collision time. [Post Condition]
     @param outNormal    Box's surface normal to collision [Post Condition]
     ...
     */
    static float
    collisionTimeForMovingSphereFixedPlane(const class Sphere& sphere,
                                           const Vector3&      velocity,
                                           const class Plane&  plane,
                                           Vector3&            outLocation,
                                           Vector3& outNormal = ignore);
    ...
    /**
     ...
     @param outLocation    Location of collision, if collision occurs -- not
     center position of sphere at the collision time. If there is
     interpenetration at the start, this point may be inside the sphere.
     @param b           Barycentric coordinates. These are not valid unless
     collision occurs.
    ...
    */
    static float
    collisionTimeForMovingSphereFixedTriangle(const class Sphere& sphere,
                                              const Vector3&      velocity,
     ...
     */
    static float
    collisionTimeForMovingSphereFixedRectangle(const class Sphere& sphere,
                                               const Vector3&      velocity,
                                               const Vector3&      v0,
                                               const Vector3&      v1,
                                               const Vector3&      v2,
     ...
     */
    static float
    collisionTimeForMovingSphereFixedBox(const class Sphere& sphere,
                                         const Vector3&      velocity,
                                         const class Box&    box,
                                         Vector3&            outLocation,
                                         Vector3& outNormal = ignore);
    ...
    /** Calculates time between the intersection of a moving sphere
        ...
        @param outLocation        Location of collision -- not center position
       of sphere at the collision time. [Post Condition]
        @param outNormal        Moving sphere's surface normal to collision
       [Post Condition]
    ...
    */
    static float
    collisionTimeForMovingSphereFixedSphere(const Sphere&  sphere,
                                            const Vector3& velocity,
    ...
    /**
     ...
     @param outLocation  Location of collision -- not center position of sphere
                         at the collision time. [Post Condition]
     @param outNormal    Capsule's surface normal to the collision [Post
     Condition]
     ...
     */
    static float
    collisionTimeForMovingSphereFixedCapsule(const class Sphere&  sphere,
                                             const Vector3&       velocity,
                                             const class Capsule& capsule,
                                             Vector3&             outLocation,
                                             Vector3& outNormal = ignore);
     ...
     */
    static Vector3 bounceDirection(const class Sphere& sphere,
                                   const Vector3&      velocity,
     ...
     */
    static Vector3 slideDirection(const class Sphere& sphere,
                                  const Vector3&      velocity,
                                  const float         collisionTime,
                                  const Vector3&      collisionLocation);
     ...
     */
    static Vector3 closestPointOnLineSegment(const Vector3& v0,
                                             const Vector3& v1,
                                             const Vector3& point);
    ...
    /**
     Finds the closest point on the perimeter of the triangle to an external
     point; given a triangle defined by three points v0, v1, & v2, and the
     external point.
     ...
     triangle.
     */
    static Vector3 closestPointOnTrianglePerimeter(const Vector3& v0,
                                                   const Vector3& v1,
                                                   const Vector3& v2,
                                                   const Vector3& point);
    ...
    /**
     Finds the closest point on the perimeter of the triangle to an external
     point; given a triangle defined by the array of points v, its edge
     directions and their lengths, as well as the external point.

     @note This is an optimization to closestPointToTrianglePerimeter.  Edge
     length and direction can be used in this function if already
     pre-calculated.  This prevents doing the same work twice.

     @param v           Triangle vertices.
     @param point       External point.
     @param edgeIndex   The point lies on the edge between v[edgeIndex] and
     v[(edgeIndex + 1) % 3]
     ...
     */
    static Vector3
    closestPointOnTrianglePerimeter(const Vector3  v[3],
     ...
     */
    static bool
    isPointInsideTriangle(const Vector3& v0,
                          const Vector3& v1,
                          const Vector3& v2,
    ...
    */
    static bool movingSpherePassesThroughFixedBox(const Sphere&  sphere,
                                                  const Vector3& velocity,
                                                  const Box&     box,
    ...
    /**
     ...
     @return false - if there is no intersection.
     */
    static bool movingSpherePassesThroughFixedSphere(const Sphere&  sphere,
                                                     const Vector3& velocity,
                                                     const Sphere&  fixedSphere,
                                                     double timeLimit = inf());
     ...
     */
    static bool
    fixedSolidSphereIntersectsFixedSolidSphere(const Sphere& sphere1,
    ...
    /**
     ...
     @return false - if there is no intersection.
     */
    static bool fixedSolidSphereIntersectsFixedSolidBox(const Sphere& sphere,
                                                        const Box&    box);

    static bool
    fixedSolidSphereIntersectsFixedTriangle(const Sphere&   sphere,
                                            const Triangle& triangle);

    static bool fixedSolidBoxIntersectsFixedTriangle(const AABox&    box,
                                                     const Triangle& triangle);
    ...
    /**
     ...
     @return false - otherwise
     */
    static bool isPointInsideRectangle(const Vector3& v0,
                                       const Vector3& v1,
                                       const Vector3& v2,
                                       const Vector3& v3,
                                       const Vector3& normal,
    ...
    /**
     ...
     @return Closests point to <code>point</code> on the perimeter of the
      rectangle.
      */
    static Vector3 closestPointToRectanglePerimeter(const Vector3& v0,
                                                    const Vector3& v1,
                                                    const Vector3& v2,
                                                    const Vector3& v3,
                                                    const Vector3& point);
     ...
     */
    static Vector3 closestPointToRectangle(const Vector3& v0,
                                           const Vector3& v1,
                                           const Vector3& v2,
                                           const Vector3& v3,
                                           const Vector3& point);
