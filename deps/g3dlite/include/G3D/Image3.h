...
public:
    ...
    /** Loads from any of the file formats supported by G3D::GImage.  If there
       is an alpha channel on the input, it is stripped. Converts 8-bit formats
       to the range (0, 1) */
    void load(const std::string& filename);

    /** Saves in any of the formats supported by G3D::GImage. Assumes the data
     * is on the range (0, 1) if saving to an 8-bit format.*/
