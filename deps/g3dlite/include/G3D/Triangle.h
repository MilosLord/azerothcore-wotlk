/**
 ...
 \cite Random point method by  Greg Turk, Generating random points in triangles.
 In A. S. Glassner, ed., Graphics Gems, pp. 24-28. Academic Press, 1990
...
public:
    ...
    inline void getRandomSurfacePoint(Point3&  P,
    ...
    {
        return _vertex[0].hashCode() + (_vertex[1].hashCode() >> 2) +
     ...
     */
    bool
    intersect(const class Ray& ray, float& distance, float baryCoord[3]) const;
};
