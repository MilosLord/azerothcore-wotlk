...
public:
    inline MeshBuilder(bool twoSided = false, bool scaleAndCenter = true)
    ...
    /** Vertices within this distance are considered identical.
        Use AUTO_WELD (the default) to have the distance be a function of the
       model size.*/
