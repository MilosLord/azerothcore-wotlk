...
public:
    ...
    public:
        /** Surfaces with normals that are within this angle of each
            other are considered to be curved.  Default value is
           toRadians(70.0f).*/
        ...
        inline Settings(float normalSmoothAngle = toRadians(70.0f))
            : normalSmoothingAngle(normalSmoothAngle), vertexWeldRadius(0.001f),
              textureWeldRadius(0.0001f), normalWeldRadius(0.01f)
        {
        }
    ...
    /**
         ...
         */
    static void weld(Array<Vector3>&     vertices,
    ...
    /**
     ...
     @param indices Input and output. This is an array of trilist indices.
     */
    inline static void weld(Array<Vector3>& vertices,
                            Array<Vector2>& textureCoords,
                            Array<Vector3>& normals,
                            Array<int>&     indices,
                            const Settings& settings)
