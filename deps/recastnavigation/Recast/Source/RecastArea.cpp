...
/// built.
///
/// @see rcCompactHeightfield, rcBuildCompactHeightfield,
...
bool rcErodeWalkableArea(rcContext* ctx, int radius, rcCompactHeightfield& chf)
{
    ...
    unsigned char* dist = (unsigned char*)rcAlloc(
                ...
                if (chf.areas[i] == RC_NULL_AREA) {
                    ...
                    for (int dir = 0; dir < 4; ++dir) {
                        if (rcGetCon(s, dir) != RC_NOT_CONNECTED) {
                            ...
                            const int nidx = (int)chf.cells[nx + ny * w].index +
                                             rcGetCon(s, dir);
...
/// effectively projected onto the xz-plane at @p hmin, then extruded to @p
/// hmax.
///
/// @see rcCompactHeightfield, rcMedianFilterWalkableArea
