...
#define uint3korr(A)                                                           \
    (uint32)(((uint32)((uchar)(A)[0])) + (((uint32)((uchar)(A)[1])) << 8) +    \
             (((uint32)((uchar)(A)[2])) << 16))
#else
/*
   ATTENTION !
...
*/
#define sint2korr(A)                                                           \
    (int16)(((int16)((uchar)(A)[0])) + ((int16)((int16)(A)[1]) << 8))
#define sint3korr(A)                                                           \
    ((int32)((((uchar)(A)[2]) & 128)                                           \
                 ? (((uint32)255L << 24) | (((uint32)(uchar)(A)[2]) << 16) |   \
                    (((uint32)(uchar)(A)[1]) << 8) | ((uint32)(uchar)(A)[0]))  \
...
#define uint2korr(A)                                                           \
    (uint16)(((uint16)((uchar)(A)[0])) + ((uint16)((uchar)(A)[1]) << 8))
#define uint3korr(A)                                                           \
    (uint32)(((uint32)((uchar)(A)[0])) + (((uint32)((uchar)(A)[1])) << 8) +    \
             (((uint32)((uchar)(A)[2])) << 16))
#define uint4korr(A)                                                           \
...
static inline double rint(double x)
{
    ...
    */
    if (x > 0.0)
        i +=
            (double)((f > 0.5) || (f == 0.5 && i <= (double)MAX_EXACT_INTEGER &&
                                   (longlong)i % 2));
    else
        i -= (double)((f < -0.5) ||
                      (f == -0.5 && i >= (double)-MAX_EXACT_INTEGER &&
                       (longlong)i % 2));
    return i;
}
#endif /* HAVE_RINT */
