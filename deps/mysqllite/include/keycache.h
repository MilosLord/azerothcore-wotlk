...
typedef struct st_key_cache {
    ...
    */
    ...
    BLOCK_LINK*
        changed_blocks[CHANGED_BLOCKS_HASH];      /* hash for dirty file bl.*/
    ...
    */
    ...
    ulonglong
        global_cache_w_requests;  /* number of write requests (write hits) */
...
extern int    init_key_cache(KEY_CACHE* keycache,
...
extern int    resize_key_cache(KEY_CACHE* keycache,
                               ...
                               uint       division_limit,
                               uint       age_threshold);
extern void   change_key_cache_param(KEY_CACHE* keycache,
                                     uint       division_limit,
                                     uint       age_threshold);
...
extern int    key_cache_write(KEY_CACHE* keycache,
                              ...
                              int        force_write);
extern int
flush_key_blocks(KEY_CACHE* keycache, int file, enum flush_type type);
...
extern my_bool
multi_key_cache_set(const uchar* key, uint length, KEY_CACHE* key_cache);
