...
{"ER_HASHCHK", 1000, "hashchk"}, {"ER_NISAMCHK", 1001, "isamchk"},
    {"ER_NO", 1002, "NO"}, {"ER_YES", 1003, "YES"},
    ...
    {"ER_ERROR_ON_RENAME",
     1025,
     "Error on rename of \'%-.210s\' to \'%-.210s\' (errno: %d)"},
    ...
    {"ER_BLOB_USED_AS_KEY",
     1073,
     "BLOB column \'%-.192s\' can\'t be used in key specification with the "
     "used table type"},
    {"ER_TOO_BIG_FIELDLENGTH",
     1074,
     "Column length too big for column \'%-.192s\' (max = %lu); use BLOB or "
     "TEXT instead"},
    {"ER_WRONG_AUTO_KEY",
     1075,
    ...
    {"ER_NO_SUCH_INDEX",
     1082,
     "Table \'%-.192s\' has no index like the one used in CREATE INDEX; "
     "recreate the table"},
    ...
    {"ER_TEXTFILE_NOT_READABLE",
     1085,
     "The file \'%-.128s\' must be in the database directory or be readable by "
     "all"},
    ...
    {"ER_WRONG_SUB_KEY",
     ...
     "is longer than the key part, or the storage engine doesn\'t support "
     "unique prefix keys"},
    ...
    {"ER_UNSUPPORTED_EXTENSION",
     1112,
     "Table \'%-.192s\' uses an extension that doesn\'t exist in this MySQL "
     "version"},
    ...
    {"ER_TOO_BIG_ROWSIZE",
     ...
     "counting BLOBs, is %ld. You have to change some columns to TEXT or "
     "BLOBs"},
    {"ER_STACK_OVERRUN",
     1119,
     "Thread stack overrun:  Used: %ld of a %ld stack.  Use \'mysqld "
    ...
    {"ER_TABLEACCESS_DENIED_ERROR",
     1142,
     "%-.16s command denied to user \'%-.48s\'@\'%-.64s\' for table "
     "\'%-.192s\'"},
    {"ER_COLUMNACCESS_DENIED_ERROR",
     1143,
     "%-.16s command denied to user \'%-.48s\'@\'%-.64s\' for column "
     "\'%-.192s\' in table \'%-.192s\'"},
    ...
    {"ER_DELAYED_INSERT_TABLE_LOCKED",
     1165,
     "INSERT DELAYED can\'t be used with table \'%-.192s\' because it is "
    ...
    {"ER_BLOB_KEY_WITHOUT_LENGTH",
     1170,
     "BLOB/TEXT column \'%-.192s\' used in key specification without a key "
     "length"},
    ...
    {"ER_CRASHED_ON_REPAIR",
     1195,
     "Table \'%-.192s\' is marked as crashed and last (automatic?) repair "
     "failed"},
    ...
    {"ER_SPECIFIC_ACCESS_DENIED_ERROR",
     1227,
     "Access denied; you need (at least one of) the %-.128s privilege(s) for "
     "this operation"},
    {"ER_LOCAL_VARIABLE",
     1228,
     "Variable \'%-.64s\' is a SESSION variable and can\'t be used with SET "
     "GLOBAL"},
    {"ER_GLOBAL_VARIABLE",
     1229,
     "Variable \'%-.64s\' is a GLOBAL variable and should be set with SET "
     "GLOBAL"},
    {"ER_NO_DEFAULT",
     1230,
    ...
    {"ER_SERVER_IS_IN_SECURE_AUTH_MODE",
     1275,
     "Server is running in --secure-auth mode, but \'%s\'@\'%s\' has a "
     "password in the old format; please change the password to the new "
     "format"},
    {"ER_WARN_FIELD_RESOLVED",
     1276,
     "Field or reference \'%-.192s%s%-.192s%s%-.192s\' of SELECT #%d was "
    ...
    {"ER_WARN_DEPRECATED_SYNTAX",
     1287,
     "\'%s\' is deprecated and will be removed in a future release. Please use "
     "%s instead"},
    ...
    {"ER_FEATURE_DISABLED",
     1289,
     "The \'%s\' feature is disabled; you need MySQL built with \'%s\' to have "
     "it working"},
    ...
    {"ER_UPDATE_LOG_DEPRECATED_IGNORED",
     ...
     "SQL_LOG_UPDATE has been ignored. This option will be removed in MySQL "
     "5.6."},
    {"ER_UPDATE_LOG_DEPRECATED_TRANSLATED",
     1316,
     "The update log is deprecated and replaced by the binary log; SET "
     "SQL_LOG_UPDATE has been translated to SET SQL_LOG_BIN. This option will "
     "be removed in MySQL 5.6."},
    ...
    {"ER_PROCACCESS_DENIED_ERROR",
     1370,
     "%-.16s command denied to user \'%-.48s\'@\'%-.64s\' for routine "
     "\'%-.192s\'"},
    ...
    {"ER_RESERVED_SYNTAX",
     1382,
     "The \'%-.64s\' syntax is reserved for purposes internal to the MySQL "
     "server"},
    ...
    {"ER_SP_NOT_VAR_ARG",
     1414,
     "OUT or INOUT argument %d for routine %s is not a variable or NEW "
    ...
    {"ER_NO_DEFAULT_FOR_VIEW_FIELD",
     1423,
     "Field of view \'%-.192s.%-.192s\' underlying table doesn\'t have a "
     "default value"},
    {"ER_SP_NO_RECURSION",
     1424,
    ...
    {"ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE",
     1432,
     "Can\'t create federated table. The data source connection string "
     "\'%-.64s\' is not in the correct format"},
    {"ER_FOREIGN_DATA_STRING_INVALID",
     1433,
     "The data source connection string \'%-.64s\' is not in the correct "
     "format"},
    ...
    {"ER_PS_NO_RECURSION",
     ...
     "that same statement. It\'s not allowed to execute a prepared statement "
    ...
    {"ER_VIEW_FRM_NO_USER",
     1447,
     "View \'%-.192s\'.\'%-.192s\' has no definer information (old table "
     "format). Current user is used as definer. Please recreate the view!"},
    {"ER_VIEW_OTHER_USER",
     1448,
    ...
    {"ER_TRG_NO_DEFINER",
     1454,
     "No definer attribute for trigger \'%-.192s\'.\'%-.192s\'. The trigger "
     "will be activated under the authorization of the invoker, which may have "
     "insufficient privileges. Please recreate the trigger."},
    {"ER_OLD_FILE_FORMAT",
     1455,
     "\'%-.192s\' has an old format, you should re-create the \'%s\' "
     "object(s)"},
    ...
    {"ER_SP_PROC_TABLE_CORRUPT",
     1457,
     "Failed to load routine %-.192s. The table mysql.proc is missing, "
     "corrupt, or contains bad data (internal code %d)"},
    {"ER_SP_WRONG_NAME", 1458, "Incorrect routine name \'%-.192s\'"},
    {"ER_TABLE_NEEDS_UPGRADE",
     1459,
     "Table upgrade required. Please do \"REPAIR TABLE `%-.32s`\" or "
    ...
    {"ER_USERNAME", 1468, "user name"}, {"ER_HOSTNAME", 1469, "host name"},
    ...
    {"ER_ADMIN_WRONG_MRG_TABLE",
     1472,
     "Table \'%-.64s\' is differently defined or of non-MyISAM type or "
     "doesn\'t exist"},
    ...
    {"ER_ILLEGAL_HA_CREATE_OPTION",
     1478,
     "Table storage engine \'%-.64s\' does not support the create option "
     "\'%.64s\'"},
    ...
    {"ER_FOREIGN_KEY_ON_PARTITIONED",
     1506,
     "Foreign key clause is not yet supported in conjunction with "
     "partitioning"},
    ...
    {"ER_REORG_NO_PARAM_ERROR",
     1511,
     "REORGANIZE PARTITION without parameters can only be used on "
    ...
    {"ER_REORG_OUTSIDE_RANGE",
     1520,
     "Reorganize of range partitions cannot change total ranges except for "
     "last partition where it can extend the range"},
    ...
    {"ER_SIZE_OVERFLOW_ERROR",
     1532,
     "The size number was correct but we don\'t allow the digit part to be "
     "more than 2 billion"},
    ...
    {"ER_WARN_DEPRECATED_SYNTAX_WITH_VER",
     1554,
     "The syntax \'%s\' is deprecated and will be removed in MySQL %s. Please "
     "use %s instead"},
    ...
    {"ER_FOREIGN_DUPLICATE_KEY",
     1557,
     "Upholding foreign key constraints for table \'%.192s\', entry "
    ...
    {"ER_TEMP_TABLE_PREVENTS_SWITCH_OUT_OF_RBR",
     1559,
     "Cannot switch out of the row-based binary log format when the session "
    ...
    {"ER_NDB_CANT_SWITCH_BINLOG_FORMAT",
     1561,
     "The NDB cluster engine does not support changing the binlog format on "
     "the fly yet"},
    ...
    {"ER_CANT_RENAME_LOG_TABLE",
     1581,
     "Cannot rename \'%s\'. When logging enabled, rename to/from log table "
     "must rename two tables: the log table to an archive table and another "
     "table back to \'%s\'"},
    ...
    {"ER_XA_RBDEADLOCK",
     1614,
     "XA_RBDEADLOCK: Transaction branch was rolled back: deadlock was "
     "detected"},
    ...
    {"ER_DATABASE_NAME", 1631, "Database"}, {"ER_TABLE_NAME", 1632, "Table"},
    ...
    {"ER_SLAVE_IGNORE_SERVER_IDS",
     1650,
     "The requested server id %d clashes with the slave startup option "
    ...
    {"ER_FIELD_TYPE_NOT_ALLOWED_AS_PARTITION_FIELD",
     1659,
     "Field \'%-.192s\' is of a not allowed type for this type of "
     "partitioning"},
    ...
    {"ER_SLAVE_CONVERSION_FAILED",
     1677,
     "Column %d of table \'%-.192s.%-.192s\' cannot be converted from type "
     "\'%-.32s\' to type \'%-.32s\'"},
    ...
    {"ER_WARN_I_S_SKIPPED_TABLE",
     1684,
     "Table \'%s\'.\'%s\' was skipped since its definition is being modified "
     "by concurrent DDL statement"},
    ...
    {"ER_STORED_FUNCTION_PREVENTS_SWITCH_BINLOG_DIRECT",
     1686,
     "Cannot change the binlog direct flag inside a stored function or "
     "trigger"},
    ...
    {"ER_WRONG_SPVAR_TYPE_IN_LIMIT",
     1691,
     "A variable of a non-integer type in LIMIT clause"},
    {"ER_BINLOG_UNSAFE_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE",
     1692,
     "Mixing self-logging and non-self-logging engines in a statement is "
     "unsafe."},
    ...
    {"ER_GRANT_PLUGIN_USER_EXISTS",
     1700,
     "GRANT with IDENTIFIED WITH is illegal because the user %-.*s already "
     "exists"},
    ...
    {"ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX",
     ...
     "`slave_net_timeout\' seconds. A sensible value for the period should be "
