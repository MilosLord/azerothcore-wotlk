...
typedef struct st_mysql_methods {
    ...
    my_bool (*advanced_command)(MYSQL*                   mysql,
                                ...
                                my_bool                  skip_check,
                                MYSQL_STMT*              stmt);
    MYSQL_DATA* (*read_rows)(MYSQL*       mysql,
...
#define simple_command(mysql, command, arg, length, skip_check)                \
    (*(mysql)->methods->advanced_command)(                                     \
        mysql, command, 0, 0, arg, length, skip_check, NULL)
#define stmt_command(mysql, command, arg, length, stmt)                        \
    (*(mysql)->methods->advanced_command)(                                     \
        mysql, command, 0, 0, arg, length, 1, stmt)
...
void          set_mysql_extended_error(
             MYSQL* mysql, int errcode, const char* sqlstate, const char* format, ...);
