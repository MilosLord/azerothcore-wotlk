...
extern struct thd_alloc_service_st {
    ...
    MYSQL_LEX_STRING* (*thd_make_lex_string_func)(
        MYSQL_THD, MYSQL_LEX_STRING*, const char*, unsigned int, int);
}* thd_alloc_service;
...
#define thd_make_lex_string(thd, lex_str, str, size, allocate_lex_string)      \
    (thd_alloc_service->thd_make_lex_string_func(                              \
        (thd), (lex_str), (str), (size), (allocate_lex_string)))
