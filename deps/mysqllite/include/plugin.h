...
#define MYSQL_SYSVAR_BOOL(name, varname, opt, comment, check, update, def)     \
    DECLARE_MYSQL_SYSVAR_BASIC(name, char) = {PLUGIN_VAR_BOOL |                \
                                                  ((opt) & PLUGIN_VAR_MASK),   \
                                              #name,                           \
                                              comment,                         \
                                              check,                           \
...
#define MYSQL_SYSVAR_STR(name, varname, opt, comment, check, update, def)      \
    DECLARE_MYSQL_SYSVAR_BASIC(name, char*) = {PLUGIN_VAR_STR |                \
                                                   ((opt) & PLUGIN_VAR_MASK),  \
                                               #name,                          \
                                               comment,                        \
                                               check,                          \
...
#define MYSQL_SYSVAR_INT(                                                      \
    name, varname, opt, comment, check, update, def, min, max, blk)            \
    DECLARE_MYSQL_SYSVAR_SIMPLE(name, int) = {PLUGIN_VAR_INT |                 \
                                                  ((opt) & PLUGIN_VAR_MASK),   \
                                              #name,                           \
                                              comment,                         \
                                              check,                           \
...
#define MYSQL_SYSVAR_LONG(                                                     \
    name, varname, opt, comment, check, update, def, min, max, blk)            \
    DECLARE_MYSQL_SYSVAR_SIMPLE(name, long) = {PLUGIN_VAR_LONG |               \
                                                   ((opt) & PLUGIN_VAR_MASK),  \
                                               #name,                          \
                                               comment,                        \
                                               check,                          \
...
#define MYSQL_SYSVAR_ENUM(                                                     \
    name, varname, opt, comment, check, update, def, typelib)                  \
...
#define MYSQL_THDVAR_INT(                                                      \
    name, opt, comment, check, update, def, min, max, blk)                     \
