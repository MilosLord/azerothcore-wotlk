...
size_t
my_gcvt(double x, my_gcvt_arg_type type, int width, char* to, my_bool* error);
...
extern char*
         str2int(const char* src, int radix, long lower, long upper, long* val);
...
static inline const uchar* skip_trailing_space(const uchar* ptr, size_t len)
{
    ...
    if (len > 20) {
        const uchar* end_words =
            (const uchar*)(intptr)(((ulonglong)(intptr)end) / SIZEOF_INT *
                                   SIZEOF_INT);
