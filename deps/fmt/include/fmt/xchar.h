...
template <typename... T>
constexpr format_arg_store<wformat_context, T...>
make_wformat_args(const T&... args)
{
    return {args...};
}
...
template <typename OutputIt,
          ...
          bool enable   = detail::is_output_iterator<OutputIt, Char>::value &&
                        ...
                        detail::is_exotic_char<Char>::value>
inline auto
format_to(OutputIt out, const Locale& loc, const S& format_str, T&&... args) ->
