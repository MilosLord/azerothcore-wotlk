...
inline void
fwrite_fully(const void* ptr, size_t size, size_t count, FILE* stream)
{
...
FMT_FUNC std::system_error
         vsystem_error(int error_code, string_view fmt, format_args args)
{
...
struct formatter<detail::bigint> {
        ...
        -> format_context::iterator
    {
        ...
        if (n.exp_ > 0)
            out = format_to(
                out, FMT_STRING("p{}"), n.exp_ * detail::bigint::bigit_bits);
        return out;
    }
};
...
FMT_FUNC void vprint_mojibake(std::FILE* f, string_view fmt, format_args args)
{
    auto buffer = memory_buffer();
    detail::vformat_to(
        buffer, fmt, basic_format_args<buffer_context<char>>(args));
