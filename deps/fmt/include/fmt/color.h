...
private:
    ...
    static FMT_CONSTEXPR void
    to_esc(uint8_t c, Char* out, char delimiter) noexcept
    {
...
FMT_CONSTEXPR ansi_color_escape<Char>
              make_foreground_color(detail::color_type foreground) noexcept
{
...
template <typename Char>
FMT_CONSTEXPR ansi_color_escape<Char>
              make_background_color(detail::color_type background) noexcept
{
...
inline void
vprint(std::FILE* f, const text_style& ts, string_view fmt, format_args args)
{
...
inline std::basic_string<Char>
format(const text_style& ts, const S& format_str, const Args&... args)
{
    return fmt::vformat(ts,
