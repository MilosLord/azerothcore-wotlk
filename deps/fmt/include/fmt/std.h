...
private:
    ...
    static constexpr basic_string_view<Char> optional = detail::
        string_literal<Char, 'o', 'p', 't', 'i', 'o', 'n', 'a', 'l', '('>{};
...
struct formatter<std::error_code, Char> {
                              ...
                              FormatContext& ctx) const -> decltype(ctx.out())
    {
        ...
        out      = detail::write_bytes(
            out, ec.category().name(), format_specs<Char>());
