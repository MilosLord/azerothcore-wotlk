...
template <typename T>
struct has_member_fn_begin_end_t<T,
...
// Workaround a bug in MSVC 2015 and earlier.
                            ...
                            >::value>>
    : detail::
          range_default_formatter<range_format_kind<R, Char>::value, R, Char> {
};
...
struct formatter<tuple_join_view<Char, T...>, Char> {
    ...
    {
        return do_format(
            value, ctx, std::integral_constant<size_t, sizeof...(T)>());
    }
