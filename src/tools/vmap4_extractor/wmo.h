...
/* for whatever reason a certain company just can't stick to one coordinate
 * system... */
...
public:
    unsigned int color;
    uint32 nTextures, nGroups, nPortals, nLights, nDoodadNames, nDoodadDefs,
        nDoodadSets, RootWMOID, flags;
    float bbcorn1[3];
    float bbcorn2[3];
...
namespace MapObject {
void Extract(ADT::MODF const& mapObjDef,
