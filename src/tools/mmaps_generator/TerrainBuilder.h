...
struct MeshData {
    ...
    G3D::Array<float>
        offMeshConnections; // [p0y,p0z,p0x,p1y,p1z,p1x] - per connection
...
public:
    ...
    void loadOffMeshConnections(uint32      mapID,
                                uint32      tileX,
                                uint32      tileY,
                                MeshData&   meshData,
    ...
    static void transform(std::vector<G3D::Vector3>& original,
                          std::vector<G3D::Vector3>& transformed,
                          float                      scale,
                          G3D::Matrix3&              rotation,
                          G3D::Vector3&              position);
    static void copyVertices(std::vector<G3D::Vector3>& source,
                             G3D::Array<float>&         dest);
    static void copyIndices(std::vector<VMAP::MeshTriangle>& source,
                            G3D::Array<int>&                 dest,
                            int                              offest,
                            bool                             flip);
    static void
    copyIndices(G3D::Array<int>& src, G3D::Array<int>& dest, int offset);
...
private:
    ...
    bool loadHeightMap(uint32             mapID,
                       uint32             tileX,
                       uint32             tileY,
    ...
    void getHeightTriangle(int  square,
                           Spot triangle,
                           int* indices,
                           bool liquid = false);
