...
SD%Complete: 80
SDComment: Provides learn/unlearn/relearn-options for professions. Not
supported: Unlearn engineering, re-learn engineering. SDCategory: NPCs
EndScriptData */

/*
A few notes for future developement:
- A full implementation of gossip for GO's is required. They must have the same
scripting capabilities as creatures. Basically, there is no difference here
(except that default text is chosen with `gameobject_template`.`data3` (for GO
type2, different dataN for a few others)
- It's possible blacksmithing still require some tweaks and adjustments due to
the way we _have_ to use reputation.
*/
...
#define TALK_MUST_UNLEARN_WEAPON                                               \
    "You must forget your weapon type specialty before I can help you. Go to " \
    "Everlook in Winterspring and seek help there."

#define TALK_HAMMER_LEARN                                                      \
    "Ah, a seasoned veteran you once were. I know you are capable, you "       \
    "merely need to ask and I shall teach you the way of the hammersmith."
#define TALK_AXE_LEARN                                                         \
    "Ah, a seasoned veteran you once were. I know you are capable, you "       \
    "merely need to ask and I shall teach you the way of the axesmith."
#define TALK_SWORD_LEARN                                                       \
    "Ah, a seasoned veteran you once were. I know you are capable, you "       \
    "merely need to ask and I shall teach you the way of the swordsmith."

#define TALK_HAMMER_UNLEARN                                                    \
    "Forgetting your Hammersmithing skill is not something to do lightly. If " \
    "you choose to abandon it you will forget all recipes that require "       \
    "Hammersmithing to create!"
#define TALK_AXE_UNLEARN                                                       \
    "Forgetting your Axesmithing skill is not something to do lightly. If "    \
    "you choose to abandon it you will forget all recipes that require "       \
    "Axesmithing to create!"
#define TALK_SWORD_UNLEARN                                                     \
    "Forgetting your Swordsmithing skill is not something to do lightly. If "  \
    "you choose to abandon it you will forget all recipes that require "       \
    "Swordsmithing to create!"
...
#define BOX_UNLEARN_ARMORORWEAPON                                              \
    "Do you really want to unlearn your blacksmith specialty and lose all "    \
    "associated recipes? \n Cost: "
...
#define BOX_UNLEARN_WEAPON_SPEC                                                \
    "Do you really want to unlearn your weaponsmith specialty and lose all "   \
    "associated recipes? \n Cost: "

#define GOSSIP_LEARN_SPELLFIRE                                                 \
    "Please teach me how to become a Spellcloth tailor"
#define GOSSIP_UNLEARN_SPELLFIRE "I wish to unlearn Spellfire Tailoring"
#define GOSSIP_LEARN_MOONCLOTH                                                 \
    "Please teach me how to become a Mooncloth tailor"
#define GOSSIP_UNLEARN_MOONCLOTH "I wish to unlearn Mooncloth Tailoring"
#define GOSSIP_LEARN_SHADOWEAVE                                                \
    "Please teach me how to become a Shadoweave tailor"
#define GOSSIP_UNLEARN_SHADOWEAVE "I wish to unlearn Shadoweave Tailoring"

#define BOX_UNLEARN_TAILOR_SPEC                                                \
    "Do you really want to unlearn your tailoring specialty and lose all "     \
    "associated recipes? \n Cost: "

#define GOSSIP_LEARN_GOBLIN                                                    \
    "I am absolutely certain that i want to learn Goblin engineering"
#define GOSSIP_LEARN_GNOMISH                                                   \
    "I am absolutely certain that i want to learn Gnomish engineering"
...
#define BOX_UNLEARN_ENGIN_SPEC                                                 \
    "Do you really want to unlearn your engineering specialty and lose all "   \
    "associated recipes? \n Cost: "
#define BOX_LEARN_ENGIN_SPEC                                                   \
    "Do you really want to learn this engineering specialty? \n Cost: "
    ...
    for (uint8 i = 0; i < 3; ++i) {
        ...
        for (uint8 j = EQUIPMENT_SLOT_START; j < EQUIPMENT_SLOT_END; ++j) {
            ...
            if (item && item->GetTemplate()->RequiredSpell == reqSpell) {
                // player has item equipped that require specialty. Not allow to
                // unlearn, player has to unequip first
                LOG_DEBUG("scripts.ai",
                          "Player attempt to unlearn spell {}, but item {} is "
                          "equipped.",
                          reqSpell,
                          item->GetEntry());
                return false;
...
void ProfessionUnlearnSpells(Player* player, uint32 type)
{
    ...
    case S_UNLEARN_WEAPON: // S_UNLEARN_WEAPON
        player->removeSpell(
            36125, SPEC_MASK_ALL, false); // Light Earthforged Blade
        player->removeSpell(
            36128, SPEC_MASK_ALL, false); // Light Emberforged Hammer
        player->removeSpell(36126, SPEC_MASK_ALL, false); // Light Skyforged Axe
        break;
    case S_UNLEARN_ARMOR: // S_UNLEARN_ARMOR
        player->removeSpell(
            36122, SPEC_MASK_ALL, false); // Earthforged Leggings
        player->removeSpell(
            36129, SPEC_MASK_ALL, false); // Heavy Earthforged Breastplate
        player->removeSpell(36130, SPEC_MASK_ALL, false); // Stormforged Hauberk
        player->removeSpell(
            34533, SPEC_MASK_ALL, false); // Breastplate of Kings
        ...
        player->removeSpell(
            36257, SPEC_MASK_ALL, false); // Bulwark of the Ancient Kings
        player->removeSpell(
            36256, SPEC_MASK_ALL, false); // Embrace of the Twisting Nether
        player->removeSpell(
            34530, SPEC_MASK_ALL, false); // Twisting Nether Chain Shirt
    ...
    case S_UNLEARN_HAMMER:                                // S_UNLEARN_HAMMER
        ...
        player->removeSpell(
            36136, SPEC_MASK_ALL, false); // Lavaforged Warhammer
        ...
        player->removeSpell(
            36137, SPEC_MASK_ALL, false); // Great Earthforged Hammer
        break;
    case S_UNLEARN_AXE: // S_UNLEARN_AXE
        player->removeSpell(
            36260, SPEC_MASK_ALL, false); // Wicked Edge of the Planes
    ...
    case S_UNLEARN_SWORD:                                 // S_UNLEARN_SWORD
        ...
        player->removeSpell(
            36133, SPEC_MASK_ALL, false); // Stoneforged Claymore
        ...
        player->removeSpell(
            36259, SPEC_MASK_ALL, false); // Lionheart Executioner
        break;
    case S_UNLEARN_DRAGON: // S_UNLEARN_DRAGON
        player->removeSpell(
            10619, SPEC_MASK_ALL, false); // Dragonscale Guantlets
        player->removeSpell(
            10650, SPEC_MASK_ALL, false); // Dragonscale Breastplate
        player->removeSpell(
            36076, SPEC_MASK_ALL, false); // Dragonstrike Leggings
        player->removeSpell(
            24655, SPEC_MASK_ALL, false); // Green Dragonscale Gauntlets
        player->removeSpell(
            24654, SPEC_MASK_ALL, false); // Blue Dragonscale Leggings
        player->removeSpell(
            36079, SPEC_MASK_ALL, false); // Golden Dragonstrike Breastplate
        player->removeSpell(
            35576, SPEC_MASK_ALL, false); // Ebon Netherscale Belt
        player->removeSpell(
            35577, SPEC_MASK_ALL, false); // Ebon Netherscale Bracers
        player->removeSpell(
            35575, SPEC_MASK_ALL, false); // Ebon Netherscale Breastplate
        player->removeSpell(35582, SPEC_MASK_ALL, false); // Netherstrike Belt
        player->removeSpell(
            35584, SPEC_MASK_ALL, false); // Netherstrike Bracers
        player->removeSpell(
            35580, SPEC_MASK_ALL, false); // Netherstrike Breastplate
        break;
    case S_UNLEARN_ELEMENTAL:                             // S_UNLEARN_ELEMENTAL
        player->removeSpell(36074, SPEC_MASK_ALL, false); // Blackstorm Leggings
        player->removeSpell(
            36077, SPEC_MASK_ALL, false); // Primalstorm Breastplate
        player->removeSpell(35590, SPEC_MASK_ALL, false); // Primalstrike Belt
        player->removeSpell(
            35591, SPEC_MASK_ALL, false); // Primalstrike Bracers
        player->removeSpell(35589, SPEC_MASK_ALL, false); // Primalstrike Vest
        player->removeSpell(
            10630, SPEC_MASK_ALL, false); // Gauntlets of the Sea
    ...
    case S_UNLEARN_TRIBAL:                                // S_UNLEARN_TRIBAL
        ...
        player->removeSpell(
            36075, SPEC_MASK_ALL, false); // Wildfeather Leggings
        player->removeSpell(
            36078, SPEC_MASK_ALL, false); // Living Crystal Breastplate
        player->removeSpell(10621, SPEC_MASK_ALL, false); // Wolfshead Helm
        player->removeSpell(
            10647, SPEC_MASK_ALL, false); // Feathered Breastplate
        break;
    ...
    case S_UNLEARN_MOONCLOTH: // S_UNLEARN_MOONCLOTH
        player->removeSpell(
            26760, SPEC_MASK_ALL, false); // Primal Mooncloth Belt
        player->removeSpell(
            26761, SPEC_MASK_ALL, false); // Primal Mooncloth Shoulders
        player->removeSpell(
            26762, SPEC_MASK_ALL, false); // Primal Mooncloth Robe
        break;
    case S_UNLEARN_SHADOWEAVE: // S_UNLEARN_SHADOWEAVE
        player->removeSpell(
            26756, SPEC_MASK_ALL, false); // Frozen Shadoweave Shoulders
        player->removeSpell(
            26757, SPEC_MASK_ALL, false); // Frozen Shadoweave Boots
        player->removeSpell(
            26758, SPEC_MASK_ALL, false); // Frozen Shadoweave Robe
        break;
    }
}
...
public:
    ...
    {
        return (player->HasSpell(S_TRANSMUTE) || player->HasSpell(S_ELIXIR) ||
                player->HasSpell(S_POTION));
    }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (player->HasSkill(SKILL_ALCHEMY) &&
            player->GetBaseSkillValue(SKILL_ALCHEMY) >= 325 &&
            player->GetLevel() > 67) {
            if (player->GetQuestRewardStatus(Q_MASTER_TRANSMUTE) ||
                player->GetQuestRewardStatus(Q_MASTER_ELIXIR) ||
                player->GetQuestRewardStatus(Q_MASTER_POTION)) {
    ...
    void SendActionMenu(Player* player, Creature* creature, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 4:
            ProcessUnlearnAction(player,
                                 creature,
                                 S_UNLEARN_TRANSMUTE,
                                 0,
                                 DoHighUnlearnCost(player));
            break;
...
public:
    ...
    {
        return (player->HasSpell(S_HAMMER) || player->HasSpell(S_AXE) ||
                player->HasSpell(S_SWORD));
    }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (player->GetBaseSkillValue(SKILL_BLACKSMITHING) >= 225) {
            if (player->GetQuestRewardStatus(5284) ||
                player->GetQuestRewardStatus(5302) ||
                player->GetQuestRewardStatus(5283) ||
                player->GetQuestStatus(5301)) {
                switch (creatureId) {
                case N_TRAINER_SMITHOMNI1: // Myolor Sunderfury
                case N_TRAINER_SMITHOMNI2: // Krathok Moltenfist
                    if (!player->HasSpell(S_ARMOR) &&
                        !player->HasSpell(S_WEAPON))
                        AddGossipItemFor(player,
                                         GOSSIP_ICON_CHAT,
                                         GOSSIP_ARMOR_LEARN,
                                         GOSSIP_SENDER_MAIN,
        ...
        // WEAPONSMITH SPEC
        if (player->HasSpell(S_WEAPON) && player->GetLevel() > 49 &&
            player->GetBaseSkillValue(SKILL_BLACKSMITHING) >= 250) {
            switch (creatureId) {
    ...
    void SendActionMenu(Player* player, Creature* creature, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 8:
            ProcessUnlearnAction(player,
                                 ...
                                 S_UNLEARN_HAMMER,
                                 0,
                                 DoMedUnlearnCost(player));
            break;
        case GOSSIP_ACTION_INFO_DEF + 9:
            ProcessUnlearnAction(
                player, creature, S_UNLEARN_AXE, 0, DoMedUnlearnCost(player));
            break;
        case GOSSIP_ACTION_INFO_DEF + 10:
            ProcessUnlearnAction(
                player, creature, S_UNLEARN_SWORD, 0, DoMedUnlearnCost(player));
            break;
        }
    }
...
public:
    npc_engineering_tele_trinket()
        : CreatureScript("npc_engineering_tele_trinket")
    {
    }
                  ...
                  uint32& npcTextId)
    {
        bool res  = false;
        npcTextId = textId;
        if (player->GetBaseSkillValue(SKILL_ENGINEERING) >= skillValue &&
            player->HasSpell(reqSpellId)) {
...
public:
    ...
    {
        return (player->HasSpell(S_DRAGON) || player->HasSpell(S_ELEMENTAL) ||
                player->HasSpell(S_TRIBAL));
    }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        case N_TRAINER_DRAGON2: // Thorkaf Dragoneye
            AddGossipItemFor(player,
                             creature->GetEntry() == N_TRAINER_DRAGON1
        ...
        case N_TRAINER_ELEMENTAL2: // Brumn Winterhoof
            AddGossipItemFor(player,
                             creature->GetEntry() == N_TRAINER_ELEMENTAL1
        ...
        case N_TRAINER_TRIBAL2: // Se'Jib
            AddGossipItemFor(player,
                             creature->GetEntry() == N_TRAINER_TRIBAL1
        ...
        if (player->HasSkill(SKILL_LEATHERWORKING) &&
            player->GetBaseSkillValue(SKILL_LEATHERWORKING) >= 225 &&
            player->GetLevel() > 40) {
            switch (creature->GetEntry()) {
            case N_TRAINER_DRAGON1: // Peter Galen
            case N_TRAINER_DRAGON2: // Thorkaf Dragoneye
                        ...
                        uint32 action) override
    {
        ...
        case GOSSIP_MENU_UNLEARN_CONFIRM_DRAGONSCALE:
            AddGossipItemFor(player,
                             ...
                             DoMedUnlearnCost(player));
            SendGossipMenuFor(
                player, GOSSIP_TEXT_UNLEARN_CONFIRM_DRAGONSCALE, creature);
            break;
        case GOSSIP_MENU_UNLEARN_CONFIRM_ELEMENTAL:
            AddGossipItemFor(player,
                             ...
                             DoMedUnlearnCost(player));
            SendGossipMenuFor(
                player, GOSSIP_TEXT_UNLEARN_CONFIRM_ELEMENTAL, creature);
            break;
        case GOSSIP_MENU_UNLEARN_CONFIRM_TRIBAL:
            AddGossipItemFor(player,
                             ...
                             DoMedUnlearnCost(player));
            SendGossipMenuFor(
                player, GOSSIP_TEXT_UNLEARN_CONFIRM_TRIBAL, creature);
            break;
        case GOSSIP_ACTION_INFO_DEF + 1:
            ProcessUnlearnAction(player,
                                 creature,
...
public:
    ...
    {
        return (player->HasSpell(S_MOONCLOTH) ||
                player->HasSpell(S_SHADOWEAVE) ||
                player->HasSpell(S_SPELLFIRE));
    }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (player->HasSkill(SKILL_TAILORING) &&
            player->GetBaseSkillValue(SKILL_TAILORING) >= 350 &&
            player->GetLevel() > 59) {
            if (player->GetQuestRewardStatus(10831) ||
                player->GetQuestRewardStatus(10832) ||
                player->GetQuestRewardStatus(10833)) {
                switch (creature->GetEntry()) {
...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* gameobject) override
    {
        // ENGINEERING SPEC
        if (player->HasSkill(SKILL_ENGINEERING) &&
            player->GetBaseSkillValue(SKILL_ENGINEERING) >= 225 &&
            player->GetLevel() >= 35) {
            if (player->GetQuestRewardStatus(3643) ||
                player->GetQuestRewardStatus(3641) ||
                player->GetQuestRewardStatus(3639)) {
                if (player->HasSpell(S_GOBLIN)) // Has Goblin specialization
                {
                    AddGossipItemFor(player,
                             ...
                             S_GNOMISH)) // Has Gnomish specialization
                {
                    AddGossipItemFor(player,
                                     0,
        ...
        if (player->HasSkill(SKILL_LEATHERWORKING) &&
            player->GetBaseSkillValue(SKILL_LEATHERWORKING) >= 225 &&
            player->GetLevel() >= 40) {
            if (!HasLeatherSpecialty(player) &&
                (player->GetQuestRewardStatus(5141) ||
                 player->GetQuestRewardStatus(5143) ||
                 player->GetQuestRewardStatus(5144) ||
                 player->GetQuestRewardStatus(5145) ||
                 player->GetQuestRewardStatus(5146) ||
                 player->GetQuestRewardStatus(5148))) {
                AddGossipItemFor(player,
        ...
        SendGossipMenuFor(
            player, player->GetGossipTextId(gameobject), gameobject->GetGUID());
        return true;
    }

    void
    SendActionMenu(Player* player, GameObject* /*gameobject*/, uint32 uiAction)
    {
        switch (uiAction) {
        // Learn Goblin
        case GOSSIP_ACTION_INFO_DEF + 1:
            ProcessCastaction(
                player, nullptr, S_GOBLIN, S_LEARN_GOBLIN, DoLearnCost(player));
            break;
        // Learn Gnomish
        case GOSSIP_ACTION_INFO_DEF + 2:
            ProcessCastaction(player,
        ...
        case GOSSIP_ACTION_INFO_DEF + 6:
            ProcessCastaction(
                player, nullptr, S_ELEMENTAL, S_LEARN_ELEMENTAL, 0);
            break;
        // Learn Tribal
        case GOSSIP_ACTION_INFO_DEF + 7:
    ...
    void
    SendConfirmLearn(Player* player, GameObject* gameobject, uint32 uiAction)
    {
        switch (uiAction) {
        // Goblin
        case GOSSIP_ACTION_INFO_DEF + 1:
            AddGossipItemFor(player,
                             ...
                             uiAction);
            SendGossipMenuFor(player,
                              player->GetGossipTextId(gameobject),
                              gameobject->GetGUID());
            break;
        // Gnomish
        case GOSSIP_ACTION_INFO_DEF + 2:
    ...
    void
    SendConfirmUnlearn(Player* player, GameObject* gameobject, uint32 uiAction)
    {
        switch (uiAction) {
        // Goblin
        case GOSSIP_ACTION_INFO_DEF + 3:
