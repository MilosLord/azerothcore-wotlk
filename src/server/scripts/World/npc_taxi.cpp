...
enum Npcs {
    ...
    NPC_KIELAR = 17209, // William Kielar <Spectral Gryphon Master> - Eastern
                        // Plaguelands Towers
};
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        case NPC_NETHER_DRAKE:
            if (player->GetQuestStatus(QUEST_NETHERY_WINGS) ==
        ...
        case NPC_IRONWING:
            ...
            break;
        case NPC_DABIR:
            if (player->GetQuestStatus(QUEST_GATEWAYS_A) ==
                QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 0,
            ...
            break;
        case NPC_BRACK:
            if (player->GetQuestStatus(QUEST_GATEWAYS_H) ==
                QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 5,
            ...
            if (player->GetQuestStatus(QUEST_ABBYSAL) ==
                    QUEST_STATUS_INCOMPLETE ||
                player->GetQuestStatus(QUEST_ABBYSAL_DAILY) ==
                    QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 0,
            ...
            if (player->GetQuestStatus(QUEST_SPINEBREAKER) ==
        ...
        case NPC_IRENA:
            ...
            break;
        case NPC_AYREN:
            if (player->GetQuestStatus(QUEST_DEAD_SCAR) ==
                    QUEST_STATUS_INCOMPLETE ||
                player->GetQuestStatus(QUEST_AIR_STRIKE) ==
                    QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 0,
            ...
            if (player->GetQuestStatus(QUEST_INTERCEPT) ==
                    QUEST_STATUS_INCOMPLETE ||
                player->GetQuestStatus(QUEST_KEEP_AT_BEY) ==
                    QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 0,
        ...
        case NPC_DRAGONHAWK:
            ...
            break;
        case NPC_VERONIA:
            if (player->GetQuestStatus(QUEST_BEHIND_ENEMY) !=
        ...
        case NPC_TORASTRASZA:
            ...
            AddGossipItemFor(player,
                             ...
                             0,
                             GOSSIP_SENDER_MAIN,
                             GOSSIP_ACTION_INFO_DEF + 22);
            break;
        case NPC_CESSA:
            if (player->GetQuestStatus(QUEST_SURVEY_ALCAZ) ==
                QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player,
                                 gossipmenuid,
                                 0,
                                 GOSSIP_SENDER_MAIN,
                                 GOSSIP_ACTION_INFO_DEF + 25);
            break;
        case NPC_KIELAR:
            AddGossipItemFor(player,
                             gossipmenuid,
                             0,
                             GOSSIP_SENDER_MAIN,
                             GOSSIP_ACTION_INFO_DEF + 26); // Northpass Tower.
            AddGossipItemFor(player,
                             gossipmenuid,
                             1,
                             GOSSIP_SENDER_MAIN,
                             GOSSIP_ACTION_INFO_DEF + 27); // Eastwall Tower.
            AddGossipItemFor(player,
                             gossipmenuid,
                             2,
                             GOSSIP_SENDER_MAIN,
                             GOSSIP_ACTION_INFO_DEF + 28); // Crown Guard Tower.
            break;
        }
                        ...
                        uint32 action) override
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 3:
            CloseGossipMenuFor(player);
            player->CastSpell(
                player, 53335, true); // TaxiPath 1041 (Stormwind Harbor)
            break;
        case GOSSIP_ACTION_INFO_DEF + 4:
            ...
            player->CastSpell(
                player,
                33768,
                true); // TaxiPath 585 (Gateways Murket and Shaadraz)
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:
            CloseGossipMenuFor(player);
            player->CastSpell(
                player, 35069, true); // TaxiPath 612 (Taxi - Hellfire Peninsula
                                      // - Expedition Point to Shatter Point)
            break;
        case GOSSIP_ACTION_INFO_DEF + 8:
            ...
            player->CastSpell(
                player,
                33659,
                true); // TaxiPath 584 (Gateways Murket and Shaadraz)
            break;
        case GOSSIP_ACTION_INFO_DEF + 9:
            ...
            player->CastSpell(
                player,
                33825,
                true); // TaxiPath 587 (Aerial Assault Flight (Horde))
            break;
        case GOSSIP_ACTION_INFO_DEF + 10:
            CloseGossipMenuFor(player);
            player->CastSpell(
                player, 34578, true); // TaxiPath 604 (Taxi - Reaver's Fall to
                                      // Spinebreaker Ridge)
            break;
        ...
        case GOSSIP_ACTION_INFO_DEF + 16:
            ...
            player->CastSpell(
                player,
                41279,
                true); // TaxiPath 705 (Taxi - Skettis to Skyguard Outpost)
            break;
...
void AddSC_npc_taxi() { new npc_taxi; }
