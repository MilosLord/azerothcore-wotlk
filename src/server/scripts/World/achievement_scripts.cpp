...
public:
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        ...
        return bg && bg->GetBgTypeID(true) == BATTLEGROUND_AB &&
               bg->ToBattlegroundAB()->IsTeamScores500Disadvantage(
                   source->GetTeamId());
    }
};
    ...
    bool OnCheck(Player* source, Unit* target, uint32 /*criteria_id*/) override
    {
        ...
        if (Player const* player = target->ToPlayer()) {
            ...
            return bg && bg->GetBgTypeID(true) == BATTLEGROUND_WS &&
                   bg->ToBattlegroundWS()->GetFlagState(player->GetTeamId()) ==
...
public:
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        ...
        return bg && bg->GetBgTypeID(true) == BATTLEGROUND_IC &&
               bg->ToBattlegroundIC()->IsResourceGlutAllowed(
                   source->GetTeamId());
    }
};
...
public:
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        if (Creature* vehicle = source->GetVehicleCreatureBase())
            return vehicle->GetEntry() == NPC_GLAIVE_THROWER_H ||
                   vehicle->GetEntry() == NPC_GLAIVE_THROWER_A;
...
public:
    achievement_bg_sa_artillery()
        : AchievementCriteriaScript("achievement_bg_sa_artillery")
    {
    }
...
public:
    achievement_arena_by_type(char const* name, uint8 arenaType)
        : AchievementCriteriaScript(name), _arenaType(arenaType)
    {
    }
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        return source->InArena() &&
               source->GetBattleground()->GetArenaType() == _arenaType;
    }
...
public:
    achievement_sickly_gazelle()
        : AchievementCriteriaScript("achievement_sickly_gazelle")
    {
    }
...
public:
    achievement_everything_counts()
        : AchievementCriteriaScript("achievement_everything_counts")
    {
    }
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        ...
        return bg && bg->GetBgTypeID(true) == BATTLEGROUND_AV &&
               bg->ToBattlegroundAV()->IsBothMinesControlledByTeam(
                   source->GetTeamId());
    }
};
...
public:
    achievement_bg_av_perfection()
        : AchievementCriteriaScript("achievement_bg_av_perfection")
    {
    }
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        Battleground* bg = source->GetBattleground();
        return bg && bg->GetBgTypeID(true) == BATTLEGROUND_AV &&
               bg->ToBattlegroundAV()->IsAllTowersControlledAndCaptainAlive(
                   source->GetTeamId());
    }
};

class achievement_sa_defense_of_the_ancients
    : public AchievementCriteriaScript {
public:
    achievement_sa_defense_of_the_ancients()
        : AchievementCriteriaScript("achievement_sa_defense_of_the_ancients")
    {
    }
...
public:
    achievement_not_even_a_scratch()
        : AchievementCriteriaScript("achievement_not_even_a_scratch")
    {
    }
    ...
    OnCheck(Player* source, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        ...
        return battleground &&
               battleground->GetBgTypeID(true) == BATTLEGROUND_SA &&
               battleground->ToBattlegroundSA()->notEvenAScratch(
                   source->GetTeamId());
    }
};

class achievement_killed_exp_or_honor_target
    : public AchievementCriteriaScript {
public:
    achievement_killed_exp_or_honor_target()
        : AchievementCriteriaScript("achievement_killed_exp_or_honor_target")
    {
    }
...
class achievement_flirt_with_disaster_perf_check
    : public AchievementCriteriaScript {
public:
    ...
    OnCheck(Player* player, Unit* /*target*/, uint32 /*criteria_id*/) override
    {
        ...
        if (player->HasAura(AURA_PERFUME_FOREVER) ||
            player->HasAura(AURA_PERFUME_ENCHANTRESS) ||
...
void AddSC_achievement_scripts()
{
    ...
    new achievement_arena_by_type("achievement_arena_2v2_check",
                                  ARENA_TYPE_2v2);
    new achievement_arena_by_type("achievement_arena_3v3_check",
                                  ARENA_TYPE_3v3);
    new achievement_arena_by_type("achievement_arena_5v5_check",
                                  ARENA_TYPE_5v5);
