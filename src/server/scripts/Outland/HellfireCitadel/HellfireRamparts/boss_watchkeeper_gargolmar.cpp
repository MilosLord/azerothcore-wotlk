...
struct boss_watchkeeper_gargolmar : public BossAI {
    boss_watchkeeper_gargolmar(Creature* creature)
        : BossAI(creature, DATA_WATCHKEEPER_GARGOLMAR)
    {
        _taunted = false;
    ...
    void Reset() override
    {
        ...
        ScheduleHealthCheckEvent(50, [&] {
            ...
            me->GetCreaturesWithEntryInRange(
                clist, 100.0f, NPC_HELLFIRE_WATCHER);
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        scheduler
            ...
            .Schedule(3s, [this](TaskContext context) {
                Talk(SAY_SURGE);
                if (Unit* target =
                        SelectTarget(SelectTargetMethod::MinDistance, 0)) {
