...
enum Says { SAY_AGGRO = 0, SAY_KILL = 1, SAY_DIE = 2 };

enum Spells { SPELL_EXPLODING_BEAKER = 30925, SPELL_DOMINATION = 30923 };
...
void AddSC_boss_the_maker() { RegisterBloodFurnaceCreatureAI(boss_the_maker); }
