...
public:
    instance_shadow_labyrinth()
        : InstanceMapScript("instance_shadow_labyrinth", 555)
    {
    }
    ...
    struct instance_shadow_labyrinth_InstanceMapScript : public InstanceScript {
        ...
        void Initialize() override { _ritualistsAliveCount = 0; }
...
class spell_mark_of_malice : public AuraScript {
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& /*eventInfo*/)
    {
        ...
        GetTarget()->CastSpell(
            GetTarget(), SPELL_MARK_OF_MALICE_TRIGGERED, true);
    }

    void Register() override
    {
        OnEffectProc += AuraEffectProcFn(
            spell_mark_of_malice::HandleProc, EFFECT_0, SPELL_AURA_DUMMY);
    }
};
