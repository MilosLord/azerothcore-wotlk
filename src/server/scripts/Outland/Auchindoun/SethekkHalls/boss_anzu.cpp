...
struct boss_anzu : public BossAI {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        scheduler
            ...
            .Schedule(8s, [this](TaskContext context) {
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 1, 45.0f, true)) {
    ...
    {
        me->SummonCreature(
            NPC_HAWK_SPIRIT, AnzuSpiritPos[0], TEMPSUMMON_MANUAL_DESPAWN);
        me->SummonCreature(
            NPC_FALCON_SPIRIT, AnzuSpiritPos[1], TEMPSUMMON_MANUAL_DESPAWN);
        me->SummonCreature(
            NPC_EAGLE_SPIRIT, AnzuSpiritPos[2], TEMPSUMMON_MANUAL_DESPAWN);
    }
...
struct npc_anzu_spirit : public ScriptedAI {
    ...
    void IsSummonedBy(WorldObject* /*summoner*/) override
    {
        _scheduler.Schedule(1ms, [this](TaskContext task) {
            ...
            if (me->GetAuraEffect(
                    SPELL_AURA_PERIODIC_HEAL, SPELLFAMILY_DRUID, 64, 0)) {
