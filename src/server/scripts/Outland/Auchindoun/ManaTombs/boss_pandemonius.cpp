...
struct boss_pandemonius : public BossAI {
    ...
    void PullRoom()
    {
        ...
        GetCreatureListWithEntryInGrid(
            creatureList, me, NPC_SCAVENGER, ROOM_PULL_RANGE);
        GetCreatureListWithEntryInGrid(
            creatureList, me, NPC_CRYPT_RAIDER, ROOM_PULL_RANGE);
        GetCreatureListWithEntryInGrid(
            creatureList, me, NPC_SORCERER, ROOM_PULL_RANGE);
        for (Creature* creature : creatureList) {
            if (creature && (creature->GetPositionY() < ROOM_ENTERANCE &&
                             creature->GetPositionY() > ROOM_EXIT)) {
...
void AddSC_boss_pandemonius() { RegisterManaTombsCreatureAI(boss_pandemonius); }
