...
public:
    SuckBackEvent(Creature& owner, uint32 action)
        : BasicEvent(), _owner(owner), _action(action)
    {
    }
...
public:
    ...
    struct boss_reliquary_of_soulsAI : public BossAI {
        boss_reliquary_of_soulsAI(Creature* creature)
            : BossAI(creature, DATA_RELIQUARY_OF_SOULS)
        {
        }
        ...
        {
            if (!who || me->getStandState() != UNIT_STAND_STATE_SLEEP ||
                who->GetTypeId() != TYPEID_PLAYER ||
                me->GetDistance2d(who) > 90.0f ||
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPAWN_SOUL:
                me->CastCustomSpell(SPELL_SUMMON_ENSLAVED_SOUL,
    ...
    struct boss_essence_of_sufferingAI : public ScriptedAI {
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            ...
            me->m_Events.AddEvent(
                new SuckBackEvent(*me, ACTION_ESSENCE_OF_SUFFERING),
            ...
            if (damage >= me->GetHealth()) {
                ...
                if (!me->HasUnitFlag(UNIT_FLAG_NON_ATTACKABLE)) {
                    me->RemoveAurasDueToSpell(
                        SPELL_ESSENCE_OF_SUFFERING_PASSIVE); // prevent fixate
                                                             // from triggering
                    ...
                    me->GetMotionMaster()->MovePoint(
                        POINT_GO_BACK, me->GetHomePosition(), false);
                    events.Reset();
                }
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SUFF_SOUL_DRAIN:
                me->CastCustomSpell(
                    SPELL_SOUL_DRAIN, SPELLVALUE_MAX_TARGETS, 3, me, false);
...
public:
    ...
    struct boss_essence_of_desireAI : public ScriptedAI {
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            ...
            me->m_Events.AddEvent(
                new SuckBackEvent(*me, ACTION_ESSENCE_OF_DESIRE),
                me->m_Events.CalculateTime(1500));
            me->SetTarget();
            me->SetFacingTo(M_PI / 2.0f);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_ANGER_SPITE:
                if (roll_chance_i(30))
                    Talk(ANGER_SAY_SPEC);
                me->CastCustomSpell(
                    SPELL_SPITE, SPELLVALUE_MAX_TARGETS, 3, me, false);
...
public:
    spell_reliquary_of_souls_aura_of_suffering()
        : SpellScriptLoader("spell_reliquary_of_souls_aura_of_suffering")
    {
    }

    class spell_reliquary_of_souls_aura_of_suffering_AuraScript
        : public AuraScript {
        ...
        {
            GetTarget()->CastSpell(
                GetTarget(), SPELL_AURA_OF_SUFFERING_TRIGGER, true);
        }
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_reliquary_of_souls_aura_of_suffering_AuraScript::
                    HandleEffectApply,
                EFFECT_0,
...
public:
    spell_reliquary_of_souls_fixate()
        : SpellScriptLoader("spell_reliquary_of_souls_fixate")
    {
    }
    ...
    class spell_reliquary_of_souls_fixate_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_reliquary_of_souls_fixate_SpellScript::FilterTargets,
                EFFECT_ALL,
    ...
    class spell_reliquary_of_souls_fixate_AuraScript : public AuraScript {
        ...
        {
            OnEffectRemove += AuraEffectRemoveFn(
                spell_reliquary_of_souls_fixate_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
        }
...
public:
    spell_reliquary_of_souls_aura_of_desire()
        : SpellScriptLoader("spell_reliquary_of_souls_aura_of_desire")
    {
    }

    class spell_reliquary_of_souls_aura_of_desire_AuraScript
        : public AuraScript {
        ...
        void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
        {
            ...
            eventInfo.GetActionTarget()->CastCustomSpell(
                ...
                eventInfo.GetDamageInfo()->GetDamage() / 2,
                eventInfo.GetActor(),
                true);
        }
                             ...
                             bool& /*canBeRecalculated*/)
        {
            if (AuraEffect* effect = GetAura()->GetEffect(EFFECT_2))
                amount =
                    std::max<int32>(-100, -5 * int32(effect->GetTickNumber()));
        }
        ...
        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(
                spell_reliquary_of_souls_aura_of_desire_AuraScript::CheckProc);
            OnEffectProc += AuraEffectProcFn(
                spell_reliquary_of_souls_aura_of_desire_AuraScript::HandleProc,
                EFFECT_0,
                SPELL_AURA_MOD_HEALING_PCT);
            ...
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_reliquary_of_souls_aura_of_desire_AuraScript::Update,
                EFFECT_2,
...
public:
    spell_reliquary_of_souls_aura_of_anger()
        : SpellScriptLoader("spell_reliquary_of_souls_aura_of_anger")
    {
    }

    class spell_reliquary_of_souls_aura_of_anger_AuraScript
        : public AuraScript {
        ...
        void Register() override
        {
            ...
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_reliquary_of_souls_aura_of_anger_AuraScript::Update,
                EFFECT_0,
                SPELL_AURA_PERIODIC_DAMAGE);
        }
    };
...
public:
    spell_reliquary_of_souls_spite()
        : SpellScriptLoader("spell_reliquary_of_souls_spite")
    {
    }
    ...
    class spell_reliquary_of_souls_spite_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_reliquary_of_souls_spite_AuraScript::HandleEffectRemove,
                EFFECT_0,
