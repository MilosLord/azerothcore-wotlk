...
struct boss_supremus : public BossAI {
    ...
    void SchedulePhase(bool run)
    {
        ...
        if (!run) {
            events.ScheduleEvent(
                EVENT_SPELL_HATEFUL_STRIKE, 5000, EVENT_GROUP_ABILITIES);
            me->ApplySpellImmune(
        ...
        if (summon->GetEntry() == NPC_SUPREMUS_PUNCH_STALKER) {
            ...
            if (Unit* target =
                ...
                summon->GetMotionMaster()->MoveFollow(
                    target, 0.0f, 0.0f, MOTION_SLOT_CONTROLLED);
        }
        else
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        case EVENT_SPELL_HATEFUL_STRIKE:
            ...
            events.ScheduleEvent(EVENT_SPELL_HATEFUL_STRIKE,
                                 urand(1500, 3000),
        ...
        case EVENT_SPELL_MOLTEN_FLAMES:
            ...
            events.ScheduleEvent(
                EVENT_SPELL_MOLTEN_FLAMES, 20000, EVENT_GROUP_ABILITIES);
            break;
        ...
        case EVENT_SWITCH_TARGET:
            ...
            events.ScheduleEvent(
                EVENT_SWITCH_TARGET, 10000, EVENT_GROUP_ABILITIES);
            break;
        ...
        case EVENT_SPELL_VOLCANIC_ERUPTION:
            ...
            events.ScheduleEvent(EVENT_SPELL_VOLCANIC_ERUPTION,
                                 urand(10000, 18000),
                                 EVENT_GROUP_ABILITIES);
            break;
        }
    ...
    {
        return me->GetPositionX() < 565 || me->GetPositionX() > 865 ||
               me->GetPositionY() < 545 || me->GetPositionY() > 1000;
    }
};

void AddSC_boss_supremus() { RegisterBlackTempleCreatureAI(boss_supremus); }
