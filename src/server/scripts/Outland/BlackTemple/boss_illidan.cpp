...
public:
    ...
    struct boss_illidan_stormrageAI : public BossAI {
        boss_illidan_stormrageAI(Creature* creature)
            : BossAI(creature, DATA_ILLIDAN_STORMRAGE)
        {
        }
        ...
        {
            return target->GetEntry() != NPC_AKAMA_ILLIDAN &&
                   target->GetEntry() != NPC_MAIEV_SHADOWSONG;
        }
            ...
            if (id == POINT_ILLIDAN_HOVER) {
                if (events2.GetNextEventTime(EVENT_START_PHASE_2_END) == 0) {
                    ...
                    events.ScheduleEvent(
                        EVENT_PHASE_2_EYE_BEAM, 15000, GROUP_PHASE_2_ABILITY);
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_SPELL_BERSERK,
                                 25 * MINUTE * IN_MILLISECONDS);
        ...
        void AttackStart(Unit* victim) override
        {
            if (victim && me->Attack(victim, true))
                me->GetMotionMaster()->MoveChase(
                    victim,
                    events.GetNextEventTime(EVENT_REMOVE_DEMON_FORM) != 0
                        ? 35.0f
                        : 0.0f);
        }
                         ...
                         SpellSchoolMask) override
        {
            if (damage >= me->GetHealth()) {
                ...
                if (!me->HasUnitFlag(UNIT_FLAG_NON_ATTACKABLE)) {
                    if (Creature* maiev = summons.GetCreatureWithEntry(
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_PHASE_2_EYE_BEAM_START:
                ...
                if (Creature* trigger =
                        summons.GetCreatureWithEntry(NPC_ILLIDAN_DB_TARGET))
                    trigger->GetMotionMaster()->MovePoint(
                        0,
                        eyeBeamPos[beamPosId + MAX_EYE_BEAM_POS],
                        false,
                        true);
                break;
            ...
            case EVENT_START_PHASE_2_END:
                ...
                if (!summons.HasEntry(NPC_FLAME_OF_AZZINOTH)) {
                    ...
                    me->GetMotionMaster()->MovePoint(
                        POINT_ILLIDAN_MIDDLE, 676.02f, 305.45f, 353.6f);
                    break;
                }
            ...
            case EVENT_OUTRO_1:
                if (Creature* maiev =
                        summons.GetCreatureWithEntry(NPC_MAIEV_SHADOWSONG)) {
                    maiev->SetTarget(me->GetGUID());
                    maiev->SetFacingToObject(me);
                ...
                if (Creature* akama =
                        instance->GetCreature(DATA_AKAMA_ILLIDAN)) {
                    akama->AI()->DoAction(ACTION_ILLIDAN_DEAD);
                    akama->SetTarget(me->GetGUID());
                    akama->GetMotionMaster()->MovePoint(
                        0, 695.63f, 306.63f, 354.26f);
                }
            ...
            case EVENT_PHASE_2_SUMMON1:
                ...
                me->GetMotionMaster()->MovePoint(POINT_ILLIDAN_HOVER,
                                                 727.875f,
                                                 305.365f,
                                                 356.0f,
                                                 false,
            ...
            case EVENT_PHASE_2_CHANGE_POS:
                ...
                events.ScheduleEvent(
                    EVENT_SPELL_FIREBALL, 8000, GROUP_PHASE_2_ABILITY);
                events.ScheduleEvent(
                    EVENT_SPELL_DARK_BARRAGE, 18000, GROUP_PHASE_2_ABILITY);
                events.ScheduleEvent(EVENT_PHASE_2_EYE_BEAM,
                                     urand(25000, 50000),
                                     GROUP_PHASE_2_ABILITY);
                me->GetMotionMaster()->MovePoint(
                    POINT_ILLIDAN_HOVER, airHoverPos[beamPosId], false, true);
                break;
            case EVENT_PHASE_2_EYE_BEAM:
                me->SummonCreature(NPC_ILLIDAN_DB_TARGET,
                                   eyeBeamPos[beamPosId],
            ...
            case EVENT_SPELL_FIREBALL:
                ...
                events.ScheduleEvent(
                    EVENT_SPELL_FIREBALL, 2200, GROUP_PHASE_2_ABILITY);
                break;
            case EVENT_SPELL_DARK_BARRAGE:
                ...
                events.ScheduleEvent(
                    EVENT_SPELL_DARK_BARRAGE, 30000, GROUP_PHASE_2_ABILITY);
                break;
            ...
            case EVENT_MOVE_MAIEV:
                if (Creature* maiev =
                    ...
                    if (events.GetNextEventTime(EVENT_REMOVE_DEMON_FORM) != 0) {
                        ...
                        if (Unit* target = SelectTarget(
                                SelectTargetMethod::Random, 0, -25.0f, true))
                            maiev->GetMotionMaster()->MoveCharge(
                                target->GetPositionX(),
                                target->GetPositionY(),
                                target->GetPositionZ(),
                                7.0f,
        ...
        {
            return me->GetHomePosition().GetExactDist(me) > 90.0f ||
                   !SelectTargetFromPlayerList(80.0f);
        }
    };
    ...
    struct npc_akama_illidanAI : public npc_escortAI {
        ...
        void DoAction(int32 param) override
        {
            if (param == ACTION_FIGHT_MINIONS) {
                ...
                me->GetMotionMaster()->MoveCharge(
                    741.97f, 358.74f, 353.0f, 10.0f, POINT_FIGHT_MINIONS);
                ...
                me->GetMotionMaster()->MovePath(PATH_AKAMA_ILLIDARI_COUNCIL_1,
                                                false);
            }
        }
                           ...
                           uint32 /*action*/) override
        {
            ...
            if (instance->GetBossState(DATA_AKAMA_ILLIDAN) != DONE) {
                ...
                me->GetMotionMaster()->MovePoint(
                    POINT_ILLIDAN, 744.45f, 304.84f, 353.0f);
                events.Reset();
        ...
        void PathEndReached(uint32 pathId) override
        {
            if (pathId == PATH_AKAMA_ILLIDARI_COUNCIL_1) {
                ScheduleUniqueTimedEvent(
                    200ms, [&] { Talk(SAY_AKAMA_COUNCIL_1); }, 1);
                ScheduleUniqueTimedEvent(
                    7800ms,
                    [&] {
        ...
        void UpdateEscortAI(uint32 diff) override
        {
            ...
            case EVENT_AKAMA_SCENE_5:
                me->SummonCreature(NPC_SPIRIT_OF_UDALO,
                                   me->GetPositionX() - 5.0f,
                                   me->GetPositionY() + 8.0f,
                                   me->GetPositionZ(),
                                   0.0f,
                                   TEMPSUMMON_TIMED_DESPAWN,
                                   60000);
                me->SummonCreature(NPC_SPIRIT_OF_OLUM,
                                   me->GetPositionX() - 5.0f,
                                   me->GetPositionY() - 8.0f,
                                   me->GetPositionZ(),
                                   0.0f,
            ...
            case EVENT_AKAMA_SCENE_6:
                if (Creature* udalo =
                        me->FindNearestCreature(NPC_SPIRIT_OF_UDALO, 15.0f))
                    udalo->AI()->Talk(SAY_UDALO);
                break;
            case EVENT_AKAMA_SCENE_7:
                if (Creature* olum =
                        me->FindNearestCreature(NPC_SPIRIT_OF_OLUM, 15.0f))
            ...
            case EVENT_AKAMA_SCENE_20:
                if (Creature* illidan =
                        instance->GetCreature(DATA_ILLIDAN_STORMRAGE))
            ...
            case EVENT_AKAMA_SUMMON_ILLIDARI:
                me->SummonCreature(NPC_ILLIDARI_ELITE,
                                   742.55f,
                                   359.12f,
                                   353.0f,
                                   4.35f,
                                   ...
                                   30000);
                events.ScheduleEvent(EVENT_AKAMA_SUMMON_ILLIDARI,
                                     urand(2000, 6000));
                break;
            case EVENT_AKAMA_SPELL_CHAIN:
                if (me->GetVictim())
                    me->CastSpell(
                        me->GetVictim(), SPELL_CHAIN_LIGHTNING, false);
    ...
    class spell_illidan_draw_soul_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_illidan_draw_soul_SpellScript::HandleScriptEffect,
                EFFECT_1,
...
public:
    spell_illidan_parasitic_shadowfiend()
        : SpellScriptLoader("spell_illidan_parasitic_shadowfiend")
    {
    }
    ...
    class spell_illidan_parasitic_shadowfiend_AuraScript : public AuraScript {
                                    ...
                                    AuraEffectHandleModes /*mode*/)
        {
            if (!GetTarget()->HasAura(SPELL_SHADOW_PRISON) &&
                GetTarget()->GetInstanceScript() &&
                GetTarget()->GetInstanceScript()->IsEncounterInProgress())
                GetTarget()->CastSpell(
                    GetTarget(), SPELL_SUMMON_PARASITIC_SHADOWFIENDS, true);
        }
...
public:
    spell_illidan_parasitic_shadowfiend_trigger()
        : SpellScriptLoader("spell_illidan_parasitic_shadowfiend_trigger")
    {
    }
    ...
    class spell_illidan_parasitic_shadowfiend_trigger_AuraScript
        : public AuraScript {
        PrepareAuraScript(
            spell_illidan_parasitic_shadowfiend_trigger_AuraScript)
    ...
    class spell_illidan_parasitic_shadowfiend_trigger_SpellScript
        : public SpellScript {
        PrepareSpellScript(
            spell_illidan_parasitic_shadowfiend_trigger_SpellScript);
...
public:
    spell_illidan_glaive_throw()
        : SpellScriptLoader("spell_illidan_glaive_throw")
    {
    }
    ...
    class spell_illidan_glaive_throw_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_illidan_glaive_throw_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_illidan_tear_of_azzinoth_summon_channel()
        : SpellScriptLoader("spell_illidan_tear_of_azzinoth_summon_channel")
    {
    }

    class spell_illidan_tear_of_azzinoth_summon_channel_AuraScript
        : public AuraScript {
        PrepareAuraScript(
        ...
        void OnPeriodic(AuraEffect const* /*aurEff*/)
        {
            ...
            if (Unit* caster = GetCaster()) {
                if (GetTarget()->GetDistance2d(caster) > 25.0f) {
                    SetDuration(0);
                    GetTarget()->CastSpell(
                        GetTarget(), SPELL_UNCAGED_WRATH, true);
                }
            }
            ...
            for (Map::PlayerList::const_iterator itr = pl.begin();
                ...
                if (Player* player = itr->GetSource())
                    if (player->GetPositionX() > 693.4f ||
                        player->GetPositionY() < 271.8f ||
                        player->GetPositionX() < 658.43f ||
                        player->GetPositionY() > 338.68f) {
...
public:
    spell_illidan_shadow_prison()
        : SpellScriptLoader("spell_illidan_shadow_prison")
    {
    }
    ...
    class spell_illidan_shadow_prison_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_illidan_shadow_prison_SpellScript::FilterTargets,
                EFFECT_ALL,
...
public:
    spell_illidan_demon_transform1()
        : SpellScriptLoader("spell_illidan_demon_transform1")
    {
    }
    ...
    class spell_illidan_demon_transform1_AuraScript : public AuraScript {
        ...
        void OnPeriodic(AuraEffect const* /*aurEff*/)
        {
            ...
            GetUnitOwner()->CastSpell(
                GetUnitOwner(), SPELL_DEMON_TRANSFORM_2, true);
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_illidan_demon_transform1_AuraScript::OnPeriodic,
                EFFECT_1,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    spell_illidan_demon_transform2()
        : SpellScriptLoader("spell_illidan_demon_transform2")
    {
    }
    ...
    class spell_illidan_demon_transform2_AuraScript : public AuraScript {
        ...
        void OnPeriodic(AuraEffect const* aurEff)
        {
            ...
            if (aurEff->GetTickNumber() == 1) {
                if (GetUnitOwner()->GetDisplayId() ==
                    GetUnitOwner()->GetNativeDisplayId())
                    GetUnitOwner()->CastSpell(
                        GetUnitOwner(), SPELL_DEMON_FORM, true);
                else
                ...
                SetDuration(0);
                GetUnitOwner()->CastSpell(
                    GetUnitOwner(), SPELL_DEMON_TRANSFORM_3, true);
                if (Aura* aura =
                        GetUnitOwner()->GetAura(SPELL_DEMON_TRANSFORM_3))
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_illidan_demon_transform2_AuraScript::OnPeriodic,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    ...
    class spell_illidan_flame_burst_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_illidan_flame_burst_SpellScript::HandleScriptEffect,
                EFFECT_0,
                SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    spell_illidan_found_target()
        : SpellScriptLoader("spell_illidan_found_target")
    {
    }
    ...
    class spell_illidan_found_target_SpellScript : public SpellScript {
        ...
        void HandleDummy(SpellEffIndex effIndex)
        {
            ...
            if (Unit* target = GetHitUnit())
                if (GetCaster()->GetDistance(target) < 2.0f) {
                    ...
                    GetCaster()->CastSpell(
                        GetCaster(), SPELL_FIND_TARGET, true);
                }
        }
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_illidan_found_target_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    ...
    class spell_illidan_cage_trap_SpellScript : public SpellScript {
            ...
            if (Creature* target = GetHitCreature())
                if (GetCaster()->GetExactDist2d(target) < 4.0f) {
                    ...
                    if (GameObject* gobject =
                            GetCaster()->FindNearestGameObject(GO_CAGE_TRAP,
                                                               10.0f))
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_illidan_cage_trap_SpellScript::HandleScriptEffect,
                EFFECT_0,
                SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    spell_illidan_cage_trap_stun()
        : SpellScriptLoader("spell_illidan_cage_trap_stun")
    {
    }
    ...
    class spell_illidan_cage_trap_stun_AuraScript : public AuraScript {
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_illidan_cage_trap_stun_AuraScript::OnPeriodic,
                EFFECT_1,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
