...
public:
    ...
    struct boss_gurtogg_bloodboilAI : public BossAI {
        boss_gurtogg_bloodboilAI(Creature* creature)
            : BossAI(creature, DATA_GURTOGG_BLOODBOIL)
        {
        }
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(
                EVENT_SPELL_BEWILDERING_STRIKE, 28000, GROUP_DELAY);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_EJECT:
                me->CastSpell(me->GetVictim(),
                              me->HasAura(SPELL_FEL_RAGE_SELF) ? SPELL_EJECT2
                                                               : SPELL_EJECT1,
                              false);
            ...
            case EVENT_SPELL_FEL_GEYSER:
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 1, 40.0f, true)) {
    ...
    class spell_gurtogg_bloodboil_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_gurtogg_bloodboil_SpellScript::FilterTargets,
                EFFECT_ALL,
    ...
    class spell_gurtogg_eject_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_gurtogg_eject_SpellScript::HandleScriptEffect,
                EFFECT_2,
