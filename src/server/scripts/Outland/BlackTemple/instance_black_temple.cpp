...
ObjectData const objectData[] = {{0, 0}};

BossBoundaryData const boundaries = {
    {DATA_HIGH_WARLORD_NAJENTUS,
     new RectangleBoundary(394.0f, 479.4f, 707.8f, 859.1f)},
    {DATA_SUPREMUS, new RectangleBoundary(556.1f, 850.2f, 542.0f, 1001.0f)},
    {DATA_SHADE_OF_AKAMA,
     new RectangleBoundary(406.8f, 564.0f, 327.9f, 473.5f)},
    {DATA_TERON_GOREFIEND,
     new RectangleBoundary(512.5f, 613.3f, 373.2f, 432.0f)},
    {DATA_TERON_GOREFIEND, new ZRangeBoundary(179.5f, 223.6f)},
    {DATA_GURTOGG_BLOODBOIL,
     new RectangleBoundary(720.5f, 864.5f, 159.3f, 316.0f)},
    {DATA_RELIQUARY_OF_SOULS,
     new RectangleBoundary(435.9f, 660.3f, 21.2f, 229.6f)},
    ...
    {DATA_ILLIDARI_COUNCIL,
     new EllipseBoundary(Position(696.6f, 305.0f), 70.0, 85.0)},
    {DATA_ILLIDAN_STORMRAGE,
     new EllipseBoundary(Position(694.8f, 309.0f), 80.0, 95.0)}};
...
public:
    ...
    struct instance_black_temple_InstanceMapScript : public InstanceScript {
        ...
        {
            // If created after Illidari Council is done, then skip Akama's
            // event. Used for crashes/reset
...
public:
    spell_black_template_harpooners_mark()
        : SpellScriptLoader("spell_black_template_harpooners_mark")
    {
    }
    ...
    class spell_black_template_harpooners_mark_AuraScript : public AuraScript {
                               ...
                               AuraEffectHandleModes /*mode*/)
        {
            ...
            GetUnitOwner()->GetCreaturesWithEntryInRange(
                creatureList, 80.0f, NPC_DRAGON_TURTLE);
                                ...
                                AuraEffectHandleModes /*mode*/)
        {
            for (ObjectGuid const& guid : _turtleSet)
                if (Creature* turtle =
                        ObjectAccessor::GetCreature(*GetUnitOwner(), guid)) {
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_black_template_harpooners_mark_AuraScript::
                    HandleEffectApply,
                EFFECT_1,
...
public:
    spell_black_template_free_friend()
        : SpellScriptLoader("spell_black_template_free_friend")
    {
    }
    ...
    class spell_black_template_free_friend_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_black_template_free_friend_SpellScript::
                                  HandleScriptEffect,
                              EFFECT_0,
...
public:
    spell_black_temple_curse_of_the_bleakheart()
        : SpellScriptLoader("spell_black_temple_curse_of_the_bleakheart")
    {
    }
    ...
    class spell_black_temple_curse_of_the_bleakheart_AuraScript
        ...
        void Update(AuraEffect const* /*effect*/)
        {
            ...
            if (roll_chance_i(20))
                GetUnitOwner()->CastSpell(
                    GetUnitOwner(), SPELL_CHEST_PAINS, true);
        }
        ...
        void Register() override
        {
            ...
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_black_temple_curse_of_the_bleakheart_AuraScript::Update,
                EFFECT_0,
                SPELL_AURA_DUMMY);
        }
    };
...
public:
    spell_black_temple_skeleton_shot()
        : SpellScriptLoader("spell_black_temple_skeleton_shot")
    {
    }
    ...
    class spell_black_temple_skeleton_shot_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_black_temple_skeleton_shot_AuraScript::HandleEffectRemove,
                EFFECT_1,
...
public:
    spell_black_temple_wyvern_sting()
        : SpellScriptLoader("spell_black_temple_wyvern_sting")
    {
    }
    ...
    class spell_black_temple_wyvern_sting_AuraScript : public AuraScript {
        ...
        {
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_black_temple_wyvern_sting_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_MOD_STUN,
                AURA_EFFECT_HANDLE_REAL);
        }
...
public:
    spell_black_temple_charge_rage()
        : SpellScriptLoader("spell_black_temple_charge_rage")
    {
    }
    ...
    class spell_black_temple_charge_rage_AuraScript : public AuraScript {
        ...
        {
            PreventDefaultAction();
            if (Unit* target = GetUnitOwner()->SelectNearbyNoTotemTarget(
                    (Unit*)nullptr, 50.0f))
                GetUnitOwner()->CastSpell(
                    target,
                    GetSpellInfo()->Effects[effect->GetEffIndex()].TriggerSpell,
                    true);
        }
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_black_temple_charge_rage_AuraScript::Update,
                EFFECT_0,
...
public:
    spell_black_temple_shadow_inferno()
        : SpellScriptLoader("spell_black_temple_shadow_inferno")
    {
    }
    ...
    class spell_black_temple_shadow_inferno_AuraScript : public AuraScript {
        ...
        {
            PreventDefaultAction();
            GetUnitOwner()->CastCustomSpell(SPELL_SHADOW_INFERNO_DAMAGE,
                                            SPELLVALUE_BASE_POINT0,
                                            effect->GetAmount(),
                                            GetUnitOwner(),
                                            TRIGGERED_FULL_MASK);
            GetAura()
                ->GetEffect(effect->GetEffIndex())
                ->SetAmount(effect->GetAmount() + 500);
        }

        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_black_temple_shadow_inferno_AuraScript::Update,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    spell_black_temple_spell_absorption()
        : SpellScriptLoader("spell_black_temple_spell_absorption")
    {
    }
    ...
    class spell_black_temple_spell_absorption_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(
                spell_black_temple_spell_absorption_AuraScript::CalculateAmount,
                EFFECT_2,
                SPELL_AURA_SCHOOL_ABSORB);
            OnEffectAbsorb += AuraEffectAbsorbFn(
                spell_black_temple_spell_absorption_AuraScript::Absorb,
                EFFECT_2);
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_black_temple_spell_absorption_AuraScript::Update,
                EFFECT_1,
...
public:
    spell_black_temple_bloodbolt()
        : SpellScriptLoader("spell_black_temple_bloodbolt")
    {
    }
    ...
    class spell_black_temple_bloodbolt_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_black_temple_bloodbolt_SpellScript::HandleScriptEffect,
                EFFECT_0,
                SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    spell_black_temple_consuming_strikes()
        : SpellScriptLoader("spell_black_temple_consuming_strikes")
    {
    }
    ...
    class spell_black_temple_consuming_strikes_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectProc += AuraEffectProcFn(
                spell_black_temple_consuming_strikes_AuraScript::HandleProc,
                EFFECT_0,
...
public:
    spell_black_temple_curse_of_vitality()
        : SpellScriptLoader("spell_black_temple_curse_of_vitality")
    {
    }
    ...
    class spell_black_temple_curse_of_vitality_AuraScript : public AuraScript {
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_black_temple_curse_of_vitality_AuraScript::OnPeriodic,
                EFFECT_0,
                SPELL_AURA_PERIODIC_DAMAGE);
        }
    };
...
public:
    spell_black_temple_dementia()
        : SpellScriptLoader("spell_black_temple_dementia")
    {
    }
