    ...
    void JustSummoned(Creature* summon) override
    {
        ...
        if (summon->GetEntry() == WORLD_TRIGGER) {
            ...
            summon->GetMotionMaster()->MoveRandom(30.0f);
                 ...
                 summon->GetEntry() != NPC_ENCHANTED_ELEMENTAL) {
            summon->GetMotionMaster()->MovePoint(POINT_HOME,
                                                 me->GetPositionX(),
                                                 me->GetPositionY(),
                                                 me->GetPositionZ(),
                                                 true,
            ...
            .Schedule(1s, [this](TaskContext context) {
                if (!me->HasAura(SPELL_MAGIC_BARRIER)) {
                    ...
                    scheduler.Schedule(5s, [this](TaskContext context) {
                        ...
                        _batTimer = 20s - static_cast<std::chrono::seconds>(
                                              std::min(_count++, 16));
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (!me->IsWithinMeleeRange(me->GetVictim())) {
            ...
            me->CastSpell(me->GetVictim(),
                          roll_chance_i(33) ? SPELL_MULTI_SHOT : SPELL_SHOOT,
                          false);
            if (roll_chance_i(15)) {
                Talk(SAY_BOWSHOT);
            }
...
struct npc_tainted_elemental : public ScriptedAI {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        scheduler
            ...
            .Schedule(15s, [this](TaskContext) { me->DespawnOrUnsummon(); });
    }
...
class spell_lady_vashj_magic_barrier : public AuraScript {
    ...
    {
        Unit::DealDamage(
            GetTarget(), GetTarget(), GetTarget()->CountPctFromMaxHealth(5));
    }

    void Register() override
    {
        AfterEffectRemove += AuraEffectRemoveFn(
            spell_lady_vashj_magic_barrier::HandleEffectRemove,
            EFFECT_0,
...
class spell_lady_vashj_remove_tainted_cores : public SpellScript {
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_lady_vashj_remove_tainted_cores::HandleScriptEffect,
            EFFECT_0,
...
class spell_lady_vashj_summon_sporebat : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_lady_vashj_summon_sporebat::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_lady_vashj_spore_drop_effect : public SpellScript {
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_lady_vashj_spore_drop_effect::HandleScriptEffect,
            EFFECT_0,
            SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_lady_vashj_summons : public SpellScript {
    ...
    {
        return ValidateSpellInfo({SPELL_SUMMON_WAVE_A_MOB,
    ...
    void FilterTargets(std::list<WorldObject*>& targets)
    {
        ...
        // Coilfang Elites/Striders spawns on top of the stairs. The others at
        // the foot of the stairs.
        bool top = GetSpellInfo()->Id == SPELL_SUMMON_COILFANG_ELITE ||
                   GetSpellInfo()->Id == SPELL_SUMMON_COILFANG_STRIDER;
        ...
        targets.remove_if(
            [caster, minDist, maxDist](WorldObject const* target) -> bool {
                float dist = caster->GetExactDist2d(target);
                return target->GetEntry() != NPC_TRIGGER ||
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_lady_vashj_summons::FilterTargets,
            EFFECT_ALL,
