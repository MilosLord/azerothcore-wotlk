...
enum Misc { MAX_GROW_REPEAT = 9, EMOTE_ROARS = 0 };
...
struct boss_hungarfen : public BossAI {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        _scheduler.Schedule(
            IsHeroic() ? randtime(2400ms, 3600ms) : 10s,
...
class spell_spore_cloud : public AuraScript {
    ...
    {
        OnEffectPeriodic +=
            AuraEffectPeriodicFn(spell_spore_cloud::HandlePeriodic,
                                 EFFECT_0,
...
class spell_despawn_underbog_mushrooms : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_despawn_underbog_mushrooms::HandleScript,
                          EFFECT_0,
