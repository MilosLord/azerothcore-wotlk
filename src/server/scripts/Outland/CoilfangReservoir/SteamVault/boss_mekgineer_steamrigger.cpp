...
struct boss_mekgineer_steamrigger : public BossAI {
    boss_mekgineer_steamrigger(Creature* creature)
        : BossAI(creature, DATA_MEKGINEER_STEAMRIGGER)
    {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        scheduler
            ...
            .Schedule(6050ms,
                      17650ms,
                      [this](TaskContext context) {
                          if (DoCastRandomTarget(SPELL_SAW_BLADE, 1) !=
                              SPELL_CAST_OK) {
        ...
        if (!IsHeroic()) {
            ScheduleHealthCheckEvent({75, 50, 25}, [&] {
                ...
                for (auto const& spell : {SPELL_SUMMON_MECHANICS_1,
                                          SPELL_SUMMON_MECHANICS_2,
                                          SPELL_SUMMON_MECHANICS_3}) {
            ...
            scheduler.Schedule(15600ms, [this](TaskContext context) {
                ...
                DoCastAOE(RAND(SPELL_SUMMON_MECHANICS_1,
                               SPELL_SUMMON_MECHANICS_2,
                               SPELL_SUMMON_MECHANICS_3),
                          true);
