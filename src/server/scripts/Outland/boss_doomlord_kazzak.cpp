...
public:
    ...
    struct boss_doomlordkazzakAI : public ScriptedAI {
        ...
        void JustRespawned() override { Talk(SAY_INTRO); }
    ...
    class spell_mark_of_kazzak_AuraScript : public AuraScript {
        ...
        void OnPeriodic(AuraEffect const* aurEff)
        {
            ...
            if (target->GetPower(POWER_MANA) == 0) {
                target->CastSpell(
                    target, SPELL_MARK_OF_KAZZAK_DAMAGE, true, nullptr, aurEff);
        ...
        void Register() override
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(
                spell_mark_of_kazzak_AuraScript::CalculateAmount,
                EFFECT_0,
                SPELL_AURA_PERIODIC_MANA_LEECH);
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_mark_of_kazzak_AuraScript::OnPeriodic,
                EFFECT_0,
                SPELL_AURA_PERIODIC_MANA_LEECH);
        }
    };
