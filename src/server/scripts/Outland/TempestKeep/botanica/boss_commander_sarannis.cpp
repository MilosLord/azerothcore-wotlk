...
struct boss_commander_sarannis : public BossAI {
    boss_commander_sarannis(Creature* creature)
        : BossAI(creature, DATA_COMMANDER_SARANNIS)
    {
    }
...
class spell_commander_sarannis_arcane_devastation : public AuraScript {
    ...
    void Register() override
    {
        AfterEffectApply += AuraEffectApplyFn(
            spell_commander_sarannis_arcane_devastation::AfterApply,
            EFFECT_2,
            SPELL_AURA_DUMMY,
...
class spell_commander_sarannis_summon_reinforcements : public SpellScript {
    ...
    {
        return ValidateSpellInfo({SPELL_SUMMON_MENDER_1,
    ...
    {
        std::vector<uint32> reinforcementSpells = {SPELL_SUMMON_MENDER_1,
                                                   SPELL_SUMMON_RESERVIST_1,
                                                   SPELL_SUMMON_RESERVIST_2,
                                                   SPELL_SUMMON_RESERVIST_3};
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_commander_sarannis_summon_reinforcements::HandleCast,
            EFFECT_0,
            SPELL_EFFECT_DUMMY);
    }
};
