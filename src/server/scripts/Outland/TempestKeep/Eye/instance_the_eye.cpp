...
ObjectData const creatureData[] = {{NPC_ALAR, DATA_ALAR},
...
DoorData const doorData[] = {{GO_KAEL_DOOR_1, DATA_KAELTHAS, DOOR_TYPE_ROOM},
                             {GO_KAEL_DOOR_2, DATA_KAELTHAS, DOOR_TYPE_ROOM},
                             {0, 0, DOOR_TYPE_ROOM}};

BossBoundaryData const boundaries = {
    {DATA_REAVER,
     new CircleBoundary(Position(432.741809f, 371.8595890f), 115.0f)},
    {DATA_ALAR,
     new CircleBoundary(Position(331.000000f, -2.38000000f), 108.29246f)},
    {DATA_ASTROMANCER,
     new CircleBoundary(Position(432.869202f, -374.213806f), 103.74374f)}};
...
public:
    spell_the_eye_countercharge()
        : SpellScriptLoader("spell_the_eye_countercharge")
    {
    }
    ...
    class spell_the_eye_counterchargeScript : public AuraScript {
        ...
        {
            DoCheckProc +=
                AuraCheckProcFn(spell_the_eye_counterchargeScript::PrepareProc);
        }
    };
