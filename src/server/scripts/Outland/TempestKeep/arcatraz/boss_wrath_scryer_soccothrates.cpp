...
struct boss_wrath_scryer_soccothrates : public BossAI {
    boss_wrath_scryer_soccothrates(Creature* creature)
        : BossAI(creature, DATA_SOCCOTHRATES)
    {
    ...
    void InitializeAI() override { BossAI::InitializeAI(); }
            ...
            .Schedule(30s,
                      ...
                      [this](TaskContext context) {
                          ...
                          scheduler.Schedule(4600ms, [this](TaskContext) {
                              ...
                              scheduler.Schedule(
                                  300ms, [this](TaskContext context2) {
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        case EVENT_PREFIGHT_7:
            if (Creature* dalliah = instance->GetCreature(DATA_DALLIAH))
                dalliah->GetMotionMaster()->MovePoint(
                    0, 118.6048f, 96.84852f, 22.44115f);
            events2.ScheduleEvent(EVENT_PREFIGHT_8, 4000);
            break;
        case EVENT_PREFIGHT_8:
            me->GetMotionMaster()->MovePoint(
                0, 122.1035f, 192.7203f, 22.44115f);
        ...
        case EVENT_PREFIGHT_9:
            if (Creature* dalliah = instance->GetCreature(DATA_DALLIAH)) {
                ...
                dalliah->SetHomePosition(dalliah->GetPositionX(),
                                         dalliah->GetPositionY(),
                                         dalliah->GetPositionZ(),
                                         1.51737f);
