...
enum Misc { NPC_HARBINGER_SKYRISS_66 = 21466 };
...
struct boss_harbinger_skyriss : public BossAI {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        scheduler
            ...
            .Schedule(15s,
                      [this](TaskContext context) {
                          if (DoCastRandomTarget(SPELL_FEAR, 1, 20.0f) ==
                              SPELL_CAST_OK) {
                              Talk(SAY_FEAR);
                          }
                          context.Repeat(25s);
            ...
            .Schedule(30s, [this](TaskContext context) {
                if (DoCastRandomTarget(SPELL_DOMINATION, 1, 30.0f) ==
                    SPELL_CAST_OK) {
                    Talk(SAY_MIND);
                }
                context.Repeat();
    ...
    void JustSummoned(Creature* summon) override
    {
        summon->SetHealth(summon->CountPctFromMaxHealth(
            summon->GetEntry() == NPC_HARBINGER_SKYRISS_66 ? 66 : 33));
