...
public:
    ...
    struct npc_millhouse_manastormAI : public ScriptedAI {
        ...
        void KilledUnit(Unit* /*who*/) override { Talk(SAY_KILL); }

        void JustDied(Unit* /*killer*/) override { Talk(SAY_DEATH); }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_MILL_BASE_SPELL:
                switch (RAND(
                    SPELL_FIREBALL, SPELL_ARCANE_MISSILES, SPELL_FROSTBOLT)) {
                case SPELL_FIREBALL:
                ...
                case SPELL_ARCANE_MISSILES:
                    me->CastSpell(
                        me->GetVictim(), SPELL_ARCANE_MISSILES, false);
...
public:
    ...
    struct npc_warden_mellicharAI : public BossAI {
        npc_warden_mellicharAI(Creature* creature)
            : BossAI(creature, DATA_WARDEN_MELLICHAR)
        {
        }
        ...
        void SummonedCreatureDies(Creature* summon, Unit*) override
        {
            if (summon->GetEntry() == NPC_HARBINGER_SKYRISS) {
                ...
                if (Creature* creature =
                        summons.GetCreatureWithEntry(NPC_MILLHOUSE)) {
                    if (IsHeroic()) {
        ...
        void JustDied(Unit*) override { me->setActive(false); }
        ...
        void Reset() override
        {
            ...
            instance->HandleGameObject(
                instance->GetGuidData(DATA_WARDENS_SHIELD), true);
        ...
        {
            if (attacker && attacker->GetCharmerOrOwnerOrOwnGUID().IsPlayer() &&
                damage > 0 && !me->isActiveObject()) {
                me->setActive(true);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_WARDEN_INTRO2:
                instance->HandleGameObject(
                    instance->GetGuidData(DATA_WARDENS_SHIELD), false);
            ...
            case EVENT_WARDEN_INTRO13:
                me->SummonCreature(NPC_MILLHOUSE,
                                   413.292f,
                                   -148.378f,
                                   42.56f,
                                   6.27f,
            ...
            case EVENT_WARDEN_INTRO18:
                me->SummonCreature(RAND(NPC_AKKIRIS, NPC_SULFURON),
                                   420.179f,
                                   -174.396f,
                                   42.58f,
                                   0.02f,
            ...
            case EVENT_WARDEN_INTRO23:
                me->SummonCreature(RAND(NPC_TW_DRAK, NPC_BL_DRAK),
                                   471.795f,
                                   -174.58f,
                                   42.58f,
                                   3.06f,
            ...
            case EVENT_WARDEN_INTRO25:
                if (Creature* cr =
                        me->SummonCreature(NPC_HARBINGER_SKYRISS,
                                           445.763f,
                                           -191.639f,
                                           44.64f,
                                           1.60f,
            ...
            case EVENT_WARDEN_INTRO26:
                if (Creature* creature =
                        summons.GetCreatureWithEntry(NPC_HARBINGER_SKYRISS))
    ...
    class spell_arcatraz_soul_steal_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_arcatraz_soul_steal_AuraScript::HandleEffectApply,
                EFFECT_0,
                SPELL_AURA_MOD_DAMAGE_PERCENT_DONE,
                AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(
                spell_arcatraz_soul_steal_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_MOD_DAMAGE_PERCENT_DONE,
                AURA_EFFECT_HANDLE_REAL);
        }
