...
class spell_q11065_wrangle_some_aether_rays : public SpellScript {
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_q11065_wrangle_some_aether_rays::CheckCast);
    }
};

class spell_q11065_wrangle_some_aether_rays_aura : public AuraScript {
    PrepareAuraScript(spell_q11065_wrangle_some_aether_rays_aura) void HandleEffectRemove(
        AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        ...
        if (ar && ar->ToCreature()) {
            if (GetCaster() && GetCaster()->ToPlayer()) {
                ...
                if (Creature* cr =
                        GetCaster()->SummonCreature(23343,
                                                    ar->GetPositionX(),
                                                    ar->GetPositionY(),
                                                    ar->GetPositionZ(),
                                                    ar->GetOrientation(),
                    ...
                    cr->GetMotionMaster()->MoveFollow(
                        player, 5.0f, 2 * M_PI * rand_norm());
    ...
    void Register() override
    {
        OnEffectApply += AuraEffectApplyFn(
            spell_q11065_wrangle_some_aether_rays_aura::HandleEffectApply,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove += AuraEffectRemoveFn(
            spell_q11065_wrangle_some_aether_rays_aura::HandleEffectRemove,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_image_of_drakuru_reagent_check : public SpellScript {
    ...
    void HandleDummyEffect(SpellEffIndex /*effIndex*/)
    {
        ...
        if (dist < 40.0f) {
            caster->ToPlayer()->GroupEventHappens(
                QUEST_SUBJECT_TO_INTERPRETATION, caster);
        ...
        if (dist < 40.0f) {
            caster->ToPlayer()->GroupEventHappens(
                QUEST_MY_HEART_IS_IN_YOUR_HANDS, caster);
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_image_of_drakuru_reagent_check::HandleDummyEffect,
            EFFECT_0,
            SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12014_steady_as_a_rock : public SpellScript {
    ...
    void HandleFinish()
    {
        ...
        if (caster->ToPlayer()->GetQuestStatus(
                12014 /*QUEST_STEADY_AS_A_ROCK*/) == QUEST_STATUS_INCOMPLETE) {
            float x =
                caster->GetPositionX() + 3.0f * cos(caster->GetOrientation());
            float y = caster->GetPositionY() +
                      3.0f * std::sin(caster->GetOrientation());
            float o = caster->GetOrientation() < M_PI
                          ? caster->GetOrientation() + M_PI
                          : caster->GetOrientation() - M_PI;
            caster->SummonGameObject(188367,
                                     x,
                                     y,
                                     caster->GetPositionZ(),
                                     o,
...
class spell_q11026_a11051_banish_the_demons_aura : public AuraScript {
    ...
    void Register() override
    {
        ...
        if (m_scriptSpellId == 40825)
            OnEffectRemove += AuraEffectRemoveFn(
                spell_q11026_a11051_banish_the_demons_aura::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_q11026_a11051_banish_the_demons : public SpellScript {
    ...
    void Register() override
    {
        ...
        if (m_scriptSpellId == 40828)
            OnEffectHitTarget += SpellEffectFn(
                spell_q11026_a11051_banish_the_demons::HandleScriptEffect,
                EFFECT_0,
...
class spell_q10525_vision_guide : public AuraScript {
    ...
    {
        OnEffectApply +=
            AuraEffectApplyFn(spell_q10525_vision_guide::HandleEffectApply,
                              EFFECT_0,
                              SPELL_AURA_TRANSFORM,
                              AURA_EFFECT_HANDLE_REAL);
        AfterEffectRemove +=
            AuraEffectRemoveFn(spell_q10525_vision_guide::HandleEffectRemove,
                               EFFECT_0,
                               SPELL_AURA_TRANSFORM,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_q11322_q11317_the_cleansing : public AuraScript {
                               ...
                               AuraEffectHandleModes /*mode*/)
    {
        Unit* ar = GetCaster();
        if (ar && ar->ToPlayer()) {
            if (ar->ToPlayer()->GetQuestStatus(11317) ==
                    QUEST_STATUS_INCOMPLETE ||
                ar->ToPlayer()->GetQuestStatus(11322) ==
                    QUEST_STATUS_INCOMPLETE)
                ar->SummonCreature(27959,
                                   3032.0f,
                                   -5095.0f,
                                   723.0f,
                                   0.0f,
    ...
    {
        OnEffectApply += AuraEffectApplyFn(
            spell_q11322_q11317_the_cleansing::HandleEffectApply,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_q10714_on_spirits_wings : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (Creature* target = GetHitCreature())
            if (target->GetSpawnId() == 77757 ||
                target->GetSpawnId() == 78693) {
                count++;
                if (count == 2)
                    if (GetCaster() && GetCaster()->ToPlayer())
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q10714_on_spirits_wings::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q10720_the_smallest_creature : public SpellScript {
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_q10720_the_smallest_creature::HandleScriptEffect,
            EFFECT_0,
            SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q13086_last_line_of_defence : public SpellScript {
    ...
    void HandleAfterCast()
    {
        if (WorldLocation const* loc = GetExplTargetDest())
            GetCaster()->CastSpell(loc->GetPositionX(),
                                   loc->GetPositionY(),
                                   loc->GetPositionZ(),
                                   _triggerSpellId,
                                   true);
    ...
    {
        OnEffectLaunch +=
            SpellEffectFn(spell_q13086_last_line_of_defence::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
        OnEffectLaunch +=
            SpellEffectFn(spell_q13086_last_line_of_defence::HandleDummy,
                          ...
                          SPELL_EFFECT_DUMMY);
        AfterCast +=
            SpellCastFn(spell_q13086_last_line_of_defence::HandleAfterCast);
    }
...
class spell_q12943_shadow_vault_decree : public SpellScript {
    ...
    SpellCastResult CheckRequirement()
    {
        ...
        Unit* caster = GetCaster();
        if (Creature* thane =
                caster->FindNearestCreature(NPC_THANE_UFRANG, 30.0f))
            if (!thane->IsInCombat())
                return SPELL_CAST_OK;
    ...
    void Register() override
    {
        OnCheckCast += SpellCheckCastFn(
            spell_q12943_shadow_vault_decree::CheckRequirement);
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12943_shadow_vault_decree::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q10769_dissension_amongst_the_ranks : public SpellScript {
    ...
    void Register() override
    {
        if (m_scriptSpellId == 38223)
            OnEffectHitTarget += SpellEffectFn(
                spell_q10769_dissension_amongst_the_ranks::HandleScriptEffect,
                EFFECT_0,
                SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q11520_discovering_your_roots : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (GameObject* go = GetCaster()->FindNearestGameObject(
                GO_RAZORTHORN_DIRT_MOUNT, 20.0f)) {
            GetCaster()->GetMotionMaster()->MovePoint(0, *go);
            go->SetLootState(GO_JUST_DEACTIVATED);
            GetCaster()->CastSpell(
                GetCaster(), SPELL_SUMMON_RAZORTHORN_ROOT, true);
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11520_discovering_your_roots::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_quest_dragonmaw_race_generic : public SpellScript {
    ...
    {
        Unit* caster = GetCaster();
        float o      = Position::NormalizeOrientation(caster->GetOrientation() +
                                                 frand(0.0f, 2 * M_PI));
    ...
    void ChangeDest(SpellEffIndex effIndex)
    {
        ...
        Unit* caster = GetCaster();
        if (Creature* trigger = caster->SummonCreature(
                23356, _x, _y, _z, 0.0f, TEMPSUMMON_TIMED_DESPAWN, 1500)) {
            trigger->CastSpell(
                trigger, GetSpellInfo()->Effects[effIndex].TriggerSpell, true);
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_quest_dragonmaw_race_generic::RelocateDest);
        OnEffectHit +=
            SpellEffectFn(spell_quest_dragonmaw_race_generic::ChangeDest,
                          EFFECT_0,
...
class spell_q11670_it_was_the_orcs_honest : public SpellScript {
    ...
    void HandleScriptEffect()
    {
        ...
        if (Unit* caster = GetCaster())
            caster->CastSpell(caster,
                              caster->getGender() == GENDER_MALE ? 45760
                                                                 : 45762,
                              true);
    }
    ...
    SpellCastResult CheckTarget()
    {
        ...
        if (!GetCaster() ||
            !GetCaster()->HasAura(
                (GetCaster()->getGender() == GENDER_MALE ? 45760 : 45762))) {
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_q11670_it_was_the_orcs_honest::CheckTarget);
        AfterHit +=
            SpellHitFn(spell_q11670_it_was_the_orcs_honest::HandleScriptEffect);
    }
};
...
class spell_quest_test_flight_charging : public AuraScript {
    PrepareAuraScript(spell_quest_test_flight_charging)
        ...
        void OnApplySelf(AuraEffect const* /*aurEff*/,
                         AuraEffectHandleModes /*mode*/)
    {
    ...
    void PerformKick()
    {
        if (Player* player = GetTarget()->ToPlayer()) {
            Creature* shooter =
                player->FindNearestCreature(NPC_GNOME_SHOOTER, 20.0f);
            if (!shooter)
                return;
    ...
    void HandleEffectPeriodicSelf(AuraEffect const* aurEff)
    {
        if (aurEff->GetTickNumber() == 1) {
            GetTarget()->SummonCreature(NPC_CANNON_TARGET,
                                        1919.99f,
                                        5581.97f,
                                        272.30f,
                                        5.27f,
                                        ...
                                        12000);
            if (Creature* cannon =
                    GetTarget()->FindNearestCreature(NPC_CANNON, 40.0f))
    ...
    void HandleEffectPeriodicPlatform(AuraEffect const* aurEff)
    {
        if (aurEff->GetTickNumber() == 1)
            GetTarget()->CastSpell(
                GetTarget(), SPELL_CANNON_CHARGING_STATE2, true);
        else if (aurEff->GetTickNumber() == 2)
            GetTarget()->CastSpell(
                GetTarget(), SPELL_CANNON_CHARGING_STATE3, true);
        else if (aurEff->GetTickNumber() == 3)
            GetTarget()->CastSpell(
                GetTarget(), SPELL_CANNON_CHARGING_STATE4, true);
    ...
    void Register() override
    {
        if (m_scriptSpellId == SPELL_CANNON_CHARGING_SELF) {
            OnEffectApply +=
                AuraEffectApplyFn(spell_quest_test_flight_charging::OnApplySelf,
                                  EFFECT_0,
                                  SPELL_AURA_PERIODIC_TRIGGER_SPELL,
                                  AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_quest_test_flight_charging::HandleEffectPeriodicSelf,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
        else
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_quest_test_flight_charging::HandleEffectPeriodicPlatform,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_q12274_a_fall_from_grace_costume : public SpellScript {
    ...
    {
        return ValidateSpellInfo({SPELL_SCARLET_RAVEN_PRIEST_IMAGE_MALE,
                                  SPELL_SCARLET_RAVEN_PRIEST_IMAGE_FEMALE});
    }
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        if (Unit* target = GetHitUnit()) {
            if (Player* p = target->ToPlayer()) {
                p->CastSpell(p,
                             p->getGender() == GENDER_FEMALE
                                 ? SPELL_SCARLET_RAVEN_PRIEST_IMAGE_FEMALE
                                 : SPELL_SCARLET_RAVEN_PRIEST_IMAGE_MALE,
                             false);
            }
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12274_a_fall_from_grace_costume::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q13369_fate_up_against_your_will : public SpellScript {
    ...
    SpellCastResult CheckRequirement()
    {
        ...
        if (Unit* caster = GetCaster())
            if (caster->GetTypeId() == TYPEID_PLAYER &&
                caster->ToPlayer()->GetQuestStatus(13369) >=
    ...
    {
        OnCheckCast += SpellCheckCastFn(
            spell_q13369_fate_up_against_your_will::CheckRequirement);
        OnEffectHitTarget +=
            SpellEffectFn(spell_q13369_fate_up_against_your_will::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q11198_take_down_tethyr : public SpellScript {
        ...
        void HandleScript(SpellEffIndex effIndex)
    {
        ...
        if (Unit* unit = GetHitUnit())
            if (unit->IsImmuneToPC())
                return;
        GetCaster()->CastCustomSpell(42576 /*SPELL_CANNON_BLAST*/,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11198_take_down_tethyr::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q11653_youre_not_so_big_now : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11653_youre_not_so_big_now::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q10985_light_of_the_naaru : public AuraScript {
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        ...
        return target &&
               target->GetFaction() == 1843; // Xinef: Illidari demons faction
    }

    void Register() override
    {
        DoCheckProc +=
            AuraCheckProcFn(spell_q10985_light_of_the_naaru::CheckProc);
    }
};
...
public:
    spell_generic_quest_update_entry_SpellScript(uint16 spellEffect,
                                                 uint8  effIndex,
                                                 uint32 originalEntry,
                                                 uint32 newEntry,
                                                 bool   shouldAttack,
                                                 uint32 despawnTime = 0)
        : SpellScript(), _spellEffect(spellEffect), _effIndex(effIndex),
          _originalEntry(originalEntry), _newEntry(newEntry),
          _shouldAttack(shouldAttack), _despawnTime(despawnTime)
    {
    }
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_generic_quest_update_entry_SpellScript::HandleDummy,
            _effIndex,
            _spellEffect);
    }
};
...
class spell_q1846_bending_shinbone : public SpellScript {
    ...
    void HandleScriptEffect(SpellEffIndex /* effIndex */)
    {
        ...
        uint32 const spellId = roll_chance_i(20) ? SPELL_BENDING_SHINBONE1
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q1846_bending_shinbone::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q2203_thaumaturgy_channel : public AuraScript {
    ...
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_q2203_thaumaturgy_channel::HandleEffectPeriodic,
            EFFECT_0,
            SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_q5206_test_fetid_skull : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo(
            {SPELL_CREATE_RESONATING_SKULL, SPELL_CREATE_BONE_DUST});
    }

    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        Unit*  caster  = GetCaster();
        uint32 spellId = roll_chance_i(50) ? SPELL_CREATE_RESONATING_SKULL
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_q5206_test_fetid_skull::HandleDummy,
                                     EFFECT_0,
                                     SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q6124_6129_apply_salve : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q6124_6129_apply_salve::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q11396_11399_force_shield_arcane_purple_x3 : public AuraScript {
    ...
    {
        OnEffectApply += AuraEffectApplyFn(
            spell_q11396_11399_force_shield_arcane_purple_x3::HandleEffectApply,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove += AuraEffectRemoveFn(
...
class spell_q11396_11399_scourging_crystal_controller : public SpellScript {
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_q11396_11399_scourging_crystal_controller::HandleDummy,
            EFFECT_0,
            SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q11396_11399_scourging_crystal_controller_dummy
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_q11396_11399_scourging_crystal_controller_dummy::HandleDummy,
            EFFECT_0,
            SPELL_EFFECT_DUMMY);
    }
};
...
enum Quest11587Data {
    ...
    SPELL_SUMMON_ARCANE_PRISONER_FEMALE =
        45448,                                // Summon Arcane Prisoner - Female
...
class spell_q11587_arcane_prisoner_rescue : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_SUMMON_ARCANE_PRISONER_MALE,
                                  SPELL_SUMMON_ARCANE_PRISONER_FEMALE,
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        if (Unit* unitTarget = GetHitUnit()) {
            ...
            unitTarget->CastSpell(
                caster, SPELL_ARCANE_PRISONER_KILL_CREDIT, true);
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11587_arcane_prisoner_rescue::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q11730_ultrasonic_screwdriver : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_SUMMON_SCAVENGEBOT_004A8,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11730_ultrasonic_screwdriver::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12459_seeds_of_natures_wrath : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12459_seeds_of_natures_wrath::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12634_despawn_fruit_tosser : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_BANANAS_FALL_TO_GROUND,
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q12634_despawn_fruit_tosser::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12683_take_sputum_sample : public SpellScript {
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q12683_take_sputum_sample::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12851_going_bearback : public AuraScript {
    ...
    {
        AfterEffectApply +=
            AuraEffectApplyFn(spell_q12851_going_bearback::HandleEffectApply,
                              EFFECT_0,
...
class spell_q12937_relief_for_the_fallen : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        if (Creature* target = GetHitCreature()) {
            caster->CastSpell(
                caster, SPELL_TRIGGER_AID_OF_THE_EARTHEN, true, nullptr);
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12937_relief_for_the_fallen::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q10041_q10040_who_are_they : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_MALE_DISGUISE,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q10041_q10040_who_are_they::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_symbol_of_life_dummy : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (Creature* target = GetHitCreature()) {
            if (target->HasAura(SPELL_PERMANENT_FEIGN_DEATH)) {
                ...
                target->SetPower(
                    POWER_MANA,
                    uint32(target->GetMaxPower(POWER_MANA) * 0.75f));
            }
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_symbol_of_life_dummy::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12659_ahunaes_knife : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12659_ahunaes_knife::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q9874_liquid_fire : public SpellScript {
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_q9874_liquid_fire::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12805_lifeblood_dummy : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12805_lifeblood_dummy::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q13280_13283_plant_battle_standard : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        if (caster->IsVehicle())
            if (Unit* player = caster->GetVehicleKit()->GetPassenger(0))
                player->ToPlayer()->KilledMonsterCredit(
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q13280_13283_plant_battle_standard::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q14112_14145_chum_the_water : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q14112_14145_chum_the_water::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q9452_cast_net : public SpellScript {
    ...
    {
        GameObject* go =
            GetCaster()->FindNearestGameObject(GO_SCHOOL_OF_RED_SNAPPER, 3.0f);
    ...
    {
        PreventHitDefaultEffect(effIndex);
        GetHitGObj()->SetRespawnTime(roll_chance_i(50) ? 2 * MINUTE
                                                       : 3 * MINUTE);
    ...
    void Register() override
    {
        ...
        OnEffectHit += SpellEffectFn(
            spell_q9452_cast_net::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        OnEffectHitTarget +=
            SpellEffectFn(spell_q9452_cast_net::HandleActiveObject,
                          EFFECT_1,
...
class spell_q12987_read_pronouncement : public AuraScript {
    ...
    void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        ...
        if (Player* target = GetTarget()->ToPlayer()) {
            if (Creature* trigger =
                    target->FindNearestCreature(NPC_ICE_SPIKE_BUNNY, 25.0f)) {
                sCreatureTextMgr->SendChat(trigger,
                                           SAY_1,
                                           target,
                                           CHAT_MSG_ADDON,
                                           LANG_ADDON,
    ...
    {
        AfterEffectApply +=
            AuraEffectApplyFn(spell_q12987_read_pronouncement::OnApply,
                              EFFECT_0,
                              SPELL_AURA_NONE,
                              AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_q12277_wintergarde_mine_explosion : public SpellScript {
                ...
                if (caster->GetTypeId() == TYPEID_UNIT) {
                    if (Unit* owner = caster->GetOwner()) {
                        ...
                        case NPC_UPPER_MINE_SHAFT:
                            caster->CastSpell(
                                owner, SPELL_UPPER_MINE_SHAFT_CREDIT, true);
                            break;
                        case NPC_LOWER_MINE_SHAFT:
                            caster->CastSpell(
                                owner, SPELL_LOWER_MINE_SHAFT_CREDIT, true);
                            break;
                        default:
                            break;
                        }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12277_wintergarde_mine_explosion::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12066_bunny_kill_credit : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12066_bunny_kill_credit::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12735_song_of_cleansing : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12735_song_of_cleansing::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q11010_q11102_q11023_aggro_check_aura : public AuraScript {
    ...
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_q11010_q11102_q11023_aggro_check_aura::HandleTriggerSpell,
            EFFECT_0,
            SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_q11010_q11102_q11023_aggro_check : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (Player* playerTarget = GetHitPlayer())
            ...
            if (playerTarget->HasAuraType(SPELL_AURA_FLY) ||
                playerTarget->HasAuraType(
                    SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED))
                playerTarget->CastSpell(playerTarget,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q11010_q11102_q11023_aggro_check::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q11010_q11102_q11023_aggro_burst : public AuraScript {
    ...
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_q11010_q11102_q11023_aggro_burst::HandleEffectPeriodic,
            EFFECT_0,
            SPELL_AURA_PERIODIC_DUMMY);
    }
};
...
class spell_q11010_q11102_q11023_choose_loc : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        Acore::PlayerListSearcher<Acore::AnyPlayerInObjectRangeCheck> searcher(
            caster, playerList, checker);
        Cell::VisitWorldObjects(caster, searcher, 65.0f);
        for (std::list<Player*>::const_iterator itr = playerList.begin();
             itr != playerList.end();
             ++itr)
            // Check if found player target is on fly mount or using flying form
            if ((*itr)->HasAuraType(SPELL_AURA_FLY) ||
                (*itr)->HasAuraType(
                    SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED))
                // Summom Fel Cannon (bunny version) at found player
                caster->SummonCreature(NPC_FEL_CANNON2,
                                       (*itr)->GetPositionX(),
                                       (*itr)->GetPositionY(),
                                       (*itr)->GetPositionZ());
    }
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q11010_q11102_q11023_choose_loc::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q11010_q11102_q11023_q11008_check_fly_mount : public SpellScript {
    ...
    SpellCastResult CheckRequirement()
    {
        ...
        if (!(caster->HasAuraType(SPELL_AURA_FLY) ||
              caster->HasAuraType(
                  SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED)))
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_q11010_q11102_q11023_q11008_check_fly_mount::
                                 CheckRequirement);
    }
};
...
class spell_q12661_q12669_q12676_q12677_q12713_summon_stefan
    ...
    void Register() override
    {
        OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
            spell_q12661_q12669_q12676_q12677_q12713_summon_stefan::SetDest,
            EFFECT_0,
...
class spell_q12730_quenching_mist : public AuraScript {
    ...
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_q12730_quenching_mist::HandleEffectPeriodic,
            EFFECT_0,
...
// Volatility/13261 - Volatiliy /Daily//
...
class spell_q13291_q13292_q13239_q13261_frostbrood_skytalon_grab_decoy
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (!GetHitCreature())
            return;
        // TO DO: Being triggered is hack, but in checkcast it doesn't pass
        // aurastate requirements. Beside that the decoy won't keep it's freeze
        // animation state when enter.
...
class spell_q13011_bear_flank_master : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_BEAR_FLANK_MASTER, SPELL_CREATE_BEAR_FLANK});
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q13011_bear_flank_master::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q12690_burst_at_the_seams : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_BURST_AT_THE_SEAMS,
        ...
        if (Unit* creature = GetHitCreature()) {
            if (Unit* charmer = GetCaster()->GetCharmerOrOwner()) {
                if (Player* player = charmer->ToPlayer()) {
                    if (player->GetQuestStatus(QUEST_BURST_AT_THE_SEAMS) ==
                        QUEST_STATUS_INCOMPLETE) {
                        creature->CastSpell(
                            creature, SPELL_BURST_AT_THE_SEAMS_BONE, true);
                        creature->CastSpell(
                            creature, SPELL_BURST_AT_THE_SEAMS_MEAT, true);
                        creature->CastSpell(
                            creature, SPELL_BURST_AT_THE_SEAMS_BMEAT, true);
                        creature->CastSpell(
                            creature, SPELL_BURST_AT_THE_SEAMS_DMG, true);
                        creature->CastSpell(
                            creature, SPELL_BURST_AT_THE_SEAMS_DMG_2, true);

                        player->CastSpell(
                            player, SPELL_DRAKKARI_SKULLCRUSHER_CREDIT, true);
                        uint16 count = player->GetReqKillOrCastCurrentCount(
                            QUEST_BURST_AT_THE_SEAMS, NPC_DRAKKARI_CHIEFTAINK);
                        if ((count % 20) == 0)
                            player->CastSpell(
                                player, SPELL_SUMMON_DRAKKARI_CHIEFTAIN, true);
                    }
                }
            }
        }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12690_burst_at_the_seams::HandleKnockBack,
                          EFFECT_1,
                          SPELL_EFFECT_KNOCK_BACK);
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12690_burst_at_the_seams::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q12308_escape_from_silverbrook : public SpellScript {
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q12308_escape_from_silverbrook::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12308_escape_from_silverbrook_summon_worgen : public SpellScript {
    ...
    {
        OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
            spell_q12308_escape_from_silverbrook_summon_worgen::ModDest,
            EFFECT_0,
...
class spell_q12641_death_comes_from_on_high : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_FORGE_CREDIT,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12641_death_comes_from_on_high::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_q12619_emblazon_runeblade : public AuraScript {
    ...
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_q12619_emblazon_runeblade::HandleEffectPeriodic,
            EFFECT_0,
            SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_q12619_emblazon_runeblade_effect : public SpellScript {
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_q12619_emblazon_runeblade_effect::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q12919_gymers_grab : public SpellScript {
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        ...
        if (!GetHitCreature())
            return;
        GetHitCreature()->CastCustomSpell(SPELL_RIDE_GYMER,
                                          SPELLVALUE_BASE_POINT0,
                                          seatId,
                                          GetCaster(),
                                          true);
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12919_gymers_grab::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q12919_gymers_throw : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q12919_gymers_throw::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_q9718_crow_transform : public AuraScript {
    ...
    {
        OnEffectRemove +=
            AuraEffectRemoveFn(spell_q9718_crow_transform::HandleEffectRemove,
                               EFFECT_0,
                               SPELL_AURA_TRANSFORM,
                               AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
    }
...
class spell_q5056_summon_shy_rotam : public SpellScript {
    ...
    void HandleFinish()
    {
        Position shyRotamSpawnPosition =
            Position(8072.38f, -3833.81f, 690.03f, 4.56f);
        if (Creature* summon =
                GetCaster()->SummonCreature(NPC_SHY_ROTAM,
                                            shyRotamSpawnPosition,
                                            TEMPSUMMON_TIMED_DESPAWN,
...
class spell_q4735_collect_rookery_egg : public SpellScript {
    ...
    SpellCastResult CheckCast()
    {
        if (GameObject* rookery = GetCaster()->FindNearestGameObject(
                GO_ROOKERY_EGG, 5.0f, true)) {
    ...
    SpellCastResult CheckQuest()
    {
        if (Player* playerCaster = GetCaster()->ToPlayer()) {
            if (playerCaster->GetQuestStatus(QUEST_EGG_COLLECTION) ==
                QUEST_STATUS_INCOMPLETE)
                return SPELL_CAST_OK;
        }
        return SPELL_FAILED_DONT_REPORT;
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_q4735_collect_rookery_egg::CheckQuest);
        OnCheckCast +=
            SpellCheckCastFn(spell_q4735_collect_rookery_egg::CheckCast);
        OnEffectHit +=
            SpellEffectFn(spell_q4735_collect_rookery_egg::HandleActiveObject,
                          EFFECT_0,
                          SPELL_EFFECT_ACTIVATE_OBJECT);
    }
};

enum BookOfFelNames { SPELL_METAMORPHOSIS = 36298 };
...
class spell_q10651_q10692_book_of_fel_names : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_q10651_q10692_book_of_fel_names::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};

enum Feralfen { NPC_FERALFEN_TOTEM = 18186 };
...
class spell_q9847_a_spirit_ally : public SpellScript {
    ...
    void HandleSendEvent(SpellEffIndex /*effIndex*/)
    {
        ...
        Position pos   = GetCaster()->GetNearPosition(dist, angle);
        GetCaster()->SummonCreature(NPC_FERALFEN_TOTEM,
                                    pos,
                                    TEMPSUMMON_TIMED_DESPAWN,
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_q9847_a_spirit_ally::HandleSendEvent,
                                     EFFECT_0,
...
{
    RegisterSpellAndAuraScriptPair(spell_q11065_wrangle_some_aether_rays,
    ...
    RegisterSpellAndAuraScriptPair(spell_q11026_a11051_banish_the_demons,
    ...
    RegisterSpellAndAuraScriptPair(
        spell_q10769_dissension_amongst_the_ranks,
        spell_q10769_dissension_amongst_the_ranks_aura);
