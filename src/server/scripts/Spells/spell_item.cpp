...
class spell_item_massive_seaforium_charge : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_massive_seaforium_charge::HandleItemRemove,
                          EFFECT_0,
...
class spell_item_titanium_seal_of_dalaran : public SpellScript {
        ...
        void OnScriptEffect(SpellEffIndex effIndex)
    {
        ...
        if (Player* player = caster->ToPlayer()) {
            ...
            if (BroadcastText const* bct = sObjectMgr->GetBroadcastText(
            ...
            if (urand(0, 1)) {
                if (BroadcastText const* bct = sObjectMgr->GetBroadcastText(
                    ...
                    player->TextEmote(
                        bct->GetText(loc_idx, player->getGender()));
            }
            else {
                if (BroadcastText const* bct = sObjectMgr->GetBroadcastText(
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_titanium_seal_of_dalaran::OnScriptEffect,
                          EFFECT_0,
...
class spell_item_mind_amplify_dish : public SpellScript {
        ...
        if (Player* player = caster->ToPlayer()) {
            if (Unit* target = GetHitUnit()) {
                ...
                if (target->ToCreature())
                    if (target->ToCreature()->GetCreatureTemplate()->rank >
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_mind_amplify_dish::OnDummyEffect,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_runescroll_of_fortitude : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_runescroll_of_fortitude::OnScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_branns_communicator : public SpellScript {
        ...
        void OnScriptEffect(SpellEffIndex effIndex)
    {
        ...
        if (Player* target = GetHitPlayer()) {
            ...
            target->CastSpell(
                target, SPELL_CONTACT_BRANN, true); // Brann summoning spell
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_branns_communicator::OnScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_goblin_gumbo_kettle : public AuraScript {
    ...
    void Update(AuraEffect* effect)
    {
        ...
        effect->SetPeriodicTimer(
            urand(10 * IN_MILLISECONDS, 40 * IN_MILLISECONDS));
    ...
    void Register() override
    {
        DoEffectCalcPeriodic += AuraEffectCalcPeriodicFn(
            spell_item_goblin_gumbo_kettle::CalcPeriodic,
            EFFECT_0,
            SPELL_AURA_PROC_TRIGGER_SPELL);
        OnEffectUpdatePeriodic +=
            AuraEffectUpdatePeriodicFn(spell_item_goblin_gumbo_kettle::Update,
                                       EFFECT_0,
                                       SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_with_mount_speed : public AuraScript {
    ...
    void Register() override
    {
        OnEffectApply += AuraEffectApplyFn(spell_item_with_mount_speed::OnApply,
                                           EFFECT_0,
                                           SPELL_AURA_DUMMY,
                                           AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove +=
            AuraEffectRemoveFn(spell_item_with_mount_speed::OnRemove,
                               EFFECT_0,
                               SPELL_AURA_DUMMY,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_magic_dust : public SpellScript {
    ...
    void HandlePreventAura(SpellEffIndex /*effIndex*/)
    {
        if (Unit* target = GetHitUnit()) {
            if (target->GetLevel() >= 30) {
                uint8 chance =
                    100 - std::min<uint8>(
                              100, target->GetLevel() - 30 * urand(3, 10));
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_magic_dust::HandlePreventAura,
                          EFFECT_0,
...
class spell_item_toy_train_set : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_toy_train_set::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_rocket_chicken : public AuraScript {
    ...
    void HandleDummyTick(AuraEffect const* /*aurEff*/)
    {
        if (roll_chance_i(5)) {
            ...
            GetTarget()->CastSpell(
                GetTarget(), SPELL_ROCKET_CHICKEN_EMOTE, false);
    }

    void Register() override
    {
        OnEffectPeriodic +=
            AuraEffectPeriodicFn(spell_item_rocket_chicken::HandleDummyTick,
                                 EFFECT_0,
...
class spell_item_sleepy_willy : public SpellScript {
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect +=
            SpellObjectAreaTargetSelectFn(spell_item_sleepy_willy::SelectTarget,
                                          EFFECT_0,
                                          TARGET_UNIT_SRC_AREA_ENTRY);
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_sleepy_willy::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_lil_phylactery : public AuraScript {
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        return eventInfo.GetActionTarget() &&
               (eventInfo.GetActionTarget()->GetTypeId() != TYPEID_UNIT ||
                eventInfo.GetActionTarget()->ToCreature()->isWorldBoss());
    }
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& /*eventInfo*/)
    {
        ...
        if (Unit* critter = ObjectAccessor::GetUnit(
                *GetUnitOwner(), GetUnitOwner()->GetCritterGUID()))
            GetUnitOwner()->CastSpell(
                critter, 69731 /*SPELL_LICH_PET_AURA_ON_KILL*/, true);
    }

    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(spell_item_lil_phylactery::CheckProc);
        OnEffectProc += AuraEffectProcFn(spell_item_lil_phylactery::HandleProc,
                                         EFFECT_0,
                                         SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_shifting_naaru_silver : public AuraScript {
    ...
    void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        if (Aura* aur = GetTarget()->GetAura(45044 /*Limitless Power*/,
                                             GetTarget()->GetGUID()))
            aur->SetDuration(0);
    }

    void OnBaseRemove(AuraEffect const* /*aurEff*/,
    ...
    void Register() override
    {
        if (m_scriptSpellId == 45043) {
            OnEffectApply +=
                AuraEffectApplyFn(spell_item_shifting_naaru_silver::OnApply,
                                  EFFECT_0,
                                  SPELL_AURA_DUMMY,
                                  AURA_EFFECT_HANDLE_REAL);
            AfterEffectRemove +=
                AuraEffectRemoveFn(spell_item_shifting_naaru_silver::OnRemove,
                                   EFFECT_0,
                                   SPELL_AURA_DUMMY,
                                   AURA_EFFECT_HANDLE_REAL);
        }
            ...
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_item_shifting_naaru_silver::OnBaseRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_toxic_wasteling : public SpellScript {
    ...
    void HandleJump(SpellEffIndex effIndex)
    {
        ...
        if (Creature* target = GetHitCreature()) {
            ...
            GetCaster()->ToCreature()->SetHomePosition(target->GetPositionX(),
                                                       target->GetPositionY(),
                                                       target->GetPositionZ(),
                                                       0.0f);
            GetCaster()->GetMotionMaster()->MoveJump(target->GetPositionX(),
                                                     target->GetPositionY(),
                                                     target->GetPositionZ(),
                                                     12.0f,
                                                     3.0f,
    ...
    void Register() override
    {
        OnEffectLaunchTarget +=
            SpellEffectFn(spell_item_toxic_wasteling::HandleJump,
                          EFFECT_0,
                          SPELL_EFFECT_JUMP);
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_toxic_wasteling::HandleScriptEffect,
                          EFFECT_1,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_lil_xt : public SpellScript {
    ...
    void Register() override
    {
        if (m_scriptSpellId == 76098)
            OnEffectHitTarget +=
                SpellEffectFn(spell_item_lil_xt::HandleScriptEffect,
                              EFFECT_0,
                              SPELL_EFFECT_SCRIPT_EFFECT);
        else
            OnEffectHitTarget += SpellEffectFn(
                spell_item_lil_xt::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_crazy_alchemists_potion : public SpellScript {
    ...
    void HandleHeal(SpellEffIndex /*effIndex*/)
    {
        ...
        if (roll_chance_i(20))
            GetCaster()->CastSpell(
                GetCaster(),
                crazyAlchemistTable[urand(
                    0, (GetCaster()->getPowerType() == POWER_MANA ? 4 : 3))],
                true);
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_crazy_alchemists_potion::HandleHeal,
                          EFFECT_0,
                          SPELL_EFFECT_HEAL);
    }
};
...
class spell_item_skull_of_impeding_doom : public AuraScript {
    ...
    void CalculateDamageAmount(AuraEffect const* /*aurEff*/,
                               int32& amount,
                               bool& /*canBeRecalculated*/)
    {
        ...
        amount = GetCaster()->GetMaxHealth() *
                 0.12f; // 5 ticks which reduce health by 60%
    }

    void CalculateManaLeechAmount(AuraEffect const* /*aurEff*/,
                                  int32& amount,
                                  bool& /*canBeRecalculated*/)
    {
        ...
        amount = GetCaster()->GetMaxPower(POWER_MANA) *
                 0.12f; // 5 ticks which reduce health by 60%
    }
    ...
    void Register() override
    {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_item_skull_of_impeding_doom::CalculateDamageAmount,
            EFFECT_1,
            SPELL_AURA_PERIODIC_DAMAGE);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_item_skull_of_impeding_doom::CalculateManaLeechAmount,
            EFFECT_2,
...
class spell_item_feast : public SpellScript {
        ...
        if (Player* player = caster->ToPlayer()) {
            ...
            case SPELL_GREAT_FEAST:
                if (BroadcastText const* bct = sObjectMgr->GetBroadcastText(
                    ...
                    player->TextEmote(
                        bct->GetText(loc_idx, player->getGender()), player);
                break;
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_item_feast::HandleScriptEffect,
                                           EFFECT_0,
                                           SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_gnomish_universal_remote : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_gnomish_universal_remote::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_powerful_anti_venom : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex effIndex)
    {
        ...
        if (Unit* target = GetHitUnit()) {
            ...
            for (Unit::AuraMap::const_iterator itr = auras.begin();
                ...
                if (aura->GetSpellInfo()->SpellLevel > 60 ||
            ...
            for (std::list<uint32>::const_iterator itr = removeList.begin();
                 itr != removeList.end();
                 ++itr) {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_powerful_anti_venom::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_strong_anti_venom : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex effIndex)
    {
        ...
        if (Unit* target = GetHitUnit()) {
            ...
            for (Unit::AuraMap::const_iterator itr = auras.begin();
                 ...
                 ++itr) {
                Aura* aura = itr->second;
                if (aura->GetSpellInfo()->SpellLevel > 35 ||
                    aura->GetSpellInfo()->Dispel != DISPEL_POISON)
                    continue;
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_strong_anti_venom::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_anti_venom : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex effIndex)
    {
        ...
        if (Unit* target = GetHitUnit()) {
            ...
            for (Unit::AuraMap::const_iterator itr = auras.begin();
                 ...
                 ++itr) {
                Aura* aura = itr->second;
                if (aura->GetSpellInfo()->SpellLevel > 25 ||
                    aura->GetSpellInfo()->Dispel != DISPEL_POISON) {
                    continue;
                }
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_anti_venom::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_gnomish_shrink_ray : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        if (Unit* target = GetHitUnit()) {
            if (urand(0, 99) < 15)
                caster->CastSpell(
                    caster, SPELL_GNOMISH_SHRINK_RAY_SELF, true, nullptr);
            else
                caster->CastSpell(
                    target, SPELL_GNOMISH_SHRINK_RAY_TARGET, true, nullptr);
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_gnomish_shrink_ray::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
{
    if (!SpellScript::ValidateSpellInfo({SPELL_PERSONALIZED_WEATHER_RAIN,
...
class spell_item_goblin_weather_machine : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_goblin_weather_machine::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_goblin_weather_machine_aura : public AuraScript {
    ...
    {
        AfterEffectRemove +=
            AuraEffectRemoveFn(spell_item_goblin_weather_machine_aura::OnRemove,
                               EFFECT_0,
                               SPELL_AURA_DUMMY,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_light_lamp : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_light_lamp::HandleActivateObject,
                          EFFECT_0,
...
class spell_item_fetch_ball : public SpellScript {
    ...
    void SelectTarget(std::list<WorldObject*>& targets)
    {
        ...
        for (std::list<WorldObject*>::const_iterator itr = targets.begin();
             ...
             ++itr)
            if (Creature* creature = (*itr)->ToCreature()) {
                if (creature->GetOwnerGUID() == GetCaster()->GetOwnerGUID() &&
                    !creature->IsNonMeleeSpellCast(false) &&
    ...
    {
        OnObjectAreaTargetSelect +=
            SpellObjectAreaTargetSelectFn(spell_item_fetch_ball::SelectTarget,
                                          EFFECT_0,
                                          TARGET_UNIT_SRC_AREA_ENTRY);
    }
};
...
class spell_item_oracle_ablutions : public SpellScript {
        ...
        void HandleScriptEffect(SpellEffIndex effIndex)
    {
        ...
        case POWER_MANA: {
            ...
            caster->CastCustomSpell(SPELL_ABLUTION_MANA,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_oracle_ablutions::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_trauma : public AuraScript {
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(spell_item_trauma::HandleProc,
                                         EFFECT_0,
                                         SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_blade_ward_enchant : public AuraScript {
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
    {
        ...
        if (SpellInfo const* spellInfo =
                sSpellMgr->GetSpellInfo(64442 /*SPELL_BLADE_WARDING*/)) {
            int32 basepoints = spellInfo->Effects[EFFECT_0].CalcValue() *
                               this->GetStackAmount();
            eventInfo.GetActionTarget()->CastCustomSpell(spellInfo->Id,
                                                         SPELLVALUE_BASE_POINT0,
                                                         basepoints,
                                                         eventInfo.GetActor(),
                                                         true);
    ...
    {
        OnEffectProc +=
            AuraEffectProcFn(spell_item_blade_ward_enchant::HandleProc,
                             EFFECT_1,
                             SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_blood_draining_enchant : public AuraScript {
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
    {
        ...
        if (!eventInfo.GetActionTarget() || !eventInfo.GetDamageInfo() ||
            (eventInfo.GetActionTarget()->GetHealth() -
             eventInfo.GetDamageInfo()->GetDamage()) >=
                eventInfo.GetActionTarget()->CountPctFromMaxHealth(35)) {
            return;
        }

        if (SpellInfo const* spellInfo =
                sSpellMgr->GetSpellInfo(64569 /*SPELL_BLOOD_RESERVE*/)) {
            int32 basepoints = spellInfo->Effects[EFFECT_0].CalcValue() *
                               this->GetStackAmount();
            eventInfo.GetActionTarget()->CastCustomSpell(
                spellInfo->Id,
                SPELLVALUE_BASE_POINT0,
                basepoints,
                eventInfo.GetActionTarget(),
                true);
            eventInfo.GetActionTarget()->RemoveAurasDueToSpell(
                GetSpellInfo()->Id); // Remove rest auras
        }

        SpellInfo const* spellInfo =
            sSpellMgr->GetSpellInfo(64569 /*SPELL_BLOOD_RESERVE*/);
        int32 basepoints =
            spellInfo->Effects[EFFECT_0].CalcValue() * this->GetStackAmount();
        eventInfo.GetActionTarget()->CastCustomSpell(
            spellInfo->Id,
            SPELLVALUE_BASE_POINT0,
            basepoints,
    ...
    {
        OnEffectProc +=
            AuraEffectProcFn(spell_item_blood_draining_enchant::HandleProc,
                             EFFECT_0,
                             SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_dragon_kite_summon_lightning_bunny : public SpellScript {
    ...
    void Register() override
    {
        OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
            spell_item_dragon_kite_summon_lightning_bunny::SetDest,
            EFFECT_0,
...
class spell_item_enchanted_broom_periodic : public AuraScript {
    ...
    void HandlePeriodicTick(AuraEffect const* /*aurEff*/)
    {
        ...
        if (Unit* owner = GetTarget()->GetOwner()) {
            if (owner->isMoving()) {
                GetTarget()->GetMotionMaster()->MoveFollow(
                    owner,
                    PET_FOLLOW_DIST,
                    GetTarget()->GetFollowAngle(),
                    MOTION_SLOT_ACTIVE);
            }
            else {
...
class spell_item_summon_or_dismiss : public SpellScript {
    ...
    {
        for (Unit::ControlSet::iterator itr = GetCaster()->m_Controlled.begin();
             itr != GetCaster()->m_Controlled.end();
             ++itr) {
            if (GetSpellInfo()->Effects[effIndex].MiscValue >= 0 &&
                (*itr)->GetEntry() ==
                    uint32(GetSpellInfo()->Effects[effIndex].MiscValue)) {
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_item_summon_or_dismiss::HandleSummon,
                                     EFFECT_ALL,
                                     SPELL_EFFECT_SUMMON);
    }
};
...
class spell_item_draenic_pale_ale : public SpellScript {
    ...
    void HandleSummon(SpellEffIndex effIndex)
    {
        ...
        for (uint8 count = 0; count < GetEffectValue(); ++count) {
            ...
            GetCaster()->GetClosePoint(pos.m_positionX,
                                       pos.m_positionY,
                                       pos.m_positionZ,
                                       pos.GetOrientation(),
                                       radius,
                                       M_PI - 1.2f + 0.3f * urand(0, 8));
            Creature* summon = GetCaster()->SummonCreature(
                GetSpellInfo()->Effects[effIndex].MiscValue,
                pos,
                TEMPSUMMON_TIMED_DESPAWN,
                GetSpellInfo()->GetDuration());
            if (!summon)
                continue;
            ...
            summon->GetMotionMaster()->MoveFollow(GetCaster(),
                                                  PET_FOLLOW_DIST,
                                                  GetCaster()->GetAngle(summon),
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_item_draenic_pale_ale::HandleSummon,
                                     EFFECT_0,
                                     SPELL_EFFECT_SUMMON);
    }
};
...
class spell_item_direbrew_remote : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_direbrew_remote::HandleScriptEffect,
                          EFFECT_1,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_direbrew_remote_aura : public AuraScript {
    ...
    void HandlePeriodicTick(AuraEffect const* aurEff)
    {
        ...
        if (aurEff->GetTickNumber() >= 2) {
            SetDuration(0);
            GetTarget()->CastSpell(
                GetTarget(), SPELL_MOLE_MACHINE_PORT_TO_GRIM_GUZZLER, true);
        }
    }
...
class spell_item_eye_of_gruul_healing_discount : public AuraScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_DRUID_ITEM_HEALING_TRANCE,
    ...
    void Register() override
    {
        OnEffectProc += AuraEffectProcFn(
            spell_item_eye_of_gruul_healing_discount::HandleProc,
            EFFECT_0,
            SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_summon_argent_knight : public SpellScript {
    ...
    void HandleOnEffectHit(SpellEffIndex effIndex)
    {
        if (Unit* caster = GetCaster()) {
            if (caster->GetTypeId() == TYPEID_PLAYER) {
                // summoning the "Argent Knight (Horde)" is default for spell
                // 54307;
                if (caster->ToPlayer()->GetTeamId() == TEAM_ALLIANCE) {
                    // prevent default summoning and summon "Argent Knight
                    // (Alliance)" instead
                    PreventHitDefaultEffect(effIndex);
                    caster->CastSpell(
                        caster, SPELL_SUMMON_ARGENT_KNIGHT_ALLIANCE, true);
                }
            }
        }
    }
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_item_summon_argent_knight::HandleOnEffectHit,
                          EFFECT_0,
                          SPELL_EFFECT_SUMMON);
    }
};
...
class spell_item_instant_statue : public AuraScript {
    ...
    void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        ...
        if (Creature* creature = caster->FindNearestCreature(
    ...
    {
        OnEffectRemove +=
            AuraEffectRemoveFn(spell_item_instant_statue::OnRemove,
                               EFFECT_1,
                               SPELL_AURA_DUMMY,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
public:
    spell_item_trigger_spell(uint32 triggeredSpellId)
        : SpellScript(), _triggeredSpellId(triggeredSpellId)
    {
    }
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_item_trigger_spell::HandleDummy,
                                     EFFECT_0,
                                     SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_aegis_of_preservation : public AuraScript {
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& /*eventInfo*/)
    {
        PreventDefaultAction();
        GetTarget()->CastSpell(
            GetTarget(), SPELL_AEGIS_HEAL, true, nullptr, aurEff);
    }

    void Register() override
    {
        OnEffectProc +=
            AuraEffectProcFn(spell_item_aegis_of_preservation::HandleProc,
                             EFFECT_1,
                             SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_arcane_shroud : public AuraScript {
    ...
    {
        DoEffectCalcAmount +=
            AuraEffectCalcAmountFn(spell_item_arcane_shroud::CalculateAmount,
                                   EFFECT_0,
...
class spell_item_valanyr_hammer_of_ancient_kings : public AuraScript {
    ...
    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(
            spell_item_valanyr_hammer_of_ancient_kings::CheckProc);
    }
};
...
class spell_item_brittle_armor : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_brittle_armor::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_blessing_of_ancient_kings : public AuraScript {
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        if (AuraEffect* protEff = eventInfo.GetProcTarget()->GetAuraEffect(
                SPELL_PROTECTION_OF_ANCIENT_KINGS,
                0 /*, eventInfo.GetActor()->GetGUID()*/)) {
            // The shield can grow to a maximum size of 20,000 damage absorbtion
            protEff->SetAmount(
                std::min<int32>(protEff->GetAmount() + absorb, 20000));

            // Refresh and return to prevent replacing the aura
            protEff->GetBase()->RefreshDuration();
        }
        else
            GetTarget()->CastCustomSpell(SPELL_PROTECTION_OF_ANCIENT_KINGS,
                                         SPELLVALUE_BASE_POINT0,
                                         absorb,
    ...
    {
        DoCheckProc +=
            AuraCheckProcFn(spell_item_blessing_of_ancient_kings::CheckProc);
        OnEffectProc +=
            AuraEffectProcFn(spell_item_blessing_of_ancient_kings::HandleProc,
                             EFFECT_0,
                             SPELL_AURA_DUMMY);
    }
};
...
public:
    spell_item_defibrillate(uint8 chance, uint32 failSpell = 0)
        : SpellScript(), _chance(chance), _failSpell(failSpell)
    {
    }
    ...
    void HandleScript(SpellEffIndex effIndex)
    {
        if (roll_chance_i(_chance)) {
            ...
            if (_failSpell)
                GetCaster()->CastSpell(
                    GetCaster(), _failSpell, true, GetCastItem());
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_defibrillate::HandleScript,
                          EFFECT_0,
...
class spell_item_desperate_defense : public AuraScript {
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& /*eventInfo*/)
    {
        PreventDefaultAction();
        GetTarget()->CastSpell(
            GetTarget(), SPELL_DESPERATE_RAGE, true, nullptr, aurEff);
    }
    ...
    {
        OnEffectProc +=
            AuraEffectProcFn(spell_item_desperate_defense::HandleProc,
                             EFFECT_2,
                             SPELL_AURA_PROC_TRIGGER_SPELL);
        OnEffectRemove +=
            AuraEffectRemoveFn(spell_item_desperate_defense::OnRemove,
                               EFFECT_0,
...
class spell_item_deviate_fish : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_SLEEPY,
                                  SPELL_INVIGORATE,
                                  SPELL_SHRINK,
                                  SPELL_PARTY_TIME,
    ...
    {
        Unit*  caster  = GetCaster();
        uint32 spellId = RAND(SPELL_SLEEPY,
                              SPELL_INVIGORATE,
                              SPELL_SHRINK,
                              SPELL_PARTY_TIME,
                              SPELL_HEALTHY_SPIRIT,
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(
            spell_item_deviate_fish::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
public:
    ...
    bool Execute(uint64 /*time*/, uint32 /*diff*/) override
    {
        ...
        if (_player->isMoving()) {
            _player->HandleEmoteCommand(RAND(EMOTE_ONESHOT_APPLAUD,
                                             EMOTE_ONESHOT_LAUGH,
                                             EMOTE_ONESHOT_CHEER,
        ...
        _player->m_Events.AddEvent(
            this,
            RAND(_player->m_Events.CalculateTime(5000),
                 _player->m_Events.CalculateTime(10000),
                 _player->m_Events.CalculateTime(15000)));
...
class spell_item_party_time : public AuraScript {
                           ...
                           AuraEffectHandleModes /*mode*/)
    {
        ...
        player->m_Events.AddEvent(new PartyTimeEmoteEvent(player),
                                  RAND(player->m_Events.CalculateTime(5000),
                                       player->m_Events.CalculateTime(10000),
                                       player->m_Events.CalculateTime(15000)));
    }

    void Register() override
    {
        OnEffectApply +=
            AuraEffectApplyFn(spell_item_party_time::HandleEffectApply,
                              EFFECT_0,
                              SPELL_AURA_DUMMY,
                              AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_echoes_of_light : public SpellScript {
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_item_echoes_of_light::FilterTargets,
            EFFECT_0,
...
class spell_item_fate_rune_of_unsurpassed_vigor : public AuraScript {
    ...
    {
        OnEffectProc += AuraEffectProcFn(
            spell_item_fate_rune_of_unsurpassed_vigor::HandleProc,
            EFFECT_0,
            SPELL_AURA_DUMMY);
    }
};
...
class spell_item_flask_of_the_north : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_FLASK_OF_THE_NORTH_SP,
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        caster->CastSpell(caster,
                          possibleSpells[irand(0, (possibleSpells.size() - 1))],
                          true,
                          nullptr);
    }
    ...
    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_item_flask_of_the_north::HandleDummy,
                                     EFFECT_0,
                                     SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_gnomish_death_ray : public SpellScript {
    ...
    {
        if (Unit* caster = GetCaster()) {
            if (Unit* target = ObjectAccessor::GetUnit(
                    *caster, caster->GetGuidValue(UNIT_FIELD_CHANNEL_OBJECT))) {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_gnomish_death_ray::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_make_a_wish : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_MR_PINCHYS_BLESSING,
    ...
    {
        OnEffectHit += SpellEffectFn(
            spell_item_make_a_wish::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
std::array<uint32, 20> const CreateFortuneSpells = {
    SPELL_CREATE_FORTUNE_1,  SPELL_CREATE_FORTUNE_2,  SPELL_CREATE_FORTUNE_3,
    SPELL_CREATE_FORTUNE_4,  SPELL_CREATE_FORTUNE_5,  SPELL_CREATE_FORTUNE_6,
    SPELL_CREATE_FORTUNE_7,  SPELL_CREATE_FORTUNE_8,  SPELL_CREATE_FORTUNE_9,
    SPELL_CREATE_FORTUNE_10, SPELL_CREATE_FORTUNE_11, SPELL_CREATE_FORTUNE_12,
    SPELL_CREATE_FORTUNE_13, SPELL_CREATE_FORTUNE_14, SPELL_CREATE_FORTUNE_15,
    SPELL_CREATE_FORTUNE_16, SPELL_CREATE_FORTUNE_17, SPELL_CREATE_FORTUNE_18,
    SPELL_CREATE_FORTUNE_19, SPELL_CREATE_FORTUNE_20};
...
class spell_item_mercurial_shield : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_mercurial_shield::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_mingos_fortune_generator : public SpellScript {
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_item_mingos_fortune_generator::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_necrotic_touch : public AuraScript {
    ...
    {
        return eventInfo.GetProcTarget() &&
               eventInfo.GetProcTarget()->IsAlive();
    }
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        int32 bp = CalculatePct(static_cast<int32>(damageInfo->GetDamage()),
                                aurEff->GetAmount());
        GetTarget()->CastCustomSpell(SPELL_ITEM_NECROTIC_TOUCH_PROC,
                                     SPELLVALUE_BASE_POINT0,
                                     bp,
                                     eventInfo.GetProcTarget(),
                                     true,
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(
            spell_item_necrotic_touch::HandleProc, EFFECT_0, SPELL_AURA_DUMMY);
    }
};
...
class spell_item_net_o_matic : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_NET_O_MATIC_TRIGGERED1,
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (Unit* target = GetHitUnit()) {
            ...
            else if (roll < 4) // 2% for 20 sec root, charge to target (off-like
                               // chance unknown)
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_net_o_matic::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_noggenfogger_elixir : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_NOGGENFOGGER_ELIXIR_TRIGGERED1,
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_item_noggenfogger_elixir::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_piccolo_of_the_flaming_fire : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_piccolo_of_the_flaming_fire::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_savory_deviate_delight : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        for (uint32 spellId = SPELL_FLIP_OUT_MALE;
             spellId <= SPELL_YAAARRRR_FEMALE;
             ++spellId)
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        case 1:
            spellId =
                (caster->getGender() == GENDER_MALE ? SPELL_FLIP_OUT_MALE
                                                    : SPELL_FLIP_OUT_FEMALE);
            break;
        // Yaaarrrr - pirate
        case 2:
            spellId =
                (caster->getGender() == GENDER_MALE ? SPELL_YAAARRRR_MALE
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_item_savory_deviate_delight::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_scroll_of_recall : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_scroll_of_recall::HandleScript,
                          EFFECT_0,
...
class spell_item_dimensional_ripper_area52 : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_dimensional_ripper_area52::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_TELEPORT_UNITS);
    }
};
...
class spell_item_unsated_craving : public AuraScript {
    ...
    bool CheckProc(ProcEventInfo& procInfo)
    {
        ...
        if (!target || target->GetTypeId() != TYPEID_UNIT ||
            target->IsCritter() || target->IsSummon()) {
            return false;
        }
    ...
    // xinef: prevent default proc with castItem passed, which applies 30 sec
    // cooldown to procing of the aura
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        PreventDefaultAction();
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(spell_item_unsated_craving::HandleProc,
                                         EFFECT_0,
                                         SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_item_shadows_fate : public AuraScript {
    ...
    {
        OnEffectProc += AuraEffectProcFn(
            spell_item_shadows_fate::HandleProc, EFFECT_0, SPELL_AURA_DUMMY);
    }
};
...
class spell_item_shadowmourne : public AuraScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_SHADOWMOURNE_CHAOS_BANE_DAMAGE,
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        if (GetTarget()->HasAura(
                SPELL_SHADOWMOURNE_CHAOS_BANE_BUFF)) // cant collect shards
                                                     // while under effect of
                                                     // Chaos Bane buff
            return false;

        // Xinef: Not on BG / Arena
        /*if (!GetTarget()->FindMap() ||
           GetTarget()->FindMap()->IsBattlegroundOrArena()) return false;*/

        if (SpellInfo const* procSpell = eventInfo.GetSpellInfo()) {
            if (eventInfo.GetDamageInfo() &&
                !eventInfo.GetDamageInfo()->GetDamage()) {
                if (!procSpell->SpellFamilyFlags.HasFlag(
                        0x2 | 0x20 | 0x4000, 0x0, 0x0))
                    return false;
            }
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        // this can't be handled in AuraScript of SoulFragments because we need
        // to know victim
        if (Aura* soulFragments =
                GetTarget()->GetAura(SPELL_SHADOWMOURNE_SOUL_FRAGMENT)) {
            if (soulFragments->GetStackAmount() >= 10) {
                GetTarget()->CastSpell(eventInfo.GetProcTarget(),
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(
            spell_item_shadowmourne::HandleProc, EFFECT_0, SPELL_AURA_DUMMY);
        AfterEffectRemove +=
            AuraEffectRemoveFn(spell_item_shadowmourne::OnRemove,
                               EFFECT_0,
                               SPELL_AURA_DUMMY,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_shadowmourne_soul_fragment : public AuraScript {
    ...
    void Register() override
    {
        AfterEffectApply += AuraEffectApplyFn(
            spell_item_shadowmourne_soul_fragment::OnStackChange,
            EFFECT_0,
            SPELL_AURA_MOD_STAT,
            AuraEffectHandleModes(AURA_EFFECT_HANDLE_REAL |
                                  AURA_EFFECT_HANDLE_REAPPLY));
        AfterEffectRemove +=
            AuraEffectRemoveFn(spell_item_shadowmourne_soul_fragment::OnRemove,
                               EFFECT_0,
                               SPELL_AURA_MOD_STAT,
                               AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_item_six_demon_bag : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_FROSTBOLT,
                                  SPELL_POLYMORPH,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_six_demon_bag::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_underbelly_elixir : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({SPELL_UNDERBELLY_ELIXIR_TRIGGERED1,
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        ...
        caster->CastSpell(
            caster, spellId, true, GetCastItem(), nullptr, caster->GetGUID());
    }

    void Register() override
    {
        OnEffectHit += SpellEffectFn(spell_item_underbelly_elixir::HandleDummy,
                                     EFFECT_0,
                                     SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_book_of_glyph_mastery : public SpellScript {
    ...
    void Register() override
    {
        OnCheckCast += SpellCheckCastFn(
            spell_item_book_of_glyph_mastery::CheckRequirement);
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_book_of_glyph_mastery::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_map_of_the_geyser_fields : public SpellScript {
    ...
    {
        OnCheckCast += SpellCheckCastFn(
            spell_item_map_of_the_geyser_fields::CheckSinkholes);
    }
};
...
class spell_item_vanquished_clutches : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo(
            {SPELL_CRUSHER, SPELL_CONSTRICTOR, SPELL_CORRUPTOR});
    }

    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        uint32 spellId =
            RAND(SPELL_CRUSHER, SPELL_CONSTRICTOR, SPELL_CORRUPTOR);
        Unit* caster = GetCaster();
        caster->CastSpell(caster, spellId, true);
    }
    ...
    {
        OnEffectHit +=
            SpellEffectFn(spell_item_vanquished_clutches::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_ashbringer : public SpellScript {
    ...
    void OnDummyEffect(SpellEffIndex effIndex)
    {
        ...
        uint32  sound_id = RAND(SOUND_ASHBRINGER_1,
                               SOUND_ASHBRINGER_2,
                               SOUND_ASHBRINGER_3,
                               SOUND_ASHBRINGER_4,
                               SOUND_ASHBRINGER_5,
        ...
        // Ashbringers effect (spellID 28441) retriggers every 5 seconds, with a
        // chance of making it say one of the above 12 sounds
        if (urand(0, 60) < 1)
    ...
    {
        OnEffectHit += SpellEffectFn(
            spell_item_ashbringer::OnDummyEffect, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_magic_eater_food : public AuraScript {
    ...
    {
        OnEffectPeriodic +=
            AuraEffectPeriodicFn(spell_magic_eater_food::HandleTriggerSpell,
                                 EFFECT_1,
                                 SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_item_shimmering_vessel : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_shimmering_vessel::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_purify_helboar_meat : public SpellScript {
    ...
    {
        return ValidateSpellInfo({SPELL_SUMMON_PURIFIED_HELBOAR_MEAT,
    ...
    void HandleDummy(SpellEffIndex /* effIndex */)
    {
        Unit* caster = GetCaster();
        caster->CastSpell(caster,
                          roll_chance_i(50) ? SPELL_SUMMON_PURIFIED_HELBOAR_MEAT
                                            : SPELL_SUMMON_TOXIC_HELBOAR_MEAT,
                          true,
                          nullptr);
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_purify_helboar_meat::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_reindeer_transformation : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spell*/) override
    {
        return ValidateSpellInfo({SPELL_FLYING_REINDEER_310,
        ...
        if (caster->HasAuraType(SPELL_AURA_MOUNTED)) {
            ...
            if (flyspeed >= 4.1f)
                ...
                caster->CastSpell(caster,
                                  ...
                                  true); // 310% flying Reindeer
            else if (flyspeed >= 3.8f)
                // Flying Reindeer
                caster->CastSpell(caster,
                                  SPELL_FLYING_REINDEER_280,
                                  true); // 280% flying Reindeer
            else if (flyspeed >= 1.6f)
                // Flying Reindeer
                caster->CastSpell(caster,
                                  SPELL_FLYING_REINDEER_60,
                                  true); // 60% flying Reindeer
            else if (speed >= 2.0f)
                // Reindeer
                caster->CastSpell(
                    caster, SPELL_REINDEER_100, true); // 100% ground Reindeer
            else
                // Reindeer
                caster->CastSpell(
                    caster, SPELL_REINDEER_60, true); // 60% ground Reindeer
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_reindeer_transformation::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_nigh_invulnerability : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_NIGH_INVULNERABILITY, SPELL_COMPLETE_VULNERABILITY});
    }
    ...
    void HandleDummy(SpellEffIndex /* effIndex */)
    {
        ...
        if (Item* castItem = GetCastItem()) {
            if (roll_chance_i(86)) // Nigh-Invulnerability   - success
                caster->CastSpell(
                    caster, SPELL_NIGH_INVULNERABILITY, true, castItem);
            else // Complete Vulnerability - backfire in 14% casts
                caster->CastSpell(
                    caster, SPELL_COMPLETE_VULNERABILITY, true, castItem);
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_nigh_invulnerability::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_poultryizer : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spell*/) override
    {
        return ValidateSpellInfo({SPELL_POULTRYIZER_SUCCESS_1,
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_poultryizer::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_socrethars_stone : public SpellScript {
    ...
    bool Load() override
    {
        return (GetCaster()->GetAreaId() == 3900 ||
                GetCaster()->GetAreaId() == 3742);
    }

    bool Validate(SpellInfo const* /*spell*/) override
    {
        return ValidateSpellInfo(
            {SPELL_SOCRETHAR_TO_SEAT, SPELL_SOCRETHAR_FROM_SEAT});
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_socrethars_stone::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_demon_broiled_surprise : public SpellScript {
    ...
    {
        Player* player = GetCaster()->ToPlayer();
        if (player->GetQuestStatus(QUEST_SUPER_HOT_STEW) !=
            QUEST_STATUS_INCOMPLETE)
            return SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW;

        if (Creature* creature = player->FindNearestCreature(
                NPC_ABYSSAL_FLAMEBRINGER, 10, false))
            if (creature->isDead())
                return SPELL_CAST_OK;
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_demon_broiled_surprise::HandleDummy,
                          EFFECT_1,
                          SPELL_EFFECT_DUMMY);
        OnCheckCast += SpellCheckCastFn(
            spell_item_demon_broiled_surprise::CheckRequirement);
    }
};
...
class spell_item_complete_raptor_capture : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /* effIndex */)
    {
        ...
        if (GetHitCreature()) {
            ...
            caster->CastSpell(
                caster, SPELL_RAPTOR_CAPTURE_CREDIT, true, nullptr);
        }
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_complete_raptor_capture::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_impale_leviroth : public SpellScript {
    ...
    {
        if (Creature* target = GetHitCreature())
            if (target->GetEntry() == NPC_LEVIROTH &&
                target->HealthAbovePct(94)) {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_impale_leviroth::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_brewfest_mount_transformation : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spell*/) override
    {
        return ValidateSpellInfo({SPELL_MOUNT_RAM_100,
                                  SPELL_MOUNT_RAM_60,
        ...
        if (caster->HasAuraType(SPELL_AURA_MOUNTED)) {
            ...
            case SPELL_BREWFEST_MOUNT_TRANSFORM:
                if (caster->GetSpeedRate(MOVE_RUN) >= 2.0f)
                    spell_id = caster->GetTeamId() == TEAM_ALLIANCE
                                   ? SPELL_MOUNT_RAM_100
                                   : SPELL_MOUNT_KODO_100;
                else
                    spell_id = caster->GetTeamId() == TEAM_ALLIANCE
            ...
            case SPELL_BREWFEST_MOUNT_TRANSFORM_REVERSE:
                if (caster->GetSpeedRate(MOVE_RUN) >= 2.0f)
                    spell_id = caster->GetTeamId() == TEAM_HORDE
                                   ? SPELL_MOUNT_RAM_100
                                   : SPELL_MOUNT_KODO_100;
                else
                    spell_id = caster->GetTeamId() == TEAM_HORDE
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_brewfest_mount_transformation::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_nitro_boots : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /* effIndex */)
    {
        Unit* caster = GetCaster();
        caster->CastSpell(caster,
                          caster->GetMap()->IsDungeon() || roll_chance_i(95)
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_nitro_boots::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_teach_language : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_LEARN_GNOMISH_BINARY, SPELL_LEARN_GOBLIN_BINARY});
    }
    ...
    void HandleDummy(SpellEffIndex /* effIndex */)
    {
        ...
        if (roll_chance_i(34))
            caster->CastSpell(caster,
                              caster->GetTeamId() == TEAM_ALLIANCE
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_teach_language::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_rocket_boots : public SpellScript {
    ...
    void Register() override
    {
        ...
        OnEffectHitTarget += SpellEffectFn(
            spell_item_rocket_boots::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_healing_injector : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_healing_injector::HandleHeal,
                          EFFECT_0,
                          SPELL_EFFECT_HEAL);
    }
};
...
class spell_item_mana_injector : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_mana_injector::HandleEnergize,
                          EFFECT_0,
...
class spell_item_pygmy_oil : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_PYGMY_OIL_PYGMY_AURA, SPELL_PYGMY_OIL_SMALLER_AURA});
    }
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_pygmy_oil::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_unusual_compass : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_unusual_compass::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_chicken_cover : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_CHICKEN_NET, SPELL_CAPTURE_CHICKEN_ESCAPE});
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_chicken_cover::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_refocus : public SpellScript {
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_refocus::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_muisek_vessel : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_muisek_vessel::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_greatmothers_soulcatcher : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_greatmothers_soulcatcher::HandleDummy,
                          EFFECT_0,
                          SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_eggnog : public SpellScript {
    ...
    {
        return ValidateSpellInfo(
            {SPELL_EGG_NOG_REINDEER, SPELL_EGG_NOG_SNOWMAN});
    }
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_item_eggnog::HandleScript, EFFECT_2, SPELL_EFFECT_INEBRIATE);
    }
};
...
class spell_item_goblin_bomb : public SpellScript {
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        if (Unit* caster = GetCaster()) {
            caster->CastSpell(caster,
                              roll_chance_i(95) ? SPELL_SUMMON_GOBLIN_BOMB
    ...
    {
        OnEffectHit += SpellEffectFn(
            spell_item_goblin_bomb::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};
...
class spell_item_linken_boomerang : public SpellScript {
    ...
    void Register() override
    {
        OnEffectLaunchTarget += SpellEffectFn(
            spell_item_linken_boomerang::OnEffectLaunchTargetDisarm,
            EFFECT_1,
            SPELL_EFFECT_TRIGGER_SPELL);
        OnEffectLaunchTarget +=
            SpellEffectFn(spell_item_linken_boomerang::OnEffectLaunchTargetStun,
                          EFFECT_2,
                          SPELL_EFFECT_TRIGGER_SPELL);

        OnEffectHitTarget +=
            SpellEffectFn(spell_item_linken_boomerang::OnEffectHitTargetDisarm,
                          EFFECT_1,
                          SPELL_EFFECT_TRIGGER_SPELL);
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_linken_boomerang::OnEffectHitTargetStun,
                          EFFECT_2,
                          SPELL_EFFECT_TRIGGER_SPELL);
    }
};
...
class spell_item_recall : public SpellScript {
    ...
    void SetDest(SpellDestination& dest)
    {
        ...
        if (player->GetTeamId(true) != bgTeam) {
            if (SpellTargetPosition const* recallSpellTarget =
                    sSpellMgr->GetSpellTargetPosition(
                        bgTeam == TEAM_HORDE ? SPELL_RECALL_HORDE
                                             : SPELL_RECALL_ALLIANCE,
                        EFFECT_0)) {
                Position pos = Position(recallSpellTarget->target_X,
                                        recallSpellTarget->target_Y,
                                        recallSpellTarget->target_Z,
                                        recallSpellTarget->target_Orientation);
                dest.Relocate(pos);
            }
        }
    }
    ...
    {
        OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
            spell_item_recall::SetDest, EFFECT_0, TARGET_DEST_DB);
    }
};
...
class spell_item_wraith_scythe_drain_life : public SpellScript {
    ...
    {
        OnHit +=
            SpellHitFn(spell_item_wraith_scythe_drain_life::CalculateDamage);
    }
};
...
class spell_item_mirrens_drinking_hat : public SpellScript {
    ...
    void HandleScriptEffect(SpellEffIndex /* effIndex */)
    {
        ...
        case 2:
        case 3:
            spellId = SPELL_LOCH_MODAN_LAGER;
            break;
        case 4:
        case 5:
            spellId = SPELL_STOUTHAMMER_LITE;
            break;
        case 6:
            spellId = SPELL_AERIE_PEAK_PALE_ALE;
            break;
        }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_mirrens_drinking_hat::HandleScriptEffect,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_freeze_rookery_egg : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_freeze_rookery_egg::HandleOpenObject,
                          EFFECT_0,
...
/// @todo Temporary fix until pet restrictions vs player restrictions are
/// investigated
class spell_item_elixir_of_shadows : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_elixir_of_shadows::HandleEffect,
                          EFFECT_0,
                          SPELL_EFFECT_APPLY_AURA);
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_elixir_of_shadows::HandleEffect,
...
class spell_item_worn_troll_dice : public SpellScript {
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_item_worn_troll_dice::HandleScript,
                          EFFECT_0,
                          SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_item_venomhide_feed : public SpellScript {
    ...
    void Register() override
    {
        ...
        OnObjectTargetSelect +=
            SpellObjectTargetSelectFn(spell_item_venomhide_feed::UpdateTarget,
                                      EFFECT_0,
...
class spell_item_scroll_of_retribution : public SpellScript {
    ...
    {
        OnCheckCast +=
            SpellCheckCastFn(spell_item_scroll_of_retribution::CheckCast);
    }
};
...
void AddSC_item_spell_scripts()
{
    ...
    RegisterSpellAndAuraScriptPair(spell_item_direbrew_remote,
    ...
    RegisterSpellScriptWithArgs(spell_item_trigger_spell,
                                "spell_item_arcanite_dragonling",
                                SPELL_ARCANITE_DRAGONLING);
    // 23133 Gnomish Battle Chicken
    RegisterSpellScriptWithArgs(spell_item_trigger_spell,
                                "spell_item_gnomish_battle_chicken",
                                SPELL_BATTLE_CHICKEN);
    // 23076 Mechanical Dragonling
    RegisterSpellScriptWithArgs(spell_item_trigger_spell,
                                "spell_item_mechanical_dragonling",
                                SPELL_MECHANICAL_DRAGONLING);
    // 23075 Mithril Mechanical Dragonling
    RegisterSpellScriptWithArgs(spell_item_trigger_spell,
                                "spell_item_mithril_mechanical_dragonling",
    ...
    RegisterSpellScriptWithArgs(spell_item_defibrillate,
    ...
    RegisterSpellScriptWithArgs(
        spell_item_defibrillate, "spell_item_gnomish_army_knife", 33);
