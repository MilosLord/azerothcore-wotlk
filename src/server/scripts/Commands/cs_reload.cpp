...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        static ChatCommandTable commandTable = {{"reload", reloadCommandTable}};
        return commandTable;
    }
    ...
    static bool HandleReloadBattlegroundTemplate(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `battleground_template` reloaded.");
        return true;
    }
    ...
    {
        // HandleReloadQuestAreaTriggersCommand(handler); -- reloaded in
        // HandleReloadAllQuestCommand
    ...
    static bool HandleReloadDungeonAccessCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
                 "Re-Loading Dungeon Access Requirement definitions...");
        sObjectMgr->LoadAccessRequirements();
        handler->SendGlobalGMSysMessage(
            "DB tables `dungeon_access_template` AND "
            "`dungeon_access_requirements` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Additional Achievement Criteria Data...");
        sAchievementMgr->LoadAchievementCriteriaData();
        handler->SendGlobalGMSysMessage(
            "DB table `achievement_criteria_data` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadAchievementRewardCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `achievement_reward` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadAreaTriggerTavernCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `areatrigger_tavern` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Area Trigger teleport definitions...");
        sObjectMgr->LoadAreaTriggerTeleports();
        handler->SendGlobalGMSysMessage(
            "DB table `areatrigger_teleport` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadCommandCommand(ChatHandler* handler)
    {
        ...
        // do not log this invocation, otherwise we might crash (the command
        // table we used to get here is no longer valid!)
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading creature award reputation definitions...");
                                                    ...
                                                    std::string_view args)
    {
        ...
        for (std::string_view entryStr : Acore::Tokenize(args, ' ', false)) {
            ...
            if (!result) {
                handler->PSendSysMessage(LANG_COMMAND_CREATURETEMPLATE_NOTFOUND,
                                         entry);
                continue;
            }

            CreatureTemplate* cInfo = const_cast<CreatureTemplate*>(
                sObjectMgr->GetCreatureTemplate(entry));
            if (!cInfo) {
                handler->PSendSysMessage(LANG_COMMAND_CREATURESTORAGE_NOTFOUND,
                                         entry);
                continue;
            }

            LOG_INFO("server.loading",
                     "Reloading creature template entry {}",
                     entry);
    ...
    {
        LOG_INFO("server.loading",
                 "Loading Quests Relations... (`creature_queststarter`)");
        sObjectMgr->LoadCreatureQuestStarters();
        handler->SendGlobalGMSysMessage(
            "DB table `creature_queststarter` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Loading Linked Respawns... (`creature_linked_respawn`)");
        sObjectMgr->LoadLinkedRespawn();
        handler->SendGlobalGMSysMessage("DB table `creature_linked_respawn` "
                                        "(creature linked respawns) reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Loading Quests Relations... (`creature_questender`)");
        sObjectMgr->LoadCreatureQuestEnders();
        handler->SendGlobalGMSysMessage(
            "DB table `creature_questender` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadGossipMenuOptionCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `gossip_menu_option` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Loading Quests Relations... (`gameobject_queststarter`)");
        sObjectMgr->LoadGameobjectQuestStarters();
        handler->SendGlobalGMSysMessage(
            "DB table `gameobject_queststarter` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Loading Quests Relations... (`gameobject_questender`)");
        sObjectMgr->LoadGameobjectQuestEnders();
        handler->SendGlobalGMSysMessage(
            "DB table `gameobject_questender` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesQuestGreetingCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `quest_greeting_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadQuestTemplateCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "Data GameObjects for quests reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLootTemplatesCreatureCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `creature_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }

    static bool
    HandleReloadCreatureMovementOverrideCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading", "Re-Loading Creature movement overrides...");
        sObjectMgr->LoadCreatureMovementOverrides();
        handler->SendGlobalGMSysMessage(
            "DB table `creature_movement_override` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`fishing_loot_template`)");
        LoadLootTemplates_Fishing();
        LootTemplates_Fishing.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `fishing_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`gameobject_loot_template`)");
        LoadLootTemplates_Gameobject();
        LootTemplates_Gameobject.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `gameobject_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`item_loot_template`)");
        LoadLootTemplates_Item();
        LootTemplates_Item.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `item_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`milling_loot_template`)");
        LoadLootTemplates_Milling();
        LootTemplates_Milling.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `milling_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }

    static bool
    HandleReloadLootTemplatesPickpocketingCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `pickpocketing_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }

    static bool
    HandleReloadLootTemplatesProspectingCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`prospecting_loot_template`)");
        LoadLootTemplates_Prospecting();
        LootTemplates_Prospecting.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `prospecting_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`mail_loot_template`)");
        LoadLootTemplates_Mail();
        LootTemplates_Mail.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `mail_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`reference_loot_template`)");
        LoadLootTemplates_Reference();
        handler->SendGlobalGMSysMessage(
            "DB table `reference_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`skinning_loot_template`)");
        LoadLootTemplates_Skinning();
        LootTemplates_Skinning.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `skinning_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Loot Tables... (`player_loot_template`)");
        LoadLootTemplates_Player();
        LootTemplates_Player.CheckLootRefs();
        handler->SendGlobalGMSysMessage(
            "DB table `player_loot_template` reloaded.");
        sConditionMgr->LoadConditions(true);
        return true;
    }
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler)
    {
        if (!sWorld->getBoolConfig(CONFIG_WARDEN_ENABLED)) {
            handler->SendErrorMessage("Warden system disabled by config - "
                                      "reloading warden_action skipped.");
            return false;
        }
    ...
    static bool HandleReloadPointsOfInterestCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `points_of_interest` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadQuestPOICommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB Table `quest_poi` and `quest_poi_points` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellClickSpellsCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `npc_spellclick_spells` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadProfanityNameCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `profanity_player` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading `reputation_reward_rate` Table!");
        sObjectMgr->LoadReputationRewardRate();
        handler->SendGlobalSysMessage(
            "DB table `reputation_reward_rate` reloaded.");
        return true;
    }

    static bool
    HandleReloadReputationSpilloverTemplateCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
                 "Re-Loading `reputation_spillover_template` Table!");
        sObjectMgr->LoadReputationSpilloverTemplate();
        handler->SendGlobalSysMessage(
            "DB table `reputation_spillover_template` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSkillDiscoveryTemplateCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `skill_discovery_template` (recipes discovered at "
            "crafting) reloaded.");
        return true;
    }

    static bool
    HandleReloadSkillPerfectItemTemplateCommand(ChatHandler* handler)
    {
        // latched onto HandleReloadSkillExtraItemTemplateCommand as it's part
        // of that table group (and i don't want to chance all the command IDs)
        LOG_INFO("server.loading", "Re-Loading Skill Perfection Data Table...");
        LoadSkillPerfectItemTable();
        handler->SendGlobalGMSysMessage(
            "DB table `skill_perfect_item_template` (perfect item procs when "
            "crafting) reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Skill Fishing base level requirements...");
    ...
    static bool HandleReloadSpellAreaCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `spell_area` (spell dependences from area/quest/auras "
            "state) reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellGroupsCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `spell_group` (spell groups) reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellLinkedSpellCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `spell_linked_spell` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellProcEventCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage("DB table `spell_proc_event` (spell "
                                        "proc trigger requirements) reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Spell Proc conditions and data...");
        sSpellMgr->LoadSpellProcs();
        handler->SendGlobalGMSysMessage(
            "DB table `spell_proc` (spell proc conditions and data) reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellTargetPositionCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `spell_target_position` (destination coordinates for "
            "spell targets) reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSpellGroupStackRulesCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `spell_group_stack_rules` (spell stacking definitions) "
            "reloaded.");
        return true;
    }
    ...
    static bool HandleReloadPageTextsCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "You need to delete your client cache or change the cache number "
            "in config in order for your players see the changes.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Item Random Enchantments Table...");
        LoadRandomEnchantmentsTable();
        handler->SendGlobalGMSysMessage(
            "DB table `item_enchantment_template` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler)
    {
        ...
        LOG_INFO("server.loading",
                 "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler)
    {
        ...
        LOG_INFO("server.loading",
                 "Re-Loading Scripts from `waypoint_scripts`...");

        sObjectMgr->LoadWaypointScripts();

        handler->SendGlobalGMSysMessage(
            "DB table `waypoint_scripts` reloaded.");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler)
    {
        ...
        LOG_INFO("server.loading",
                 "Re-Loading Scripts from `spell_scripts`...");
    ...
    static bool
    HandleReloadLocalesAchievementRewardCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
                 "Re-Loading Achievement Reward Data Locale...");
        sAchievementMgr->LoadRewardLocales();
        handler->SendGlobalGMSysMessage(
            "DB table `achievement_reward_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLfgRewardsCommand(ChatHandler* handler)
    {
        ...
        sLFGMgr->LoadRewards();
        handler->SendGlobalGMSysMessage(
            "DB table `lfg_dungeon_rewards` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesCreatureCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `creature_template_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesCreatureTextCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `creature_text_locale` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Gameobject Template Locale ... ");
        sObjectMgr->LoadGameObjectLocales();
        handler->SendGlobalGMSysMessage(
            "DB table `gameobject_template_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesGossipMenuOptionCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `gossip_menu_option_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesItemSetNameCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `item_set_name_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesPageTextCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `page_text_locale` reloaded.");
        handler->SendGlobalGMSysMessage(
            "You need to delete your client cache or change the cache number "
            "in config in order for your players see the changes.");
        return true;
    ...
    static bool HandleReloadLocalesPointsOfInterestCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `points_of_interest_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesQuestCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `quest_template_locale` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadLocalesQuestOfferRewardCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `quest_offer_reward_locale` reloaded.");
        return true;
    }

    static bool
    HandleReloadLocalesQuestRequestItemsCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading", "Re-Loading Quest Request Item Locale... ");
        sObjectMgr->LoadQuestRequestItemsLocale();
        handler->SendGlobalGMSysMessage(
            "DB table `quest_request_item_locale` reloaded.");
        return true;
    }
    ...
    {
        LOG_INFO("server.loading",
                 "Re-Loading Player level dependent mail rewards...");
        sObjectMgr->LoadMailLevelRewards();
        handler->SendGlobalGMSysMessage(
            "DB table `mail_level_reward` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadMailServerTemplateCommand(ChatHandler* handler)
    {
        ...
        handler->SendGlobalGMSysMessage(
            "DB table `server_mail_template` reloaded.");
        return true;
    }
    ...
    static bool
    HandleReloadVehicleTemplateAccessoryCommand(ChatHandler* handler)
    {
        LOG_INFO("server.loading",
                 "Reloading vehicle_template_accessory table...");
        sObjectMgr->LoadVehicleTemplateAccessories();
        handler->SendGlobalGMSysMessage(
            "Vehicle template accessories reloaded.");
        return true;
    }
...
void AddSC_reload_commandscript() { new reload_commandscript(); }
