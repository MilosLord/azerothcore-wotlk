...
public:
    ...
    static bool HandleWpAddCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (!path_number) {
            if (target)
                ...
                handler->PSendSysMessage(
                    "%s%s|r", "|cff00ff00", "New path started.");
            }
        }
        else
        ...
        handler->PSendSysMessage("%s%s%u%s%u%s|r",
                                 "|cff00ff00",
                                 "PathID: |r|cff00ffff",
                                 pathid,
                                 "|r|cff00ff00: Waypoint |r|cff00ffff",
                                 point + 1,
                                 "|r|cff00ff00 created. ");
        return true;
    } // HandleWpAddCommand
    ...
    static bool HandleWpLoadCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (!pathid) {
            handler->PSendSysMessage(
                "%s%s|r", "|cffff33ff", "No valid path number provided.");
            return true;
        }
        ...
        if (result) {
            stmt = WorldDatabase.GetPreparedStatement(
    ...
    static bool HandleWpReloadCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(
            "%s%s|r|cff00ffff%u|r", "|cff00ff00", "Loading Path: ", id);
                                      ...
                                      const char* /*args*/)
    {
        ...
        if (!target) {
            handler->PSendSysMessage(
                "%s%s|r", "|cff33ffff", "You must select target.");
            return true;
        }
    ...
    static bool HandleWpEventCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (show == "add") {
            ...
            if (id) {
                ...
                if (!result) {
                    ...
                    handler->PSendSysMessage(
                        "|cff00ff00Wp Event: You have choosed an existing "
                        "waypoint script guid: %u|r",
                        id);
            }
            else {
                WorldDatabasePreparedStatement* stmt =
        ...
        if (show == "listid") {
            ...
            do {
                ...
                handler->PSendSysMessage(
                    "|cffff33ffid:|r|cff00ffff %u|r|cff00ff00, guid: "
                    "|r|cff00ffff%u|r|cff00ff00, delay: "
                    "|r|cff00ffff%u|r|cff00ff00, command: "
                    "|r|cff00ffff%u|r|cff00ff00, datalong: "
                    "|r|cff00ffff%u|r|cff00ff00, datalong2: "
                    "|r|cff00ffff%u|r|cff00ff00, datatext: "
                    "|r|cff00ffff%s|r|cff00ff00, posx: "
                    "|r|cff00ffff%f|r|cff00ff00, posy: "
                    "|r|cff00ffff%f|r|cff00ff00, posz: "
                    "|r|cff00ffff%f|r|cff00ff00, orientation: |r|cff00ffff%f|r",
                    id,
                    a2,
                    a3,
                    a4,
        ...
        if (show == "del") {
            ...
            if (result) {
                ...
                handler->PSendSysMessage("%s%s%u|r",
                                         "|cff00ff00",
                                         "Wp Event: Waypoint script removed: ",
                                         id);
            }
            else
                handler->PSendSysMessage("|cffff33ffWp Event: ERROR: you have "
                                         "selected a non existing script: %u|r",
                                         id);
        ...
        if (show == "mod") {
            ...
            if (!id) {
                handler->SendSysMessage("|cffff33ffERROR: No vallid waypoint "
                                        "script id not present.|r");
                return true;
            }
            ...
            if ((arg_string != "setid") && (arg_string != "delay") &&
                (arg_string != "command") && (arg_string != "datalong") &&
                (arg_string != "datalong2") && (arg_string != "dataint") &&
                (arg_string != "posx") && (arg_string != "posy") &&
                (arg_string != "posz") && (arg_string != "orientation")) {
                handler->SendSysMessage(
            ...
            if (arg_str_2 == "setid") {
                ...
                if (!result) {
                    handler->SendSysMessage(
                        "|cffff33ffERROR: You have selected an non existing "
                        "waypoint script guid.|r");
                    return true;
                }
                ...
                if (arg_str_2 == "posx") {
                    ...
                    handler->PSendSysMessage(
                        "|cff00ff00Waypoint script:|r|cff00ffff %u|r|cff00ff00 "
                        "position_x updated.|r",
                        id);
                    return true;
                }
                    ...
                    handler->PSendSysMessage(
                        "|cff00ff00Waypoint script: |r|cff00ffff%u|r|cff00ff00 "
                        "orientation updated.|r",
                        id);
                    return true;
                }
                else if (arg_str_2 == "dataint") {
                    WorldDatabase.Execute(
                        "UPDATE waypoint_scripts SET {}='{}' WHERE guid='{}'",
                        arg_2,
                        atoi(arg_3),
                        id); // Query can't be a prepared statement
            ...
            handler->PSendSysMessage("%s%s|r|cff00ffff%u:|r|cff00ff00 %s %s|r",
                                     "|cff00ff00",
                                     "Waypoint script:",
                                     id,
                                     arg_2,
    ...
    static bool HandleWpModifyCommand(ChatHandler* handler, const char* args)
    {
        ...
        if ((show != "delay") && (show != "action") &&
            (show != "action_chance") && (show != "move_type") &&
            (show != "del") && (show != "move") && (show != "wpadd")) {
            return false;
        }
        ...
        if (!result) {
            ...
            // thousand (0.001) - There is no other way to compare C++ floats
            // with mySQL floats See also:
        ...
        if (show == "del") {
            ...
            if (wpSpawnId != 0)
                if (Creature* wpCreature =
                        handler->GetSession()
                            ->GetPlayer()
                            ->GetMap()
                            ->GetCreature(target->GetGUID())) {
            ...
            WorldDatabasePreparedStatement* stmt =
                WorldDatabase.GetPreparedStatement(WORLD_DEL_WAYPOINT_DATA);
            stmt->SetData(0, pathid);
        ...
        if (show == "move") {
            ...
            Map*    map = chr->GetMap();
            {
                ...
                if (wpSpawnId != 0) {
                    if (Creature* wpCreature =
                            map->GetCreature(target->GetGUID())) {
                        wpCreature->CombatStop();
                        wpCreature->DeleteFromDB();
                        wpCreature->AddObjectToRemoveList();
                    }
                    ...
                    if (!wpCreature2->Create(
                            ...
                            chr->GetPositionZ(),
                            chr->GetOrientation())) {
                        handler->PSendSysMessage(LANG_WAYPOINT_VP_NOTCREATED,
                                                 VISUAL_WAYPOINT);
                        delete wpCreature2;
                        wpCreature2 = nullptr;
                        return false;
                    ...
                    wpCreature2->SaveToDB(map->GetId(),
                                          (1 << map->GetSpawnMode()),
                                          chr->GetPhaseMaskForSpawn());
                    // To call _LoadGoods(); _LoadQuests();
                    // CreateTrainerSpells();
                    // TODO: Should we first use "Create" then use "LoadFromDB"?
                    if (!wpCreature2->LoadCreatureFromDB(
                            wpCreature2->GetSpawnId(), map, true, true)) {
                        handler->PSendSysMessage(LANG_WAYPOINT_VP_NOTCREATED,
                                                 VISUAL_WAYPOINT);
                        delete wpCreature2;
                        wpCreature2 = nullptr;
        ...
        if (text == 0) {
            // show_str check for present in list of correct values, no sql
            // injection possible
            WorldDatabase.Execute("UPDATE waypoint_data SET {}=nullptr WHERE "
                                  "id='{}' AND point='{}'",
                                  show_str,
                                  pathid,
                                  point); // Query can't be a prepared statement
        }
        else {
            // show_str check for present in list of correct values, no sql
            // injection possible
            ...
            WorldDatabase.Execute(
                "UPDATE waypoint_data SET {}='{}' WHERE id='{}' AND point='{}'",
                show_str,
                text2,
                pathid,
                point); // Query can't be a prepared statement
    ...
    static bool HandleWpShowCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (show == "info") {
            ...
            do {
                ...
                handler->PSendSysMessage(
                    "|cff00ff00Show info: for current point: "
                    "|r|cff00ffff%u|r|cff00ff00, Path ID: |r|cff00ffff%u|r",
                    point,
                    pathid);
                handler->PSendSysMessage(
        ...
        if (show == "on") {
                ...
                do {
                    ...
                    Creature* creature =
                        handler->GetSession()
                            ->GetPlayer()
                            ->GetMap()
                            ->GetCreature(ObjectGuid::Create<HighGuid::Unit>(
                                VISUAL_WAYPOINT, wpguid));
            ...
            do {
                ...
                if (!wpCreature->Create(map->GenerateLowGuid<HighGuid::Unit>(),
                                        map,
                                        chr->GetPhaseMaskForSpawn(),
                                        id,
                                        0,
                ...
                if (!wpCreature->LoadCreatureFromDB(
                        wpCreature->GetSpawnId(), map, true, true)) {
                    handler->PSendSysMessage(LANG_WAYPOINT_VP_NOTCREATED, id);
                    delete wpCreature;
                    return false;
                }
                ...
                if (target) {
                    ...
                    wpCreature->SetLevel(
                        point > STRONG_MAX_LEVEL ? STRONG_MAX_LEVEL : point);
                }
            } while (result->NextRow());
        ...
        if (show == "first") {
            ...
            if (!creature->LoadCreatureFromDB(
                    creature->GetSpawnId(), map, true, true)) {
                handler->PSendSysMessage(LANG_WAYPOINT_VP_NOTCREATED, id);
                delete creature;
                return false;
            }
        ...
        if (show == "off") {
            WorldDatabasePreparedStatement* stmt =
                WorldDatabase.GetPreparedStatement(WORLD_SEL_CREATURE_BY_ID);
            ...
            do {
                ...
                Creature*           creature =
                    handler->GetSession()->GetPlayer()->GetMap()->GetCreature(
                        ObjectGuid::Create<HighGuid::Unit>(VISUAL_WAYPOINT,
                                                           guid));
                if (!creature) {
...
void AddSC_wp_commandscript() { new wp_commandscript(); }
