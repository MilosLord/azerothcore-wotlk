...
public:
    instance_sunwell_plateau()
        : InstanceMapScript("instance_sunwell_plateau", 580)
    {
    }
    ...
    struct instance_sunwell_plateau_InstanceMapScript : public InstanceScript {
        ...
        Player const* GetPlayerInMap() const
        {
            ...
            // else
            //     LOG_DEBUG("scripts", "Instance Sunwell Plateau:
            //     GetPlayerInMap, but PlayerList is empty!");
        ...
        void OnCreatureCreate(Creature* creature) override
        {
            ...
            case NPC_SINISTER_REFLECTION:
                if (Creature* kiljaedenC =
                        instance->GetCreature(KilJaedenControllerGUID))
    ...
    class spell_cataclysm_breath_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            AfterCast += SpellCastFn(
                spell_cataclysm_breath_SpellScript::HandleAfterCast);
        }
    };
