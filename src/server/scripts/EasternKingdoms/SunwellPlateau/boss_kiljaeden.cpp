...
public:
    ...
    bool Execute(uint64 /*execTime*/, uint32 /*diff*/) override
    {
        ...
        _caster->SetPosition(_caster->GetPositionX(),
                             _caster->GetPositionY(),
                             _caster->GetPositionZ() - 20.0f,
                             0.0f);
        return true;
    }
...
public:
    ...
    struct npc_kiljaeden_controllerAI : public NullCreatureAI {
        ...
        {
            for (uint8 i = 0; i < 4; ++i)
                if (GameObject* orb = ObjectAccessor::GetGameObject(
                        *me,
                        instance->GetGuidData(
                            DATA_ORB_OF_THE_BLUE_DRAGONFLIGHT_1 + i)))
        ...
        void SummonedCreatureDies(Creature* summon, Unit*) override
        {
            ...
            if (summon->GetEntry() == NPC_HAND_OF_THE_DECEIVER) {
                ...
                if (!summons.HasEntry(NPC_HAND_OF_THE_DECEIVER)) {
                    ...
                    me->SummonCreature(NPC_KILJAEDEN,
                                       me->GetPositionX(),
                                       me->GetPositionY(),
                                       me->GetPositionZ() + 1.5f,
                                       4.3f,
                                       TEMPSUMMON_MANUAL_DESPAWN);
                    me->SummonCreature(NPC_KALECGOS_KJ,
                                       1726.80f,
                                       661.43f,
                                       138.65f,
                                       3.95f,
    ...
    struct boss_kiljaedenAI : public ScriptedAI {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (Creature* controller = ObjectAccessor::GetCreature(
                    *me, instance->GetGuidData(NPC_KILJAEDEN_CONTROLLER)))
        ...
        void KilledUnit(Unit* victim) override
        {
            if (victim->GetTypeId() == TYPEID_PLAYER &&
                events.GetNextEventTime(EVENT_NO_KILL_TALK) == 0)
                Talk(SAY_KJ_SLAY);
        }

        void JustEngagedWith(Unit* /*who*/) override
        {
            events2.ScheduleEvent(
                EVENT_TEXT_SPEACH11, 26000, EVENT_GROUP_SPEACH);
            Talk(SAY_KJ_EMERGE);
        ...
        void JustSummoned(Creature* summon) override
        {
            if (summon->GetEntry() == NPC_ARMAGEDDON_TARGET) {
                ...
                summon->SetPosition(summon->GetPositionX(),
                                    summon->GetPositionY(),
                                    summon->GetPositionZ() + 20.0f,
                                    0.0f);
                summon->m_Events.AddEvent(new CastArmageddon(summon),
                                          summon->m_Events.CalculateTime(6000));
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_EMPOWER_ORBS1:
                if (Creature* kalec = ObjectAccessor::GetCreature(
                        *me, instance->GetGuidData(NPC_KALECGOS_KJ)))
            ...
            case EVENT_TEXT_SPEACH22:
                if (Creature* anveena = ObjectAccessor::GetCreature(
                        *me, instance->GetGuidData(NPC_ANVEENA)))
                    sCreatureTextMgr->SendChat(anveena,
            ...
            case EVENT_TEXT_SPEACH46:
                if (Creature* anveena = ObjectAccessor::GetCreature(
                        *me, instance->GetGuidData(NPC_ANVEENA))) {
                    anveena->CastSpell(
                        anveena, SPELL_SACRIFICE_OF_ANVEENA, true);
            ...
            case EVENT_CHECK_HEALTH85:
                if (me->HealthBelowPct(85)) {
                    ...
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH21, 16000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH22, 22000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH23, 28000, EVENT_GROUP_SPEACH);
                    ...
                    events.RescheduleEvent(EVENT_SPELL_DARKNESS,
                                           16000); // will be delayed by 29 secs
                    break;
                }
            ...
            case EVENT_CHECK_HEALTH55:
                if (me->HealthBelowPct(55)) {
                    ...
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH31, 16000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH32, 22000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH33, 28000, EVENT_GROUP_SPEACH);
                    ...
                    events.ScheduleEvent(EVENT_SPELL_SHADOW_SPIKE, 1200);
                    events.RescheduleEvent(EVENT_SPELL_DARKNESS,
                                           15000); // will be delayed by 29 secs
            ...
            case EVENT_CHECK_HEALTH25:
                if (me->HealthBelowPct(25)) {
                    ...
                    events2.CancelEventGroup(EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH41, 8000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH42, 18000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH43, 20200, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH44, 25000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH45, 28000, EVENT_GROUP_SPEACH);
                    events2.ScheduleEvent(
                        EVENT_TEXT_SPEACH46, 30000, EVENT_GROUP_SPEACH);
            ...
            case EVENT_SPELL_LEGION_LIGHTNING:
                ...
                events.ScheduleEvent(EVENT_SPELL_LEGION_LIGHTNING,
                                     phase == PHASE_SACRIFICE ? 15000 : 30000);
                events.RescheduleEvent(EVENT_SPELL_SOUL_FLAY, 2000);
                break;
            case EVENT_SPELL_FIRE_BLOOM:
                me->CastCustomSpell(SPELL_FIRE_BLOOM,
                                    SPELLVALUE_MAX_TARGETS,
                                    5,
                                    me,
                                    TRIGGERED_NONE);
                me->SetTarget(me->GetVictim()->GetGUID());
                events.ScheduleEvent(EVENT_SPELL_FIRE_BLOOM,
                                     phase == PHASE_SACRIFICE ? 20000 : 40000);
                events.RescheduleEvent(EVENT_SPELL_SOUL_FLAY, 1500);
                break;
            case EVENT_SUMMON_ORBS:
                for (uint8 i = 1; i < phase; ++i) {
                    float x = me->GetPositionX() +
                              18.0f * cos((i * 2.0f - 1.0f) * M_PI / 3.0f);
                    float y = me->GetPositionY() +
                              18.0f * std::sin((i * 2.0f - 1.0f) * M_PI / 3.0f);
                    if (Creature* orb =
                            me->SummonCreature(NPC_SHIELD_ORB,
                                               x,
                                               y,
                                               40.0f,
                                               0,
            ...
            case EVENT_SPELL_SINISTER_REFLECTION:
                ...
                me->CastCustomSpell(SPELL_SINISTER_REFLECTION,
                                    SPELLVALUE_MAX_TARGETS,
                                    1,
                                    me,
                                    TRIGGERED_NONE);
            ...
            case EVENT_SPELL_DARKNESS:
                ...
                events.ScheduleEvent(EVENT_SPELL_DARKNESS,
                                     phase == PHASE_SACRIFICE ? 20000 : 45000);
                events.DelayEvents(8000);
                break;
            case EVENT_SPELL_ARMAGEDDON:
                me->CastSpell(me, SPELL_ARMAGEDDON_PERIODIC, true);
                events.ScheduleEvent(EVENT_SPELL_ARMAGEDDON,
                                     phase == PHASE_SACRIFICE ? 20000 : 40000);
                break;
            }
            ...
            for (uint8 i = 0; i < 4; ++i) {
                if (GameObject* orb = ObjectAccessor::GetGameObject(
                    ...
                    if (orb->HasGameObjectFlag(GO_FLAG_NOT_SELECTABLE)) {
                        ...
                        if (Creature* trigger = me->SummonTrigger(
                                orb->GetPositionX(),
                                orb->GetPositionY(),
                                orb->GetPositionZ(),
                                0,
...
public:
    MoveDelayed(Creature* owner, float x, float y, float z, float o)
        : _owner(owner), _x(x), _y(y), _z(z), _o(o)
    {
    }
...
public:
    ...
    bool Execute(uint64 /*execTime*/, uint32 /*diff*/) override
    {
        ...
        _owner->GetCreaturesWithEntryInRange(
            cList, 20.0f, NPC_SHATTERED_SUN_SOLDIER);
...
public:
    ...
    struct npc_kalecgos_kjAI : public NullCreatureAI {
        npc_kalecgos_kjAI(Creature* creature)
            : NullCreatureAI(creature), summons(me)
        {
            instance = creature->GetInstanceScript();
        }
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            if (summon->GetEntry() == NPC_SHATTERED_SUN_RIFTWAKER) {
                ...
                if (Creature* riftwaker = summon->FindNearestCreature(
                        NPC_SHATTERED_SUN_RIFTWAKER, 10.0f))
                    riftwaker->CastSpell(
                        summon, SPELL_OPEN_PORTAL_FROM_SHATTRATH, false);
                summon->SetWalk(true);
                ...
                summon->GetMotionMaster()->MovePoint(
                    0, 1710.15f, 639.23f, 27.311f, false, true);
            }
            else if (summon->GetEntry() == NPC_THE_CORE_OF_ENTROPIUS)
                summon->GetMotionMaster()->MovePoint(
                    0, summon->GetPositionX(), summon->GetPositionY(), 30.0f);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SCENE_01:
                ...
                break;
            case EVENT_SCENE_02:
                me->SummonCreature(NPC_SHATTERED_SUN_RIFTWAKER,
                                   1688.42f,
                                   641.82f,
                                   27.60f,
                                   0.67f);
                ...
                break;
            case EVENT_SCENE_03:
                me->SummonCreature(NPC_SHATTRATH_PORTAL_DUMMY,
                                   1727.08f + cos(5.14f),
                                   656.82f + std::sin(5.14f),
                                   28.37f + 2.0f,
                                   0.0f,
            ...
            case EVENT_SCENE_04:
                me->SummonCreature(
                    NPC_INERT_PORTAL, 1734.96f, 642.43f, 28.06f, 3.49f);
            ...
            case EVENT_SCENE_05:
                if (Creature* first =
                        me->SummonCreature(NPC_SHATTERED_SUN_SOLDIER,
                                           ...
                                           28.06f,
                                           3.49f)) {
                    first->m_Events.AddEvent(
                        new MoveDelayed(
                            first, 1718.70f, 607.78f, 28.06f, 2.323f),
                        first->m_Events.CalculateTime(5000));
                    first->m_Events.AddEvent(
                        new FixOrientation(first),
                        first->m_Events.CalculateTime(12000));
                    for (uint8 i = 0; i < 9; ++i)
                        if (Creature* follower = me->SummonCreature(
                                NPC_SHATTERED_SUN_SOLDIER,
                                1729.48f + 5 * cos(i * 2.0f * M_PI / 9),
                                640.49f + 5 * std::sin(i * 2.0f * M_PI / 9),
                                28.06f,
                                3.49f))
                            follower->GetMotionMaster()->MoveFollow(
                                first, 3.0f, follower->GetAngle(first));
                }
            ...
            case EVENT_SCENE_06:
                if (Creature* first =
                    ...
                    first->m_Events.AddEvent(
                        new MoveDelayed(
                            first, 1678.69f, 649.27f, 28.06f, 5.46f),
                        first->m_Events.CalculateTime(5000));
                    first->m_Events.AddEvent(
                        new FixOrientation(first),
                        first->m_Events.CalculateTime(14500));
                    for (uint8 i = 0; i < 9; ++i)
                        if (Creature* follower = me->SummonCreature(
                                NPC_SHATTERED_SUN_SOLDIER,
                                1729.48f + 5 * cos(i * 2.0f * M_PI / 9),
            ...
            case EVENT_SCENE_07:
                me->SummonCreature(
                    NPC_LADY_LIADRIN, 1719.87f, 644.265f, 28.06f, 3.83f);
                me->SummonCreature(
                    NPC_PROPHET_VELEN, 1717.97f, 646.44f, 28.06f, 3.94f);
                events.ScheduleEvent(eventId + 1, 7000);
                break;
            case EVENT_SCENE_08:
                if (Creature* velen =
                        summons.GetCreatureWithEntry(NPC_PROPHET_VELEN))
            ...
            case EVENT_SCENE_11:
                me->SummonCreature(
                    NPC_THE_CORE_OF_ENTROPIUS, 1698.86f, 628.73f, 92.83f, 0.0f);
                if (Creature* velen =
                        summons.GetCreatureWithEntry(NPC_PROPHET_VELEN))
            ...
            case EVENT_SCENE_13:
                if (Creature* liadrin =
                        summons.GetCreatureWithEntry(NPC_LADY_LIADRIN))
                    liadrin->GetMotionMaster()->MovePoint(
                        0, 1711.28f, 637.29f, 27.29f);
                events.ScheduleEvent(eventId + 1, 6000);
                break;
            case EVENT_SCENE_14:
                if (Creature* liadrin =
            ...
            case EVENT_SCENE_17:
                ...
                break;
            case EVENT_SCENE_18:
                if (Creature* core = summons.GetCreatureWithEntry(
            ...
            case EVENT_SCENE_19:
                if (Creature* core = summons.GetCreatureWithEntry(
                    ...
                    core->GetMotionMaster()->MovePoint(
                        0, core->GetPositionX(), core->GetPositionY(), 28.0f);
                }
                events.ScheduleEvent(eventId + 1, 2000);
                break;
            case EVENT_SCENE_20:
                if (Creature* core =
                        summons.GetCreatureWithEntry(NPC_THE_CORE_OF_ENTROPIUS))
            ...
            case EVENT_SCENE_25:
                if (Creature* velen =
                        summons.GetCreatureWithEntry(NPC_PROPHET_VELEN)) {
                    velen->GetMotionMaster()->MovePoint(
                        0, 1739.38f, 643.79f, 28.06f);
                    ...
                    if (Creature* summon =
                        ...
                        if (summon->GetEntry() == NPC_SHATTERED_SUN_SOLDIER) {
                            ...
                            summon->DespawnOrUnsummon(
                                summon->GetExactDist2d(1734.96f, 642.43f) *
                                100);
                        }
                events.ScheduleEvent(eventId + 1, 7000);
                break;
...
public:
    spell_kiljaeden_shadow_spike()
        : SpellScriptLoader("spell_kiljaeden_shadow_spike")
    {
    }
    ...
    class spell_kiljaeden_shadow_spike_AuraScript : public AuraScript {
        ...
        void HandlePeriodic(AuraEffect const* aurEff)
        {
            ...
            if (Unit* target = GetUnitOwner()->GetAI()->SelectTarget(
                    SelectTargetMethod::Random, 0, 60.0f, true))
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_kiljaeden_shadow_spike_AuraScript::HandlePeriodic,
                EFFECT_0,
...
public:
    spell_kiljaeden_sinister_reflection()
        : SpellScriptLoader("spell_kiljaeden_sinister_reflection")
    {
    }
    ...
    class spell_kiljaeden_sinister_reflection_SpellScript : public SpellScript {
        ...
        {
            targets.remove_if(
                Acore::UnitAuraCheck(true, SPELL_VENGEANCE_OF_THE_BLUE_FLIGHT));
        }
        ...
        void HandleScriptEffect(SpellEffIndex effIndex)
        {
            ...
            if (Unit* target = GetHitUnit()) {
                target->CastSpell(
                    target, SPELL_SINISTER_REFLECTION_SUMMON, true);
                // target->CastSpell(target, SPELL_SINISTER_REFLECTION_CLONE,
                // true);
            }
        }
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_kiljaeden_sinister_reflection_SpellScript::FilterTargets,
                EFFECT_0,
                TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget +=
                SpellEffectFn(spell_kiljaeden_sinister_reflection_SpellScript::
                                  HandleScriptEffect,
                              EFFECT_0,
...
public:
    spell_kiljaeden_sinister_reflection_clone()
        : SpellScriptLoader("spell_kiljaeden_sinister_reflection_clone")
    {
    }

    class spell_kiljaeden_sinister_reflection_clone_SpellScript
        : public SpellScript {
        PrepareSpellScript(
...
public:
    spell_kiljaeden_flame_dart()
        : SpellScriptLoader("spell_kiljaeden_flame_dart")
    {
    }
    ...
    class spell_kiljaeden_flame_dart_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_kiljaeden_flame_dart_SpellScript::HandleSchoolDamage,
                EFFECT_0,
    ...
    class spell_kiljaeden_darkness_AuraScript : public AuraScript {
                          ...
                          AuraEffectHandleModes /*mode*/)
        {
            if (GetUnitOwner()->GetTypeId() == TYPEID_UNIT)
                GetUnitOwner()->ToCreature()->AI()->DoAction(
                    ACTION_NO_KILL_TALK);
        ...
        void Register() override
        {
            OnEffectRemove += AuraEffectRemoveFn(
                spell_kiljaeden_darkness_AuraScript::HandleRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
...
public:
    spell_kiljaeden_power_of_the_blue_flight()
        : SpellScriptLoader("spell_kiljaeden_power_of_the_blue_flight")
    {
    }

    class spell_kiljaeden_power_of_the_blue_flight_SpellScript
        : public SpellScript {
        PrepareSpellScript(
            spell_kiljaeden_power_of_the_blue_flight_SpellScript);
        ...
        void HandleScriptEffect(SpellEffIndex effIndex)
        {
            ...
            if (Player* player = GetHitPlayer()) {
                ...
                player->CastSpell(
                    player, SPELL_VENGEANCE_OF_THE_BLUE_FLIGHT, true);
            }
        }
...
public:
    spell_kiljaeden_vengeance_of_the_blue_flight()
        : SpellScriptLoader("spell_kiljaeden_vengeance_of_the_blue_flight")
    {
    }

    class spell_kiljaeden_vengeance_of_the_blue_flight_AuraScript
        : public AuraScript {
        PrepareAuraScript(
        ...
        {
            GetUnitOwner()->CastSpell(
                GetUnitOwner(), SPELL_POSSESS_DRAKE_IMMUNITY, true);
        }
...
public:
    spell_kiljaeden_armageddon_periodic()
        : SpellScriptLoader("spell_kiljaeden_armageddon_periodic")
    {
    }
    ...
    class spell_kiljaeden_armageddon_periodic_AuraScript : public AuraScript {
        ...
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_kiljaeden_armageddon_periodic_AuraScript::HandlePeriodic,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    spell_kiljaeden_armageddon_missile()
        : SpellScriptLoader("spell_kiljaeden_armageddon_missile")
    {
    }
    ...
    class spell_kiljaeden_armageddon_missile_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
                spell_kiljaeden_armageddon_missile_SpellScript::SetDest,
                EFFECT_0,
                TARGET_DEST_CASTER);
        }
    };
...
public:
    spell_kiljaeden_dragon_breath()
        : SpellScriptLoader("spell_kiljaeden_dragon_breath")
    {
    }
    ...
    class spell_kiljaeden_dragon_breath_SpellScript : public SpellScript {
        ...
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_kiljaeden_dragon_breath_SpellScript::FilterTargets,
                EFFECT_ALL,
