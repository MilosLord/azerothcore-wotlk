...
struct boss_felblood_kaelthas : public ScriptedAI {
    ...
    {
        if (!introSpeak && me->IsWithinDistInMap(who, 40.0f) &&
        ...
        for (Map::PlayerList::const_iterator itr = playerList.begin();
            ...
            if (Player* player = itr->GetSource()) {
                if (action == ACTION_TELEPORT_PLAYERS)
                    me->CastSpell(
                        player, SPELL_GRAVITY_LAPSE_PLAYER + counter, true);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        case EVENT_SPELL_FIREBALL:
            me->CastSpell(me->GetVictim(),
                          DUNGEON_MODE(SPELL_FIREBALL_N, SPELL_FIREBALL_H),
                          false);
        ...
        case EVENT_SPELL_SHOCK_BARRIER:
            ...
            me->CastCustomSpell(SPELL_PYROBLAST,
        ...
        case EVENT_GRAVITY_LAPSE_1_2:
            Talk(eventId == EVENT_GRAVITY_LAPSE_1_1 ? SAY_GRAVITY_LAPSE
                                                    : SAY_RECAST_GRAVITY);
