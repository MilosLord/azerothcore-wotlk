...
enum Misc { NPC_PURE_ENERGY = 24745 };
...
struct boss_vexallus : public BossAI {
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        ScheduleTimedEvent(
            8s,
            [&] {
                DoCastRandomTarget(DUNGEON_MODE(SPELL_CHAIN_LIGHTNING_N,
        ...
        ScheduleTimedEvent(
            ...
            [&] {
                DoCastRandomTarget(
                    DUNGEON_MODE(SPELL_ARCANE_SHOCK_N, SPELL_ARCANE_SHOCK_H));
            },
            8s,
            8s);
    }
    ...
    void SummonedCreatureDies(Creature* summon, Unit* killer) override
    {
        ...
        if (killer)
            killer->CastSpell(
                killer, SPELL_ENERGY_FEEDBACK, true, 0, 0, summon->GetGUID());
    }
};
