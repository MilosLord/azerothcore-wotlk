...
enum KarazhanSpells {
    ...
    SPELL_HAND_OF_MEDIVH =
        39339, // 1st cheat: AOE spell burn cell under enemy chesspieces.
...
enum KarazhanChessGamePhase {
    ...
    CHESS_PHASE_PVE_WARMUP =
        1, // Medivh has been spoken too but king isn't controlled yet
...
#define RegisterKarazhanCreatureAI(ai_name)                                    \
    RegisterCreatureAIWithFactory(ai_name, GetKarazhanAI)
