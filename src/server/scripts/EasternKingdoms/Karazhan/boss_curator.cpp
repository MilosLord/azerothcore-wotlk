        ...
        scheduler
            ...
            .Schedule(6s, [this](TaskContext context) {
                if (me->HealthAbovePct(15)) {
                    ...
                    DoCastSelf(RAND(SPELL_SUMMON_ASTRAL_FLARE1,
                                    SPELL_SUMMON_ASTRAL_FLARE2,
                                    SPELL_SUMMON_ASTRAL_FLARE3,
                                    SPELL_SUMMON_ASTRAL_FLARE4));
...
void AddSC_boss_curator() { RegisterKarazhanCreatureAI(boss_curator); }
