...
public:
                       ...
                       const Quest* quest) override
    {
        if (quest->GetQuestId() == QUEST_TOME_VALOR) {
            ...
            if (npc_escortAI* pEscortAI = CAST_AI(
                    npc_daphne_stilwell::npc_daphne_stilwellAI, creature->AI()))
    ...
    struct npc_daphne_stilwellAI : public npc_escortAI {
        npc_daphne_stilwellAI(Creature* creature)
        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            case 4:
                SetEquipmentSlots(
                    false, EQUIP_NO_CHANGE, EQUIP_NO_CHANGE, EQUIP_ID_RIFLE);
...
void AddSC_westfall() { new npc_daphne_stilwell(); }
