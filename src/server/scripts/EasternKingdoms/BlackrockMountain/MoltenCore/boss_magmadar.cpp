...
enum Spells {
    ...
    SPELL_PANIC      = 19408,
    SPELL_LAVA_BOMB  = 19411, // This calls a dummy server side effect that cast
                              // spell 20494 to spawn GO 177704 for 30s
    SPELL_LAVA_BOMB_EFFECT =
        20494, // Spawns trap GO 177704 which triggers 19428
    SPELL_LAVA_BOMB_RANGED =
        20474, // This calls a dummy server side effect that cast spell 20495 to
               // spawn GO 177704 for 60s
    SPELL_LAVA_BOMB_RANGED_EFFECT =
        20495, // Spawns trap GO 177704 which triggers 19428
};
    ...
    class spell_magmadar_lava_bomb_SpellScript : public SpellScript {
        ...
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo(
                {SPELL_LAVA_BOMB_EFFECT, SPELL_LAVA_BOMB_RANGED_EFFECT});
        }
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_magmadar_lava_bomb_SpellScript::HandleDummy,
                              EFFECT_0,
                              SPELL_EFFECT_DUMMY);
        }
    };
