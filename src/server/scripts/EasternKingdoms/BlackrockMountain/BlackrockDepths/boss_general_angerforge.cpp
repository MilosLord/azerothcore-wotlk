...
public:
    ...
    struct boss_general_angerforgeAI : public ScriptedAI {
        ...
        {
            if (Creature* SummonedAdd =
                    DoSpawnCreature(8901,
                                    float(irand(-14, 14)),
                                    float(irand(-14, 14)),
                                    0,
                                    0,
        ...
        {
            if (Creature* SummonedMedic =
                    DoSpawnCreature(8894,
                                    float(irand(-9, 9)),
                                    float(irand(-9, 9)),
                                    0,
                                    0,
...
void AddSC_boss_general_angerforge() { new boss_general_angerforge(); }
