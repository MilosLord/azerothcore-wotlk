...
enum Gossip {
    ...
    GOSSIP_GROOMREL = 1945, // Option 1 : Before quest(4083) accepted, option 0
                            // after quest(4083) accepted
    GOSSIP_DOOMREL_START_COMBAT =
        1947, // Your bondage is at an end, Doom'rel.  I challenge you!
    SAY_DOOMREL_HELLO =
        2601, // Our fate is the doom of all who face the Great Fire.
    SAY_QUEST_ACCEPTED = 2604, // You wish to learn the old craft?  You wish to
                               // smelt dark iron?$B$BAppease me, $r.  Show me a
                               // sacrifice and I will consider it!
    SAY_QUEST_COMPLETED = 2605, // Your will is strong, and your intent is
                                // clear.$B$BPerhaps you are worthy...
    SAY_QUEST_COMPLETED_END =
        2606, // You have shown me your desire, and have payed with precious
              // stone.  I will teach you...
};
...
public:
                        ...
                        uint32 action) override
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 1:
            ...
            SendGossipMenuFor(
                player, SAY_QUEST_COMPLETED_END, creature->GetGUID());
            break;
        ...
        case GOSSIP_ACTION_INFO_DEF + 22:
            ...
            if (InstanceScript* instance = creature->GetInstanceScript()) {
                // are 5 minutes expected? go template may have data to despawn
                // when used at quest
                instance->DoRespawnGameObject(
                    instance->GetGuidData(DATA_GO_CHALICE), MINUTE * 5);
            }
            break;
        }
        return true;
    ...
    {
        if (player->GetQuestRewardStatus(QUEST_SPECTRAL_CHALICE) == 1 &&
            player->GetSkillValue(SKILL_MINING) >= DATA_SKILLPOINT_MIN &&
            !player->HasSpell(SPELL_SMELT_DARK_IRON)) {
            AddGossipItemFor(player,
                             GOSSIP_GROOMREL,
                             0,
                             GOSSIP_SENDER_MAIN,
        ...
        if (player->GetQuestRewardStatus(QUEST_SPECTRAL_CHALICE) == 0 &&
            player->GetSkillValue(SKILL_MINING) >= DATA_SKILLPOINT_MIN)
            AddGossipItemFor(player,
                             GOSSIP_GROOMREL,
                             1,
...
public:
    ...
    struct boss_doomrelAI : public ScriptedAI {
        ...
        void Reset() override
        {
            ...
            if (instance->GetData(TYPE_TOMB_OF_SEVEN) ==
                DONE) // what is this trying to do? Probably some kind of crash
                      // recovery
            {
