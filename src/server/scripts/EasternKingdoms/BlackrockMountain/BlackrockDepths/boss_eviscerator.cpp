...
public:
    ...
    struct boss_evisceratorAI : public BossAI {
        boss_evisceratorAI(Creature* creature)
            : BossAI(creature, DATA_EVISCERATOR)
        {
        }
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(SPELL_SHADOWBOLT_VOLLEY,
                                 0.2 * (int)TIMER_SHADOWBOLT_VOLLEY);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                ...
                case SPELL_SHADOWBOLT_VOLLEY:
                    ...
                    events.ScheduleEvent(SPELL_SHADOWBOLT_VOLLEY,
                                         urand(TIMER_SHADOWBOLT_VOLLEY - 2000,
                                               TIMER_SHADOWBOLT_VOLLEY + 2000));
                    break;
                case SPELL_REND:
                    DoCastVictim(SPELL_REND);
                    events.ScheduleEvent(
                        SPELL_REND,
                        urand(TIMER_REND - 2000, TIMER_REND + 2000));
                    break;
                case SPELL_SHIELD:
...
void AddSC_boss_eviscerator() { new boss_eviscerator(); }
