...
public:
    ...
    struct boss_hedrumAI : public BossAI {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(SPELL_WEB_EXPLOSION,
                                 0.2 * (int)TIMER_WEB_EXPLOSION);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                ...
                case SPELL_PARALYZING:
                    ...
                    events.ScheduleEvent(SPELL_PARALYZING,
                                         urand(TIMER_PARALYZING - 2000,
                                               TIMER_PARALYZING + 2000));
                    break;
                case SPELL_BANEFUL:
                    DoCastVictim(SPELL_BANEFUL);
                    events.ScheduleEvent(
                        SPELL_BANEFUL,
                        urand(TIMER_BANEFUL - 2000, TIMER_BANEFUL + 2000));
                    break;
                case SPELL_WEB_EXPLOSION:
                    ...
                    events.ScheduleEvent(SPELL_WEB_EXPLOSION,
                                         urand(TIMER_WEB_EXPLOSION - 2000,
                                               TIMER_WEB_EXPLOSION + 2000));
                    break;
                default:
                    break;
                }
...
void AddSC_boss_hedrum() { new boss_hedrum(); }
