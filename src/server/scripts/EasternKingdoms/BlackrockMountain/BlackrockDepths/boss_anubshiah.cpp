...
public:
    ...
    struct boss_anubshiahAI : public BossAI {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(SPELL_CURSE_TONGUES,
                                 0.2 * (int)TIMER_CURSE_TONGUES);
            events.ScheduleEvent(SPELL_CURSE_WEAKNESS,
                                 0.2 * (int)TIMER_CURSE_WEAKNESS);
            events.ScheduleEvent(SPELL_DEMON_ARMOR,
                                 0.2 * (int)TIMER_DEMON_ARMOR);
            events.ScheduleEvent(SPELL_ENVELOPING_WEB,
                                 0.2 * (int)TIMER_ENVELOPING_WEB);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                ...
                case SPELL_SHADOWBOLT:
                    ...
                    events.ScheduleEvent(SPELL_SHADOWBOLT,
                                         urand(TIMER_SHADOWBOLT - 2000,
                                               TIMER_SHADOWBOLT + 2000));
                    break;
                case SPELL_CURSE_TONGUES:
                    ...
                    events.ScheduleEvent(SPELL_CURSE_TONGUES,
                                         urand(TIMER_CURSE_TONGUES - 2000,
                                               TIMER_CURSE_TONGUES + 2000));
                    break;
                case SPELL_CURSE_WEAKNESS:
                    ...
                    events.ScheduleEvent(SPELL_CURSE_WEAKNESS,
                                         urand(TIMER_CURSE_WEAKNESS - 2000,
                                               TIMER_CURSE_WEAKNESS + 2000));
                    break;
                ...
                case SPELL_ENVELOPING_WEB:
                    ...
                    events.ScheduleEvent(SPELL_ENVELOPING_WEB,
                                         urand(TIMER_ENVELOPING_WEB - 2000,
                                               TIMER_ENVELOPING_WEB + 2000));
                    break;
                default:
                    break;
                }
...
void AddSC_boss_anubshiah() { new boss_anubshiah(); }
