...
enum Says { TALK_SUMMON = 0, TALK_AGGRO = 1, TALK_40_HP = 2, TALK_15_HP = 3 };
...
enum EventPhase { EVENT_PHASE_TALK = 1, EVENT_PHASE_FIGHT = 2 };
...
public:
    ...
    struct boss_lord_valthalakAI : public BossAI {
        boss_lord_valthalakAI(Creature* creature)
            : BossAI(creature, DATA_LORD_VALTHALAK)
        {
        }
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(
                EVENT_SUMMON_SPECTRAL_ASSASSIN, 6s, 8s, 0, EVENT_PHASE_FIGHT);
            events.ScheduleEvent(
                EVENT_SHADOW_WRATH, 9s, 18s, 0, EVENT_PHASE_FIGHT);
        }
                         ...
                         SpellSchoolMask /*school*/) override
        {
            ...
            if (!frenzy15 && me->HealthBelowPctDamaged(15, damage)) {
                ...
                events.ScheduleEvent(
                    EVENT_SHADOW_BOLT_VOLLEY, 12s, 19s, 0, EVENT_PHASE_FIGHT);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                ...
                case EVENT_SUMMON_SPECTRAL_ASSASSIN:
                    ...
                    events.ScheduleEvent(EVENT_SUMMON_SPECTRAL_ASSASSIN,
                                         30s,
                                         35s,
                                         0,
                                         EVENT_PHASE_FIGHT);
                ...
                case EVENT_SHADOW_BOLT_VOLLEY:
                    ...
                    events.ScheduleEvent(
                        EVENT_SHADOW_BOLT_VOLLEY, 4s, 6s, 0, EVENT_PHASE_FIGHT);
                    break;
                case EVENT_SHADOW_WRATH:
                    DoCastVictim(SPELL_SHADOW_WRATH);
                    events.ScheduleEvent(
                        EVENT_SHADOW_WRATH, 19s, 24s, 0, EVENT_PHASE_FIGHT);
                    break;
                default:
                    break;
                }
...
void AddSC_boss_lord_valthalak() { new boss_lord_valthalak(); }
