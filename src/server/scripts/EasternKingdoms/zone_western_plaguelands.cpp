...
SD%Complete: 90
SDComment: Quest support: 5097, 5098, 5216, 5219, 5222, 5225, 5229, 5231, 5233,
5235. To obtain Vitreous Focuser (could use more spesifics about gossip items)
    ...
    struct npc_the_scourge_cauldronAI : public ScriptedAI {
        ...
        void DoDie()
        {
            ...
            Unit::DealDamage(me,
                             ...
                             nullptr,
                             false);
            // override any database `spawntimesecs` to prevent duplicated
            // summons
...
enum AndorhalTower { GO_BEACON_TORCH = 176093 };
