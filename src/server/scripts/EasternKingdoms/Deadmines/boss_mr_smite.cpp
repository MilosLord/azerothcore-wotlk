...
public:
    ...
    struct boss_mr_smiteAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_CHECK_HEALTH1:
                if (me->HealthBelowPct(67) && !health67) {
                    ...
                    me->GetMotionMaster()->MovePoint(
                        EQUIP_TWO_SWORDS, 1.859f, -780.72f, 9.831f);
                    Talk(SAY_SWAP1);
            ...
            case EVENT_CHECK_HEALTH2:
                if (me->HealthBelowPct(34) && !health34) {
                    ...
                    me->GetMotionMaster()->Clear();
                    me->GetMotionMaster()->MovePoint(
                        EQUIP_MACE, 1.859f, -780.72f, 9.831f);
                    Talk(SAY_SWAP2);
                    me->SetUnitFlag(UNIT_FLAG_PACIFIED);
                    me->SetReactState(REACT_PASSIVE);
                    health34 = true;
        ...
        void MovementInform(uint32 type, uint32 point) override
        {
            ...
            me->SetStandState(UNIT_STAND_STATE_KNEEL);
            events.ScheduleEvent(point == EQUIP_TWO_SWORDS ? EVENT_SWAP_WEAPON1
                                                           : EVENT_SWAP_WEAPON2,
                                 1500ms);
...
void AddSC_boss_mr_smite() { new boss_mr_smite(); }
