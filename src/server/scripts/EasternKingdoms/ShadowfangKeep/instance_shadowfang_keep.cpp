...
public:
    instance_shadowfang_keep()
        : InstanceMapScript("instance_shadowfang_keep", 33)
    {
    }
    ...
    struct instance_shadowfang_keep_InstanceMapScript : public InstanceScript {
        ...
        void OnCreatureCreate(Creature* creature) override
        {
            ...
            case NPC_CRAZED_APOTHECARY:
                if (Creature* hummel =
                        instance->GetCreature(_apothecaryHummel)) {
...
public:
    spell_shadowfang_keep_haunting_spirits()
        : SpellScriptLoader("spell_shadowfang_keep_haunting_spirits")
    {
    }

    class spell_shadowfang_keep_haunting_spirits_AuraScript
        : public AuraScript {
...
public:
    spell_shadowfang_keep_forsaken_skills()
        : SpellScriptLoader("spell_shadowfang_keep_forsaken_skills")
    {
    }
    ...
    class spell_shadowfang_keep_forsaken_skills_AuraScript : public AuraScript {
        ...
        {
            _forsakenSpell =
                urand(SPELL_FORSAKEN_SKILL_SWORD, SPELL_FORSAKEN_SKILL_SHADOW);
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_shadowfang_keep_forsaken_skills_AuraScript::OnApply,
                EFFECT_0,
                SPELL_AURA_PERIODIC_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_shadowfang_keep_forsaken_skills_AuraScript::
                    HandleDummyTick,
                EFFECT_0,
                SPELL_AURA_PERIODIC_DUMMY);
        }
