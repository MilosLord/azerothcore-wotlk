...
enum DataTypes {
    ...
    DATA_EDGE_OF_MADNESS = 9,  // Optional Event Edge of Madness - one of:
                               // Gri'lek, Renataki, Hazza'rah, or Wushoolay
...
enum SpellIds { SPELL_HAKKAR_POWER = 24692, SPELL_HAKKAR_POWER_DOWN = 24693 };
...
#define RegisterZulGurubCreatureAI(ai_name)                                    \
    RegisterCreatureAIWithFactory(ai_name, GetZulGurubAI)
