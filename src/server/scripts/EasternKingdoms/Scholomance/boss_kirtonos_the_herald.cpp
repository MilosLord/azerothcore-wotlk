...
Position const PosMove[2] = {{299.4884f, 92.76137f, 105.6335f, 0.0f},
    ...
    struct boss_kirtonos_the_heraldAI : public ScriptedAI {
        ...
        void DoAction(int32 action) override
        {
            if (action == IN_PROGRESS) {
                ...
                me->SetImmuneToAll(
                    true); // for some reason he aggroes if we don't have this.
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_DOMINATE_MIND:
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 1, 20.0f, true)) {
...
void AddSC_boss_kirtonos_the_herald() { new boss_kirtonos_the_herald(); }
