    ...
    struct instance_uldaman_InstanceMapScript : public InstanceScript {
        ...
        void SetData(uint32 type, uint32 data) override
        {
            ...
            case DATA_ARCHAEDAS:
                ...
                HandleGameObject(
                    archaedasTempleDoorGUID, data != IN_PROGRESS, nullptr);
                break;
            }
...
public:
    spell_uldaman_sub_boss_agro_keepers()
        : SpellScriptLoader("spell_uldaman_sub_boss_agro_keepers")
    {
    }
    ...
    class spell_uldaman_sub_boss_agro_keepers_SpellScript : public SpellScript {
        ...
        {
            if (Creature* keeper = GetCaster()->FindNearestCreature(
                    NPC_STONE_KEEPER, 100.0f, true))
        ...
        {
            OnEffectLaunch +=
                SpellEffectFn(spell_uldaman_sub_boss_agro_keepers_SpellScript::
                                  HandleSendEvent,
                              EFFECT_0,
...
enum UldamanStonedEnum { MAP_ULDAMAN = 70 };
    ...
    class spell_uldaman_stoned_AuraScript : public AuraScript {
        ...
        bool Load() override
        {
            return GetUnitOwner()->GetTypeId() == TYPEID_UNIT &&
                   GetUnitOwner()->GetMapId() == MAP_ULDAMAN;
        }
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_uldaman_stoned_AuraScript::HandleEffectApply,
                EFFECT_0,
                SPELL_AURA_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(
                spell_uldaman_stoned_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
                AURA_EFFECT_HANDLE_REAL);
        }
...
public:
    spell_uldaman_boss_agro_archaedas()
        : SpellScriptLoader("spell_uldaman_boss_agro_archaedas")
    {
    }
    ...
    class spell_uldaman_boss_agro_archaedas_SpellScript : public SpellScript {
        ...
        void HandleSendEvent(SpellEffIndex /*effIndex*/)
        {
            ...
            if (Creature* archaedas = GetCaster()->FindNearestCreature(
                    NPC_ARCHAEDAS, 100.0f, true))
        ...
        void Register() override
        {
            OnEffectLaunch += SpellEffectFn(
                spell_uldaman_boss_agro_archaedas_SpellScript::HandleSendEvent,
                EFFECT_0,
                SPELL_EFFECT_SEND_EVENT);
        }
    };
