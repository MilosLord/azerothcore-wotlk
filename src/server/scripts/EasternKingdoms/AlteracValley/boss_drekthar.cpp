    ...
    struct boss_drektharAI : public ScriptedAI {
            ...
            if (!Attacked) {
                ...
                if (BattlegroundMap* bgMap =
                    ...
                    if (Battleground* bg = bgMap->GetBG()) {
                        for (uint8 i = AV_CPLACE_H_MARSHAL_ICE;
                             i <= AV_CPLACE_H_MARSHAL_WTOWER;
                             ++i) {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (WhirlwindTimer <= diff) {
                ...
                WhirlwindTimer =
                    urand(8 * IN_MILLISECONDS, 18 * IN_MILLISECONDS);
            }
            else
                WhirlwindTimer -= diff;
            ...
            if (Whirlwind2Timer <= diff) {
                ...
                Whirlwind2Timer =
                    urand(7 * IN_MILLISECONDS, 25 * IN_MILLISECONDS);
            }
            else
...
void AddSC_boss_drekthar() { new boss_drekthar; }
