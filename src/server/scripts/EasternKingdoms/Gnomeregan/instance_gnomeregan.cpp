...
public:
                       ...
                       const Quest* quest) override
    {
        if (quest->GetQuestId() == QUEST_A_FINE_MESS) {
            ...
            creature->GetMotionMaster()->MoveFollow(
                player, PET_FOLLOW_DIST, M_PI, MOTION_SLOT_CONTROLLED);
        }
        return true;
    }
    ...
    struct npc_kernobeeAI : public PassiveAI {
        ...
        void SetGUID(ObjectGuid guid, int32) override { playerGUID = guid; }
...
public:
    spell_gnomeregan_radiation_bolt()
        : SpellScriptLoader("spell_gnomeregan_radiation_bolt")
    {
    }
    ...
    class spell_gnomeregan_radiation_bolt_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHit += SpellEffectFn(
                spell_gnomeregan_radiation_bolt_SpellScript::HandleTriggerSpell,
                EFFECT_1,
