...
LocationXYZ AmbushSpawn[] = {{191.296204f, -2839.329346f, 107.388f},
                             {70.972466f, -2848.674805f, 109.459f}};

LocationXYZ AmbushMoveTo[] = {{166.630386f, -2824.780273f, 108.153f},
    ...
    struct npc_rinjiAI : public npc_escortAI {
        ...
        void JustSummoned(Creature* summoned) override
        {
            ...
            summoned->GetMotionMaster()->MovePoint(0,
                                                   AmbushMoveTo[spawnId].x,
                                                   AmbushMoveTo[spawnId].y,
                                                   AmbushMoveTo[spawnId].z);
        }
        ...
        void sQuestAccept(Player* player, Quest const* quest) override
        {
            ...
            if (quest->GetQuestId() == QUEST_RINJI_TRAPPED) {
                if (GameObject* go = me->FindNearestGameObject(
                        GO_RINJI_CAGE, INTERACTION_DISTANCE))
                    go->UseDoorOrButton();
...
void AddSC_hinterlands() { new npc_rinji(); }
