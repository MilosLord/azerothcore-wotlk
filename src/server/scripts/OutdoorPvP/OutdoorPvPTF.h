...
// update lock timer every 1/4 minute (overkill, but this way it's sure the
// timer won't "jump" 2 minutes at once.)
...
const go_type TFCapturePoints[TF_TOWER_NUM] = {{183104,
                                                530,
                                                -3081.65f,
                                                5335.03f,
                                                17.1853f,
