...
struct boss_kurinnaxx : public BossAI {
    ...
    void InitializeAI() override { me->m_CombatDistance = 50.0f; }
            ...
            .Schedule(5s,
                      ...
                      [this](TaskContext context) {
                          if (Unit* target = SelectTarget(
                                  SelectTargetMethod::Random, 1, 100.f, true)) {
    ...
    void JustDied(Unit* killer) override
    {
        if (killer) {
            ...
            killer->GetMap()->LoadGrid(-8538.17f,
...
struct go_sand_trap : public GameObjectAI {
    ...
    void UpdateAI(uint32 const diff) override { _scheduler.Update(diff); }
