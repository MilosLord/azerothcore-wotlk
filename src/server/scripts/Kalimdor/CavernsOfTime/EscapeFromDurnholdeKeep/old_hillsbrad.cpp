...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (instance->GetData(DATA_ESCORT_PROGRESS) ==
            ENCOUNTER_PROGRESS_SKARLOC_KILLED)
            menuId = 7830;
        else if (instance->GetData(DATA_ESCORT_PROGRESS) ==
    ...
    {
        GossipMenuItemData const* gossipMenuItemData =
            player->PlayerTalkClass->GetGossipMenu().GetItemData(0);
        InstanceScript* instance = creature->GetInstanceScript();
        if (!instance ||
            (gossipMenuItemData && gossipMenuItemData->GossipActionMenuId != 0))
            return false;
    ...
    struct npc_thrall_old_hillsbradAI : public npc_escortAI {
        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            case 18:
                if (Creature* warden =
                        me->SummonCreature(NPC_DURNHOLDE_WARDEN,
                                           2149.4634f,
                                           104.97559f,
                                           73.632385f,
                                           1.9065f,
                                           ...
                                           30 * IN_MILLISECONDS)) {
                    warden->SetWalk(true);
                    warden->GetMotionMaster()->MovePoint(
                        0, 2144.9893f, 117.81233f, 75.98518f);
                }
                if (Creature* veteran =
                        me->SummonCreature(NPC_DURNHOLDE_VETERAN,
                                           2147.3281f,
                                           106.72353f,
                                           74.34447f,
                                           1.6904f,
                    ...
                    veteran->GetMotionMaster()->MovePoint(
                        0, 2145.2092f, 124.361f, 76.13655f);
                }
                if (Creature* veteran =
                        me->SummonCreature(NPC_DURNHOLDE_VETERAN,
                                           2149.212f,
                    ...
                    veteran->SetWalk(true);
                    veteran->GetMotionMaster()->MovePoint(
                        0, 2143.7898f, 119.41281f, 75.96626f);
                }
                if (Creature* mage =
                        me->SummonCreature(NPC_DURNHOLDE_MAGE,
                                           2147.624f,
                                           104.61046f,
                                           73.909294f,
                                           1.6186f,
                                           ...
                                           30 * IN_MILLISECONDS)) {
                    mage->SetWalk(true);
                    mage->GetMotionMaster()->MovePoint(
                        0, 2146.975f, 118.05078f, 76.098465f);
                }
                break;
            case 27:
                instance->SetData(DATA_ESCORT_PROGRESS,
                                  ENCOUNTER_PROGRESS_AMBUSHES_1);
                break;
            case 28:
                me->SummonCreature(NPC_CAPTAIN_SKARLOC,
                                   1995.78f,
                                   277.46f,
                                   66.64f,
                                   0.74f,
            ...
            case 59:
                instance->SetData(DATA_ESCORT_PROGRESS,
                                  ENCOUNTER_PROGRESS_TARREN_MILL);
                if (Creature* mount =
                        me->SummonCreature(NPC_SKARLOC_MOUNT,
                                           2488.64f,
                                           625.77f,
                                           58.26f,
                                           4.71f,
            ...
            case 60:
                ...
                if (Creature* horse =
                        me->FindNearestCreature(NPC_SKARLOC_MOUNT, 10.0f)) {
                    horse->GetMotionMaster()->MovePoint(
                        0, 2501.15f, 572.14f, 54.13f);
            ...
            case 82:
                ...
                break;
            case 91:
                me->SummonCreature(NPC_TM_PROTECTOR,
                                   2652.71f,
                                   660.31f,
                                   61.93f,
                                   1.67f,
                                   TEMPSUMMON_MANUAL_DESPAWN);
                me->SummonCreature(NPC_TM_LOOKOUT,
                                   2648.96f,
                                   662.59f,
                                   61.93f,
                                   0.79f,
                                   TEMPSUMMON_MANUAL_DESPAWN);
                me->SummonCreature(NPC_TM_GUARDSMAN,
                                   2657.36f,
                                   662.34f,
                                   61.93f,
                                   2.68f,
                ...
                me->SummonCreature(NPC_TM_GUARDSMAN,
                                   ...
                                   TEMPSUMMON_MANUAL_DESPAWN);
                if (Creature* summon =
                        summons.GetCreatureWithEntry(NPC_TM_LOOKOUT))
            ...
            case 94:
                ...
                instance->SetData(DATA_ESCORT_PROGRESS,
                                  ENCOUNTER_PROGRESS_TARETHA_MEET);
                if (Creature* Taretha = ObjectAccessor::GetCreature(
                        *me, instance->GetGuidData(DATA_TARETHA_GUID))) {
        ...
        void MovementInform(uint32 type, uint32 point) override
        {
            ...
            if (type == POINT_MOTION_TYPE &&
                point == 0xFFFFFF /*POINT_LAST_POINT*/) {
                if (roll_chance_i(30))
        ...
        void KilledUnit(Unit*) override { Talk(SAY_RANDOM_KILL); }

        void JustSummoned(Creature* summon) override
        {
            if (summon->GetEntry() == NPC_INFINITE_SLAYER ||
                summon->GetEntry() == NPC_INFINITE_SABOTEUR ||
                summon->GetEntry() == NPC_INFINITE_DEFILER)
                summon->GetMotionMaster()->MovePoint(
                    10, 2634.25f, 672.01f, 54.445f);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_OPEN_DOORS:
                if (GameObject* doors =
                        me->FindNearestGameObject(GO_PRISON_DOOR, 10.0f))
                    doors->SetGoState(GO_STATE_ACTIVE);
                me->SummonCreature(NPC_DURNHOLDE_SENTRY,
                                   2142.372f,
                                   174.2907f,
                                   66.30494f,
                                   2.5656f,
            ...
            case EVENT_SET_FACING:
                if (Creature* armorer =
                        me->FindNearestCreature(NPC_DURNHOLDE_ARMORER, 30.0f)) {
            ...
            case EVENT_DRESSING_SHIELD:
                me->SetUInt32Value(UNIT_VIRTUAL_ITEM_SLOT_ID + 1,
                                   THRALL_SHIELD_ITEM);
                break;
            case EVENT_DRESSING_TALK:
                ...
                if (Creature* sentry =
                        me->SummonCreature(NPC_DURNHOLDE_SENTRY,
                                           ...
                                           30 * IN_MILLISECONDS)) {
                    sentry->SetWalk(true);
                    sentry->GetMotionMaster()->MovePoint(
                        0, 2191.9712f, 138.11394f, 88.2125f);
                }
                if (Creature* warden =
                        me->SummonCreature(NPC_DURNHOLDE_WARDEN,
                                           2188.5586f,
                    ...
                    warden->SetWalk(true);
                    warden->GetMotionMaster()->MovePoint(
                        0, 2188.5068f, 140.48346f, 88.21251f);
                }
                if (Creature* veteran =
                        me->SummonCreature(NPC_DURNHOLDE_VETERAN,
                                           2186.9856f,
                    ...
                    veteran->SetWalk(true);
                    veteran->GetMotionMaster()->MovePoint(
                        0, 2190.48f, 140.81056f, 88.21251f);
                }
                if (Creature* mage =
                        me->SummonCreature(NPC_DURNHOLDE_MAGE,
                                           2189.7336f,
                    ...
                    mage->SetWalk(true);
                    mage->GetMotionMaster()->MovePoint(
                        0, 2187.8035f, 138.61118f, 88.21251f);
                }
                break;
            ...
            case EVENT_SUMMON_CHRONO:
                if (Creature* epoch =
                        me->SummonCreature(NPC_EPOCH_HUNTER,
                                           2640.49f,
                                           696.15f,
                                           64.31f,
                                           4.51f,
            ...
            case EVENT_TARETHA_FALL:
                if (Creature* epoch =
                        summons.GetCreatureWithEntry(NPC_EPOCH_HUNTER))
            ...
            case EVENT_SUMMON_INFINITES:
                me->SummonCreature(NPC_EPOCH_LOOKOUT,
                                   2647.57f,
                                   701.17f,
                                   56.215f,
                                   4.3f,
                                   TEMPSUMMON_MANUAL_DESPAWN);
                me->SummonCreature(NPC_EPOCH_GUARDSMAN,
                                   2629.46f,
                                   704.76f,
                                   56.286f,
                                   4.98f,
                                   TEMPSUMMON_MANUAL_DESPAWN);
                me->SummonCreature(NPC_EPOCH_PROTECTOR,
                                   2640.14f,
                                   709.44f,
                                   56.135f,
                                   4.70f,
            ...
            case EVENT_CHECK_WAVE_1:
                if (summons.size() == 1) {
                    me->SummonCreature(NPC_INFINITE_SABOTEUR,
                                       2599.57f,
                                       683.72f,
                                       55.975f,
                                       0.05f,
                                       TEMPSUMMON_MANUAL_DESPAWN);
                    me->SummonCreature(NPC_INFINITE_SLAYER,
                                       2599.57f,
                                       677.0f,
                                       55.975f,
                                       0.05f,
                                       TEMPSUMMON_MANUAL_DESPAWN);
                    me->SummonCreature(NPC_INFINITE_DEFILER,
                                       2592.57f,
                                       680.0f,
                                       55.975f,
                                       0.05f,
            ...
            case EVENT_EROZION_TALK_1:
                if (Creature* erozion =
                        summons.GetCreatureWithEntry(NPC_EROZION)) {
            ...
            case EVENT_EROZION_ACTION_2:
                if (Creature* erozion =
                        summons.GetCreatureWithEntry(NPC_EROZION))
                    erozion->CastSpell(
                        erozion, SPELL_MEMORY_WIPE_RESUME, false);
                break;
            ...
            case EVENT_EROZION_FLAGS:
                if (Creature* erozion =
                        summons.GetCreatureWithEntry(NPC_EROZION))
                    erozion->SetNpcFlag(UNIT_NPC_FLAG_GOSSIP |
                                        UNIT_NPC_FLAG_QUESTGIVER);
                break;
            }
        }
    ...
    struct npc_tarethaAI : public npc_escortAI {
        ...
        void WaypointReached(uint32 waypointId) override
        {
            if (waypointId == 7) {
                ...
                me->HandleEmoteCommand(EMOTE_ONESHOT_CHEER);
                if (Creature* thrall = ObjectAccessor::GetCreature(
                        *me, instance->GetGuidData(DATA_THRALL_GUID)))
