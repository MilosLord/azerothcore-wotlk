    ...
    struct boss_salrammAI : public ScriptedAI {
        ...
        void ExplodeGhoul()
        {
            for (SummonList::const_iterator itr = summons.begin();
                ...
                if (Creature* cr = ObjectAccessor::GetCreature(*me, (*itr)))
                    if (cr->IsAlive()) {
                        me->CastSpell(cr,
                                      DUNGEON_MODE(SPELL_EXPLODE_GHOUL_N,
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_STEAL_FLESH:
                ...
                me->CastSpell(
                    me->GetVictim(), SPELL_STEAL_FLESH_CHANNEL, false);
            ...
            case EVENT_SPELL_CURSE:
                me->CastSpell(
                    me->GetVictim(), SPELL_CURSE_OF_TWISTED_FAITH, false);
...
public:
    spell_boss_salramm_steal_flesh()
        : SpellScriptLoader("spell_boss_salramm_steal_flesh")
    {
    }
    ...
    class spell_boss_salramm_steal_flesh_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_boss_salramm_steal_flesh_AuraScript::OnRemove,
                EFFECT_0,
