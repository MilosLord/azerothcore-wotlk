...
public:
    ...
    struct boss_meathookAI : public ScriptedAI {
        boss_meathookAI(Creature* c) : ScriptedAI(c) { Talk(SAY_SPAWN); }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_DISEASE_EXPULSION:
                me->CastSpell(me,
                              DUNGEON_MODE(SPELL_DISEASE_EXPULSION_N,
                                           SPELL_DISEASE_EXPULSION_H),
                              false);
            ...
            case EVENT_SPELL_CONSTRICTING_CHAINS:
                if (Unit* pTarget = SelectTarget(
                        SelectTargetMethod::MinThreat, 0, 50.0f, true))
                    me->CastSpell(pTarget,
                                  DUNGEON_MODE(SPELL_CONSTRICTING_CHAINS_N,
                                               SPELL_CONSTRICTING_CHAINS_H),
                                  false);
