...
public:
    ...
    struct boss_epochAI : public ScriptedAI {
        ...
        {
            if (spellInfo->Id == SPELL_TIME_STEP_H ||
                spellInfo->Id == SPELL_TIME_STEP_N) {
                if (target == me)
                    return;
                ...
                me->CastSpell(
                    target,
                    DUNGEON_MODE(SPELL_TIME_STEP_N, SPELL_TIME_STEP_H),
                    true);
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_WOUNDING_STRIKE:
                me->CastSpell(me->GetVictim(),
                              DUNGEON_MODE(SPELL_WOUNDING_STRIKE_N,
                                           SPELL_WOUNDING_STRIKE_H),
                              false);
