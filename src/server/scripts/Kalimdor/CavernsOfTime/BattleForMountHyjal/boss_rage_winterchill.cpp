...
enum Misc { PATH_RAGE_WINTERCHILL = 177670, POINT_COMBAT_START = 7 };

struct boss_rage_winterchill : public BossAI {
public:
    boss_rage_winterchill(Creature* creature)
        : BossAI(creature, DATA_WINTERCHILL)
    {
...
void AddSC_boss_rage_winterchill() { RegisterHyjalAI(boss_rage_winterchill); }
