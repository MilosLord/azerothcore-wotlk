...
TO DO: get correct spell IDs and timings for spells cast upon dragon
transformations TO DO: Dragons should use the
HandleEmoteCommand(EMOTE_ONESHOT_LIFTOFF) after transformation, but for some
unknown reason it doesnt work. EndContentData */

#define EVENT_AREA_RADIUS 65 // 65yds
#define EVENT_COOLDOWN                                                         \
    500000 // in ms. appear after event completed or failed (should be = Adds
           // despawn time)
...
// Creature 0 - Anachronos, 1 - Fandral, 2 - Arygos, 3 - Merithra, 4 -
// Caelestrasz
static QuestCinematic EventAnim[] = {
    ...
    {0, 0, 5000}, // Spell 2-> Arcane long cosmetic (barrier appears) (Barrier
                  // -> Glyphs)
    {0, 0, 7000}, // BarrieR
    {0, 0, 4000}, // Glyphs
...
static SpawnSpells SpawnCast[4] = {
    ...
    {80950,
     300000,
     42075}, // Fire Explosion (need correct spell however this one looks cool)
};
/*#####
...
public:
    ...
    struct npc_anachronos_the_ancientAI : public ScriptedAI {
        ...
        void HandleAnimation()
        {
            ...
            Creature* Fandral =
                player->FindNearestCreature(C_FANDRAL_STAGHELM, 100.0f);
            Creature* Arygos = player->FindNearestCreature(C_ARYGOS, 100.0f);
            Creature* Caelestrasz =
                player->FindNearestCreature(C_CAELESTRASZ, 100.0f);
            Creature* Merithra =
                player->FindNearestCreature(C_MERITHRA, 100.0f);
            ...
            if (!eventEnd) {
                ...
                case 7:
                    ...
                    Merithra->GetMotionMaster()->MoveCharge(
                        -8065, 1530, 2.61f, 10);
                    break;
                case 8:
                ...
                case 14:
                    ...
                    break;
                case 15:
                    Arygos->GetMotionMaster()->MoveCharge(
                        -8065, 1530, 2.61f, 10);
                    Merithra->GetMotionMaster()->MoveCharge(
                        -8034.535f, 1535.14f, 2.61f, 42);
                    break;
                case 16:
                ...
                case 22:
                    ...
                    break;
                case 23:
                    Caelestrasz->GetMotionMaster()->MoveCharge(
                        -8065, 1530, 2.61f, 10);
                    Arygos->SetVisible(false);
                    Arygos->GetMotionMaster()->MoveCharge(
                        -8034.535f, 1535.14f, 2.61f, 10);
                    break;
                case 24:
                ...
                case 32:
                    ...
                    Caelestrasz->GetMotionMaster()->MoveCharge(
                        -8034.535f, 1535.14f, 2.61f, 42);
                    Fandral->GetMotionMaster()->MoveCharge(
                        -8108, 1529, 2.77f, 8);
                ...
                case 36:
                    ...
                    break;
                case 37:
                    me->SummonGameObject(GO_GATE_OF_AHN_QIRAJ,
                                         -8130,
                                         1525,
                                         17.5f,
                                         0,
                ...
                case 38:
                    ...
                    me->SummonGameObject(GO_GLYPH_OF_AHN_QIRAJ,
                                         -8130,
                                         1525,
                                         17.5f,
                                         0,
                ...
                case 40:
                    ...
                    break;
                case 41:
                    Fandral->SummonGameObject(GO_ROOTS_OF_AHN_QIRAJ,
                                              -8130,
                                              1525,
                                              17.5f,
                                              0,
                ...
                case 51: {
                    ...
                    me->GetCreatureListWithEntryInGrid(
                        constructList, 15423, 100.0f);
                    me->GetCreatureListWithEntryInGrid(
                        constructList, 15424, 100.0f);
                    me->GetCreatureListWithEntryInGrid(
                        constructList, 15414, 100.0f);
                    me->GetCreatureListWithEntryInGrid(
                        constructList, 15422, 100.0f);

                    if (!constructList.empty()) {
                        for (std::list<Creature*>::const_iterator itr =
                                 constructList.begin();
                             itr != constructList.end();
                             ++itr) {
                            (*itr)->RemoveFromWorld();
                        }
                    }
                ...
                case 58:
                    me->GetMotionMaster()->MoveCharge(
                        -8112.67f, 1529.9f, 2.86f, 4);
                    break;
                case 59:
                    me->GetMotionMaster()->MoveCharge(
                        -8117.99f, 1532.24f, 3.94f, 4);
                    break;
                case 60:
                    Talk(ANACHRONOS_SAY_10, player);
                    me->GetMotionMaster()->MoveCharge(
                        -8113.46f, 1524.16f, 2.89f, 4);
                    break;
                case 61:
                    me->GetMotionMaster()->MoveCharge(
                        -8057.1f, 1470.32f, 2.61f, 6);
                    if (player->IsInRange(me, 0, 15))
                        player->GroupEventHappens(
                            QUEST_A_PAWN_ON_THE_ETERNAL_BOARD, me);
                    break;
                case 62:
                ...
                case 65:
                    me->SetVisible(false);
                    if (Creature* AnachronosQuestTrigger =
                            (ObjectAccessor::GetCreature(
                                *me, AnachronosQuestTriggerGUID))) {
                        Talk(ARYGOS_YELL_1);
...
public:
    ...
    struct npc_qiraj_war_spawnAI : public ScriptedAI {
        ...
        {
            if (!Timers) {
                if (me->GetEntry() == 15424 || me->GetEntry() == 15422 ||
                    me->GetEntry() == 15414) // all but Kaldorei Soldiers
                {
                    SpellTimer1 = SpawnCast[1].Timer1;
                    SpellTimer2 = SpawnCast[2].Timer1;
                    SpellTimer3 = SpawnCast[3].Timer1;
                }
                if (me->GetEntry() == 15423 || me->GetEntry() == 15424 ||
                    me->GetEntry() == 15422 || me->GetEntry() == 15414)
...
public:
    npc_anachronos_quest_trigger()
        : CreatureScript("npc_anachronos_quest_trigger")
    {
    }
    ...
    struct npc_anachronos_quest_triggerAI : public ScriptedAI {
        ...
        void SummonNextWave()
        {
            ...
            for (uint8 i = locIndex; i <= count; ++i) {
                ...
                if (Creature* spawn =
                        me->SummonCreature(WavesInfo[WaveCount].CreatureId,
                                           SpawnLocation[i],
                                           TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                           desptimer)) {
                    if (spawn->GetEntry() == 15423)
                        spawn->SetUInt32Value(UNIT_FIELD_DISPLAYID,
                                              15427 + rand() % 4);
                    if (i >= 30)
                        WaveCount = 1;
                    if (i >= 33)
                    ...
                    {
                        if (npc_qiraj_war_spawn::
                                npc_qiraj_war_spawnAI* spawnAI = CAST_AI(
                                    npc_qiraj_war_spawn::npc_qiraj_war_spawnAI,
                                    spawn->AI())) {
...
void npc_qiraj_war_spawn::npc_qiraj_war_spawnAI::JustDied(Unit* /*slayer*/)
{
    ...
    if (Creature* mob = ObjectAccessor::GetCreature(*me, MobGUID))
        if (npc_anachronos_quest_trigger::
                npc_anachronos_quest_triggerAI* triggerAI =
                    CAST_AI(npc_anachronos_quest_trigger::
                                npc_anachronos_quest_triggerAI,
                            mob->AI()))
...
public:
    ...
    bool
    OnQuestAccept(Player* player, GameObject* go, Quest const* quest) override
    {
        if (quest->GetQuestId() == QUEST_A_PAWN_ON_THE_ETERNAL_BOARD) {
            if (Creature* trigger =
                    go->FindNearestCreature(15454, 100, player)) {
                Unit* Merithra =
                    trigger->SummonCreature(15378,
                                            -8034.535f,
                                            1535.14f,
                                            2.61f,
                                            0,
                ...
                Unit* Arygos =
                    trigger->SummonCreature(15380,
                                            ...
                                            TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
                                            220000);
                /* Unit* Fandral = */ trigger->SummonCreature(
                    15382,
                    -8028.462f,
                    1535.843f,
                    2.61f,
                ...
                if (Anachronos) {
                    if (npc_anachronos_the_ancient::
                            npc_anachronos_the_ancientAI* anachronosAI =
                                CAST_AI(npc_anachronos_the_ancient::
...
public:
    DelayedWindstoneSummonEvent(TempSummon* summon, ObjectGuid playerGUID)
        : _summon(summon), _playerGUID(playerGUID)
    {
    }
    ...
    struct go_wind_stoneAI : public GameObjectAI {
        ...
        bool GossipHello(Player* player, bool reportUse) override
        {
            if (reportUse) {
                ...
                bool   _twilightSetAura =
                    (player->HasAura(AURA_TWILIGHT_SET, player->GetGUID()));
                bool _medallionAura =
                    (player->HasAura(AURA_MEDALLION, player->GetGUID()));
                bool _ringAura =
                    (player->HasAura(AURA_RING, player->GetGUID()));
        ...
        bool GossipSelect(Player* player, uint32 sender, uint32 action) override
        {
            ...
            Creature* lastSpawn =
                ObjectAccessor::GetCreature(*me, _creatureGuid);
            ...
            if (sender == GOSSIPID_LESSER_WS) {
                ...
                case 2:
                    SummonNPC(
                        me, player, NPC_TEMPLAR_WATER, SPELL_TEMPLAR_WATER);
                    break;
                case 3:
                    SummonNPC(
                        me, player, NPC_TEMPLAR_EARTH, SPELL_TEMPLAR_EARTH);
                    break;
                case 4:
            ...
            me->DespawnOrUnsummon(
                5000ms,
                respawnTimer); // Despawn in 5 Seconds for respawnTimer value
        ...
        void
        SummonNPC(GameObject* go, Player* player, uint32 npc, uint32 spellId)
        {
            SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(spellId);
            if (!spellInfo)
                return;
            SpellInfo const* spellInfoTrigger = sSpellMgr->GetSpellInfo(
            ...
            if (TempSummon* summons =
                    go->SummonCreature(npc,
                                       go->GetPositionX(),
                                       go->GetPositionY(),
                                       go->GetPositionZ(),
                ...
                summons->m_Events.AddEvent(
                    new DelayedWindstoneSummonEvent(summons, player->GetGUID()),
                    summons->m_Events.CalculateTime(5200));
