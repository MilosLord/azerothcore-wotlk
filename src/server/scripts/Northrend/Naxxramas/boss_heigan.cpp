...
enum Misc { PHASE_SLOW_DANCE = 0, PHASE_FAST_DANCE = 1 };
...
public:
    ...
    struct boss_heiganAI : public BossAI {
        ...
        void Reset() override
        {
            ...
            if (pInstance) {
                if (GameObject* go = me->GetMap()->GetGameObject(
                        pInstance->GetGuidData(DATA_HEIGAN_ENTER_GATE))) {
        ...
        {
            if (who->GetPositionX() > 2826 || who->GetPositionX() < 2723 ||
                who->GetPositionY() > -3641 || who->GetPositionY() < -3736) {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_DECEPIT_FEVER:
                me->CastSpell(
                    me,
                    RAID_MODE(SPELL_DECREPIT_FEVER_10, SPELL_DECREPIT_FEVER_25),
                    false);
...
void AddSC_boss_heigan() { new boss_heigan(); }
