...
public:
    ...
    struct boss_loathebAI : public BossAI {
        explicit boss_loathebAI(Creature* c)
            : BossAI(c, BOSS_LOATHEB), summons(me)
        {
        ...
        void Reset() override
        {
            ...
            if (pInstance) {
                ...
                if (GameObject* go = me->GetMap()->GetGameObject(
                        pInstance->GetGuidData(DATA_LOATHEB_GATE))) {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_DEATHBLOOM:
                me->CastSpell(
                    me,
                    RAID_MODE(SPELL_DEATHBLOOM_10, SPELL_DEATHBLOOM_25),
                    false);
                events.Repeat(30s);
                break;
            case EVENT_INEVITABLE_DOOM:
                me->CastSpell(me,
                              RAID_MODE(SPELL_INEVITABLE_DOOM_10,
                                        SPELL_INEVITABLE_DOOM_25),
                              false);
                doomCounter++;
...
void AddSC_boss_loatheb() { new boss_loatheb(); }
