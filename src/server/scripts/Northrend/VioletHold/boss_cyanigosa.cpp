...
#define SPELL_UNCONTROLLABLE_ENERGY                                            \
    DUNGEON_MODE(SPELL_UNCONTROLLABLE_ENERGY_N, SPELL_UNCONTROLLABLE_ENERGY_H)
    ...
    struct boss_cyanigosaAI : public ScriptedAI {
        ...
        void SpellHitTarget(Unit* target, SpellInfo const* spell) override
        {
            ...
            case SPELL_ARCANE_VACUUM:
                target->NearTeleportTo(me->GetPositionX(),
                                       me->GetPositionY(),
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_UNCONTROLLABLE_ENERGY:
                me->CastSpell(
                    me->GetVictim(), SPELL_UNCONTROLLABLE_ENERGY, false);
...
void AddSC_boss_cyanigosa() { new boss_cyanigosa(); }
