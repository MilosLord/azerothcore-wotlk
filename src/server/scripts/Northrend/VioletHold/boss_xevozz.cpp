...
#define SPELL_ARCANE_BARRAGE_VOLLEY                                            \
    DUNGEON_MODE(SPELL_ARCANE_BARRAGE_VOLLEY_N, SPELL_ARCANE_BARRAGE_VOLLEY_H)
#define SPELL_ARCANE_BUFFET                                                    \
    DUNGEON_MODE(SPELL_ARCANE_BUFFET_N, SPELL_ARCANE_BUFFET_H)
#define SPELL_ARCANE_POWER                                                     \
    DUNGEON_MODE(SPELL_ARCANE_POWER_N, SPELL_ARCANE_POWER_H)
    ...
    struct boss_xevozzAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_ARCANE_BARRAGE_VOLLEY:
                me->CastSpell(
                    (Unit*)nullptr, SPELL_ARCANE_BARRAGE_VOLLEY, false);
                events.Repeat(20s);
                break;
            ...
            case EVENT_SUMMON_SPHERES: {
                ...
                spheres.DespawnAll();
                uint32 entry1 = RAND(SPELL_SUMMON_ETHEREAL_SPHERE_1,
...
void AddSC_boss_xevozz() { new boss_xevozz(); }
