...
#define SPELL_SHROUD_OF_DARKNESS                                               \
    DUNGEON_MODE(SPELL_SHROUD_OF_DARKNESS_N, SPELL_SHROUD_OF_DARKNESS_H)
    ...
    struct npc_vh_void_sentryAI : public NullCreatureAI {
        npc_vh_void_sentryAI(Creature* c) : NullCreatureAI(c)
        {
            ...
            if (Creature* pSummoned =
                    me->SummonCreature(NPC_VOID_SENTRY_BALL,
                                       *me,
        ...
        void DoAction(int32 a) override
        {
            if (a == -1337)
                if (Creature* c =
                        pInstance->instance->GetCreature(SummonedGUID))
                    c->DespawnOrUnsummon();
        }
