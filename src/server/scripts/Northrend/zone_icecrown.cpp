    ...
    struct npc_black_knight_graveyardAI : public ScriptedAI {
        ...
        void MoveInLineOfSight(Unit* who) override
        {
            if (who->GetTypeId() != TYPEID_PLAYER ||
                me->GetDistance(who) > 8.0f ||
                who->ToPlayer()->GetQuestStatus(QUEST_BLACK_KNIGHT_CURSE) !=
            ...
            me->SummonCreature(NPC_CULT_ASSASSIN,
                               8452.50f,
                               459.08f,
                               596.08f,
                               0.93f,
                               TEMPSUMMON_CORPSE_DESPAWN);
            me->SummonCreature(NPC_CULT_SABOTEUR,
                               8455.47f,
                               458.64f,
                               596.08f,
                               2.36f,
...
public:
    ...
    struct npc_battle_at_valhalasAI : public ScriptedAI {
        ...
        void PrepareSummons()
        {
            ...
            case QUEST_BFV_DARK_MASTER:
                me->SummonCreature(NPC_DARK_MASTER,
                                   8184.97f,
                                   3491.2f,
                                   625.33f,
                                   0.6f,
        ...
        void CheckSummons()
        {
            ...
            if (allow) {
                ...
                if (Player* player =
                    ...
                    switch (quest) {
                    case QUEST_BFV_FALLEN_HEROES:
                        me->Yell("$N has defeated the fallen heroes of "
                                 "Valhalas battles past. This is only a "
                                 "beginning, but it will suffice.",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
                    case QUEST_BFV_DARK_MASTER:
                        me->Yell("Khit'rix the Dark Master has been defeated "
                                 "by $N and his band of companions. Let the "
                                 "next challenge be issued!",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
                    case QUEST_BFV_SIGRID:
                        me->Yell("$N has defeated Sigrid Iceborn for a second "
                                 "time. Well, this time he did it with the "
                                 "help of his friends, but a win is a win!",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
                    case QUEST_BFV_CARNAGE:
                        me->Yell("The horror known as Carnage is no more. "
                                 "Could it be that $N is truly worthy of "
                                 "battle in Valhalas? We shall see.",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
                    case QUEST_BFV_THANE:
                        me->Yell("Thane Banahogg the Deathblow has fallen to "
                                 "$N and his fighting companions. He has but "
                                 "one challenge ahead of him. Who will it be?",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
                    case QUEST_BFV_FINAL:
                        me->Yell("The unthinkable has happened... $N has slain "
                                 "Prince Sandoval!",
                                 LANG_UNIVERSAL,
                                 ObjectAccessor::GetPlayer(*me, playerGUID));
                        break;
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_VALHALAS_FIRST: {
                ...
                case QUEST_BFV_FALLEN_HEROES:
                    ...
                    me->Yell("$N and comrades in arms have chosen to accept "
                             "honorable combat within the sacred confines of "
                             "Valhalas.",
                             LANG_UNIVERSAL,
                             ObjectAccessor::GetPlayer(*me, playerGUID));
                    break;
                case QUEST_BFV_DARK_MASTER:
                    events.ScheduleEvent(EVENT_VALHALAS_SECOND, 8s);
                    me->Yell("$N has accepted the challenge of Khit'rix the "
                             "Dark Master. May the gods show mercy upon him "
                             "for Khit'rix surely will not.",
                             LANG_UNIVERSAL,
                             ObjectAccessor::GetPlayer(*me, playerGUID));
                    break;
                case QUEST_BFV_SIGRID:
                    PrepareSummons();
                    me->TextEmote("Circling Valhalas, Sigrid Iceborn "
                                  "approaches to seek her revenge!",
                                  nullptr,
                                  true);
                    break;
                case QUEST_BFV_CARNAGE:
                    events.ScheduleEvent(EVENT_VALHALAS_SECOND, 8s);
                    me->Yell(
                        "From the bowels of the Underhalls comes Carnage. "
                        "Brave and foolish $N has accepted the challenge. $N "
                        "and his group stand ready to face the monstrosity.",
                        LANG_UNIVERSAL,
                        ObjectAccessor::GetPlayer(*me, playerGUID));
                    break;
                case QUEST_BFV_THANE:
                    events.ScheduleEvent(EVENT_VALHALAS_SECOND, 8s);
                    me->Yell("Thane Banahogg returns to Valhalas for the first "
                             "time in ages to prove that the vrykul are the "
                             "only beings worthy to fight within its sacred "
                             "ring. Will $N prove him wrong?",
                             LANG_UNIVERSAL,
                             ObjectAccessor::GetPlayer(*me, playerGUID));
                    break;
                case QUEST_BFV_FINAL:
                    events.ScheduleEvent(EVENT_VALHALAS_SECOND, 8s);
                    me->Yell("From the depths of Icecrown Citadel, one of the "
                             "Lich King's chosen comes to put an end to the "
                             "existence of $N and his friends.",
                             LANG_UNIVERSAL,
                             ObjectAccessor::GetPlayer(*me, playerGUID));
                    break;
                }
            ...
            case EVENT_VALHALAS_SECOND: {
                ...
                case QUEST_BFV_FALLEN_HEROES:
                    me->Yell(
                        "There can only be one outcome to such a battle: death "
                        "for one side or the other. Let $n prove himself upon "
                        "the bones of these outsiders who have fallen before!",
                        LANG_UNIVERSAL,
                        ObjectAccessor::GetPlayer(*me, playerGUID));
                    me->TextEmote("The fallen heroes of Valhalas emerge from "
                                  "the ground to do battle once more!",
                                  nullptr,
                                  true);
                    break;
                case QUEST_BFV_DARK_MASTER:
                    me->TextEmote("Khit'rix the Dark Master skitters into "
                                  "Valhalas from the southeast!",
                                  nullptr,
                                  true);
                    break;
                case QUEST_BFV_CARNAGE:
                    me->TextEmote("Lumbering in from the south, the smell of "
                                  "Carnage precedes him!",
                                  nullptr,
                                  true);
                    break;
                case QUEST_BFV_THANE:
                    me->TextEmote("Thane Banahogg appears upon the overlook to "
                                  "the southeast!",
                                  nullptr,
                                  true);
                    break;
                case QUEST_BFV_FINAL:
                    me->Yell("Warriors of Jotunheim, I present to you, Blood "
                             "Prince Sandoval!",
                             LANG_UNIVERSAL);
                    me->TextEmote("Without warning, Prince Sandoval magically "
                                  "appears within Valhalas!",
                                  nullptr,
                                  true);
                    break;
                }
            ...
            case EVENT_VALHALAS_THIRD: {
                me->Yell("In defeating him, he and his fighting companions "
                         "have proven themselves worthy of battle in this most "
                         "sacred place of vrykul honor.",
                         LANG_UNIVERSAL,
                         ObjectAccessor::GetPlayer(*me, playerGUID));
            ...
            case EVENT_VALHALAS_THIRD + 2: {
                me->Yell("ALL HAIL $N, CHAMPION OF VALHALAS! ",
                         LANG_UNIVERSAL,
                         ObjectAccessor::GetPlayer(*me, playerGUID2));
                break;
            }
    ...
    {
        npc_battle_at_valhalasAI* vAI = CAST_AI(
            npc_battle_at_valhalas::npc_battle_at_valhalasAI, creature->AI());
        vAI->ResetData();
        ...
        case QUEST_BFV_FALLEN_HEROES:
            creature->Say("Valhalas is yours to win or die in, $N. But "
                          "whatever you do, stay within the bounds of the "
                          "arena. To flee is to lose and be dishonored.",
                          LANG_UNIVERSAL,
                          player);
            break;
        case QUEST_BFV_DARK_MASTER:
            creature->Say("Prepare yourself. Khit'rix will be entering "
                          "Valhalas from the southeast. Remember, do not leave "
                          "the ring or you will lose the battle.",
                          LANG_UNIVERSAL,
                          player);
            break;
        case QUEST_BFV_SIGRID:
            creature->Yell(
                "Sigrid Iceborn has returned to the heights of Jotunheim to "
                "prove herself against $N. When last they met, $N bester her "
                "in personal combat. Let us see the outcome of this match.",
                LANG_UNIVERSAL,
                player);
            break;
        case QUEST_BFV_CARNAGE:
            creature->Say("Carnage is coming! Remember, no matter what you do, "
                          "do NOT leave the battle ring or I will disqualify "
                          "you and your group.",
                          LANG_UNIVERSAL);
            break;
        case QUEST_BFV_THANE:
            creature->Say(
                "Look to the southeast and you will see the thane upon the "
                "platform near Gjonner the Merciless when he shows himself. "
                "Let him come down. Stay within the ring of Valhalas.",
                LANG_UNIVERSAL);
            break;
        case QUEST_BFV_FINAL:
            creature->Say("It's too late to run now. Do not leave the ring. "
                          "Die bravely, $N!",
                          LANG_UNIVERSAL);
            break;
        }
...
public:
    ...
    struct npc_llod_genericAI : public CombatAI {
        npc_llod_genericAI(Creature* pCreature) : CombatAI(pCreature)
        {
            attackTimer = 0;
            summonTimer = 1;
        }
    ...
    struct npc_lord_areteAI : ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_START:
                ...
                if (Creature* cr =
                        me->FindNearestCreature(NPC_LANDGREN, 100.0f, false)) {
                    _landgrenGUID = cr->GetGUID();

                    float o = cr->GetAngle(me);
                    me->GetMotionMaster()->MovePoint(
                        1,
                        cr->GetPositionX() + cos(o) * 3,
                        cr->GetPositionY() + std::sin(o) * 3,
                        cr->GetPositionZ());
            ...
            case EVENT_SUMMON_SOUL:
                if (Creature* cr =
                        ObjectAccessor::GetCreature(*me, _landgrenGUID))
                    cr->CastSpell(cr, SPELL_SUMMON_LANDGREN_SOUL, true);
                if (Creature* soul =
                        me->FindNearestCreature(NPC_LANDGREN_SOUL, 100.0f)) {
            ...
            case EVENT_SOUL_FLY:
                if (Creature* soul =
                        ObjectAccessor::GetCreature(*me, _landgrenSoulGUID)) {
                    soul->SetCanFly(true);
                    soul->SetVisible(true);
                    Movement::MoveSplineInit init(soul);
                    init.MoveTo(soul->GetPositionX(),
                                soul->GetPositionY(),
                                soul->GetPositionZ() + 5.0f);
            ...
            case EVENT_SCENE_1:
                if (Creature* soul =
                        ObjectAccessor::GetCreature(*me, _landgrenSoulGUID)) {
                    soul->SetPosition(soul->GetPositionX(),
                                      soul->GetPositionY(),
                                      soul->GetPositionZ() + 5.0f,
                                      soul->GetOrientation());
                    soul->CastSpell(soul, 64462, true); // Drown
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (checkTimer >= 500) {
                ...
                if (Unit* victim = me->GetVictim()) {
                    if (victim->GetEntry() == 33531 /*NPC_CAMPAIGN_WARHORSE*/ &&
...
public:
    ...
    struct npc_tirions_gambit_tirionAI : npc_escortAI {
        npc_tirions_gambit_tirionAI(Creature* creature)
            : npc_escortAI(creature), summons(me)
        {
        }
        ...
        void DoAction(int32 param) override
        {
            if (param == ACTION_START_EVENT) {
                ...
                GetCreatureListWithEntryInGrid(
                    cList, me, NPC_DISGUISED_CRUSADER, 15.0f);
                for (std::list<Creature*>::const_iterator itr = cList.begin();
                     itr != cList.end();
                     ++itr, ++i) {
                    (*itr)->SetWalk(true);
                    (*itr)->GetMotionMaster()->MoveFollow(
                        me,
                        1.0f,
                        Position::NormalizeOrientation(M_PI * i / 2.0f));
                    summons.Summon(*itr);
                }
            }
        }
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            if (summon->GetEntry() == NPC_CHOSEN_ZEALOT ||
                summon->GetEntry() == NPC_TIRION_LICH_KING)
                summon->SetWalk(true);
            else if (summon->GetEntry() != NPC_INVOKER_BASALEPH) {
                summon->SetUInt32Value(UNIT_NPC_EMOTESTATE,
                                       EMOTE_STATE_READY2H);
                summon->SetImmuneToAll(true);
                summon->GetMotionMaster()->MovePoint(
                    4, 6135.97f, 2753.84f, 573.92f);
            }
        }
        ...
        void WaypointReached(uint32 pointId) override
        {
            switch (pointId) {
            case 6:
                me->SummonCreature(NPC_INVOKER_BASALEPH,
                                   6130.26f,
                                   2764.83f,
                                   573.92f,
                                   5.19f,
            ...
            case 15: {
                ...
                for (SummonList::const_iterator itr = summons.begin();
                     ...
                     ++itr, ++i)
                    if (Creature* summon =
                            ObjectAccessor::GetCreature(*me, *itr))
                ...
                if (Creature* summon = ObjectAccessor::GetCreature(*me, *itr))
                    if (summon->GetEntry() == entry) {
                        ...
                        case ACTION_SUMMON_MOVE_STRAIGHT:
                            summon->GetMotionMaster()->MovePoint(
                                1,
                                summon->GetPositionX() - param,
                                summon->GetPositionY() + param * 2 + 3,
                                summon->GetPositionZ());
                            break;
        ...
        void UpdateEscortAI(uint32 diff) override
        {
            ...
            case EVENT_START_SCENE:
                Talk(2);
                DoSummonAction(
                    NPC_DISGUISED_CRUSADER, ACTION_SUMMON_ORIENTATION, 200);

                me->SummonCreature(NPC_CHOSEN_ZEALOT,
                                   6160.74f,
                                   2695.90f,
                                   573.92f,
                                   2.04f,
                ...
                DoSummonAction(
                    NPC_CHOSEN_ZEALOT, ACTION_SUMMON_MOVE_STRAIGHT, 27);
                events.ScheduleEvent(EVENT_SCENE_0, 30s);
                break;
            case EVENT_SCENE_0:
                DoSummonAction(NPC_CHOSEN_ZEALOT,
                               ACTION_SUMMON_STAND_STATE,
                               UNIT_STAND_STATE_KNEEL);
                me->SummonGameObject(GO_FROZEN_HEART,
                                     6132.38f,
                                     2760.76f,
                                     574.0f,
                                     0.0f,
            ...
            case EVENT_SCENE_0 + 3:
                Talk(3);
                if (Creature* cr =
                        me->SummonCreature(NPC_TIRION_LICH_KING,
                                           6161.26f,
                                           2700.05f,
                                           573.92f,
                                           2.04f,
            ...
            case EVENT_SCENE_0 + 5:
                DoSummonAction(
                    NPC_TIRION_LICH_KING, ACTION_SUMMON_ORIENTATION, 11);
                ...
                for (SummonList::iterator itr = summons.begin();
                    ...
                    if (Creature* summon =
                        ...
                        if (summon->GetEntry() == NPC_DISGUISED_CRUSADER) {
                            ...
                            summon->GetMotionMaster()->MovePoint(
                                2,
                                6132.38f + 4 * cos(2 * M_PI * (i / 3.0)),
                                2760.76f + 4 * std::sin(2 * M_PI * (i / 3.0)),
                                me->GetPositionZ());
                        }
                break;
            }
            case EVENT_SCENE_0 + 16:
                ...
                if (GameObject* go =
                        me->FindNearestGameObject(GO_FROZEN_HEART, 20.0f))
                    go->Delete();
                events.ScheduleEvent(EVENT_SCENE_0 + 17, 2s);
                break;
            case EVENT_SCENE_0 + 17:
                DoSummonAction(NPC_TIRION_LICH_KING,
                               ACTION_SUMMON_STAND_STATE,
                               UNIT_STAND_STATE_KNEEL);
            ...
            case EVENT_SCENE_0 + 170:
                DoSummonAction(
                    NPC_DISGUISED_CRUSADER, ACTION_SUMMON_ORIENTATION, 500);
                DoSummonAction(NPC_DISGUISED_CRUSADER,
                               ACTION_SUMMON_EMOTE,
                               EMOTE_STATE_READY2H);
                if (Creature* cr =
                        me->FindNearestCreature(NPC_DISGUISED_CRUSADER, 10.0f))
                    cr->AI()->Talk(0);
            ...
            case EVENT_SCENE_0 + 18: {
                ...
                me->GetCreaturesWithEntryInRange(
                    zealotList, 100.0f, NPC_CHOSEN_ZEALOT);
                for (std::list<Creature*>::const_iterator itr =
                         zealotList.begin();
                     itr != zealotList.end();
                     ++itr) {
                    (*itr)->SetUInt32Value(UNIT_NPC_EMOTESTATE,
                                           EMOTE_STATE_READY_UNARMED);
                    if ((*itr)->GetPositionX() > 6150.0f) {
                        Position tpos = pos1;
                        (*itr)->MovePosition(
                            tpos, frand(1.0f, 14.0f), frand(3.14f, 4.14f));
                        (*itr)->GetMotionMaster()->MovePoint(
                            3,
                            tpos.GetPositionX(),
                            tpos.GetPositionY(),
                            tpos.GetPositionZ());
                        ...
                        Position tpos = pos2;
                        (*itr)->MovePosition(
                            tpos, frand(1.0f, 14.0f), frand(0.0f, 1.0f));
                        (*itr)->GetMotionMaster()->MovePoint(
                            3,
                            tpos.GetPositionX(),
                            tpos.GetPositionY(),
            ...
            case EVENT_SCENE_0 + 20: {
                for (SummonList::const_iterator itr = summons.begin();
                    ...
                    if (Creature* summon =
                        ...
                        if (summon->GetEntry() >= NPC_TIRION_EBON_KNIGHT &&
                            summon->GetEntry() <= NPC_TIRION_MOGRAINE) {
                            if (summon->GetEntry() == NPC_TIRION_MOGRAINE)
                                summon->SetHomePosition(
                                    6135.97f, 2753.84f, 573.92f, 3.70f);
                            else
                                summon->SetHomePosition(
                                    6138.36f + frand(-2.0f, 2.0f),
                                    2749.25f + frand(-2.0f, 2.0f),
                                    573.92f,
                                    2.03f);
                        }
                    }
                ...
                me->GetCreaturesWithEntryInRange(
                    zealotList, 100.0f, NPC_CHOSEN_ZEALOT);
                Unit* target =
                    me->FindNearestCreature(NPC_TIRION_MOGRAINE, 100.0f);
                for (std::list<Creature*>::const_iterator itr =
                         zealotList.begin();
                     itr != zealotList.end();
                     ++itr) {
            ...
            case EVENT_SCENE_0 + 310:
                ...
                DoSummonAction(NPC_TIRION_LICH_KING,
                               ACTION_SUMMON_STAND_STATE,
                               UNIT_STAND_STATE_STAND);
                me->SummonGameObject(GO_ESCAPE_PORTAL,
                                     6133.83f,
                                     2757.24f,
                                     573.914f,
                                     1.97f,
                ...
                for (SummonList::const_iterator itr = summons.begin();
                    ...
                    if (Creature* summon =
                        ...
                        if (summon->GetEntry() == NPC_TIRION_LICH_KING)
                            summon->CastSpell(
                                summon, SPELL_LICH_KINGS_FURY, false);
                        summon->DespawnOrUnsummon(
                            summon->GetEntry() == NPC_TIRION_LICH_KING ? 10000
                                                                       : 4000);
                    }
...
public:
    spell_switch_infragreen_bomber_station()
        : SpellScriptLoader("spell_switch_infragreen_bomber_station")
    {
    }

    class spell_switch_infragreen_bomber_station_SpellScript
        : public SpellScript {
        ...
        void HandleDummy(SpellEffIndex effIndex)
        {
            ...
            Unit*    charmer =
                GetCaster()->GetCharmer(); // Player controlling station
            if (!kit || !charmer)
                return;

            uint8             seatNumber = GetSeatNumber(GetSpellInfo()->Id);
            SeatMap::iterator itr =
                kit->GetSeatIteratorForPassenger(GetCaster());
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_switch_infragreen_bomber_station_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_charge_shield_bomber()
        : SpellScriptLoader("spell_charge_shield_bomber")
    {
    }
    ...
    class spell_charge_shield_bomber_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            if (m_scriptSpellId == SPELL_CHARGE_SHIELD)
                OnEffectHitTarget += SpellEffectFn(
                    spell_charge_shield_bomber_SpellScript::HandleDummy,
                    EFFECT_0,
                    SPELL_EFFECT_DUMMY);
        }
    };
        ...
        void Register() override
        {
            if (m_scriptSpellId == SPELL_INFRA_GREEN_SHIELD) {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(
                    spell_charge_shield_bomber_AuraScript::CalculateAmount,
                    EFFECT_0,
                    SPELL_AURA_SCHOOL_ABSORB);
                OnEffectAbsorb += AuraEffectAbsorbFn(
                    spell_charge_shield_bomber_AuraScript::Absorb, EFFECT_0);
            }
        }
    };
...
public:
    ...
    class spell_fight_fire_bomber_SpellScript : public SpellScript {
            ...
            for (uint8 seat = 3; seat <= 5; ++seat)
                if (Unit* banner = kit->GetPassenger(seat))
                    if (banner->HasAura(SPELL_COSMETIC_FIRE)) {
                        if (!extinguished) {
                            GetCaster()->CastSpell(
                                banner, SPELL_EXTINGUISH_FIRE, true);
                            extinguished = true;
                            if (urand(0, 2)) {
                                banner->RemoveAurasDueToSpell(
                                    SPELL_COSMETIC_FIRE);
                                continue;
                            }
                        }
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_fight_fire_bomber_SpellScript::HandleDummy,
                              EFFECT_0,
                              SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_anti_air_rocket_bomber()
        : SpellScriptLoader("spell_anti_air_rocket_bomber")
    {
    }
    ...
    class spell_anti_air_rocket_bomber_SpellScript : public SpellScript {
            ...
            void HandleDummy(SpellEffIndex effIndex)
        {
            ...
            GetCaster()->CastSpell(
                ...
                loc->GetPositionY(),
                loc->GetPositionZ(),
                GetSpellInfo()->Effects[effIndex].CalcValue(),
                true);
        }
        ...
        void Register() override
        {
            OnEffectLaunch += SpellEffectFn(
                spell_anti_air_rocket_bomber_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    npc_infra_green_bomber_generic()
    ...
    struct npc_infra_green_bomber_genericAI : NullCreatureAI {
        ...
        void IsSummonedBy(WorldObject* summoner) override
        {
            ...
            summoner->ToUnit()->CastSpell(
                summoner->ToUnit(), SPELL_WAITING_FOR_A_BOMBER, true);
            summoner->ToUnit()->CastSpell(
                summoner->ToUnit(), SPELL_FLIGHT_ORDERS, true);
        ...
        void SpreadFire(bool init)
        {
            ...
            if (Unit* passenger = kit->GetPassenger(SEAT_ENGINEERING))
                if (init && !passenger->HasAura(SPELL_BURNING)) {
                    me->TextEmote(
                        "Your Vehicle is burning!", GetSummoner(), true);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_START_FLIGHT: {
                ...
                pathPoints.push_back(G3D::Vector3(me->GetPositionX(),
                                                  me->GetPositionY(),
                                                  me->GetPositionZ()));
                ...
                events.ScheduleEvent(EVENT_CHECK_PATH_REGEN_HEALTH_BURN_DAMAGE,
                                     1min);
            ...
            case EVENT_SYNCHRONIZE_SHIELDS:
                if (Vehicle* kit = me->GetVehicleKit()) {
                    ...
                    uint32 stackAmount =
                        me->GetAuraCount(SPELL_INFRA_GREEN_SHIELD);
                    for (uint8 i = SEAT_BOMBER; i <= SEAT_ENGINEERING; ++i)
                        if (Unit* station = kit->GetPassenger(i)) {
                            ...
                            if (stackAmount)
                                station->SetAuraStack(SPELL_INFRA_GREEN_SHIELD,
                                                      station,
                                                      stackAmount);
                            else
                                station->RemoveAurasDueToSpell(
...
public:
    spell_onslaught_or_call_bone_gryphon()
        : SpellScriptLoader("spell_onslaught_or_call_bone_gryphon")
    {
    }
    ...
    class spell_onslaught_or_call_bone_gryphon_SpellScript
        ...
        {
            OnEffectHit +=
                SpellEffectFn(spell_onslaught_or_call_bone_gryphon_SpellScript::
                                  ChangeSummonPos,
                              EFFECT_0,
                              SPELL_EFFECT_SUMMON);
        }
...
class spell_deliver_gryphon : public SpellScript {
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo(
            {SPELL_DELIVER_GRYPHON, SPELL_ONSLAUGHT_GRYPHON});
    }
        ...
        if (Unit* caster = GetCaster()) {
            if (Vehicle* gryphon = caster->GetVehicleKit()) {
                if (Unit* player = gryphon->GetPassenger(SEAT_PLAYER)) {
                    ...
                    player->SummonCreature(NPC_CAPTURED_ONSLAUGHT_GRYPHON,
                                           7434.7f,
                                           4213.3f,
                                           316.52f,
                                           3.88f,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_deliver_gryphon::HandleScriptEffect,
                          EFFECT_1,
    ...
    struct npc_tournament_training_dummyAI : ScriptedAI {
        ...
        void Reset() override
        {
            ...
            case NPC_RANGED_TARGET:
                me->CastCustomSpell(
                    SPELL_RANGED_DEFEND, SPELLVALUE_AURA_STACK, 3, me);
                break;
            }
        ...
        void SpellHit(Unit* caster, SpellInfo const* spell) override
        {
            ...
            if (spell->Id == SPELL_PLAYER_BREAK_SHIELD)
                if (!me->HasAura(SPELL_CHARGE_DEFEND) &&
                    !me->HasAura(SPELL_RANGED_DEFEND))
                    isVulnerable = true;
        }
...
enum BlessedBanner {
    ...
    DALFORS_SAY_PRE_1 = 0, // "BY THE LIGHT! Those damned monsters! Look at what
    ...
    DALFORS_YELL_FINISHED =
        3, // "We've done it, lads! We've taken the pinnacle from the Scourge!
           // Report to Father Gustav at once and tell him the good news! We're
           // gonna get to buildin' and settin' up! Go!"
...
public:
    ...
    struct npc_blessed_bannerAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_INTRO_1: {
                if (Creature* Dalfors =
                        ObjectAccessor::GetCreature(*me, guidDalfors))
            ...
            case EVENT_WAVE_SPAWN: {
                if (PhaseCount == 3) {
                    if (Creature* LK =
                            GetClosestCreatureWithEntry(me, NPC_LK, 100))
                ...
                if (Creature* tempsum =
                    ...
                    tempsum->AI()->AttackStart(GetClosestCreatureWithEntry(
                        me, NPC_BLESSED_BANNER, 100));
                }
                if (urand(0, 1) == 0) {
                    if (Creature* tempsum =
            ...
            case EVENT_HALOF: {
                ...
                if (Creature* tempsum =
                        DoSummon(NPC_HALOF_THE_DEATHBRINGER, DalforsPos[0])) {
                    HalofSpawned = true;
            ...
            if (PhaseCount == 8)
                if (Creature* Halof =
                        ObjectAccessor::GetCreature(*me, guidHalof))
                    if (Halof->isDead()) {
...
/*######
## Borrowed Technology - Id: 13291, The Solution Solution (daily) - Id: 13292,
Volatility - Id: 13239, Volatiliy - Id: 13261 (daily)
######*/
...
public:
    ...
    struct npc_frostbrood_skytalonAI : public VehicleAI {
        ...
        void IsSummonedBy(WorldObject* summoner) override
        {
            ...
            me->GetMotionMaster()->MovePoint(POINT_GRAB_DECOY,
                                             summoner->GetPositionX(),
                                             summoner->GetPositionY(),
                                             summoner->GetPositionZ() + 3.0f);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                if (eventId == EVENT_FLY_AWAY) {
                    ...
                    randomPosOnRadius.m_positionZ =
                        (me->GetPositionZ() + 40.0f);
                    me->GetNearPoint2D(randomPosOnRadius.m_positionX,
                                       randomPosOnRadius.m_positionY,
                                       40.0f,
                                       me->GetAngle(me));
                    me->GetMotionMaster()->MovePoint(POINT_FLY_AWAY,
                                                     randomPosOnRadius);
                }
            }
        }
