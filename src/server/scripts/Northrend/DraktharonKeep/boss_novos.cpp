...
std::unordered_map<uint32, std::tuple<uint32, Position>> const npcSummon = {
    {ROOM_RIGHT,
     {NPC_SUMMON_CRYSTAL_HANDLER_TARGET, {-341.31f, -724.40f, 28.57f, 0.0f}}},
    {ROOM_LEFT,
     {NPC_SUMMON_CRYSTAL_HANDLER_TARGET, {-408.87f, -730.21f, 28.58f, 0.0f}}},
    {ROOM_STAIRS,
     {NPC_CRYSTAL_CHANNEL_TARGET, {-378.40f, -813.13f, 59.74f, 0.0f}}},
};
    ...
    struct boss_novosAI : public BossAI {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            for (auto& itr : npcSummon) {
                ...
                if (Creature* creature =
                        me->SummonCreature(summonEntry, summonPos))
                    switch (itr.first) {
                    case ROOM_LEFT:
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            if (me->HasUnitFlag(UNIT_FLAG_NOT_SELECTABLE) &&
                summon->GetEntry() != NPC_CRYSTAL_CHANNEL_TARGET &&
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SUMMON_FETID_TROLL:
                if (Creature* trigger = summons.GetCreatureWithEntry(
...
public:
    spell_novos_despawn_crystal_handler()
        : SpellScriptLoader("spell_novos_despawn_crystal_handler")
    {
    }
    ...
    class spell_novos_despawn_crystal_handler_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_novos_despawn_crystal_handler_SpellScript::
                                  HandleScriptEffect,
                              EFFECT_0,
...
public:
    spell_novos_crystal_handler_death()
    ...
    class spell_novos_crystal_handler_death_AuraScript : public AuraScript {
                                   ...
                                   AuraEffectHandleModes /*mode*/)
        {
            ...
            if (GameObject* crystal =
                    GetUnitOwner()->FindNearestGameObjectOfType(
                        GAMEOBJECT_TYPE_DOOR, 5.0f))
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_novos_crystal_handler_death_AuraScript::HandleEffectApply,
                EFFECT_0,
                SPELL_AURA_DUMMY,
...
public:
    spell_novos_summon_minions()
        : SpellScriptLoader("spell_novos_summon_minions")
    {
    }
    ...
    class spell_novos_summon_minions_SpellScript : public SpellScript {
        ...
        void HandleScript(SpellEffIndex /*effIndex*/)
        {
            for (uint8 i = 0; i < 4; ++i)
                GetCaster()->CastSpell(
                    (Unit*)nullptr, SPELL_COPY_OF_SUMMON_MINIONS, true);
        }

        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_novos_summon_minions_SpellScript::HandleScript,
                EFFECT_0,
                SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
