...
public:
    spell_tharon_ja_curse_of_life()
        : SpellScriptLoader("spell_tharon_ja_curse_of_life")
    {
    }
    ...
    class spell_tharon_ja_curse_of_life_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_tharon_ja_curse_of_life_AuraScript::OnPeriodic,
                EFFECT_0,
    ...
    class spell_tharon_ja_dummy_AuraScript : public AuraScript {
                                   ...
                                   AuraEffectHandleModes /*mode*/)
        {
            ...
            GetUnitOwner()->CastSpell(
                GetUnitOwner(), SPELL_GIFT_OF_THARON_JA, true);
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(
                spell_tharon_ja_dummy_AuraScript::HandleEffectApply,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL,
                AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(
                spell_tharon_ja_dummy_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_PERIODIC_TRIGGER_SPELL,
                AURA_EFFECT_HANDLE_REAL);
        }
...
public:
    spell_tharon_ja_clear_gift_of_tharon_ja()
        : SpellScriptLoader("spell_tharon_ja_clear_gift_of_tharon_ja")
    {
    }

    class spell_tharon_ja_clear_gift_of_tharon_ja_SpellScript
        : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_tharon_ja_clear_gift_of_tharon_ja_SpellScript::
                    HandleScript,
                EFFECT_0,
