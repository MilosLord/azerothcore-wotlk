...
public:
    instance_drak_tharon_keep()
        : InstanceMapScript("instance_drak_tharon_keep", 600)
    {
    }
...
public:
    ...
    class spell_dtk_raise_dead_AuraScript : public AuraScript {
                                ...
                                AuraEffectHandleModes /*mode*/)
        {
            ...
            GetUnitOwner()->SummonCreature(NPC_RISEN_DRAKKARI_WARRIOR,
                                           *GetUnitOwner());
        }
        ...
        void Register() override
        {
            AfterEffectRemove += AuraEffectRemoveFn(
                spell_dtk_raise_dead_AuraScript::HandleEffectRemove,
                EFFECT_0,
                SPELL_AURA_DUMMY,
...
public:
    spell_dtk_summon_random_drakkari()
        : SpellScriptLoader("spell_dtk_summon_random_drakkari")
    {
    }
    ...
    class spell_dtk_summon_random_drakkari_SpellScript : public SpellScript {
        ...
        void HandleScriptEffect(SpellEffIndex /*effIndex*/)
        {
            GetCaster()->CastSpell(GetCaster(),
                                   RAND(SPELL_SUMMON_DRAKKARI_SHAMAN,
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_dtk_summon_random_drakkari_SpellScript::
                                  HandleScriptEffect,
                              EFFECT_0,
