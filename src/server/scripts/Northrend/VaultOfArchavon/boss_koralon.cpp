...
enum Spells {
    ...
    SPELL_FLAMING_CINDER_MISSILE =
        66682, // trigger of missile handled by spell_difficulty
...
public:
    ...
    class spell_voa_flaming_cinder_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget +=
                SpellEffectFn(spell_voa_flaming_cinder_SpellScript::HandleDummy,
                              EFFECT_0,
                              SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_koralon_meteor_fists()
        : SpellScriptLoader("spell_koralon_meteor_fists")
    {
    }
...
public:
    spell_flame_warder_meteor_fists()
        : SpellScriptLoader("spell_flame_warder_meteor_fists")
    {
    }
