    ...
    struct boss_emalonAI : public ScriptedAI {
        ...
        void ResetSummons()
        {
            ...
            for (uint8 i = 0; i < MAX_TEMPEST_MINIONS; ++i)
                me->SummonCreature(NPC_TEMPEST_MINION,
                                   TempestMinions[i],
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_LIGHTNING_NOVA:
                me->CastSpell(
                    me,
                    RAID_MODE(SPELL_LIGHTNING_NOVA_10, SPELL_LIGHTNING_NOVA_25),
                    false);
                events.Repeat(40s);
                break;
            case EVENT_OVERCHARGE:
                if (!summons.empty())
                    me->CastCustomSpell(
                        SPELL_OVERCHARGE, SPELLVALUE_MAX_TARGETS, 1, me, true);
    ...
    class spell_voa_overcharge_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_voa_overcharge_AuraScript::HandlePeriodicDummy,
                EFFECT_2,
    ...
    class spell_voa_lightning_nova_SpellScript : public SpellScript {
        ...
        void HandleOnHit()
        {
            ...
            if (Unit* target = GetHitUnit()) {
                ...
                damage     = int32(GetHitDamage() *
                               (70.0f - std::min(70.0f, dist)) / 70.0f);
            }
        ...
        {
            OnHit +=
                SpellHitFn(spell_voa_lightning_nova_SpellScript::HandleOnHit);
        }
    };
