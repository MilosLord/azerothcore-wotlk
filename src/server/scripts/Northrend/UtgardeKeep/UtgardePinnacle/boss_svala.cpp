...
const Position RitualChannelerLoc[3] = {{296.42f, -355.01f, 90.94f, 0.0f},
...
public:
    ...
    struct boss_svalaAI : public ScriptedAI {
        ...
        {
            if (data != 1 || param != 1 || Started ||
                (instance && instance->GetData(DATA_SVALA_SORROWGRAVE) == DONE))
                return;
            ...
            if (instance) {
                ...
                if (GameObject* mirror = ObjectAccessor::GetGameObject(
                        *me, instance->GetGuidData(GO_SVALA_MIRROR)))
        ...
        void KilledUnit(Unit* victim) override
        {
            if (victim->GetEntry() == NPC_SCOURGE_HULK && instance) {
                ...
                instance->DoUpdateAchievementCriteria(
                    ACHIEVEMENT_CRITERIA_TYPE_KILL_CREATURE, 26555, 1, nullptr);
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SVALA_TALK1:
                if (Creature* Arthas =
                        ObjectAccessor::GetCreature(*me, ArthasGUID))
            ...
            case EVENT_SVALA_TALK2:
                if (Creature* Arthas =
                        ObjectAccessor::GetCreature(*me, ArthasGUID))
                    Arthas->CastSpell(
                        me, SPELL_ARTHAS_TRANSFORMING_SVALA, false);
            ...
            case EVENT_SVALA_TALK4: {
                ...
                me->SetCorpseDelay(
                    sWorld->getIntConfig(CONFIG_CORPSE_DECAY_ELITE));
                me->SetFloatValue(UNIT_FIELD_HOVERHEIGHT, 6.0f);
                me->SetImmuneToAll(true);
                if (Creature* Arthas =
                        ObjectAccessor::GetCreature(*me, ArthasGUID))
                ...
                me->GetCreaturesWithEntryInRange(
                    creatureList, 100.0f, NPC_DRAGONFLAYER_SPECTATOR);
            ...
            case EVENT_SORROWGRAVE_SS:
                me->CastSpell(me->GetVictim(),
                              IsHeroic() ? SPELL_SINSTER_STRIKE_H
            ...
            case EVENT_SORROWGRAVE_FLAMES2: {
                ...
                me->GetCreaturesWithEntryInRange(
                    braziers, 100.0f, NPC_FLAME_BRAZIER);
                if (!braziers.empty()) {
                    for (std::list<Creature*>::const_iterator itr =
                             braziers.begin();
                         itr != braziers.end();
                         ++itr)
                        (*itr)->CastCustomSpell(SPELL_BALL_OF_FLAME,
            ...
            case EVENT_SORROWGRAVE_RITUAL:
                if (Unit* target = SelectTarget(
                    ...
                    me->NearTeleportTo(
                        296.632f, -346.075f, 110.0f, 4.6f, false);
    ...
    class spell_svala_ritual_strike_SpellScript : public SpellScript {
        ...
        void HandleDummyEffect(SpellEffIndex /*effIndex*/)
        {
            if (Unit* unitTarget = GetHitUnit()) {
                ...
                Unit::DealDamage(
                    GetCaster(), unitTarget, 7000, nullptr, DIRECT_DAMAGE);
            }
        }
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_svala_ritual_strike_SpellScript::HandleDummyEffect,
                EFFECT_2,
                SPELL_EFFECT_DUMMY);
        }
    };
    ...
    class spell_svala_ritual_strike_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(
                spell_svala_ritual_strike_AuraScript::CalculateAmount,
                EFFECT_1,
