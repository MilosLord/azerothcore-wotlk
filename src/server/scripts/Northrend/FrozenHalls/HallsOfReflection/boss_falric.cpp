...
const uint32 hopelessnessId[3][2] = {
    {72395, 72390}, {72396, 72391}, {72397, 72393}};
...
public:
    ...
    struct boss_falricAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if ((uiHopelessnessCount == 0 && HealthBelowPct(67)) ||
                (uiHopelessnessCount == 1 && HealthBelowPct(34)) ||
                (uiHopelessnessCount == 2 && HealthBelowPct(11))) {
                if (uiHopelessnessCount)
                    me->RemoveOwnedAura(hopelessnessId[uiHopelessnessCount - 1]
                                                      [DUNGEON_MODE(0, 1)]);
                me->CastSpell(
                    (Unit*)nullptr,
                    hopelessnessId[uiHopelessnessCount][DUNGEON_MODE(0, 1)],
                    true);
                ++uiHopelessnessCount;
            }
...
void AddSC_boss_falric() { new boss_falric(); }
