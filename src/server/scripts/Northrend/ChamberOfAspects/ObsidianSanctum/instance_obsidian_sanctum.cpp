...
BossBoundaryData const boundaries = {
    {DATA_SARTHARION,
     new RectangleBoundary(3218.86f, 3275.69f, 484.68f, 572.4f)}};

class instance_obsidian_sanctum : public InstanceMapScript {
public:
    instance_obsidian_sanctum()
        : InstanceMapScript("instance_obsidian_sanctum", 615)
    {
    }
    ...
    struct instance_obsidian_sanctum_InstanceMapScript : public InstanceScript {
        instance_obsidian_sanctum_InstanceMapScript(Map* pMap)
            : InstanceScript(pMap), portalCount(0)
        {
                                          ...
                                          uint32 /*miscvalue1*/) override
        {
            ...
            case 7327: {
                Creature const* sartharion =
                    instance->GetCreature(m_uiSartharionGUID);
                return sartharion && !sartharion->AI()->GetData(
                                         source->GetGUID().GetCounter());
            }
            ...
            case 7331: {
                Creature const* sartharion =
                    instance->GetCreature(m_uiSartharionGUID);
                return sartharion && sartharion->AI()->GetData(
                                         DATA_ACHIEVEMENT_DRAGONS_COUNT) >= 1;
            }
            ...
            case 7332: {
                Creature const* sartharion =
                    instance->GetCreature(m_uiSartharionGUID);
                return sartharion && sartharion->AI()->GetData(
                                         DATA_ACHIEVEMENT_DRAGONS_COUNT) >= 2;
            }
            ...
            case 7333: {
                Creature const* sartharion =
                    instance->GetCreature(m_uiSartharionGUID);
                return sartharion && sartharion->AI()->GetData(
                                         DATA_ACHIEVEMENT_DRAGONS_COUNT) >= 3;
            }
            }
        ...
        void DoAction(int32 action) override
        {
                ...
                if (!m_uiPortalGUID) {
                    if (Creature* sartharion =
                        ...
                        if (GameObject* portal =
                                sartharion->SummonGameObject(GO_TWILIGHT_PORTAL,
                                                             3247.29f,
                                                             529.804f,
                                                             58.9595f,
                                                             0.0f,
            ...
            case ACTION_CLEAR_PORTAL: {
                ...
                if (!portalCount) {
                    if (GameObject* go =
                            instance->GetGameObject(m_uiPortalGUID)) {
                        go->Delete();
                    }
...
void AddSC_instance_obsidian_sanctum() { new instance_obsidian_sanctum(); }
