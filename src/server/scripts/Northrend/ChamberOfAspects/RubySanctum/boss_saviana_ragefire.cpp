...
public:
    ...
    struct boss_saviana_ragefireAI : public BossAI {
        boss_saviana_ragefireAI(Creature* creature)
            : BossAI(creature, DATA_SAVIANA_RAGEFIRE)
        {
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_FLIGHT: {
                ...
                me->GetMotionMaster()->MovePoint(POINT_TAKEOFF,
                                                 me->GetPositionX(),
                                                 me->GetPositionY(),
                                                 me->GetPositionZ() + 6.0f,
                                                 false);
            ...
            case EVENT_CONFLAGRATION:
                me->CastCustomSpell(SPELL_CONFLAGRATION,
            ...
            case EVENT_AIR_MOVEMENT:
                me->GetMotionMaster()->MovePoint(
                    POINT_FLIGHT, 3155.51f, 683.844f, 95.0f, false);
                break;
            case EVENT_LAND_BACK:
                me->GetMotionMaster()->MovePoint(
                    POINT_LAND, 3151.07f, 636.443f, 80.0f, false);
                break;
...
public:
    spell_saviana_conflagration_init()
        : SpellScriptLoader("spell_saviana_conflagration_init")
    {
    }
    ...
    class spell_saviana_conflagration_init_SpellScript : public SpellScript {
        ...
        void HandleDummy(SpellEffIndex effIndex)
        {
            ...
            GetCaster()->CastSpell(
                GetHitUnit(), SPELL_CONFLAGRATION_MISSLE, true);
        }

        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_saviana_conflagration_init_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_saviana_conflagration_throwback()
        : SpellScriptLoader("spell_saviana_conflagration_throwback")
    {
    }

    class spell_saviana_conflagration_throwback_SpellScript
        : public SpellScript {
