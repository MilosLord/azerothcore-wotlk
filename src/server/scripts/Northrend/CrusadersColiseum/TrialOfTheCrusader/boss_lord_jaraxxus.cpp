    ...
    struct boss_jaraxxusAI : public ScriptedAI {
        ...
        void Reset() override
        {
            ...
            me->GetCreatureListWithEntryInGrid(
                creatures, NPC_INFERNAL_VOLCANO, 500.f);
            me->GetCreatureListWithEntryInGrid(
                creatures, NPC_NETHER_PORTAL, 500.f);
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            //   events.RescheduleEvent(EVENT_SPELL_TOUCH_OF_JARAXXUS, 10s,
            //   15s);
            events.RescheduleEvent(EVENT_SUMMON_NETHER_PORTAL,
                                   20s); // it schedules EVENT_SUMMON_VOLCANO
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_FEL_LIGHTNING:
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 0, 0.0f, true, true))
            ...
            case EVENT_SUMMON_NETHER_PORTAL:
                ...
                me->CastSpell(
                    (Unit*)nullptr, SPELL_SUMMON_NETHER_PORTAL, false);
    ...
    struct npc_fel_infernalAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_SPELL_FEL_STEAK:
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 0, 44.0f, true)) {
                    DoResetThreatList();
    ...
    class spell_toc25_mistress_kiss_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(
                spell_toc25_mistress_kiss_AuraScript::HandleEffectPeriodic,
                EFFECT_0,
    ...
    class spell_mistress_kiss_area_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
                spell_mistress_kiss_area_SpellScript::FilterTargets,
                EFFECT_0,
                TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget += SpellEffectFn(
                spell_mistress_kiss_area_SpellScript::HandleScript,
                EFFECT_0,
