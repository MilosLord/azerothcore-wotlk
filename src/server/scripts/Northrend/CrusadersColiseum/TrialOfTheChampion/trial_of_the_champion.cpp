...
public:
                        ...
                        uint32 uiAction) override
    {
        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 1 ||
            ...
            pInstance->SetData(
                ...
                (uiAction == GOSSIP_ACTION_INFO_DEF + 2 ? 1 : 0));
    ...
    struct npc_announcer_toc5AI : public CreatureAI {
        ...
        void Reset() override
        {
            ...
            me->SetUnitFlag(
                UNIT_FLAG_NON_ATTACKABLE); // removed during black knight scene
        }
        ...
        {
            if (damage >=
                me->GetHealth()) // for bk scene so strangulate doesn't kill him
...
void AddSC_trial_of_the_champion() { new npc_announcer_toc5(); }
