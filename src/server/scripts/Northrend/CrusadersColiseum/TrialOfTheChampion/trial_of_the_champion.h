...
enum eNpcs {
    ...
    NPC_TIRION = 33628, // Possibly wrong npc here, 34996 had already populated
                        // creature_text (from ToC25) that matches. Needs a
                        // sniff to confirm.

    /// @todo: Argent Raid Spectator - FX - Missing spawns for Toc5 (map 650),
    /// ToC25 probably matches positions, needs a sniff to confirm.
    // Horde
...
enum eTexts {
    ...
    // Announcers: Alliance Announcer - Arelas Brightstar && Horde Announcer -
    // Jaeren Sunsworn
    ...
    SAY_EADRIC_KILL_PLAYER = 5, // "You! You need more practice." && "Nay, nay,
                                // and I say yet again nay! Not good enough."
