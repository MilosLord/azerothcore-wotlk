        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_BOULDER: {
                if (Unit* target = SelectTarget(
                    ...
                    me->CastSpell(target,
                                  DUNGEON_MODE(BOULDER_TOSS, BOULDER_TOSS_H),
                                  false);
            ...
            case EVENT_SHATTER: {
                me->CastSpell(
                    (Unit*)nullptr, DUNGEON_MODE(SHATTER, SHATTER_H), false);
                Talk(SAY_SHATTER);
    ...
    class spell_krystallus_shatter_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_krystallus_shatter_SpellScript::HandleScript,
                EFFECT_0,
...
public:
    ...
    class spell_krystallus_shatter_effect_SpellScript : public SpellScript {
        ...
        {
            OnHit += SpellHitFn(
                spell_krystallus_shatter_effect_SpellScript::CalculateDamage);
        }
    };
