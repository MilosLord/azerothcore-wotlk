    ...
    struct boss_lokenAI : public ScriptedAI {
        ...
        void Reset() override
        {
            ...
            if (m_pInstance) {
                m_pInstance->DoStopTimedAchievement(
                    ACHIEVEMENT_TIMED_TYPE_EVENT, ACHIEVEMENT_TIMELY_DEATH);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_LIGHTNING_NOVA:
                ...
                events.ScheduleEvent(EVENT_AURA_REMOVE,
                                     me->GetMap()->IsHeroic() ? 4s : 5s);

                me->CastSpell(me,
                              me->GetMap()->IsHeroic() ? SPELL_LIGHTNING_NOVA_H
            ...
            case EVENT_ARC_LIGHTNING:
                if (Unit* target =
                        SelectTargetFromPlayerList(100, SPELL_ARC_LIGHTNING))
...
public:
    spell_loken_pulsing_shockwave()
        : SpellScriptLoader("spell_loken_pulsing_shockwave")
    {
    }
    ...
    class spell_loken_pulsing_shockwave_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_loken_pulsing_shockwave_SpellScript::CalculateDamage,
                EFFECT_0,
