...
public:
    ...
    struct boss_volkhanAI : public ScriptedAI {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_HEAT:
                me->CastSpell(me,
                              me->GetMap()->IsHeroic() ? SPELL_HEAT_H
                                                       : SPELL_HEAT_N,
                              true);
                events.Repeat(8s);
                break;
    ...
    struct npc_molten_golemAI : public ScriptedAI {
        ...
        void DoAction(int32 param) override
        {
            if (me->GetEntry() == NPC_BRITTLE_GOLEM &&
                ...
                if (Creature* volkhan = ObjectAccessor::GetCreature(
                        *me, m_pInstance->GetGuidData(TYPE_VOLKHAN)))
                    volkhan->AI()->DoAction(ACTION_DESTROYED);

                me->CastSpell(me,
                              me->GetMap()->IsHeroic() ? SPELL_SHATTER_H
                                                       : SPELL_SHATTER_N,
                              true);
    ...
    struct npc_hol_monumentAI : public ScriptedAI {
        ...
        void MoveInLineOfSight(Unit* who) override
        {
            if (_attackGUID)
                ...
                if ((who->GetPositionX() < me->GetPositionX() ||
                     who->GetPositionY() < -220.0f) &&
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_BLADE_TURNING:
                me->CastSpell(me->GetVictim(),
                              me->GetMap()->IsHeroic() ? SPELL_BLADE_TURNING_H
            ...
            case EVENT_THROW:
                me->CastSpell(
                    SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true, 0),
            ...
            case EVENT_DEADLY_THROW:
                me->CastSpell(
                    SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true, 0),
                    me->GetMap()->IsHeroic() ? SPELL_DEADLY_THROW_H
            ...
            case EVENT_DEFLECTION:
                me->CastSpell(me,
                              me->GetMap()->IsHeroic() ? SPELL_DEFLECTION_H
                                                       : SPELL_DEFLECTION_N,
                              false);
                events.Repeat(15s);
                break;
