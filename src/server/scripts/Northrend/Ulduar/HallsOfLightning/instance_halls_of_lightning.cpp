...
public:
    instance_halls_of_lightning()
        : InstanceMapScript("instance_halls_of_lightning", 602)
    {
    }
    ...
    struct instance_halls_of_lightning_InstanceMapScript
        ...
        void SetData(uint32 uiType, uint32 uiData) override
        {
            ...
            case TYPE_LOKEN:
                ...
                // Appears to be type 5 GO with animation. Need to figure out
                // how this work, code below only placeholder
                if (GameObject* pGlobe =
                        instance->GetGameObject(m_uiLokenGlobeGUID))
...
void AddSC_instance_halls_of_lightning() { new instance_halls_of_lightning(); }
