...
#define SPELL_GROUND_TREMOR                                                    \
    RAID_MODE(SPELL_GROUND_TREMOR_10, SPELL_GROUND_TREMOR_25)
#define SPELL_PETRIFIED_BARK                                                   \
...
#define SPELL_UNSTABLE_SUN_DAMAGE                                              \
    RAID_MODE(SPELL_UNSTABLE_SUN_DAMAGE_10, SPELL_UNSTABLE_SUN_DAMAGE_25)
#define SPELL_SOLAR_FLARE RAID_MODE(SPELL_SOLAR_FLARE_10, SPELL_SOLAR_FLARE_25)
#define SPELL_TOUCH_OF_EONAR                                                   \
    RAID_MODE(SPELL_TOUCH_OF_EONAR_10, SPELL_TOUCH_OF_EONAR_25)
#define SPELL_LIFEBINDER_HEAL                                                  \
    RAID_MODE(SPELL_LIFEBINDER_HEAL_10, SPELL_LIFEBINDER_HEAL_25)
#define SPELL_TIDAL_WAVE RAID_MODE(SPELL_TIDAL_WAVE_10, SPELL_TIDAL_WAVE_25)
#define SPELL_TIDAL_WAVE_DAMAGE                                                \
    RAID_MODE(SPELL_TIDAL_WAVE_DAMAGE_10, SPELL_TIDAL_WAVE_DAMAGE_25)
#define SPELL_NATURE_FURY RAID_MODE(SPELL_NATURE_FURY_10, SPELL_NATURE_FURY_25)
#define SPELL_HARDENED_BARK                                                    \
    RAID_MODE(SPELL_HARDENED_BARK_10, SPELL_HARDENED_BARK_25)
#define SPELL_DETONATE RAID_MODE(SPELL_DETONATE_10, SPELL_DETONATE_25)
// #define SPELL_NATURE_BOMB_DAMAGE RAID_MODE(SPELL_NATURE_BOMB_DAMAGE_10,
...
#define SPELL_GROUND_TREMOR_FREYA                                              \
    RAID_MODE(SPELL_GROUND_TREMOR_FREYA_10, SPELL_GROUND_TREMOR_FREYA_25)
#define SPELL_IRON_ROOTS_FREYA                                                 \
    RAID_MODE(SPELL_IRON_ROOTS_FREYA_10, SPELL_IRON_ROOTS_FREYA_25)
#define SPELL_UNSTABLE_SUN_FREYA_DAMAGE                                        \
    RAID_MODE(SPELL_UNSTABLE_SUN_FREYA_DAMAGE_10,                              \
              SPELL_UNSTABLE_SUN_FREYA_DAMAGE_25)
#define SPELL_LIGHTNING_LASH                                                   \
    RAID_MODE(SPELL_LIGHTNING_LASH_10, SPELL_LIGHTNING_LASH_25)
    ...
    struct boss_freyaAI : public ScriptedAI {
        ...
        void Reset() override
        {
            ...
            for (uint8 i = 0; i < 3; ++i) {
                ...
                if (Creature* elder =
                        ObjectAccessor::GetCreature(*me, _elderGUID[i]))
                         ...
                         SpellSchoolMask) override
        {
            if (damage >= me->GetHealth()) {
                ...
                if (m_pInstance->GetData(TYPE_FREYA) != DONE) {
                    ...
                    uint32 chestId =
                        RAID_MODE(GO_FREYA_CHEST, GO_FREYA_CHEST_HERO);
        ...
        void SpawnWave()
        {
            ...
            if (_waveNumber == 1) {
                ...
                me->SummonCreature(NPC_ANCIENT_WATER_SPIRIT,
                                   me->GetPositionX() + urand(5, 15),
                                   me->GetPositionY() + urand(5, 15),
                                   me->GetMapHeight(me->GetPositionX(),
                                                    me->GetPositionY(),
                                                    me->GetPositionZ()));
                me->SummonCreature(NPC_STORM_LASHER,
                                   me->GetPositionX() + urand(5, 15),
                                   me->GetPositionY() + urand(5, 15),
                                   me->GetMapHeight(me->GetPositionX(),
                                                    me->GetPositionY(),
                                                    me->GetPositionZ()));
                me->SummonCreature(NPC_SNAPLASHER,
                                   me->GetPositionX() + urand(5, 15),
                                   me->GetPositionY() + urand(5, 15),
                                   me->GetMapHeight(me->GetPositionX(),
                                                    me->GetPositionY(),
            ...
            // Ancient Conservator
                ...
                me->SummonCreature(NPC_ANCIENT_CONSERVATOR,
                                   me->GetPositionX() + urand(5, 15),
                                   me->GetPositionY() + urand(5, 15),
                                   me->GetMapHeight(me->GetPositionX(),
                                                    me->GetPositionY(),
            ...
            // Detonating Lashers
                ...
                for (uint8 i = 0; i < 10; ++i)
                    me->SummonCreature(NPC_DETONATING_LASHER,
                                       me->GetPositionX() + urand(5, 20),
                                       me->GetPositionY() + urand(5, 20),
                                       me->GetMapHeight(me->GetPositionX(),
                                                        me->GetPositionY(),
                                                        me->GetPositionZ()),
                                       0,
            ...
            if (param == ACTION_LUMBERJACKED) {
                ...
                if (_lumberjacked == 1)
                    m_pInstance->DoStartTimedAchievement(
                        ACHIEVEMENT_TIMED_TYPE_EVENT, CRITERIA_LUMBERJACKED);
                else if (_lumberjacked == 3)
                    m_pInstance->DoUpdateAchievementCriteria(
                        ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET,
                        65296 /*SPELL_LUMBERJACKED*/,
                        0,
                        me);
                return;
            }
        ...
        void JustEngagedWith(Unit*) override
        {
            ...
            events.ScheduleEvent(
                EVENT_FREYA_ADDS_SPAM, 10s, 0, EVENT_PHASE_ADDS);
            ...
            // HARD MODE CHECKS
            Creature* elder = ObjectAccessor::GetCreature(
                *me, m_pInstance->GetGuidData(NPC_ELDER_STONEBARK));
            ...
            elder = ObjectAccessor::GetCreature(
                *me, m_pInstance->GetGuidData(NPC_ELDER_IRONBRANCH));
            if (elder && elder->IsAlive()) {
                elder->CastSpell(elder, SPELL_DRAINED_OF_POWER, true);
            ...
            elder = ObjectAccessor::GetCreature(
                *me, m_pInstance->GetGuidData(NPC_ELDER_BRIGHTLEAF));
            if (elder && elder->IsAlive()) {
                elder->CastSpell(elder, SPELL_DRAINED_OF_POWER, true);
        ...
        void SpellHitTarget(Unit* target, SpellInfo const* spell) override
        {
            if (spell->Id == SPELL_NATURE_BOMB_FLIGHT)
                me->SummonCreature(NPC_NATURE_BOMB,
                                   target->GetPositionX(),
                                   target->GetPositionY(),
                                   target->GetPositionZ());
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_FREYA_NATURE_BOMB: {
                uint8 _minCount =
                    me->GetMap()->Is25ManRaid() ? urand(7, 10) : urand(3, 4);
                Map::PlayerList const& pList = me->GetMap()->GetPlayers();
                for (Map::PlayerList::const_iterator itr = pList.begin();
                     itr != pList.end();
                     ++itr) {
                    if (me->GetDistance(itr->GetSource()) > 70 ||
                        !itr->GetSource()->IsAlive())
                        continue;

                    me->CastSpell(
                        itr->GetSource(), SPELL_NATURE_BOMB_FLIGHT, true);
            ...
            case EVENT_FREYA_IRON_ROOT:
                ...
                me->CastCustomSpell(SPELL_IRON_ROOTS_FREYA,
            ...
            case EVENT_FREYA_UNSTABLE_SUN_BEAM:
                me->SummonCreature(NPC_FREYA_UNSTABLE_SUN_BEAM,
                                   me->GetPositionX() + urand(7, 25),
                                   me->GetPositionY() + urand(7, 25),
                                   me->GetMapHeight(me->GetPositionX(),
                                                    me->GetPositionY(),
                                                    me->GetPositionZ()),
                                   0,
...
public:
    ...
    struct boss_freya_elder_stonebarkAI : public ScriptedAI {
        boss_freya_elder_stonebarkAI(Creature* pCreature)
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (me->GetInstanceScript())
                if (Creature* freya = ObjectAccessor::GetCreature(
                        *me, me->GetInstanceScript()->GetGuidData(TYPE_FREYA)))
        ...
        void JustEngagedWith(Unit*) override
        {
            ...
            if (!me->HasAura(
                    SPELL_DRAINED_OF_POWER)) // Prevents speech if combat is
                                             // initiated by hardmode activation
                         ...
                         SpellSchoolMask  damageSchoolMask) override
        {
            if ((damageType == DIRECT_DAMAGE ||
                 (damageType == SPELL_DIRECT_DAMAGE &&
                  damageSchoolMask & SPELL_SCHOOL_MASK_NORMAL)) &&
                _chargesCount) {
                --_chargesCount;
                damage = 0;
            }
...
public:
    boss_freya_elder_brightleaf()
        : CreatureScript("boss_freya_elder_brightleaf")
    {
    }
    ...
    struct boss_freya_elder_brightleafAI : public ScriptedAI {
        boss_freya_elder_brightleafAI(Creature* pCreature)
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_BRIGHTLEAF_SOLAR_FLARE:
                if (Aura* aur = me->GetAura(SPELL_BRIGHTLEAF_FLUX)) {
                    me->CastCustomSpell(SPELL_SOLAR_FLARE,
                                        SPELLVALUE_MAX_TARGETS,
                                        aur->GetStackAmount(),
                                        me,
                                        false);
            ...
            case EVENT_BRIGHTLEAF_DESPAWN_SUN_BEAM:
                for (SummonList::iterator i = summons.begin();
                    ...
                    if (summon)
                        summon->CastSpell(
                            summon, SPELL_UNSTABLE_SUN_DAMAGE, false);
                }
...
public:
    boss_freya_elder_ironbranch()
        : CreatureScript("boss_freya_elder_ironbranch")
    {
    }
    ...
    struct boss_freya_elder_ironbranchAI : public ScriptedAI {
        boss_freya_elder_ironbranchAI(Creature* pCreature)
            : ScriptedAI(pCreature)
        {
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_IRONBRANCH_IRON_ROOT:
                me->CastCustomSpell(
                    SPELL_IRON_ROOTS, SPELLVALUE_MAX_TARGETS, 1, me, false);
                events.Repeat(20s);
                break;
    ...
    struct boss_freya_iron_rootAI : public NullCreatureAI {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (Unit* target = ObjectAccessor::GetUnit(
                    *me, me->ToTempSummon()->GetSummonerGUID())) {
                if (me->GetEntry() ==
                    NPC_IRON_ROOT_TRIGGER) // Iron Branch spell
                    target->RemoveAura(target->GetMap()->Is25ManRaid()
...
public:
    ...
    struct boss_freya_healthy_sporeAI : public NullCreatureAI {
        boss_freya_healthy_sporeAI(Creature* pCreature)
...
public:
    ...
    struct boss_freya_summonsAI : public ScriptedAI {
        ...
        {
            _freyaGUID = me->GetInstanceScript()
                             ? me->GetInstanceScript()->GetGuidData(TYPE_FREYA)
                             : ObjectGuid::Empty;
            _isTrio    = me->GetEntry() == NPC_ANCIENT_WATER_SPIRIT ||
                      me->GetEntry() == NPC_STORM_LASHER ||
                      me->GetEntry() == NPC_SNAPLASHER;
            _hasDied = false;
        }
        ...
        {
            if (Creature* freya =
                    ObjectAccessor::GetCreature(*me, _freyaGUID)) {
                if (!_hasDied)
        ...
        void JustEngagedWith(Unit*) override
        {
            if (me->GetEntry() == NPC_ANCIENT_CONSERVATOR) {
                ...
                events.ScheduleEvent(EVENT_ANCIENT_CONSERVATOR_NATURE_FURY,
                                     14s);
...
public:
    ...
    struct boss_freya_nature_bombAI : public NullCreatureAI {
        boss_freya_nature_bombAI(Creature* pCreature)
            : NullCreatureAI(pCreature)
        {
            _goGUID.Clear();
        }
        ...
        void Reset() override
        {
            ...
            _explodeTimer = 0;
            if (GameObject* go = me->SummonGameObject(194902 /*GO_NATURE_BOMB*/,
                                                      me->GetPositionX(),
                                                      me->GetPositionY(),
                                                      me->GetPositionZ(),
                                                      0,
...
public:
    achievement_freya_getting_back_to_nature()
        : AchievementCriteriaScript("achievement_freya_getting_back_to_nature")
    {
    }
...
public:
    achievement_freya_knock_on_wood(char const* name, uint32 count)
        : AchievementCriteriaScript(name), _elderCount(count)
    {
    }
    ...
    {
        return target &&
               _elderCount <= target->GetAI()->GetData(DATA_GET_ELDER_COUNT);
    }
...
void AddSC_boss_freya()
{
    ...
    new achievement_freya_knock_on_wood("achievement_freya_knock_knock_on_wood",
                                        2);
    new achievement_freya_knock_on_wood(
        "achievement_freya_knock_knock_knock_on_wood", 3);
}
