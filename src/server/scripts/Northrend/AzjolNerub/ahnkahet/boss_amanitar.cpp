...
struct boss_amanitar : public BossAI {
    boss_amanitar(Creature* creature)
        : BossAI(creature, DATA_AMANITAR), mushroomsSummoned(false)
    {
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case EVENT_MINI: {
            ...
            if (SelectTarget(SelectTargetMethod::Random,
                             0,
                             0.0f,
                             true,
                             true,
...
private:
    ...
    {
        me->SummonCreature(roll_chance_i(40) ? NPC_HEALTHY_MUSHROOM
...
class spell_amanitar_remove_mushroom_power : public AuraScript {
    ...
    {
        OnEffectApply +=
            AuraEffectApplyFn(spell_amanitar_remove_mushroom_power::HandleApply,
                              EFFECT_0,
                              SPELL_AURA_DUMMY,
