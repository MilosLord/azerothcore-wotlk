...
BossBoundaryData const boundaries = {
    {DATA_KRIKTHIR_THE_GATEWATCHER_EVENT,
     new RectangleBoundary(400.0f, 580.0f, 623.5f, 810.0f)},
    {DATA_HADRONOX_EVENT, new ZRangeBoundary(666.0f, 776.0f)},
    {DATA_ANUBARAK_EVENT,
     new CircleBoundary(Position(550.6178f, 253.5917f), 26.0f)}};
    ...
    struct instance_azjol_nerub_InstanceScript : public InstanceScript {
        ...
        void OnCreatureCreate(Creature* creature) override
        {
            ...
            case NPC_SKITTERING_INFECTIOR:
                if (Creature* krikthir =
                        GetCreature((DATA_KRIKTHIR_THE_GATEWATCHER_EVENT)))
    ...
    class spell_azjol_nerub_fixate_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_azjol_nerub_fixate_SpellScript::HandleScriptEffect,
                EFFECT_0,
    ...
    class spell_azjol_nerub_web_wrap_AuraScript : public AuraScript {
        ...
        void Register() override
        {
            OnEffectRemove += AuraEffectRemoveFn(
                spell_azjol_nerub_web_wrap_AuraScript::OnRemove,
                EFFECT_0,
                SPELL_AURA_MOD_ROOT,
