...
public:
    ...
    struct boss_krik_thirAI : public BossAI {
        boss_krik_thirAI(Creature* creature)
            : BossAI(creature, DATA_KRIKTHIR_THE_GATEWATCHER_EVENT)
        {
            _initTalk = false;
        }
        ...
        void Reset() override
        {
            ...
            me->SummonCreature(NPC_WATCHER_NARJIL,
                               511.8f,
                               666.493f,
                               776.278f,
                               0.977f,
                               ...
                               30000);
            me->SummonCreature(NPC_SHADOWCASTER,
                               511.63f,
                               672.44f,
                               775.71f,
                               0.90f,
            ...
            me->SummonCreature(NPC_WARRIOR,
                               ...
                               TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                               30000);
            me->SummonCreature(NPC_WATCHER_GASHRA,
                               526.66f,
                               663.605f,
                               775.805f,
                               1.23f,
                               TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                               30000);
            me->SummonCreature(NPC_SKIRMISHER,
                               522.91f,
                               660.18f,
                               776.19f,
                               1.28f,
            ...
            me->SummonCreature(NPC_WARRIOR,
                               ...
                               TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                               30000);
            me->SummonCreature(NPC_WATCHER_SILTHIK,
                               543.826f,
                               665.123f,
                               776.245f,
                               1.55f,
        ...
        {
            if (data == me->GetEntry())
                return summons.HasEntry(NPC_WATCHER_NARJIL) &&
                       summons.HasEntry(NPC_WATCHER_GASHRA) &&
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_KRIK_START_WAVE:
                me->CastCustomSpell(SPELL_SUBBOSS_AGGRO_TRIGGER,
...
public:
    achievement_watch_him_die()
        : AchievementCriteriaScript("achievement_watch_him_die")
    {
    }
