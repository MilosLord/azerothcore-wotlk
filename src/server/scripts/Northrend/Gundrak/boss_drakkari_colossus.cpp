...
static Position mojoPosition[] = {{1663.1f, 743.6f, 143.1f, 0.0f},
...
public:
    ...
    struct boss_drakkari_colossusAI : public BossAI {
        boss_drakkari_colossusAI(Creature* creature)
            : BossAI(creature, DATA_DRAKKARI_COLOSSUS)
        {
        }
        ...
        void JustSummoned(Creature* summon) override
        {
            if (summon->GetEntry() == NPC_DRAKKARI_ELEMENTAL) {
                ...
                summon->m_Events.AddEvent(new RestoreFight(summon),
                                          summon->m_Events.CalculateTime(3000));
...
public:
    ...
    struct boss_drakkari_elementalAI : public ScriptedAI {
        ...
        void JustDied(Unit*) override { Talk(EMOTE_ALTAR); }
        ...
        void DoAction(int32 param) override
        {
            if (param == ACTION_MERGE) {
                ...
                me->GetMotionMaster()->MoveCharge(
                    1672.96f, 743.488f, 143.338f, 7.0f, POINT_MERGE);
...
public:
    spell_drakkari_colossus_emerge()
        : SpellScriptLoader("spell_drakkari_colossus_emerge")
    {
    }
    ...
    class spell_drakkari_colossus_emerge_SpellScript : public SpellScript {
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_drakkari_colossus_emerge_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_drakkari_colossus_surge()
        : SpellScriptLoader("spell_drakkari_colossus_surge")
    {
    }
    ...
    class spell_drakkari_colossus_surge_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_drakkari_colossus_surge_SpellScript::HandleDummy,
                EFFECT_0,
                SPELL_EFFECT_DUMMY);
        }
    };
...
public:
    spell_drakkari_colossus_face_me()
        : SpellScriptLoader("spell_drakkari_colossus_face_me")
    {
    }
    ...
    class spell_drakkari_colossus_face_me_SpellScript : public SpellScript {
        ...
        {
            OnEffectHitTarget += SpellEffectFn(
                spell_drakkari_colossus_face_me_SpellScript::HandleScriptEffect,
                EFFECT_0,
