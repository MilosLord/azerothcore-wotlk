...
public:
    ...
    struct boss_eckAI : public BossAI {
        boss_eckAI(Creature* creature)
            : BossAI(creature, DATA_ECK_THE_FEROCIOUS)
        {
        }
        ...
        void InitializeAI() override
        {
            ...
            me->GetMotionMaster()->MovePoint(
                POINT_START, 1638.55f, 919.76f, 104.95f, false);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_ECK_SPRING:
                if (Unit* target = SelectTarget(
                        SelectTargetMethod::Random, 1, 30.0f, true)) {
...
void AddSC_boss_eck() { new boss_eck(); }
