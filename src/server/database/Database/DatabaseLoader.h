...
public:
    ...
    template <class T>
    DatabaseLoader& AddDatabase(DatabaseWorkerPool<T>& pool,
...
private:
    ...
    // Invokes all functions in the given queue and closes the databases on
    // errors. Returns false when there was an error.
