...
enum BG_IC_MaxSpawns {
    MAX_NORMAL_GAMEOBJECTS_SPAWNS =
        BG_IC_GO_DOODAD_ND_WINTERORC_WALL_GATEFX_DOOR03 + 1,
...
const ICNpc BG_IC_NpcSpawnlocs[MAX_NORMAL_NPCS_SPAWNS] = {
    {BG_IC_NPC_OVERLORD_AGMAR,
     ...
     -765.733f,
     70.0541f,
     0.0f}, // Overlord Agmar 1
    {BG_IC_NPC_HIGH_COMMANDER_HALFORD_WYRMBANE,
     NPC_HIGH_COMMANDER_HALFORD_WYRMBANE,
     224.983f,
     -831.573f,
     60.9034f,
     0.0f}, // High Commander Halford Wyrmbane 2
    {BG_IC_NPC_KOR_KRON_GUARD_1,
     NPC_KOR_KRON_GUARD,
     1296.01f,
     -773.256f,
...
const ICGo BG_IC_Teleporters[MAX_FORTRESS_TELEPORTERS_SPAWNS] = {
    ...
    {BG_IC_GO_TELEPORTER_1_2,
     ...
     -669.415f,
     48.2729f,
     0.104719f}, // Teleporter
    {BG_IC_GO_TELEPORTER_2_1,
     GO_TELEPORTER_2,
     1233.27f,
     -844.526f,
     48.8824f,
     -0.0174525f}, // Teleporter
    {BG_IC_GO_TELEPORTER_3_1,
     GO_TELEPORTER_3,
     311.92f,
     -913.972f,
...
const ICGo BG_IC_TeleporterEffects[MAX_FORTRESS_TELEPORTER_EFFECTS_SPAWNS] = {
    {BG_IC_GO_TELEPORTER_EFFECTS_A_1,
     ...
     -857.092f,
     48.51f,
     -1.62316f}, // Teleporter Effects (Alliance)
    {BG_IC_GO_TELEPORTER_EFFECTS_A_2,
     GO_TELEPORTER_EFFECTS_A,
     324.634f,
     -749.148f,
     49.359f,
     0.0174525f}, // Teleporter Effects (Alliance)
    {BG_IC_GO_TELEPORTER_EFFECTS_A_3,
     GO_TELEPORTER_EFFECTS_A,
     311.911f,
     -913.986f,
     48.8157f,
     3.08918f}, // Teleporter Effects (Alliance)
    {BG_IC_GO_TELEPORTER_EFFECTS_A_4,
     GO_TELEPORTER_EFFECTS_A,
     326.266f,
     -777.347f,
     49.0215f,
     3.12412f}, // Teleporter Effects (Alliance)
    {BG_IC_GO_TELEPORTER_EFFECTS_A_5,
     GO_TELEPORTER_EFFECTS_A,
     323.55f,
     -888.347f,
    ...
    {BG_IC_GO_TELEPORTER_EFFECTS_A_6,
     ...
     -859.378f,
     48.8989f,
     1.64061f}, // Teleporter Effects (Alliance)
    ...
    {BG_IC_GO_TELEPORTER_EFFECTS_H_1,
     ...
     -779.623f,
     48.6291f,
     1.62316f}, // Teleporter Effects (Horde)
    {BG_IC_GO_TELEPORTER_EFFECTS_H_2,
     GO_TELEPORTER_EFFECTS_H,
     1158.64f,
     -746.148f,
     48.6277f,
     -1.50098f}, // Teleporter Effects (Horde)
    {BG_IC_GO_TELEPORTER_EFFECTS_H_3,
     GO_TELEPORTER_EFFECTS_H,
     1233.25f,
     -844.573f,
     48.8836f,
     0.0174525f}, // Teleporter Effects (Horde)
    {BG_IC_GO_TELEPORTER_EFFECTS_H_4,
     GO_TELEPORTER_EFFECTS_H,
     1235.07f,
     -857.957f,
     48.9163f,
     3.05433f}, // Teleporter Effects (Horde)
    {BG_IC_GO_TELEPORTER_EFFECTS_H_5,
     GO_TELEPORTER_EFFECTS_H,
     1236.46f,
     -669.344f,
     48.2684f,
     0.087266f}, // Teleporter Effects (Horde)
    {BG_IC_GO_TELEPORTER_EFFECTS_H_6,
     GO_TELEPORTER_EFFECTS_H,
     1235.6f,
     -683.806f,
     49.3028f,
     -3.07177f} // Teleporter Effects (Horde)
};
...
const ICGo BG_IC_ObjSpawnlocs[MAX_NORMAL_GAMEOBJECTS_SPAWNS] = {
    {BG_IC_GO_ALLIANCE_GATE_1,
     ...
     -762.75f,
     48.9162f,
     -1.5708f}, // Alliance Gate || Left
    {BG_IC_GO_ALLIANCE_GATE_2,
     GO_ALLIANCE_GATE_2,
     351.024f,
     -903.326f,
     48.9247f,
     1.5708f}, // Alliance Gate || Right
    {BG_IC_GO_ALLIANCE_GATE_3,
     GO_ALLIANCE_GATE_3,
     413.479f,
     -833.95f,
     48.5238f,
     3.14159f}, // Alliance Gate || Front
    ...
    {BG_IC_GO_HORDE_GATE_1,
     ...
     -762.606f,
     47.5077f,
     3.14159f}, // Horde Gate || Front
    {BG_IC_GO_HORDE_GATE_2,
     GO_HORDE_GATE_2,
     1218.74f,
     -851.155f,
     48.2533f,
     -1.5708f}, // Horde Gate || Left
    {BG_IC_GO_HORDE_GATE_3,
     GO_HORDE_GATE_3,
     1217.9f,
     -676.948f,
     47.6341f,
     1.5708f}, // Horde Gate || Right
    ...
    {BG_IC_GO_HORDE_BANNER,
     ...
     -705.668f,
     48.9163f,
     -3.08918f}, // Horde Banner
    {BG_IC_GO_ALLIANCE_BANNER,
     GO_ALLIANCE_BANNER,
     299.153f,
     -784.589f,
     48.9162f,
     -0.157079f}, // Alliance Banner
    ...
    {BG_IC_GO_WORKSHOP_BANNER,
     ...
     -804.283f,
     6.45052f,
     1.6057f}, // Workshop Banner
    {BG_IC_GO_DOCKS_BANNER,
     GO_DOCKS_BANNER,
     726.385f,
     -360.205f,
     17.8153f,
     -1.62316f}, // Docks Banner
    {BG_IC_GO_HANGAR_BANNER,
     GO_HANGAR_BANNER,
     807.78f,
     -1000.07f,
     132.381f,
     -1.93732f}, // Hangar Banner
    {BG_IC_GO_QUARRY_BANNER,
     GO_QUARRY_BANNER,
     251.016f,
     -1159.32f,
     17.2376f,
     -2.25147f}, // Quarry Banner
    {BG_IC_GO_REFINERY_BANNER,
     GO_REFINERY_BANNER,
     1269.5f,
     -400.809f,
     37.6253f,
     -1.76278f}, // Refinery Banner
    ...
    {BG_IC_GO_DOODAD_HU_PORTCULLIS01_1,
     ...
     -780.724f,
     49.9482f,
     -2.52896f}, // Doodad_HU_Portcullis01
    {BG_IC_GO_DOODAD_HU_PORTCULLIS01_2,
     GO_DOODAD_HU_PORTCULLIS01,
     399.802f,
     -885.208f,
     50.1939f,
     2.516f}, // Doodad_HU_Portcullis01
    ...
    {BG_IC_GO_DOODAD_ND_HUMAN_GATE_CLOSEDFX_DOOR01,
     ...
     -833.95f,
     48.5238f,
     3.14159f}, // Doodad_ND_Human_Gate_ClosedFX_Door01
    {BG_IC_GO_DOODAD_ND_HUMAN_GATE_CLOSEDFX_DOOR02,
     GO_DOODAD_ND_HUMAN_GATE_CLOSEDFX_DOOR01,
     351.615f,
     -762.75f,
     48.91625f,
     4.71292f}, // Doodad_ND_Human_Gate_ClosedFX_Door01
    {BG_IC_GO_DOODAD_ND_HUMAN_GATE_CLOSEDFX_DOOR03,
     GO_DOODAD_ND_HUMAN_GATE_CLOSEDFX_DOOR01,
     351.024f,
     -903.33f,
     48.92472f,
     1.570796f}, // Doodad_ND_Human_Gate_ClosedFX_Door01
    ...
    {BG_IC_GO_DOODAD_PORTCULLISACTIVE01,
     ...
     51.4109f,
     -0.0261791f,
     0.0f}, // Doodad_PortcullisActive01
    ...
    {BG_IC_GO_DOODAD_PORTCULLISACTIVE02,
     ...
     -832.199f,
     51.4109f,
     -0.0261791f}, // Doodad_PortcullisActive02
    ...
    {BG_IC_GO_DOODAD_VR_PORTCULLIS01_1,
     ...
     -843.998f,
     48.6322f,
     0.732934f}, // Doodad_VR_Portcullis01
    {BG_IC_GO_DOODAD_VR_PORTCULLIS01_2,
     GO_DOODAD_VR_PORTCULLIS01,
     1157.05f,
     -682.36f,
     48.6322f,
     -0.829132f}, // Doodad_VR_Portcullis01
    ...
    {BG_IC_GO_HORDE_KEEP_PORTCULLIS,
     ...
     -765.878f,
     50.8297f,
     -3.13286f}, // Horde Keep Portcullis
...
const Position workshopBombs[2] = {{750.601f, -864.597f, 13.4754f, 1.93731f},
...
const uint32 BG_IC_GraveyardIds[MAX_NODE_TYPES + 2] = {
    0, 0, 1480, 1481, 1482, 1485, 1486, 1483, 1484};
...
struct ICNodePoint {
    uint32
        gameobject_type; // with this we will get the GameObject of that point
    uint32 gameobject_entry; // what gamoebject entry is active here.
    TeamId faction;          // who has this node
    ICNodePointType
           nodeType;   // here we can specify if it is graveyards, hangar etc...
    uint32 banners[4]; // the banners that have this point
    bool   needChange; // this is used for the 1 minute time period after the
                       // point is captured
...
public:
    ...
    void EventPlayerDamagedGO(Player* /*player*/,
                              GameObject* /*go*/,
                              uint32 /*eventType*/) override
    {
    }
    ...
    {
        return (uint8)nodePoint[nodeType].nodeState;
    }
...
private:
    ...
    uint32
    GetNextBanner(ICNodePoint* nodePoint, uint32 team, bool returnDefinitve);
    ...
    uint32 GetWorldStateFromGateEntry(uint32 id, bool open)
    {
        ...
        switch (id) {
        case GO_HORDE_GATE_1:
            uws = (open ? BG_IC_GATE_FRONT_H_WS_OPEN
                        : BG_IC_GATE_FRONT_H_WS_CLOSED);
            break;
        case GO_HORDE_GATE_2:
            uws = (open ? BG_IC_GATE_EAST_H_WS_OPEN
                        : BG_IC_GATE_EAST_H_WS_CLOSED);
            break;
        case GO_HORDE_GATE_3:
            uws = (open ? BG_IC_GATE_WEST_H_WS_OPEN
                        : BG_IC_GATE_WEST_H_WS_CLOSED);
            break;
        case GO_ALLIANCE_GATE_3:
            uws = (open ? BG_IC_GATE_FRONT_A_WS_OPEN
                        : BG_IC_GATE_FRONT_A_WS_CLOSED);
            break;
        case GO_ALLIANCE_GATE_1:
            uws = (open ? BG_IC_GATE_WEST_A_WS_OPEN
                        : BG_IC_GATE_WEST_A_WS_CLOSED);
            break;
        case GO_ALLIANCE_GATE_2:
            uws = (open ? BG_IC_GATE_EAST_A_WS_OPEN
