...
enum BG_EY_WorldStates {
    ...
    PROGRESS_BAR_STATUS = 2719, // 50 init!, 48 ... hordak bere .. 33 .. 0 =
                                // full 100% hordacky, 100 = full alliance
    PROGRESS_BAR_SHOW =
...
struct BattlegroundEYPointIconsStruct {
    BattlegroundEYPointIconsStruct(uint32 _WorldStateControlIndex,
...
struct BattlegroundEYLosingPointStruct {
    BattlegroundEYLosingPointStruct(uint32 _SpawnNeutralObjectType,
...
struct BattlegroundEYCapturingPointStruct {
    BattlegroundEYCapturingPointStruct(uint32 _DespawnNeutralObjectType,
        ...
        : DespawnNeutralObjectType(_DespawnNeutralObjectType),
          ...
          MessageIdHorde(_MessageIdHorde), GraveYardId(_GraveYardId)
    {
    }
...
const BattlegroundEYPointIconsStruct m_PointsIconStruct[EY_POINTS_MAX] = {
    BattlegroundEYPointIconsStruct(FEL_REAVER_UNCONTROL,
                                   FEL_REAVER_ALLIANCE_CONTROL,
                                   FEL_REAVER_HORDE_CONTROL),
    BattlegroundEYPointIconsStruct(BLOOD_ELF_UNCONTROL,
                                   BLOOD_ELF_ALLIANCE_CONTROL,
                                   BLOOD_ELF_HORDE_CONTROL),
    BattlegroundEYPointIconsStruct(DRAENEI_RUINS_UNCONTROL,
                                   DRAENEI_RUINS_ALLIANCE_CONTROL,
                                   DRAENEI_RUINS_HORDE_CONTROL),
    BattlegroundEYPointIconsStruct(MAGE_TOWER_UNCONTROL,
...
const BattlegroundEYLosingPointStruct m_LosingPointTypes[EY_POINTS_MAX] = {
    BattlegroundEYLosingPointStruct(BG_EY_OBJECT_N_BANNER_FEL_REAVER_CENTER,
    ...
    BattlegroundEYLosingPointStruct(BG_EY_OBJECT_N_BANNER_BLOOD_ELF_CENTER,
    ...
    BattlegroundEYLosingPointStruct(BG_EY_OBJECT_N_BANNER_DRAENEI_RUINS_CENTER,
...
public:
    ...
    /* BG Flags */
    ObjectGuid
    GetFlagPickerGUID(TeamId /*teamId*/ = TEAM_NEUTRAL) const override
    {
        return _flagKeeperGUID;
    }
    ...
    void                   SetDroppedFlagGUID(ObjectGuid guid,
    ...
    /* Battleground Events */
    void EventPlayerClickedOnFlag(Player*     player,
...
private:
    ...
    struct CapturePointInfo {
        CapturePointInfo()
            : _ownerTeamId(TEAM_NEUTRAL),
              _barStatus(BG_EY_PROGRESS_BAR_STATE_MIDDLE), _areaTrigger(0)
        {
