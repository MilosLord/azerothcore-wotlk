...
BattlegroundBE::BattlegroundBE() { BgObjects.resize(BG_BE_OBJECT_MAX); }
...
bool BattlegroundBE::HandlePlayerUnderMap(Player* player)
{
    player->NearTeleportTo(
        6238.930176f, 262.963470f, 0.889519f, player->GetOrientation());
    return true;
}
...
{
    // gates
    if (!AddObject(BG_BE_OBJECT_DOOR_1,
        ...
        !AddObject(BG_BE_OBJECT_BUFF_2,
                   ...
                   120)
        // Arena Ready Marker
        || !AddObject(BG_BE_OBJECT_READY_MARKER_1,
                      ...
                      0.0f,
                      300) ||
        !AddObject(BG_BE_OBJECT_READY_MARKER_2,
                   ARENA_READY_MARKER_ENTRY,
                   6287.19f,
                   288.25f,
                   5.33f,
