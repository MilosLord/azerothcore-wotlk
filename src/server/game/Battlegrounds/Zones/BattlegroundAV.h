...
enum BG_AV_Sounds {
    ...
    8212:
        ...
        drek "mlanzenabschaum! In meiner Burg?! Toetet sie all" - nicht immer
    der sound 8333: galv "sterbt fuer euch ist kein platz hier"
    ...
    8174:
        horde tower assault
        horde grave assault
        van "es Sturmlanzenklans, euer General wird angegriffen! Ich fordere
    Unterst" 8173: ally grave capture/defend tower destroy mine capture ally
    wins 8192: ally tower destroy(only iceblood - found a bug^^) ally tower
    defend horde tower defend 8213 horde: grave defend/capture tower destroy
        mine capture
        horde wins
        */
    ...
    AV_SOUND_ALLIANCE_ASSAULTS =
        8212, // tower, grave + enemy boss if someone tries to attack him
    AV_SOUND_HORDE_ASSAULTS = 8174,
    AV_SOUND_ALLIANCE_GOOD =
        8173, // if something good happens for the team:  wins(maybe only
              // through killing the boss), captures mine or grave, destroys
              // tower and defends grave
    AV_SOUND_HORDE_GOOD        = 8213,
    AV_SOUND_BOTH_TOWER_DEFEND = 8192,

    AV_SOUND_ALLIANCE_CAPTAIN =
        8232, // gets called when someone attacks them and at the beginning
              // after 3min+rand(x)*10sec (maybe buff)
...
enum BG_AV_OTHER_VALUES {
    ...
    AV_MINE_RECLAIM_TIMER =
        1200000, // TODO: get the right value.. this is currently 20 minutes
...
enum BG_AV_ObjectIds {
    // cause the moongose-system is a bit different, we don't use the right
    // go-ids for every node.. if we want to be 100% like another big server, we
    // must take one object for every node snowfall 4flags as eyecandy 179424
    // (alliance neutral) Banners - stolen from battleground_AB.h ;-)
...
enum BG_AV_ObjectTypes {
    ...
    // big flags on top of towers 2 flags on each (contested, (alliance |
    // horde)) + 2 auras
...
const float BG_AV_ObjectPos[AV_OPLACE_MAX][4] = {
    ...
    // burning auras towers have 9*179065 captain-buildings have
    // 5*179066+5*179065 dunns
...
enum BG_AV_CreaturePlace {
    ...
    // i don't will add for all 4 positions a variable.. i think one is enough
    // to compute the rest
...
const uint32 BG_AV_CreatureInfo[AV_NPC_INFO_MAX] = {
    ...
    13358, // Stormpike Bowman /// @todo: Confirm if this is correct. Author
           // assumpted 60, 61 & 69, 70, but wouldn't work here
...
const float BG_AV_StaticCreaturePos[AV_STATICCPLACE_MAX][5] = {
    ...
    {-57.7891f,
     ...
     15.6479f,
     6.02139f,
     18}, // 11949 - Captain Balinda Stonehearth
    {930.498f, -520.755f, 93.7334f, 1.8326f, 19}, // 11997 - Stormpike Herald
    {-776.092f,
     -345.161f,
     67.4092f,
     1.89257f,
     20}, // 12051 - Frostwolf Legionnaire
    {-1224.63f,
     -308.144f,
     65.0087f,
     4.01139f,
    ...
    {587.633f,
     ...
     37.5438f,
     5.81195f,
     21}, // 12096 - Stormpike Quartermaster
    {-1293.79f,
     -194.407f,
     72.4398f,
     5.84685f,
     22}, // 12097 - Frostwolf Quartermaster
    {446.163f,
     -377.119f,
     -1.12725f,
     0.209526f,
     23}, // 12127 - Stormpike Guardsman
    {549.348f,
     -399.254f,
     53.3537f,
     3.24729f,
    ...
    {-1332.0f,
     ...
     91.2631f,
     1.50098f,
     25}, // 13179 - Wing Commander Guse
    {569.983f,
     -94.9992f,
     38.0325f,
     1.39626f,
     26}, // 13216 - Gaelden Hammersmith
    {-1244.92f, -308.916f, 63.2525f, 1.62316f, 27}, // 13218 - Grunnda Wolfheart
    {-1319.56f,
     -342.675f,
     60.3404f,
     1.20428f,
     28},                                          // 13236 - Primalist Thurloga
    ...
    {569.963f,
     ...
     37.7581f,
     4.27606f,
     31}, // 13438 - Wing Commander Slidore
    ...
    {724.768f,
     ...
     51.6335f,
     0.733038f,
     33}, // 13443 - Druid of the Grove
    {596.68f,
     -83.0633f,
     39.0051f,
     6.24828f,
     34}, // 13447 - Corporal Noreg Stormpike
    {600.032f,
     -2.92475f,
     42.0788f,
     5.00909f,
     35}, // 13577 - Stormpike Ram Rider Commander
    {610.239f,
     -21.8454f,
     43.272f,
     4.90438f,
     36}, // 13617 - Stormpike Stable Master
    {613.422f,
     -150.764f,
     33.4517f,
     5.55015f,
     37}, // 13797 - Mountaineer Boombellow
    {-1213.91f, -370.619f, 56.4455f, 0.837758f, 38}, // 13798 - Jotek
    {704.35f,
     -22.9071f,
     50.2187f,
     0.785398f,
     39}, // 13816 - Prospector Stonehewer
    ...
    {947.412f,
     ...
     95.1098f,
     2.82743f,
     46}, // 14284 - Stormpike Battleguard
    {934.557f,
     -512.395f,
     93.662f,
     3.61004f,
...
const uint32 BG_AV_GraveyardIds[9] = {AV_GRAVE_STORM_AID,
...
enum BG_AV_WorldStates {
    ...
    /*
        //the comments behind the state shows which icon overlaps the other..
    but is, until now, unused and maybe not a good solution (but give few
    performance (:)
...
const uint32 BG_AV_MineWorldStates[2][3] = {{1358, 1360, 1359},
                                            {1355, 1357, 1356}};
...
protected:
    explicit BattlegroundAVScore(ObjectGuid playerGuid)
...
public:
    ...
    bool UpdatePlayerScore(Player* player,
                           uint32  type,
                           uint32  value,
                           bool    doAddHonor = true) override;

    /*handlestuff*/ // these are functions which get called from extern
    void EventPlayerClickedOnFlag(Player*     source,
