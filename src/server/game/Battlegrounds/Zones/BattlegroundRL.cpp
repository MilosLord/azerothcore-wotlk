...
BattlegroundRL::BattlegroundRL() { BgObjects.resize(BG_RL_OBJECT_MAX); }
...
bool BattlegroundRL::HandlePlayerUnderMap(Player* player)
{
    player->NearTeleportTo(
        1285.810547f, 1667.896851f, 39.957642f, player->GetOrientation());
    return true;
}
...
bool BattlegroundRL::SetupBattleground()
{
    ...
    if (!AddObject(BG_RL_OBJECT_DOOR_1,
        ...
        !AddObject(BG_RL_OBJECT_BUFF_2,
                   ...
                   120)
        // Arena Ready Marker
        || !AddObject(BG_RL_OBJECT_READY_MARKER_1,
                      ...
                      0.0f,
                      300) ||
        !AddObject(BG_RL_OBJECT_READY_MARKER_2,
                   ARENA_READY_MARKER_ENTRY,
                   1273.71f,
                   1734.05f,
                   31.61f,
