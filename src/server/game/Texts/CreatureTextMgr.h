...
typedef std::unordered_map<ObjectGuid, CreatureTextRepeatGroup>
...
public:
    ...
    void SendSound(Creature*          source,
                   uint32             sound,
                   ChatMsg            msgType,
    ...
    std::string GetLocalizedChatString(uint32         entry,
                                       uint8          gender,
                                       uint8          textGroup,
                                       uint32         id,
    ...
    void SendChatPacket(WorldObject*       source,
...
private:
    ...
    void  SendNonChatPacket(WorldObject*       source,
...
template <class Builder>
void CreatureTextMgr::SendChatPacket(
    WorldObject*       source,
    Builder const&     builder,
    ChatMsg            msgType,
    WorldObject const* target /*= nullptr*/,
    ...
    bool               gmOnly /*= false*/) const
{
    ...
    Acore::PlayerDistWorker<CreatureTextLocalizer<Builder>> worker(
        source, dist, localizer);
