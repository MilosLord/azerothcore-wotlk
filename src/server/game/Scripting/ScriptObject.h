...
public:
    // Do not override this in scripts; it should be overridden by the various
    // script type classes. It indicates whether or not this script type must be
    ...
    [[nodiscard]] uint16 GetTotalAvailableHooks()
    {
        return _totalAvailableHooks;
    }

protected:
    ScriptObject(const char* name, uint16 totalAvailableHooks = 0)
        : _name(std::string(name)), _totalAvailableHooks(totalAvailableHooks)
    {
    }
...
public:
    ...
    // Gets the MapEntry structure associated with this script. Can return
    // nullptr.
    ...
    virtual void OnLoadGridMap(TMap* /*map*/,
                               GridMap* /*gmap*/,
                               uint32 /*gx*/,
                               uint32 /*gy*/)
    {
    ...
    virtual void OnUnloadGridMap(TMap* /*map*/,
                                 GridMap* /*gmap*/,
                                 uint32 /*gx*/,
                                 uint32 /*gy*/)
    {
