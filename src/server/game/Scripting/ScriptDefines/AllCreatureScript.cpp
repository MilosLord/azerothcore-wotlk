...
// bool ScriptMgr::CanCreatureSendListInventory(Player* player, Creature*
// creature, uint32 vendorEntry)
//{
//     auto ret = IsValidBoolScript<AllCreatureScript>([&](AllCreatureScript*
//     script)
//     {
//         return !script->CanCreatureSendListInventory(player, creature,
//         vendorEntry);
//     });
//
//     if (ret && *ret)
