...
public:
    ...
    virtual void OnSendInitialPacketsBeforeAddToMap(Player* /*player*/,
                                                    WorldPacket& /*data*/)
    {
    }

    // Called when a player does a desertion action (see
    // BattlegroundDesertionType)
    virtual void
    OnBattlegroundDesertion(Player* /*player*/,
                            BattlegroundDesertionType const /*desertionType*/)
    {
    }

    // Called when a player completes a quest
    virtual void OnPlayerCompleteQuest(Player* /*player*/,
                                       Quest const* /*quest_id*/)
    {
    }
    ...
    virtual void OnCreatureKilledByPet(Player* /*PetOwner*/,
                                       Creature* /*killed*/)
    {
    }

    // Called when a player is killed by a creature
    virtual void OnPlayerKilledByCreature(Creature* /*killer*/,
                                          Player* /*killed*/)
    {
    }
    ...
    // Called when a player's free talent points change (right before the change
    // is applied)
    virtual void OnFreeTalentPointsChanged(Player* /*player*/,
                                           uint32 /*points*/)
    {
    }

    // Called when a player's talent points are reset (right before the reset is
    // done)
    ...
    // Called when a player's money is modified (before the modification is
    // done)
    ...
    virtual void OnGiveXP(Player* /*player*/,
                          uint32& /*amount*/,
                          Unit* /*victim*/,
                          uint8 /*xpSource*/)
    {
    ...
    virtual bool OnReputationChange(Player* /*player*/,
                                    uint32 /*factionID*/,
                                    int32& /*standing*/,
                                    bool /*incremental*/)
    {
    ...
    // Called when a player's reputation rank changes (before it is actually
    // changed)
    virtual void OnReputationRankChange(Player* /*player*/,
                                        uint32 /*factionID*/,
                                        ReputationRank /*newRank*/,
                                        ReputationRank /*olRank*/,
                                        bool /*increased*/)
    {
    }
    ...
    virtual void OnChat(Player* /*player*/,
                        uint32 /*type*/,
                        uint32 /*lang*/,
                        std::string& /*msg*/)
    {
    ...
    virtual void OnBeforeSendChatMessage(Player* /*player*/,
                                         uint32& /*type*/,
                                         uint32& /*lang*/,
                                         std::string& /*msg*/)
    {
    ...
    virtual void OnTextEmote(Player* /*player*/,
                             uint32 /*textEmote*/,
                             uint32 /*emoteNum*/,
                             ObjectGuid /*guid*/)
    {
    ...
    virtual void OnBindToInstance(Player* /*player*/,
    ...
    // Called when a player switches to a new area (more accurate than
    // UpdateZone)
    virtual void
    ...
    [[nodiscard]] virtual bool OnBeforeTeleport(Player* /*player*/,
                                                uint32 /*mapid*/,
                                                float /*x*/,
                                                float /*y*/,
                                                float /*z*/,
    ...
    // Called when a player queues a Random Dungeon using the RDF (Random
    // Dungeon Finder)
    virtual void OnQueueRandomDungeon(Player* /*player*/,
                                      uint32& /*rDungeonId*/)
    {
    }

    // Called when a player is removed from battleground
    virtual void OnRemoveFromBattleground(Player* /*player*/,
                                          Battleground* /*bg*/)
    {
    }

    // Called when a player complete an achievement
    virtual void OnAchiComplete(Player* /*player*/,
                                AchievementEntry const* /*achievement*/)
    {
    }

    // Called before player complete an achievement, can be used to disable
    // achievements in certain conditions
    virtual bool OnBeforeAchiComplete(Player* /*player*/,
                                      AchievementEntry const* /*achievement*/)
    {
        return true;
    }
    ...
    virtual void
    OnCriteriaProgress(Player* /*player*/,
                       AchievementCriteriaEntry const* /*criteria*/)
    {
    }

    //  Called before player complete an achievement criteria, can be used to
    //  disable achievement criteria in certain conditions
    virtual bool
    OnBeforeCriteriaProgress(Player* /*player*/,
                             AchievementCriteriaEntry const* /*criteria*/)
    {
        return true;
    }
    ...
    virtual void OnAchiSave(CharacterDatabaseTransaction /*trans*/,
                            Player* /*player*/,
                            uint16 /*achId*/,
    ...
    virtual void OnCriteriaSave(CharacterDatabaseTransaction /*trans*/,
                                Player* /*player*/,
                                uint16 /*achId*/,
    ...
    virtual void OnGossipSelect(Player* /*player*/,
                                uint32 /*menu_id*/,
                                uint32 /*sender*/,
                                uint32 /*action*/)
    {
    ...
    // Called when a player selects an option in a player gossip window
    virtual void OnGossipSelectCode(Player* /*player*/,
                                    uint32 /*menu_id*/,
                                    uint32 /*sender*/,
                                    uint32 /*action*/,
                                    const char* /*code*/)
    ...
    virtual void OnBeingCharmed(Player* /*player*/,
                                Unit* /*charmer*/,
                                uint32 /*oldFactionId*/,
                                uint32 /*newFactionId*/)
    {
    ...
    virtual void OnAfterSetVisibleItemSlot(Player* /*player*/,
                                           uint8 /*slot*/,
                                           Item* /*item*/)
    {
    }
    ...
    virtual void OnAfterMoveItemFromInventory(Player* /*player*/,
                                              Item* /*it*/,
                                              uint8 /*bag*/,
                                              uint8 /*slot*/,
                                              bool /*update*/)
    ...
    // Called when trying to get a team ID of a slot > 2 (This is for custom
    // teams created by modules)
    virtual void GetCustomGetArenaTeamId(Player const* /*player*/,
                                         uint8 /*slot*/,
                                         uint32& /*teamID*/) const
    {
    }

    // Called when trying to get players personal rating of an arena slot > 2
    // (This is for custom teams created by modules)
    virtual void GetCustomArenaPersonalRating(Player const* /*player*/,
                                              uint8 /*slot*/,
                                              uint32& /*rating*/) const
    {
    }

    // Called after the normal slots (0..2) for arena have been evaluated so
    // that custom arena teams could modify it if nececasry
    virtual void
    OnGetMaxPersonalArenaRatingRequirement(Player const* /*player*/,
                                           uint32 /*minSlot*/,
    ...
    // After looting item
    virtual void OnLootItem(Player* /*player*/,
                            Item* /*item*/,
                            uint32 /*count*/,
                            ObjectGuid /*lootguid*/)
    {
    ...
    // Before looting item
    virtual void OnBeforeFillQuestLootItem(Player* /*player*/,
                                           LootItem& /*item*/)
    {
    }
    ...
    virtual void
    OnStoreNewItem(Player* /*player*/, Item* /*item*/, uint32 /*count*/)
    {
    }
    ...
    [[nodiscard]] virtual bool CanPlaceAuctionBid(Player* /*player*/,
    ...
    virtual void OnGroupRollRewardItem(Player* /*player*/,
                                       Item* /*item*/,
                                       uint32 /*count*/,
                                       RollVote /*voteType*/,
                                       Roll* /*roll*/)
    ...
    [[nodiscard]] virtual bool OnBeforeOpenItem(Player* /*player*/,
                                                Item* /*item*/)
    {
        return true;
    }
    ...
    [[nodiscard]] virtual bool OnBeforeQuestComplete(Player* /*player*/,
                                                     uint32 /*quest_id*/)
    {
        return true;
    }
    ...
    virtual void OnQuestComputeXP(Player* /*player*/,
                                  Quest const* /*quest*/,
                                  uint32& /*xpValue*/)
    {
    }
    ...
    virtual void OnBeforeDurabilityRepair(Player* /*player*/,
                                          ObjectGuid /*npcGUID*/,
                                          ObjectGuid /*itemGUID*/,
                                          float& /*discountMod*/,
                                          uint8 /*guildBank*/)
    ...
    virtual void OnBeforeBuyItemFromVendor(Player* /*player*/,
    ...
    // Before buying something from any vendor
    virtual void OnBeforeStoreOrEquipNewItem(Player* /*player*/,
                                             uint32 /*vendorslot*/,
                                             uint32& /*item*/,
                                             uint8 /*count*/,
                                             uint8 /*bag*/,
    ...
    virtual void OnAfterStoreOrEquipNewItem(Player* /*player*/,
                                            uint32 /*vendorslot*/,
                                            Item* /*item*/,
                                            uint8 /*count*/,
                                            uint8 /*bag*/,
    ...
    virtual void OnAfterUpdateMaxPower(Player* /*player*/,
                                       Powers& /*power*/,
                                       float& /*value*/)
    {
    }
    ...
    virtual void OnBeforeUpdateAttackPowerAndDamage(Player* /*player*/,
                                                    float& /*level*/,
                                                    float& /*val2*/,
                                                    bool /*ranged*/)
    {
    ...
    virtual void
    OnAfterUpdateAttackPowerAndDamage(Player* /*player*/,
                                      float& /*level*/,
                                      float& /*base_attPower*/,
                                      float& /*attPowerMod*/,
    ...
    virtual void OnBeforeInitTalentForLevel(Player* /*player*/,
                                            uint8& /*level*/,
    ...
    CanJoinInBattlegroundQueue(Player* /*player*/,
    ...
    // Called before the player's temporary summoned creature has initialized
    // it's stats
    virtual void OnBeforeTempSummonInitStats(Player* /*player*/,
                                             TempSummon* /*tempSummon*/,
                                             uint32& /*duration*/)
    {
    }

    // Called before the player's guardian / pet has initialized it's stats for
    // the player's level
    virtual void
    OnBeforeGuardianInitStatsForLevel(Player* /*player*/,
                                      Guardian* /*guardian*/,
    ...
    // Called after the player's guardian / pet has initialized it's stats for
    // the player's level
    virtual void OnAfterGuardianInitStatsForLevel(Player* /*player*/,
                                                  Guardian* /*guardian*/)
    {
    }

    // Called before loading a player's pet from the DB
    virtual void OnBeforeLoadPetFromDB(Player* /*player*/,
                                       uint32& /*petentry*/,
                                       uint32& /*petnumber*/,
                                       bool& /*current*/,
    ...
    [[nodiscard]] virtual bool
    CanJoinInArenaQueue(Player* /*player*/,
                        ObjectGuid /*BattlemasterGuid*/,
                        uint8 /*arenaslot*/,
                        BattlegroundTypeId /*BGTypeID*/,
                        uint8 /*joinAsGroup*/,
    ...
    [[nodiscard]] virtual bool
    CanBattleFieldPort(Player* /*player*/,
                       uint8 /*arenaType*/,
                       BattlegroundTypeId /*BGTypeID*/,
                       uint8 /*action*/)
    {
    ...
    [[nodiscard]] virtual bool CanGroupInvite(Player* /*player*/,
                                              std::string& /*membername*/)
    {
        return true;
    }

    [[nodiscard]] virtual bool CanGroupAccept(Player* /*player*/,
                                              Group* /*group*/)
    {
        return true;
    }
    ...
    [[nodiscard]] virtual bool
    CanSellItem(Player* /*player*/, Item* /*item*/, Creature* /*creature*/)
    {
        return true;
    }

    [[nodiscard]] virtual bool CanSendMail(Player* /*player*/,
    ...
    virtual void PetitionBuy(Player* /*player*/,
                             Creature* /*creature*/,
                             uint32& /*charterid*/,
                             uint32& /*cost*/,
                             uint32& /*type*/)
    ...
    virtual void PetitionShowList(Player* /*player*/,
                                  Creature* /*creature*/,
                                  uint32& /*CharterEntry*/,
    ...
    virtual void OnRewardKillRewarder(Player* /*player*/,
    ...
    [[nodiscard]] virtual bool CanGiveMailRewardAtGiveLevel(Player* /*player*/,
                                                            uint8 /*level*/)
    {
        return true;
    }

    virtual void OnDeleteFromDB(CharacterDatabaseTransaction /*trans*/,
                                uint32 /*guid*/)
    {
    }

    [[nodiscard]] virtual bool CanRepopAtGraveyard(Player* /*player*/)
    {
        return true;
    }

    [[nodiscard]] virtual Optional<bool>
    OnPlayerIsClass(Player const* /*player*/,
                    Classes /*playerClass*/,
    ...
    virtual void OnGetMaxSkillValue(Player* /*player*/,
                                    uint32 /*skill*/,
                                    int32& /*result*/,
                                    bool /*IsPure*/)
    {
    ...
    [[nodiscard]] virtual bool
    OnPlayerHasActivePowerType(Player const* /*player*/, Powers /*power*/)
    {
        return false;
    }

    /**
     * @brief This hook called before gathering skill gain is applied to the
     * character.
     *
     ...
     * @param gain Contains the amount of points that should be added to the
     * Player
     */
    virtual void OnUpdateGatheringSkill(Player* /*player*/,
                                        uint32 /*skill_id*/,
                                        uint32 /*current*/,
                                        uint32 /*gray*/,
                                        uint32 /*green*/,
    ...
    /**
     * @brief This hook is called before crafting skill gain is applied to the
     * character.
     *
     * @param player Contains information about the Player sender
     ...
     * Player
     */
    virtual void OnUpdateCraftingSkill(Player* /*player*/,
    ...
    [[nodiscard]] virtual bool OnUpdateFishingSkill(Player* /*player*/,
                                                    int32 /*skill*/,
                                                    int32 /*zone_skill*/,
                                                    int32 /*chance*/,
                                                    int32 /*roll*/)
    ...
    [[nodiscard]] virtual bool CanAreaExploreAndOutdoor(Player* /*player*/)
    {
        return true;
    }

    virtual void OnVictimRewardBefore(Player* /*player*/,
                                      Player* /*victim*/,
                                      uint32& /*killer_title*/,
                                      uint32& /*victim_title*/)
    {
    ...
    virtual void OnVictimRewardAfter(Player* /*player*/,
                                     Player* /*victim*/,
                                     uint32& /*killer_title*/,
                                     uint32& /*victim_rank*/,
                                     float& /*honor_f*/)
    ...
    virtual void
    OnCustomScalingStatValueBefore(Player* /*player*/,
    ...
    virtual void OnCustomScalingStatValue(Player* /*player*/,
                                          ItemTemplate const* /*proto*/,
                                          uint32& /*statType*/,
                                          int32& /*val*/,
    ...
    [[nodiscard]] virtual bool CanArmorDamageModifier(Player* /*player*/)
    {
        return true;
    }

    virtual void OnGetFeralApBonus(Player* /*player*/,
                                   int32& /*feral_bonus*/,
                                   int32 /*dpsMod*/,
                                   ItemTemplate const* /*proto*/,
                                   ScalingStatValuesEntry const* /*ssv*/)
    ...
    [[nodiscard]] virtual bool
    CanApplyWeaponDependentAuraDamageMod(Player* /*player*/,
                                         Item* /*item*/,
    ...
    [[nodiscard]] virtual bool
    CanApplyEquipSpell(Player* /*player*/,
    ...
    [[nodiscard]] virtual bool
    CanApplyEquipSpellsItemSet(Player* /*player*/, ItemSetEffect* /*eff*/)
    {
        return true;
    }

    [[nodiscard]] virtual bool
    CanCastItemCombatSpell(Player* /*player*/,
                           Unit* /*target*/,
    ...
    [[nodiscard]] virtual bool
    CanCastItemUseSpell(Player* /*player*/,
                        Item* /*item*/,
    ...
    virtual void OnApplyAmmoBonuses(Player* /*player*/,
                                    ItemTemplate const* /*proto*/,
                                    float& /*currentAmmoDPS*/)
    {
    }

    [[nodiscard]] virtual bool CanEquipItem(Player* /*player*/,
                                            uint8 /*slot*/,
                                            uint16& /*dest*/,
                                            Item* /*pItem*/,
                                            bool /*swap*/,
    ...
    [[nodiscard]] virtual bool
    CanUnequipItem(Player* /*player*/, uint16 /*pos*/, bool /*swap*/)
    {
        return true;
    }

    [[nodiscard]] virtual bool CanUseItem(Player* /*player*/,
                                          ItemTemplate const* /*proto*/,
    ...
    [[nodiscard]] virtual bool CanSaveEquipNewItem(Player* /*player*/,
                                                   Item* /*item*/,
                                                   uint16 /*pos*/,
                                                   bool /*update*/)
    {
    ...
    [[nodiscard]] virtual bool CanApplyEnchantment(Player* /*player*/,
                                                   Item* /*item*/,
    ...
    [[nodiscard]] virtual bool
    PassedQuestKilledMonsterCredit(Player* /*player*/,
                                   Quest const* /*qinfo*/,
                                   uint32 /*entry*/,
                                   uint32 /*real_entry*/,
                                   ObjectGuid /*guid*/)
    ...
    [[nodiscard]] virtual bool
    CheckItemInSlotAtLoadInventory(Player* /*player*/,
                                   Item* /*item*/,
                                   uint8 /*slot*/,
                                   uint8& /*err*/,
                                   uint16& /*dest*/)
    ...
    [[nodiscard]] virtual bool NotVisibleGloballyFor(Player* /*player*/,
                                                     Player const* /*u*/)
    {
        return true;
    }

    virtual void OnGetArenaPersonalRating(Player* /*player*/,
                                          uint8 /*slot*/,
                                          uint32& /*result*/)
    {
    }
    ...
    virtual void OnGetMaxSkillValueForLevel(Player* /*player*/,
                                            uint16& /*result*/)
    {
    }

    [[nodiscard]] virtual bool
    NotSetArenaTeamInfoField(Player* /*player*/,
                             uint8 /*slot*/,
    ...
    [[nodiscard]] virtual bool CanJoinLfg(Player* /*player*/,
                                          uint8 /*roles*/,
    ...
    [[nodiscard]] virtual bool CanEnterMap(Player* /*player*/,
    ...
    [[nodiscard]] virtual bool CanInitTrade(Player* /*player*/,
                                            Player* /*target*/)
    {
        return true;
    }
    ...
    /**
     * @brief This hook called just before finishing the handling of the action
     * of a player setting an item in a trade slot
     *
     * @param player Contains information about the trade initiator Player
     * @param tradedItem Contains information about the item set in the trade
     * slot
     *
     * @return True if you want to continue setting the item in the trade slot,
     * false if you want to cancel the trade
     */
    [[nodiscard]] virtual bool CanSetTradeItem(Player* /*player*/,
                                               Item* /*tradedItem*/,
                                               uint8 /*tradeSlot*/)
    {
        return true;
    ...
    virtual void OnSetServerSideVisibility(Player* /*player*/,
    ...
    virtual void
    OnSetServerSideVisibilityDetect(Player* /*player*/,
                                    ServerSideVisibilityType& /*type*/,
                                    AccountTypes& /*sec*/)
    {
    }
    ...
    virtual void OnBeforeChooseGraveyard(Player* /*player*/,
                                         TeamId /*teamId*/,
                                         bool /*nearCorpse*/,
     ...
     *
     * @return True if you want to continue sending the message, false if you
     * want to disable sending the message
     */
    [[nodiscard]] virtual bool CanPlayerUseChat(Player* /*player*/,
                                                uint32 /*type*/,
                                                uint32 /*language*/,
                                                std::string& /*msg*/)
    {
    ...
    /**
     * @brief This hook called before player sending message to other player via
     * private
     *
     * @param player Contains information about the Player sender
     * @param type Contains information about the chat message type
     ...
     */
    virtual void OnPlayerLearnTalents(Player* /*player*/,
                                      uint32 /*talentId*/,
                                      uint32 /*talentRank*/,
                                      uint32 /*spellid*/)
    {
     ...
     * @param bySpell Contains information about the spell that invoked the
     * check
     */
    [[nodiscard]] virtual bool
    OnCanPlayerFlyInZone(Player* /*player*/,
                         uint32 /*mapId*/,
                         uint32 /*zoneId*/,
    ...
    virtual void
    AnticheatUpdateMovementInfo(Player* /*player*/,
                                MovementInfo const& /*movementInfo*/)
    {
    }
    [[nodiscard]] virtual bool AnticheatHandleDoubleJump(Player* /*player*/,
                                                         Unit* /*mover*/)
    {
        return true;
    }
    [[nodiscard]] virtual bool
    AnticheatCheckMovementInfo(Player* /*player*/,
                               MovementInfo const& /*movementInfo*/,
                               Unit* /*mover*/,
                               bool /*jump*/)
    {
    ...
    /**
     * @brief This hook is called, to avoid displaying the error message that
     * the body has already been stripped
     *
     * @param player Contains information about the Player
     *
     * @return true Avoiding displaying the error message that the loot has
     * already been taken.
     */
