...
public:
    ...
    virtual void OnBeforeCreatureSelectLevel(const CreatureTemplate* /*cinfo*/,
                                             Creature* /*creature*/,
                                             uint8& /*level*/)
    {
    }
    ...
    virtual void Creature_SelectLevel(const CreatureTemplate* /*cinfo*/,
                                      Creature* /*creature*/)
    {
    }
    ...
    /**
     * @brief This hook called when a player opens a gossip dialog with the
     * creature.
     *
     ...
     */
    [[nodiscard]] virtual bool CanCreatureGossipHello(Player* /*player*/,
                                                      Creature* /*creature*/)
    {
        return false;
    }
    ...
    /**
     * @brief This hook called when a player selects a gossip item in the
     * creature's gossip menu.
     *
     * @param player Contains information about the Player
     * @param creature Contains information about the Creature
     ...
     * @return False if you want to continue, true if you want to disable
     */
    [[nodiscard]] virtual bool CanCreatureGossipSelect(Player* /*player*/,
                                                       Creature* /*creature*/,
                                                       uint32 /*sender*/,
                                                       uint32 /*action*/)
    {
    ...
    /**
     * @brief This hook called when a player selects a gossip with a code in the
     * creature's gossip menu.
     *
     * @param player Contains information about the Player
     * @param creature Contains information about the Creature
    ...
    CanCreatureGossipSelectCode(Player* /*player*/,
                                Creature* /*creature*/,
                                uint32 /*sender*/,
                                uint32 /*action*/,
                                const char* /*code*/)
    ...
    [[nodiscard]] virtual bool CanCreatureQuestAccept(Player* /*player*/,
                                                      Creature* /*creature*/,
                                                      Quest const* /*quest*/)
    {
        return false;
    ...
    [[nodiscard]] virtual bool CanCreatureQuestReward(Player* /*player*/,
                                                      Creature* /*creature*/,
                                                      Quest const* /*quest*/,
                                                      uint32 /*opt*/)
    {
    ...
    [[nodiscard]] virtual CreatureAI*
    GetCreatureAI(Creature* /*creature*/) const
    {
        return nullptr;
    }
