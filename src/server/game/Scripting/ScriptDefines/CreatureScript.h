...
public:
    ...
    // Called when a player selects a gossip with a code in the creature's
    // gossip menu.
    ...
    [[nodiscard]] virtual bool OnQuestSelect(Player* /*player*/,
                                             Creature* /*creature*/,
                                             Quest const* /*quest*/)
    {
        return false;
    ...
    [[nodiscard]] virtual bool OnQuestComplete(Player* /*player*/,
                                               Creature* /*creature*/,
                                               Quest const* /*quest*/)
    {
        return false;
    ...
    // Called when the dialog status between a player and the creature is
    // requested.
