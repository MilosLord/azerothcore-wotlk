...
public:
    ...
    [[nodiscard]] virtual bool CanGameObjectGossipHello(Player* /*player*/,
                                                        GameObject* /*go*/)
    {
        return false;
    }
    ...
    // menu.
    [[nodiscard]] virtual bool CanGameObjectGossipSelect(Player* /*player*/,
                                                         GameObject* /*go*/,
                                                         uint32 /*sender*/,
                                                         uint32 /*action*/)
    {
    ...
    CanGameObjectGossipSelectCode(Player* /*player*/,
                                  GameObject* /*go*/,
                                  uint32 /*sender*/,
                                  uint32 /*action*/,
                                  const char* /*code*/)
    ...
    [[nodiscard]] virtual bool CanGameObjectQuestAccept(Player* /*player*/,
                                                        GameObject* /*go*/,
                                                        Quest const* /*quest*/)
    {
        return false;
    ...
    [[nodiscard]] virtual bool CanGameObjectQuestReward(Player* /*player*/,
                                                        GameObject* /*go*/,
                                                        Quest const* /*quest*/,
                                                        uint32 /*opt*/)
    {
    ...
    // buildings only).
    virtual void OnGameObjectModifyHealth(GameObject* /*go*/,
    ...
    virtual void OnGameObjectLootStateChanged(GameObject* /*go*/,
                                              uint32 /*state*/,
                                              Unit* /*unit*/)
    {
    }
    ...
    virtual GameObjectAI* GetGameObjectAI(GameObject* /*go*/) const
    {
        return nullptr;
    }
};
