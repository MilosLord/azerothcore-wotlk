...
public:
    /**
     * @brief This hook called when the weather changes in the zone this script
     * is associated with.
     *
     ...
     */
    virtual void OnWeatherChange(Weather* /*weather*/,
                                 WeatherState /*state*/,
                                 float /*grade*/)
    {
    }
    ...
    [[nodiscard]] virtual bool CanAreaTrigger(Player* /*player*/,
