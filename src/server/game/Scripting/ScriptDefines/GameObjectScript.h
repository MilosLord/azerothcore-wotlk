...
class GameObjectScript : public ScriptObject,
                         public UpdatableScript<GameObject> {
protected:
...
public:
    ...
    [[nodiscard]] virtual bool OnGossipHello(Player* /*player*/,
                                             GameObject* /*go*/)
    {
        return false;
    }

    // Called when a player selects a gossip item in the gameobject's gossip
    // menu.
    [[nodiscard]] virtual bool OnGossipSelect(Player* /*player*/,
                                              GameObject* /*go*/,
                                              uint32 /*sender*/,
                                              uint32 /*action*/)
    {
    ...
    // Called when a player selects a gossip with a code in the gameobject's
    // gossip menu.
    [[nodiscard]] virtual bool OnGossipSelectCode(Player* /*player*/,
                                                  GameObject* /*go*/,
                                                  uint32 /*sender*/,
                                                  uint32 /*action*/,
                                                  const char* /*code*/)
    ...
    [[nodiscard]] virtual bool OnQuestAccept(Player* /*player*/,
                                             GameObject* /*go*/,
                                             Quest const* /*quest*/)
    {
        return false;
    ...
    [[nodiscard]] virtual bool OnQuestReward(Player* /*player*/,
                                             GameObject* /*go*/,
                                             Quest const* /*quest*/,
                                             uint32 /*opt*/)
    {
    ...
    // Called when the dialog status between a player and the gameobject is
    // requested.
    ...
    // Called when the health of a game object is modified (destructible
    // buildings only).
    virtual void OnModifyHealth(GameObject* /*go*/,
    ...
    virtual void
    OnLootStateChanged(GameObject* /*go*/, uint32 /*state*/, Unit* /*unit*/)
    {
    }
...
#define RegisterGameObjectAI(ai_name)                                          \
    new GenericGameObjectScript<ai_name>(#ai_name)
