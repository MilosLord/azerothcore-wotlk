...
public:
    ...
    // End Battleground
    virtual void OnBattlegroundEndReward(Battleground* /*bg*/,
                                         Player* /*player*/,
                                         TeamId /*winnerTeamId*/)
    {
    }
    ...
    virtual void OnBattlegroundAddPlayer(Battleground* /*bg*/,
                                         Player* /*player*/)
    {
    }

    // Before added player in Battlegroud
    virtual void OnBattlegroundBeforeAddPlayer(Battleground* /*bg*/,
                                               Player* /*player*/)
    {
    }

    // Remove player at leave BG
    virtual void OnBattlegroundRemovePlayerAtLeave(Battleground* /*bg*/,
                                                   Player* /*player*/)
    {
    }

    virtual void OnQueueUpdate(BattlegroundQueue* /*queue*/,
                               uint32 /* diff */,
    ...
    virtual void OnAddGroup(BattlegroundQueue* /*queue*/,
    ...
    CanFillPlayersToBG(BattlegroundQueue* /*queue*/,
                       Battleground* /*bg*/,
                       BattlegroundBracketId /*bracket_id*/)
    {
        return true;
    ...
    [[nodiscard]] virtual bool
    IsCheckNormalMatch(BattlegroundQueue* /*queue*/,
    ...
    [[nodiscard]] virtual bool
    CanSendMessageBGQueue(BattlegroundQueue* /*queue*/,
                          Player* /*leader*/,
                          Battleground* /*bg*/,
                          PvPDifficultyEntry const* /*bracketEntry*/)
    {
    ...
    /**
     * @brief This hook runs before sending the join message during the arena
     * queue, allowing you to run extra operations or disabling the join message
     *
     ...
     * want to disable the message
     */
    [[nodiscard]] virtual bool OnBeforeSendJoinMessageArenaQueue(
    ...
    /**
     * @brief This hook runs before sending the exit message during the arena
     * queue, allowing you to run extra operations or disabling the exit message
     *
     * @param queue Contains information about the Arena queue
     * @param ginfo Contains information about the group of the queue
     * @return True if you want to continue sending the message, false if you
     ...
     */
    [[nodiscard]] virtual bool
    OnBeforeSendExitMessageArenaQueue(BattlegroundQueue* /*queue*/,
                                      GroupQueueInfo* /*ginfo*/)
    {
        return true;
    }
