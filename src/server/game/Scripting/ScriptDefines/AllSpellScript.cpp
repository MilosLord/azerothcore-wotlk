...
{
    CALL_ENABLED_HOOKS(AllSpellScript,
...
bool ScriptMgr::CanModAuraEffectDamageDone(AuraEffect const*      auraEff,
                                           ...
                                           bool                   apply)
{
    CALL_ENABLED_BOOLEAN_HOOKS(AllSpellScript,
                               ALLSPELLHOOK_CAN_MOD_AURA_EFFECT_DAMAGE_DONE,
                               !script->CanModAuraEffectDamageDone(
                                   auraEff, target, aurApp, mode, apply));
}

bool ScriptMgr::CanModAuraEffectModDamagePercentDone(
    ...
    bool                   apply)
{
    CALL_ENABLED_BOOLEAN_HOOKS(
        ...
        !script->CanModAuraEffectModDamagePercentDone(
            auraEff, target, aurApp, mode, apply));
}
                           ...
                           AuraEffect const*       triggeredByAura)
{
    CALL_ENABLED_BOOLEAN_HOOKS(
        ...
        !script->CanPrepare(spell, targets, triggeredByAura));
}
...
bool ScriptMgr::CanScalingEverything(Spell* spell)
{
    CALL_ENABLED_BOOLEAN_HOOKS_WITH_DEFAULT_FALSE(
        ...
        script->CanScalingEverything(spell));
}
...
bool ScriptMgr::CanSelectSpecTalent(Spell* spell)
{
    CALL_ENABLED_BOOLEAN_HOOKS(AllSpellScript,
                               ...
                               !script->CanSelectSpecTalent(spell));
}
                                   ...
                                   TargetInfo& targetInfo)
{
    CALL_ENABLED_HOOKS(AllSpellScript,
                       ...
                       script->OnScaleAuraUnitAdd(spell,
                                                  target,
                                                  effectMask,
                                                  checkIfValid,
                                                  implicit,
                                         ...
                                         bool&       needErase)
{
    CALL_ENABLED_HOOKS(AllSpellScript,
                       ...
                       script->OnRemoveAuraScaleTargets(
                           spell, targetInfo, auraScaleMask, needErase));
}
