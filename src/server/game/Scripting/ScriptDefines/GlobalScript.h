...
public:
    // items
    virtual void OnItemDelFromDB(CharacterDatabaseTransaction /*trans*/,
                                 ObjectGuid::LowType /*itemGuid*/)
    {
    }
    virtual void OnMirrorImageDisplayItem(Item const* /*item*/,
                                          uint32& /*display*/)
    {
    }

    // loot
    virtual void OnAfterRefCount(Player const* /*player*/,
    ...
    virtual void OnAfterCalculateLootGroupAmount(Player const* /*player*/,
                                                 Loot& /*loot*/,
                                                 uint16 /*lootMode*/,
                                                 uint32& /*groupAmount*/,
                                                 LootStore const& /*store*/)
    ...
    virtual void OnBeforeDropAddItem(Player const* /*player*/,
                                     Loot& /*loot*/,
                                     bool /*canRate*/,
                                     uint16 /*lootMode*/,
                                     LootStoreItem* /*LootStoreItem*/,
    ...
    virtual bool OnItemRoll(Player const* /*player*/,
    ...
    virtual bool
    OnBeforeLootEqualChanced(Player const* /*player*/,
                             std::list<LootStoreItem*> /*EqualChanced*/,
                             Loot& /*loot*/,
                             LootStore const& /*store*/)
    {
        return true;
    ...
    virtual void
    OnInitializeLockedDungeons(Player* /*player*/,
                               uint8& /*level*/,
                               uint32& /*lockData*/,
    ...
    virtual void OnBeforeUpdateArenaPoints(ArenaTeam* /*at*/,
    ...
    virtual void
    OnBeforeWorldObjectSetPhaseMask(WorldObject const* /*worldObject*/,
                                    uint32& /*oldPhaseMask*/,
                                    uint32& /*newPhaseMask*/,
    ...
    virtual bool OnIsAffectedBySpellModCheck(SpellInfo const* /*affectSpell*/,
    ...
    virtual bool
    OnSpellHealingBonusTakenNegativeModifiers(Unit const* /*target*/,
                                              Unit const* /*caster*/,
    ...
    virtual bool OnAllowedForPlayerLootCheck(Player const* /*player*/,
                                             ObjectGuid /*source*/)
    {
        return false;
    };

    // Called when checking if a player can see the creature loot (if it can
    // click the corpse f.e)
    virtual bool OnAllowedToLootContainerCheck(Player const* /*player*/,
                                               ObjectGuid /*source*/)
    {
        return false;
    };
    ...
    // Called when any raid boss has their state updated (e.g. pull, reset,
    // kill)
    virtual void OnBeforeSetBossState(uint32 /*id*/,
    ...
    virtual void AfterInstanceGameObjectCreate(Map* /*instance*/,
                                               GameObject* /*go*/)
    {
    }
};
