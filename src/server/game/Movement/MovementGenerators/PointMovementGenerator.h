...
public:
    PointMovementGenerator(uint32                       _id,
                           float                        _x,
                           float                        _y,
                           float                        _z,
                           float                        _speed       = 0.0f,
        ...
        : id(_id), i_x(_x), i_y(_y), i_z(_z), speed(_speed),
          i_orientation(orientation), _generatePath(generatePath),
...
// Does almost nothing - just doesn't allows previous movegen interrupt current
// effect.
