...
void WaypointMgr::Load()
{
    ...
    QueryResult result = WorldDatabase.Query(
        ...
        "move_type, delay, action, action_chance FROM waypoint_data ORDER BY "
        "id, point");
    ...
    do {
        ...
        if (wp->move_type >= WAYPOINT_MOVE_TYPE_MAX) {
            // LOG_ERROR("sql.sql", "Waypoint {} in waypoint_data has invalid
