...
RectangleBoundary::RectangleBoundary(
    float southX, float northX, float eastY, float westY, bool isInverted)
    : AreaBoundary(isInverted), _minX(southX), _maxX(northX), _minY(eastY),
      _maxY(westY)
{
}
...
CircleBoundary::CircleBoundary(Position const& center,
                               ...
                               bool            isInverted)
    : AreaBoundary(isInverted), _center(center),
      _radiusSq(_center.GetDoubleExactDist2dSq(pointOnCircle))
{
}
...
EllipseBoundary::EllipseBoundary(Position const& center,
                                 ...
                                 double          radiusY,
                                 bool            isInverted)
    : AreaBoundary(isInverted), _center(center), _radiusYSq(radiusY * radiusY),
...
{
    // half-plane signs
    bool sign1 = ((-_b.GetDoublePositionX() + pos->GetPositionX()) * _aby -
                  (-_b.GetDoublePositionY() + pos->GetPositionY()) * _abx) < 0;
    bool sign2 = ((-_c.GetDoublePositionX() + pos->GetPositionX()) * _bcy -
                  (-_c.GetDoublePositionY() + pos->GetPositionY()) * _bcx) < 0;
    bool sign3 = ((-_a.GetDoublePositionX() + pos->GetPositionX()) * _cay -
                  (-_a.GetDoublePositionY() + pos->GetPositionY()) * _cax) < 0;
...
ParallelogramBoundary::ParallelogramBoundary(Position const& cornerA,
    ...
    : AreaBoundary(isInverted), _a(cornerA), _b(cornerB), _d(cornerD),
      _c(DoublePosition(_d.GetDoublePositionX() +
                            (_b.GetDoublePositionX() - _a.GetDoublePositionX()),
                        _d.GetDoublePositionY() + (_b.GetDoublePositionY() -
...
bool ParallelogramBoundary::IsWithinBoundaryArea(Position const* pos) const
{
    ...
    bool sign1 = ((-_b.GetDoublePositionX() + pos->GetPositionX()) * _aby -
                  (-_b.GetDoublePositionY() + pos->GetPositionY()) * _abx) < 0;
    bool sign2 = ((-_a.GetDoublePositionX() + pos->GetPositionX()) * _day -
                  (-_a.GetDoublePositionY() + pos->GetPositionY()) * _dax) < 0;
    bool sign3 = ((-_d.GetDoublePositionY() + pos->GetPositionY()) * _abx -
                  (-_d.GetDoublePositionX() + pos->GetPositionX()) * _aby) <
                 0; // AB = -CD
    bool sign4 = ((-_c.GetDoublePositionY() + pos->GetPositionY()) * _dax -
                  (-_c.GetDoublePositionX() + pos->GetPositionX()) * _day) <
                 0; // DA = -BC
