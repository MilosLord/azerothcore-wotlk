...
public: // constructors and global modifiers
    explicit ReputationMgr(Player* owner)
        : _player(owner), _visibleFactionCount(0), _honoredFactionCount(0),
          _reveredFactionCount(0), _exaltedFactionCount(0),
...
public: // accessors
    ...
    {
        return factionEntry->CanHaveReputation()
                   ? GetState(factionEntry->reputationListID)
                   : nullptr;
    }
    ...
    ReputationRank const*
    GetForcedRankIfAny(FactionTemplateEntry const* factionTemplateEntry) const
    {
        ForcedReactions::const_iterator forceItr =
            _forcedReactions.find(factionTemplateEntry->faction);
...
public: // modifiers
    ...
    bool ModifyReputation(FactionEntry const*      factionEntry,
                          float                    standing,
                          bool                     noSpillOver = false,
                          Optional<ReputationRank> repMaxCap   = {})
    {
        return SetReputation(
            factionEntry, standing, true, noSpillOver, repMaxCap);
    }
    ...
    bool SetOneFactionReputation(FactionEntry const*      factionEntry,
                                 float                    standing,
                                 bool                     incremental,
                                 Optional<ReputationRank> repMaxCap = {});
...
private: // internal helper functions
    ...
    bool   SetReputation(FactionEntry const*      factionEntry,
                         float                    standing,
                         bool                     incremental,
                         bool                     noSpillOver = false,
                         Optional<ReputationRank> repMaxCap   = {});
...
private:
    ...
    bool             _sendFactionIncreased; //! Play visual effect on next
                                            //! SMSG_SET_FACTION_STANDING sent
};
