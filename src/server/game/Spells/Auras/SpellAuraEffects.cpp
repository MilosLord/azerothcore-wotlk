...
// AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK set - aura is recalculated or is just
// applied/removed - need to redo all things related to m_amount
// AURA_EFFECT_HANDLE_CHANGE_AMOUNT_SEND_FOR_CLIENT_MASK - logical or of above
// conditions AURA_EFFECT_HANDLE_STAT - set when stats are reapplied such checks
// will Speedup azerothcore change amount/send for client operations because for
// change amount operation packets will not be send aura effect handlers
// shouldn't contain any AuraEffect or Aura object modifications
...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS] = {
    ...
    &AuraEffect::HandleNoImmediateEffect, //  8 SPELL_AURA_PERIODIC_HEAL
                                          //  implemented in
                                          //  AuraEffect::PeriodicTick
    ...
    &AuraEffect::HandleNoImmediateEffect, // 14 SPELL_AURA_MOD_DAMAGE_TAKEN
                                          // implemented in
                                          // Unit::MeleeDamageBonus and
                                          // Unit::SpellDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 15 SPELL_AURA_DAMAGE_SHIELD
                                          // implemented in Unit::DoAttackDamage
    ...
    &AuraEffect::
        HandleModInvisibilityDetect, // 19 SPELL_AURA_MOD_INVISIBILITY_DETECTION
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 23 SPELL_AURA_PERIODIC_TRIGGER_SPELL
                                 // implemented in AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect, // 24 SPELL_AURA_PERIODIC_ENERGIZE
                                          // implemented in
                                          // AuraEffect::PeriodicTick
    ...
    &AuraEffect::HandleNoImmediateEffect, // 28 SPELL_AURA_REFLECT_SPELLS
    ...
    &AuraEffect::HandleNoImmediateEffect,  // 42 SPELL_AURA_PROC_TRIGGER_SPELL
                                           // implemented in
                                           // Unit::ProcDamageAndSpellFor and
                                           // Unit::HandleProcTriggerSpell
    &AuraEffect::HandleNoImmediateEffect,  // 43 SPELL_AURA_PROC_TRIGGER_DAMAGE
                                           // implemented in
    ...
    &AuraEffect::HandleNULL, // 46 SPELL_AURA_46 (used in test spells 54054 and
                             // 54058, and spell 48050) (3.0.8a)
    &AuraEffect::HandleAuraModParryPercent, // 47 SPELL_AURA_MOD_PARRY_PERCENT
    &AuraEffect::
        HandleNoImmediateEffect, // 48
                                 // SPELL_AURA_PERIODIC_TRIGGER_SPELL_FROM_CLIENT
    &AuraEffect::HandleAuraModDodgePercent, // 49 SPELL_AURA_MOD_DODGE_PERCENT
    &AuraEffect::HandleNoImmediateEffect,   // 50
    ...
    &AuraEffect::
        HandleAuraModWeaponCritPercent, // 52 SPELL_AURA_MOD_WEAPON_CRIT_PERCENT
    &AuraEffect::HandleNoImmediateEffect,  // 53 SPELL_AURA_PERIODIC_LEECH
                                           // implemented in
                                           // AuraEffect::PeriodicTick
    ...
    &AuraEffect::HandleModSpellCritChance, // 57
                                           // SPELL_AURA_MOD_SPELL_CRIT_CHANCE
    &AuraEffect::
        HandleAuraModIncreaseSwimSpeed, // 58 SPELL_AURA_MOD_INCREASE_SWIM_SPEED
    &AuraEffect::
        HandleNoImmediateEffect, // 59 SPELL_AURA_MOD_DAMAGE_DONE_CREATURE
                                 // implemented in Unit::MeleeDamageBonus and
                                 // Unit::SpellDamageBonus
    &AuraEffect::HandleAuraModPacifyAndSilence, // 60
                                                // SPELL_AURA_MOD_PACIFY_SILENCE
    &AuraEffect::HandleAuraModScale,            // 61 SPELL_AURA_MOD_SCALE
    &AuraEffect::
        HandleNoImmediateEffect, // 62 SPELL_AURA_PERIODIC_HEALTH_FUNNEL
                                 // implemented in AuraEffect::PeriodicTick
    &AuraEffect::HandleNULL,     // 63 unused (3.2.0) old
                                 // SPELL_AURA_PERIODIC_MANA_FUNNEL
    &AuraEffect::HandleNoImmediateEffect, // 64 SPELL_AURA_PERIODIC_MANA_LEECH
                                          // implemented in
                                          // AuraEffect::PeriodicTick
    &AuraEffect::
    ...
    &AuraEffect::HandleNoImmediateEffect, // 69 SPELL_AURA_SCHOOL_ABSORB
                                          // implemented in
                                          // Unit::CalcAbsorbResist
    &AuraEffect::HandleUnused, // 70 SPELL_AURA_EXTRA_ATTACKS clientside
    &AuraEffect::
        HandleModSpellCritChanceShool, // 71
                                       // SPELL_AURA_MOD_SPELL_CRIT_CHANCE_SCHOOL
    &AuraEffect::HandleModPowerCostPCT, // 72
                                        // SPELL_AURA_MOD_POWER_COST_SCHOOL_PCT
    &AuraEffect::HandleModPowerCost,    // 73 SPELL_AURA_MOD_POWER_COST_SCHOOL
    &AuraEffect::HandleNoImmediateEffect, // 74 SPELL_AURA_REFLECT_SPELLS_SCHOOL
    ...
    &AuraEffect::
        HandleModDamagePercentDone,    // 79 SPELL_AURA_MOD_DAMAGE_PERCENT_DONE
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 87 SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN
                                 // implemented in Unit::MeleeDamageBonus and
                                 // Unit::SpellDamageBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 88 SPELL_AURA_MOD_HEALTH_REGEN_PERCENT
                                 // implemented in Player::RegenerateHealth
    &AuraEffect::HandleNoImmediateEffect,  // 89
                                           // SPELL_AURA_PERIODIC_DAMAGE_PERCENT
    &AuraEffect::HandleNULL,               // 90 unused (3.0.8a) old
                                           // SPELL_AURA_MOD_RESIST_CHANCE
    &AuraEffect::HandleNoImmediateEffect,  // 91 SPELL_AURA_MOD_DETECT_RANGE
                                           // implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,  // 96 SPELL_AURA_SPELL_MAGNET
                                           // implemented in
                                           // Unit::SelectMagnetTarget
    &AuraEffect::HandleNoImmediateEffect,  // 97 SPELL_AURA_MANA_SHIELD
                                           // implemented in
                                           // Unit::CalcAbsorbResist
    ...
    &AuraEffect::HandleUnused, // 100 SPELL_AURA_AURAS_VISIBLE obsolete? all
                               // player can see all auras now, but still have
                               // spells including GM-spell
    &AuraEffect::HandleModResistancePercent, // 101
                                             // SPELL_AURA_MOD_RESISTANCE_PCT
    &AuraEffect::
        HandleNoImmediateEffect, // 102 SPELL_AURA_MOD_MELEE_ATTACK_POWER_VERSUS
    ...
    &AuraEffect::HandleModPowerRegenPCT,  // 110
                                         // SPELL_AURA_MOD_POWER_REGEN_PERCENT
                                         // implemented in Player::Regenerate,
                                         // Creature::Regenerate
    &AuraEffect::
        HandleNoImmediateEffect, // 111 SPELL_AURA_ADD_CASTER_HIT_TRIGGER
                                 // implemented in Unit::SelectMagnetTarget
    &AuraEffect::HandleNoImmediateEffect, // 112
                                          // SPELL_AURA_OVERRIDE_CLASS_SCRIPTS
    &AuraEffect::
        HandleNoImmediateEffect, // 113 SPELL_AURA_MOD_RANGED_DAMAGE_TAKEN
                                 // implemented in Unit::MeleeDamageBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 114 SPELL_AURA_MOD_RANGED_DAMAGE_TAKEN_PCT
                                 // implemented in Unit::MeleeDamageBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 115 SPELL_AURA_MOD_HEALING implemented in
                                 // Unit::SpellBaseHealingBonusForVictim
    &AuraEffect::HandleNoImmediateEffect, // 116
                                          // SPELL_AURA_MOD_REGEN_DURING_COMBAT
    &AuraEffect::
        HandleNoImmediateEffect, // 117 SPELL_AURA_MOD_MECHANIC_RESISTANCE
                                 // implemented in Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 118 SPELL_AURA_MOD_HEALING_PCT
                                          // implemented in
                                          // Unit::SpellHealingBonus
    &AuraEffect::HandleNULL, // 119 unused (3.2.0) old
                             // SPELL_AURA_SHARE_PET_TRACKING
    &AuraEffect::HandleAuraUntrackable, // 120 SPELL_AURA_UNTRACKABLE
    &AuraEffect::HandleAuraEmpathy,     // 121 SPELL_AURA_EMPATHY
    &AuraEffect::
        HandleModOffhandDamagePercent, // 122 SPELL_AURA_MOD_OFFHAND_DAMAGE_PCT
    &AuraEffect::HandleModTargetResistance, // 123
                                            // SPELL_AURA_MOD_TARGET_RESISTANCE
    &AuraEffect::
        HandleAuraModRangedAttackPower, // 124
                                        // SPELL_AURA_MOD_RANGED_ATTACK_POWER
    &AuraEffect::
        HandleNoImmediateEffect, // 125 SPELL_AURA_MOD_MELEE_DAMAGE_TAKEN
                                 // implemented in Unit::MeleeDamageBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 126 SPELL_AURA_MOD_MELEE_DAMAGE_TAKEN_PCT
                                 // implemented in Unit::MeleeDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 127
    ...
    &AuraEffect::
        HandleAuraModIncreaseMountedSpeed, // 130
                                           // SPELL_AURA_MOD_MOUNTED_SPEED_ALWAYS
    &AuraEffect::HandleNoImmediateEffect, // 131
                                          // SPELL_AURA_MOD_RANGED_ATTACK_POWER_VERSUS
                                          // implemented in
                                          // Unit::MeleeDamageBonus
    &AuraEffect::
        HandleAuraModIncreaseEnergyPercent, // 132
                                            // SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT
    &AuraEffect::
        HandleAuraModIncreaseHealthPercent, // 133
                                            // SPELL_AURA_MOD_INCREASE_HEALTH_PERCENT
    &AuraEffect::
        HandleAuraModRegenInterrupt, // 134 SPELL_AURA_MOD_MANA_REGEN_INTERRUPT
    &AuraEffect::HandleModHealingDone, // 135 SPELL_AURA_MOD_HEALING_DONE
    &AuraEffect::
        HandleNoImmediateEffect, // 136 SPELL_AURA_MOD_HEALING_DONE_PERCENT
                                 // implemented in Unit::SpellHealingBonus
    &AuraEffect::
        HandleModTotalPercentStat, // 137 SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE
    ...
    &AuraEffect::
        HandleAuraModBaseResistancePCT, // 142
                                        // SPELL_AURA_MOD_BASE_RESISTANCE_PCT
    &AuraEffect::
        HandleAuraModResistanceExclusive, // 143
                                          // SPELL_AURA_MOD_RESISTANCE_EXCLUSIVE
    &AuraEffect::HandleNoImmediateEffect, // 144 SPELL_AURA_SAFE_FALL
                                          // implemented in
                                          // WorldSession::HandleMovementOpcodes
    &AuraEffect::
        HandleAuraModPetTalentsPoints, // 145 SPELL_AURA_MOD_PET_TALENT_POINTS
    &AuraEffect::HandleNoImmediateEffect, // 146 SPELL_AURA_ALLOW_TAME_PET_TYPE
    &AuraEffect::
        HandleModStateImmunityMask, // 147 SPELL_AURA_MECHANIC_IMMUNITY_MASK
    &AuraEffect::HandleAuraRetainComboPoints, // 148
                                              // SPELL_AURA_RETAIN_COMBO_POINTS
    &AuraEffect::HandleNoImmediateEffect, // 149 SPELL_AURA_REDUCE_PUSHBACK
    &AuraEffect::HandleShieldBlockValue,  // 150
                                         // SPELL_AURA_MOD_SHIELD_BLOCKVALUE_PCT
    &AuraEffect::HandleAuraTrackStealthed, // 151 SPELL_AURA_TRACK_STEALTHED
    &AuraEffect::HandleNoImmediateEffect,  // 152 SPELL_AURA_MOD_DETECTED_RANGE
                                          // implemented in
                                          // Creature::GetAggroRange
    ...
    &AuraEffect::HandleNoImmediateEffect, // 159 SPELL_AURA_NO_PVP_CREDIT only
                                          // for Honorless Target spell
    &AuraEffect::HandleNoImmediateEffect, // 160 SPELL_AURA_MOD_AOE_AVOIDANCE
                                          // implemented in
                                          // Unit::MagicSpellHitResult
    &AuraEffect::
        HandleNoImmediateEffect, // 161 SPELL_AURA_MOD_HEALTH_REGEN_IN_COMBAT
    &AuraEffect::HandleNoImmediateEffect, // 162 SPELL_AURA_POWER_BURN
                                          // implemented in
                                          // AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect, // 163
    ...
    &AuraEffect::HandleNoImmediateEffect, // 165
                                          ...
                                          // Unit::MeleeDamageBonus
    &AuraEffect::
        HandleAuraModAttackPowerPercent, // 166 SPELL_AURA_MOD_ATTACK_POWER_PCT
    &AuraEffect::
        HandleAuraModRangedAttackPowerPercent, // 167
                                               // SPELL_AURA_MOD_RANGED_ATTACK_POWER_PCT
    &AuraEffect::
        HandleNoImmediateEffect, // 168 SPELL_AURA_MOD_DAMAGE_DONE_VERSUS
                                 // implemented in Unit::SpellDamageBonus,
                                 // Unit::MeleeDamageBonus
    &AuraEffect::
    ...
    &AuraEffect::HandleDetectAmore, // 170 SPELL_AURA_DETECT_AMORE       various
                                    // spells that change visual of units for
                                    // aura target (clientside?)
    &AuraEffect::HandleAuraModIncreaseSpeed, // 171
                                             // SPELL_AURA_MOD_SPEED_NOT_STACK
    &AuraEffect::
        HandleAuraModIncreaseMountedSpeed, // 172
                                           // SPELL_AURA_MOD_MOUNTED_SPEED_NOT_STACK
    &AuraEffect::HandleNULL, // 173 unused (3.2.0) no spells, old
                             // SPELL_AURA_ALLOW_CHAMPION_SPELLS  only for
                             // Proclaim Champion spell
    &AuraEffect::
        HandleModSpellDamagePercentFromStat, // 174
                                             // SPELL_AURA_MOD_SPELL_DAMAGE_OF_STAT_PERCENT
                                             // implemented in
                                             // Unit::SpellBaseDamageBonus
    &AuraEffect::
        HandleModSpellHealingPercentFromStat, // 175
                                              // SPELL_AURA_MOD_SPELL_HEALING_OF_STAT_PERCENT
                                              // implemented in
                                              // Unit::SpellBaseHealingBonus
    &AuraEffect::HandleSpiritOfRedemption, // 176
                                           // SPELL_AURA_SPIRIT_OF_REDEMPTION
                                           // only for Spirit of Redemption
                                           // spell, die at aura end
    &AuraEffect::HandleCharmConvert, // 177 SPELL_AURA_AOE_CHARM
    &AuraEffect::
        HandleNoImmediateEffect, // 178 SPELL_AURA_MOD_DEBUFF_RESISTANCE
                                 // implemented in Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 179
                                          // SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE
                                          // implemented in
                                          // Unit::SpellCriticalBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 180 SPELL_AURA_MOD_FLAT_SPELL_DAMAGE_VERSUS
                                 // implemented in Unit::SpellDamageBonus
    &AuraEffect::HandleNULL, // 181 unused (3.2.0) old
                             // SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS
    &AuraEffect::
        HandleAuraModResistenceOfStatPercent, // 182
                                              // SPELL_AURA_MOD_RESISTANCE_OF_STAT_PERCENT
    &AuraEffect::HandleNULL, // 183 SPELL_AURA_MOD_CRITICAL_THREAT only used in
                             // 28746 - miscvalue - spell school
    &AuraEffect::
        HandleNoImmediateEffect, // 184 SPELL_AURA_MOD_ATTACKER_MELEE_HIT_CHANCE
                                 // implemented in Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect, // 185
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 186 SPELL_AURA_MOD_ATTACKER_SPELL_HIT_CHANCE
                                 // implemented in Unit::MagicSpellHitResult
    &AuraEffect::
        HandleNoImmediateEffect, // 187
                                 // SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_CHANCE
                                 // implemented in
                                 // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::
        HandleNoImmediateEffect, // 188
                                 // SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_CHANCE
                                 // implemented in
                                 // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleModRating,         // 189 SPELL_AURA_MOD_RATING
    &AuraEffect::HandleNoImmediateEffect, // 190
                                          // SPELL_AURA_MOD_FACTION_REPUTATION_GAIN
                                          // implemented in
                                          // Player::CalculateReputationGain
    &AuraEffect::
        HandleAuraModUseNormalSpeed, // 191 SPELL_AURA_USE_NORMAL_MOVEMENT_SPEED
    &AuraEffect::
        HandleModMeleeRangedSpeedPct, // 192 SPELL_AURA_MOD_MELEE_RANGED_HASTE
    &AuraEffect::HandleModCombatSpeedPct, // 193 SPELL_AURA_MELEE_SLOW (in fact
                                          // combat (any type attack) Speed pct)
    &AuraEffect::
        HandleNoImmediateEffect, // 194 SPELL_AURA_MOD_TARGET_ABSORB_SCHOOL
                                 // implemented in Unit::CalcAbsorbResist
    &AuraEffect::HandleNoImmediateEffect, // 195
                                          // SPELL_AURA_MOD_TARGET_ABILITY_ABSORB_SCHOOL
                                          // implemented in
                                          // Unit::CalcAbsorbResist
    &AuraEffect::HandleNoImmediateEffect, // 196 SPELL_AURA_MOD_COOLDOWN - flat
                                          // mod of spell cooldowns
    &AuraEffect::
        HandleNoImmediateEffect, // 197
                                 // SPELL_AURA_MOD_ATTACKER_SPELL_AND_WEAPON_CRIT_CHANCE
                                 // implemented in Unit::SpellCriticalBonus
                                 // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleNULL, // 198 unused (3.2.0) old
                             // SPELL_AURA_MOD_ALL_WEAPON_SKILLS
    &AuraEffect::HandleNoImmediateEffect, // 199
                                          // SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT
                                          // implemented in
                                          // Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 200 SPELL_AURA_MOD_XP_PCT
                                          // implemented in
                                          // Player::RewardPlayerAndGroupAtKill
    &AuraEffect::HandleAuraAllowFlight, // 201 SPELL_AURA_FLY this aura enable
                                        // flight mode...
    &AuraEffect::HandleNoImmediateEffect, // 202 SPELL_AURA_CANNOT_BE_DODGED
                                          // implemented in
                                          // Unit::RollPhysicalOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect, // 203
                                          // SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_DAMAGE
                                          // implemented in
                                          // Unit::CalculateMeleeDamage and
                                          // Unit::CalculateSpellDamage
    &AuraEffect::HandleNoImmediateEffect, // 204
    ...
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 206
                                          // SPELL_AURA_MOD_INCREASE_VEHICLE_FLIGHT_SPEED
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 207
                                          // SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 208
                                          // SPELL_AURA_MOD_INCREASE_FLIGHT_SPEED
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 209
                                          // SPELL_AURA_MOD_MOUNTED_FLIGHT_SPEED_ALWAYS
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 210
                                          // SPELL_AURA_MOD_VEHICLE_SPEED_ALWAYS
    &AuraEffect::
        HandleAuraModIncreaseFlightSpeed, // 211
                                          // SPELL_AURA_MOD_FLIGHT_SPEED_NOT_STACK
    &AuraEffect::
        HandleAuraModRangedAttackPowerOfStatPercent, // 212
                                                     // SPELL_AURA_MOD_RANGED_ATTACK_POWER_OF_STAT_PERCENT
    &AuraEffect::HandleNoImmediateEffect, // 213
    ...
    &AuraEffect::HandleUnused, // 222 unused (3.2.0) only for spell 44586 that
                               // not used in real spell cast
    &AuraEffect::HandleNoImmediateEffect, // 223
                                          // SPELL_AURA_RAID_PROC_FROM_CHARGE
    &AuraEffect::HandleUnused, // 224 unused (3.0.8a)
    &AuraEffect::
        HandleNoImmediateEffect, // 225
                                 // SPELL_AURA_RAID_PROC_FROM_CHARGE_WITH_VALUE
    &AuraEffect::HandleNoImmediateEffect, // 226 SPELL_AURA_PERIODIC_DUMMY
                                          // implemented in
                                          // AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect, // 227
                                          // SPELL_AURA_PERIODIC_TRIGGER_SPELL_WITH_VALUE
                                          // implemented in
                                          // AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect, // 228 SPELL_AURA_DETECT_STEALTH
                                          // stealth detection
    &AuraEffect::HandleNoImmediateEffect, // 229
                                          // SPELL_AURA_MOD_AOE_DAMAGE_AVOIDANCE
    &AuraEffect::
        HandleAuraModIncreaseHealth, // 230 SPELL_AURA_MOD_INCREASE_HEALTH_2
    &AuraEffect::
        HandleNoImmediateEffect, // 231 SPELL_AURA_PROC_TRIGGER_SPELL_WITH_VALUE
    &AuraEffect::
        HandleNoImmediateEffect, // 232 SPELL_AURA_MECHANIC_DURATION_MOD
                                 // implement in Unit::CalculateSpellDuration
    &AuraEffect::HandleUnused, // 233 set model id to the one of the creature
                               // with id GetMiscValue() - clientside
    &AuraEffect::HandleNoImmediateEffect, // 234
                                          // SPELL_AURA_MECHANIC_DURATION_MOD_NOT_STACK
                                          // implement in
                                          // Unit::CalculateSpellDuration
    &AuraEffect::HandleNoImmediateEffect, // 235 SPELL_AURA_MOD_DISPEL_RESIST
                                          // implement in
                                          // Unit::MagicSpellHitResult
    &AuraEffect::HandleAuraControlVehicle, // 236 SPELL_AURA_CONTROL_VEHICLE
    &AuraEffect::
        HandleModSpellDamagePercentFromAttackPower, // 237
                                                    // SPELL_AURA_MOD_SPELL_DAMAGE_OF_ATTACK_POWER
                                                    // implemented in
                                                    // Unit::SpellBaseDamageBonus
    &AuraEffect::
        HandleModSpellHealingPercentFromAttackPower, // 238
                                                     // SPELL_AURA_MOD_SPELL_HEALING_OF_ATTACK_POWER
                                                     // implemented in
                                                     // Unit::SpellBaseHealingBonus
    &AuraEffect::HandleAuraModScale, // 239 SPELL_AURA_MOD_SCALE_2 only in
                                     // Noggenfogger Elixir (16595) before 2.3.0
                                     // aura 61
    &AuraEffect::HandleAuraModExpertise, // 240 SPELL_AURA_MOD_EXPERTISE
    &AuraEffect::HandleForceMoveForward, // 241 SPELL_AURA_FORCE_MOVE_FORWARD
                                         // Forces the caster to move forward
    &AuraEffect::HandleNULL, // 242 SPELL_AURA_MOD_SPELL_DAMAGE_FROM_HEALING - 2
                             // test spells: 44183 and 44182
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 245 SPELL_AURA_MOD_AURA_DURATION_BY_DISPEL
    &AuraEffect::HandleNoImmediateEffect, // 246
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 248 SPELL_AURA_MOD_COMBAT_RESULT_CHANCE
                                 // implemented in Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleAuraConvertRune, // 249 SPELL_AURA_CONVERT_RUNE
    &AuraEffect::
        HandleAuraModIncreaseHealth, // 250 SPELL_AURA_MOD_INCREASE_HEALTH_2
    &AuraEffect::HandleNoImmediateEffect, // 251 SPELL_AURA_MOD_ENEMY_DODGE
    &AuraEffect::HandleModCombatSpeedPct, // 252 SPELL_AURA_252 Is there any
                                          // difference between this and
                                          // SPELL_AURA_MELEE_SLOW ? maybe not
                                          // stacking mod?
    &AuraEffect::
        HandleNoImmediateEffect, // 253 SPELL_AURA_MOD_BLOCK_CRIT_CHANCE
                                 // implemented in Unit::isBlockCritical
    &AuraEffect::HandleAuraModDisarm,     // 254 SPELL_AURA_MOD_DISARM_OFFHAND
    &AuraEffect::HandleNoImmediateEffect, // 255
                                          // SPELL_AURA_MOD_MECHANIC_DAMAGE_TAKEN_PERCENT
                                          // implemented in
                                          // Unit::SpellDamageBonus
    &AuraEffect::HandleNoReagentUseAura, // 256 SPELL_AURA_NO_REAGENT_USE Use
                                         // SpellClassMask for spell select
    &AuraEffect::HandleNULL, // 257 SPELL_AURA_MOD_TARGET_RESIST_BY_SPELL_CLASS
    ...
    &AuraEffect::HandleNoImmediateEffect, // 259 SPELL_AURA_MOD_HOT_PCT
                                          ...
                                          // Unit::SpellHealingBonus
    &AuraEffect::
        HandleNoImmediateEffect, // 260 SPELL_AURA_SCREEN_EFFECT (miscvalue = id
                                 // in ScreenEffect.dbc) not required any code
    &AuraEffect::HandlePhase,             // 261 SPELL_AURA_PHASE
    &AuraEffect::HandleNoImmediateEffect, // 262
                                          // SPELL_AURA_ABILITY_IGNORE_AURASTATE
                                          // implemented in spell::cancast
    &AuraEffect::HandleAuraAllowOnlyAbility, // 263
                                             // SPELL_AURA_ALLOW_ONLY_ABILITY
                                             // player can use only abilities
                                             // set in SpellClassMask
    &AuraEffect::HandleUnused, // 264 unused (3.2.0)
    &AuraEffect::HandleUnused, // 265 unused (3.2.0)
    &AuraEffect::HandleUnused, // 266 unused (3.2.0)
    &AuraEffect::
        HandleNoImmediateEffect, // 267 SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL
                                 // implemented in Unit::IsImmunedToSpellEffect
    &AuraEffect::
        HandleAuraModAttackPowerOfStatPercent, // 268
                                               // SPELL_AURA_MOD_ATTACK_POWER_OF_STAT_PERCENT
    &AuraEffect::
        HandleNoImmediateEffect, // 269 SPELL_AURA_MOD_IGNORE_TARGET_RESIST
                                 // implemented in Unit::CalcAbsorbResist and
                                 // CalcArmorReducedDamage
    &AuraEffect::HandleNoImmediateEffect, // 270
                                          // SPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST
                                          // implemented in
                                          // Unit::CalcAbsorbResist and
                                          // CalcArmorReducedDamage
    &AuraEffect::
        HandleNoImmediateEffect, // 271 SPELL_AURA_MOD_DAMAGE_FROM_CASTER
                                 // implemented in Unit::SpellDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 272 SPELL_AURA_IGNORE_MELEE_RESET
    &AuraEffect::HandleUnused,            // 273 clientside
    &AuraEffect::
        HandleNoImmediateEffect, // 274 SPELL_AURA_CONSUME_NO_AMMO implemented
                                 // in spell::CalculateDamageDoneForAllTargets
    &AuraEffect::HandleNoImmediateEffect, // 275
                                          // SPELL_AURA_MOD_IGNORE_SHAPESHIFT
                                          // Use SpellClassMask for spell select
    &AuraEffect::HandleNULL,              // 276 mod damage % mechanic?
    &AuraEffect::HandleNoImmediateEffect, // 277
                                          // SPELL_AURA_MOD_ABILITY_AFFECTED_TARGETS
                                          // implemented in spell::settargetmap
    &AuraEffect::HandleAuraModDisarm, // 278 SPELL_AURA_MOD_DISARM_RANGED disarm
                                      // ranged weapon
    ...
    &AuraEffect::HandleNoImmediateEffect, // 281 SPELL_AURA_MOD_HONOR_GAIN_PCT
                                          // implemented in Player::RewardHonor
    &AuraEffect::
        HandleAuraIncreaseBaseHealthPercent, // 282
                                             // SPELL_AURA_INCREASE_BASE_HEALTH_PERCENT
    &AuraEffect::HandleNoImmediateEffect, // 283 SPELL_AURA_MOD_HEALING_RECEIVED
                                          // implemented in
                                          // Unit::SpellHealingBonus
    &AuraEffect::HandleAuraLinked, // 284 SPELL_AURA_LINKED
    &AuraEffect::
        HandleAuraModAttackPowerOfArmor, // 285
                                         // SPELL_AURA_MOD_ATTACK_POWER_OF_ARMOR
                                         // implemented in
                                         // Player::UpdateAttackPowerAndDamage
    &AuraEffect::
        HandleNoImmediateEffect, // 286 SPELL_AURA_ABILITY_PERIODIC_CRIT
                                 // implemented in AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect, // 287 SPELL_AURA_DEFLECT_SPELLS
                                          // implemented in
                                          // Unit::MagicSpellHitResult and
                                          // Unit::MeleeSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 288 SPELL_AURA_IGNORE_HIT_DIRECTION
                                          // implemented in
                                          // Unit::MagicSpellHitResult and
                                          // Unit::MeleeSpellHitResult
                                          // Unit::RollMeleeOutcomeAgainst
    &AuraEffect::
        HandleNoImmediateEffect, // 289 SPELL_AURA_PREVENT_DURABILITY_LOSS
                                 // implemented in Player::DurabilityPointsLoss
    &AuraEffect::HandleAuraModCritPct,    // 290 SPELL_AURA_MOD_CRIT_PCT
    &AuraEffect::HandleNoImmediateEffect, // 291 SPELL_AURA_MOD_XP_QUEST_PCT
                                          // implemented in Player::RewardQuest
    &AuraEffect::HandleAuraOpenStable,     // 292 SPELL_AURA_OPEN_STABLE
    &AuraEffect::HandleAuraOverrideSpells, // 293 auras which probably add set
                                           // of abilities to their target based
                                           // on it's miscvalue
    &AuraEffect::HandleModManaRegen, // 294 SPELL_AURA_PREVENT_REGENERATE_POWER
                                     // implemented in Player::Regenerate(Powers
                                     // power), HandleModManaRegen to refresh
                                     // regeneration clientside
    &AuraEffect::HandleNULL,           // 295 0 spells in 3.3.5
    &AuraEffect::HandleAuraSetVehicle, // 296 SPELL_AURA_SET_VEHICLE_ID sets
                                       // vehicle on target
    &AuraEffect::HandleNULL, // 297 Spirit Burst spells
    &AuraEffect::HandleNULL, // 298 70569 - Strangulating, maybe prevents talk
                             // or cast
    &AuraEffect::HandleNULL,              // 299 unused
    &AuraEffect::HandleNoImmediateEffect, // 300 SPELL_AURA_SHARE_DAMAGE_PCT
                                          // implemented in Unit::DealDamage
    &AuraEffect::HandleNoImmediateEffect, // 301 SPELL_AURA_SCHOOL_HEAL_ABSORB
                                          // implemented in Unit::CalcHealAbsorb
    &AuraEffect::HandleNULL,              // 302 0 spells in 3.3.5
    &AuraEffect::HandleNoImmediateEffect, // 303
                                          // SPELL_AURA_MOD_DAMAGE_DONE_VERSUS_AURASTATE
                                          // implemented in
                                          // Unit::SpellDamageBonus,
                                          // Unit::MeleeDamageBonus
    &AuraEffect::HandleAuraModFakeInebriation, // 304
    ...
    &AuraEffect::
        HandleNoImmediateEffect, // 308 SPELL_AURA_MOD_CRIT_CHANCE_FOR_CASTER
                                 // implemented in Unit::isSpellCrit,
                                 // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleNULL,              // 309 0 spells in 3.3.5
    &AuraEffect::HandleNoImmediateEffect, // 310
    ...
    &AuraEffect::
        HandlePreventResurrection, // 314 SPELL_AURA_PREVENT_RESURRECTION todo
    &AuraEffect::HandleNoImmediateEffect, // 315 SPELL_AURA_UNDERWATER_WALKING
                                          // todo
    &AuraEffect::HandleNoImmediateEffect, // 316 SPELL_AURA_PERIODIC_HASTE
                                          // implemented in
...
AuraEffect::AuraEffect(Aura*  base,
    ...
    : m_base(base), m_spellInfo(base->GetSpellInfo()),
      m_baseAmount(baseAmount ? *baseAmount
                              : m_spellInfo->Effects[effIndex].BasePoints),
      m_dieSides(m_spellInfo->Effects[effIndex].DieSides), m_critChance(0),
      m_oldAmount(0), m_isAuraEnabled(true), m_channelData(nullptr),
      ...
      m_effIndex(effIndex), m_canBeRecalculated(true), m_isPeriodic(false)
{
    ...
    if (caster)
        if (Spell* spell = caster->GetCurrentSpell(CURRENT_CHANNELED_SPELL))
            m_channelData = new ChannelTargetData(
                caster->GetGuidValue(UNIT_FIELD_CHANNEL_OBJECT),
                spell->m_targets.HasDst() ? spell->m_targets.GetDst()
                                          : nullptr);
}
...
void AuraEffect::GetTargetList(std::list<Unit*>& targetList) const
{
    ...
    // remove all targets which were not added to new list - they no longer
    // deserve area aura
    for (Aura::ApplicationMap::const_iterator appIter = targetMap.begin();
         appIter != targetMap.end();
         ++appIter) {
...
uint32 AuraEffect::GetId() const { return m_spellInfo->Id; }
...
int32 AuraEffect::CalculateAmount(Unit* caster)
{
    ...
    amount = m_spellInfo->Effects[m_effIndex].CalcValue(
        caster, &m_baseAmount, nullptr);
                    ...
                    if (castItem->GetItemSuffixFactor()) {
                        ItemRandomSuffixEntry const* item_rand_suffix =
                            sItemRandomSuffixStore.LookupEntry(
                                std::abs(castItem->GetItemRandomPropertyId()));
                        if (item_rand_suffix) {
                            for (uint8 k = 0; k < MAX_ITEM_ENCHANTMENT_EFFECTS;
                                 k++) {
                                SpellItemEnchantmentEntry const* pEnchant =
                                    sSpellItemEnchantmentStore.LookupEntry(
                                        item_rand_suffix->Enchantment[k]);
                                if (pEnchant) {
                                    for (uint8 t = 0;
                                         t < MAX_SPELL_ITEM_ENCHANTMENT_EFFECTS;
                                         t++)
    ...
    case SPELL_AURA_TRANSFORM:
        ...
        if (!m_spellInfo->ProcFlags ||
            m_spellInfo->HasAura(
                SPELL_AURA_PROC_TRIGGER_SPELL)) // xinef: skip auras with
                                                // proctriggerspell, they must
                                                // have procflags...
            break;
    ...
    // xinef: save base amount, before calculating sp etc. Used for
    // Unit::CastDelayedSpellWithPeriodicAmount
    SetOldAmount(amount * GetBase()->GetStackAmount());
    GetBase()->CallScriptEffectCalcAmountHandlers(
        this, amount, m_canBeRecalculated);
    ...
    if (caster)
        ...
        case SPELL_AURA_PERIODIC_LEECH:
            // xinef: save caster depending auras, always pass 1 as stack
            // amount, effect will be multiplicated at the end of the function
            // by correct value!
            if (GetBase()->GetType() == UNIT_AURA_TYPE)
                amount = caster->SpellDamageBonusDone(GetBase()->GetUnitOwner(),
                                                      GetSpellInfo(),
                                                      amount,
                                                      DOT,
                                                      GetEffIndex(),
        ...
        case SPELL_AURA_PERIODIC_HEAL:
            if (GetBase()->GetType() == UNIT_AURA_TYPE)
                amount =
                    caster->SpellHealingBonusDone(GetBase()->GetUnitOwner(),
                                                  GetSpellInfo(),
                                                  amount,
                                                  DOT,
                                                  GetEffIndex(),
...
void AuraEffect::CalculatePeriodicData()
{
    ...
    if (GetBase()->GetType() == UNIT_AURA_TYPE && GetCaster()) {
        if (m_spellInfo->HasAura(SPELL_AURA_PERIODIC_HEAL))
            m_pctMods = GetCaster()->SpellPctHealingModsDone(
                GetBase()->GetUnitOwner(), GetSpellInfo(), DOT);
        else if (m_spellInfo->HasAura(SPELL_AURA_PERIODIC_DAMAGE) ||
                 m_spellInfo->HasAura(SPELL_AURA_PERIODIC_LEECH))
            m_pctMods = GetCaster()->SpellPctDamageModsDone(
                GetBase()->GetUnitOwner(), GetSpellInfo(), DOT);
    }

    if (GetCaster())
        SetCritChance(CalcPeriodicCritChance(
            GetCaster(),
            (GetBase()->GetType() == UNIT_AURA_TYPE ? GetBase()->GetUnitOwner()
                                                    : nullptr)));
}
...
void AuraEffect::CalculatePeriodic(Unit* caster, bool create, bool load)
{
    ...
    if (m_amplitude) {
        ...
        if (modOwner)
            modOwner->ApplySpellMod(
                GetId(), SPELLMOD_ACTIVATION_TIME, m_amplitude);

        if (caster) {
            if (caster->HasAuraTypeWithAffectMask(SPELL_AURA_PERIODIC_HASTE,
                                                  m_spellInfo) ||
    ...
    if (load) // aura loaded from db
    {
        ...
        m_periodicTimer =
            m_amplitude ? GetBase()->GetDuration() % m_amplitude : 0;
    ...
    else // aura just created or reapplied
    {
        ...
        // possibly we should not reset periodic timers only when aura is
        // triggered by proc or maybe there's a spell attribute somewhere
        bool resetPeriodicTimer =
            create || ((GetAuraType() != SPELL_AURA_PERIODIC_DAMAGE) &&
                       (GetAuraType() != SPELL_AURA_PERIODIC_DAMAGE_PERCENT));

        if (resetPeriodicTimer) {
            m_periodicTimer = 0;
            // Start periodic on next tick or at aura apply
            if (m_amplitude) {
                if (!GetSpellInfo()->HasAttribute(
...
void AuraEffect::CalculateSpellMod()
{
    ...
    case SPELL_AURA_ADD_PCT_MODIFIER:
        if (!m_spellmod) {
            ...
            m_spellmod->type = SpellModType(
                GetAuraType()); // SpellModType value == spell aura types
            m_spellmod->spellId = GetId();
            m_spellmod->mask =
                GetSpellInfo()->Effects[GetEffIndex()].SpellClassMask;
...
void AuraEffect::ChangeAmount(int32 newAmount, bool mark, bool onStackOrReapply)
{
    ...
    for (std::list<AuraApplication*>::const_iterator apptItr =
             effectApplications.begin();
         apptItr != effectApplications.end();
         ++apptItr)
...
{
    // check if call is correct, we really don't want using bitmasks here (with
    // 1 exception)
    ASSERT(mode == AURA_EFFECT_HANDLE_REAL ||
           ...
           mode ==
               (AURA_EFFECT_HANDLE_CHANGE_AMOUNT | AURA_EFFECT_HANDLE_REAPPLY));

    // register/unregister effect in lists in case of real AuraEffect
    // apply/remove registration/unregistration is done always before real
    // effect handling (some effect handlers code is depending on this)
    if (mode & AURA_EFFECT_HANDLE_REAL)
        aurApp->GetTarget()->_RegisterAuraEffect(this, apply);

    // xinef: stacking system, force return if effect is disabled, prevents
    // double apply / unapply xinef: placed here so above line can unregister
    // effect from the list xinef: this condition works under assumption that
    // effect handlers performs ALL necessery action with CHANGE_AMOUNT mode
    ...
    if (apply)
        prevented = GetBase()->CallScriptEffectApplyHandlers(
            this,
            const_cast<AuraApplication const*>(aurApp),
    ...
    // check if script events have removed the aura or if default effect
    // prevention was requested
    ...
    if (apply)
        GetBase()->CallScriptAfterEffectApplyHandlers(
            this, aurApp, (AuraEffectHandleModes)mode);
    else
...
void AuraEffect::HandleEffect(Unit* target, uint8 mode, bool apply)
{
    AuraApplication* aurApp =
        GetBase()->GetApplicationOfTarget(target->GetGUID());
    ASSERT(aurApp);
...
void AuraEffect::ApplySpellMod(Unit* target, bool apply)
{
    ...
    case SPELLMOD_EFFECT3: {
        ...
        for (Unit::AuraApplicationMap::iterator iter = auras.begin();
            ...
            // only passive and permament auras-active auras should have amount
            // set on spellcast and not be affected if aura is casted by others,
        ...
        for (Unit::AuraApplicationMap::iterator iter = petauras.begin();
             iter != petauras.end();
             ++iter) {
            Aura* aura = iter->second->GetBase();
            // only passive auras-active auras should have amount set on
            // spellcast and not be affected if aura is casted by others, it
            // will not be affected
            if ((aura->IsPassive() || aura->IsPermanent()) &&
                aura->GetCasterGUID() == petguid &&
                aura->GetSpellInfo()->IsAffectedBySpellMod(m_spellmod)) {
                if (GetMiscValue() == SPELLMOD_ALL_EFFECTS) {
                    for (uint8 i = 0; i < MAX_SPELL_EFFECTS; ++i) {
                        if (AuraEffect* aurEff = aura->GetEffect(i))
...
{
    if (m_isPeriodic && (GetBase()->GetDuration() >= 0 ||
                         GetBase()->IsPassive() || GetBase()->IsPermanent())) {
        ...
        while (m_periodicTimer <= 0) {
            ...
            // update before tick (aura can be removed in TriggerSpell or
            // PeriodicTick calls)
            m_periodicTimer += m_amplitude;
            ...
            case 61830:
                ...
                if (AuraEffect* aurEff = GetBase()->GetEffect(0)) {
                    if (aurEff->GetAuraType() != SPELL_AURA_MOD_POWER_REGEN) {
                        ...
                        LOG_ERROR(
                            "spells.aura.effect",
                            "Aura {} structure has been changed - first aura "
                            "is no longer SPELL_AURA_MOD_POWER_REGEN",
                            GetId());
                    }
                    else {
                        ...
                        if (!caster->ToPlayer()->InArena()) {
                            ...
                            // **********************************************
                            // Here need increase mana regen per tick (6 second
                            // rule) on 0 tick -   0  (handled in 2 second) on 1
                            // tick - 166% (handled in 4 second) on 2 tick -
                            // 133% (handled in 6 second)
                                         ...
                                         Unit const* target) const
{
    ...
    if (caster) {
        if (Player* modOwner = caster->GetSpellModOwner()) {
            ...
            for (Unit::AuraEffectList::const_iterator itr =
                     mPeriodicCritAuras.begin();
                 itr != mPeriodicCritAuras.end();
                 ++itr) {
                if ((*itr)->IsAffectedOnSpell(GetSpellInfo())) {
                    critChance = modOwner->SpellDoneCritChance(
                        nullptr,
                        GetSpellInfo(),
                        GetSpellInfo()->GetSchoolMask(),
                        (GetSpellInfo()->DmgClass == SPELL_DAMAGE_CLASS_RANGED
                             ? RANGED_ATTACK
                             : BASE_ATTACK),
                        true);
                    break;
    ...
    if (target && critChance > 0.0f)
        critChance =
            target->SpellTakenCritChance(caster,
                                         GetSpellInfo(),
                                         GetSpellInfo()->GetSchoolMask(),
                                         critChance,
                                         BASE_ATTACK,
...
void AuraEffect::PeriodicTick(AuraApplication* aurApp, Unit* caster) const
{
    ...
    // Update serverside orientation of tracking channeled auras on periodic
    // update ticks exclude players because can turn during channeling and
    // shouldn't desync orientation client/server
    if (caster && !caster->IsPlayer() && m_spellInfo->IsChanneled() &&
        m_spellInfo->HasAttribute(SPELL_ATTR1_TRACK_TARGET_IN_CHANNEL)) {
        ObjectGuid const channelGuid =
            caster->GetGuidValue(UNIT_FIELD_CHANNEL_OBJECT);
        if (!channelGuid.IsEmpty() && channelGuid != caster->GetGUID()) {
            if (WorldObject const* objectTarget =
                    ObjectAccessor::GetWorldObject(*caster, channelGuid)) {
    ...
    case SPELL_AURA_PERIODIC_TRIGGER_SPELL:
        ...
        break;
    case SPELL_AURA_PERIODIC_TRIGGER_SPELL_FROM_CLIENT:
        // Don't actually do anything - client will trigger casts of these
        // spells by itself
        break;
    case SPELL_AURA_PERIODIC_TRIGGER_SPELL_WITH_VALUE:
...
{
    bool prevented =
        GetBase()->CallScriptEffectProcHandlers(this, aurApp, eventInfo);
    if (prevented)
        return;
...
void AuraEffect::CleanupTriggeredSpells(Unit* target)
{
    ...
    /// sophisticated way?
    if (m_spellInfo->Effects[GetEffIndex()].ApplyAuraName ==
            SPELL_AURA_PERIODIC_TRIGGER_SPELL &&
        uint32(m_spellInfo->GetDuration()) ==
            m_spellInfo->Effects[GetEffIndex()].Amplitude)
        return;
...
void AuraEffect::HandleShapeshiftBoosts(Unit* target, bool apply) const
{
    ...
    if (apply) {
        // Remove cooldown of spells triggered on stance change - they may share
        // cooldown with stance spell
        if (spellId) {
            if (player)
                player->RemoveSpellCooldown(spellId);
            target->CastSpell(
                target, spellId, true, nullptr, this, target->GetGUID());
        }
        ...
        if (spellId2) {
            ...
            target->CastSpell(
                target, spellId2, true, nullptr, this, target->GetGUID());
        }
        ...
        if (player) {
            ...
            for (PlayerSpellMap::const_iterator itr = sp_list.begin();
                ...
                if (itr->second->State == PLAYERSPELL_REMOVED ||
                    !itr->second->IsInSpec(player->GetActiveSpec()))
                    continue;
                ...
                if (!spellInfo ||
                    !spellInfo->HasAttribute(SpellAttr0(
                        SPELL_ATTR0_PASSIVE | SPELL_ATTR0_DO_NOT_DISPLAY)))
                    continue;
            ...
            // xinef: talent stance auras are not on m_spells map, so iterate
            // talents
            const PlayerTalentMap& tl_list = player->GetTalentMap();
            for (PlayerTalentMap::const_iterator itr = tl_list.begin();
                 itr != tl_list.end();
                 ++itr) {
                if (itr->second->State == PLAYERSPELL_REMOVED ||
                    !itr->second->IsInSpec(player->GetActiveSpec()))
            ...
            for (uint32 i = 0; i < MAX_GLYPH_SLOT_INDEX; ++i) {
                if (uint32 glyphId = player->GetGlyph(i)) {
                    if (GlyphPropertiesEntry const* glyph =
                        ...
                        if (!spellInfo || !spellInfo->HasAttribute(SpellAttr0(
                                              SPELL_ATTR0_PASSIVE |
            ...
            if (player->HasTalent(17007, player->GetActiveSpec())) {
                ...
                if (spellInfo &&
                    ...
                    target->CastSpell(
                        target, 24932, true, nullptr, this, target->GetGUID());
            }
            // Improved Barkskin - apply/remove armor bonus due to shapeshift
            if (player->HasTalent(63410, player->GetActiveSpec()) ||
                player->HasTalent(63411, player->GetActiveSpec())) {
                target->RemoveAurasDueToSpell(66530);
                if (GetMiscValue() == FORM_TRAVEL ||
                    GetMiscValue() == FORM_NONE) // "while in Travel Form or
                                                 // while not shapeshifted"
                    target->CastSpell(target, 66530, true);
            }
            // Heart of the Wild
            if (HotWSpellId) {
                // hacky, but the only way as spell family is not
                // SPELLFAMILY_DRUID
                Unit::AuraEffectList const& mModTotalStatPct =
                    target->GetAuraEffectsByType(
                        SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE);
                for (Unit::AuraEffectList::const_iterator i =
                         mModTotalStatPct.begin();
                     i != mModTotalStatPct.end();
                     ++i) {
                    // Heart of the Wild
                    if ((*i)->GetSpellInfo()->SpellIconID == 240 &&
                        (*i)->GetMiscValue() == STAT_INTELLECT) {
                        int32 HotWMod = (*i)->GetAmount() /
                                        2; // For each 2% Intelligence, you get
                                           // 1% stamina and 1% attack power.
            ...
            case FORM_CAT:
                // Savage Roar
                if (target->GetAuraEffect(
                        SPELL_AURA_DUMMY, SPELLFAMILY_DRUID, 0, 0x10000000, 0))
                    target->CastSpell(target, 62071, true);
                // Nurturing Instinct
                if (AuraEffect const* aurEff = target->GetAuraEffect(
                        SPELL_AURA_MOD_SPELL_HEALING_OF_STAT_PERCENT,
                        SPELLFAMILY_DRUID,
                        2254,
                        0)) {
                ...
                if (AuraEffect const* aurEff = target->GetDummyAuraEffect(
                    ...
                    target->CastCustomSpell(
                        target, 48420, &bp, nullptr, nullptr, true);
                }
                break;
            case FORM_DIREBEAR:
            case FORM_BEAR:
                ...
                if (AuraEffect const* aurEff = target->GetDummyAuraEffect(
                    ...
                    int32 bp = aurEff->GetAmount();
                    target->CastCustomSpell(
                        target, 48418, &bp, nullptr, nullptr, true);
                }
                ...
                if (AuraEffect const* aurEff = target->GetAuraEffect(
                        ...
                        0)) {
                    int32 bp =
                        aurEff->GetSpellInfo()->Effects[EFFECT_2].CalcValue();
                    target->CastCustomSpell(target,
                                            62069,
                                            &bp,
                                            nullptr,
            ...
            case FORM_MOONKIN:
                ...
                if (AuraEffect const* aurEff = target->GetDummyAuraEffect(
                    ...
                    int32 bp = aurEff->GetAmount();
                    target->CastCustomSpell(
                        target, 48421, &bp, nullptr, nullptr, true);
                }
                // Always cast Moonkin Aura
                target->CastSpell(
                    target, 24907, true, nullptr, this, target->GetGUID());
                break;
            ...
            case FORM_TREE:
                if (AuraEffect const* aurEff = target->GetDummyAuraEffect(
                    ...
                    int32 bp = aurEff->GetAmount();
                    target->CastCustomSpell(
                        target, 48422, &bp, nullptr, nullptr, true);
                }
                break;
            }
        }
        ...
        const Unit::AuraEffectList& shapeshifts =
            target->GetAuraEffectsByType(SPELL_AURA_MOD_SHAPESHIFT);
        AuraEffect* newAura = nullptr;
        // Iterate through all the shapeshift auras that the target has, if
        // there is another aura with SPELL_AURA_MOD_SHAPESHIFT, then this aura
        // is being removed due to that one being applied
        for (Unit::AuraEffectList::const_iterator itr = shapeshifts.begin();
             itr != shapeshifts.end();
             ++itr) {
            if ((*itr) != this) {
                newAura = *itr;
        ...
        for (Unit::AuraApplicationMap::iterator itr = tAuras.begin();
            ...
            if (itr->second->GetBase()->IsRemovedOnShapeLost(target) &&
                (!(itr->second->GetBase()->GetSpellInfo()->Stances &
                   newStance) ||
                 itr->second->GetBase()->IsPassive()))
        ...
        if (Spell* spell = target->GetCurrentSpell(CURRENT_MELEE_SPELL))
            if (spell->GetSpellInfo()->CheckShapeshift(
                    newAura ? newAura->GetMiscValue() : 0) != SPELL_CAST_OK)
                spell->cancel(true);
    }
}
                                             ...
                                             bool                   apply) const
{
    ...
    // call functions which may have additional effects after chainging state of
    // unit
                                       ...
                                       bool                   apply) const
{
    ...
    if (apply) {
        ...
        if (target->GetTypeId() == TYPEID_PLAYER &&
            (type == INVISIBILITY_GENERAL || type == INVISIBILITY_UNK10))
            target->SetByteFlag(PLAYER_FIELD_BYTES2,
        ...
        if (!target->HasAuraType(SPELL_AURA_MOD_INVISIBILITY)) {
            ...
            if (target->GetTypeId() == TYPEID_PLAYER)
                target->RemoveByteFlag(PLAYER_FIELD_BYTES2,
                                       3,
                                       PLAYER_FIELD_BYTE2_INVISIBILITY_GLOW);
            ...
            bool                        found = false;
            Unit::AuraEffectList const& invisAuras =
                target->GetAuraEffectsByType(SPELL_AURA_MOD_INVISIBILITY);
            for (Unit::AuraEffectList::const_iterator i = invisAuras.begin();
                 i != invisAuras.end();
                 ++i) {
            ...
            if (!found) {
                ...
                // remove glow vision
                if (target->GetTypeId() == TYPEID_PLAYER &&
                    !target->m_invisibility.HasFlag(INVISIBILITY_GENERAL) &&
                    !target->m_invisibility.HasFlag(INVISIBILITY_UNK10)) {
                                  ...
                                  bool                   apply) const
{
    ...
    if (apply) {
        ...
        if (target->GetTypeId() == TYPEID_PLAYER)
            target->SetByteFlag(
                PLAYER_FIELD_BYTES2, 3, PLAYER_FIELD_BYTE2_STEALTH);
        ...
        if (!target->HasAuraType(
                SPELL_AURA_MOD_STEALTH)) // if last SPELL_AURA_MOD_STEALTH
        {
                                   ...
                                   bool                   apply) const
{
    ...
    if (apply) {
        ...
        if (target->HasAuraType(SPELL_AURA_DETECT_AMORE)) {
            Unit::AuraEffectList const& amoreAuras =
        ...
        target->RemoveByteFlag(
            PLAYER_FIELD_BYTES2, 3, 1 << (GetMiscValue() - 1));
    }
}
                                          ...
                                          bool                   apply) const
{
    ...
    // die at aura end
        ...
        // call functions which may have additional effects after chainging
        // state of unit
        target->setDeathState(DeathState::JustDied);

    // xinef: damage immunity spell, not needed because of 93 aura (adds
    // non_attackable state) xinef: probably blizzard added it just in case in
    // wotlk (id > 46000)
    if (apply)
                             ...
                             bool                   apply) const
{
        ...
        if (!newPhase) {
            ...
            if (Creature* creature = target->ToCreature())
                if (CreatureData const* data =
                        sObjectMgr->GetCreatureData(creature->GetSpawnId()))
    ...
    // call functions which may have additional effects after chainging state of
    // unit phase auras normally not expected at BG but anyway better check
    if (apply) {
        // drop flag at invisibiliy in bg
        target->RemoveAurasWithInterruptFlags(
            AURA_INTERRUPT_FLAG_IMMUNE_OR_LOST_SELECTION);
    ...
    // need triggering visibility update base at phase update of not GM
    // invisible (other GMs anyway see in any phases)
    if (target->IsVisible()) {
        if (!target->GetMap()->Instanceable()) {
            target->UpdateObjectVisibility(false);
            target->m_last_notify_position.Relocate(
                                         ...
                                         bool                   apply) const
{
    ...
    case FORM_SPIRITOFREDEMPTION: // 0x20
        break;
    default:
        LOG_ERROR("spells.aura.effect",
                  "Auras: Unknown Shapeshift Type: {}",
                  GetMiscValue());
    }
    ...
    if (apply) {
        ...
        // xinef: rogue shouldnt be wrapped by this check (shadow dance vs
        // stealth)
        if (GetSpellInfo()->SpellFamilyName != SPELLFAMILY_ROGUE)
            target->RemoveAurasByType(
                SPELL_AURA_MOD_SHAPESHIFT, ObjectGuid::Empty, GetBase());
        ...
        if (PowerType != POWER_MANA) {
            ...
            case FORM_DIREBEAR: {
                ...
                if (AuraEffect const* dummy =
                        target->GetDummyAuraEffect(SPELLFAMILY_DRUID, 238, 0))
                ...
                default: {
                    uint32 newEnergy =
                        std::min(target->GetPower(POWER_ENERGY), FurorChance);
        ...
        // xinef: allow shapeshift to override model id if forced transform aura
        // is not present!
        if (modelid > 0) {
            bool allow = true;
            if (target->getTransForm())
                if (SpellInfo const* transformSpellInfo =
                        sSpellMgr->GetSpellInfo(target->getTransForm()))
        ...
        case FORM_BERSERKERSTANCE: {
            ...
            if (form == FORM_DEFENSIVESTANCE) {
                if (AuraEffect const* aurEff =
                        target->IsScriptOverriden(m_spellInfo, 831))
                    Rage_val += aurEff->GetAmount() * 10;
            }
            // Stance mastery + Tactical mastery (both passive, and last have
            // aura only in defense stance, but need apply at any stance switch)
            if (target->GetTypeId() == TYPEID_PLAYER) {
                ...
                for (PlayerSpellMap::const_iterator itr = sp_list.begin();
                    ...
                    if (spellInfo &&
                        ...
                        Rage_val +=
                            target->CalculateSpellDamage(target, spellInfo, 0) *
                            10;
                }

                // Tactical Mastery - talent
                PlayerTalentMap const& tp_list =
                    target->ToPlayer()->GetTalentMap();
                for (PlayerTalentMap::const_iterator itr = tp_list.begin();
                     itr != tp_list.end();
                     ++itr) {
                    if (itr->second->State == PLAYERSPELL_REMOVED ||
                        !itr->second->IsInSpec(
    ...
    if (target->IsClass(CLASS_DRUID, CLASS_CONTEXT_ABILITY)) {
        // Dash
        if (AuraEffect* aurEff = target->GetAuraEffect(
                SPELL_AURA_MOD_INCREASE_SPEED, SPELLFAMILY_DRUID, 0, 0, 0x8))
            aurEff->RecalculateAmount();

        // Disarm handling
        // If druid shifts while being disarmed we need to deal with that since
        // forms aren't affected by disarm and also HandleAuraModDisarm is not
        // triggered
        if (!target->CanUseAttackType(BASE_ATTACK)) {
            if (Item* pItem = target->ToPlayer()->GetItemByPos(
    ...
    if (target->GetTypeId() == TYPEID_PLAYER) {
        SpellShapeshiftEntry const* shapeInfo =
            sSpellShapeshiftStore.LookupEntry(form);
        // Learn spells for shapeshift form - no need to send action bars or add
        // spells to spellbook
        for (uint8 i = 0; i < MAX_SHAPESHIFT_SPELLS; ++i) {
            if (!shapeInfo->stanceSpell[i])
                continue;
            if (apply)
                target->ToPlayer()->_addSpell(
                    shapeInfo->stanceSpell[i], SPEC_MASK_ALL, true);
            else
                target->ToPlayer()->removeSpell(
                    shapeInfo->stanceSpell[i], SPEC_MASK_ALL, true);
        }
    }
}
                                     ...
                                     bool                   apply) const
{
    ...
    if (apply) {
        // update active transform spell only when transform or shapeshift not
        // set or not overwriting negative by positive case
        if (GetSpellInfo()->HasAttribute(SPELL_ATTR0_NO_IMMUNITIES) ||
            !target->GetModelForForm(target->GetShapeshiftForm(), GetId()) ||
            ...
            if (GetMiscValue() == 0) {
                ...
                case 16739: {
                    ...
                    case RACE_BLOODELF:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 17829 : 17830);
                        break;
                    // Orc
                    case RACE_ORC:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10139 : 10140);
                        break;
                    // Troll
                    case RACE_TROLL:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10135 : 10134);
                        break;
                    // Tauren
                    case RACE_TAUREN:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10136 : 10147);
                        break;
                    // Undead
                    case RACE_UNDEAD_PLAYER:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10146 : 10145);
                        break;
                    // Draenei
                    case RACE_DRAENEI:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 17827 : 17828);
                        break;
                    // Dwarf
                    case RACE_DWARF:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10141 : 10142);
                        break;
                    // Gnome
                    case RACE_GNOME:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10148 : 10149);
                        break;
                    // Human
                    case RACE_HUMAN:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10137 : 10138);
                        break;
                    // Night Elf
                    case RACE_NIGHTELF:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 10143 : 10144);
                        break;
                    default:
                        break;
                    }
                ...
                case 65495:
                    target->SetDisplayId(
                        target->getGender() == GENDER_MALE ? 29203 : 29204);
                    break;
                ...
                case 65511: {
                    ...
                    case DisplayRace::BloodElf:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21839
                                                                   : 21838);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21841
                                                                   : 21840);
                        break;
                    case DisplayRace::Orc:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21867
                                                                   : 21866);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21869
                                                                   : 21868);
                        break;
                    case DisplayRace::Troll:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21875
                                                                   : 21874);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21877
                                                                   : 21876);
                        break;
                    case DisplayRace::Tauren:
                        if (urand(0, 1))
                            ...
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21872
                                                                   : 21873);
                        break;
                    case DisplayRace::Undead:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21879
                                                                   : 21878);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21881
                                                                   : 21880);
                        break;
                    case DisplayRace::Draenei:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21844
                                                                   : 21842);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21845
                                                                   : 21843);
                        break;
                    case DisplayRace::Dwarf:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21846
                                                                   : 21848);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21847
                                                                   : 21849);
                        break;
                    case DisplayRace::Gnome:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21851
                                                                   : 21850);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21853
                                                                   : 21852);
                        break;
                    case DisplayRace::Human:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21859
                                                                   : 21858);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21861
                                                                   : 21860);
                        break;
                    case DisplayRace::NightElf:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21863
                                                                   : 21862);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21865
                                                                   : 21864);
                        break;
                    case DisplayRace::Goblin:
                        if (urand(0, 1))
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21854
                                                                   : 21856);
                        else
                            target->SetDisplayId(
                                target->getGender() == GENDER_MALE ? 21855
                                                                   : 21857);
                        break;
                    default:
                        break;
                ...
                case 65522: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18793 : 18785);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18805 : 18804);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18809 : 18808);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18807 : 18806);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18811 : 18810);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18795 : 18794);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18797 : 18796);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18799 : 18798);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18801 : 18800);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18803 : 18802);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19342 : 19339);
                    default:
                        break;
                    }
                    break;
                ...
                case 65523: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19170 : 19169);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19182 : 19181);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19186 : 19185);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19184 : 19183);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19188 : 19187);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19172 : 19171);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19174 : 19173);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19176 : 19175);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19178 : 19177);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19180 : 19179);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 19343 : 19340);
                    default:
                        break;
                    }
                    break;
                ...
                case 65524: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18841 : 18840);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18870 : 18869);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18874 : 18873);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18872 : 18871);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18876 : 18875);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18843 : 18842);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18845 : 18844);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18847 : 18846);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18860 : 18858);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 18868 : 18867);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 21067 : 19341);
                    default:
                        break;
                    }
                    break;
                ...
                case 65525: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22361 : 22360);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22375 : 22374);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22379 : 22378);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22377 : 22376);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22381 : 22380);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22363 : 22362);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22365 : 22364);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22367 : 22366);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22371 : 22370);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22373 : 22372);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 22369 : 22368);
                    default:
                        break;
                    }
                    break;
                ...
                case 65526: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 21086 : 21085);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16438 : 16436);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16446 : 16445);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16432 : 16442);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16444 : 16443);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 21083 : 21084);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16413 : 16434);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16448 : 16447);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16433 : 16412);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 16435 : 16414);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 29243 : 16431);
                    default:
                        break;
                    }
                    break;
                ...
                case 65527: {
                    ...
                    case DisplayRace::BloodElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24508 : 24519);
                        break;
                    case DisplayRace::Orc:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24515 : 24526);
                        break;
                    case DisplayRace::Troll:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24517 : 24528);
                        break;
                    case DisplayRace::Tauren:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24516 : 24527);
                        break;
                    case DisplayRace::Undead:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24518 : 24529);
                        break;
                    case DisplayRace::Draenei:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24509 : 24520);
                        break;
                    case DisplayRace::Dwarf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24510 : 24521);
                        break;
                    case DisplayRace::Gnome:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24511 : 24522);
                        break;
                    case DisplayRace::Human:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24513 : 24524);
                        break;
                    case DisplayRace::NightElf:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24514 : 24525);
                        break;
                    case DisplayRace::Goblin:
                        target->SetDisplayId(
                            target->getGender() == GENDER_MALE ? 24512 : 24523);
                    default:
                        break;
                    }
                    break;
                ...
                case 75532:
                    target->SetDisplayId(
                        target->getGender() == GENDER_MALE ? 31737 : 31738);
                    break;
                // Gnomeregan Pride
                case 75531:
                    target->SetDisplayId(
                        target->getGender() == GENDER_MALE ? 31654 : 31655);
                    break;
                default:
                    break;
                }
                ...
                CreatureTemplate const* ci =
                    sObjectMgr->GetCreatureTemplate(GetMiscValue());
                if (!ci) {
                    target->SetDisplayId(16358); // pig pink ^_^
                    LOG_ERROR(
                        "spells.aura.effect",
                        "Auras: unknown creature id = {} (only need its "
                        "modelid) From Spell Aura Transform in Spell ID = {}",
                        GetMiscValue(),
                        GetId());
                }
                else {
                    ...
                    if (GetSpellInfo()->SpellFamilyName == SPELLFAMILY_MAGE &&
                        GetSpellInfo()->SpellIconID == 82 &&
                        GetSpellInfo()->SpellVisual[0] == 12978)
        ...
        // update active transform spell only when transform or shapeshift not
        // set or not overwriting negative by positive case
        SpellInfo const* transformSpellInfo =
            sSpellMgr->GetSpellInfo(target->getTransForm());
        if (!transformSpellInfo ||
            GetSpellInfo()->HasAttribute(SPELL_ATTR0_NO_IMMUNITIES) ||
            !GetSpellInfo()->IsPositive() || transformSpellInfo->IsPositive())
            target->setTransForm(GetId());

        // polymorph case
        if ((mode & AURA_EFFECT_HANDLE_REAL) &&
            target->GetTypeId() == TYPEID_PLAYER && target->IsPolymorphed()) {
            // for players, start regeneration after 1s (in polymorph fast
            // regeneration case) only if caster is Player (after patch 2.4.2)
        ...
        // HandleEffect(this, AURA_EFFECT_HANDLE_SEND_FOR_CLIENT, true) will
        // reapply it if need
        ...
        if (GetId() == 42016 && target->GetMountID() == 16314) {
            if (!target->GetAuraEffectsByType(SPELL_AURA_MOUNTED).empty()) {
                uint32 cr_id = target->GetAuraEffectsByType(SPELL_AURA_MOUNTED)
                                   .front()
                                   ->GetMiscValue();
                if (CreatureTemplate const* ci =
                        sObjectMgr->GetCreatureTemplate(cr_id)) {
                                  ...
                                  bool                   apply) const
{
    ...
    if (apply) {
        ...
        */
        ...
        UnitList                                   targets;
        Acore::AnyUnfriendlyUnitInObjectRangeCheck u_check(
            target,
            target,
            target->GetVisibilityRange()); // no VISIBILITY_COMPENSATION,
                                           // distance is enough
        Acore::UnitListSearcher<Acore::AnyUnfriendlyUnitInObjectRangeCheck>
            searcher(target, targets, u_check);
        Cell::VisitAllObjects(
            target, searcher, target->GetMap()->GetVisibilityRange());
        for (UnitList::iterator iter = targets.begin(); iter != targets.end();
            ...
            for (uint32 i = CURRENT_FIRST_NON_MELEE_SPELL;
                ...
                if ((*iter)->GetCurrentSpell(i) &&
                    (*iter)->GetCurrentSpell(i)
                            ->m_targets.GetUnitTargetGUID() ==
                        target->GetGUID()) {
                    SpellInfo const* si =
                        (*iter)->GetCurrentSpell(i)->GetSpellInfo();
                    if (si->HasAttribute(SPELL_ATTR6_IGNORE_PHASE_SHIFT) &&
                        (*iter)->GetTypeId() == TYPEID_UNIT) {
                        Creature* c = (*iter)->ToCreature();
                        if ((!c->IsPet() && c->GetCreatureTemplate()->rank ==
                                                CREATURE_ELITE_WORLDBOSS) ||
                            c->isWorldBoss() || c->IsDungeonBoss())
                            continue;
                    }
                    bool interrupt =
                        false; // pussywizard: skip spells that don't target
                               // units, but casted on unit (eg.
                               // TARGET_DEST_TARGET_ENEMY)
                    for (uint8 j = 0; j < MAX_SPELL_EFFECTS; ++j)
                        if (si->Effects[j].Effect &&
                            (si->Effects[j].GetUsedTargetObjectType() ==
                                 TARGET_OBJECT_TYPE_UNIT ||
                             si->Effects[j].GetUsedTargetObjectType() ==
                                 TARGET_OBJECT_TYPE_UNIT_AND_DEST)) {
                            // at least one effect truly targets an unit,
                            // interrupt the spell
                            interrupt = true;
                            break;
                        }
                                       ...
                                       bool                   apply) const
{
    ...
    // do not remove unit flag if there are more than this auraEffect of that
    // kind on unit on unit
    ...
    // unit
    if (apply && (mode & AURA_EFFECT_HANDLE_REAL)) {
        // xinef: this aura should not stop combat (movie with sindragosa proves
        // that)
        // target->CombatStop();
        target->RemoveAurasWithInterruptFlags(
            AURA_INTERRUPT_FLAG_IMMUNE_OR_LOST_SELECTION);
                                     ...
                                     bool                   apply) const
{
    ...
    if ((apply) ? target->GetAuraEffectsByType(type).size() > 1
    ...
    // if disarm aura is to be removed, remove the flag first to reapply
    // damage/aura mods
    if (!apply)
    ...
    if (target->GetTypeId() == TYPEID_PLAYER &&
        (!target->IsInFeralForm() ||
         target->GetShapeshiftForm() == FORM_GHOSTWOLF)) {
        if (Item* pItem =
                target->ToPlayer()->GetItemByPos(INVENTORY_SLOT_BAG_0, slot)) {
            uint8 attacktype = Player::GetAttackBySlot(slot);

            if (attacktype < MAX_ATTACK) {
                target->ToPlayer()->_ApplyWeaponDamage(
                    slot, pItem->GetTemplate(), nullptr, !apply);
                target->ToPlayer()->_ApplyWeaponDependentAuraMods(
                    pItem, WeaponAttackType(attacktype), !apply);
            }
        }
    }

    // if disarm effects should be applied, wait to set flag until damage mods
    // are unapplied
    if (apply)
                                      ...
                                      bool                   apply) const
{
    ...
    if (apply) {
        ...
        // call functions which may have additional effects after chainging
        // state of unit Stop cast only spells vs PreventionType ==
        ...
        // do not remove unit flag if there are more than this auraEffect of
        // that kind on unit on unit
                                     ...
                                     bool                   apply) const
{
    ...
    if (apply) {
        ...
        // target->AttackStop(); // pussywizard: why having this flag prevents
        // from being in combat? it should just prevent melee attack
    }
    else {
        // do not remove unit flag if there are more than this auraEffect of
        // that kind on unit on unit
                                          ...
                                          bool                   apply) const
{
    ...
    if (apply)
        target->SetFlag(PLAYER_TRACK_CREATURES,
                        uint32(1) << (GetMiscValue() - 1));
    else
        target->RemoveFlag(PLAYER_TRACK_CREATURES,
                           uint32(1) << (GetMiscValue() - 1));
}
                                          ...
                                          bool                   apply) const
{
    ...
    if (apply)
        target->SetFlag(PLAYER_TRACK_RESOURCES,
                        uint32(1) << (GetMiscValue() - 1));
    else
        target->RemoveFlag(PLAYER_TRACK_RESOURCES,
                           uint32(1) << (GetMiscValue() - 1));
}
                                          ...
                                          bool                   apply) const
{
    ...
    target->ApplyModFlag(
        PLAYER_FIELD_BYTES, PLAYER_FIELD_BYTE_TRACK_STEALTHED, apply);
}
                                       ...
                                       bool                   apply) const
{
    ...
    if (apply)
        target->SetByteFlag(UNIT_FIELD_BYTES_1,
...
{
    if (!(mode &
          (AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK | AURA_EFFECT_HANDLE_SKILL)))
        return;
    Unit* target = aurApp->GetTarget();
    ...
    target->ToPlayer()->ModifySkillBonus(prot,
                                         ((apply) ? points : -points),
                                         GetAuraType() ==
                                   ...
                                   bool                   apply) const
{
    ...
    if (apply) {
        ...
        if (!GetBase()->HasEffectType(
                SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED) &&
            target->HasAura(FRESH_BREWFEST_HOPS)) {
        ...
        if (CreatureTemplate const* creatureInfo =
            ...
            {
                displayId = GetMiscValueB() == 2 && creatureInfo->Modelid2 > 0
                                ? creatureInfo->Modelid2
                                : creatureInfo->Modelid1;
            }
        ...
        target->Dismount();
        // some mounts like Headless Horseman's Mount or broom stick are skill
        // based spell
        //  need to remove ALL arura related to mounts, this will stop client
        //  crash with broom stick and never endless flying after using Headless
        //  Horseman's Mount
        if (mode & AURA_EFFECT_HANDLE_REAL)
            target->RemoveAurasByType(SPELL_AURA_MOUNTED);
    }
                                       ...
                                       bool                   apply) const
{
    ...
    if (!apply) {
        ...
        // that kind on unit on unit
        if (target->HasAuraType(GetAuraType()) ||
            target->HasAuraType(SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED))
            return;
    }
                                       ...
                                       bool                   apply) const
{
    ...
    if (!apply && target->GetTypeId() == TYPEID_PLAYER)
        target->ToPlayer()->SetFallInformation(GameTime::GetGameTime().count(),
                                               target->GetPositionZ());
}
                                ...
                                bool                   apply) const
{
    ...
    if (apply)
        ...
        // When taunt aura fades out, mob will switch to previous target if
        // current has less than 1.1 * secondthreat
                                      ...
                                      bool                   apply) const
{
    ...
    Unit* target = aurApp->GetTarget();
    // Since patch 3.0.2 this mechanic no longer affects fear effects. It will
    // ONLY prevent humanoids from fleeing due to low health.
    if (target->GetTypeId() == TYPEID_PLAYER || !apply ||
        target->HasAuraType(SPELL_AURA_MOD_FEAR))
        return;
    /// @todo: find a way to cancel fleeing for assistance.
    /// Currently this will only stop creatures fleeing due to low health that
    /// could not find nearby allies to flee towards.
                                     ...
                                     bool                   apply) const
{
    ...
    if (apply) {
        ...
        // Must clear current motion or pet leashes back to owner after a few
        // yards
        ...
        if (!pet->IsWithinDistInMap(caster,
            ...
            // Follow owner only if not fighting or owner didn't click "stay" at
            // new location This may be confusing because pet bar shows "stay"
            // when under the spell but it retains
            //  the "follow" flag. Player MUST click "stay" while under the
            //  spell.
            if (!pet->GetVictim() &&
                !pet->GetCharmInfo()->HasCommandState(COMMAND_STAY)) {
                pet->GetMotionMaster()->MoveFollow(
                    caster, PET_FOLLOW_DIST, pet->GetFollowAngle());
            }
        }
    }
}
                                          ...
                                          bool                   apply) const
{
    ...
    if (apply) {
        // Currently spells that have base points  0 and DieSides 0 = "0/0"
        // exception are pushed to -1, however the idea of 0/0 is to ingore flag
        // VEHICLE_SEAT_FLAG_CAN_ENTER_OR_EXIT and -1 checks for it, so this
        // break such spells or most of them. Current formula about m_amount:
        // effect base points + dieside - 1 TO DO: Reasearch more about 0/0 and
        // fix it.
        ...
        caster->_ExitVehicle();
        // some SPELL_AURA_CONTROL_VEHICLE auras have a dummy effect on the
        // player - remove them
                                                  ...
                                                  bool apply) const
{
    ...
    if (GetAuraType() == SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED) {
        ...
        // that kind on unit on unit
        if (mode & AURA_EFFECT_HANDLE_SEND_FOR_CLIENT_MASK &&
            (apply || (!target->HasAuraType(
                           SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED) &&
                       !target->HasAuraType(SPELL_AURA_FLY)))) {
            target->SetCanFly(apply);

            if (!apply && target->GetTypeId() == TYPEID_UNIT &&
                !target->IsLevitating())
                target->GetMotionMaster()->MoveFall();
        }

        //! Someone should clean up these hacks and remove it from this
        //! function. It doesn't even belong here.
        if (mode & AURA_EFFECT_HANDLE_REAL) {
            // Players on flying mounts must be immune to polymorph
            if (target->GetTypeId() == TYPEID_PLAYER)
                target->ApplySpellImmune(
                    GetId(), IMMUNITY_MECHANIC, MECHANIC_POLYMORPH, apply);
                                            ...
                                            bool                   apply) const
{
    ...
    case 1615: {
        if (!GetAmount()) {
            mechanic_immunity_list =
                (1 << MECHANIC_SNARE) | (1 << MECHANIC_ROOT) |
            ...
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_CHARM, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_SNARE, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_ROOT, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_FEAR, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_STUN, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_SLEEP, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_SAPPED, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_HORROR, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_POLYMORPH, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_DISORIENTED, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_FREEZE, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_TURN, apply);
    ...
    case 1694: {
        target->ApplySpellImmune(
            GetId(), IMMUNITY_EFFECT, SPELL_EFFECT_ATTACK_ME, apply);
    ...
    case 1632: {
        if (!GetAmount()) {
            ...
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_TURN, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_BANISH, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, apply);
            target->ApplySpellImmune(
                GetId(), IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK_DEST, apply);
            aura_immunity_list.push_back(SPELL_AURA_MOD_STUN);
    ...
    case 878: {
        if (GetAmount() == 1) {
            mechanic_immunity_list =
                (1 << MECHANIC_SNARE) | (1 << MECHANIC_STUN) |
    ...
    if (aura_immunity_list.empty()) {
        ...
        if (GetMiscValue() & (1 << 3)) {
            ...
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_INTERRUPT, apply);
        }
        // Transform?
        if (GetMiscValue() & (1 << 4)) {
        ...
        if (GetMiscValue() & (1 << 5)) {
            ...
            target->ApplySpellImmune(
                GetId(), IMMUNITY_MECHANIC, MECHANIC_KNOCKOUT, apply);
        }
        // // Slowing effects
        if (GetMiscValue() & (1 << 6)) {
            mechanic_immunity_list = (1 << MECHANIC_SNARE);
    ...
    // apply immunities
    for (std::list<AuraType>::iterator iter = aura_immunity_list.begin();
         iter != aura_immunity_list.end();
         ++iter)
        target->ApplySpellImmune(GetId(), IMMUNITY_STATE, *iter, apply);

    // Patch 3.0.3 Bladestorm now breaks all snares and roots on the warrior
    // when activated.
    if (GetId() == 46924) {
        if (apply) {
    ...
    if (apply &&
        ...
        target->RemoveAurasWithMechanic(
            mechanic_immunity_list, AURA_REMOVE_BY_DEFAULT, GetId());
        for (std::list<AuraType>::iterator iter = aura_immunity_list.begin();
             iter != aura_immunity_list.end();
             ++iter)
                                           ...
                                           bool                   apply) const
{
    ...
    case 38484: // Bestial Wrath
        ...
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_BANISH, apply);
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_SHACKLE, apply);
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_TURN, apply);
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_HORROR, apply);
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_DAZE, apply);
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, MECHANIC_SAPPED, apply);
        break;
    ...
    case 46227: // Medalion of Immunity
        mechanic = IMMUNE_TO_MOVEMENT_IMPAIRMENT_AND_LOSS_CONTROL_MASK;
        target->RemoveAurasByType(
            SPELL_AURA_PREVENTS_FLEEING); // xinef: Patch 2.3.0 PvP Trinkets:
                                          // Insignia of the Alliance, Insignia
                                          // of the Horde, Medallion of the
                                          // Alliance, and Medallion of the
                                          // Horde now clear the debuff from
                                          // Judgement of Justice.
        // Actually we should apply immunities here, too, but the aura has only
        // 100 ms duration, so there is practically no point
        break;
    ...
    default:
        ...
        target->ApplySpellImmune(
            GetId(), IMMUNITY_MECHANIC, GetMiscValue(), apply);
        break;
    }
    ...
    if (apply &&
        ...
        if (mechanic == (1 << MECHANIC_SNARE))
            ...
            target->RemoveAurasWithMechanic(
                mechanic, AURA_REMOVE_BY_DEFAULT, GetId());
    }
}
                                             ...
                                             bool                   apply) const
{
    ...
    Player* player = target->ToPlayer();
    if (!apply && player &&
        (GetSpellInfo()->AuraInterruptFlags &
         AURA_INTERRUPT_FLAG_IMMUNE_OR_LOST_SELECTION)) {
                                            ...
                                            bool                   apply) const
{
    ...
    if (apply &&
        GetSpellInfo()->HasAttribute(SPELL_ATTR1_IMMUNITY_PURGES_EFFECT))
        target->RemoveAurasByType(
            AuraType(GetMiscValue()), ObjectGuid::Empty, GetBase());
}
                                             ...
                                             bool                   apply) const
{
    ...
    /// @todo: optimalize this cycle - use RemoveAurasWithInterruptFlags call or
    /// something else
    if ((apply) &&
        GetSpellInfo()->HasAttribute(SPELL_ATTR1_IMMUNITY_PURGES_EFFECT) &&
                                             ...
                                             bool                   apply) const
{
    ...
    target->ApplySpellDispelImmunity(
        m_spellInfo, DispelType(GetMiscValue()), (apply));
}
        ...
        if (GetMiscValue() & int32(1 << x)) {
            ...
            if (amount < GetAmount()) {
                ...
                target->HandleStatModifier(
                    UnitMods(UNIT_MOD_RESISTANCE_START + x),
                    BASE_VALUE,
                    value,
                    apply);
                if (target->GetTypeId() == TYPEID_PLAYER)
                    target->ApplyResistanceBuffModsMod(
                        SpellSchools(x), aurApp->IsPositive(), value, apply);
            }
        }
    }
}
    ...
    for (int8 i = SPELL_SCHOOL_NORMAL; i < MAX_SPELL_SCHOOL; i++) {
        if (GetMiscValue() & int32(1 << i)) {
            target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i),
                                       ...
                                       apply);
            if (target->GetTypeId() == TYPEID_PLAYER || target->IsPet()) {
                target->ApplyResistanceBuffModsPercentMod(
                    SpellSchools(i), true, (float)GetAmount(), apply);
                target->ApplyResistanceBuffModsPercentMod(
                    SpellSchools(i), false, (float)GetAmount(), apply);
            }
        }
    }
}
                                           ...
                                           bool                   apply) const
{
    ...
    // and Unit::CalcArmorReducedDamage

    // show armor penetration
    if (target->GetTypeId() == TYPEID_PLAYER &&
        (GetMiscValue() & SPELL_SCHOOL_MASK_NORMAL))
        target->ApplyModInt32Value(
            PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE, GetAmount(), apply);

    // show as spell penetration only full spell penetration bonuses (all
    // resistances except armor and holy
    if (target->GetTypeId() == TYPEID_PLAYER &&
        (GetMiscValue() & SPELL_SCHOOL_MASK_SPELL) == SPELL_SCHOOL_MASK_SPELL)
        target->ApplyModInt32Value(
            PLAYER_FIELD_MOD_TARGET_RESISTANCE, GetAmount(), apply);
}
                                   ...
                                   bool                   apply) const
{
    ...
    if (GetMiscValue() < -2 || GetMiscValue() > 4) {
        LOG_ERROR("spells.aura.effect",
                  "WARNING: Spell {} effect {} has an unsupported misc value "
                                           ...
                                           bool                   apply) const
{
    ...
    if (GetId() == 67480) // xinef: hack fix for blessing of sanctuary stats
                          // stack with blessing of kings...
    {
        ...
        for (int32 i = STAT_STRENGTH; i < MAX_STATS; i++) {
            if (i == STAT_STRENGTH || i == STAT_STAMINA) {
                ...
                target->HandleStatModifier(
                    UnitMods(UNIT_MOD_STAT_START + i), TOTAL_PCT, value, apply);
    ...
    // spells with SPELL_ATTR0_UNK4 0x00000010 flag)
    if (GetMiscValue() == STAT_STAMINA &&
        m_spellInfo->HasAttribute(SPELL_ATTR0_IS_ABILITY))
        target->SetHealth(
            std::max<uint32>(uint32(healthPct * target->GetMaxHealth() * 0.01f),
                             (alive ? 1 : 0)));
}
    ...
    AuraApplication const* aurApp, uint8 mode, bool /*apply*/) const
{
    ...
    if (GetMiscValue() != SPELL_SCHOOL_MASK_NORMAL) {
        ...
        // UpdateResistence at intellect update and include in UpdateResistence
        // same code as in UpdateArmor for aura mod apply.
        LOG_ERROR("spells.aura.effect",
                  "Aura SPELL_AURA_MOD_RESISTANCE_OF_STAT_PERCENT(182) does "
                  "not work for non-armor type resistances!");
        return;
    }
                                     ...
                                     bool /*apply*/) const
{
    ...
    // other powers are not immediate effects - implemented in
    // Player::Regenerate, Creature::Regenerate
}
                                             ...
                                             bool                   apply) const
{
    ...
    if (apply) {
        target->HandleStatModifier(
            UNIT_MOD_HEALTH, TOTAL_VALUE, float(GetAmount()), apply);
                                                ...
                                                bool apply) const
{
    ...
    if (oldhealth > 0) {
        uint32 newhealth = uint32(
            std::ceil((double)target->GetMaxHealth() * healthPercentage));
        if (newhealth == 0)
            newhealth = 1;
                                             ...
                                             bool                   apply) const
{
    ...
    UnitMods unitMod =
        UnitMods(static_cast<uint16>(UNIT_MOD_POWER_START) + PowerType);
    ...
    AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_HEALTH, TOTAL_PCT, float(GetAmount()), apply);

    // Xinef: pct was rounded down and could "kill" creature by setting its
    // health to 0 making npc zombie
    if (target->IsAlive())
    ...
    AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_HEALTH, BASE_PCT, float(GetAmount()), apply);
}
                                                ...
                                                bool apply) const
{
    ...
    for (int i = 0; i < MAX_ATTACK; ++i)
        if (Item* pItem = target->ToPlayer()->GetWeaponForAttack(
                WeaponAttackType(i), true))
            target->ToPlayer()->_ApplyWeaponDependentAuraCritMod(
                pItem, WeaponAttackType(i), this, apply);

    // mods must be applied base at equipped weapon class and subclass
    // comparison with spell->EquippedItemClass and  EquippedItemSubClassMask
    // and EquippedItemInventoryTypeMask GetMiscValue() comparison with item
    // generated damage types

    if (GetSpellInfo()->EquippedItemClass == -1) {
        target->ToPlayer()->HandleBaseModValue(
            CRIT_PERCENTAGE, FLAT_MOD, float(GetAmount()), apply);
        target->ToPlayer()->HandleBaseModValue(
            OFFHAND_CRIT_PERCENTAGE, FLAT_MOD, float(GetAmount()), apply);
        target->ToPlayer()->HandleBaseModValue(
            RANGED_CRIT_PERCENTAGE, FLAT_MOD, float(GetAmount()), apply);
    }
    else {
                                 ...
                                 bool                   apply) const
{
    ...
    for (uint32 rating = 0; rating < MAX_COMBAT_RATING; ++rating)
        if (GetMiscValue() & (1 << rating))
            target->ToPlayer()->ApplyRatingMod(
                CombatRating(rating), GetAmount(), apply);
}
                                          ...
                                          bool                   apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_ATTACK_POWER, TOTAL_VALUE, float(GetAmount()), apply);
}
                                                ...
                                                bool apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_ATTACK_POWER_RANGED, TOTAL_VALUE, float(GetAmount()), apply);
}
                                                 ...
                                                 bool apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_ATTACK_POWER, TOTAL_PCT, float(GetAmount()), apply);
}
    ...
    AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    target->HandleStatModifier(
        UNIT_MOD_ATTACK_POWER_RANGED, TOTAL_PCT, float(GetAmount()), apply);
}
                                     ...
                                     bool                   apply) const
{
    ...
    if (target->GetTypeId() == TYPEID_PLAYER) {
        for (int i = 0; i < MAX_ATTACK; ++i)
            if (Item* pItem = target->ToPlayer()->GetWeaponForAttack(
                    WeaponAttackType(i), true))
                target->ToPlayer()->_ApplyWeaponDependentAuraDamageMod(
                    pItem, WeaponAttackType(i), this, apply);
    }
    ...
    // wands 127 - full bitmask any damages
    //
    // mods must be applied base at equipped weapon class and subclass
    // comparison with spell->EquippedItemClass and  EquippedItemSubClassMask
    // and EquippedItemInventoryTypeMask GetMiscValue() comparison with item
    ...
    if ((GetMiscValue() & SPELL_SCHOOL_MASK_NORMAL) != 0 &&
        sScriptMgr->CanModAuraEffectDamageDone(
            this, target, aurApp, mode, apply)) {
        // apply generic physical damage bonuses including wand case
        if (GetSpellInfo()->EquippedItemClass == -1 ||
            target->GetTypeId() != TYPEID_PLAYER) {
            target->HandleStatModifier(UNIT_MOD_DAMAGE_MAINHAND,
                                       TOTAL_VALUE,
                                       float(GetAmount()),
                                       apply);
            target->HandleStatModifier(UNIT_MOD_DAMAGE_OFFHAND,
                                       TOTAL_VALUE,
                                       float(GetAmount()),
                                       apply);
            target->HandleStatModifier(
                UNIT_MOD_DAMAGE_RANGED, TOTAL_VALUE, float(GetAmount()), apply);

            if (target->GetTypeId() == TYPEID_PLAYER) {
                if (GetAmount() > 0)
                    target->ApplyModInt32Value(
                        PLAYER_FIELD_MOD_DAMAGE_DONE_POS, GetAmount(), apply);
                else
                    target->ApplyModInt32Value(
                        PLAYER_FIELD_MOD_DAMAGE_DONE_NEG, GetAmount(), apply);
            }
        }
        else {
            // done in Player::_ApplyWeaponDependentAuraMods
    ...
    if (GetSpellInfo()->EquippedItemClass != -1 ||
        GetSpellInfo()->EquippedItemInventoryTypeMask != 0) {
        ...
        if (GetAmount() > 0) {
            for (uint32 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; i++) {
                if ((GetMiscValue() & (1 << i)) != 0)
                    target->ApplyModInt32Value(
                        PLAYER_FIELD_MOD_DAMAGE_DONE_POS + i,
                        GetAmount(),
                        apply);
            }
        }
            ...
            for (uint32 i = SPELL_SCHOOL_HOLY; i < MAX_SPELL_SCHOOL; i++) {
                if ((GetMiscValue() & (1 << i)) != 0)
                    target->ApplyModInt32Value(
                        PLAYER_FIELD_MOD_DAMAGE_DONE_NEG + i,
                        GetAmount(),
                        apply);
            }
        }
                                            ...
                                            bool                   apply) const
{
    ...
    if (!sScriptMgr->CanModAuraEffectModDamagePercentDone(
            this, target, aurApp, mode, apply))
        return;

    if (target->GetTypeId() == TYPEID_PLAYER) {
        for (int i = 0; i < MAX_ATTACK; ++i)
            if (Item* item = target->ToPlayer()->GetWeaponForAttack(
                    WeaponAttackType(i), false))
                target->ToPlayer()->_ApplyWeaponDependentAuraDamageMod(
                    item, WeaponAttackType(i), this, apply);
    }

    if ((GetMiscValue() & SPELL_SCHOOL_MASK_NORMAL) &&
        (GetSpellInfo()->EquippedItemClass == -1 ||
         target->GetTypeId() != TYPEID_PLAYER)) {
        target->HandleStatModifier(
            UNIT_MOD_DAMAGE_MAINHAND, TOTAL_PCT, float(GetAmount()), apply);
        target->HandleStatModifier(
            UNIT_MOD_DAMAGE_OFFHAND, TOTAL_PCT, float(GetAmount()), apply);
        target->HandleStatModifier(
            UNIT_MOD_DAMAGE_RANGED, TOTAL_PCT, float(GetAmount()), apply);

        if (target->GetTypeId() == TYPEID_PLAYER)
            target->ToPlayer()->ApplyPercentModFloatValue(
                PLAYER_FIELD_MOD_DAMAGE_DONE_PCT, float(GetAmount()), apply);
    }
    else {
        // done in Player::_ApplyWeaponDependentAuraMods for
        // SPELL_SCHOOL_MASK_NORMAL && EquippedItemClass != -1 and also for wand
        // case
    }
}
                                        ...
                                        bool                   apply) const
{
    ...
    if (target->GetTypeId() == TYPEID_PLAYER)
        target->ToPlayer()->HandleBaseModValue(
            SHIELD_BLOCK_VALUE, modType, float(GetAmount()), apply);
}
                                    ...
                                    bool                   apply) const
{
    ...
    for (int i = 0; i < MAX_SPELL_SCHOOL; ++i)
        if (GetMiscValue() & (1 << i))
            target->ApplyModInt32Value(
                UNIT_FIELD_POWER_COST_MODIFIER + i, GetAmount(), apply);
}
                                        ...
                                        bool /*apply*/) const
{
    ...
    flag96                      mask;
    Unit::AuraEffectList const& noReagent =
        target->GetAuraEffectsByType(SPELL_AURA_NO_REAGENT_USE);
...
{
    if (!(mode &
          (AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK | AURA_EFFECT_HANDLE_REAPPLY)))
        return;
    ...
    if (mode & AURA_EFFECT_HANDLE_REAL) {
        ...
        if (PetAura const* petSpell =
                sSpellMgr->GetPetAura(GetId(), m_effIndex)) {
            if (apply)
    ...
    if (mode & (AURA_EFFECT_HANDLE_REAL | AURA_EFFECT_HANDLE_REAPPLY)) {
        ...
        if (apply) {
            ...
            case 34026: // kill command
            {
                ...
                // set 3 stacks and 3 charges (to make all auras not disappear
                // at once)
                ...
                if (owner_aura) {
                    ...
                    owner_aura->SetStackAmount(
                        owner_aura->GetSpellInfo()->StackAmount);
                    if (pet_aura) {
                        pet_aura->SetCharges(0);
                        pet_aura->SetStackAmount(
                            owner_aura->GetSpellInfo()->StackAmount);
                    }
                }
                break;
            ...
            case 71563: {
                if (Aura* newAura = target->AddAura(71564, target))
                    newAura->SetStackAmount(
                        newAura->GetSpellInfo()->StackAmount);
                return;
            }
            }
        }
        // AT REMOVE
            ...
            if ((GetSpellInfo()->IsQuestTame()) && caster &&
                caster->IsAlive() && target->IsAlive() &&
                aurApp->GetRemoveMode() != AURA_REMOVE_BY_CANCEL) {
            ...
            case SPELLFAMILY_GENERIC:
                ...
                case 2584: // Waiting to Resurrect
                    // Waiting to resurrect spell cancel, we must remove player
                    // from resurrect queue
                    if (target->GetTypeId() == TYPEID_PLAYER) {
                        if (Battleground* bg =
                                target->ToPlayer()->GetBattleground())
                            bg->RemovePlayerFromResurrectQueue(
                                target->ToPlayer());
                        if (Battlefield* bf =
                                sBattlefieldMgr->GetBattlefieldToZoneId(
                                    target->GetZoneId()))
                            bf->RemovePlayerFromResurrectQueue(
                                target->GetGUID());
                    }
                    break;
                case 43681: // Inactive
                {
                    if (target->GetTypeId() != TYPEID_PLAYER ||
                        aurApp->GetRemoveMode() != AURA_REMOVE_BY_EXPIRE)
                        return;
                ...
                case 60244: // Blood Parrot Despawn Aura
                    target->CastSpell(
                        (Unit*)nullptr, GetAmount(), true, nullptr, this);
                    break;
                ...
                case 52921: {
                    ...
                    Acore::PlayerSearcher<Acore::AnyPlayerInObjectRangeCheck>
                        searcher(target, player, checker);
                ...
                {
                    if (target->isDead() && GetBase() &&
                        target->GetTypeId() == TYPEID_UNIT &&
                        target->GetEntry() == 24601) {
        ...
        case 62061: // Festive Holiday Mount
            if (target->HasAuraType(SPELL_AURA_MOUNTED)) {
                ...
                if (apply) {
                    ...
                    creatureEntry =
                        target->GetAuraEffectsByType(SPELL_AURA_MOUNTED)
                            .front()
                            ->GetMiscValue();
                                        ...
                                        bool                   apply) const
{
    ...
    InventoryResult msg =
        plCaster->CanStoreNewItem(NULL_BAG,
                                  NULL_SLOT,
                                  dest,
                                  GetSpellInfo()->Effects[m_effIndex].ItemType,
                                  count,
                                  &noSpaceForCount);
    if (msg != EQUIP_ERR_OK) {
        count -= noSpaceForCount;
        plCaster->SendEquipError(msg,
                                 nullptr,
                                 nullptr,
                                 GetSpellInfo()->Effects[m_effIndex].ItemType);
        if (count == 0)
    ...
    Item* newitem = plCaster->StoreNewItem(
        dest, GetSpellInfo()->Effects[m_effIndex].ItemType, true);
    if (!newitem) {
                                       ...
                                       bool                   apply) const
{
    ...
    // convert number of runes specified in aura amount of rune type in
    // miscvalue to runetype in miscvalueb
    if (apply) {
                                  ...
                                  bool                   apply) const
{
    ...
    uint32 triggeredSpellId = sSpellMgr->GetSpellIdForDifficulty(
        m_spellInfo->Effects[m_effIndex].TriggerSpell, target);
    SpellInfo const* triggeredSpellInfo =
        sSpellMgr->GetSpellInfo(triggeredSpellId);
    if (!triggeredSpellInfo)
        return;

    if (mode & AURA_EFFECT_HANDLE_REAL) {
        if (apply) {
            Unit* caster = triggeredSpellInfo->NeedsToBeTriggeredByCaster(
                               m_spellInfo, GetEffIndex())
                               ? GetCaster()
                               : target;
            ...
            if (GetAmount())
                ...
                caster->CastSpell(
                    target, triggeredSpellId, true, nullptr, this);
        }
        else {
            ObjectGuid casterGUID =
                triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo,
                                                               GetEffIndex())
                    ? GetCasterGUID()
                    : target->GetGUID();
            target->RemoveAura(
                triggeredSpellId, casterGUID, 0, aurApp->GetRemoveMode());
        }
    }
    else if (mode & AURA_EFFECT_HANDLE_REAPPLY && apply) {
        ObjectGuid casterGUID = triggeredSpellInfo->NeedsToBeTriggeredByCaster(
                                    m_spellInfo, GetEffIndex())
                                    ? GetCasterGUID()
                                    : target->GetGUID();
        // change the stack amount to be equal to stack amount of our aura
        if (Aura* triggeredAura = target->GetAura(triggeredSpellId, casterGUID))
            triggeredAura->ModStackAmount(GetBase()->GetStackAmount() -
                                          triggeredAura->GetStackAmount());
    }
}
                                          ...
                                          bool                   apply) const
{
    ...
    if (apply) {
        target->SetUInt16Value(PLAYER_FIELD_BYTES2,
                               PLAYER_BYTES_2_OVERRIDE_SPELLS_UINT16_OFFSET,
                               overrideId);
        if (OverrideSpellDataEntry const* overrideSpells =
                sOverrideSpellDataStore.LookupEntry(overrideId))
...
void AuraEffect::HandlePeriodicDummyAuraTick(Unit* target, Unit* caster) const
{
    ...
    case SPELLFAMILY_DRUID: {
        ...
        case 22842: {
            // Converts up to 10 rage per second into health for $d.  Each point
            // of rage is converted into ${$m2/10}.1% of max health. Should be
            // manauser
            ...
            int32 points =
                target->CalculateSpellDamage(target, GetSpellInfo(), 1);
    ...
    case SPELLFAMILY_SHAMAN:
        if (GetId() == 52179) // Astral Shift
        {
            ...
            if (!(target->GetUnitFlags() &
                  (UNIT_FLAG_STUNNED | UNIT_FLAG_FLEEING | UNIT_FLAG_SILENCED)))
    ...
    case SPELLFAMILY_DEATHKNIGHT:
        ...
        if (GetSpellInfo()->SpellIconID == 3041 ||
            ...
            if (target->GetTypeId() != TYPEID_PLAYER)
                return;
            if (!target->ToPlayer()->IsClass(CLASS_DEATH_KNIGHT,
                                                    ...
                                                    Unit* caster) const
{
    ...
    if (!triggeredSpellInfo) {
        ...
        case SPELLFAMILY_GENERIC: {
            ...
            case 23493: {
                if (caster) {
                    ...
                    HealInfo healInfo(caster,
                                      ...
                                      heal,
                                      auraSpellInfo,
                                      auraSpellInfo->GetSchoolMask());
                    caster->HealBySpell(healInfo);

                    if (int32 mana = caster->GetMaxPower(POWER_MANA)) {
                        mana /= 10;
                        caster->EnergizeBySpell(
                            caster, 23493, mana, POWER_MANA);
                    }
                }
                return;
            }
            ...
            case 27808:
                if (caster) {
                    caster->CastCustomSpell(
                        29879,
                        SPELLVALUE_BASE_POINT0,
                        int32(target->CountPctFromMaxHealth(21)),
                        target,
                        true,
                        nullptr,
                        this);
            ...
            case 29528:
                if (target->GetTypeId() !=
                    TYPEID_UNIT) // prevent error reports in case ignored player
                                 // target
                    return;
                break;
            ...
            case 30427: {
                ...
                if (caster && caster->GetTypeId() == TYPEID_PLAYER &&
                    target->GetTypeId() == TYPEID_UNIT &&
                    target->ToCreature()->GetCreatureTemplate()->type ==
                    ...
                    player->AutoStoreLoot(
                        creature->GetCreatureTemplate()->SkinLootId,
            ...
            /// and executed in spell finish phase
            ...
            // Tear of Azzinoth Summon Channel - it's not really supposed to do
            // anything, and this only prevents the console spam
            case 39857:
        ...
        case SPELLFAMILY_SHAMAN: {
            switch (auraId) {
            // Lightning Shield (The Earthshatterer set trigger after cast
            // Lighting Shield)
            case 28820: {
        ...
        case 66882:
            target->CastCustomSpell(
                ...
                (int32)((((float)m_tickNumber / 60) * 0.9f + 0.1f) * 10000 * 2 /
                        3),
                nullptr,
                true,
                nullptr,
        ...
        case 56432:
            if (triggerSpellId == 56438) {
                target->CastCustomSpell(
                    triggerSpellId,
                    SPELLVALUE_RADIUS_MOD,
                    (int32)(10000 * (1.0f - 0.02f * (m_tickNumber + 1))),
                    nullptr,
                    true,
                    nullptr,
                    this);
        ...
        case 53563: {
            ...
            GetBase()->GetUnitOwner()->CastSpell(
                target,
                triggeredSpellInfo,
                true,
                0,
                this,
                GetBase()->GetUnitOwner()->GetGUID());
            return;
        }
        ...
        case 66283: {
            ...
            target->CastCustomSpell(
                target, 66316, &dmg, nullptr, nullptr, true);
            return;
        }
        ...
        case 58882:
            int32 amount =
                int32(target->GetMaxPower(POWER_MANA) * GetAmount() / 100.0f);
            target->CastCustomSpell(target,
                                    triggerSpellId,
                                    &amount,
                                    nullptr,
    ...
    if (triggeredSpellInfo) {
        if (Unit* triggerCaster =
            ...
            if (GetSpellInfo()->Effects[GetEffIndex()].TargetA.GetCheckType() ==
                    TARGET_CHECK_ENTRY ||
                GetSpellInfo()->Effects[GetEffIndex()].TargetB.GetCheckType() ==
                    TARGET_CHECK_ENTRY)
                triggerFlags =
                    TriggerCastFlags(TRIGGERED_FULL_MASK &
                                     ~TRIGGERED_IGNORE_POWER_AND_REAGENT_COST);

            triggerCaster->CastSpell(targets,
                                     triggeredSpellInfo,
                                     nullptr,
                                     triggerFlags,
                                     nullptr,
            ...
            LOG_DEBUG("spells.aura",
                      "AuraEffect::HandlePeriodicTriggerSpellAuraTick: Spell "
                      "{} Trigger {}",
                      GetId(),
                                                             ...
                                                             Unit* caster) const
{
    ...
    if (SpellInfo const* triggeredSpellInfo =
            sSpellMgr->GetSpellInfo(triggerSpellId)) {
        if (Unit* triggerCaster =
                triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo,
                                                               GetEffIndex())
        ...
        if (c && caster) {
            sScriptMgr->OnDummyEffect(caster,
                                      GetId(),
        ...
        LOG_DEBUG("spells.aura",
                  "AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: "
                  "Spell {} has non-existent spell {} in EffectTriggered[{}] "
...
void AuraEffect::HandlePeriodicDamageAurasTick(Unit* target, Unit* caster) const
{
    ...
    if (target->HasUnitState(UNIT_STATE_ISOLATED) ||
        target->IsImmunedToDamageOrSchool(GetSpellInfo()) ||
        target->IsTotem()) {
    ...
    if (caster &&
        GetSpellInfo()->Effects[GetEffIndex()].Effect ==
            SPELL_EFFECT_PERSISTENT_AREA_AURA &&
        caster->SpellHitResult(target, GetSpellInfo(), false) !=
            SPELL_MISS_NONE)
        return;
    ...
    // If the damage is percent-max-health based, calculate damage before the
    // Modify hook
    if (GetAuraType() == SPELL_AURA_PERIODIC_DAMAGE_PERCENT) {
        // xinef: ceil obtained value, it may happen that 10 ticks for 10%
        // damage may not kill owner
        damage = uint32(std::ceil(
            CalculatePct<float, float>(target->GetMaxHealth(), damage)));
    }

    // Script Hook For HandlePeriodicDamageAurasTick -- Allow scripts to change
    // the Damage pre class mitigation calculations
    sScriptMgr->ModifyPeriodicDamageAurasTick(
        target, caster, damage, GetSpellInfo());
    ...
    if (GetAuraType() == SPELL_AURA_PERIODIC_DAMAGE) {
        // xinef: leave only target depending bonuses, rest is handled in
        // calculate amount
        if (GetBase()->GetType() == DYNOBJ_AURA_TYPE && caster)
            damage = caster->SpellDamageBonusDone(target,
                                                  GetSpellInfo(),
                                                  damage,
                                                  DOT,
                                                  GetEffIndex(),
        ...
        damage = target->SpellDamageBonusTaken(
            caster, GetSpellInfo(), damage, DOT, GetBase()->GetStackAmount());

        // Calculate armor mitigation
        if (Unit::IsDamageReducedByArmor(GetSpellInfo()->GetSchoolMask(),
                                         GetSpellInfo(),
                                         GetEffIndex())) {
            uint32 damageReductedArmor = Unit::CalcArmorReducedDamage(
                caster, target, damage, GetSpellInfo(), GetCasterLevel());
            cleanDamage.mitigated_damage += damage - damageReductedArmor;
            damage = damageReductedArmor;
        }

        // Curse of Agony damage-per-tick calculation
        if (GetSpellInfo()->SpellFamilyName == SPELLFAMILY_WARLOCK &&
            (GetSpellInfo()->SpellFamilyFlags[0] & 0x400) &&
            GetSpellInfo()->SpellIconID == 544) {
    ...
    if ((crit = roll_chance_f(GetCritChance())))
        damage =
            Unit::SpellCriticalDamageBonus(caster, m_spellInfo, damage, target);
    ...
    if (GetSpellInfo()->Effects[GetEffIndex()].IsAreaAuraEffect() ||
        ...
        GetSpellInfo()->Effects[GetEffIndex()].Effect ==
            SPELL_EFFECT_PERSISTENT_AREA_AURA) // some persistent area auras
                                               // have targets like A=53 B=28
    {
        damage = target->CalculateAOEDamageReduction(
            damage, GetSpellInfo()->SchoolMask, caster);
    }
    ...
    if (CanApplyResilience()) {
        ...
        Unit::ApplyResilience(
            target, nullptr, &resilienceReduction, crit, CR_CRIT_TAKEN_SPELL);
    ...
    LOG_DEBUG(
        "spells.aura.effect",
        "PeriodicTick: {} attacked {} for {} dmg inflicted by {} abs is {}",
    ...
    SpellPeriodicAuraLogInfo pInfo(
        this, damage, overkill, absorb, resist, 0.0f, crit);
    target->SendPeriodicAuraLog(&pInfo);

    Unit::DealDamage(caster,
                     target,
                     damage,
                     &cleanDamage,
                     DOT,
                                                   ...
                                                   Unit* caster) const
{
    ...
    // Script Hook For HandlePeriodicHealthLeechAurasTick -- Allow scripts to
    // change the Damage pre class mitigation calculations
    sScriptMgr->ModifyPeriodicDamageAurasTick(
        target, caster, damage, GetSpellInfo());
    ...
    if (Unit::IsDamageReducedByArmor(
            GetSpellInfo()->GetSchoolMask(), GetSpellInfo(), m_effIndex)) {
        uint32 damageReductedArmor = Unit::CalcArmorReducedDamage(
            caster, target, damage, GetSpellInfo(), GetCasterLevel());
        cleanDamage.mitigated_damage += damage - damageReductedArmor;
        damage = damageReductedArmor;
    ...
    LOG_DEBUG("spells.aura.effect",
              "PeriodicTick: {} health leech of {} for {} dmg inflicted by {} "
              "abs is {}",
              GetCasterGUID().ToString(),
              target->GetGUID().ToString(),
              damage,
              ...
              absorb);
    if (caster)
        caster->SendSpellNonMeleeDamageLog(target,
                                           GetSpellInfo(),
                                           damage,
                                           GetSpellInfo()->GetSchoolMask(),
                                           absorb,
    ...
    new_damage = Unit::DealDamage(caster,
                                  target,
                                  damage,
                                  &cleanDamage,
                                  DOT,
    ...
    float gainMultiplier =
        GetSpellInfo()->Effects[GetEffIndex()].CalcValueMultiplier(caster);

    uint32 heal = uint32(
        caster->SpellHealingBonusDone(caster,
                                      GetSpellInfo(),
                                      uint32(new_damage * gainMultiplier),
                                      DOT,
                                      GetEffIndex(),
                                      0.0f,
                                      GetBase()->GetStackAmount()));
    heal = uint32(caster->SpellHealingBonusTaken(
        caster, GetSpellInfo(), heal, DOT, GetBase()->GetStackAmount()));

    HealInfo healInfo(
        caster, caster, heal, GetSpellInfo(), GetSpellInfo()->GetSchoolMask());
    int32 gain = caster->HealBySpell(healInfo);
    caster->getHostileRefMgr().threatAssist(
        caster, gain * 0.5f, GetSpellInfo());
}
                                                    ...
                                                    Unit* caster) const
{
    ...
    LOG_DEBUG("spells.aura",
              "PeriodicTick: donator {} target {} damage {}.",
              caster->GetEntry(),
              target->GetEntry(),
              damage);
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
    ...
    if (target != caster &&
        GetSpellInfo()->HasAttribute(SPELL_ATTR2_NO_TARGET_PER_SECOND_COST) &&
    ...
    if (GetAuraType() == SPELL_AURA_OBS_MOD_HEALTH) {
        ...
        float minval_hot =
            (float)target->GetMaxNegativeAuraModifier(SPELL_AURA_MOD_HOT_PCT);
        if (minval_hot)
            AddPct(TakenTotalMod, minval_hot);

        float maxval_hot =
            (float)target->GetMaxPositiveAuraModifier(SPELL_AURA_MOD_HOT_PCT);
        if (maxval_hot)
            AddPct(TakenTotalMod, maxval_hot);

        // Arena / BG Dampening
        float minval_pct = (float)target->GetMaxNegativeAuraModifier(
        ...
        // the most ugly hack i made :P the other option is to change all
        // spellvalues to float... demonic aegis
        if (caster && GetSpellInfo()->SpellFamilyName == SPELLFAMILY_WARLOCK &&
            (GetSpellInfo()->SpellFamilyFlags[1] & 0x20000000))
            if (AuraEffect* aurEff = caster->GetAuraEffect(
                    SPELL_AURA_ADD_PCT_MODIFIER, SPELLFAMILY_WARLOCK, 89, 0))
        ...
        if (GetSpellInfo()->SpellFamilyName == SPELLFAMILY_DRUID &&
            GetSpellInfo()->SpellIconID == 2864) {
            uint32 tickNumber = GetTickNumber() - 1;
            int32  tempAmount = m_spellInfo->Effects[m_effIndex].CalcValue(
                caster, &m_baseAmount, nullptr);
            ...
            damage += GetTotalTicks() * tempAmount * (6 - (drop * tickNumber)) *
                      0.01f;
        }

        if (GetBase()->GetType() == DYNOBJ_AURA_TYPE)
            damage = caster->SpellHealingBonusDone(target,
                                                   GetSpellInfo(),
                                                   damage,
                                                   DOT,
                                                   GetEffIndex(),
    ...
    bool crit = false;
    if ((crit = roll_chance_f(GetCritChance())))
        damage = Unit::SpellCriticalHealingBonus(
            caster, GetSpellInfo(), damage, target);
    ...
    HealInfo healInfo(
        caster, target, heal, GetSpellInfo(), GetSpellInfo()->GetSchoolMask());
    Unit::CalcHealAbsorb(healInfo);
    int32 gain = Unit::DealHeal(caster, target, healInfo.GetHeal());
    healInfo.SetEffectiveHeal(gain);

    SpellPeriodicAuraLogInfo pInfo(this,
                                   healInfo.GetHeal(),
                                   healInfo.GetHeal() -
    ...
    if (caster)
        target->getHostileRefMgr().threatAssist(
            caster, float(gain) * 0.5f, GetSpellInfo());
    ...
    if (!haveCastItem &&
        GetAuraType() !=
            SPELL_AURA_OBS_MOD_HEALTH) // xinef: dont allow obs_mod_health to
                                       // proc spells, this is passive
                                       // regeneration and not hot
        Unit::ProcDamageAndSpell(caster,
                                 target,
                                 caster ? procAttacker : 0,
                                 procVictim,
                                                 ...
                                                 Unit* caster) const
{
    ...
    if (!caster || !caster->IsAlive() || !target->IsAlive() ||
        !target->HasActivePowerType(PowerType))
        return;
    ...
    if (GetSpellInfo()->Effects[GetEffIndex()].Effect ==
            SPELL_EFFECT_PERSISTENT_AREA_AURA &&
        caster->SpellHitResult(target, GetSpellInfo(), false) !=
            SPELL_MISS_NONE)
        return;
    ...
    // Special case: draining x% of mana (up to a maximum of 2*x% of the
    // caster's maximum mana) It's mana percent cost spells, m_amount is percent
    // drain from target
    if (m_spellInfo->ManaCostPercentage) {
        // max value
        int32 maxmana =
            CalculatePct(caster->GetMaxPower(PowerType), drainAmount * 2.0f);
    ...
    SpellPeriodicAuraLogInfo pInfo(
        this, drainedAmount, 0, 0, 0, gainMultiplier, false);
    target->SendPeriodicAuraLog(&pInfo);
...
void AuraEffect::HandleObsModPowerAuraTick(Unit* target, Unit* caster) const
{
    ...
    // ignore negative values (can be result apply spellmods to aura damage
    uint32 amount =
        std::max(m_amount, 0) * target->GetMaxPower(PowerType) / 100;
    LOG_DEBUG("spells.aura.effect",
                                                 ...
                                                 Unit* caster) const
{
    ...
    SpellNonMeleeDamage damageInfo(
        caster, target, spellProto, spellProto->SchoolMask);
    // no SpellDamageBonus for burn mana
    caster->CalculateSpellDamageTaken(
        &damageInfo, int32(gain * dmgMultiplier), spellProto);
                                                ...
                                                ProcEventInfo&   eventInfo)
{
    ...
    if (SpellInfo const* triggeredSpellInfo =
            sSpellMgr->GetSpellInfo(triggerSpellId)) {
        LOG_DEBUG("spells.aura",
                  "AuraEffect::HandleProcTriggerSpellAuraProc: Triggering "
                  "spell {} from aura {} proc",
                  triggeredSpellInfo->Id,
                  GetId());
        triggerCaster->CastSpell(
            triggerTarget, triggeredSpellInfo, true, nullptr, this);
    }
    else {
        LOG_DEBUG("spells.aura",
                  "AuraEffect::HandleProcTriggerSpellAuraProc: Could not "
                  "trigger spell {} from aura {} proc, because the spell does "
                  "not have an entry in Spell.dbc.",
                  triggerSpellId,
                  GetId());
    }
}

void AuraEffect::HandleProcTriggerSpellWithValueAuraProc(
    AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
    Unit* triggerCaster = aurApp->GetTarget();
    Unit* triggerTarget = eventInfo.GetProcTarget();
    ...
    if (SpellInfo const* triggeredSpellInfo =
        ...
        LOG_DEBUG("spells.aura",
                  ...
                  "Triggering spell {} with value {} from aura {} proc",
                  triggeredSpellInfo->Id,
                  basepoints0,
                  GetId());
        triggerCaster->CastCustomSpell(triggerTarget,
                                       triggerSpellId,
                                       &basepoints0,
                                       nullptr,
                                       nullptr,
        ...
        LOG_DEBUG("spells.aura",
                  ...
                  "not trigger spell {} from aura {} proc, because the spell "
                  "does not have an entry in Spell.dbc.",
                  triggerSpellId,
                  GetId());
    }
}
                                                 ...
                                                 ProcEventInfo&   eventInfo)
{
    ...
    if (triggerTarget->HasUnitState(UNIT_STATE_ISOLATED) ||
        triggerTarget->IsImmunedToDamageOrSchool(GetSpellInfo())) {
        SendTickImmune(triggerTarget, target);
        return;
    }

    SpellNonMeleeDamage damageInfo(
        target, triggerTarget, GetSpellInfo(), GetSpellInfo()->SchoolMask);
    uint32 damage = target->SpellDamageBonusDone(triggerTarget,
                                                 GetSpellInfo(),
                                                 GetAmount(),
                                                 SPELL_DIRECT_DAMAGE,
                                                 GetEffIndex());
    damage        = triggerTarget->SpellDamageBonusTaken(
        target, GetSpellInfo(), damage, SPELL_DIRECT_DAMAGE);
    target->CalculateSpellDamageTaken(&damageInfo, damage, GetSpellInfo());
    Unit::DealDamageMods(
        damageInfo.target, damageInfo.damage, &damageInfo.absorb);
    target->SendSpellNonMeleeDamageLog(&damageInfo);
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandleProcTriggerDamageAuraProc: Triggering {} "
              "spell damage from aura {} proc",
              damage,
              GetId());
                                                  ...
                                                  ProcEventInfo& /*eventInfo*/)
{
    ...
    default:
        LOG_DEBUG("spells.aura",
                  "AuraEffect::HandleRaidProcFromChargeAuraProc: received not "
                  "handled spell: {}",
                  GetId());
        return;
    }
    ...
    if (jumps > 0) {
        if (Unit* caster = GetCaster()) {
            float radius =
                GetSpellInfo()->Effects[GetEffIndex()].CalcRadius(caster);

            if (Unit* triggerTarget =
                    target->GetNextRandomRaidMemberOrPet(radius)) {
                target->CastSpell(triggerTarget,
                                  GetSpellInfo(),
                                  true,
                                  nullptr,
                                  this,
                                  GetCasterGUID());
                if (Aura* aura =
                        triggerTarget->GetAura(GetId(), GetCasterGUID()))
    ...
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandleRaidProcFromChargeAuraProc: Triggering spell "
              "{} from aura {} proc",
              triggerSpellId,
              GetId());
    target->CastSpell(
        target, triggerSpellId, true, nullptr, this, GetCasterGUID());
}
    ...
    AuraApplication* aurApp, ProcEventInfo& /*eventInfo*/)
{
    ...
    if (jumps > 0) {
        if (Unit* caster = GetCaster()) {
            ...
            Acore::UnitLastSearcher<Acore::MostHPMissingGroupInRange> searcher(
                target, triggerTarget, u_check);
            Cell::VisitAllObjects(target, searcher, radius);

            if (triggerTarget) {
                target->CastCustomSpell(triggerTarget,
                                        GetId(),
                                        &value,
                                        nullptr,
                                        nullptr,
    ...
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandleRaidProcFromChargeWithValueAuraProc: "
              "Triggering spell {} from aura {} proc",
              triggerSpellId,
              GetId());
    target->CastCustomSpell(target,
                            triggerSpellId,
