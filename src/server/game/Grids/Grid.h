...
public:
    ...
    */
    ...
    // template<class SPECIFIC_OBJECT> void RemoveWorldObject(SPECIFIC_OBJECT
    // *obj)
    //{
    ...
    template <class T>
    void
    Visit(TypeContainerVisitor<T, TypeMapContainer<GRID_OBJECT_TYPES>>& visitor)
    {
    ...
    template <class T>
    void Visit(
        TypeContainerVisitor<T, TypeMapContainer<WORLD_OBJECT_TYPES>>& visitor)
    {
     ...
     */
    // template<class SPECIFIC_OBJECT> void RemoveGridObject(SPECIFIC_OBJECT
    // *obj)
    //{
    //     ASSERT(obj->GetGridRef().isValid());
