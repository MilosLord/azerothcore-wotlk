...
float const  WintergraspStalkerPos[4] = {
    4948.985f, 2937.789f, 550.5172f, 1.815142f};
...
public:
     ...
     * - Remove vehicle
     * \param endByTimer : true if battle ended when timer is at 00:00, false if
     * battle ended by clicking on relic
     */
    ...
    /// Check if players can interact with the relic (Only if the last door has
    /// been broken)
...
const WintergraspObjectPositionData WGKeepNPC[WG_MAX_KEEP_NPC] = {
    // X          Y            Z           O         horde alliance North East
    {5326.203125f,
     2660.026367f,
     409.100891f,
     2.543383f,
     BATTLEFIELD_WG_NPC_GUARD_H,
     BATTLEFIELD_WG_NPC_GUARD_A}, // Roaming Guard
    {5298.430176f,
     2738.760010f,
     409.316010f,
     3.971740f,
     BATTLEFIELD_WG_NPC_VIERON_BLAZEFEATHER,
     BATTLEFIELD_WG_NPC_BOWYER_RANDOLPH}, // Vieron Blazefeather
    {5335.310059f,
     2764.110107f,
     409.274994f,
     4.834560f,
     BATTLEFIELD_WG_NPC_GUARD_H,
     BATTLEFIELD_WG_NPC_GUARD_A}, // Standing Guard
    {5349.810059f,
     2763.629883f,
     409.333008f,
     4.660030f,
    ...
    {5373.470215f,
     ...
     BATTLEFIELD_WG_NPC_KNIGHT_DAMERON}, // Stone Guard Mukar
    {5296.560059f,
     2789.870117f,
     409.274994f,
     0.733038f,
     BATTLEFIELD_WG_NPC_HOODOO_MASTER_FU_JIN,
     BATTLEFIELD_WG_NPC_SORCERESS_KAYLANA}, // Voodoo Master Fu'jin
    {5372.670000f,
     2786.740000f,
     409.442000f,
     2.809980f,
     BATTLEFIELD_WG_NPC_CHAMPION_ROS_SLAI,
     BATTLEFIELD_WG_NPC_MARSHAL_MAGRUDER}, // Wintergrasp Quartermaster
    {5368.709961f,
     2856.360107f,
     409.322998f,
     2.949610f,
    ...
    {5359.129883f,
     ...
     BATTLEFIELD_WG_NPC_COMMANDER_ZANNETH}, // Commander Dardosh
    {5366.129883f,
     2833.399902f,
     409.322998f,
     3.141590f,
     BATTLEFIELD_WG_NPC_TACTICAL_OFFICER_KILRATH,
     BATTLEFIELD_WG_NPC_TACTICAL_OFFICER_AHBRAMIS}, // Tactical Officer Kilrath
    {5467.590000f,
     2841.060000f,
     418.758000f,
     1.396260f,
     BATTLEFIELD_WG_NPC_HORDE_WARBRINGER,
     BATTLEFIELD_WG_NPC_BRIGADIER_GENERAL}, // Battlemaster
    ...
    {5415.120000f,
     ...
     BATTLEFIELD_WG_NPC_AV_PORTAL_ALLY}, // Portal
    {5467.560000f,
     2810.080000f,
     418.758000f,
     0.837758f,
     BATTLEFIELD_WG_NPC_AB_PORTAL_HORDE,
     BATTLEFIELD_WG_NPC_AB_PORTAL_ALLY}, // Portal
    {5476.330000f,
     2863.210000f,
     418.758000f,
     0.471239f,
     BATTLEFIELD_WG_NPC_EOTS_PORTAL_HORDE,
     BATTLEFIELD_WG_NPC_EOTS_PORTAL_ALLY}, // Portal
    {5468.270000f,
     2871.140000f,
     418.758000f,
     0.000000f,
     BATTLEFIELD_WG_NPC_SOTA_PORTAL_HORDE,
     BATTLEFIELD_WG_NPC_SOTA_PORTAL_ALLY}, // Portal
    {5476.100000f,
     2818.040000f,
     418.758000f,
     4.380780f,
     BATTLEFIELD_WG_NPC_WG_PORTAL_HORDE,
     BATTLEFIELD_WG_NPC_WG_PORTAL_ALLY}, // Portal
    ...
    {5295.560059f,
     ...
     BATTLEFIELD_WG_NPC_SIEGE_MASTER_STOUTHANDLE}, // Stronghoof
    {5371.399902f,
     3026.510010f,
     409.205994f,
     3.250030f,
     BATTLEFIELD_WG_NPC_PRIMALIST_MULFORT,
     BATTLEFIELD_WG_NPC_ANCHORITE_TESSA}, // Primalist Mulfort
    {5392.123535f,
     3031.110352f,
     409.187683f,
     3.677212f,
    ...
    {5234.970215f,
     ...
     BATTLEFIELD_WG_NPC_SENIOR_DEMOLITIONIST_LEGOSO}, // Lieutenant Murp
                                                      // X          Y Z O horde
                                                      // alliance Portal guards
                                                      // (from around the
                                                      // fortress)
    {5319.209473f,
     3055.947754f,
...
struct WintergraspTowerData {
    ...
    WintergraspObjectPositionData
        GameObject[6]; // Gameobject position and entry (Horde/Alliance)

    // Creature : Turrets and Guard, TODO: check if killed on tower destruction?
    // tower damage?
    ...
    {190356,
     6,
     {
         ...
         {4433.899902f,
          ...
          -1.850050f,
          192269,
          192278}, // Flag near workshop
         {4572.930176f,
          3475.520020f,
          363.009003f,
          1.42240f,
          192269,
          192278} // Flag near bridge
     },
     6,
     {
         {4418.688477f,
    ...
    // South Tower
    {
        ...
        5,
        {
            ...
            {4387.620117f,
             ...
             -1.544620f,
             192366,
             192414}, // Flag near tower
            {4464.120117f,
             2855.449951f,
             406.110992f,
             0.829032f,
             192366,
             192429}, // Flag near tower
            {4526.459961f,
             2810.179932f,
             391.200012f,
             -2.993220f,
...
struct BfWGGameObjectBuilding {
    ...
    void Rebuild()
    {
        ...
        case BATTLEFIELD_WG_OBJECTTYPE_WALL:
            m_Team = m_WG->GetDefenderTeam(); // Objects that are part of the
                                              // keep should be the defender's
            break;
        case BATTLEFIELD_WG_OBJECTTYPE_TOWER:
            m_Team = m_WG->GetAttackerTeam(); // The towers in the south should
                                              // be the attacker's
            break;
        default:
            m_Team = TEAM_NEUTRAL;
    ...
    void Damaged()
    {
        ...
        for (GuidUnorderedSet::const_iterator itr =
                 m_CreatureTopList[m_WG->GetAttackerTeam()].begin();
             itr != m_CreatureTopList[m_WG->GetAttackerTeam()].end();
             ++itr)
            if (Creature* creature = m_WG->GetCreature(*itr))
                m_WG->HideNpc(creature);

        for (GuidUnorderedSet::const_iterator itr = m_TurretTopList.begin();
             itr != m_TurretTopList.end();
             ++itr)
            if (Creature* creature = m_WG->GetCreature(*itr))
                m_WG->HideNpc(creature);
    ...
    void Destroyed()
    {
        ...
        switch (m_Type) {
        // Inform the global wintergrasp script of the destruction of this
        // object
        case BATTLEFIELD_WG_OBJECTTYPE_TOWER:
            m_WG->UpdatedDestroyedTowerCount(TeamId(m_Team),
                                             m_WG->GetGameObject(m_Build));
            break;
        case BATTLEFIELD_WG_OBJECTTYPE_DOOR_LAST:
              ...
              uint8       destroyText)
    {
        ...
        if (towerid > 3) // Attacker towers
        {
            ...
            for (uint8 i = 0; i < AttackTowers[towerid - 4].nbObject; i++) {
                WintergraspObjectPositionData gobData =
                    AttackTowers[towerid - 4].GameObject[i];
                if (GameObject* go = m_WG->SpawnGameObject(gobData.entryHorde,
                                                           gobData.x,
                                                           gobData.y,
                                                           gobData.z,
                                                           gobData.o))
                ...
                if (GameObject* go =
                        m_WG->SpawnGameObject(gobData.entryAlliance,
                                              gobData.x,
                                              gobData.y,
                                              gobData.z,
                                              gobData.o))
            ...
            for (uint8 i = 0; i < AttackTowers[towerid - 4].nbCreatureBottom;
                 i++) {
                WintergraspObjectPositionData creatureData =
                    AttackTowers[towerid - 4].CreatureBottom[i];
                if (Creature* creature =
                        m_WG->SpawnCreature(creatureData.entryHorde,
                                            creatureData.x,
                                            creatureData.y,
                                            creatureData.z,
                                            creatureData.o,
                                            TEAM_HORDE))
                    m_CreatureBottomList[TEAM_HORDE].insert(
                        creature->GetGUID());
                if (Creature* creature =
                        m_WG->SpawnCreature(creatureData.entryAlliance,
                                            creatureData.x,
                                            creatureData.y,
                                            creatureData.z,
                                            creatureData.o,
                                            TEAM_ALLIANCE))
                    m_CreatureBottomList[TEAM_ALLIANCE].insert(
                        creature->GetGUID());
            }

            // Spawn associate npc top
            for (uint8 i = 0; i < AttackTowers[towerid - 4].nbCreatureTop;
                 i++) {
                WintergraspObjectPositionData creatureData =
                    AttackTowers[towerid - 4].CreatureTop[i];
                if (Creature* creature =
                        m_WG->SpawnCreature(creatureData.entryHorde,
                                            creatureData.x,
                                            creatureData.y,
                ...
                if (Creature* creature =
                        m_WG->SpawnCreature(creatureData.entryAlliance,
                                            ...
                                            creatureData.o,
                                            TEAM_ALLIANCE))
                    m_CreatureTopList[TEAM_ALLIANCE].insert(
                        creature->GetGUID());
            }
        }
        ...
        if (towerid >= 0) {
            // Spawn Turret bottom
            for (uint8 i = 0; i < TowerCannon[towerid].nbTowerCannonBottom;
                 i++) {
                Position turretPos =
                    TowerCannon[towerid].TowerCannonBottom[i].GetPosition();
                if (Creature* turret =
                        m_WG->SpawnCreature(NPC_WINTERGRASP_TOWER_CANNON,
                                            turretPos,
                                            TEAM_ALLIANCE)) {
            ...
            for (uint8 i = 0; i < TowerCannon[towerid].nbTurretTop; i++) {
                Position towerCannonPos =
                    TowerCannon[towerid].TurretTop[i].GetPosition();
                if (Creature* turret =
                        m_WG->SpawnCreature(NPC_WINTERGRASP_TOWER_CANNON,
                                            towerCannonPos,
                                            TEAM_ALLIANCE)) {
    ...
    {
        for (GuidUnorderedSet::const_iterator itr =
                 m_CreatureTopList[m_WG->GetDefenderTeam()].begin();
             itr != m_CreatureTopList[m_WG->GetDefenderTeam()].end();
             ++itr)
            if (Creature* creature = m_WG->GetCreature(*itr))
                m_WG->HideNpc(creature);
        ...
        for (GuidUnorderedSet::const_iterator itr =
                 m_CreatureBottomList[m_WG->GetDefenderTeam()].begin();
             itr != m_CreatureBottomList[m_WG->GetDefenderTeam()].end();
             ++itr)
            if (Creature* creature = m_WG->GetCreature(*itr))
                m_WG->HideNpc(creature);

        for (GuidUnorderedSet::const_iterator itr =
                 m_CreatureBottomList[m_WG->GetAttackerTeam()].begin();
             itr != m_CreatureBottomList[m_WG->GetAttackerTeam()].end();
             ++itr)
            if (Creature* creature = m_WG->GetCreature(*itr))
                m_WG->ShowNpc(creature, true);

        for (GameObjectSet::const_iterator itr =
                 m_GameObjectList[m_WG->GetDefenderTeam()].begin();
             itr != m_GameObjectList[m_WG->GetDefenderTeam()].end();
             ++itr)
            (*itr)->SetRespawnTime(RESPAWN_ONE_DAY);

        for (GameObjectSet::const_iterator itr =
                 m_GameObjectList[m_WG->GetAttackerTeam()].begin();
             itr != m_GameObjectList[m_WG->GetAttackerTeam()].end();
             ++itr)
    ...
    void UpdateTurretAttack(bool disable)
    {
        ...
        for (GuidUnorderedSet::const_iterator itr =
                 m_TowerCannonBottomList.begin();
             itr != m_TowerCannonBottomList.end();
             ++itr) {
            if (Creature* creature = m_WG->GetCreature(*itr)) {
    ...
    void Save() { sWorld->setWorldState(m_WorldState, m_State); }
};
...
struct WGWorkshop {
    ...
    void GiveControlTo(TeamId team, bool init /* for first call in setup*/)
    {
        switch (team) {
        case TEAM_NEUTRAL: {
            // Send warning message to all player to inform a faction attack to
            // a workshop alliance / horde attacking a workshop
            bf->SendWarning(teamControl
                                ? WorkshopsData[workshopId].attackText
                                : (WorkshopsData[workshopId].attackText + 2));

            // Updating worldstate, update icon to neutral
            state = BATTLEFIELD_WG_OBJECTSTATE_NEUTRAL_INTACT;
            bf->SendUpdateWorldState(WorkshopsData[workshopId].worldstate,
                                     state);
        ...
        case TEAM_HORDE: {
            ...
            if (!init) // workshop taken - alliance
                bf->SendWarning(
                    team == TEAM_ALLIANCE
                        ? WorkshopsData[workshopId].takenText
                        : (WorkshopsData[workshopId].takenText + 2));
    ...
    {
        if (workshopId < BATTLEFIELD_WG_WORKSHOP_KEEP_WEST)
            bf->GetGraveyardById(workshopId)
                ->GiveControlTo(TeamId(teamControl));
        else
