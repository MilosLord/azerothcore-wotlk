...
typedef std::unordered_multimap<uint32, SkillRaceClassInfoEntry const*>
    SkillRaceClassInfoMap;
typedef std::pair<SkillRaceClassInfoMap::iterator,
...
typedef std::unordered_map<uint32 /* SkillLine */,
                           std::vector<SkillLineAbilityEntry const*>>
...
extern DBCStorage<GtOCTClassCombatRatingScalarEntry>
                                     sGtOCTClassCombatRatingScalarStore;
extern DBCStorage<GtOCTRegenHPEntry> sGtOCTRegenHPStore;
// extern DBCStorage <GtOCTRegenMPEntry>            sGtOCTRegenMPStore; -- not
// used currently
...
// extern DBCStorage <MapDifficultyEntry>           sMapDifficultyStore; -- use
// GetMapDifficultyData insteed
...
extern DBCStorage<SpellItemEnchantmentConditionEntry>
...
// extern DBCStorage <WorldMapAreaEntry>           sWorldMapAreaStore; -- use
