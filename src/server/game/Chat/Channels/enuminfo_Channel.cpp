...
template <>
AC_API_EXPORT size_t EnumUtils<ChatNotify>::Count()
{
    return 36;
}
...
AC_API_EXPORT ChatNotify EnumUtils<ChatNotify>::FromIndex(size_t index)
{
    ...
    case 11:
        return CHAT_CHANNEL_OWNER_NOTICE;
    case 12:
        return CHAT_MODE_CHANGE_NOTICE;
    case 13:
        return CHAT_ANNOUNCEMENTS_ON_NOTICE;
    case 14:
        return CHAT_ANNOUNCEMENTS_OFF_NOTICE;
