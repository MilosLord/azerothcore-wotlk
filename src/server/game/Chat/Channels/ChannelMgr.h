...
public:
    ...
    static void                 SetChannelRightsFor(const std::string&      name,
                                                    const uint32&           flags,
...
private:
    ...
    static ChannelRights    channelRightsEmpty; // when not found in the map,
                                                // reference to this is returned
...
public:
    AllianceChannelMgr() : ChannelMgr(TEAM_ALLIANCE) {}
};
class HordeChannelMgr : public ChannelMgr {
public:
    HordeChannelMgr() : ChannelMgr(TEAM_HORDE) {}
};
