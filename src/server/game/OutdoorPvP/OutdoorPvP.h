...
public:
    ...
    virtual bool
    HandleCustomSpell(Player* player, uint32 spellId, GameObject* go);
    ...
    virtual bool
    HandleGossipOption(Player* player, Creature* creature, uint32 gossipId);
    virtual bool
    CanTalkTo(Player* player, Creature* c, GossipMenuItems const& gso);
    ...
    [[nodiscard]] float GetSlider() const { return _value; }
...
public:
    ...
    typedef std::map<ObjectGuid::LowType /*lowguid*/, OPvPCapturePoint*>
                                                        OPvPCapturePointMap;
    ...
    // called by OutdoorPvPMgr, updates the objectives and if needed, sends new
    // worldstateui information
    virtual bool Update(uint32 diff);
    ...
    virtual bool
         CanTalkTo(Player* player, Creature* c, GossipMenuItems const& gso);
    void TeamApplyBuff(TeamId  teamId,
                       uint32  spellId,
                       uint32  spellId2   = 0,
...
protected:
    ...
    void
    TeamCastSpell(TeamId team, int32 spellId, Player* sameMapPlr = nullptr);
