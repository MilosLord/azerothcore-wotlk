...
struct AuctionEntry {
    ...
    BuildAuctionMailSubject(MailAuctionAnswers response) const;
    static std::string BuildAuctionMailBody(ObjectGuid guid,
                                            uint32     bid,
                                            uint32     buyout,
                                            uint32     deposit    = 0,
                                            uint32     cut        = 0,
...
public:
    ...
    void BuildListBidderItems(WorldPacket& data,
                              Player*      player,
                              uint32&      count,
                              uint32&      totalcount);
    void BuildListOwnerItems(WorldPacket& data,
                             Player*      player,
                             uint32&      count,
                             uint32&      totalcount);
    bool BuildListAuctionItems(WorldPacket&                  data,
                               Player*                       player,
...
public:
    ...
    static uint32 GetAuctionDeposit(AuctionHouseEntry const* entry,
                                    uint32                   time,
                                    Item*                    pItem,
                                    uint32                   count);
    static AuctionHouseEntry const*
    GetAuctionHouseEntry(uint32 factionTemplateId);
    static AuctionHouseEntry const*
    GetAuctionHouseEntryFromHouse(uint8 houseId);
...
public:
    ...
    bool RemoveAItem(ObjectGuid                    itemGuid,
