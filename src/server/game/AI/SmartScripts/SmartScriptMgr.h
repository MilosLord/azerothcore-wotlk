...
enum SMART_EVENT_PHASE_BITS {
    ...
    SMART_EVENT_PHASE_ALL = SMART_EVENT_PHASE_1_BIT + SMART_EVENT_PHASE_2_BIT +
                            ...
                            SMART_EVENT_PHASE_7_BIT + SMART_EVENT_PHASE_8_BIT +
                            SMART_EVENT_PHASE_9_BIT + SMART_EVENT_PHASE_10_BIT +
...
enum SMART_EVENT {
    ...
    SMART_EVENT_KILL =
        5, // CooldownMin0, CooldownMax1, playerOnly2, else creature entry3
    ...
    SMART_EVENT_OOC_LOS =
        10, // HostilityMode, MaxRnage, CooldownMin, CooldownMax, PlayerOnly
    ...
    SMART_EVENT_FRIENDLY_MISSING_BUFF =
        16, // SpellId, Radius, RepeatMin, RepeatMax, onlyInCombat
    SMART_EVENT_SUMMONED_UNIT =
        17, // CreatureId(0 all), CooldownMin, CooldownMax
    SMART_EVENT_TARGET_MANA_PCT =
        18, // ManaMin%, ManaMax%, RepeatMin, RepeatMax
    SMART_EVENT_ACCEPTED_QUEST =
        19, // QuestID (0 = any), CooldownMin, CooldownMax
    SMART_EVENT_REWARD_QUEST =
        20, // QuestID (0 = any), CooldownMin, CooldownMax
    SMART_EVENT_REACHED_HOME = 21, // NONE
    SMART_EVENT_RECEIVE_EMOTE =
        22, // EmoteId, CooldownMin, CooldownMax, condition, val1, val2, val3
    SMART_EVENT_HAS_AURA = 23,      // Param1 = SpellID, Param2 = Stack amount,
                                    // Param3/4 RepeatMin, RepeatMax
    SMART_EVENT_TARGET_BUFFED = 24, // Param1 = SpellID, Param2 = Stack amount,
                                    // Param3/4 RepeatMin, RepeatMax
    SMART_EVENT_RESET =
        25, // Called after combat, when the creature respawn and spawn.
    SMART_EVENT_IC_LOS =
        26, // HostilityMode, MaxRnage, CooldownMin, CooldownMax, PlayerOnly
    ...
    SMART_EVENT_TEXT_OVER =
        52, // GroupId from creature_text,  creature entry who talks (0 any)
    ...
    SMART_EVENT_LINK   = 61, // INTERNAL USAGE, no params, used to link together
                           // multiple events, does not use any extra resources
                           // to iterate event lists needlessly
    SMART_EVENT_GOSSIP_SELECT = 62, // menuID, actionID
    SMART_EVENT_JUST_CREATED  = 63, // none
    SMART_EVENT_GOSSIP_HELLO =
        64, // event_para_1 (only) 0 = no filter set, always execute action, 1 =
            // GossipHello only filter set, skip action if reportUse, 2 =
            // reportUse only filter set, skip action if GossipHello
    SMART_EVENT_FOLLOW_COMPLETED = 65, // none
    SMART_EVENT_EVENT_PHASE_CHANGE =
        66, // event phase mask (<= SMART_EVENT_PHASE_ALL)
    SMART_EVENT_IS_BEHIND_TARGET =
        67, // min, max, repeatMin, repeatMax, rangeMin, rangeMax
    ...
    SMART_EVENT_FRIENDLY_HEALTH_PCT =
        74, // min, max, repeatMin, repeatMax, hpPct, range
    ...
    SMART_EVENT_SUMMONED_UNIT_DIES =
        82, // CreatureId(0 all), CooldownMin, CooldownMax
    ...
    SMART_EVENT_NEAR_PLAYERS =
        101, // min, radius, first timer, repeatMin, repeatMax
    SMART_EVENT_NEAR_PLAYERS_NEGATION =
        102, // max, radius, first timer, repeatMin, repeatMax
    SMART_EVENT_NEAR_UNIT =
        103, // type (0: creature 1: gob), entry, count, range, timer
    SMART_EVENT_NEAR_UNIT_NEGATION =
        104, // type (0: creature 1: gob), entry, count, range, timer
    SMART_EVENT_AREA_CASTING =
        105, // min, max, repeatMin, repeatMax, rangeMin, rangeMax
    SMART_EVENT_AREA_RANGE =
        106, // min, max, repeatMin, repeatMax, rangeMin, rangeMax
    SMART_EVENT_SUMMONED_UNIT_EVADE =
        107, // CreatureId(0 all), CooldownMin, CooldownMax
...
enum SMART_ACTION {
    ...
    SMART_ACTION_TALK =
        1, // groupID from creature_text, duration to wait before TEXT_OVER
           // event is triggered, use first target from targetlist as invoker,
           // useTalkTarget (0/1) - use target as talk target
    SMART_ACTION_SET_FACTION = 2, // FactionId (or 0 for default)
    SMART_ACTION_MORPH_TO_ENTRY_OR_MODEL =
        3, // Creature_template entry(param1) OR ModelId (param2) (or 0 for both
           // to demorph)
    ...
    SMART_ACTION_SUMMON_CREATURE =
        12, // CreatureID, summonType, duration in ms, attackInvoker,
            // attackScriptOwner, flags(SmartActionSummonCreatureFlags)
    ...
    SMART_ACTION_SET_UNIT_FLAG =
        18, // Flags (may be more than one field OR'd together), Target
    SMART_ACTION_REMOVE_UNIT_FLAG =
        19, // Flags (may be more than one field OR'd together), Target
    SMART_ACTION_AUTO_ATTACK = 20, // AllowAttackState (0 = stop attack,
                                   // anything else means continue attacking)
    SMART_ACTION_ALLOW_COMBAT_MOVEMENT =
        21, // AllowCombatMovement (0 = stop combat based movement, anything
            // else continue attacking)
    SMART_ACTION_SET_EVENT_PHASE = 22, // Phase
    SMART_ACTION_INC_EVENT_PHASE =
        23, // Value (may be negative to decrement phase, should not be 0)
    SMART_ACTION_EVADE                  = 24, // No Params
    SMART_ACTION_FLEE_FOR_ASSIST        = 25, // With Emote
    SMART_ACTION_CALL_GROUPEVENTHAPPENS = 26, // QuestID
    SMART_ACTION_COMBAT_STOP            = 27, // No Params
    SMART_ACTION_REMOVEAURASFROMSPELL =
        28, // Spellid (0 removes all auras), charges (0 removes aura)
    SMART_ACTION_FOLLOW =
        29, // Distance (0 = default), Angle (0 = default), EndCreatureEntry,
            // credit, creditType (0monsterkill, 1event)
    ...
    SMART_ACTION_MOUNT_TO_ENTRY_OR_MODEL =
        43, // Creature_template entry(param1) OR ModelId (param2) (or 0 for
            // both to dismount)
    ...
    SMART_ACTION_SUMMON_GO = 50, // GameObjectID, DespawnTime, targetSummon,
                                 // summonType (0 time or summoner dies/1 time)
    SMART_ACTION_KILL_UNIT     = 51, //
    SMART_ACTION_ACTIVATE_TAXI = 52, // TaxiID
    SMART_ACTION_WP_START =
        53, // run/walk, pathID, canRepeat, quest, despawntime, reactState
    ...
    SMART_ACTION_SET_ORIENTATION =
        66, // quick change, random orientation? (0/1), turnAngle
    SMART_ACTION_CREATE_TIMED_EVENT =
        67, // id, InitialMin, InitialMax, RepeatMin(only if it repeats),
            // RepeatMax(only if it repeats), chance
    SMART_ACTION_PLAYMOVIE   = 68,    // entry
    SMART_ACTION_MOVE_TO_POS = 69,    // PointId (optional x,y,z offset),
                                      // transport, controlled, ContactDistance
    SMART_ACTION_RESPAWN_TARGET = 70, // force / goRespawnTime
    SMART_ACTION_EQUIP =
        71, // entry, slotmask slot1, slot2, slot3   , only slots with mask set
            // will be sent to client, bits are 1, 2, 4, leaving mask 0 is
            // defaulted to mask 7 (send all), slots1-3 are only used if no
            // entry is set
    ...
    SMART_ACTION_OVERRIDE_SCRIPT_BASE_OBJECT =
        76, // WARNING: CAN CRASH CORE, do not use if you dont know what you are
            // doing
    ...
    SMART_ACTION_CALL_TIMED_ACTIONLIST =
        80, // ID (overwrites already running actionlist), stop after
            // combat?(0/1), timer update type(0-OOC, 1-IC, 2-ALWAYS)
    SMART_ACTION_SET_NPC_FLAG    = 81, // Flags
    SMART_ACTION_ADD_NPC_FLAG    = 82, // Flags
    SMART_ACTION_REMOVE_NPC_FLAG = 83, // Flags
    SMART_ACTION_SIMPLE_TALK =
        84, // groupID, can be used to make players say groupID, Text_over event
            // is not triggered, whisper can not be used (Target units will say
            // the text)
    SMART_ACTION_SELF_CAST =
        85, // spellID, castFlags, triggerFlags, targetsLimit
    SMART_ACTION_CROSS_CAST =
        86, // spellID, castFlags, CasterTargetType, CasterTarget param1,
            // CasterTarget param2, CasterTarget param3, ( + the origonal target
            // fields as Destination target),   CasterTargets will cast spellID
            // on all Targets (use with caution if targeting multiple * multiple
            // units)
    ...
    SMART_ACTION_SUMMON_CREATURE_GROUP =
        107, // Group, attackInvoker, attackScriptOwner
    ...
    SMART_ACTION_START_CLOSEST_WAYPOINT =
        113,                    // wp1, wp2, wp3, wp4, wp5, wp6, wp7
    SMART_ACTION_RISE_UP = 114, // distance
    SMART_ACTION_RANDOM_SOUND =
        115, // SoundId1, SoundId2, SoundId3, SoundId4, onlySelf, distance
    ...
    SMART_ACTION_INVOKER_CAST =
        134, // spellID, castFlags, triggerFlags, targetsLimit
    ...
    // Replaced by SMART_ACTION_GO_SET_GO_STATE
    ...
    SMART_ACTION_RANDOM_MUSIC =
        217, // SoundId1, SoundId2, SoundId3, SoundId4, onlySelf, type

    SMART_ACTION_CUSTOM_CAST = 218, // spellId, castflag, bp0, bp1, bp2
    SMART_ACTION_CONE_SUMMON =
        219, // entry, duration (0 = perm), dist between rings, dist between
             // earch summon in a row, length of cone, width of cone (angle)
    SMART_ACTION_PLAYER_TALK = 220, // acore_string.entry, yell? (0/1)
    SMART_ACTION_VORTEX_SUMMON =
        221, // entry, duration (0 = perm), spiral scaling, spiral appearance,
             // range max, phi_delta     <-- yes confusing math, try it ingame
             // and see, my lovely AC boys!
    SMART_ACTION_CU_ENCOUNTER_START =
        222, // Resets cooldowns on all targets and removes Heroism debuff(s)
    SMART_ACTION_DO_ACTION   = 223, // ActionId
    SMART_ACTION_ATTACK_STOP = 224, //
    SMART_ACTION_SET_GUID = 225, // Sends the invoker's or the base object's own
                                 // ObjectGuid to target
    SMART_ACTION_DISABLE   = 226, // state
    SMART_ACTION_SET_SCALE = 227, // scale
    SMART_ACTION_SUMMON_RADIAL =
        228, // summonEntry, summonDuration, repetitions, startAngle, stepAngle,
             // dist
    ...
    SMART_ACTION_SET_ORIENTATION_TARGET =
        231, // type, target_type, target_param1, target_param2, target_param3,
             // target_param4
...
enum SMARTAI_TEMPLATE {
    ...
    SMARTAI_TEMPLATE_CASTER = 1, // spellid, repeatMin, repeatMax, range,
                                 // manaPCT +JOIN: target_param1 as castFlag
    SMARTAI_TEMPLATE_TURRET =
        2, // spellid, repeatMin, repeatMax +JOIN: target_param1 as castFlag
    SMARTAI_TEMPLATE_PASSIVE = 3,
    SMARTAI_TEMPLATE_CAGED_GO_PART =
        4, // creatureID, give credit at point end?,
    SMARTAI_TEMPLATE_CAGED_NPC_PART =
        5, // gameObjectID, despawntime, run?, dist, TextGroupID
...
enum SMARTAI_TARGETS {
    ...
    SMART_TARGET_HOSTILE_SECOND_AGGRO =
        3, // Second highest aggro, maxdist, playerOnly, powerType + 1, missing
           // aura
    SMART_TARGET_HOSTILE_LAST_AGGRO =
        4, // Dead last on aggro, maxdist, playerOnly, powerType + 1, missing
           // aura
    SMART_TARGET_HOSTILE_RANDOM =
        5, // Just any random target on our threat list, maxdist, playerOnly,
           // powerType + 1, missing aura
    SMART_TARGET_HOSTILE_RANDOM_NOT_TOP =
        6, // Any random target except top threat, maxdist, playerOnly,
           // powerType + 1, missing aura
    ...
    SMART_TARGET_PLAYER_RANGE =
        17, // min, max, maxCount (maxCount by pussywizard), set target.o to 1
            // if u want to search for all in range if min, max fails
    ...
    SMART_TARGET_ACTION_INVOKER_VEHICLE =
        22, // Unit's vehicle who caused this Event to occur
    SMART_TARGET_OWNER_OR_SUMMONER =
        23, // Unit's owner or summoner, Use Owner/Charmer of this unit
    SMART_TARGET_THREAT_LIST =
        24, // All units on creature's threat list, maxdist, playerOnly
    ...
    SMART_TARGET_VEHICLE_PASSENGER =
        29, // seat number (vehicle can target it's own accessory)
    ...
    SMART_TARGET_PLAYER_WITH_AURA =
        201, // spellId, negation, MaxDist, MinDist, set target.o to a number to
             // random resize the list
    SMART_TARGET_RANDOM_POINT = 202, // range, amount (for summoning creature),
                                     // self als middle (0/1) else use xyz
    SMART_TARGET_ROLE_SELECTION = 203, // Range Max, TargetMask (Tanks (1),
                                       // Healer (2) Damage (4)), resize list
    SMART_TARGET_SUMMONED_CREATURES = 204, // Entry
    SMART_TARGET_INSTANCE_STORAGE =
        205, // Instance data index, Type (creature (1), gameobject (2))

    SMART_TARGET_AC_END = 206 // placeholder
};

struct SmartTarget {
    SmartTarget(SMARTAI_TARGETS t  = SMART_TARGET_NONE,
                uint32          p1 = 0,
                uint32          p2 = 0,
                uint32          p3 = 0,
                uint32          p4 = 0)
...
const uint32 SmartAIEventMask[SMART_EVENT_AC_END][2] = {
    {SMART_EVENT_UPDATE_IC,
     SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_TIMED_ACTIONLIST},
    {SMART_EVENT_UPDATE_OOC,
     SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT +
    ...
    {SMART_EVENT_LINK,
     SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT +
         SMART_SCRIPT_TYPE_MASK_AREATRIGGER + SMART_SCRIPT_TYPE_MASK_EVENT +
         SMART_SCRIPT_TYPE_MASK_GOSSIP + SMART_SCRIPT_TYPE_MASK_QUEST +
         SMART_SCRIPT_TYPE_MASK_SPELL + SMART_SCRIPT_TYPE_MASK_TRANSPORT +
         SMART_SCRIPT_TYPE_MASK_INSTANCE},
...
enum SmartEventFlags {
    ...
    SMART_EVENT_FLAG_DIFFICULTY_0 =
        0x002, // Event only occurs in instance difficulty 0
    SMART_EVENT_FLAG_DIFFICULTY_1 =
        0x004, // Event only occurs in instance difficulty 1
    SMART_EVENT_FLAG_DIFFICULTY_2 =
        0x008, // Event only occurs in instance difficulty 2
    SMART_EVENT_FLAG_DIFFICULTY_3 =
        0x010, // Event only occurs in instance difficulty 3
    ...
    SMART_EVENT_FLAG_DONT_RESET =
        0x100, // Event will not reset in SmartScript::OnReset()
    SMART_EVENT_FLAG_WHILE_CHARMED =
        0x200, // Event occurs even if AI owner is charmed

    SMART_EVENT_FLAG_DIFFICULTY_ALL =
        (SMART_EVENT_FLAG_DIFFICULTY_0 | SMART_EVENT_FLAG_DIFFICULTY_1 |
         SMART_EVENT_FLAG_DIFFICULTY_2 | SMART_EVENT_FLAG_DIFFICULTY_3),
    SMART_EVENT_FLAGS_ALL =
        (SMART_EVENT_FLAG_NOT_REPEATABLE | SMART_EVENT_FLAG_DIFFICULTY_ALL |
         SMART_EVENT_FLAG_RESERVED_5 | SMART_EVENT_FLAG_RESERVED_6 |
         SMART_EVENT_FLAG_DEBUG_ONLY | SMART_EVENT_FLAG_DONT_RESET |
         SMART_EVENT_FLAG_WHILE_CHARMED),

    // Temp flags, used only at runtime, never stored in DB
    SMART_EVENT_FLAG_TEMP_IGNORE_CHANCE_ROLL =
        0x40000000, // Event occurs no matter what
                    // roll_chance_i(e.event.event_chance) returns.
};

enum SmartCastFlags {
    SMARTCAST_INTERRUPT_PREVIOUS = 0x001, // Interrupt any spell casting
    SMARTCAST_TRIGGERED = 0x002, // Triggered (this makes spell cost zero mana
                                 // and have no cast time)
    // CAST_FORCE_CAST                  = 0x004,                     // Forces
    // cast even if creature is out of mana or out of range CAST_NO_MELEE_IF_OOM
    // = 0x008,                     // Prevents creature from entering melee if
    // out of mana or out of range CAST_FORCE_TARGET_SELF           = 0x010, //
    // Forces the target to cast this spell on itself
    SMARTCAST_AURA_NOT_PRESENT = 0x020, // Only casts the spell if the target
                                        // does not have an aura from the spell
    SMARTCAST_COMBAT_MOVE =
        0x040, // Prevents combat movement if cast successful. Allows movement
               // on range, OOM, LOS
    SMARTCAST_THREATLIST_NOT_SINGLE =
        0x080, // Only cast if the source's threatlist is higher than one. This
               // includes pets (see Skeram's True Fulfillment)
    SMARTCAST_TARGET_POWER_MANA =
        0x100 // Only cast if the target has power type mana (e.g. Mana Drain)
};

enum SmartFollowType {
    FOLLOW_TYPE_CIRCLE =
        1, // 360 degrees around leader, 90 degrees is the maximum angle
    ...
    FOLLOW_TYPE_ANGULAR =
        6 // geese-like formation 135 and 225 degrees behind leader
};

// one line in DB is one event
struct SmartScriptHolder {
    SmartScriptHolder()
        : entryOrGuid(0), source_type(SMART_SCRIPT_TYPE_CREATURE), event_id(0),
          link(0), event(), action(), target(), timer(0),
          priority(DEFAULT_PRIORITY), active(false), runOnce(false),
          enableTimed(false)
    {
    }
...
public:
    ...
    {
        return std::tie(priority, entryOrGuid, source_type, event_id, link) <
               std::tie(other.priority,
                        other.entryOrGuid,
                        other.source_type,
                        other.event_id,
                        other.link);
...
public:
    ...
    SmartAIEventList GetScript(int32 entry, SmartScriptType type)
    {
        ...
        if (mEventMap[uint32(type)].find(entry) !=
            mEventMap[uint32(type)].end())
            return mEventMap[uint32(type)][entry];
        else {
            if (entry > 0) // first search is for guid (negative), do not drop
                           // error if not found
                LOG_DEBUG("sql.sql",
                          "SmartAIMgr::GetScript: Could not load Script for "
                          "Entry {} ScriptType {}.",
                          entry,
                          uint32(type));
            return temp;
...
private:
    ...
    e.GetScriptType(), e.event_id, e.GetActionType(), target); return false;
        }
        return true;
    }*/
    ...
    bool IsMinMaxValid(SmartScriptHolder const& e, uint32 min, uint32 max)
    {
        if (max < min) {
            LOG_ERROR("sql.sql",
                      ...
                      "uses min/max params wrong ({}/{}), skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    e.GetScriptType(), e.event_id, e.GetActionType(), pct); return false;
        }
        return true;
    }*/
    ...
    bool NotNULL(SmartScriptHolder const& e, uint32 data)
    {
        if (!data) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "Parameter can not be nullptr, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType());
    ...
    bool IsGameObjectValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sObjectMgr->GetGameObjectTemplate(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent GameObject entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    bool IsItemValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sItemStore.LookupEntry(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent Item entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    bool IsTextEmoteValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sEmotesTextStore.LookupEntry(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent Text Emote entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    bool IsEmoteValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sEmotesStore.LookupEntry(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent Emote entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    bool IsAreaTriggerValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sObjectMgr->GetAreaTrigger(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent AreaTrigger entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
    ...
    bool IsSoundValid(SmartScriptHolder const& e, uint32 entry)
    {
        if (!sSoundEntriesStore.LookupEntry(entry)) {
            LOG_ERROR("sql.sql",
                      "SmartAIMgr: Entry {} SourceType {} Event {} Action {} "
                      "uses non-existent Sound entry {}, skipped.",
                      e.entryOrGuid,
                      e.GetScriptType(),
                      e.event_id,
                      e.GetActionType(),
