...
public:
    QueryGuildInfo(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_QUERY, std::move(packet))
    {
    }
...
public:
    GuildCreate(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_CREATE, std::move(packet))
    {
    }
...
public:
    GuildGetInfo(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_INFO, std::move(packet))
    {
    }
...
public:
    GuildGetRoster(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_ROSTER, std::move(packet))
    {
    }
...
public:
    GuildUpdateMotdText(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_MOTD, std::move(packet))
    {
    }
...
public:
    AcceptGuildInvite(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_ACCEPT, std::move(packet))
    {
    }
...
public:
    GuildDeclineInvitation(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_DECLINE, std::move(packet))
    {
    }
...
public:
    GuildInviteByName(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_INVITE, std::move(packet))
    {
    }
...
public:
    GuildEventLogQuery(WorldPacket&& packet)
        : ClientPacket(MSG_GUILD_EVENT_LOG_QUERY, std::move(packet))
    {
    }
...
public:
    GuildPermissionsQuery(WorldPacket&& packet)
        : ClientPacket(MSG_GUILD_PERMISSIONS, std::move(packet))
    {
    }
...
public:
    GuildSetRankPermissions(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_RANK, std::move(packet))
    {
    }
...
public:
    GuildAddRank(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_ADD_RANK, std::move(packet))
    {
    }
...
public:
    GuildDeleteRank(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_DEL_RANK, std::move(packet))
    {
    }
...
public:
    GuildUpdateInfoText(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_INFO_TEXT, std::move(packet))
    {
    }
...
public:
    GuildDelete(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_DISBAND, std::move(packet))
    {
    }
...
public:
    GuildDemoteMember(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_DEMOTE, std::move(packet))
    {
    }
...
public:
    GuildPromoteMember(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_PROMOTE, std::move(packet))
    {
    }
...
public:
    GuildOfficerRemoveMember(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_REMOVE, std::move(packet))
    {
    }
...
public:
    GuildLeave(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_LEAVE, std::move(packet))
    {
    }
...
public:
    GuildBankActivate(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANKER_ACTIVATE, std::move(packet))
    {
    }
...
public:
    GuildBankBuyTab(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_BUY_TAB, std::move(packet))
    {
    }
...
public:
    GuildBankUpdateTab(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_UPDATE_TAB, std::move(packet))
    {
    }
...
public:
    GuildBankDepositMoney(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_DEPOSIT_MONEY, std::move(packet))
    {
    }
...
public:
    GuildBankQueryTab(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_QUERY_TAB, std::move(packet))
    {
    }
...
public:
    GuildBankRemainingWithdrawMoneyQuery(WorldPacket&& packet)
        : ClientPacket(MSG_GUILD_BANK_MONEY_WITHDRAWN, std::move(packet))
    {
    }
...
public:
    GuildBankRemainingWithdrawMoney()
        : ServerPacket(MSG_GUILD_BANK_MONEY_WITHDRAWN, 8)
    {
    }
...
public:
    GuildBankWithdrawMoney(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_WITHDRAW_MONEY, std::move(packet))
    {
    }
...
public:
    GuildBankSwapItems(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_BANK_SWAP_ITEMS, std::move(packet))
    {
    }
...
public:
    GuildBankLogQuery(WorldPacket&& packet)
        : ClientPacket(MSG_GUILD_BANK_LOG_QUERY, std::move(packet))
    {
    }
...
public:
    GuildBankTextQuery(WorldPacket&& packet)
        : ClientPacket(MSG_QUERY_GUILD_BANK_TEXT, std::move(packet))
    {
    }
...
public:
    GuildBankSetTabText(WorldPacket&& packet)
        : ClientPacket(CMSG_SET_GUILD_BANK_TEXT, std::move(packet))
    {
    }
...
public:
    GuildSetGuildMaster(WorldPacket&& packet)
        : ClientPacket(CMSG_GUILD_LEADER, std::move(packet))
    {
    }
...
public:
    SaveGuildEmblem(WorldPacket&& packet)
        : ClientPacket(MSG_SAVE_GUILD_EMBLEM, std::move(packet))
    {
    }
