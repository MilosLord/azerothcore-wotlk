...
public:
    ...
    void SendPetNameInvalid(uint32             error,
                            std::string const& name,
                            DeclinedName*      declinedName);
    void SendPartyResult(PartyOperation     operation,
    ...
    {
        m_currentVendorEntry = vendorEntry;
    }
    ...
    void SetLogoutStartTime(time_t requestTime) { _logoutTime = requestTime; }
    ...
    {
        return this->KickPlayer("Unknown reason", setKicked);
    }
    ...
    // void SendTestCreatureQueryOpcode(uint32 entry, ObjectGuid guid, uint32
    // testvalue);
    ...
    void SendBattleGroundList(ObjectGuid         guid,
    ...
    // Spell
    void HandleClientCastFlags(WorldPacket&      recvPacket,
                               uint8             castFlags,
    ...
    void
    SetAccountData(AccountDataType type, time_t tm, std::string const& data);
    ...
    void SendAuctionCommandResult(uint32 auctionId,
                                  uint32 Action,
                                  uint32 ErrorCode,
                                  uint32 bidError = 0);
    void SendAuctionBidderNotification(uint32     location,
                                       uint32     auctionId,
                                       ObjectGuid bidder,
                                       uint32     bidSum,
                                       uint32     diff,
    ...
    // Item Enchantment
    void SendEnchantmentLog(ObjectGuid target,
                            ObjectGuid caster,
                            uint32     itemId,
                            uint32     enchantId);
    void SendItemEnchantTimeUpdate(ObjectGuid Playerguid,
                                   ObjectGuid Itemguid,
                                   uint32     slot,
                                   uint32     Duration);
    ...
    // Guild/Arena Team
    void SendArenaTeamCommandResult(uint32             team_action,
    ...
    void ResetTimeOutTime(bool onlyActive)
    {
        if (GetPlayer())
            m_timeOutTime =
                int32(sWorld->getIntConfig(CONFIG_SOCKET_TIMEOUTTIME_ACTIVE));
        else if (!onlyActive)
            m_timeOutTime =
                int32(sWorld->getIntConfig(CONFIG_SOCKET_TIMEOUTTIME));
    }
    ...
    {
        return _calendarEventCreationCooldown;
    }
    void SetCalendarEventCreationCooldown(time_t cooldown)
    {
        _calendarEventCreationCooldown = cooldown;
    }
...
public:                                  // opcodes handlers
    ...
    void Handle_ServerSide(WorldPacket& recvPacket); // sever side only, can't
                                                     // be accepted from client
    void
    Handle_Deprecated(WorldPacket& recvPacket); // never used anymore by client
    ...
    void
         SendCharFactionChange(ResponseCodes                     result,
    ...
    void
    HandleShowingCloakOpcode(WorldPackets::Character::ShowingCloak& packet);
    ...
    void
    HandleGuildInviteOpcode(WorldPackets::Guild::GuildInviteByName& packet);
    void HandleGuildRemoveOpcode(
        WorldPackets::Guild::GuildOfficerRemoveMember& packet);
    void
    HandleGuildAcceptOpcode(WorldPackets::Guild::AcceptGuildInvite& invite);
    ...
    void
    HandleGuildPromoteOpcode(WorldPackets::Guild::GuildPromoteMember& promote);
    void
    HandleGuildDemoteOpcode(WorldPackets::Guild::GuildDemoteMember& demote);
    ...
    void
    HandleGuildLeaderOpcode(WorldPackets::Guild::GuildSetGuildMaster& packet);
    void
    HandleGuildMOTDOpcode(WorldPackets::Guild::GuildUpdateMotdText& packet);
    void HandleGuildSetPublicNoteOpcode(
        WorldPackets::Guild::GuildSetMemberNote& packet);
    void HandleGuildSetOfficerNoteOpcode(
        WorldPackets::Guild::GuildSetMemberNote& packet);
    void
    HandleGuildRankOpcode(WorldPackets::Guild::GuildSetRankPermissions& packet);
    ...
    void
    HandleSaveGuildEmblemOpcode(WorldPackets::Guild::SaveGuildEmblem& packet);
    ...
    void HandleOpenWrappedItemCallback(uint8               bagIndex,
                                       uint8               slot,
    ...
    void HandleAutoStoreBankItemOpcode(
        WorldPackets::Bank::AutoStoreBankItem& packet);
    ...
    void HandlePetActionHelper(Unit*      pet,
                               ObjectGuid guid1,
                               uint32     spellid,
                               uint16     flag,
                               ObjectGuid guid2);
    ...
    void
    HandlePetSpellAutocastOpcode(WorldPackets::Pet::PetSpellAutocast& packet);
    ...
    void
    HandleCharRenameCallBack(std::shared_ptr<CharacterRenameInfo> renameInfo,
                             PreparedQueryResult                  result);
    void HandleSetPlayerDeclinedNames(WorldPacket& recvData);

    void
    HandleTotemDestroyed(WorldPackets::Totem::TotemDestroyed& totemDestroyed);
    void
    HandleDismissCritter(WorldPackets::Pet::DismissCritter& dismissCritter);
    ...
    void SendBfQueueInviteResponse(uint32 battleId,
                                   uint32 zoneId,
                                   bool   canQueue = true,
                                   bool   full     = false);
    ...
    void
    SendLfgPlayerReward(lfg::LfgPlayerRewardData const& lfgPlayerRewardData);
    ...
    // Guild Bank
    void
    HandleGuildPermissions(WorldPackets::Guild::GuildPermissionsQuery& packet);
    void HandleGuildBankMoneyWithdrawn(
        WorldPackets::Guild::GuildBankRemainingWithdrawMoneyQuery& packet);
    void
    HandleGuildBankerActivate(WorldPackets::Guild::GuildBankActivate& packet);
    void
    HandleGuildBankQueryTab(WorldPackets::Guild::GuildBankQueryTab& packet);
    void
    HandleGuildBankLogQuery(WorldPackets::Guild::GuildBankLogQuery& packet);
    ...
    void
    HandleGuildBankSwapItems(WorldPackets::Guild::GuildBankSwapItems& packet);

    void
    HandleGuildBankUpdateTab(WorldPackets::Guild::GuildBankUpdateTab& packet);
    void HandleGuildBankBuyTab(WorldPackets::Guild::GuildBankBuyTab& packet);
    void HandleQueryGuildBankTabText(
        WorldPackets::Guild::GuildBankTextQuery& packet);
    void
    HandleSetGuildBankTabText(WorldPackets::Guild::GuildBankSetTabText& packet);
    ...
    AddQueryHolderCallback(SQLQueryHolderCallback&& callback);

    void InitializeSession();
    void
    InitializeSessionCallback(CharacterDatabaseQueryHolder const& realmHolder,
...
private:
    ...
    // logging helper
    void LogUnexpectedOpcode(WorldPacket* packet,
                             char const*  status,
                             const char*  reason);
    ...
    CircularBuffer<std::pair<int64, uint32>>
        _timeSyncClockDeltaQueue; // first member: clockDelta. Second member:
                                  // latency of the packet exchange that was
                                  // used to compute that clockDelta.
    int64 _timeSyncClockDelta;
    void  ComputeNewClockDelta();

    std::map<uint32, uint32>
        _pendingTimeSyncRequests; // key: counter. value: server time when
                                  // packet with that counter was sent.
