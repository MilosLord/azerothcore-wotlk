...
template <class Str>
AC_COMMON_API Str
Acore::String::Trim(const Str& s, const std::locale& loc /*= std::locale()*/)
{
...
/**
 * @brief Util function to add a suffix char. Can be used to add a slash at the
 * end of a path
 *
...
// Template Trim
template AC_COMMON_API std::string
                       Acore::String::Trim<std::string>(const std::string& s,
