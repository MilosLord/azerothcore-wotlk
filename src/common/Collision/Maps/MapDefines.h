...
// All padding fields must be handled and initialized to ensure mmaps_generator
// will produce binary-identical *.mmtile files
static_assert(
    sizeof(MmapTileHeader) == 20,
    "MmapTileHeader size is not correct, adjust the padding field size");
