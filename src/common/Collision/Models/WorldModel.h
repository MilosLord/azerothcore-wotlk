...
public:
    ...
    //! pass mesh data to object and create BIH. Passed vectors get get swapped
    //! with old geometry!
    void setMeshData(std::vector<G3D::Vector3>& vert,
    ...
    bool IntersectRay(const G3D::Ray& ray,
                      float&          distance,
                      bool            stopAtFirstHit) const;
    bool IsInsideObject(const G3D::Vector3& pos,
...
public:
    ...
    //! pass group models to WorldModel and create BIH. Passed vector is swapped
    //! with old geometry!
    ...
    bool   IntersectPoint(const G3D::Vector3& p,
                          const G3D::Vector3& down,
                          float&              dist,
                          AreaInfo&           info) const;
    bool   GetLocationInfo(const G3D::Vector3& p,
                           const G3D::Vector3& down,
                           float&              dist,
