...
public:
    ...
    {
        return Acore::Count(i_elements, (SPECIFIC_TYPE*)nullptr);
    }
    ...
    [[nodiscard]] const ContainerMapList<OBJECT_TYPES>& GetElements() const
    {
        return i_elements;
    }
...
public:
    ...
    [[nodiscard]] ContainerUnorderedMap<OBJECT_TYPES, KEY_TYPE> const&
    GetElements() const
    {
        return _elements;
    }
