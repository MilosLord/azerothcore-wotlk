...
public:
    ...
    // Link is invalid due to destruction of referenced target object. Call
    // comes from the refTo object Tell our refFrom object, that the link is cut
    ...
    [[nodiscard]] Reference<TO, FROM> const* next() const
    {
    ...
    [[nodiscard]] Reference<TO, FROM> const* prev() const
    {
    ...
    [[nodiscard]] Reference<TO, FROM> const* nocheck_next() const
    {
    ...
    [[nodiscard]] Reference<TO, FROM> const* nocheck_prev() const
    {
